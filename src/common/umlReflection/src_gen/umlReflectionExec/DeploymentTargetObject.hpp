...
#ifndef UML_DEPLOYMENTTARGET_EXECUTION_HPP
#define UML_DEPLOYMENTTARGET_EXECUTION_HPP
...
namespace UML 
{
	class DeploymentTargetObject : virtual public UML::NamedElementObject
	{
		public:
		    //constructors
		    DeploymentTargetObject(DeploymentTargetObject &obj);
		    DeploymentTargetObject(std::shared_ptr<uml::DeploymentTarget>);
		 	DeploymentTargetObject();
		    //destructor
		    virtual ~DeploymentTargetObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			DeploymentTargetObject& operator=(DeploymentTargetObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::DeploymentTarget> getDeploymentTargetValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setDeploymentTargetValue(std::shared_ptr<uml::DeploymentTarget>);
			virtual void setThisDeploymentTargetObjectPtr(std::weak_ptr<DeploymentTargetObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::DeploymentTarget> m_DeploymentTargetValue = nullptr;
	};
}
#endif /* end of include guard: UML_DEPLOYMENTTARGET_OBJECT_HPP */
