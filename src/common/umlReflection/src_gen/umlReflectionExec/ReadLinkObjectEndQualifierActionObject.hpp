...
#ifndef UML_READLINKOBJECTENDQUALIFIERACTION_EXECUTION_HPP
#define UML_READLINKOBJECTENDQUALIFIERACTION_EXECUTION_HPP
...
namespace UML 
{
	class ReadLinkObjectEndQualifierActionObject : virtual public UML::ActionObject
	{
		public:
		    //constructors
		    ReadLinkObjectEndQualifierActionObject(ReadLinkObjectEndQualifierActionObject &obj);
		    ReadLinkObjectEndQualifierActionObject(std::shared_ptr<uml::ReadLinkObjectEndQualifierAction>);
		 	ReadLinkObjectEndQualifierActionObject();
		    //destructor
		    virtual ~ReadLinkObjectEndQualifierActionObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			ReadLinkObjectEndQualifierActionObject& operator=(ReadLinkObjectEndQualifierActionObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::ReadLinkObjectEndQualifierAction> getReadLinkObjectEndQualifierActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setReadLinkObjectEndQualifierActionValue(std::shared_ptr<uml::ReadLinkObjectEndQualifierAction>);
			virtual void setThisReadLinkObjectEndQualifierActionObjectPtr(std::weak_ptr<ReadLinkObjectEndQualifierActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ReadLinkObjectEndQualifierAction> m_ReadLinkObjectEndQualifierActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_READLINKOBJECTENDQUALIFIERACTION_OBJECT_HPP */
