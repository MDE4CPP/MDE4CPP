...
namespace uml 
{
	class StructuredActivityNodeImpl :virtual public ActionImpl, virtual public ActivityGroupImpl, virtual public NamespaceImpl, virtual public StructuredActivityNode 
	{
		...
		protected:
			...
			StructuredActivityNodeImpl(std::shared_ptr<uml::Activity > par_Activity, const int reference_id);
			...
			//Additional constructors for the containments back reference
			StructuredActivityNodeImpl(std::shared_ptr<uml::Namespace > par_namespace);
			...
			//Additional constructors for the containments back reference
			StructuredActivityNodeImpl(std::shared_ptr<uml::ActivityGroup > par_superGroup);
