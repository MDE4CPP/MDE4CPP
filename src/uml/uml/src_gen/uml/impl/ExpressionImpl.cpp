...
bool ExpressionImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::EXPRESSION_ATTRIBUTE_OPERAND:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ExpressionImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
