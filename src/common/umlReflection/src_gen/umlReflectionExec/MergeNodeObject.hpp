...
#ifndef UML_MERGENODE_EXECUTION_HPP
#define UML_MERGENODE_EXECUTION_HPP
...
namespace UML 
{
	class MergeNodeObject : virtual public UML::ControlNodeObject
	{
		public:
		    //constructors
		    MergeNodeObject(MergeNodeObject &obj);
		    MergeNodeObject(std::shared_ptr<uml::MergeNode>);
		 	MergeNodeObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::MergeNode> getMergeNodeValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setMergeNodeValue(std::shared_ptr<uml::MergeNode>);
			virtual void setThisMergeNodeObjectPtr(std::weak_ptr<MergeNodeObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::MergeNode> m_MergeNodeValue = nullptr;
	};
}
#endif /* end of include guard: UML_MERGENODE_OBJECT_HPP */
