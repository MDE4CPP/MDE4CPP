...
void SimpleClassifiersPackageImpl::createSignalInstanceContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_signalInstance_Operation_getTypes = factory->createEOperation_as_eOperations_in_EClass(m_signalInstance_Class, SIGNALINSTANCE_OPERATION_GETTYPES);
...
void SimpleClassifiersPackageImpl::createStructuredValueContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_structuredValue_Operation_getMemberFeatures_Classifier = factory->createEOperation_as_eOperations_in_EClass(m_structuredValue_Class, STRUCTUREDVALUE_OPERATION_GETMEMBERFEATURES_CLASSIFIER);
	m_structuredValue_Operation_getStructuralFeatureForType_Classifier = factory->createEOperation_as_eOperations_in_EClass(m_structuredValue_Class, STRUCTUREDVALUE_OPERATION_GETSTRUCTURALFEATUREFORTYPE_CLASSIFIER);
	...
	m_structuredValue_Operation_retrieveStructuralFeatures = factory->createEOperation_as_eOperations_in_EClass(m_structuredValue_Class, STRUCTUREDVALUE_OPERATION_RETRIEVESTRUCTURALFEATURES);
