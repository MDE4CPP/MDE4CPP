...
bool SubstitutionImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::SUBSTITUTION_ATTRIBUTE_CONTRACT:
		...
		case uml::umlPackage::SUBSTITUTION_ATTRIBUTE_SUBSTITUTINGCLASSIFIER:
		{
			...
			if(ecoreAny)
			{
				...
				{
					DEBUG_ERROR("Invalid type stored in 'ecore::ecoreAny' for feature 'substitutingClassifier'. Failed to set feature!")
					return false;
				}
			}
			else
			{
				DEBUG_ERROR("Invalid instance of 'ecore::ecoreAny' for feature 'substitutingClassifier'. Failed to set feature!")
				return false;
			}
		return true;
		}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> SubstitutionImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
