...
#ifndef UML_LINKENDDATA_EXECUTION_HPP
#define UML_LINKENDDATA_EXECUTION_HPP
...
namespace UML 
{
	class LinkEndDataObject : virtual public UML::ElementObject
	{
		public:
		    //constructors
		    LinkEndDataObject(LinkEndDataObject &obj);
		    LinkEndDataObject(std::shared_ptr<uml::LinkEndData>);
		 	LinkEndDataObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::LinkEndData> getLinkEndDataValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setLinkEndDataValue(std::shared_ptr<uml::LinkEndData>);
			virtual void setThisLinkEndDataObjectPtr(std::weak_ptr<LinkEndDataObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::LinkEndData> m_LinkEndDataValue = nullptr;
	};
}
#endif /* end of include guard: UML_LINKENDDATA_OBJECT_HPP */
