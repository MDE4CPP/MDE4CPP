...
namespace ocl::Expressions 
{
	class OCL_API IterateExpImpl : virtual public LoopExpImpl, virtual public IterateExp 
	{
		...
		protected:
			...
			IterateExpImpl();
			virtual std::shared_ptr<ocl::Expressions::IterateExp> getThisIterateExpPtr() const;
			virtual void setThisIterateExpPtr(std::weak_ptr<ocl::Expressions::IterateExp> thisIterateExpPtr);
			...
			//Additional constructors for the containments back reference
			//Additional constructors for the containments back reference
			IterateExpImpl(std::weak_ptr<ocl::Expressions::LoopExp> par_LoopExp, const int reference_id);
			//Additional constructors for the containments back reference
			//Additional constructors for the containments back reference
		...
		public:
			...
			virtual void setResult(std::shared_ptr<ecore::ETypedElement>) ;
		...
		private:
			std::weak_ptr<ocl::Expressions::IterateExp> m_thisIterateExpPtr;
	};
}
