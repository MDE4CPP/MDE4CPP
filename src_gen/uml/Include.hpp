...
namespace uml 
{
	...
	class Include:virtual public DirectedRelationship,virtual public NamedElement	{
		...
		public:
			...
			<p>From package UML::UseCases.</p> */
			virtual uml::UseCase *  getAddition() const = 0;
			
			/*!
			 The UseCase that is to be included.
			<p>From package UML::UseCases.</p> */
			virtual void setAddition(uml::UseCase *  _addition) = 0;
			
			/*!
			 The UseCase which includes the addition and owns the Include relationship.
			<p>From package UML::UseCases.</p> */
			virtual uml::UseCase *  getIncludingCase() const = 0;
			
			/*!
			 The UseCase which includes the addition and owns the Include relationship.
			<p>From package UML::UseCases.</p> */
			virtual void setIncludingCase(uml::UseCase *  _includingCase) = 0;
		...
		protected:
			...
			/*!
			 The UseCase that is to be included.
			<p>From package UML::UseCases.</p> */
			uml::UseCase *  m_addition =  nullptr ;
			/*!
			 The UseCase which includes the addition and owns the Include relationship.
			<p>From package UML::UseCases.</p> */
			uml::UseCase *  m_includingCase =  nullptr ;
