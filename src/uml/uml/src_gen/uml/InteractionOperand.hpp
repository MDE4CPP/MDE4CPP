	...
	class UML_API InteractionOperand: virtual public InteractionFragment, virtual public Namespace
	{
		...
		public:
			...
			*/
			...
			virtual bool guard_contain_references(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool guard_directly_prior(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
