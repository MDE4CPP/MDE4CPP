...
#ifndef UML_REDEFINABLEELEMENT_EXECUTION_HPP
#define UML_REDEFINABLEELEMENT_EXECUTION_HPP
...
namespace UML 
{
	class RedefinableElementObject : virtual public UML::NamedElementObject
	{
		public:
		    //constructors
		    RedefinableElementObject(RedefinableElementObject &obj);
		    RedefinableElementObject(std::shared_ptr<uml::RedefinableElement>);
		 	RedefinableElementObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::RedefinableElement> getRedefinableElementValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setRedefinableElementValue(std::shared_ptr<uml::RedefinableElement>);
			virtual void setThisRedefinableElementObjectPtr(std::weak_ptr<RedefinableElementObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::RedefinableElement> m_RedefinableElementValue = nullptr;
	};
}
#endif /* end of include guard: UML_REDEFINABLEELEMENT_OBJECT_HPP */
