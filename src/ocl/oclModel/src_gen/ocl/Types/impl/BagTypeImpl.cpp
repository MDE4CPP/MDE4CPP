...
BagTypeImpl& BagTypeImpl::operator=(const BagTypeImpl & obj)
{
	 ...
	 * Currently, this causes an error because it calls an implicit assignment operator of BagType 
	 * which is generated by the compiler (as BagType is an abstract class and does not have a user-defined assignment operator).
