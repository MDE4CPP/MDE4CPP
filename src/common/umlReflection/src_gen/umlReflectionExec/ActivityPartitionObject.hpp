...
#ifndef UML_ACTIVITYPARTITION_EXECUTION_HPP
#define UML_ACTIVITYPARTITION_EXECUTION_HPP
...
namespace UML 
{
	class ActivityPartitionObject : virtual public UML::ActivityGroupObject
	{
		public:
		    //constructors
		    ActivityPartitionObject(ActivityPartitionObject &obj);
		    ActivityPartitionObject(std::shared_ptr<uml::ActivityPartition>);
		 	ActivityPartitionObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::ActivityPartition> getActivityPartitionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setActivityPartitionValue(std::shared_ptr<uml::ActivityPartition>);
			virtual void setThisActivityPartitionObjectPtr(std::weak_ptr<ActivityPartitionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ActivityPartition> m_ActivityPartitionValue = nullptr;
	};
}
#endif /* end of include guard: UML_ACTIVITYPARTITION_OBJECT_HPP */
