	...
	class UML_API AcceptCallActionImpl : virtual public AcceptEventActionImpl, virtual public AcceptCallAction 
	{
		...
		public:
			...
			*/
			...
			virtual bool trigger_call_event(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			/*!
			isUnmrashall must be true for an AcceptCallAction.
			isUnmarshall = true
			*/
			 
			virtual bool unmarshall(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
