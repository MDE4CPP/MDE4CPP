...
#ifndef UML_CONNECTIONPOINTREFERENCE_EXECUTION_HPP
#define UML_CONNECTIONPOINTREFERENCE_EXECUTION_HPP
...
namespace UML 
{
	class ConnectionPointReferenceObject : virtual public UML::VertexObject
	{
		public:
		    //constructors
		    ConnectionPointReferenceObject(ConnectionPointReferenceObject &obj);
		    ConnectionPointReferenceObject(std::shared_ptr<uml::ConnectionPointReference>);
		 	ConnectionPointReferenceObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::ConnectionPointReference> getConnectionPointReferenceValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setConnectionPointReferenceValue(std::shared_ptr<uml::ConnectionPointReference>);
			virtual void setThisConnectionPointReferenceObjectPtr(std::weak_ptr<ConnectionPointReferenceObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ConnectionPointReference> m_ConnectionPointReferenceValue = nullptr;
	};
}
#endif /* end of include guard: UML_CONNECTIONPOINTREFERENCE_OBJECT_HPP */
