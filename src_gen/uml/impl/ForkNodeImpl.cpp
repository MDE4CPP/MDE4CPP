...
// Union Getter
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> ForkNodeImpl::getOwnedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> ForkNodeImpl::getRedefinedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::ActivityGroup>>> ForkNodeImpl::getInGroup() const
{
