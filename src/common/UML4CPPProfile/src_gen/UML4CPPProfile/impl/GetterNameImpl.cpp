...
GetterNameImpl::GetterNameImpl()
{
	...
	*/
	...
	//getter init
		...
		m_getterMap.insert(std::pair<long long,std::function<Any()>>(14802423,[this](){ return eAny(this->getBase_Property(), uml::umlPackage::PROPERTY_CLASS, false);}));
		//Property getterName
		m_getterMap.insert(std::pair<long long,std::function<Any()>>(1932053206,[this](){ return eAny(this->getGetterName(), types::typesPackage::STRING_CLASS, false);}));
	
	
	//setter init
	//Property base_Property
		m_setterMap.insert(std::pair<long long,std::function<void(Any)>>(14802423,[this](Any object){this->setBase_Property(object->get<std::shared_ptr<uml::Property>>());}));
	//Property getterName
		m_setterMap.insert(std::pair<long long,std::function<void(Any)>>(1932053206,[this](Any object){this->setGetterName(object->get<std::string>());}));
	
	
	//unsetter init
		//Property base_Property
		m_unsetterMap.insert(std::pair<long long,std::function<void()>>(14802423,[this](){m_base_Property = std::shared_ptr<uml::Property>(nullptr);}));
...
Any GetterNameImpl::get(long long _uID) const
{
...
void GetterNameImpl::set(long long _uID, Any value)
{
...
void GetterNameImpl::unset(long long _uID)
{
...
Any GetterNameImpl::invoke(long long _uID, std::shared_ptr<Bag<Any>> _arguments)
{
