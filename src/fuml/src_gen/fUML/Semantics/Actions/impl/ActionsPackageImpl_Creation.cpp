...
void ActionsPackageImpl::createStructuralFeatureActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_structuralFeatureActionActivation_Operation_getMatchingLinks_Association_FUML_Object = factory->createEOperation_as_eOperations_in_EClass(m_structuralFeatureActionActivation_Class, STRUCTURALFEATUREACTIONACTIVATION_OPERATION_GETMATCHINGLINKS_ASSOCIATION_FUML_OBJECT);
	m_structuralFeatureActionActivation_Operation_getMatchingLinksForEndValue_Association_FUML_Object = factory->createEOperation_as_eOperations_in_EClass(m_structuralFeatureActionActivation_Class, STRUCTURALFEATUREACTIONACTIVATION_OPERATION_GETMATCHINGLINKSFORENDVALUE_ASSOCIATION_FUML_OBJECT);
