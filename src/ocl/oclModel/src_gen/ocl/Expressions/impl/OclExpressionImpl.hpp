...
namespace ocl::Expressions 
{
	class OCL_API OclExpressionImpl : virtual public ecore::ETypedElementImpl, virtual public OclExpression 
	{
		...
		protected:
			...
			//Additional constructors for the containments back reference
			//Additional constructors for the containments back reference
			OclExpressionImpl(std::weak_ptr<ocl::Expressions::LoopExp> par_LoopExp, const int reference_id);
			//Additional constructors for the containments back reference
			//Additional constructors for the containments back reference
		...
		public:
			...
			//*********************************
			virtual const std::shared_ptr<ocl::Expressions::CallExp>& getAppliedElement() const ;
			...
			virtual const std::shared_ptr<Bag<ocl::Expressions::VarDeclarationExp>>& getInitializedElement() const ;
