...
namespace uml 
{
	...
	class Message:virtual public NamedElement	{
		...
		public:
			...
			<p>From package UML::Interactions.</p> */
			virtual std::vector<uml::ValueSpecification * > *  getArgument() const = 0;
			
			/*!
			 The Connector on which this Message is sent.
			<p>From package UML::Interactions.</p> */
			virtual uml::Connector *  getConnector() const = 0;
			
			/*!
			 The Connector on which this Message is sent.
			<p>From package UML::Interactions.</p> */
			virtual void setConnector(uml::Connector *  _connector) = 0;
			...
			<p>From package UML::Interactions.</p> */
			virtual uml::MessageEnd *  getReceiveEvent() const = 0;
			
			/*!
			 References the Receiving of the Message.
			<p>From package UML::Interactions.</p> */
			virtual void setReceiveEvent(uml::MessageEnd *  _receiveEvent) = 0;
			
			/*!
			 References the Sending of the Message.
			<p>From package UML::Interactions.</p> */
			virtual uml::MessageEnd *  getSendEvent() const = 0;
			
			/*!
			 References the Sending of the Message.
			<p>From package UML::Interactions.</p> */
			virtual void setSendEvent(uml::MessageEnd *  _sendEvent) = 0;
			
			/*!
			 The signature of the Message is the specification of its content. It refers either an Operation or a Signal.
			<p>From package UML::Interactions.</p> */
			virtual uml::NamedElement *  getSignature() const = 0;
			
			/*!
			 The signature of the Message is the specification of its content. It refers either an Operation or a Signal.
			<p>From package UML::Interactions.</p> */
			virtual void setSignature(uml::NamedElement *  _signature) = 0;
		...
		protected:
			...
			/*!
			 The arguments of the Message.
			<p>From package UML::Interactions.</p> */
			std::vector<uml::ValueSpecification * > *  m_argument =  nullptr ;
			/*!
			 The Connector on which this Message is sent.
			<p>From package UML::Interactions.</p> */
			uml::Connector *  m_connector =  nullptr ;
			/*!
			 The enclosing Interaction owning the Message.
			<p>From package UML::Interactions.</p> */
			...
			/*!
			 References the Receiving of the Message.
			<p>From package UML::Interactions.</p> */
			uml::MessageEnd *  m_receiveEvent =  nullptr ;
			/*!
			 References the Sending of the Message.
			<p>From package UML::Interactions.</p> */
			uml::MessageEnd *  m_sendEvent =  nullptr ;
			/*!
			 The signature of the Message is the specification of its content. It refers either an Operation or a Signal.
			<p>From package UML::Interactions.</p> */
			uml::NamedElement *  m_signature =  nullptr ;
