...
// Operations
//*********************************
bool WriteLinkActionImpl::allow_access(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < Any, Any>> context)
{
...
bool WriteLinkActionImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
	}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> WriteLinkActionImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
	std::shared_ptr<Any> result;
 
  	switch(operationID)
	{
		// uml::WriteLinkAction::allow_access(Any, std::map) : bool: 367255121
		case umlPackage::WRITELINKACTION_OPERATION_ALLOW_ACCESS_EDIAGNOSTICCHAIN_EMAP:
		{
			...
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for parameter 'diagnostics'. Failed to invoke operation 'allow_access'!")
				return nullptr;
			}
			...
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for parameter 'context'. Failed to invoke operation 'allow_access'!")
				return nullptr;
			}
