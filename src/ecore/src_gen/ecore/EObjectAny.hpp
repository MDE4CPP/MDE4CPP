...
#ifndef ECORE_EOBJECTANY_HPP
#define ECORE_EOBJECTANY_HPP
...
namespace ecore 
{
	...
	class ECORE_API EObjectAny : virtual public EObject
	{
		public:
 			EObjectAny(const EObjectAny &) {}
		...
		public:
			...
			//*********************************
			virtual const std::shared_ptr<Any>& getAny() const = 0;
