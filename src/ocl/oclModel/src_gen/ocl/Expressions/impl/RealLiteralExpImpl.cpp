...
bool RealLiteralExpImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::REALLITERALEXP_ATTRIBUTE_REALSYMBOL:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> RealLiteralExpImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
