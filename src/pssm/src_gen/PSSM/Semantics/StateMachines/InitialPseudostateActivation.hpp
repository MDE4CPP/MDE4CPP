...
#ifndef PSSM_SEMANTICS_STATEMACHINES_INITIALPSEUDOSTATEACTIVATION_HPP
#define PSSM_SEMANTICS_STATEMACHINES_INITIALPSEUDOSTATEACTIVATION_HPP
...
namespace PSSM::Semantics::StateMachines 
{
	...
	class PSSM_API InitialPseudostateActivation : virtual public PseudostateActivation
	{
		public:
 			InitialPseudostateActivation(const InitialPseudostateActivation &) {}
		...
		public:
			...
			//destructor
			virtual ~InitialPseudostateActivation() {}
...
#endif /* end of include guard: PSSM_SEMANTICS_STATEMACHINES_INITIALPSEUDOSTATEACTIVATION_HPP */
