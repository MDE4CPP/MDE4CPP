	...
	class UML_API AssociationClass: virtual public Association, virtual public Class
	{
		...
		public:
			...
			*/
			...
			virtual bool cannot_be_defined(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < std::shared_ptr<Any>, std::shared_ptr<Any>>> context) = 0;
			/*!
			The owned attributes and owned ends of an AssociationClass are disjoint.
			ownedAttribute->intersection(ownedEnd)->isEmpty()
			*/
			 
			virtual bool disjoint_attributes_ends(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < std::shared_ptr<Any>, std::shared_ptr<Any>>> context) = 0;
