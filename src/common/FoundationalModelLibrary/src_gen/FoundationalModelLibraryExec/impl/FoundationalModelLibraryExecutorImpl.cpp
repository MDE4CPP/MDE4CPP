...
std::shared_ptr<Bag<fUML::Semantics::CommonBehavior::ParameterValue>> FoundationalModelLibraryExecutorImpl::execute(const std::shared_ptr<uml::Behavior>& behavior, const std::shared_ptr<uml::Element>& context, const std::shared_ptr<Bag<fUML::Semantics::CommonBehavior::ParameterValue>>& inputs)
{
...
std::shared_ptr<Bag<fUML::Semantics::CommonBehavior::ParameterValue>> FoundationalModelLibraryExecutorImpl::invokeOpaqueBehavior(const std::shared_ptr<uml::OpaqueBehavior>& opaqueBehavior, const std::shared_ptr<uml::Element>& context, const std::shared_ptr<Bag<fUML::Semantics::CommonBehavior::ParameterValue>>& inputs)
{
