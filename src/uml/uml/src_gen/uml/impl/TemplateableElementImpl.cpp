...
bool TemplateableElementImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::TEMPLATEABLEELEMENT_ATTRIBUTE_OWNEDTEMPLATESIGNATURE:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> TemplateableElementImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
