...
#ifndef UML_ACTIONINPUTPIN_EXECUTION_HPP
#define UML_ACTIONINPUTPIN_EXECUTION_HPP
...
namespace UML 
{
	class ActionInputPinObject : virtual public UML::InputPinObject
	{
		public:
		    //constructors
		    ActionInputPinObject(ActionInputPinObject &obj);
		    ActionInputPinObject(std::shared_ptr<uml::ActionInputPin>);
		 	ActionInputPinObject();
		    //destructor
		    virtual ~ActionInputPinObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			ActionInputPinObject& operator=(ActionInputPinObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::ActionInputPin> getActionInputPinValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setActionInputPinValue(std::shared_ptr<uml::ActionInputPin>);
			virtual void setThisActionInputPinObjectPtr(std::weak_ptr<ActionInputPinObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ActionInputPin> m_ActionInputPinValue = nullptr;
	};
}
#endif /* end of include guard: UML_ACTIONINPUTPIN_OBJECT_HPP */
