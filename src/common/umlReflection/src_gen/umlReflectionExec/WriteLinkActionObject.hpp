...
#ifndef UML_WRITELINKACTION_EXECUTION_HPP
#define UML_WRITELINKACTION_EXECUTION_HPP
...
namespace UML 
{
	class WriteLinkActionObject : virtual public UML::LinkActionObject
	{
		public:
		    //constructors
		    WriteLinkActionObject(WriteLinkActionObject &obj);
		    WriteLinkActionObject(std::shared_ptr<uml::WriteLinkAction>);
		 	WriteLinkActionObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::WriteLinkAction> getWriteLinkActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setWriteLinkActionValue(std::shared_ptr<uml::WriteLinkAction>);
			virtual void setThisWriteLinkActionObjectPtr(std::weak_ptr<WriteLinkActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::WriteLinkAction> m_WriteLinkActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_WRITELINKACTION_OBJECT_HPP */
