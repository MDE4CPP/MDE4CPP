...
namespace ocl::Evaluations 
{
	...
	class OCL_API UnlimitedNaturalLiteralExpEval: virtual public fUML::Semantics::Values::LiteralUnlimitedNaturalEvaluation, virtual public NumericLiteralExpEval
	{
		public:
