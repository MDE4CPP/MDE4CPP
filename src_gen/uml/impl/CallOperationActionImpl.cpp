...
// Union Getter
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::ActivityGroup>>> CallOperationActionImpl::getInGroup() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> CallOperationActionImpl::getRedefinedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::OutputPin>>> CallOperationActionImpl::getOutput() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> CallOperationActionImpl::getOwnedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::InputPin>>> CallOperationActionImpl::getInput() const
{
