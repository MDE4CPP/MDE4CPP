...
namespace ecore 
{
	...
	class ECORE_API ETypedElement : virtual public ENamedElement
	{
		...
		public:
			...
			//*********************************
			virtual const std::shared_ptr<ecore::EGenericType>& getEGenericType() const = 0;
			virtual void setEGenericType(const std::shared_ptr<ecore::EGenericType>&) = 0;
			virtual const std::shared_ptr<ecore::EClassifier>& getEType() const = 0;
			virtual void setEType(const std::shared_ptr<ecore::EClassifier>&) = 0;
