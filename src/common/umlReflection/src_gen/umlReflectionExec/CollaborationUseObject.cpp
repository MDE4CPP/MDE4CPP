...
{	
	if(m_CollaborationUseValue)
	{

	}

	m_CollaborationUseValue.reset();

	fUML::Semantics::StructuredClassifiers::ObjectImpl::destroy();
}

std::shared_ptr<uml::Element> CollaborationUseObject::getUmlValue() const
{
	return getCollaborationUseValue();
}

std::shared_ptr<uml::CollaborationUse> CollaborationUseObject::getCollaborationUseValue() const
{
	return m_CollaborationUseValue;
}

void CollaborationUseObject::setUmlValue(std::shared_ptr<uml::Element> _element)
{
	setCollaborationUseValue(std::dynamic_pointer_cast<uml::CollaborationUse>(_element));
}

void CollaborationUseObject::setCollaborationUseValue(std::shared_ptr<uml::CollaborationUse> _CollaborationUseElement)
{
	m_CollaborationUseValue = _CollaborationUseElement;
	//set super type values
	UML::NamedElementObject::setNamedElementValue(_CollaborationUseElement);
}

void CollaborationUseObject::setThisCollaborationUseObjectPtr(std::weak_ptr<CollaborationUseObject> thisObjectPtr)
{
	setThisCS_ObjectPtr(thisObjectPtr);
}

bool CollaborationUseObject::equals(std::shared_ptr<fUML::Semantics::Values::Value> otherValue)
{
	bool isEqual = false;
	
	std::shared_ptr<CollaborationUseObject> otherCollaborationUseObject = std::dynamic_pointer_cast<CollaborationUseObject>(otherValue);

	if(otherCollaborationUseObject != nullptr)
	{
		if(this->getCollaborationUseValue() == otherCollaborationUseObject->getCollaborationUseValue())
		{
			isEqual = true;
		}
	}
...
std::string CollaborationUseObject::toString()
{
	std::string buffer = "Instance of 'CollaborationUseObject', " + std::to_string(getTypes()->size()) + " types (";
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Object>> CollaborationUseObject::getDirectContainers()
{   
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Link>> CollaborationUseObject::getLinks(std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_InteractionPoint> interactionPoint)
{
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> CollaborationUseObject::retrieveEndValueAsInteractionPoint(std::shared_ptr<fUML::Semantics::Values::Value> endValue, std::shared_ptr<uml::ConnectorEnd> end)
{
	return nullptr;
}

void CollaborationUseObject::removeValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<fUML::Semantics::Values::Value> value)
{
	...
	if (m_CollaborationUseValue == nullptr)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": no value stored inside CollaborationUseObject (property: " << feature->getName() << ")" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_CollaborationUse_roleBinding())
	{
		...
		{
			m_CollaborationUseValue->getRoleBinding()->clear();
		}
		else
		{
			...
			std::shared_ptr<UML::DependencyObject> inputValue = std::dynamic_pointer_cast<UML::DependencyObject>(reference->getReferent());
			if (inputValue != nullptr)
			{
				m_CollaborationUseValue->getRoleBinding()->erase(inputValue->getDependencyValue());
			}
		}
	}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		if (value == nullptr) // clear mode
		{
			m_CollaborationUseValue->getOwnedComment()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_CollaborationUseValue->getOwnedComment()->erase(inputValue->getCommentValue());
			}
		}
	}
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> CollaborationUseObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	if (feature->getMetaElementID() != uml::UmlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::UmlPackage::PORT_CLASS && feature->getMetaElementID() != uml::UmlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_CollaborationUse_type())
	{
		std::shared_ptr<UML::CollaborationObject> value(new UML::CollaborationObject());
		value->setThisCollaborationObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setCollaborationValue(m_CollaborationUseValue->getType());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_owner())
	{
		...
		value->setThisElementObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setElementValue(m_CollaborationUseValue->getOwner().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<Bag<uml::Dependency>> clientDependencyList = m_CollaborationUseValue->getClientDependency();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		value->setValue(m_CollaborationUseValue->getName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		value->setLocus(this->getLocus());
		value->setStringExpressionValue(m_CollaborationUseValue->getNameExpression());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace())
	{
		...
		value->setLocus(this->getLocus());
		value->setNamespaceValue(m_CollaborationUseValue->getNamespace().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::StringValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createStringValue();
		value->setValue(m_CollaborationUseValue->getQualifiedName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		uml::VisibilityKind visibility = m_CollaborationUseValue->getVisibility();
...
std::shared_ptr<fUML::Semantics::SimpleClassifiers::FeatureValue> CollaborationUseObject::retrieveFeatureValue(std::shared_ptr<uml::StructuralFeature> feature)
{
...
void CollaborationUseObject::setFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	if (feature->getMetaElementID() != uml::UmlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::UmlPackage::PORT_CLASS && feature->getMetaElementID() != uml::UmlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_CollaborationUse_roleBinding())
	{
		...
		while (iter != end)
		{
			...
			std::shared_ptr<UML::DependencyObject> value = std::dynamic_pointer_cast<UML::DependencyObject>(reference->getReferent());
			if (value != nullptr)
			{
				m_CollaborationUseValue->getRoleBinding()->push_back(value->getDependencyValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_CollaborationUse_type())
	{
		...
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = std::dynamic_pointer_cast<PSCS::Semantics::StructuredClassifiers::CS_Reference>(inputValue);
		std::shared_ptr<UML::CollaborationObject> value = std::dynamic_pointer_cast<UML::CollaborationObject>(reference->getReferent());
		if (value != nullptr)
		{
			m_CollaborationUseValue->setType(value->getCollaborationValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_CollaborationUseValue->getOwnedComment()->push_back(value->getCommentValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		{
			m_CollaborationUseValue->setName(valueObject->getValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		if (value != nullptr)
		{
			m_CollaborationUseValue->setNameExpression(value->getStringExpressionValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		...
		{
			m_CollaborationUseValue->setVisibility(uml::VisibilityKind::PUBLIC);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_private())
		{
			m_CollaborationUseValue->setVisibility(uml::VisibilityKind::PRIVATE);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_protected())
		{
			m_CollaborationUseValue->setVisibility(uml::VisibilityKind::PROTECTED);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_package())
		{
			m_CollaborationUseValue->setVisibility(uml::VisibilityKind::PACKAGE);
		}
		
	}
}

void CollaborationUseObject::assignFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	this->setFeatureValue(feature, values, position);
}

std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> CollaborationUseObject::retrieveFeatureValues()
{
	...
	for(unsigned int i = 0; i < allAttributesSize; i++)
	{
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_CollaborationUse_roleBinding() && m_CollaborationUseValue->getRoleBinding() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_CollaborationUse_type() && m_CollaborationUseValue->getType() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment() && m_CollaborationUseValue->getOwnedComment() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedElement() && m_CollaborationUseValue->getOwnedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_owner() && m_CollaborationUseValue->getOwner().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_clientDependency() && m_CollaborationUseValue->getClientDependency() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression() && m_CollaborationUseValue->getNameExpression() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace() && m_CollaborationUseValue->getNamespace().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
	}
