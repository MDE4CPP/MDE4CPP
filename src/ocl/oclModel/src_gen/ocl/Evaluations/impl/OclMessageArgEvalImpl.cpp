...
bool OclMessageArgEvalImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case ocl::Evaluations::EvaluationsPackage::OCLMESSAGEARGEVAL_ATTRIBUTE_EXPRESSION:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> OclMessageArgEvalImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
