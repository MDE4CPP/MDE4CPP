	...
	switch(featureID)
	{
		case uml::umlPackage::VARIABLE_ATTRIBUTE_ACTIVITYSCOPE:
		{
			...
			if(ecoreAny)
			{
				...
				{
					DEBUG_ERROR("Invalid type stored in 'ecore::ecoreAny' for feature 'activityScope'. Failed to set feature!")
					return false;
				}
			}
			else
			{
				DEBUG_ERROR("Invalid instance of 'ecore::ecoreAny' for feature 'activityScope'. Failed to set feature!")
				return false;
			}
		return true;
		}
		case uml::umlPackage::VARIABLE_ATTRIBUTE_SCOPE:
		{
			...
			if(ecoreAny)
			{
				...
				{
					DEBUG_ERROR("Invalid type stored in 'ecore::ecoreAny' for feature 'scope'. Failed to set feature!")
					return false;
				}
			}
			else
			{
				DEBUG_ERROR("Invalid instance of 'ecore::ecoreAny' for feature 'scope'. Failed to set feature!")
				return false;
			}
		return true;
		}
		...
		case umlPackage::VARIABLE_OPERATION_ISACCESSIBLEBY_ACTION:
		{
			...
			Bag<Any>::const_iterator incoming_param_a_arguments_citer = std::next(arguments->begin(), 0);
			{
				...
				if(ecoreAny)
				{
					...
					{
						DEBUG_ERROR("Invalid type stored in 'ecore::EcoreAny' for parameter 'a'. Failed to invoke operation 'isAccessibleBy'!")
						return nullptr;
					}
				}
				else
				{
					DEBUG_ERROR("Invalid instance of 'ecore::EcoreAny' for parameter 'a'. Failed to invoke operation 'isAccessibleBy'!")
					return nullptr;
				}
			}
