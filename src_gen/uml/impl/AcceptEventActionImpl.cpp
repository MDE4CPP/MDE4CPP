...
// References
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::OutputPin>>> AcceptEventActionImpl::getResult() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Trigger>>> AcceptEventActionImpl::getTrigger() const
{
//assert(m_trigger);
    return m_trigger;
}
...
std::shared_ptr<std::vector<std::shared_ptr<uml::ActivityGroup>>> AcceptEventActionImpl::getInGroup() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::OutputPin>>> AcceptEventActionImpl::getOutput() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> AcceptEventActionImpl::getOwnedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> AcceptEventActionImpl::getRedefinedElement() const
{
