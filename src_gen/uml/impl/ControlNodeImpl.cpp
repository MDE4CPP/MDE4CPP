...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> ControlNodeImpl::getRedefinedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::ActivityGroup>>> ControlNodeImpl::getInGroup() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> ControlNodeImpl::getOwnedElement() const
{
