...
//*********************************
void ActorImpl::load(std::shared_ptr<persistence::interface::XLoadHandler> loadHandler)
{
...
void ActorImpl::loadAttributes(std::shared_ptr<persistence::interface::XLoadHandler> loadHandler, std::map<std::string, std::string> attr_list)
{

	BehavioredClassifierImpl::loadAttributes(loadHandler, attr_list);
}

void ActorImpl::loadNode(std::string nodeName, std::shared_ptr<persistence::interface::XLoadHandler> loadHandler, std::shared_ptr<uml::UmlFactory> modelFactory)
{
...
void ActorImpl::save(std::shared_ptr<persistence::interface::XSaveHandler> saveHandler) const
{
...
void ActorImpl::saveContent(std::shared_ptr<persistence::interface::XSaveHandler> saveHandler) const
{
	try
	{
