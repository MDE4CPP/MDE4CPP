...
namespace fUML::Semantics::Actions
{
	class FUML_API ActionsPackageImpl : public ecore::EPackageImpl ,virtual public ActionsPackage
	{
		...
		public:
			...
			virtual const std::shared_ptr<ecore::EOperation>& getStructuralFeatureActionActivation_Operation_getMatchingLinks_Association_FUML_Object() const ;
			virtual const std::shared_ptr<ecore::EOperation>& getStructuralFeatureActionActivation_Operation_getMatchingLinksForEndValue_Association_FUML_Object() const ;
