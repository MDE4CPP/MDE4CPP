...
#ifndef FUML_CALLEVENTOCCURRENCECALLEVENTOCCURRENCEIMPL_HPP
#define FUML_CALLEVENTOCCURRENCECALLEVENTOCCURRENCEIMPL_HPP
...
namespace fUML 
{
	class CallEventOccurrenceImpl :virtual public EventOccurrenceImpl, virtual public CallEventOccurrence 
	{
		...
		public:
			...
			/*!
			 */ 
			virtual std::shared_ptr<Bag<fUML::ParameterValue> > getParameterValues() ;
			...
			/*!
			 */ 
			virtual void setOutputParameterValues(std::shared_ptr<Bag<fUML::ParameterValue> >  parameterValues) ;
			...
			/*!
			 */
			virtual std::shared_ptr<fUML::CallEventExecution > getExecution() const ;
			
			/*!
			 */
			virtual void setExecution(std::shared_ptr<fUML::CallEventExecution> _execution_execution) ;
...
#endif /* end of include guard: FUML_CALLEVENTOCCURRENCECALLEVENTOCCURRENCEIMPL_HPP */
