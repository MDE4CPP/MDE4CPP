...
NodeImpl::NodeImpl()
{
	...
	//Init references
		/*Subset*/
		m_nestedNode->initSubset(m_ownedMember);
		#ifdef SHOW_SUBSET_UNION
			std::cout << "Initialising value Subset: " << "m_nestedNode - Subset<uml::Node, uml::NamedElement >(m_ownedMember)" << std::endl;
		#endif
...
{
	std::shared_ptr<ecore::EObject> element(new NodeImpl(*this));
	return element;
}
...
boost::any NodeImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
		...
		case UmlPackage::CLASS_EXTENSION:
			return getExtension(); //20748
		case UmlPackage::CLASSIFIER_FEATURE:
			return getFeature(); //20725
		case UmlPackage::CLASSIFIER_GENERAL:
			return getGeneral(); //20728
		case UmlPackage::CLASSIFIER_GENERALIZATION:
			return getGeneralization(); //20729
		case UmlPackage::NAMESPACE_IMPORTEDMEMBER:
			return getImportedMember(); //20714
		case UmlPackage::CLASSIFIER_INHERITEDMEMBER:
			return getInheritedMember(); //20731
		case UmlPackage::BEHAVIOREDCLASSIFIER_INTERFACEREALIZATION:
			return getInterfaceRealization(); //20740
		case UmlPackage::CLASSIFIER_ISABSTRACT:
			return getIsAbstract(); //20732
		case UmlPackage::CLASS_ISACTIVE:
			return getIsActive(); //20749
		case UmlPackage::CLASSIFIER_ISFINALSPECIALIZATION:
			return getIsFinalSpecialization(); //20733
...
void NodeImpl::eSet(int featureID, boost::any newValue)
{
	switch(featureID)
	{
		case UmlPackage::BEHAVIOREDCLASSIFIER_CLASSIFIERBEHAVIOR:
		{
			...
			setClassifierBehavior(_classifierBehavior); //20739
			break;
		}
		case UmlPackage::CLASSIFIER_ISABSTRACT:
		{
			...
			setIsAbstract(_isAbstract); //20732
			break;
		}
		case UmlPackage::CLASS_ISACTIVE:
		{
		...
		case UmlPackage::CLASSIFIER_ISFINALSPECIALIZATION:
		{
			...
			setIsFinalSpecialization(_isFinalSpecialization); //20733
			break;
		}
		case UmlPackage::REDEFINABLEELEMENT_ISLEAF:
		{
		...
		case UmlPackage::NAMEDELEMENT_NAMEEXPRESSION:
		{
			...
			setNameExpression(_nameExpression); //2076
			break;
		}
		case UmlPackage::TEMPLATEABLEELEMENT_OWNEDTEMPLATESIGNATURE:
		{
			...
			setOwnedTemplateSignature(_ownedTemplateSignature); //2075
			break;
		}
		case UmlPackage::PACKAGEABLEELEMENT_OWNINGPACKAGE:
		{
			...
			setOwningPackage(_owningPackage); //20712
			break;
		}
		case UmlPackage::PARAMETERABLEELEMENT_OWNINGTEMPLATEPARAMETER:
		{
			...
			setOwningTemplateParameter(_owningTemplateParameter); //2074
			break;
		}
		case UmlPackage::TYPE_PACKAGE:
		{
		...
		case UmlPackage::CLASSIFIER_REPRESENTATION:
		{
			...
			setRepresentation(_representation); //20737
			break;
		}
		case UmlPackage::PARAMETERABLEELEMENT_TEMPLATEPARAMETER:
		{
			...
			setTemplateParameter(_templateParameter); //2075
			break;
		}
		case UmlPackage::NAMEDELEMENT_VISIBILITY:
		{
			...
			setVisibility(_visibility); //2079
			break;
		}
	}
}
