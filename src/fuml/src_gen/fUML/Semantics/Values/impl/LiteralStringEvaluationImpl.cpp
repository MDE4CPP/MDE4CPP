...
const std::shared_ptr<ecore::EClass>& LiteralStringEvaluationImpl::eStaticClass() const
{
...
bool LiteralStringEvaluationImpl::eSet(int featureID, const Any& newValue)
{
	switch(featureID)
	{
	}
...
// EOperation Invoke
//*********************************
Any LiteralStringEvaluationImpl::eInvoke(int operationID, const std::shared_ptr<std::list<Any>>& arguments)
{
	Any result;
