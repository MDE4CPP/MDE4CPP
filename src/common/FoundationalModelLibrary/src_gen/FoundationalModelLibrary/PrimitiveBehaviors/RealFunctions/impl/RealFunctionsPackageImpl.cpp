...
void RealFunctionsPackageImpl::createPackageContents(std::shared_ptr<uml::Package> foundationalModelLibrary_PrimitiveBehaviors_RealFunctions)
{
	...
	createPackageEvents(foundationalModelLibrary_PrimitiveBehaviors_RealFunctions, factory);
	...
	createPackageSignals(foundationalModelLibrary_PrimitiveBehaviors_RealFunctions, factory);
...
void RealFunctionsPackageImpl::createPackageSignals(std::shared_ptr<uml::Package> foundationalModelLibrary_PrimitiveBehaviors_RealFunctions, std::shared_ptr<uml::umlFactory> factory)
{
	std::shared_ptr<uml::Constraint> con = nullptr;
	std::shared_ptr<uml::OpaqueExpression> oe = nullptr;
...
void RealFunctionsPackageImpl::createPackageEvents(std::shared_ptr<uml::Package> foundationalModelLibrary_PrimitiveBehaviors_RealFunctions, std::shared_ptr<uml::umlFactory> factory)
{
}
...
void RealFunctionsPackageImpl::initializePackageSignals()
{
	std::shared_ptr<uml::Generalization> gen = nullptr;
...
void RealFunctionsPackageImpl::initializePackageEvents()
{
}
