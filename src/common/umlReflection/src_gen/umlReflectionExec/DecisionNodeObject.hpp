...
#ifndef UML_DECISIONNODE_EXECUTION_HPP
#define UML_DECISIONNODE_EXECUTION_HPP
...
namespace UML 
{
	class DecisionNodeObject : virtual public UML::ControlNodeObject
	{
		public:
		    //constructors
		    DecisionNodeObject(DecisionNodeObject &obj);
		    DecisionNodeObject(std::shared_ptr<uml::DecisionNode>);
		 	DecisionNodeObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::DecisionNode> getDecisionNodeValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setDecisionNodeValue(std::shared_ptr<uml::DecisionNode>);
			virtual void setThisDecisionNodeObjectPtr(std::weak_ptr<DecisionNodeObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::DecisionNode> m_DecisionNodeValue = nullptr;
	};
}
#endif /* end of include guard: UML_DECISIONNODE_OBJECT_HPP */
