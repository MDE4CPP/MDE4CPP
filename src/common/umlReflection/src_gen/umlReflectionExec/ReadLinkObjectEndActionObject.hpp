...
#ifndef UML_READLINKOBJECTENDACTION_EXECUTION_HPP
#define UML_READLINKOBJECTENDACTION_EXECUTION_HPP
...
namespace UML 
{
	class ReadLinkObjectEndActionObject : virtual public UML::ActionObject
	{
		public:
		    //constructors
		    ReadLinkObjectEndActionObject(ReadLinkObjectEndActionObject &obj);
		    ReadLinkObjectEndActionObject(std::shared_ptr<uml::ReadLinkObjectEndAction>);
		 	ReadLinkObjectEndActionObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::ReadLinkObjectEndAction> getReadLinkObjectEndActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setReadLinkObjectEndActionValue(std::shared_ptr<uml::ReadLinkObjectEndAction>);
			virtual void setThisReadLinkObjectEndActionObjectPtr(std::weak_ptr<ReadLinkObjectEndActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ReadLinkObjectEndAction> m_ReadLinkObjectEndActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_READLINKOBJECTENDACTION_OBJECT_HPP */
