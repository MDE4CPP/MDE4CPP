	...
	class Message:virtual public NamedElement
	{
		...
		public:
			...
			*/
			...
			virtual bool arguments(Any diagnostics,std::map <   Any, Any >  context) = 0;
			...
			*/
			...
			virtual bool cannot_cross_boundaries(Any diagnostics,std::map <   Any, Any >  context) = 0;
			...
			*/
			...
			virtual bool occurrence_specifications(Any diagnostics,std::map <   Any, Any >  context) = 0;
			...
			*/
			...
			virtual bool sending_receiving_message_event(Any diagnostics,std::map <   Any, Any >  context) = 0;
			...
			*/
			...
			virtual bool signature_is_operation_reply(Any diagnostics,std::map <   Any, Any >  context) = 0;
			...
			*/
			...
			virtual bool signature_is_operation_request(Any diagnostics,std::map <   Any, Any >  context) = 0;
			...
			*/
			...
			virtual bool signature_is_signal(Any diagnostics,std::map <   Any, Any >  context) = 0;
			...
			*/
			...
			virtual bool signature_refer_to(Any diagnostics,std::map <   Any, Any >  context) = 0;
