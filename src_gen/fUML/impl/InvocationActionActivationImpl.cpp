...
std::shared_ptr<InvocationActionActivation> InvocationActionActivationImpl::getThisInvocationActionActivationPtr()
{
	...
	{
		std::shared_ptr<Bag<fUML::ActivityNodeActivation>> ownersInvocationActionActivationList = wp->getNodeActivations();
		for (std::shared_ptr<fUML::ActivityNodeActivation> anInvocationActionActivation : *ownersInvocationActionActivationList)
		{
			if (anInvocationActionActivation.get() == this)
			{
				return std::dynamic_pointer_cast<InvocationActionActivation>(anInvocationActionActivation );
			}
		}
	}
	struct null_deleter{void operator()(void const *) const {}};
	return std::shared_ptr<InvocationActionActivation>(this, null_deleter());
}
