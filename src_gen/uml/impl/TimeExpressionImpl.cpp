...
bool TimeExpressionImpl::internalEIsSet(int featureID) const
{
	...
	{
		case UmlPackage::TIMEEXPRESSION_EREFERENCE_EXPR:
			return getExpr() != nullptr; //20315
		case UmlPackage::TIMEEXPRESSION_EREFERENCE_OBSERVATION:
			return getObservation() != nullptr; //20316
	}
	return ValueSpecificationImpl::internalEIsSet(featureID);
}
...
//*********************************
void TimeExpressionImpl::load(std::shared_ptr<persistence::interface::XLoadHandler> loadHandler)
{
...
void TimeExpressionImpl::loadAttributes(std::shared_ptr<persistence::interface::XLoadHandler> loadHandler, std::map<std::string, std::string> attr_list)
{
	try
	{
...
void TimeExpressionImpl::loadNode(std::string nodeName, std::shared_ptr<persistence::interface::XLoadHandler> loadHandler, std::shared_ptr<uml::UmlFactory> modelFactory)
{
...
void TimeExpressionImpl::save(std::shared_ptr<persistence::interface::XSaveHandler> saveHandler) const
{
...
void TimeExpressionImpl::saveContent(std::shared_ptr<persistence::interface::XSaveHandler> saveHandler) const
{
	try
	{
