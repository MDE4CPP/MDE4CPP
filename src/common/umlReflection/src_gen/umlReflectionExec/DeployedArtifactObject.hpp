...
#ifndef UML_DEPLOYEDARTIFACT_EXECUTION_HPP
#define UML_DEPLOYEDARTIFACT_EXECUTION_HPP
...
namespace UML 
{
	class DeployedArtifactObject : virtual public UML::NamedElementObject
	{
		public:
		    //constructors
		    DeployedArtifactObject(DeployedArtifactObject &obj);
		    DeployedArtifactObject(std::shared_ptr<uml::DeployedArtifact>);
		 	DeployedArtifactObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::DeployedArtifact> getDeployedArtifactValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setDeployedArtifactValue(std::shared_ptr<uml::DeployedArtifact>);
			virtual void setThisDeployedArtifactObjectPtr(std::weak_ptr<DeployedArtifactObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::DeployedArtifact> m_DeployedArtifactValue = nullptr;
	};
}
#endif /* end of include guard: UML_DEPLOYEDARTIFACT_OBJECT_HPP */
