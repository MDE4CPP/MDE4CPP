...
ExpansionNodeImpl& ExpansionNodeImpl::operator=(const ExpansionNodeImpl & obj)
{
	 ...
	 * Currently, this causes an error because it calls an implicit assignment operator of ExpansionNode 
	 * which is generated by the compiler (as ExpansionNode is an abstract class and does not have a user-defined assignment operator).
...
// Operations
//*********************************
bool ExpansionNodeImpl::region_as_input_or_output(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < Any, Any>> context)
{
...
//*********************************
std::shared_ptr<Any> ExpansionNodeImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
		case uml::umlPackage::EXPANSIONNODE_ATTRIBUTE_REGIONASINPUT:
			return eAny(getRegionAsInput(),uml::umlPackage::EXPANSIONREGION_CLASS,false); //9326
		case uml::umlPackage::EXPANSIONNODE_ATTRIBUTE_REGIONASOUTPUT:
			return eAny(getRegionAsOutput(),uml::umlPackage::EXPANSIONREGION_CLASS,false); //9327
	}
...
bool ExpansionNodeImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::EXPANSIONNODE_ATTRIBUTE_REGIONASINPUT:
		{
			...
			if(ecoreAny)
			{
				try
				{
					...
					std::shared_ptr<uml::ExpansionRegion> _regionAsInput = std::dynamic_pointer_cast<uml::ExpansionRegion>(eObject);
					if(_regionAsInput)
					{
				...
				{
					DEBUG_MESSAGE(std::cout << __PRETTY_FUNCTION__ << " : Invalid type stored in 'ecore::ecoreAny' for feature 'regionAsInput'. Failed to set feature!"<< std::endl;)
					return false;
				}
			}
			else
			{
				DEBUG_MESSAGE(std::cout << __PRETTY_FUNCTION__ << " : Invalid instance of 'ecore::ecoreAny' for feature 'regionAsInput'. Failed to set feature!"<< std::endl;)
				return false;
			}
		return true;
		}
		case uml::umlPackage::EXPANSIONNODE_ATTRIBUTE_REGIONASOUTPUT:
		{
			...
			if(ecoreAny)
			{
				...
				{
					std::shared_ptr<ecore::EObject> eObject = ecoreAny->getAsEObject();
					std::shared_ptr<uml::ExpansionRegion> _regionAsOutput = std::dynamic_pointer_cast<uml::ExpansionRegion>(eObject);
					if(_regionAsOutput)
					{
				...
				{
					DEBUG_MESSAGE(std::cout << __PRETTY_FUNCTION__ << " : Invalid type stored in 'ecore::ecoreAny' for feature 'regionAsOutput'. Failed to set feature!"<< std::endl;)
					return false;
				}
			}
			else
			{
				DEBUG_MESSAGE(std::cout << __PRETTY_FUNCTION__ << " : Invalid instance of 'ecore::ecoreAny' for feature 'regionAsOutput'. Failed to set feature!"<< std::endl;)
				return false;
			}
		return true;
		}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ExpansionNodeImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
	std::shared_ptr<Any> result;
 
  	switch(operationID)
	{
		// uml::ExpansionNode::region_as_input_or_output(Any, std::map) : bool: 832139747
		case umlPackage::EXPANSIONNODE_OPERATION_REGION_AS_INPUT_OR_OUTPUT_EDIAGNOSTICCHAIN_EMAP:
		{
			...
			{
				DEBUG_MESSAGE(std::cout << __PRETTY_FUNCTION__ << " : Invalid type stored in 'Any' for parameter 'diagnostics'. Failed to invoke operation 'region_as_input_or_output'!"<< std::endl;)
				return nullptr;
			}
			...
			{
				DEBUG_MESSAGE(std::cout << __PRETTY_FUNCTION__ << " : Invalid type stored in 'Any' for parameter 'context'. Failed to invoke operation 'region_as_input_or_output'!"<< std::endl;)
				return nullptr;
			}
