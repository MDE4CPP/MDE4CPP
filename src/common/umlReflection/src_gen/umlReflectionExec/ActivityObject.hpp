...
#ifndef UML_ACTIVITY_EXECUTION_HPP
#define UML_ACTIVITY_EXECUTION_HPP
...
namespace UML 
{
	class ActivityObject : virtual public UML::BehaviorObject
	{
		public:
		    //constructors
		    ActivityObject(ActivityObject &obj);
		    ActivityObject(std::shared_ptr<uml::Activity>);
		 	ActivityObject();
		    //destructor
		    virtual ~ActivityObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			ActivityObject& operator=(ActivityObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::Activity> getActivityValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setActivityValue(std::shared_ptr<uml::Activity>);
			virtual void setThisActivityObjectPtr(std::weak_ptr<ActivityObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Activity> m_ActivityValue = nullptr;
	};
}
#endif /* end of include guard: UML_ACTIVITY_OBJECT_HPP */
