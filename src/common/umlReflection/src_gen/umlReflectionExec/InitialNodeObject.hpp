...
#ifndef UML_INITIALNODE_EXECUTION_HPP
#define UML_INITIALNODE_EXECUTION_HPP
...
namespace UML 
{
	class InitialNodeObject : virtual public UML::ControlNodeObject
	{
		public:
		    //constructors
		    InitialNodeObject(InitialNodeObject &obj);
		    InitialNodeObject(std::shared_ptr<uml::InitialNode>);
		 	InitialNodeObject();
		    //destructor
		    virtual ~InitialNodeObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			InitialNodeObject& operator=(InitialNodeObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::InitialNode> getInitialNodeValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setInitialNodeValue(std::shared_ptr<uml::InitialNode>);
			virtual void setThisInitialNodeObjectPtr(std::weak_ptr<InitialNodeObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::InitialNode> m_InitialNodeValue = nullptr;
	};
}
#endif /* end of include guard: UML_INITIALNODE_OBJECT_HPP */
