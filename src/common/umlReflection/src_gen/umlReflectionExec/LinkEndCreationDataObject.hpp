...
#ifndef UML_LINKENDCREATIONDATA_EXECUTION_HPP
#define UML_LINKENDCREATIONDATA_EXECUTION_HPP
...
namespace UML 
{
	class LinkEndCreationDataObject : virtual public UML::LinkEndDataObject
	{
		public:
		    //constructors
		    LinkEndCreationDataObject(LinkEndCreationDataObject &obj);
		    LinkEndCreationDataObject(std::shared_ptr<uml::LinkEndCreationData>);
		 	LinkEndCreationDataObject();
		    //destructor
		    virtual ~LinkEndCreationDataObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			LinkEndCreationDataObject& operator=(LinkEndCreationDataObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::LinkEndCreationData> getLinkEndCreationDataValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setLinkEndCreationDataValue(std::shared_ptr<uml::LinkEndCreationData>);
			virtual void setThisLinkEndCreationDataObjectPtr(std::weak_ptr<LinkEndCreationDataObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::LinkEndCreationData> m_LinkEndCreationDataValue = nullptr;
	};
}
#endif /* end of include guard: UML_LINKENDCREATIONDATA_OBJECT_HPP */
