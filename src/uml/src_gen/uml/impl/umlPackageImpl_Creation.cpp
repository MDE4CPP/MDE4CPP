...
void umlPackageImpl::createClassifierContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_classifier_Operation_getPropertyValue_String = factory->createEOperation_in_EContainingClass(m_classifier_Class, CLASSIFIER_OPERATION_GETPROPERTYVALUE_STRING);
...
void umlPackageImpl::createInputPinContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_inputPin_Attribute_addStructuralFeatureValueAction = factory->createEReference_in_EContainingClass(m_inputPin_Class, INPUTPIN_ATTRIBUTE_ADDSTRUCTURALFEATUREVALUEACTION);
...
void umlPackageImpl::createOutputPinContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_outputPin_Attribute_clearStructuralFeatureAction = factory->createEReference_in_EContainingClass(m_outputPin_Class, OUTPUTPIN_ATTRIBUTE_CLEARSTRUCTURALFEATUREACTION);
	m_outputPin_Attribute_createObjectAction = factory->createEReference_in_EContainingClass(m_outputPin_Class, OUTPUTPIN_ATTRIBUTE_CREATEOBJECTACTION);
	m_outputPin_Attribute_readSelfAction = factory->createEReference_in_EContainingClass(m_outputPin_Class, OUTPUTPIN_ATTRIBUTE_READSELFACTION);
	m_outputPin_Attribute_readStructuralFeatureAction = factory->createEReference_in_EContainingClass(m_outputPin_Class, OUTPUTPIN_ATTRIBUTE_READSTRUCTURALFEATUREACTION);
	...
	m_outputPin_Attribute_writeStructuralFeatureAction = factory->createEReference_in_EContainingClass(m_outputPin_Class, OUTPUTPIN_ATTRIBUTE_WRITESTRUCTURALFEATUREACTION);
...
void umlPackageImpl::createValueSpecificationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_valueSpecification_Attribute_valueSpecificationAction = factory->createEReference_in_EContainingClass(m_valueSpecification_Class, VALUESPECIFICATION_ATTRIBUTE_VALUESPECIFICATIONACTION);
