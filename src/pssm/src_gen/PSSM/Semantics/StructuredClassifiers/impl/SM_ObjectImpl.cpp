...
SM_ObjectImpl& SM_ObjectImpl::operator=(const SM_ObjectImpl & obj)
{
	//call overloaded =Operator for each base class
	fUML::MDE4CPP_Extensions::FUML_ObjectImpl::operator=(obj);
	/* TODO: Find out if this call is necessary
	 * Currently, this causes an error because it calls an implicit assignment operator of SM_Object 
	 * which is generated by the compiler (as SM_Object is an abstract class and does not have a user-defined assignment operator).
...
{
	std::shared_ptr<SM_ObjectImpl> element(new SM_ObjectImpl());
	*element =(*this);
...
void SM_ObjectImpl::startBehavior(const std::shared_ptr<uml::Class>& classifier, const std::shared_ptr<Bag<fUML::Semantics::CommonBehavior::ParameterValue>>& inputs)
{
	//ADD_COUNT(__PRETTY_FUNCTION__)
	//generated from body annotation
	...
	if(this->getObjectActivation() == nullptr)
    {
        this->setObjectActivation(std::dynamic_pointer_cast<fUML::Semantics::CommonBehavior::ObjectActivation>(CommonBehavior::CommonBehaviorFactory::eInstance()->createSM_ObjectActivation()));
...
void SM_ObjectImpl::loadNode(std::string nodeName, std::shared_ptr<persistence::interfaces::XLoadHandler> loadHandler)
{
...
void SM_ObjectImpl::resolveReferences(const int featureID, std::vector<std::shared_ptr<ecore::EObject>> references)
{
...
const std::shared_ptr<ecore::EClass>& SM_ObjectImpl::eStaticClass() const
{
	return PSSM::Semantics::StructuredClassifiers::StructuredClassifiersPackage::eInstance()->getSM_Object_Class();
}

//*********************************
// EStructuralFeature Get/Set/IsSet
//*********************************
std::shared_ptr<Any> SM_ObjectImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
	}
...
bool SM_ObjectImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
	}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> SM_ObjectImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
	std::shared_ptr<Any> result;
 
  	switch(operationID)
	{
		// PSSM::Semantics::StructuredClassifiers::SM_Object::destroy(): 522477208
		case StructuredClassifiersPackage::SM_OBJECT_OPERATION_DESTROY:
		{
			this->destroy();
			break;
		}
		// PSSM::Semantics::StructuredClassifiers::SM_Object::startBehavior(uml::Class, fUML::Semantics::CommonBehavior::ParameterValue[*]): 963801320
		case StructuredClassifiersPackage::SM_OBJECT_OPERATION_STARTBEHAVIOR_CLASS_PARAMETERVALUE:
		{
...
std::shared_ptr<PSSM::Semantics::StructuredClassifiers::SM_Object> SM_ObjectImpl::getThisSM_ObjectPtr() const
{
	return m_thisSM_ObjectPtr.lock();
}
void SM_ObjectImpl::setThisSM_ObjectPtr(std::weak_ptr<PSSM::Semantics::StructuredClassifiers::SM_Object> thisSM_ObjectPtr)
{
	m_thisSM_ObjectPtr = thisSM_ObjectPtr;
	setThisFUML_ObjectPtr(thisSM_ObjectPtr);
}
