...
bool TypedElementImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::TYPEDELEMENT_ATTRIBUTE_TYPE:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> TypedElementImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
