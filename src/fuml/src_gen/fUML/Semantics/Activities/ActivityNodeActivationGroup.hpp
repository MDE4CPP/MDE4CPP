...
namespace fUML::Semantics::Activities 
{
...

	{
		...
		public:
			...
			/*!
			 */
			virtual void setActivityExecution(std::shared_ptr<fUML::Semantics::Activities::ActivityExecution> _activityExecution_activityExecution) = 0;
			/*!
			 */
			...
			/*!
			 */
			virtual void setContainingNodeActivation(std::shared_ptr<fUML::Semantics::Actions::StructuredActivityNodeActivation> _containingNodeActivation_containingNodeActivation) = 0;
			/*!
			 */
		...
		protected:
			...
			/*!
			 */
			std::shared_ptr<Bag<fUML::Semantics::Activities::ActivityEdgeInstance>> m_edgeInstances;
			/*!
			 */
			std::shared_ptr<Bag<fUML::Semantics::Activities::ActivityNodeActivation>> m_nodeActivations;
			/*!
			 */
			std::shared_ptr<Bag<fUML::Semantics::Activities::ActivityNodeActivation>> m_suspendedActivations;
