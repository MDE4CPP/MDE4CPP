...
void StateMachinesPackageImpl::createCompletionEventOccurrenceContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_completionEventOccurrence_Operation__match_Trigger = factory->createEOperation_as_eOperations_in_EClass(m_completionEventOccurrence_Class, COMPLETIONEVENTOCCURRENCE_OPERATION__MATCH_TRIGGER);
...
void StateMachinesPackageImpl::createConditionalPseudostateActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_conditionalPseudostateActivation_Operation_isElseTransition_TransitionActivation = factory->createEOperation_as_eOperations_in_EClass(m_conditionalPseudostateActivation_Class, CONDITIONALPSEUDOSTATEACTIVATION_OPERATION_ISELSETRANSITION_TRANSITIONACTIVATION);
...
void StateMachinesPackageImpl::createDoActivityContextObjectContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_doActivityContextObject_Operation__register_EventAccepter = factory->createEOperation_as_eOperations_in_EClass(m_doActivityContextObject_Class, DOACTIVITYCONTEXTOBJECT_OPERATION__REGISTER_EVENTACCEPTER);
	m_doActivityContextObject_Operation_destroy = factory->createEOperation_as_eOperations_in_EClass(m_doActivityContextObject_Class, DOACTIVITYCONTEXTOBJECT_OPERATION_DESTROY);
	m_doActivityContextObject_Operation_initialize_FUML_Object = factory->createEOperation_as_eOperations_in_EClass(m_doActivityContextObject_Class, DOACTIVITYCONTEXTOBJECT_OPERATION_INITIALIZE_FUML_OBJECT);
	m_doActivityContextObject_Operation_send_EventOccurrence = factory->createEOperation_as_eOperations_in_EClass(m_doActivityContextObject_Class, DOACTIVITYCONTEXTOBJECT_OPERATION_SEND_EVENTOCCURRENCE);
	m_doActivityContextObject_Operation_startBehavior_Class_ParameterValue = factory->createEOperation_as_eOperations_in_EClass(m_doActivityContextObject_Class, DOACTIVITYCONTEXTOBJECT_OPERATION_STARTBEHAVIOR_CLASS_PARAMETERVALUE);
	...
	m_doActivityContextObject_Operation_unregisterFromContext_EventAccepter = factory->createEOperation_as_eOperations_in_EClass(m_doActivityContextObject_Class, DOACTIVITYCONTEXTOBJECT_OPERATION_UNREGISTERFROMCONTEXT_EVENTACCEPTER);
...
void StateMachinesPackageImpl::createDoActivityContextObjectActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_doActivityContextObjectActivation_Operation_dispatchNextEvent = factory->createEOperation_as_eOperations_in_EClass(m_doActivityContextObjectActivation_Class, DOACTIVITYCONTEXTOBJECTACTIVATION_OPERATION_DISPATCHNEXTEVENT);
	m_doActivityContextObjectActivation_Operation_startBehavior_Class_ParameterValue = factory->createEOperation_as_eOperations_in_EClass(m_doActivityContextObjectActivation_Class, DOACTIVITYCONTEXTOBJECTACTIVATION_OPERATION_STARTBEHAVIOR_CLASS_PARAMETERVALUE);
...
void StateMachinesPackageImpl::createDoActivityExecutionEventAccepterContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_doActivityExecutionEventAccepter_Operation_accept_EventOccurrence = factory->createEOperation_as_eOperations_in_EClass(m_doActivityExecutionEventAccepter_Class, DOACTIVITYEXECUTIONEVENTACCEPTER_OPERATION_ACCEPT_EVENTOCCURRENCE);
	m_doActivityExecutionEventAccepter_Operation_match_EventOccurrence = factory->createEOperation_as_eOperations_in_EClass(m_doActivityExecutionEventAccepter_Class, DOACTIVITYEXECUTIONEVENTACCEPTER_OPERATION_MATCH_EVENTOCCURRENCE);
...
void StateMachinesPackageImpl::createEntryPointPseudostateActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_entryPointPseudostateActivation_Operation__enter_TransitionActivation_EventOccurrence_RegionActivation = factory->createEOperation_as_eOperations_in_EClass(m_entryPointPseudostateActivation_Class, ENTRYPOINTPSEUDOSTATEACTIVATION_OPERATION__ENTER_TRANSITIONACTIVATION_EVENTOCCURRENCE_REGIONACTIVATION);
...
void StateMachinesPackageImpl::createExternalTransitionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_externalTransitionActivation_Operation_enterTarget_EventOccurrence = factory->createEOperation_as_eOperations_in_EClass(m_externalTransitionActivation_Class, EXTERNALTRANSITIONACTIVATION_OPERATION_ENTERTARGET_EVENTOCCURRENCE);
	m_externalTransitionActivation_Operation_exitSource_EventOccurrence = factory->createEOperation_as_eOperations_in_EClass(m_externalTransitionActivation_Class, EXTERNALTRANSITIONACTIVATION_OPERATION_EXITSOURCE_EVENTOCCURRENCE);
...
void StateMachinesPackageImpl::createFinalStateActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_finalStateActivation_Operation_enter_TransitionActivation_EventOccurrence_RegionActivation = factory->createEOperation_as_eOperations_in_EClass(m_finalStateActivation_Class, FINALSTATEACTIVATION_OPERATION_ENTER_TRANSITIONACTIVATION_EVENTOCCURRENCE_REGIONACTIVATION);
...
void StateMachinesPackageImpl::createInitialPseudostateActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_initialPseudostateActivation_Operation_enter_TransitionActivation_EventOccurrence_RegionActivation = factory->createEOperation_as_eOperations_in_EClass(m_initialPseudostateActivation_Class, INITIALPSEUDOSTATEACTIVATION_OPERATION_ENTER_TRANSITIONACTIVATION_EVENTOCCURRENCE_REGIONACTIVATION);
...
void StateMachinesPackageImpl::createInternalTransitionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_internalTransitionActivation_Operation_enterTarget_EventOccurrence = factory->createEOperation_as_eOperations_in_EClass(m_internalTransitionActivation_Class, INTERNALTRANSITIONACTIVATION_OPERATION_ENTERTARGET_EVENTOCCURRENCE);
	m_internalTransitionActivation_Operation_exitSource_EventOccurrence = factory->createEOperation_as_eOperations_in_EClass(m_internalTransitionActivation_Class, INTERNALTRANSITIONACTIVATION_OPERATION_EXITSOURCE_EVENTOCCURRENCE);
...
void StateMachinesPackageImpl::createJoinPseudostateActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_joinPseudostateActivation_Operation_canPropagateExecution_TransitionActivation_EventOccurrence_RegionActivation = factory->createEOperation_as_eOperations_in_EClass(m_joinPseudostateActivation_Class, JOINPSEUDOSTATEACTIVATION_OPERATION_CANPROPAGATEEXECUTION_TRANSITIONACTIVATION_EVENTOCCURRENCE_REGIONACTIVATION);
...
void StateMachinesPackageImpl::createLocalTransitionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_localTransitionActivation_Operation_enterTarget_EventOccurrence = factory->createEOperation_as_eOperations_in_EClass(m_localTransitionActivation_Class, LOCALTRANSITIONACTIVATION_OPERATION_ENTERTARGET_EVENTOCCURRENCE);
	m_localTransitionActivation_Operation_exitSource_EventOccurrence = factory->createEOperation_as_eOperations_in_EClass(m_localTransitionActivation_Class, LOCALTRANSITIONACTIVATION_OPERATION_EXITSOURCE_EVENTOCCURRENCE);
	m_localTransitionActivation_Operation_getContainingState = factory->createEOperation_as_eOperations_in_EClass(m_localTransitionActivation_Class, LOCALTRANSITIONACTIVATION_OPERATION_GETCONTAININGSTATE);
...
void StateMachinesPackageImpl::createStateActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_stateActivation_Operation_enter_TransitionActivation_EventOccurrence_RegionActivation = factory->createEOperation_as_eOperations_in_EClass(m_stateActivation_Class, STATEACTIVATION_OPERATION_ENTER_TRANSITIONACTIVATION_EVENTOCCURRENCE_REGIONACTIVATION);
	...
	m_stateActivation_Operation_exit_TransitionActivation_EventOccurrence_RegionActivation = factory->createEOperation_as_eOperations_in_EClass(m_stateActivation_Class, STATEACTIVATION_OPERATION_EXIT_TRANSITIONACTIVATION_EVENTOCCURRENCE_REGIONACTIVATION);
	...
	m_stateActivation_Operation_getVertexActivation_Vertex = factory->createEOperation_as_eOperations_in_EClass(m_stateActivation_Class, STATEACTIVATION_OPERATION_GETVERTEXACTIVATION_VERTEX);
	...
	m_stateActivation_Operation_terminate = factory->createEOperation_as_eOperations_in_EClass(m_stateActivation_Class, STATEACTIVATION_OPERATION_TERMINATE);
...
void StateMachinesPackageImpl::createStateMachineConfigurationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_stateMachineConfiguration_Operation_unregisterAll = factory->createEOperation_as_eOperations_in_EClass(m_stateMachineConfiguration_Class, STATEMACHINECONFIGURATION_OPERATION_UNREGISTERALL);
...
void StateMachinesPackageImpl::createStateMachineSemanticVisitorContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_stateMachineSemanticVisitor_Operation_getExecutionFor_Behavior_EventOccurrence_FUML_Object = factory->createEOperation_as_eOperations_in_EClass(m_stateMachineSemanticVisitor_Class, STATEMACHINESEMANTICVISITOR_OPERATION_GETEXECUTIONFOR_BEHAVIOR_EVENTOCCURRENCE_FUML_OBJECT);
...
void StateMachinesPackageImpl::createTerminatePseudostateActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	m_terminatePseudostateActivation_Class = factory->createEClass_as_eClassifiers_in_EPackage(package, TERMINATEPSEUDOSTATEACTIVATION_CLASS);
	
	
	m_terminatePseudostateActivation_Operation_enter_TransitionActivation_EventOccurrence_RegionActivation = factory->createEOperation_as_eOperations_in_EClass(m_terminatePseudostateActivation_Class, TERMINATEPSEUDOSTATEACTIVATION_OPERATION_ENTER_TRANSITIONACTIVATION_EVENTOCCURRENCE_REGIONACTIVATION);
...
void StateMachinesPackageImpl::createVertexActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_vertexActivation_Operation_canPropagateExecution_TransitionActivation_EventOccurrence_RegionActivation = factory->createEOperation_as_eOperations_in_EClass(m_vertexActivation_Class, VERTEXACTIVATION_OPERATION_CANPROPAGATEEXECUTION_TRANSITIONACTIVATION_EVENTOCCURRENCE_REGIONACTIVATION);
	m_vertexActivation_Operation_enter_TransitionActivation_EventOccurrence_RegionActivation = factory->createEOperation_as_eOperations_in_EClass(m_vertexActivation_Class, VERTEXACTIVATION_OPERATION_ENTER_TRANSITIONACTIVATION_EVENTOCCURRENCE_REGIONACTIVATION);
	m_vertexActivation_Operation_exit_TransitionActivation_EventOccurrence_RegionActivation = factory->createEOperation_as_eOperations_in_EClass(m_vertexActivation_Class, VERTEXACTIVATION_OPERATION_EXIT_TRANSITIONACTIVATION_EVENTOCCURRENCE_REGIONACTIVATION);
