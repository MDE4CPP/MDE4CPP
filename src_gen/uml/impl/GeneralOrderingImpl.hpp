...
namespace uml 
{
	class GeneralOrderingImpl :virtual public NamedElementImpl, virtual public GeneralOrdering
	{
		...
		public:
			...
			virtual uml::OccurrenceSpecification *  getAfter() const ;
			
			/*!
			 The OccurrenceSpecification referenced comes after the OccurrenceSpecification referenced by before.
			<p>From package UML::Interactions.</p> */
			virtual void setAfter(uml::OccurrenceSpecification *  _after) ;
			
			/*!
			 The OccurrenceSpecification referenced comes before the OccurrenceSpecification referenced by after.
			<p>From package UML::Interactions.</p> */
			virtual uml::OccurrenceSpecification *  getBefore() const ;
			
			/*!
			 The OccurrenceSpecification referenced comes before the OccurrenceSpecification referenced by after.
			<p>From package UML::Interactions.</p> */
			virtual void setBefore(uml::OccurrenceSpecification *  _before) ;
