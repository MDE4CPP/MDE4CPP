...
#include "ParameterEffectKind.hpp"
...
namespace uml 
{
	...
	class Parameter:virtual public ConnectableElement,virtual public MultiplicityElement	{
		...
		public:
			...
			<p>From package UML::Classification.</p> */
			virtual std::vector<uml::ParameterSet * > *  getParameterSet() const = 0;
		...
		protected:
			...
			/*!
			 The ParameterSets containing the parameter. See ParameterSet.
			<p>From package UML::Classification.</p> */
			std::vector<uml::ParameterSet * > *  m_parameterSet =  nullptr ;
