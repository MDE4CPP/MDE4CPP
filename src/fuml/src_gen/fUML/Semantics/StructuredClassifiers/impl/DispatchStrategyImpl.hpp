...
namespace fUML::Semantics::StructuredClassifiers 
{
	class FUML_API DispatchStrategyImpl : virtual public fUML::Semantics::Loci::SemanticStrategyImpl, virtual public DispatchStrategy 
	{
		...
		public:
			...
			// Operations
			//*********************************
			virtual std::shared_ptr<fUML::Semantics::CommonBehavior::Execution> dispatch(const std::shared_ptr<fUML::Semantics::StructuredClassifiers::Object>& object, const std::shared_ptr<uml::Operation>& operation) ;
