...
//*********************************
bool
 ValueSpecificationActionImpl::compatible_type(boost::any diagnostics,std::map <   boost::any, boost::any >  context) 
{
...
bool
 ValueSpecificationActionImpl::multiplicity(boost::any diagnostics,std::map <   boost::any, boost::any >  context) 
{
	std::cout << __PRETTY_FUNCTION__  << std::endl;
	throw "UnsupportedOperationException";
}
		...
		std::shared_ptr<Union<uml::Element> > ValueSpecificationActionImpl::getOwnedElement() const
{
 ...
 ValueSpecificationActionImpl::getOutput() const
{
	return m_output;
}
