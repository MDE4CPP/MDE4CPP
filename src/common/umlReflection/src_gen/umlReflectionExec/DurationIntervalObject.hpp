...
#ifndef UML_DURATIONINTERVAL_EXECUTION_HPP
#define UML_DURATIONINTERVAL_EXECUTION_HPP
...
namespace UML 
{
	class DurationIntervalObject : virtual public UML::IntervalObject
	{
		public:
		    //constructors
		    DurationIntervalObject(DurationIntervalObject &obj);
		    DurationIntervalObject(std::shared_ptr<uml::DurationInterval>);
		 	DurationIntervalObject();
		    //destructor
		    virtual ~DurationIntervalObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			DurationIntervalObject& operator=(DurationIntervalObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::DurationInterval> getDurationIntervalValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setDurationIntervalValue(std::shared_ptr<uml::DurationInterval>);
			virtual void setThisDurationIntervalObjectPtr(std::weak_ptr<DurationIntervalObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::DurationInterval> m_DurationIntervalValue = nullptr;
	};
}
#endif /* end of include guard: UML_DURATIONINTERVAL_OBJECT_HPP */
