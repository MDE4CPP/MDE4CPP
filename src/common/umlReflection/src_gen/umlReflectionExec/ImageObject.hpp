...
#ifndef UML_IMAGE_EXECUTION_HPP
#define UML_IMAGE_EXECUTION_HPP
...
namespace UML 
{
	class ImageObject : virtual public UML::ElementObject
	{
		public:
		    //constructors
		    ImageObject(ImageObject &obj);
		    ImageObject(std::shared_ptr<uml::Image>);
		 	ImageObject();
		    //destructor
		    virtual ~ImageObject();
			...
			virtual std::shared_ptr<uml::Image> getImageValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setImageValue(std::shared_ptr<uml::Image>);
			virtual void setThisImageObjectPtr(std::weak_ptr<ImageObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Image> m_ImageValue = nullptr;
	};
}
#endif /* end of include guard: UML_IMAGE_OBJECT_HPP */
