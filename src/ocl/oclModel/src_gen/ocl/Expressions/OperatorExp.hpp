...
namespace ocl::Expressions 
{
	...
	class OCL_API OperatorExp : virtual public OclExpression
	{
		...
		public:
			...
			//*********************************
			virtual const std::shared_ptr<ocl::Expressions::OclExpression>& getLeftHandOperand() const = 0;
			virtual void setLeftHandOperand(const std::shared_ptr<ocl::Expressions::OclExpression>&) = 0;
			virtual const std::shared_ptr<ocl::Expressions::OclExpression>& getRightHandOperand() const = 0;
			virtual void setRightHandOperand(const std::shared_ptr<ocl::Expressions::OclExpression>&) = 0;
