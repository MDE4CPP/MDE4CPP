...
#ifndef UML_ACTIVITYFINALNODE_EXECUTION_HPP
#define UML_ACTIVITYFINALNODE_EXECUTION_HPP
...
namespace UML 
{
	class ActivityFinalNodeObject : virtual public UML::FinalNodeObject
	{
		public:
		    //constructors
		    ActivityFinalNodeObject(ActivityFinalNodeObject &obj);
		    ActivityFinalNodeObject(std::shared_ptr<uml::ActivityFinalNode>);
		 	ActivityFinalNodeObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::ActivityFinalNode> getActivityFinalNodeValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setActivityFinalNodeValue(std::shared_ptr<uml::ActivityFinalNode>);
			virtual void setThisActivityFinalNodeObjectPtr(std::weak_ptr<ActivityFinalNodeObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ActivityFinalNode> m_ActivityFinalNodeValue = nullptr;
	};
}
#endif /* end of include guard: UML_ACTIVITYFINALNODE_OBJECT_HPP */
