...
#ifndef UML_CREATEOBJECTACTION_EXECUTION_HPP
#define UML_CREATEOBJECTACTION_EXECUTION_HPP
...
namespace UML 
{
	class CreateObjectActionObject : virtual public UML::ActionObject
	{
		public:
		    //constructors
		    CreateObjectActionObject(CreateObjectActionObject &obj);
		    CreateObjectActionObject(std::shared_ptr<uml::CreateObjectAction>);
		 	CreateObjectActionObject();
		    //destructor
		    virtual ~CreateObjectActionObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			CreateObjectActionObject& operator=(CreateObjectActionObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::CreateObjectAction> getCreateObjectActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setCreateObjectActionValue(std::shared_ptr<uml::CreateObjectAction>);
			virtual void setThisCreateObjectActionObjectPtr(std::weak_ptr<CreateObjectActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::CreateObjectAction> m_CreateObjectActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_CREATEOBJECTACTION_OBJECT_HPP */
