...
namespace ocl::Expressions 
{
	class OCL_API StateExpImpl : virtual public OclExpressionImpl, virtual public StateExp 
	{
		...
		protected:
			...
			//Additional constructors for the containments back reference
			//Additional constructors for the containments back reference
			StateExpImpl(std::weak_ptr<ocl::Expressions::LoopExp> par_LoopExp, const int reference_id);
			//Additional constructors for the containments back reference
			//Additional constructors for the containments back reference
		...
		public:
			...
			//*********************************
			virtual const std::shared_ptr<ecore::EObject>& getReferredState() const ;
			virtual void setReferredState(const std::shared_ptr<ecore::EObject>&) ;
