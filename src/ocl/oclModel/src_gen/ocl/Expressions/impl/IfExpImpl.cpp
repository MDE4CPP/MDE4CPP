...
bool IfExpImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::IFEXP_ATTRIBUTE_CONDITION:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> IfExpImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
