...
namespace uml 
{
	...
	class JoinNode:virtual public ControlNode	{
		...
		public:
			...
			outgoing->size() = 1 */ 
			virtual bool
			 one_outgoing_edge(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 incoming_object_flow(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
