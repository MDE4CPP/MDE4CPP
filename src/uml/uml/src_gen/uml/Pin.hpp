	...
	class UML_API Pin : virtual public MultiplicityElement, virtual public ObjectNode
	{
		...
		public:
			...
			*/
			...
			virtual bool control_pins(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			Pin multiplicity is not unique.
			not isUnique
			*/
			 
			virtual bool not_unique(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
