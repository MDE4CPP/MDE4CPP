...
#ifndef FUML_SEMANTICS_LOCI_EXECUTIONFACTORYL2EXECUTIONFACTORYL2IMPL_HPP
#define FUML_SEMANTICS_LOCI_EXECUTIONFACTORYL2EXECUTIONFACTORYL2IMPL_HPP
...
namespace fUML::Semantics::Loci 
{
	class ExecutionFactoryL2Impl :virtual public ExecutionFactoryL1Impl, virtual public ExecutionFactoryL2 
	{
		...
		protected:
			...
			ExecutionFactoryL2Impl(std::weak_ptr<fUML::Semantics::Loci::Locus > par_locus);
...
#endif /* end of include guard: FUML_SEMANTICS_LOCI_EXECUTIONFACTORYL2EXECUTIONFACTORYL2IMPL_HPP */
