...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> LinkEndCreationDataObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Subset<uml::Comment, uml::Element>> ownedCommentList = m_LinkEndCreationDataValue->getOwnedComment();
	...
	{
		std::shared_ptr<Union<uml::Element>> ownedElementList = m_LinkEndCreationDataValue->getOwnedElement();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_LinkEndData_qualifier())
	{
		std::shared_ptr<Subset<uml::QualifierValue, uml::Element>> qualifierList = m_LinkEndCreationDataValue->getQualifier();
