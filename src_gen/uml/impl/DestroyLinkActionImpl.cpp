...
// Union Getter
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::ActivityGroup>>> DestroyLinkActionImpl::getInGroup() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> DestroyLinkActionImpl::getOwnedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::InputPin>>> DestroyLinkActionImpl::getInput() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> DestroyLinkActionImpl::getRedefinedElement() const
{
