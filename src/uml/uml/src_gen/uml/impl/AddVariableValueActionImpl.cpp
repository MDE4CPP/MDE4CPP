...
bool AddVariableValueActionImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::ADDVARIABLEVALUEACTION_ATTRIBUTE_INSERTAT:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> AddVariableValueActionImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
  	...
  	switch(operationID)
	{
		...
		case umlPackage::ADDVARIABLEVALUEACTION_OPERATION_INSERTAT_PIN_EDIAGNOSTICCHAIN_EMAP:
		{
			...
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for parameter 'diagnostics'. Failed to invoke operation 'insertAt_pin'!")
				return nullptr;
			}
			...
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for parameter 'context'. Failed to invoke operation 'insertAt_pin'!")
				return nullptr;
			}
		...
		case umlPackage::ADDVARIABLEVALUEACTION_OPERATION_REQUIRED_VALUE_EDIAGNOSTICCHAIN_EMAP:
		{
			...
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for parameter 'diagnostics'. Failed to invoke operation 'required_value'!")
				return nullptr;
			}
			...
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for parameter 'context'. Failed to invoke operation 'required_value'!")
				return nullptr;
			}
