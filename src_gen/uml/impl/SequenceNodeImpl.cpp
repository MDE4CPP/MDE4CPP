...
//Additional constructor for the containments back reference
			SequenceNodeImpl::SequenceNodeImpl(std::shared_ptr<uml::Activity > par_Activity, const int reference_id)
			:SequenceNodeImpl()
			{
				switch(reference_id)
				{	
...
//Additional constructor for the containments back reference
			SequenceNodeImpl::SequenceNodeImpl(std::shared_ptr<uml::Namespace > par_namespace)
			:SequenceNodeImpl()
			{
...
//Additional constructor for the containments back reference
			SequenceNodeImpl::SequenceNodeImpl(std::shared_ptr<uml::ActivityGroup > par_superGroup)
			:SequenceNodeImpl()
			{
...
SequenceNodeImpl::SequenceNodeImpl(const SequenceNodeImpl & obj):SequenceNodeImpl()
{
	...
	{
		this->getExecutableNode()->add(std::shared_ptr<uml::ExecutableNode>(dynamic_cast<uml::ExecutableNode*>(_executableNode->copy())));
	}
	#ifdef SHOW_SUBSET_UNION
