...
CallImpl::CallImpl()
{
	...
	*/
	...
	//getter init
		//Property base_Usage
		m_getterMap.insert(std::pair<long long,std::function<Any()>>(803516267,[this](){ return eAny(this->getBase_Usage(), uml::umlPackage::USAGE_CLASS, false);}));
	
	
	//setter init
	//Property base_Usage
		m_setterMap.insert(std::pair<long long,std::function<void(Any)>>(803516267,[this](Any object){this->setBase_Usage(object->get<std::shared_ptr<uml::Usage>>());}));
	
	
	//unsetter init
		//Property base_Usage
		m_unsetterMap.insert(std::pair<long long,std::function<void()>>(803516267,[this](){m_base_Usage = std::shared_ptr<uml::Usage>(nullptr);}));
...
Any CallImpl::get(long long _uID) const
{
...
void CallImpl::set(long long _uID, Any value)
{
...
void CallImpl::unset(long long _uID)
{
...
Any CallImpl::invoke(long long _uID, std::shared_ptr<Bag<Any>> _arguments)
{
