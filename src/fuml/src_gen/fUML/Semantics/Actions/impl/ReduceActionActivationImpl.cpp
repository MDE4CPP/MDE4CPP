...
Any ReduceActionActivationImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
		case fUML::FUMLPackage::REDUCEACTIONACTIVATION_ATTRIBUTE_CURRENTEXECUTION:
			return eAny(std::dynamic_pointer_cast<ecore::EObject>(getCurrentExecution())); //10110
	}
...
bool ReduceActionActivationImpl::internalEIsSet(int featureID) const
{
	...
	{
		case fUML::FUMLPackage::REDUCEACTIONACTIVATION_ATTRIBUTE_CURRENTEXECUTION:
			return getCurrentExecution() != nullptr; //10110
	}
...
bool ReduceActionActivationImpl::eSet(int featureID, Any newValue)
{
	switch(featureID)
	{
		case fUML::FUMLPackage::REDUCEACTIONACTIVATION_ATTRIBUTE_CURRENTEXECUTION:
		{
			...
			setCurrentExecution(_currentExecution); //10110
			return true;
		}
	}
