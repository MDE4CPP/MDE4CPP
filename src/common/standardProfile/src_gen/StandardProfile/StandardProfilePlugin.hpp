...
#ifndef STANDARDPROFILE_PLUGIN_HPP
#define STANDARDPROFILE_PLUGIN_HPP

#include "pluginFramework/UMLModelPlugin.hpp"

namespace StandardProfile
{
	class StandardProfilePlugin : virtual public UMLModelPlugin
	{
		public:
		...
		protected:
			StandardProfilePlugin(){};
			virtual ~StandardProfilePlugin(){};
	};
}
#endif /* end of include guard: STANDARDPROFILE_PLUGIN_HPP */
