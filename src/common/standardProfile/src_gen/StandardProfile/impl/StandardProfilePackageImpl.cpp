...
{
	standardProfile_Auxiliary = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::AUXILIARY_CLASS);
	standardProfile_Auxiliary->setName("Auxiliary");
	standardProfile_Auxiliary->setIsAbstract(false);
	standardProfile_Auxiliary_base_Class = factory->createProperty_in_Class(standardProfile_Auxiliary);
	

	standardProfile_BuildComponent = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::BUILDCOMPONENT_CLASS);
	standardProfile_BuildComponent->setName("BuildComponent");
	standardProfile_BuildComponent->setIsAbstract(false);
	standardProfile_BuildComponent_base_Component = factory->createProperty_in_Class(standardProfile_BuildComponent);
	

	standardProfile_Call = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::CALL_CLASS);
	standardProfile_Call->setName("Call");
	standardProfile_Call->setIsAbstract(false);
	standardProfile_Call_base_Usage = factory->createProperty_in_Class(standardProfile_Call);
	

	standardProfile_Create = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::CREATE_CLASS);
	standardProfile_Create->setName("Create");
	standardProfile_Create->setIsAbstract(false);
	standardProfile_Create_base_BehavioralFeature = factory->createProperty_in_Class(standardProfile_Create);standardProfile_Create_base_Usage = factory->createProperty_in_Class(standardProfile_Create);
	

	standardProfile_Derive = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::DERIVE_CLASS);
	standardProfile_Derive->setName("Derive");
	standardProfile_Derive->setIsAbstract(false);
	standardProfile_Derive_base_Abstraction = factory->createProperty_in_Class(standardProfile_Derive);
	

	standardProfile_Destroy = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::DESTROY_CLASS);
	standardProfile_Destroy->setName("Destroy");
	standardProfile_Destroy->setIsAbstract(false);
	standardProfile_Destroy_base_BehavioralFeature = factory->createProperty_in_Class(standardProfile_Destroy);
	

	standardProfile_Document = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::DOCUMENT_CLASS);
	standardProfile_Document->setName("Document");
	standardProfile_Document->setIsAbstract(false);
	standardProfile_Document_base_Artifact = factory->createProperty_in_Class(standardProfile_Document);
	

	standardProfile_Entity = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::ENTITY_CLASS);
	standardProfile_Entity->setName("Entity");
	standardProfile_Entity->setIsAbstract(false);
	standardProfile_Entity_base_Component = factory->createProperty_in_Class(standardProfile_Entity);
	

	standardProfile_Executable = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::EXECUTABLE_CLASS);
	standardProfile_Executable->setName("Executable");
	standardProfile_Executable->setIsAbstract(false);
	standardProfile_Executable_base_Artifact = factory->createProperty_in_Class(standardProfile_Executable);
	

	standardProfile_File = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::FILE_CLASS);
	standardProfile_File->setName("File");
	standardProfile_File->setIsAbstract(false);
	standardProfile_File_base_Artifact = factory->createProperty_in_Class(standardProfile_File);
	

	standardProfile_Focus = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::FOCUS_CLASS);
	standardProfile_Focus->setName("Focus");
	standardProfile_Focus->setIsAbstract(false);
	standardProfile_Focus_base_Class = factory->createProperty_in_Class(standardProfile_Focus);
	

	standardProfile_Framework = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::FRAMEWORK_CLASS);
	standardProfile_Framework->setName("Framework");
	standardProfile_Framework->setIsAbstract(false);
	standardProfile_Framework_base_Package = factory->createProperty_in_Class(standardProfile_Framework);
	

	standardProfile_Implement = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::IMPLEMENT_CLASS);
	standardProfile_Implement->setName("Implement");
	standardProfile_Implement->setIsAbstract(false);
	standardProfile_Implement_base_Component = factory->createProperty_in_Class(standardProfile_Implement);
	

	standardProfile_ImplementationClass = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::IMPLEMENTATIONCLASS_CLASS);
	standardProfile_ImplementationClass->setName("ImplementationClass");
	standardProfile_ImplementationClass->setIsAbstract(false);
	standardProfile_ImplementationClass_base_Class = factory->createProperty_in_Class(standardProfile_ImplementationClass);
	

	standardProfile_Instantiate = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::INSTANTIATE_CLASS);
	standardProfile_Instantiate->setName("Instantiate");
	standardProfile_Instantiate->setIsAbstract(false);
	standardProfile_Instantiate_base_Usage = factory->createProperty_in_Class(standardProfile_Instantiate);
	

	standardProfile_Library = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::LIBRARY_CLASS);
	standardProfile_Library->setName("Library");
	standardProfile_Library->setIsAbstract(false);
	standardProfile_Library_base_Artifact = factory->createProperty_in_Class(standardProfile_Library);
	

	standardProfile_Metaclass = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::METACLASS_CLASS);
	standardProfile_Metaclass->setName("Metaclass");
	standardProfile_Metaclass->setIsAbstract(false);
	standardProfile_Metaclass_base_Class = factory->createProperty_in_Class(standardProfile_Metaclass);
	

	standardProfile_Metamodel = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::METAMODEL_CLASS);
	standardProfile_Metamodel->setName("Metamodel");
	standardProfile_Metamodel->setIsAbstract(false);
	standardProfile_Metamodel_base_Model = factory->createProperty_in_Class(standardProfile_Metamodel);
	

	standardProfile_ModelLibrary = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::MODELLIBRARY_CLASS);
	standardProfile_ModelLibrary->setName("ModelLibrary");
	standardProfile_ModelLibrary->setIsAbstract(false);
	standardProfile_ModelLibrary_base_Package = factory->createProperty_in_Class(standardProfile_ModelLibrary);
	

	standardProfile_Process = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::PROCESS_CLASS);
	standardProfile_Process->setName("Process");
	standardProfile_Process->setIsAbstract(false);
	standardProfile_Process_base_Component = factory->createProperty_in_Class(standardProfile_Process);
	

	standardProfile_Realization = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::REALIZATION_CLASS);
	standardProfile_Realization->setName("Realization");
	standardProfile_Realization->setIsAbstract(false);
	standardProfile_Realization_base_Classifier = factory->createProperty_in_Class(standardProfile_Realization);
	

	standardProfile_Refine = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::REFINE_CLASS);
	standardProfile_Refine->setName("Refine");
	standardProfile_Refine->setIsAbstract(false);
	standardProfile_Refine_base_Abstraction = factory->createProperty_in_Class(standardProfile_Refine);
	

	standardProfile_Responsibility = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::RESPONSIBILITY_CLASS);
	standardProfile_Responsibility->setName("Responsibility");
	standardProfile_Responsibility->setIsAbstract(false);
	standardProfile_Responsibility_base_Usage = factory->createProperty_in_Class(standardProfile_Responsibility);
	

	standardProfile_Script = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::SCRIPT_CLASS);
	standardProfile_Script->setName("Script");
	standardProfile_Script->setIsAbstract(false);
	standardProfile_Script_base_Artifact = factory->createProperty_in_Class(standardProfile_Script);
	

	standardProfile_Send = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::SEND_CLASS);
	standardProfile_Send->setName("Send");
	standardProfile_Send->setIsAbstract(false);
	standardProfile_Send_base_Usage = factory->createProperty_in_Class(standardProfile_Send);
	

	standardProfile_Service = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::SERVICE_CLASS);
	standardProfile_Service->setName("Service");
	standardProfile_Service->setIsAbstract(false);
	standardProfile_Service_base_Component = factory->createProperty_in_Class(standardProfile_Service);
	

	standardProfile_Source = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::SOURCE_CLASS);
	standardProfile_Source->setName("Source");
	standardProfile_Source->setIsAbstract(false);
	standardProfile_Source_base_Artifact = factory->createProperty_in_Class(standardProfile_Source);
	

	standardProfile_Specification = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::SPECIFICATION_CLASS);
	standardProfile_Specification->setName("Specification");
	standardProfile_Specification->setIsAbstract(false);
	standardProfile_Specification_base_Classifier = factory->createProperty_in_Class(standardProfile_Specification);
	

	standardProfile_Subsystem = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::SUBSYSTEM_CLASS);
	standardProfile_Subsystem->setName("Subsystem");
	standardProfile_Subsystem->setIsAbstract(false);
	standardProfile_Subsystem_base_Component = factory->createProperty_in_Class(standardProfile_Subsystem);
	

	standardProfile_SystemModel = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::SYSTEMMODEL_CLASS);
	standardProfile_SystemModel->setName("SystemModel");
	standardProfile_SystemModel->setIsAbstract(false);
	standardProfile_SystemModel_base_Model = factory->createProperty_in_Class(standardProfile_SystemModel);
	

	standardProfile_Trace = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::TRACE_CLASS);
	standardProfile_Trace->setName("Trace");
	standardProfile_Trace->setIsAbstract(false);
	standardProfile_Trace_base_Abstraction = factory->createProperty_in_Class(standardProfile_Trace);
	

	standardProfile_Type = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::TYPE_CLASS);
	standardProfile_Type->setName("Type");
	standardProfile_Type->setIsAbstract(false);
	standardProfile_Type_base_Class = factory->createProperty_in_Class(standardProfile_Type);
	

	standardProfile_Utility = factory->createStereotype_in_Package(standardProfile, StandardProfile::StandardProfilePackage::UTILITY_CLASS);
	standardProfile_Utility->setName("Utility");
	standardProfile_Utility->setIsAbstract(false);
	standardProfile_Utility_base_Class = factory->createProperty_in_Class(standardProfile_Utility);
...
{
	extensionEnd_extension_Auxiliary_StandardProfile_Auxiliary_lowerValue_LiteralInteger_ExtensionEnd_extension_Auxiliary_StandardProfile_Auxiliary = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Auxiliary_StandardProfile_Auxiliary);
	
	extensionEnd_extension_BehavioralFeature_Create_StandardProfile_Create_lowerValue_LiteralInteger_ExtensionEnd_extension_BehavioralFeature_Create_StandardProfile_Create = factory->createLiteralInteger_in_Owner(extensionEnd_extension_BehavioralFeature_Create_StandardProfile_Create);
	
	extensionEnd_extension_BuildComponent_StandardProfile_BuildComponent_lowerValue_LiteralInteger_ExtensionEnd_extension_BuildComponent_StandardProfile_BuildComponent = factory->createLiteralInteger_in_Owner(extensionEnd_extension_BuildComponent_StandardProfile_BuildComponent);
	
	extensionEnd_extension_Call_StandardProfile_Call_lowerValue_LiteralInteger_ExtensionEnd_extension_Call_StandardProfile_Call = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Call_StandardProfile_Call);
	
	extensionEnd_extension_Derive_StandardProfile_Derive_lowerValue_LiteralInteger_ExtensionEnd_extension_Derive_StandardProfile_Derive = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Derive_StandardProfile_Derive);
	
	extensionEnd_extension_Destroy_StandardProfile_Destroy_lowerValue_LiteralInteger_ExtensionEnd_extension_Destroy_StandardProfile_Destroy = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Destroy_StandardProfile_Destroy);
	
	extensionEnd_extension_Document_StandardProfile_Document_lowerValue_LiteralInteger_ExtensionEnd_extension_Document_StandardProfile_Document = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Document_StandardProfile_Document);
	
	extensionEnd_extension_Entity_StandardProfile_Entity_lowerValue_LiteralInteger_ExtensionEnd_extension_Entity_StandardProfile_Entity = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Entity_StandardProfile_Entity);
	
	extensionEnd_extension_Executable_StandardProfile_Executable_lowerValue_LiteralInteger_ExtensionEnd_extension_Executable_StandardProfile_Executable = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Executable_StandardProfile_Executable);
	
	extensionEnd_extension_File_StandardProfile_File_lowerValue_LiteralInteger_ExtensionEnd_extension_File_StandardProfile_File = factory->createLiteralInteger_in_Owner(extensionEnd_extension_File_StandardProfile_File);
	
	extensionEnd_extension_Focus_StandardProfile_Focus_lowerValue_LiteralInteger_ExtensionEnd_extension_Focus_StandardProfile_Focus = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Focus_StandardProfile_Focus);
	
	extensionEnd_extension_Framework_StandardProfile_Framework_lowerValue_LiteralInteger_ExtensionEnd_extension_Framework_StandardProfile_Framework = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Framework_StandardProfile_Framework);
	
	extensionEnd_extension_Implement_StandardProfile_Implement_lowerValue_LiteralInteger_ExtensionEnd_extension_Implement_StandardProfile_Implement = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Implement_StandardProfile_Implement);
	
	extensionEnd_extension_ImplementationClass_StandardProfile_ImplementationClass_lowerValue_LiteralInteger_ExtensionEnd_extension_ImplementationClass_StandardProfile_ImplementationClass = factory->createLiteralInteger_in_Owner(extensionEnd_extension_ImplementationClass_StandardProfile_ImplementationClass);
	
	extensionEnd_extension_Instantiate_StandardProfile_Instantiate_lowerValue_LiteralInteger_ExtensionEnd_extension_Instantiate_StandardProfile_Instantiate = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Instantiate_StandardProfile_Instantiate);
	
	extensionEnd_extension_Library_StandardProfile_Library_lowerValue_LiteralInteger_ExtensionEnd_extension_Library_StandardProfile_Library = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Library_StandardProfile_Library);
	
	extensionEnd_extension_Metaclass_StandardProfile_Metaclass_lowerValue_LiteralInteger_ExtensionEnd_extension_Metaclass_StandardProfile_Metaclass = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Metaclass_StandardProfile_Metaclass);
	
	extensionEnd_extension_Metamodel_StandardProfile_Metamodel_lowerValue_LiteralInteger_ExtensionEnd_extension_Metamodel_StandardProfile_Metamodel = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Metamodel_StandardProfile_Metamodel);
	
	extensionEnd_extension_ModelLibrary_StandardProfile_ModelLibrary_lowerValue_LiteralInteger_ExtensionEnd_extension_ModelLibrary_StandardProfile_ModelLibrary = factory->createLiteralInteger_in_Owner(extensionEnd_extension_ModelLibrary_StandardProfile_ModelLibrary);
	
	extensionEnd_extension_Process_StandardProfile_Process_lowerValue_LiteralInteger_ExtensionEnd_extension_Process_StandardProfile_Process = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Process_StandardProfile_Process);
	
	extensionEnd_extension_Realization_StandardProfile_Realization_lowerValue_LiteralInteger_ExtensionEnd_extension_Realization_StandardProfile_Realization = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Realization_StandardProfile_Realization);
	
	extensionEnd_extension_Refine_StandardProfile_Refine_lowerValue_LiteralInteger_ExtensionEnd_extension_Refine_StandardProfile_Refine = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Refine_StandardProfile_Refine);
	
	extensionEnd_extension_Responsibility_StandardProfile_Responsibility_lowerValue_LiteralInteger_ExtensionEnd_extension_Responsibility_StandardProfile_Responsibility = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Responsibility_StandardProfile_Responsibility);
	
	extensionEnd_extension_Script_StandardProfile_Script_lowerValue_LiteralInteger_ExtensionEnd_extension_Script_StandardProfile_Script = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Script_StandardProfile_Script);
	
	extensionEnd_extension_Send_StandardProfile_Send_lowerValue_LiteralInteger_ExtensionEnd_extension_Send_StandardProfile_Send = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Send_StandardProfile_Send);
	
	extensionEnd_extension_Service_StandardProfile_Service_lowerValue_LiteralInteger_ExtensionEnd_extension_Service_StandardProfile_Service = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Service_StandardProfile_Service);
	
	extensionEnd_extension_Source_StandardProfile_Source_lowerValue_LiteralInteger_ExtensionEnd_extension_Source_StandardProfile_Source = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Source_StandardProfile_Source);
	
	extensionEnd_extension_Specification_StandardProfile_Specification_lowerValue_LiteralInteger_ExtensionEnd_extension_Specification_StandardProfile_Specification = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Specification_StandardProfile_Specification);
	
	extensionEnd_extension_Subsystem_StandardProfile_Subsystem_lowerValue_LiteralInteger_ExtensionEnd_extension_Subsystem_StandardProfile_Subsystem = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Subsystem_StandardProfile_Subsystem);
	
	extensionEnd_extension_SystemModel_StandardProfile_SystemModel_lowerValue_LiteralInteger_ExtensionEnd_extension_SystemModel_StandardProfile_SystemModel = factory->createLiteralInteger_in_Owner(extensionEnd_extension_SystemModel_StandardProfile_SystemModel);
	
	extensionEnd_extension_Trace_StandardProfile_Trace_lowerValue_LiteralInteger_ExtensionEnd_extension_Trace_StandardProfile_Trace = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Trace_StandardProfile_Trace);
	
	extensionEnd_extension_Type_StandardProfile_Type_lowerValue_LiteralInteger_ExtensionEnd_extension_Type_StandardProfile_Type = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Type_StandardProfile_Type);
	
	extensionEnd_extension_Usage_Create_StandardProfile_Create_lowerValue_LiteralInteger_ExtensionEnd_extension_Usage_Create_StandardProfile_Create = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Usage_Create_StandardProfile_Create);
	
	extensionEnd_extension_Utility_StandardProfile_Utility_lowerValue_LiteralInteger_ExtensionEnd_extension_Utility_StandardProfile_Utility = factory->createLiteralInteger_in_Owner(extensionEnd_extension_Utility_StandardProfile_Utility);
