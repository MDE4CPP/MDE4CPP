...
namespace PSCS::MDE4CPP_Extensions 
{
	class PSCS_API MDE4CPP_ExtensionsFactory : virtual public ecore::EFactory 
	{
		...
		protected:
			...
			virtual std::shared_ptr<PSCS::MDE4CPP_Extensions::MDE4CPP_ConstructStrategy> createMDE4CPP_ConstructStrategy(const int metaElementID = MDE4CPP_ExtensionsPackage::MDE4CPP_CONSTRUCTSTRATEGY_CLASS) const = 0;
