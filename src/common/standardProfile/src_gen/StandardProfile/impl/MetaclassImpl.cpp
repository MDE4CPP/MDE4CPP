...
MetaclassImpl::MetaclassImpl()
{
	...
	*/
	...
	//getter init
		//Property base_Class
		m_getterMap.insert(std::pair<long long,std::function<Any()>>(1215377267,[this](){ return eAny(this->getBase_Class(), uml::umlPackage::CLASS_CLASS, false);}));
	
	
	//setter init
	//Property base_Class
		m_setterMap.insert(std::pair<long long,std::function<void(Any)>>(1215377267,[this](Any object){this->setBase_Class(object->get<std::shared_ptr<uml::Class>>());}));
	
	
	//unsetter init
		//Property base_Class
		m_unsetterMap.insert(std::pair<long long,std::function<void()>>(1215377267,[this](){m_base_Class = std::shared_ptr<uml::Class>(nullptr);}));
...
Any MetaclassImpl::get(long long _uID) const
{
...
void MetaclassImpl::set(std::string _qualifiedName, Any value)
{
	long long uID = util::Util::polynomialRollingHash(_qualifiedName);
    this->set(uID, value);
}

void MetaclassImpl::set(long long _uID, Any value)
{
...
void MetaclassImpl::unset(long long _uID)
{
...
//*********************************
//Invoke
Any MetaclassImpl::invoke(std::shared_ptr<uml::Operation> _operation, std::shared_ptr<Bag<Any>> _arguments)
{
...
Any MetaclassImpl::invoke(std::string _qualifiedName, std::shared_ptr<Bag<Any>> _arguments)
{
	long long uID = util::Util::polynomialRollingHash(_qualifiedName);
    return this->invoke(uID, _arguments);
}

Any MetaclassImpl::invoke(long long _uID, std::shared_ptr<Bag<Any>> _arguments)
{
