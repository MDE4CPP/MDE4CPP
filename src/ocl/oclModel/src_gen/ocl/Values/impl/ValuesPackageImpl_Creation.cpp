...
void ValuesPackageImpl::createCollectionValueContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_collectionValue_Attribute_elements = factory->createEReference_as_eStructuralFeatures_in_EClass(m_collectionValue_Class, COLLECTIONVALUE_ATTRIBUTE_ELEMENTS);m_collectionValue_Attribute_model = factory->createEReference_as_eStructuralFeatures_in_EClass(m_collectionValue_Class, COLLECTIONVALUE_ATTRIBUTE_MODEL);
...
void ValuesPackageImpl::createLocalSnapshotContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_localSnapshot_Attribute_isPost = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_localSnapshot_Class, LOCALSNAPSHOT_ATTRIBUTE_ISPOST);m_localSnapshot_Attribute_isPre = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_localSnapshot_Class, LOCALSNAPSHOT_ATTRIBUTE_ISPRE);
	m_localSnapshot_Attribute_bindings = factory->createEReference_as_eStructuralFeatures_in_EClass(m_localSnapshot_Class, LOCALSNAPSHOT_ATTRIBUTE_BINDINGS);m_localSnapshot_Attribute_inputQ = factory->createEReference_as_eStructuralFeatures_in_EClass(m_localSnapshot_Class, LOCALSNAPSHOT_ATTRIBUTE_INPUTQ);m_localSnapshot_Attribute_outputQ = factory->createEReference_as_eStructuralFeatures_in_EClass(m_localSnapshot_Class, LOCALSNAPSHOT_ATTRIBUTE_OUTPUTQ);m_localSnapshot_Attribute_pred = factory->createEReference_as_eStructuralFeatures_in_EClass(m_localSnapshot_Class, LOCALSNAPSHOT_ATTRIBUTE_PRED);m_localSnapshot_Attribute_succ = factory->createEReference_as_eStructuralFeatures_in_EClass(m_localSnapshot_Class, LOCALSNAPSHOT_ATTRIBUTE_SUCC);
...
void ValuesPackageImpl::createObjectValueContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_objectValue_Attribute_history = factory->createEReference_as_eStructuralFeatures_in_EClass(m_objectValue_Class, OBJECTVALUE_ATTRIBUTE_HISTORY);m_objectValue_Attribute_value = factory->createEReference_as_eStructuralFeatures_in_EClass(m_objectValue_Class, OBJECTVALUE_ATTRIBUTE_VALUE);
...
void ValuesPackageImpl::createOclMessageValueContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_oclMessageValue_Attribute_isAsyncOperation = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_oclMessageValue_Class, OCLMESSAGEVALUE_ATTRIBUTE_ISASYNCOPERATION);m_oclMessageValue_Attribute_isSignal = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_oclMessageValue_Class, OCLMESSAGEVALUE_ATTRIBUTE_ISSIGNAL);m_oclMessageValue_Attribute_isSyncOperation = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_oclMessageValue_Class, OCLMESSAGEVALUE_ATTRIBUTE_ISSYNCOPERATION);m_oclMessageValue_Attribute_name = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_oclMessageValue_Class, OCLMESSAGEVALUE_ATTRIBUTE_NAME);
	m_oclMessageValue_Attribute_arguments = factory->createEReference_as_eStructuralFeatures_in_EClass(m_oclMessageValue_Class, OCLMESSAGEVALUE_ATTRIBUTE_ARGUMENTS);m_oclMessageValue_Attribute_returnMessage = factory->createEReference_as_eStructuralFeatures_in_EClass(m_oclMessageValue_Class, OCLMESSAGEVALUE_ATTRIBUTE_RETURNMESSAGE);m_oclMessageValue_Attribute_source = factory->createEReference_as_eStructuralFeatures_in_EClass(m_oclMessageValue_Class, OCLMESSAGEVALUE_ATTRIBUTE_SOURCE);m_oclMessageValue_Attribute_target = factory->createEReference_as_eStructuralFeatures_in_EClass(m_oclMessageValue_Class, OCLMESSAGEVALUE_ATTRIBUTE_TARGET);
...
void ValuesPackageImpl::createTupleValueContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_tupleValue_Attribute_elements = factory->createEReference_as_eStructuralFeatures_in_EClass(m_tupleValue_Class, TUPLEVALUE_ATTRIBUTE_ELEMENTS);m_tupleValue_Attribute_model = factory->createEReference_as_eStructuralFeatures_in_EClass(m_tupleValue_Class, TUPLEVALUE_ATTRIBUTE_MODEL);
