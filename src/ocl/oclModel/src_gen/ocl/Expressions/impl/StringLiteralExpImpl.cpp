...
StringLiteralExpImpl& StringLiteralExpImpl::operator=(const StringLiteralExpImpl & obj)
{
	 ...
	 * Currently, this causes an error because it calls an implicit assignment operator of StringLiteralExp 
	 * which is generated by the compiler (as StringLiteralExp is an abstract class and does not have a user-defined assignment operator).
...
//*********************************
std::shared_ptr<Any> StringLiteralExpImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::STRINGLITERALEXP_ATTRIBUTE_STRINGSYMBOL:
			return eAny(getStringSymbol(),ecore::ecorePackage::ESTRING_CLASS,false); //8024
	}
...
bool StringLiteralExpImpl::internalEIsSet(int featureID) const
{
	...
	{
		case ocl::Expressions::ExpressionsPackage::STRINGLITERALEXP_ATTRIBUTE_STRINGSYMBOL:
			return getStringSymbol() != ""; //8024
	}
	return PrimitiveLiteralExpImpl::internalEIsSet(featureID);
}

bool StringLiteralExpImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::STRINGLITERALEXP_ATTRIBUTE_STRINGSYMBOL:
		{
			try
			{
				...
				setStringSymbol(_stringSymbol); //8024
			}
			catch(...)
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for feature 'stringSymbol'. Failed to set feature!")
				return false;
			}
		return true;
		}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> StringLiteralExpImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
...
void StringLiteralExpImpl::setThisStringLiteralExpPtr(std::weak_ptr<ocl::Expressions::StringLiteralExp> thisStringLiteralExpPtr)
{
