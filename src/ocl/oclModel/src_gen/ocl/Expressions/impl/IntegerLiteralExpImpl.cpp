...
//Additional constructor for the containments back reference
IntegerLiteralExpImpl::IntegerLiteralExpImpl(std::weak_ptr<ocl::Expressions::LoopExp> par_LoopExp, const int reference_id)
:IntegerLiteralExpImpl()
{
	switch(reference_id)
	{	
...
//*********************************
std::shared_ptr<Any> IntegerLiteralExpImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::INTEGERLITERALEXP_ATTRIBUTE_INTEGERSYMBOL:
			return eAny(getIntegerSymbol(),ecore::ecorePackage::EINT_CLASS,false); //3424
	}
...
bool IntegerLiteralExpImpl::internalEIsSet(int featureID) const
{
	...
	{
		case ocl::Expressions::ExpressionsPackage::INTEGERLITERALEXP_ATTRIBUTE_INTEGERSYMBOL:
			return getIntegerSymbol() != 0; //3424
	}
	return NumericLiteralExpImpl::internalEIsSet(featureID);
}

bool IntegerLiteralExpImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::INTEGERLITERALEXP_ATTRIBUTE_INTEGERSYMBOL:
		{
			try
			{
				...
				setIntegerSymbol(_integerSymbol); //3424
			}
			catch(...)
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for feature 'integerSymbol'. Failed to set feature!")
				return false;
			}
		return true;
		}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> IntegerLiteralExpImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
...
void IntegerLiteralExpImpl::setThisIntegerLiteralExpPtr(std::weak_ptr<ocl::Expressions::IntegerLiteralExp> thisIntegerLiteralExpPtr)
{
