...
#ifndef UML_CONTROLFLOW_EXECUTION_HPP
#define UML_CONTROLFLOW_EXECUTION_HPP
...
namespace UML 
{
	class ControlFlowObject : virtual public UML::ActivityEdgeObject
	{
		public:
		    //constructors
		    ControlFlowObject(ControlFlowObject &obj);
		    ControlFlowObject(std::shared_ptr<uml::ControlFlow>);
		 	ControlFlowObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::ControlFlow> getControlFlowValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setControlFlowValue(std::shared_ptr<uml::ControlFlow>);
			virtual void setThisControlFlowObjectPtr(std::weak_ptr<ControlFlowObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ControlFlow> m_ControlFlowValue = nullptr;
	};
}
#endif /* end of include guard: UML_CONTROLFLOW_OBJECT_HPP */
