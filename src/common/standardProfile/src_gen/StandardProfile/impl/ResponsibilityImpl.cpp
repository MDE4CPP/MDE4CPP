...
ResponsibilityImpl::ResponsibilityImpl()
{
	...
	*/
	...
	//getter init
		//Property base_Usage
		m_getterMap.insert(std::pair<unsigned long,std::function<Any()>>(1620036731,[this](){ return eAny(this->getBase_Usage(), uml::umlPackage::USAGE_CLASS, false);}));
	
	
	//setter init
	//Property base_Usage
		m_setterMap.insert(std::pair<unsigned long,std::function<void(Any)>>(1620036731,[this](Any object){this->setBase_Usage(object->get<std::shared_ptr<uml::Usage>>());}));
	
	
	//unsetter init
		//Property base_Usage
		m_unsetterMap.insert(std::pair<unsigned long,std::function<void()>>(1620036731,[this](){m_base_Usage = std::shared_ptr<uml::Usage>(nullptr);}));
...
//*********************************
//Get
Any ResponsibilityImpl::get(const std::shared_ptr<uml::Property>& _property) const
{
...
Any ResponsibilityImpl::get(unsigned long _uID) const
{
...
//Set
void ResponsibilityImpl::set(const std::shared_ptr<uml::Property>& _property, const Any& value)
{
	std::string qualifiedName = _property->getQualifiedName();
    this->set(qualifiedName, value);
}

void ResponsibilityImpl::set(std::string _qualifiedName, const Any& value)
{
	unsigned long uID = util::Util::polynomialRollingHash(_qualifiedName);
    this->set(uID, value);
}

void ResponsibilityImpl::set(unsigned long _uID, const Any& value)
{
...
//Unset
void ResponsibilityImpl::unset(const std::shared_ptr<uml::Property>& _property)
{
	std::string qualifiedName = _property->getQualifiedName();
...
//*********************************
//Invoke
Any ResponsibilityImpl::invoke(const std::shared_ptr<uml::Operation>& _operation, const std::shared_ptr<Bag<Any>>& _arguments)
{
...
Any ResponsibilityImpl::invoke(std::string _qualifiedName, const std::shared_ptr<Bag<Any>>& _arguments)
{
	unsigned long uID = util::Util::polynomialRollingHash(_qualifiedName);
    return this->invoke(uID, _arguments);
}

Any ResponsibilityImpl::invoke(unsigned long _uID, const std::shared_ptr<Bag<Any>>& _arguments)
{
