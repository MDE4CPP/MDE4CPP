	...
	class UML_API Object : virtual public ecore::EModelElement
	{
		...
		public:
			...
			*/
			...
			virtual Any get(const std::shared_ptr<uml::Property>& property) const = 0;
			/*!
			...
			*/
			...
			virtual void set(const std::shared_ptr<uml::Property>& property, const Any& value) = 0;
			virtual void unset(const std::shared_ptr<uml::Property>& property) = 0;
