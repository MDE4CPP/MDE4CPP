...
bool PrePostBodyListExpImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::PREPOSTBODYLISTEXP_ATTRIBUTE_BODYEXPRESSIONLIST:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> PrePostBodyListExpImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
