...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> DeviceImpl::getRedefinedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> DeviceImpl::getOwnedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Property>>> DeviceImpl::getAttribute() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> DeviceImpl::getMember() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::ConnectableElement>>> DeviceImpl::getRole() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> DeviceImpl::getOwnedMember() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Feature>>> DeviceImpl::getFeature() const
{
