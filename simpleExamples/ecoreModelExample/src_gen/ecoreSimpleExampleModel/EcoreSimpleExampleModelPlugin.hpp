...
#ifndef ECORESIMPLEEXAMPLEMODELPLUGIN_HPP
#define ECORESIMPLEEXAMPLEMODELPLUGIN_HPP
...
{
	class EcoreSimpleExampleModelPlugin : virtual public EcoreModelPlugin
	{
		public:
		...
		protected:
			EcoreSimpleExampleModelPlugin(){};
			virtual ~EcoreSimpleExampleModelPlugin(){};
	
		private:
			static std::shared_ptr<MDE4CPPPlugin> instance;
	};
}
#endif /* end of include guard: ECORESIMPLEEXAMPLEMODELPLUGIN_HPP */
