	...
	class UML_API GeneralOrderingImpl : virtual public NamedElementImpl, virtual public GeneralOrdering 
	{
		...
		public:
			...
			*/
			...
			virtual bool irreflexive_transitive_closure(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			...
			*/
			...
			virtual void setAfter(const std::shared_ptr<uml::OccurrenceSpecification>&) ;
			/*!
			...
			*/
			...
			virtual void setBefore(const std::shared_ptr<uml::OccurrenceSpecification>&) ;
