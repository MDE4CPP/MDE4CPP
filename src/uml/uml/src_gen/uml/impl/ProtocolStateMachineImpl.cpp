...
bool ProtocolStateMachineImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::PROTOCOLSTATEMACHINE_ATTRIBUTE_CONFORMANCE:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ProtocolStateMachineImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
