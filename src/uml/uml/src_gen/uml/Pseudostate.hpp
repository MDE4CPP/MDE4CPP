	...
	class UML_API Pseudostate: virtual public Vertex
	{
		...
		public:
			...
			*/
			...
			virtual bool choice_vertex(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool fork_vertex(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			History Vertices can have at most one outgoing Transition.
			((kind = PseudostateKind::deepHistory) or (kind = PseudostateKind::shallowHistory)) implies (outgoing->size() <= 1)
			*/
			 
			virtual bool history_vertices(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool join_vertex(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool junction_vertex(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool outgoing_from_initial(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool transitions_incoming(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool transitions_outgoing(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
