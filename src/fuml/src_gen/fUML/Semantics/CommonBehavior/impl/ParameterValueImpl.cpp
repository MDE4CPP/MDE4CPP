...
Any ParameterValueImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
		case fUML::FUMLPackage::PARAMETERVALUE_ATTRIBUTE_PARAMETER:
			return eAny(std::dynamic_pointer_cast<ecore::EObject>(getParameter())); //900
...
bool ParameterValueImpl::internalEIsSet(int featureID) const
{
	...
	{
		case fUML::FUMLPackage::PARAMETERVALUE_ATTRIBUTE_PARAMETER:
			return getParameter() != nullptr; //900
		case fUML::FUMLPackage::PARAMETERVALUE_ATTRIBUTE_VALUES:
			return getValues() != nullptr; //901
	}
