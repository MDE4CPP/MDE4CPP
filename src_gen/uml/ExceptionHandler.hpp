...
namespace uml 
{
	...
	class ExceptionHandler:virtual public Element	{
		...
		public:
			...
			virtual bool
			 handler_body_edges(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 output_pins(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 one_input(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 edge_source_target(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			
			/*!
			 The handlerBody must have the same owner as the protectedNode.
			handlerBody.owner=protectedNode.owner */ 
			virtual bool
			 handler_body_owner(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 exception_input_type(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
