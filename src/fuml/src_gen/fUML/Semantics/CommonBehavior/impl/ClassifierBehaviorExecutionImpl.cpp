...
void ClassifierBehaviorExecutionImpl::saveContent(std::shared_ptr<persistence::interfaces::XSaveHandler> saveHandler) const
{
	...
	// Add references
	if ( this->eIsSet(package->getClassifierBehaviorExecution_Attribute_classifier()) )
	{
		saveHandler->addReference(this->getClassifier(), "classifier", getClassifier()->eClass() != uml::umlPackage::eInstance()->getClass_Class()); 
	}
	if ( this->eIsSet(package->getClassifierBehaviorExecution_Attribute_execution()) )
	{
	...
	if ( this->eIsSet(package->getClassifierBehaviorExecution_Attribute_objectActivation()) )
	{
...
//*********************************
std::shared_ptr<Any> ClassifierBehaviorExecutionImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
		case fUML::Semantics::CommonBehavior::CommonBehaviorPackage::CLASSIFIERBEHAVIOREXECUTION_ATTRIBUTE_CLASSIFIER:
...
bool ClassifierBehaviorExecutionImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case fUML::Semantics::CommonBehavior::CommonBehaviorPackage::CLASSIFIERBEHAVIOREXECUTION_ATTRIBUTE_CLASSIFIER:
		{
			...
			if(ecoreAny)
			{
				try
				{
					...
					std::shared_ptr<uml::Class> _classifier = std::dynamic_pointer_cast<uml::Class>(eObject);
					if(_classifier)
					{
		...
		case fUML::Semantics::CommonBehavior::CommonBehaviorPackage::CLASSIFIERBEHAVIOREXECUTION_ATTRIBUTE_EXECUTION:
		{
			...
			if(ecoreAny)
			{
				...
				{
					std::shared_ptr<ecore::EObject> eObject = ecoreAny->getAsEObject();
					std::shared_ptr<fUML::Semantics::CommonBehavior::Execution> _execution = std::dynamic_pointer_cast<fUML::Semantics::CommonBehavior::Execution>(eObject);
					if(_execution)
					{
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ClassifierBehaviorExecutionImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
  	...
  	switch(operationID)
	{
		...
		case CommonBehaviorPackage::CLASSIFIERBEHAVIOREXECUTION_OPERATION_EXECUTE_CLASS_PARAMETERVALUE:
		{
			...
			{
				std::shared_ptr<ecore::EcoreContainerAny> ecoreContainerAny = std::dynamic_pointer_cast<ecore::EcoreContainerAny>((*incoming_param_classifier_arguments_citer));
				if(ecoreContainerAny)
				{
					try
					{
						...
						if(eObjectList)
						{
							incoming_param_classifier.reset();
							for(const std::shared_ptr<ecore::EObject> anEObject: *eObjectList)
							{
								std::shared_ptr<uml::Class> _temp = std::dynamic_pointer_cast<uml::Class>(anEObject);
								incoming_param_classifier->add(_temp);
							}
						}
					}
					catch(...)
					{
						DEBUG_ERROR("Invalid type stored in 'ecore::EcoreContainerAny' for parameter 'classifier'. Failed to invoke operation 'execute'!")
						return nullptr;
					}
				}
				else
				{
					DEBUG_ERROR("Invalid instance of 'ecore::EcoreContainerAny' for parameter 'classifier'. Failed to invoke operation 'execute'!")
					return nullptr;
				}
			}
