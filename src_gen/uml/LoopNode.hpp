...
namespace uml 
{
	...
	class LoopNode:virtual public StructuredActivityNode	{
		...
		public:
			...
			virtual bool input_edges(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool setup_test_and_body(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool matching_loop_variables(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool matching_result_pins(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool loop_variable_outgoing(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			<p>From package UML::Actions.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::ExecutableNode>>> getBodyPart() const = 0;
			...
			<p>From package UML::Actions.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::OutputPin>>> getLoopVariable() const = 0;
			
			/*!
			 A list of InputPins whose values are moved into the loopVariable Pins before the first iteration of the loop.
			<p>From package UML::Actions.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::InputPin>>> getLoopVariableInput() const = 0;
			...
			<p>From package UML::Actions.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::OutputPin>>> getResult() const = 0;
			...
			<p>From package UML::Actions.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::ExecutableNode>>> getSetupPart() const = 0;
		...
		protected:
			...
			/*!
			 The set of ExecutableNodes that perform the repetitive computations of the loop. The bodyPart is executed as long as the test section produces a true value.
			<p>From package UML::Actions.</p> */
			std::shared_ptr<std::vector<std::shared_ptr<uml::ExecutableNode>>> m_bodyPart;
			/*!
			 An OutputPin on an Action in the test section whose Boolean value determines whether to continue executing the loop bodyPart.
			<p>From package UML::Actions.</p> */
			...
			/*!
			 A list of OutputPins that hold the values of the loop variables during an execution of the loop. When the test fails, the values are moved to the result OutputPins of the loop.
			<p>From package UML::Actions.</p> */
			std::shared_ptr<std::vector<std::shared_ptr<uml::OutputPin>>> m_loopVariable;
			/*!
			 A list of InputPins whose values are moved into the loopVariable Pins before the first iteration of the loop.
			<p>From package UML::Actions.</p> */
			std::shared_ptr<std::vector<std::shared_ptr<uml::InputPin>>> m_loopVariableInput;
			/*!
			 A list of OutputPins that receive the loopVariable values after the last iteration of the loop and constitute the output of the LoopNode.
			<p>From package UML::Actions.</p> */
			std::shared_ptr<std::vector<std::shared_ptr<uml::OutputPin>>> m_result;
			/*!
			 The set of ExecutableNodes executed before the first iteration of the loop, in order to initialize values or perform other setup computations.
			<p>From package UML::Actions.</p> */
			std::shared_ptr<std::vector<std::shared_ptr<uml::ExecutableNode>>> m_setupPart;
			/*!
			 The set of ExecutableNodes executed in order to provide the test result for the loop.
			<p>From package UML::Actions.</p> */
