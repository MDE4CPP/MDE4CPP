...
//*********************************
//Get
Any MetamodelImpl::get(const std::shared_ptr<uml::Property>& _property) const
{
...
//Set
void MetamodelImpl::set(const std::shared_ptr<uml::Property>& _property, const Any& value)
{
	std::string qualifiedName = _property->getQualifiedName();
    this->set(qualifiedName, value);
}

void MetamodelImpl::set(std::string _qualifiedName, const Any& value)
{
	unsigned long uID = util::Util::polynomialRollingHash(_qualifiedName);
    this->set(uID, value);
}

void MetamodelImpl::set(unsigned long _uID, const Any& value)
{
...
//*********************************
//Invoke
Any MetamodelImpl::invoke(const std::shared_ptr<uml::Operation>& _operation, const std::shared_ptr<Bag<Any>>& _arguments)
{
...
Any MetamodelImpl::invoke(std::string _qualifiedName, const std::shared_ptr<Bag<Any>>& _arguments)
{
	unsigned long uID = util::Util::polynomialRollingHash(_qualifiedName);
    return this->invoke(uID, _arguments);
}

Any MetamodelImpl::invoke(unsigned long _uID, const std::shared_ptr<Bag<Any>>& _arguments)
{
