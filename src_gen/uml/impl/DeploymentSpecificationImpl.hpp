...
namespace uml 
{
	class DeploymentSpecificationImpl :virtual public ArtifactImpl, virtual public DeploymentSpecification 
	{
		...
		public:
			...
			virtual bool
			 deployed_elements(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
			...
			<p>From package UML::Deployments.</p> */
			virtual std::shared_ptr<uml::Deployment > getDeployment() const ;
