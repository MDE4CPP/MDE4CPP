...
namespace uml 
{
	class ClassifierImpl :virtual public NamespaceImpl, virtual public RedefinableElementImpl, virtual public TemplateableElementImpl, virtual public TypeImpl, virtual public Classifier
	{
		...
		public:
			...
			<p>From package UML::Classification.</p> */ 
			virtual bool hasVisibilityOf(uml::NamedElement *  n)  ;
			...
			result = (inhs->reject(inh |
			  ...
			  ownedMember->select(oclIsKindOf(RedefinableElement))->
			    select(redefinedElement->includes(inh.oclAsType(RedefinableElement)))
			       ->notEmpty()))
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::NamedElement * > *  inherit(std::vector<uml::NamedElement * > *  inhs)  ;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::NamedElement * > *  inheritableMembers(uml::Classifier *  c)  ;
			
			/*!
			 The inheritedMember association is derived by inheriting the inheritable members of the parents.
			result = (inherit(parents()->collect(inheritableMembers(self))->asSet()))
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::NamedElement * > *  getInheritedMembers()  ;
			
			/*!
			 The query maySpecializeType() determines whether this classifier may have a generalization relationship to classifiers of the specified type. By default a classifier may specialize classifiers of the same or a more general type. It is intended to be redefined by classifiers that have different specialization constraints.
			result = (self.oclIsKindOf(c.oclType()))
			<p>From package UML::Classification.</p> */ 
			virtual bool maySpecializeType(uml::Classifier *  c)  ;
			
			/*!
			 The query parents() gives all of the immediate ancestors of a generalized Classifier.
			result = (generalization.general->asSet())
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::Classifier * > *  parents()  ;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::Interface * > *  directlyRealizedInterfaces()  ;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::Interface * > *  directlyUsedInterfaces()  ;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::Interface * > *  allRealizedInterfaces()  ;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::Interface * > *  allUsedInterfaces()  ;
			
			/*!
			 result = (substitution.contract->includes(contract))
			<p>From package UML::Classification.</p> */ 
			virtual bool isSubstitutableFor(uml::Classifier *  contract)  ;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::Property * > *  allAttributes()  ;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::StructuralFeature * > *  allSlottableFeatures()  ;
			...
			<p>From package UML::Classification.</p> */
			virtual std::vector<uml::CollaborationUse * > *  getCollaborationUse() const ;
			
			/*!
			 The generalizing Classifiers for this Classifier.
			<p>From package UML::Classification.</p> */
			virtual std::vector<uml::Classifier * > *  getGeneral() const ;
			...
			<p>From package UML::Classification.</p> */
			virtual std::vector<uml::GeneralizationSet * > *  getPowertypeExtent() const ;
			
			/*!
			 All elements inherited by this Classifier from its general Classifiers.
			<p>From package UML::Classification.</p> */
			virtual std::vector<uml::NamedElement * > *  getInheritedMember() const ;
			
			/*!
			 The UseCases owned by this classifier.
			<p>From package UML::Classification.</p> */
			virtual std::vector<uml::UseCase * > *  getOwnedUseCase() const ;
			
			/*!
			 The set of UseCases for which this Classifier is the subject.
			<p>From package UML::Classification.</p> */
			virtual std::vector<uml::UseCase * > *  getUseCase() const ;
			
			/*!
			 The Classifiers redefined by this Classifier.
			<p>From package UML::Classification.</p> */
			virtual std::vector<uml::Classifier * > *  getRedefinedClassifier() const ;
			
			/*!
			 A CollaborationUse which indicates the Collaboration that represents this Classifier.
			<p>From package UML::Classification.</p> */
			virtual uml::CollaborationUse *  getRepresentation() const ;
			
			/*!
			 A CollaborationUse which indicates the Collaboration that represents this Classifier.
			<p>From package UML::Classification.</p> */
			virtual void setRepresentation(uml::CollaborationUse *  _representation) ;
			
			/*!
			 The Substitutions owned by this Classifier.
			<p>From package UML::Classification.</p> */
			virtual std::vector<uml::Substitution * > *  getSubstitution() const ;
