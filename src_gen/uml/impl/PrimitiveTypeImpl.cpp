...
PrimitiveTypeImpl::PrimitiveTypeImpl(const PrimitiveTypeImpl & obj)
{
...
ecore::EClass* PrimitiveTypeImpl::eStaticClass() const
{
...
// Union Getter
//*********************************
std::vector<uml::NamedElement * > *  PrimitiveTypeImpl::getMember() const
{
...
std::vector<uml::Element * > *  PrimitiveTypeImpl::getOwnedElement() const
{
...
std::vector<uml::NamedElement * > *  PrimitiveTypeImpl::getOwnedMember() const
{
...
std::vector<uml::Feature * > *  PrimitiveTypeImpl::getFeature() const
{
...
uml::Namespace *  PrimitiveTypeImpl::getNamespace() const
{
...
uml::Element *  PrimitiveTypeImpl::getOwner() const
{
...
std::vector<uml::Property * > *  PrimitiveTypeImpl::getAttribute() const
{
...
std::vector<uml::RedefinableElement * > *  PrimitiveTypeImpl::getRedefinedElement() const
{
