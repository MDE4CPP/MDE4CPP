...
bool PrefixedExpImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::PREFIXEDEXP_ATTRIBUTE_REFERREDEXPRESSION:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> PrefixedExpImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
