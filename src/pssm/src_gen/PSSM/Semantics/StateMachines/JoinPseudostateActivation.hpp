...
#ifndef PSSM_SEMANTICS_STATEMACHINES_JOINPSEUDOSTATEACTIVATION_HPP
#define PSSM_SEMANTICS_STATEMACHINES_JOINPSEUDOSTATEACTIVATION_HPP
...
namespace PSSM::Semantics::StateMachines 
{
	...
	class PSSM_API JoinPseudostateActivation : virtual public PseudostateActivation
	{
		public:
 			JoinPseudostateActivation(const JoinPseudostateActivation &) {}
		...
		public:
			...
			//destructor
			virtual ~JoinPseudostateActivation() {}
...
#endif /* end of include guard: PSSM_SEMANTICS_STATEMACHINES_JOINPSEUDOSTATEACTIVATION_HPP */
