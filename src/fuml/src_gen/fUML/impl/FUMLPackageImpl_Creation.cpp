...
void FUMLPackageImpl::createStructuredValueContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::EcoreFactory> factory)
{
	...
	m_structuredValue_Operation_getValue_StructuralFeature_FeatureValue = factory->createEOperation_in_EContainingClass(m_structuredValue_Class, STRUCTUREDVALUE_OPERATION_GETVALUE_STRUCTURALFEATURE_FEATUREVALUE);
	m_structuredValue_Operation_removeFeatureValue_StructuralFeature_Boolean = factory->createEOperation_in_EContainingClass(m_structuredValue_Class, STRUCTUREDVALUE_OPERATION_REMOVEFEATUREVALUE_STRUCTURALFEATURE_BOOLEAN);
