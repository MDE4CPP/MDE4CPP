	...
	class UML_API Element : virtual public Object
	{
		...
		public:
			...
			*/
			...
			virtual std::shared_ptr<Any> getValue(const std::shared_ptr<uml::Stereotype>& stereotype, std::string propertyName) = 0;
			/*!
			...
			*/
			...
			virtual void setValue(const std::shared_ptr<uml::Stereotype>& stereotype, std::string propertyName, const std::shared_ptr<Any>& newValue) = 0;
			/*!
