...
RealLiteralExpEvalImpl& RealLiteralExpEvalImpl::operator=(const RealLiteralExpEvalImpl & obj)
{
	 ...
	 * Currently, this causes an error because it calls an implicit assignment operator of RealLiteralExpEval 
	 * which is generated by the compiler (as RealLiteralExpEval is an abstract class and does not have a user-defined assignment operator).
...
//*********************************
std::shared_ptr<Any> RealLiteralExpEvalImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
	}
...
bool RealLiteralExpEvalImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
	}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> RealLiteralExpEvalImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
