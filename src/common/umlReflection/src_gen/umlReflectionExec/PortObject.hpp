...
#ifndef UML_PORT_EXECUTION_HPP
#define UML_PORT_EXECUTION_HPP
...
namespace UML 
{
	class PortObject : virtual public UML::PropertyObject
	{
		public:
		    //constructors
		    PortObject(PortObject &obj);
		    PortObject(std::shared_ptr<uml::Port>);
		 	PortObject();
		    //destructor
		    virtual ~PortObject();
			...
			virtual std::shared_ptr<uml::Port> getPortValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setPortValue(std::shared_ptr<uml::Port>);
			virtual void setThisPortObjectPtr(std::weak_ptr<PortObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Port> m_PortValue = nullptr;
	};
}
#endif /* end of include guard: UML_PORT_OBJECT_HPP */
