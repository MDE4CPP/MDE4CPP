...
const std::shared_ptr<ecore::EClass>& LiteralRealEvaluationImpl::eStaticClass() const
{
...
bool LiteralRealEvaluationImpl::eSet(int featureID, const Any& newValue)
{
	switch(featureID)
	{
	}
...
// EOperation Invoke
//*********************************
Any LiteralRealEvaluationImpl::eInvoke(int operationID, const std::shared_ptr<std::list<Any>>& arguments)
{
	Any result;
 
  	switch(operationID)
	{
		// fUML::Semantics::Values::LiteralRealEvaluation::evaluate() : fUML::Semantics::Values::Value: 269404326
