#include "umlReflectionExec/ValuePinObject.hpp"

//General Includes
#include "abstractDataTypes/SubsetUnion.hpp"
#include "uml/ValuePin.hpp"
...
{	
	m_ValuePinValue.reset();

	fUML::Semantics::StructuredClassifiers::ObjectImpl::destroy();
}

std::shared_ptr<uml::Element> ValuePinObject::getUmlValue() const
{
	return getValuePinValue();
}

std::shared_ptr<uml::ValuePin> ValuePinObject::getValuePinValue() const
{
	return m_ValuePinValue;
}

void ValuePinObject::setUmlValue(std::shared_ptr<uml::Element> _element)
{
	setValuePinValue(std::dynamic_pointer_cast<uml::ValuePin>(_element));
}

void ValuePinObject::setValuePinValue(std::shared_ptr<uml::ValuePin> _ValuePinElement)
{
	m_ValuePinValue = _ValuePinElement;
	//set super type values
	UML::InputPinObject::setInputPinValue(_ValuePinElement);
}

void ValuePinObject::setThisValuePinObjectPtr(std::weak_ptr<ValuePinObject> thisObjectPtr)
{
	setThisCS_ObjectPtr(thisObjectPtr);
}

bool ValuePinObject::equals(std::shared_ptr<fUML::Semantics::Values::Value> otherValue)
{
	bool isEqual = false;
	
	std::shared_ptr<ValuePinObject> otherValuePinObject = std::dynamic_pointer_cast<ValuePinObject>(otherValue);

	if(otherValuePinObject != nullptr)
	{
		if(this->getValuePinValue() == otherValuePinObject->getValuePinValue())
		{
			isEqual = true;
		}
	}
...
std::string ValuePinObject::toString()
{
	std::string buffer = "Instance of 'ValuePinObject', " + std::to_string(getTypes()->size()) + " types (";
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Object>> ValuePinObject::getDirectContainers()
{   
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Link>> ValuePinObject::getLinks(std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_InteractionPoint> interactionPoint)
{
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> ValuePinObject::retrieveEndValueAsInteractionPoint(std::shared_ptr<fUML::Semantics::Values::Value> endValue, std::shared_ptr<uml::ConnectorEnd> end)
{
	/*Not done for metamodel object classes*/
...
void ValuePinObject::removeValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<fUML::Semantics::Values::Value> value)
{
	...
	if (m_ValuePinValue == nullptr)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": no value stored inside ValuePinObject (property: " << feature->getName() << ")" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inInterruptibleRegion())
	{
		...
		{
			m_ValuePinValue->getInInterruptibleRegion()->clear();
		}
		else
		{
			...
			{
				m_ValuePinValue->getInInterruptibleRegion()->erase(inputValue->getInterruptibleActivityRegionValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inPartition())
	{
		if (value == nullptr) // clear mode
		{
			m_ValuePinValue->getInPartition()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ValuePinValue->getInPartition()->erase(inputValue->getActivityPartitionValue());
			}
		}
	}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_incoming())
	{
		if (value == nullptr) // clear mode
		{
			m_ValuePinValue->getIncoming()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ValuePinValue->getIncoming()->erase(inputValue->getActivityEdgeValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_outgoing())
	{
		if (value == nullptr) // clear mode
		{
			m_ValuePinValue->getOutgoing()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ValuePinValue->getOutgoing()->erase(inputValue->getActivityEdgeValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_redefinedNode())
	{
		if (value == nullptr) // clear mode
		{
			m_ValuePinValue->getRedefinedNode()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ValuePinValue->getRedefinedNode()->erase(inputValue->getActivityNodeValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		if (value == nullptr) // clear mode
		{
			m_ValuePinValue->getOwnedComment()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ValuePinValue->getOwnedComment()->erase(inputValue->getCommentValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_isOrdered())
	{
				m_ValuePinValue->setIsOrdered(false /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_isUnique())
	{
				m_ValuePinValue->setIsUnique(true /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_lower())
	{
				m_ValuePinValue->setLower(1 /*defined default value*/);
	...
	{
				m_ValuePinValue->setUpper(1 /*defined default value*/);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ObjectNode_inState())
	{
		if (value == nullptr) // clear mode
		{
			m_ValuePinValue->getInState()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ValuePinValue->getInState()->erase(inputValue->getStateValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ObjectNode_isControlType())
	{
				m_ValuePinValue->setIsControlType(false /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ObjectNode_ordering())
	{
				m_ValuePinValue->setOrdering(uml::ObjectNodeOrderingKind::FIFO /*defined default value*/);
	...
	{
				m_ValuePinValue->setIsControl(false /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_isLeaf())
	{
				m_ValuePinValue->setIsLeaf(false /*defined default value*/);
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> ValuePinObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	if (feature->getMetaElementID() != uml::umlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::umlPackage::PORT_CLASS && feature->getMetaElementID() != uml::umlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_activity())
	{
		...
		value->setActivityValue(m_ValuePinValue->getActivity().lock());
	...
	{
		std::shared_ptr<Union<uml::ActivityGroup>> inGroupList = m_ValuePinValue->getInGroup();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inInterruptibleRegion())
	{
		std::shared_ptr<Subset<uml::InterruptibleActivityRegion, uml::ActivityGroup>> inInterruptibleRegionList = m_ValuePinValue->getInInterruptibleRegion();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inPartition())
	{
		std::shared_ptr<Subset<uml::ActivityPartition, uml::ActivityGroup>> inPartitionList = m_ValuePinValue->getInPartition();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inStructuredNode())
	{
		...
		value->setLocus(this->getLocus());
		value->setStructuredActivityNodeValue(m_ValuePinValue->getInStructuredNode().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_incoming())
	{
		std::shared_ptr<Bag<uml::ActivityEdge>> incomingList = m_ValuePinValue->getIncoming();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_outgoing())
	{
		std::shared_ptr<Bag<uml::ActivityEdge>> outgoingList = m_ValuePinValue->getOutgoing();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_redefinedNode())
	{
		std::shared_ptr<Subset<uml::ActivityNode, uml::RedefinableElement>> redefinedNodeList = m_ValuePinValue->getRedefinedNode();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Subset<uml::Comment, uml::Element>> ownedCommentList = m_ValuePinValue->getOwnedComment();
	...
	{
		std::shared_ptr<Union<uml::Element>> ownedElementList = m_ValuePinValue->getOwnedElement();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_owner())
	{
		...
		value->setThisElementObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setElementValue(m_ValuePinValue->getOwner().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_isOrdered())
	{
		...
		value->setValue(m_ValuePinValue->getIsOrdered());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_isUnique())
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_ValuePinValue->getIsUnique());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_lower())
	{
		...
		value->setValue(m_ValuePinValue->getLower());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_lowerValue())
	{
		...
		value->setLocus(this->getLocus());
		value->setValueSpecificationValue(m_ValuePinValue->getLowerValue());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_upper())
	{
		...
		value->setValue(m_ValuePinValue->getUpper());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_upperValue())
	{
		...
		value->setThisValueSpecificationObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setValueSpecificationValue(m_ValuePinValue->getUpperValue());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	{
		std::shared_ptr<Bag<uml::Dependency>> clientDependencyList = m_ValuePinValue->getClientDependency();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		value->setValue(m_ValuePinValue->getName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		value->setLocus(this->getLocus());
		value->setStringExpressionValue(m_ValuePinValue->getNameExpression());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace())
	{
		...
		value->setLocus(this->getLocus());
		value->setNamespaceValue(m_ValuePinValue->getNamespace().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::StringValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createStringValue();
		value->setValue(m_ValuePinValue->getQualifiedName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		uml::VisibilityKind visibility = m_ValuePinValue->getVisibility();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ObjectNode_inState())
	{
		std::shared_ptr<Bag<uml::State>> inStateList = m_ValuePinValue->getInState();
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_ValuePinValue->getIsControlType());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ObjectNode_ordering())
	{
		uml::ObjectNodeOrderingKind ordering = m_ValuePinValue->getOrdering();
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::EnumerationValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createEnumerationValue();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ObjectNode_selection())
	{
		...
		value->setLocus(this->getLocus());
		value->setBehaviorValue(m_ValuePinValue->getSelection());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ObjectNode_upperBound())
	{
		...
		value->setThisValueSpecificationObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setValueSpecificationValue(m_ValuePinValue->getUpperBound());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_ValuePinValue->getIsControl());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_isLeaf())
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_ValuePinValue->getIsLeaf());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_redefinedElement())
	{
		std::shared_ptr<Union<uml::RedefinableElement>> redefinedElementList = m_ValuePinValue->getRedefinedElement();
	...
	{
		std::shared_ptr<Union<uml::Classifier>> redefinitionContextList = m_ValuePinValue->getRedefinitionContext();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TypedElement_type())
	{
		...
		value->setLocus(this->getLocus());
		value->setTypeValue(m_ValuePinValue->getType());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ValuePin_value())
	{
		...
		value->setThisValueSpecificationObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setValueSpecificationValue(m_ValuePinValue->getValue());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
...
std::shared_ptr<fUML::Semantics::SimpleClassifiers::FeatureValue> ValuePinObject::retrieveFeatureValue(std::shared_ptr<uml::StructuralFeature> feature)
{
...
void ValuePinObject::setFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	if (feature->getMetaElementID() != uml::umlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::umlPackage::PORT_CLASS && feature->getMetaElementID() != uml::umlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inInterruptibleRegion())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ValuePinValue->getInInterruptibleRegion()->push_back(value->getInterruptibleActivityRegionValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inPartition())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ValuePinValue->getInPartition()->push_back(value->getActivityPartitionValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_incoming())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ValuePinValue->getIncoming()->push_back(value->getActivityEdgeValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_outgoing())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ValuePinValue->getOutgoing()->push_back(value->getActivityEdgeValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_redefinedNode())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ValuePinValue->getRedefinedNode()->push_back(value->getActivityNodeValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ValuePinValue->getOwnedComment()->push_back(value->getCommentValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_isOrdered())
	{
		...
		{
			m_ValuePinValue->setIsOrdered(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_isUnique())
	{
		...
		if (valueObject != nullptr)
		{
			m_ValuePinValue->setIsUnique(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_lower())
	{
		...
		if (valueObject != nullptr)
		{
			m_ValuePinValue->setLower(valueObject->getValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_lowerValue())
	{
		...
		if (value != nullptr)
		{
			m_ValuePinValue->setLowerValue(value->getValueSpecificationValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_upper())
	{
		...
		if (valueObject != nullptr)
		{
			m_ValuePinValue->setUpper(valueObject->getValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_upperValue())
	{
		...
		if (value != nullptr)
		{
			m_ValuePinValue->setUpperValue(value->getValueSpecificationValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		if (valueObject != nullptr)
		{
			m_ValuePinValue->setName(valueObject->getValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		if (value != nullptr)
		{
			m_ValuePinValue->setNameExpression(value->getStringExpressionValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		...
		{
			m_ValuePinValue->setVisibility(uml::VisibilityKind::PUBLIC);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_private())
		{
			m_ValuePinValue->setVisibility(uml::VisibilityKind::PRIVATE);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_protected())
		{
			m_ValuePinValue->setVisibility(uml::VisibilityKind::PROTECTED);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_package())
		{
			m_ValuePinValue->setVisibility(uml::VisibilityKind::PACKAGE);
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ObjectNode_inState())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ValuePinValue->getInState()->push_back(value->getStateValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ObjectNode_isControlType())
	{
		...
		if (valueObject != nullptr)
		{
			m_ValuePinValue->setIsControlType(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ObjectNode_ordering())
	{
		...
		{
			m_ValuePinValue->setOrdering(uml::ObjectNodeOrderingKind::UNORDERED);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_ObjectNodeOrderingKind_ordered())
		{
			m_ValuePinValue->setOrdering(uml::ObjectNodeOrderingKind::ORDERED);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_ObjectNodeOrderingKind_LIFO())
		{
			m_ValuePinValue->setOrdering(uml::ObjectNodeOrderingKind::LIFO);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_ObjectNodeOrderingKind_FIFO())
		{
			m_ValuePinValue->setOrdering(uml::ObjectNodeOrderingKind::FIFO);
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ObjectNode_selection())
	{
		...
		if (value != nullptr)
		{
			m_ValuePinValue->setSelection(value->getBehaviorValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ObjectNode_upperBound())
	{
		...
		if (value != nullptr)
		{
			m_ValuePinValue->setUpperBound(value->getValueSpecificationValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Pin_isControl())
	{
		...
		if (valueObject != nullptr)
		{
			m_ValuePinValue->setIsControl(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_isLeaf())
	{
		...
		if (valueObject != nullptr)
		{
			m_ValuePinValue->setIsLeaf(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TypedElement_type())
	{
		...
		if (value != nullptr)
		{
			m_ValuePinValue->setType(value->getTypeValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ValuePin_value())
	{
		...
		if (value != nullptr)
		{
			m_ValuePinValue->setValue(value->getValueSpecificationValue());
		}
		
	}
}

void ValuePinObject::assignFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	this->setFeatureValue(feature, values, position);
}

std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> ValuePinObject::retrieveFeatureValues()
{
	...
	for(unsigned int i = 0; i < allAttributesSize; i++)
	{
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_ActivityNode_activity() && m_ValuePinValue->getActivity().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inGroup() && m_ValuePinValue->getInGroup() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inInterruptibleRegion() && m_ValuePinValue->getInInterruptibleRegion() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inPartition() && m_ValuePinValue->getInPartition() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inStructuredNode() && m_ValuePinValue->getInStructuredNode().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ActivityNode_incoming() && m_ValuePinValue->getIncoming() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ActivityNode_outgoing() && m_ValuePinValue->getOutgoing() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ActivityNode_redefinedNode() && m_ValuePinValue->getRedefinedNode() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment() && m_ValuePinValue->getOwnedComment() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedElement() && m_ValuePinValue->getOwnedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_owner() && m_ValuePinValue->getOwner().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_lowerValue() && m_ValuePinValue->getLowerValue() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_upperValue() && m_ValuePinValue->getUpperValue() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_clientDependency() && m_ValuePinValue->getClientDependency() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression() && m_ValuePinValue->getNameExpression() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace() && m_ValuePinValue->getNamespace().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ObjectNode_inState() && m_ValuePinValue->getInState() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ObjectNode_selection() && m_ValuePinValue->getSelection() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ObjectNode_upperBound() && m_ValuePinValue->getUpperBound() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_redefinedElement() && m_ValuePinValue->getRedefinedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_redefinitionContext() && m_ValuePinValue->getRedefinitionContext() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_TypedElement_type() && m_ValuePinValue->getType() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ValuePin_value() && m_ValuePinValue->getValue() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
	}
