...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/UML4CPP_test/generator/main/generate";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "generateTestUML" };
    ...
    public void registerResourceFactories(ResourceSet resourceSet) {
        ...
        {        	 
	 		 resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap( ).put("emtl", new UML4CPP_testEMtlResourceFactory());
        }
    }
