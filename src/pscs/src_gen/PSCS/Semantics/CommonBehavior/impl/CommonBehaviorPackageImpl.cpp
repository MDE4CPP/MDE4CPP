...
const std::shared_ptr<ecore::EClass>& PSCS::Semantics::CommonBehavior::CommonBehaviorPackageImpl::getCS_CallEventExecution_Class() const
{
	return m_cS_CallEventExecution_Class;
}


const std::shared_ptr<ecore::EReference>& PSCS::Semantics::CommonBehavior::CommonBehaviorPackageImpl::getCS_CallEventExecution_Attribute_interactionPoint() const
{
	return m_cS_CallEventExecution_Attribute_interactionPoint;
}

const std::shared_ptr<ecore::EOperation>& PSCS::Semantics::CommonBehavior::CommonBehaviorPackageImpl::getCS_CallEventExecution_Operation__copy() const
{
	return m_cS_CallEventExecution_Operation__copy;
}
const std::shared_ptr<ecore::EOperation>& PSCS::Semantics::CommonBehavior::CommonBehaviorPackageImpl::getCS_CallEventExecution_Operation_createEventOccurrence() const
{
	return m_cS_CallEventExecution_Operation_createEventOccurrence;
}
const std::shared_ptr<ecore::EOperation>& PSCS::Semantics::CommonBehavior::CommonBehaviorPackageImpl::getCS_CallEventExecution_Operation_new_() const
{
...
const std::shared_ptr<ecore::EOperation>& PSCS::Semantics::CommonBehavior::CommonBehaviorPackageImpl::getCS_EventOccurrence_Operation_sendInTo_CS_Reference_Port() const
{
	return m_cS_EventOccurrence_Operation_sendInTo_CS_Reference_Port;
}
const std::shared_ptr<ecore::EOperation>& PSCS::Semantics::CommonBehavior::CommonBehaviorPackageImpl::getCS_EventOccurrence_Operation_sendOutTo_CS_Reference_Port() const
{
