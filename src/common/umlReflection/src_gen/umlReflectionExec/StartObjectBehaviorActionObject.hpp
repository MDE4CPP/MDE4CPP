...
#ifndef UML_STARTOBJECTBEHAVIORACTION_EXECUTION_HPP
#define UML_STARTOBJECTBEHAVIORACTION_EXECUTION_HPP
...
namespace UML 
{
	class StartObjectBehaviorActionObject : virtual public UML::CallActionObject
	{
		public:
		    //constructors
		    StartObjectBehaviorActionObject(StartObjectBehaviorActionObject &obj);
		    StartObjectBehaviorActionObject(std::shared_ptr<uml::StartObjectBehaviorAction>);
		 	StartObjectBehaviorActionObject();
		    //destructor
		    virtual ~StartObjectBehaviorActionObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			StartObjectBehaviorActionObject& operator=(StartObjectBehaviorActionObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::StartObjectBehaviorAction> getStartObjectBehaviorActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setStartObjectBehaviorActionValue(std::shared_ptr<uml::StartObjectBehaviorAction>);
			virtual void setThisStartObjectBehaviorActionObjectPtr(std::weak_ptr<StartObjectBehaviorActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::StartObjectBehaviorAction> m_StartObjectBehaviorActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_STARTOBJECTBEHAVIORACTION_OBJECT_HPP */
