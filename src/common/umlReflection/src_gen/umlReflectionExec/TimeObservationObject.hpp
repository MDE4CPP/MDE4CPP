...
#ifndef UML_TIMEOBSERVATION_EXECUTION_HPP
#define UML_TIMEOBSERVATION_EXECUTION_HPP
...
namespace UML 
{
	class TimeObservationObject : virtual public UML::ObservationObject
	{
		public:
		    //constructors
		    TimeObservationObject(TimeObservationObject &obj);
		    TimeObservationObject(std::shared_ptr<uml::TimeObservation>);
		 	TimeObservationObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::TimeObservation> getTimeObservationValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setTimeObservationValue(std::shared_ptr<uml::TimeObservation>);
			virtual void setThisTimeObservationObjectPtr(std::weak_ptr<TimeObservationObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::TimeObservation> m_TimeObservationValue = nullptr;
	};
}
#endif /* end of include guard: UML_TIMEOBSERVATION_OBJECT_HPP */
