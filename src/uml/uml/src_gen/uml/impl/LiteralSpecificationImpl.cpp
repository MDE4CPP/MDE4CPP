...
bool LiteralSpecificationImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
	}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> LiteralSpecificationImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
