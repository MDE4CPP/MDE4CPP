...
namespace fUML::Semantics::Actions 
{
	...
	class FUML_API AddStructuralFeatureValueActionActivation : virtual public WriteStructuralFeatureActionActivation
	{
		...
		public:
			...
			//*********************************
			virtual const std::shared_ptr<uml::AddStructuralFeatureValueAction>& getAddStructuralFeatureValueAction() const = 0;
			virtual void setAddStructuralFeatureValueAction(const std::shared_ptr<uml::AddStructuralFeatureValueAction>&) = 0;
