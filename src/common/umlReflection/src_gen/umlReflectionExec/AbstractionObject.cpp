...
std::shared_ptr<uml::Element> AbstractionObject::getUmlValue() const
{
	return getAbstractionValue();
}

std::shared_ptr<uml::Abstraction> AbstractionObject::getAbstractionValue() const
{
	return m_AbstractionValue;
}

void AbstractionObject::setUmlValue(std::shared_ptr<uml::Element> _element)
{
	setAbstractionValue(std::dynamic_pointer_cast<uml::Abstraction>(_element));
}

void AbstractionObject::setAbstractionValue(std::shared_ptr<uml::Abstraction> _AbstractionElement)
{
	m_AbstractionValue = _AbstractionElement;
	//set super type values
	UML::DependencyObject::setDependencyValue(_AbstractionElement);
}

void AbstractionObject::setThisAbstractionObjectPtr(std::weak_ptr<AbstractionObject> thisObjectPtr)
{
	setThisCS_ObjectPtr(thisObjectPtr);
}

bool AbstractionObject::equals(std::shared_ptr<fUML::Semantics::Values::Value> otherValue)
{
	bool isEqual = false;
	
	std::shared_ptr<AbstractionObject> otherAbstractionObject = std::dynamic_pointer_cast<AbstractionObject>(otherValue);

	if(otherAbstractionObject != nullptr)
	{
		if(this->getAbstractionValue() == otherAbstractionObject->getAbstractionValue())
		{
			isEqual = true;
		}
	}
...
std::string AbstractionObject::toString()
{
	std::string buffer = "Instance of 'AbstractionObject', " + std::to_string(getTypes()->size()) + " types (";
...
void AbstractionObject::removeValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<fUML::Semantics::Values::Value> value)
{
	...
	if (m_AbstractionValue == nullptr)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": no value stored inside AbstractionObject (property: " << feature->getName() << ")" << std::endl;
		throw "NullPointerException";	
	}

	if (feature == UML::UMLPackage::eInstance()->get_UML_Abstraction_mapping())
	{
				//m_AbstractionValue->getMapping().reset();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Dependency_client())
	{
		...
		{
			m_AbstractionValue->getClient()->clear();
		}
		else
		{
			...
			{
				m_AbstractionValue->getClient()->erase(inputValue->getNamedElementValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Dependency_supplier())
	{
		if (value == nullptr) // clear mode
		{
			m_AbstractionValue->getSupplier()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_AbstractionValue->getSupplier()->erase(inputValue->getNamedElementValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		if (value == nullptr) // clear mode
		{
			m_AbstractionValue->getOwnedComment()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_AbstractionValue->getOwnedComment()->erase(inputValue->getCommentValue());
			}
		}
	}
	...
	{
				//m_AbstractionValue->getNameExpression().reset();
	...
	{
				m_AbstractionValue->setVisibility(uml::VisibilityKind::PUBLIC /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_owningTemplateParameter())
	{
				//m_AbstractionValue->getOwningTemplateParameter().reset();

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_templateParameter())
	{
				//m_AbstractionValue->getTemplateParameter().reset();
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> AbstractionObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Abstraction_mapping())
	{
		...
		value->setOpaqueExpressionValue(m_AbstractionValue->getMapping());
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Dependency_client())
	{
		std::shared_ptr<SubsetUnion<uml::NamedElement, uml::Element>> clientList = m_AbstractionValue->getClient();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Dependency_supplier())
	{
		std::shared_ptr<SubsetUnion<uml::NamedElement, uml::Element>> supplierList = m_AbstractionValue->getSupplier();
	...
	{
		std::shared_ptr<SubsetUnion<uml::Element, uml::Element>> sourceList = m_AbstractionValue->getSource();
	...
	{
		std::shared_ptr<SubsetUnion<uml::Element, uml::Element>> targetList = m_AbstractionValue->getTarget();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Subset<uml::Comment, uml::Element>> ownedCommentList = m_AbstractionValue->getOwnedComment();
	...
	{
		std::shared_ptr<Union<uml::Element>> ownedElementList = m_AbstractionValue->getOwnedElement();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_owner())
	{
		...
		value->setThisElementObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setElementValue(m_AbstractionValue->getOwner().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<Bag<uml::Dependency>> clientDependencyList = m_AbstractionValue->getClientDependency();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		value->setValue(m_AbstractionValue->getName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		value->setLocus(this->getLocus());
		value->setStringExpressionValue(m_AbstractionValue->getNameExpression());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace())
	{
		...
		value->setLocus(this->getLocus());
		value->setNamespaceValue(m_AbstractionValue->getNamespace().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::StringValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createStringValue();
		value->setValue(m_AbstractionValue->getQualifiedName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		uml::VisibilityKind visibility = m_AbstractionValue->getVisibility();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_owningTemplateParameter())
	{
		...
		value->setLocus(this->getLocus());
		value->setTemplateParameterValue(m_AbstractionValue->getOwningTemplateParameter().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_templateParameter())
	{
		...
		value->setThisTemplateParameterObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setTemplateParameterValue(m_AbstractionValue->getTemplateParameter());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<Union<uml::Element>> relatedElementList = m_AbstractionValue->getRelatedElement();
...
std::shared_ptr<fUML::Semantics::SimpleClassifiers::FeatureValue> AbstractionObject::retrieveFeatureValue(std::shared_ptr<uml::StructuralFeature> feature)
{
...
void AbstractionObject::setFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Abstraction_mapping())
	{
		...
		if (value != nullptr)
		{
			m_AbstractionValue->setMapping(value->getOpaqueExpressionValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Dependency_client())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_AbstractionValue->getClient()->push_back(value->getNamedElementValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Dependency_supplier())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_AbstractionValue->getSupplier()->push_back(value->getNamedElementValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_AbstractionValue->getOwnedComment()->push_back(value->getCommentValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		{
			m_AbstractionValue->setName(valueObject->getValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		if (value != nullptr)
		{
			m_AbstractionValue->setNameExpression(value->getStringExpressionValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		...
		{
			m_AbstractionValue->setVisibility(uml::VisibilityKind::PUBLIC);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_private())
		{
			m_AbstractionValue->setVisibility(uml::VisibilityKind::PRIVATE);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_protected())
		{
			m_AbstractionValue->setVisibility(uml::VisibilityKind::PROTECTED);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_package())
		{
			m_AbstractionValue->setVisibility(uml::VisibilityKind::PACKAGE);
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_templateParameter())
	{
		...
		if (value != nullptr)
		{
			m_AbstractionValue->setTemplateParameter(value->getTemplateParameterValue());
		}
		
	}
}

void AbstractionObject::assignFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	this->setFeatureValue(feature, values, position);
}

std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> AbstractionObject::retrieveFeatureValues()
{
	...
	for(unsigned int i = 0; i < allAttributesSize; i++)
	{
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_Abstraction_mapping() && m_AbstractionValue->getMapping() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Dependency_client() && m_AbstractionValue->getClient() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Dependency_supplier() && m_AbstractionValue->getSupplier() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_DirectedRelationship_source() && m_AbstractionValue->getSource() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_DirectedRelationship_target() && m_AbstractionValue->getTarget() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment() && m_AbstractionValue->getOwnedComment() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedElement() && m_AbstractionValue->getOwnedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_owner() && m_AbstractionValue->getOwner().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_clientDependency() && m_AbstractionValue->getClientDependency() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression() && m_AbstractionValue->getNameExpression() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace() && m_AbstractionValue->getNamespace().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_owningTemplateParameter() && m_AbstractionValue->getOwningTemplateParameter().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_templateParameter() && m_AbstractionValue->getTemplateParameter() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Relationship_relatedElement() && m_AbstractionValue->getRelatedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
	}
