...
namespace uml 
{
	...
	class Message:virtual public NamedElement	{
		...
		public:
			...
			<p>From package UML::Interactions.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::ValueSpecification>>> getArgument() const = 0;
			...
			/*!
			 The Connector on which this Message is sent.
			<p>From package UML::Interactions.</p> */
			virtual void setConnector(std::shared_ptr<uml::Connector> _connector) = 0;
			/*!
			...
			/*!
			 References the Receiving of the Message.
			<p>From package UML::Interactions.</p> */
			virtual void setReceiveEvent(std::shared_ptr<uml::MessageEnd> _receiveEvent) = 0;
			/*!
			...
			/*!
			 References the Sending of the Message.
			<p>From package UML::Interactions.</p> */
			virtual void setSendEvent(std::shared_ptr<uml::MessageEnd> _sendEvent) = 0;
			/*!
			...
			/*!
			 The signature of the Message is the specification of its content. It refers either an Operation or a Signal.
			<p>From package UML::Interactions.</p> */
			virtual void setSignature(std::shared_ptr<uml::NamedElement> _signature) = 0;
		...
		protected:
			...
			/*!
			 The arguments of the Message.
			<p>From package UML::Interactions.</p> */
			std::shared_ptr<std::vector<std::shared_ptr<uml::ValueSpecification>>> m_argument;
			/*!
			 The Connector on which this Message is sent.
			<p>From package UML::Interactions.</p> */
