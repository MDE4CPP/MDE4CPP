...
//*********************************
std::shared_ptr<Any> ClassifierBehaviorExecutionActivity_OwnedBehaviorActivity1Impl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
	}
...
bool ClassifierBehaviorExecutionActivity_OwnedBehaviorActivity1Impl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
	}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ClassifierBehaviorExecutionActivity_OwnedBehaviorActivity1Impl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
