...
ecore::EClass* CallOperationActionImpl::eStaticClass() const
{
...
// References
//*********************************
uml::Operation *  CallOperationActionImpl::getOperation() const
{
	//assert(m_operation);
	return m_operation;
}
void CallOperationActionImpl::setOperation(uml::Operation *  _operation)
{
	m_operation = _operation;
}

uml::InputPin *  CallOperationActionImpl::getTarget() const
{
	//assert(m_target);
	return m_target;
}
void CallOperationActionImpl::setTarget(uml::InputPin *  _target)
{
	m_target = _target;
}
...
// Union Getter
//*********************************
std::vector<uml::Element * > *  CallOperationActionImpl::getOwnedElement() const
{
...
uml::Element *  CallOperationActionImpl::getOwner() const
{
...
std::vector<uml::OutputPin * > *  CallOperationActionImpl::getOutput() const
{
...
std::vector<uml::ActivityGroup * > *  CallOperationActionImpl::getInGroup() const
{
...
std::vector<uml::InputPin * > *  CallOperationActionImpl::getInput() const
{
...
std::vector<uml::RedefinableElement * > *  CallOperationActionImpl::getRedefinedElement() const
{
