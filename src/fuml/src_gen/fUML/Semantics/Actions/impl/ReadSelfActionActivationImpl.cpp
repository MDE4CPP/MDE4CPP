...
void ReadSelfActionActivationImpl::saveContent(std::shared_ptr<persistence::interfaces::XSaveHandler> saveHandler) const
{
	...
	// Add references
	if ( this->eIsSet(package->getReadSelfActionActivation_Attribute_readSelfAction()) )
	{
...
std::shared_ptr<Any> ReadSelfActionActivationImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	...
	{
		case fUML::Semantics::Actions::ActionsPackage::READSELFACTIONACTIVATION_ATTRIBUTE_READSELFACTION:
			return eAny(getReadSelfAction(),uml::umlPackage::READSELFACTION_CLASS,false); //9611
	}
...
bool ReadSelfActionActivationImpl::internalEIsSet(int featureID) const
{
	...
	{
		case fUML::Semantics::Actions::ActionsPackage::READSELFACTIONACTIVATION_ATTRIBUTE_READSELFACTION:
			return getReadSelfAction() != nullptr; //9611
	}
	return ActionActivationImpl::internalEIsSet(featureID);
}

bool ReadSelfActionActivationImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case fUML::Semantics::Actions::ActionsPackage::READSELFACTIONACTIVATION_ATTRIBUTE_READSELFACTION:
		{
			...
			if(ecoreAny)
			{
				try
				{
					...
					if(_readSelfAction)
					{
						setReadSelfAction(_readSelfAction); //9611
					}
					else
					{
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ReadSelfActionActivationImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
