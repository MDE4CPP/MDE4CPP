	...
	class FUML_API ActionsFactoryImpl : virtual public ecore::EFactoryImpl , virtual public ActionsFactory 
	{
		...
		public:
			...
			//Creator functions
			 ...
			 //Add as contained object
			 virtual std::shared_ptr<fUML::Semantics::Actions::ReturnInformation> createReturnInformation_as_value_in_ObjectToken(std::shared_ptr<fUML::Semantics::Activities::ObjectToken> par_ObjectToken, const int metaElementID = ActionsPackage::RETURNINFORMATION_CLASS) const ;
			 virtual std::shared_ptr<fUML::Semantics::Actions::ReturnInformation> createReturnInformation_as_values_in_FeatureValue(std::shared_ptr<fUML::Semantics::SimpleClassifiers::FeatureValue> par_FeatureValue, const int metaElementID = ActionsPackage::RETURNINFORMATION_CLASS) const ;
			 virtual std::shared_ptr<fUML::Semantics::Actions::ReturnInformation> createReturnInformation_as_values_in_ParameterValue(std::shared_ptr<fUML::Semantics::CommonBehavior::ParameterValue> par_ParameterValue, const int metaElementID = ActionsPackage::RETURNINFORMATION_CLASS) const ;
