...
InstantiateImpl::InstantiateImpl()
{
	...
	*/
	...
	//getter init
		//Property base_Usage
		m_getterMap.insert(std::pair<unsigned long,std::function<Any()>>(1382406183,[this](){ return eAny(this->getBase_Usage(), uml::umlPackage::USAGE_CLASS, false);}));
	
	
	//setter init
	//Property base_Usage
		m_setterMap.insert(std::pair<unsigned long,std::function<void(Any)>>(1382406183,[this](Any object){this->setBase_Usage(object->get<std::shared_ptr<uml::Usage>>());}));
	
	
	//unsetter init
		//Property base_Usage
		m_unsetterMap.insert(std::pair<unsigned long,std::function<void()>>(1382406183,[this](){m_base_Usage = std::shared_ptr<uml::Usage>(nullptr);}));
...
//*********************************
//Get
Any InstantiateImpl::get(const std::shared_ptr<uml::Property>& _property) const
{
...
Any InstantiateImpl::get(unsigned long _uID) const
{
...
//Set
void InstantiateImpl::set(const std::shared_ptr<uml::Property>& _property, const Any& value)
{
	std::string qualifiedName = _property->getQualifiedName();
    this->set(qualifiedName, value);
}

void InstantiateImpl::set(std::string _qualifiedName, const Any& value)
{
	unsigned long uID = util::Util::polynomialRollingHash(_qualifiedName);
    this->set(uID, value);
}

void InstantiateImpl::set(unsigned long _uID, const Any& value)
{
...
//*********************************
//Invoke
Any InstantiateImpl::invoke(const std::shared_ptr<uml::Operation>& _operation, const std::shared_ptr<Bag<Any>>& _arguments)
{
...
Any InstantiateImpl::invoke(std::string _qualifiedName, const std::shared_ptr<Bag<Any>>& _arguments)
{
	unsigned long uID = util::Util::polynomialRollingHash(_qualifiedName);
    return this->invoke(uID, _arguments);
}

Any InstantiateImpl::invoke(unsigned long _uID, const std::shared_ptr<Bag<Any>>& _arguments)
{
