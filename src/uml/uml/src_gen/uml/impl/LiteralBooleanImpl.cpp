...
bool LiteralBooleanImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::LITERALBOOLEAN_ATTRIBUTE_VALUE:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> LiteralBooleanImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
