...
#ifndef FOUNDATIONALMODELLIBRARY_PRIMITIVEBEHAVIORS_INTEGERFUNCTIONS_FACTORY_HPP
#define FOUNDATIONALMODELLIBRARY_PRIMITIVEBEHAVIORS_INTEGERFUNCTIONS_FACTORY_HPP
...
namespace FoundationalModelLibrary::PrimitiveBehaviors::IntegerFunctions 
{
	...
	class IntegerFunctionsFactory;

	class IntegerFunctionsFactory : virtual public uml::Factory 
	{ 
		protected:
			...
			//Package
			virtual std::shared_ptr<IntegerFunctionsPackage> getIntegerFunctionsPackage() = 0;
	};
}
#endif /* end of include guard: FOUNDATIONALMODELLIBRARY_PRIMITIVEBEHAVIORS_INTEGERFUNCTIONS_FACTORY_HPP */
