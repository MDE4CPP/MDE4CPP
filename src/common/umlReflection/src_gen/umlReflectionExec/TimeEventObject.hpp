...
#ifndef UML_TIMEEVENT_EXECUTION_HPP
#define UML_TIMEEVENT_EXECUTION_HPP
...
namespace UML 
{
	class TimeEventObject : virtual public UML::EventObject
	{
		public:
		    //constructors
		    TimeEventObject(TimeEventObject &obj);
		    TimeEventObject(std::shared_ptr<uml::TimeEvent>);
		 	TimeEventObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::TimeEvent> getTimeEventValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setTimeEventValue(std::shared_ptr<uml::TimeEvent>);
			virtual void setThisTimeEventObjectPtr(std::weak_ptr<TimeEventObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::TimeEvent> m_TimeEventValue = nullptr;
	};
}
#endif /* end of include guard: UML_TIMEEVENT_OBJECT_HPP */
