...
namespace PSCS::Semantics::Actions 
{
	/*!
	 */
	class CS_AddStructuralFeatureValueActionActivation : virtual public ecore::EObject 

	{
		...
		public:
			...
			//destructor
			virtual ~CS_AddStructuralFeatureValueActionActivation() {}
			...
			/*!
			 */ 
			virtual void doActionDefault() = 0;
...
#endif /* end of include guard: PSCS_SEMANTICS_ACTIONS_CS_ADDSTRUCTURALFEATUREVALUEACTIONACTIVATION_HPP */
