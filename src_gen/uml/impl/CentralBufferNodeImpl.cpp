...
ecore::EClass* CentralBufferNodeImpl::eStaticClass() const
{
...
// Union Getter
//*********************************
uml::Element *  CentralBufferNodeImpl::getOwner() const
{
...
std::vector<uml::ActivityGroup * > *  CentralBufferNodeImpl::getInGroup() const
{
...
std::vector<uml::RedefinableElement * > *  CentralBufferNodeImpl::getRedefinedElement() const
{
...
std::vector<uml::Element * > *  CentralBufferNodeImpl::getOwnedElement() const
{
