...
namespace fUML::Semantics::Actions 
{
	class FUML_API SendSignalActionActivationImpl : virtual public InvocationActionActivationImpl, virtual public SendSignalActionActivation 
	{
		...
		protected:
			...
			virtual std::shared_ptr<fUML::Semantics::Actions::SendSignalActionActivation> getThisSendSignalActionActivationPtr() const;
			virtual void setThisSendSignalActionActivationPtr(std::weak_ptr<fUML::Semantics::Actions::SendSignalActionActivation> thisSendSignalActionActivationPtr);
		...
		public:
			...
			//*********************************
			virtual const std::shared_ptr<uml::SendSignalAction>& getSendSignalAction() const ;
			virtual void setSendSignalAction(const std::shared_ptr<uml::SendSignalAction>&) ;
		...
		private:
			std::weak_ptr<fUML::Semantics::Actions::SendSignalActionActivation> m_thisSendSignalActionActivationPtr;
	};
}
