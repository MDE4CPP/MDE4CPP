...
std::shared_ptr<fUML::Semantics::Values::Value> InstanceValueEvaluationImpl::evaluate()
{
	...
	const std::shared_ptr<uml::InstanceSpecification>& instance = (std::dynamic_pointer_cast<uml::InstanceValue>(this->getSpecification()))->getInstance();
	const std::shared_ptr<Bag<uml::Classifier>>& types = instance->getClassifier();
...
const std::shared_ptr<ecore::EClass>& InstanceValueEvaluationImpl::eStaticClass() const
{
...
bool InstanceValueEvaluationImpl::eSet(int featureID, const Any& newValue)
{
	switch(featureID)
	{
	}
...
// EOperation Invoke
//*********************************
Any InstanceValueEvaluationImpl::eInvoke(int operationID, const std::shared_ptr<std::list<Any>>& arguments)
{
	Any result;
