...
bool CollectionTypeExpImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::COLLECTIONTYPEEXP_ATTRIBUTE_INNERTYPE:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> CollectionTypeExpImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
