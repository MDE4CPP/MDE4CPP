...
#ifndef UML_STARTCLASSIFIERBEHAVIORACTION_EXECUTION_HPP
#define UML_STARTCLASSIFIERBEHAVIORACTION_EXECUTION_HPP
...
namespace UML 
{
	class StartClassifierBehaviorActionObject : virtual public UML::ActionObject
	{
		public:
		    //constructors
		    StartClassifierBehaviorActionObject(StartClassifierBehaviorActionObject &obj);
		    StartClassifierBehaviorActionObject(std::shared_ptr<uml::StartClassifierBehaviorAction>);
		 	StartClassifierBehaviorActionObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::StartClassifierBehaviorAction> getStartClassifierBehaviorActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setStartClassifierBehaviorActionValue(std::shared_ptr<uml::StartClassifierBehaviorAction>);
			virtual void setThisStartClassifierBehaviorActionObjectPtr(std::weak_ptr<StartClassifierBehaviorActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::StartClassifierBehaviorAction> m_StartClassifierBehaviorActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_STARTCLASSIFIERBEHAVIORACTION_OBJECT_HPP */
