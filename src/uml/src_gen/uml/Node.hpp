...
namespace uml 
{
	...
	class Node:virtual public Class,virtual public DeploymentTarget
	{
		...
		public:
			...
			virtual std::shared_ptr<uml::CommunicationPath> createCommunicationPath(bool end1IsNavigable,AggregationKind end1Aggregation,std::string end1Name,int end1Lower,unsigned int end1Upper,std::shared_ptr<uml::Node>  end1Node,bool end2IsNavigable,AggregationKind end2Aggregation,std::string end2Name,int end2Lower,unsigned int end2Upper) = 0;
