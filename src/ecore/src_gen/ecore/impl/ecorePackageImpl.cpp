...
const std::shared_ptr<ecore::EOperation>& ecore::ecorePackageImpl::getEObject_Operation_eInvoke_EOperation_EJavaObject() const
{
...
const std::shared_ptr<ecore::EAttribute>& ecore::ecorePackageImpl::getEObjectAny_Attribute_any() const
{
...
const std::shared_ptr<ecore::EOperation>& ecore::ecorePackageImpl::getEOperation_Operation_getOperationID() const
{
...
const std::shared_ptr<ecore::EOperation>& ecore::ecorePackageImpl::getEStructuralFeature_Operation_getFeatureID() const
{
