...
void ActivitiesPackageImpl::createActivityNodeActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_activityNodeActivation_Operation_initialize_ActivityNode_ActivityNodeActivationGroup = factory->createEOperation_as_eOperations_in_EClass(m_activityNodeActivation_Class, ACTIVITYNODEACTIVATION_OPERATION_INITIALIZE_ACTIVITYNODE_ACTIVITYNODEACTIVATIONGROUP);
