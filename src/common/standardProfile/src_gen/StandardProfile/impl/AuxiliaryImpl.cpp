...
AuxiliaryImpl::AuxiliaryImpl()
{
	...
	*/
	...
	//getter init
		//Property base_Class
		m_getterMap.insert(std::pair<long long,std::function<Any()>>(1570824721,[this](){ return eAny(this->getBase_Class(), uml::umlPackage::CLASS_CLASS, false);}));
	
	
	//setter init
	//Property base_Class
		m_setterMap.insert(std::pair<long long,std::function<void(Any)>>(1570824721,[this](Any object){this->setBase_Class(object->get<std::shared_ptr<uml::Class>>());}));
	
	
	//unsetter init
		//Property base_Class
		m_unsetterMap.insert(std::pair<long long,std::function<void()>>(1570824721,[this](){m_base_Class = std::shared_ptr<uml::Class>(nullptr);}));
...
Any AuxiliaryImpl::get(long long _uID) const
{
...
void AuxiliaryImpl::set(long long _uID, Any value)
{
...
void AuxiliaryImpl::unset(long long _uID)
{
...
Any AuxiliaryImpl::invoke(long long _uID, std::shared_ptr<Bag<Any>> _arguments)
{
