...
{	
	...
	m_ConnectorValue.reset();

	fUML::Semantics::StructuredClassifiers::ObjectImpl::destroy();
}

std::shared_ptr<uml::Element> ConnectorObject::getUmlValue() const
{
	return getConnectorValue();
}

std::shared_ptr<uml::Connector> ConnectorObject::getConnectorValue() const
{
	return m_ConnectorValue;
}

void ConnectorObject::setUmlValue(std::shared_ptr<uml::Element> _element)
{
	setConnectorValue(std::dynamic_pointer_cast<uml::Connector>(_element));
}

void ConnectorObject::setConnectorValue(std::shared_ptr<uml::Connector> _ConnectorElement)
{
	m_ConnectorValue = _ConnectorElement;
	//set super type values
	UML::FeatureObject::setFeatureValue(_ConnectorElement);
}

void ConnectorObject::setThisConnectorObjectPtr(std::weak_ptr<ConnectorObject> thisObjectPtr)
{
	setThisCS_ObjectPtr(thisObjectPtr);
}

bool ConnectorObject::equals(std::shared_ptr<fUML::Semantics::Values::Value> otherValue)
{
	bool isEqual = false;
	
	std::shared_ptr<ConnectorObject> otherConnectorObject = std::dynamic_pointer_cast<ConnectorObject>(otherValue);

	if(otherConnectorObject != nullptr)
	{
		if(this->getConnectorValue() == otherConnectorObject->getConnectorValue())
		{
			isEqual = true;
		}
	}
...
std::string ConnectorObject::toString()
{
	std::string buffer = "Instance of 'ConnectorObject', " + std::to_string(getTypes()->size()) + " types (";
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Object>> ConnectorObject::getDirectContainers()
{   
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Link>> ConnectorObject::getLinks(std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_InteractionPoint> interactionPoint)
{
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> ConnectorObject::retrieveEndValueAsInteractionPoint(std::shared_ptr<fUML::Semantics::Values::Value> endValue, std::shared_ptr<uml::ConnectorEnd> end)
{
	return nullptr;
}

void ConnectorObject::removeValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<fUML::Semantics::Values::Value> value)
{
	...
	if (m_ConnectorValue == nullptr)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": no value stored inside ConnectorObject (property: " << feature->getName() << ")" << std::endl;
		throw "NullPointerException";	
	}

	if (feature == UML::UMLPackage::eInstance()->get_UML_Connector_contract())
	{
		if (value == nullptr) // clear mode
		{
			m_ConnectorValue->getContract()->clear();
		}
		else
		{
			...
			{
				m_ConnectorValue->getContract()->erase(inputValue->getBehaviorValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Connector_end())
	{
		...
		else
		{
			...
			std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = std::dynamic_pointer_cast<PSCS::Semantics::StructuredClassifiers::CS_Reference>(value); */
			std::shared_ptr<fUML::Semantics::StructuredClassifiers::Reference> reference = std::dynamic_pointer_cast<fUML::Semantics::StructuredClassifiers::Reference>(value);
			std::shared_ptr<UML::ConnectorEndObject> inputValue = std::dynamic_pointer_cast<UML::ConnectorEndObject>(reference->getReferent());
			if (inputValue != nullptr)
			{
				m_ConnectorValue->getEnd()->erase(inputValue->getConnectorEndValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Connector_redefinedConnector())
	{
		if (value == nullptr) // clear mode
		{
			m_ConnectorValue->getRedefinedConnector()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ConnectorValue->getRedefinedConnector()->erase(inputValue->getConnectorValue());
			}
		}
	}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		if (value == nullptr) // clear mode
		{
			m_ConnectorValue->getOwnedComment()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ConnectorValue->getOwnedComment()->erase(inputValue->getCommentValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Feature_isStatic())
	{
				m_ConnectorValue->setIsStatic(false /*defined default value*/);
	...
	{
				m_ConnectorValue->setIsLeaf(false /*defined default value*/);

	}
}


std::shared_ptr<Bag<fUML::Semantics::Values::Value>> ConnectorObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	if (feature->getMetaElementID() != uml::UmlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::UmlPackage::PORT_CLASS && feature->getMetaElementID() != uml::UmlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Connector_contract())
	{
		std::shared_ptr<Bag<uml::Behavior>> contractList = m_ConnectorValue->getContract();
		Bag<uml::Behavior>::iterator iter = contractList->begin();
		Bag<uml::Behavior>::iterator end = contractList->end();
		while (iter != end)
		{
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Connector_kind())
	{
		uml::ConnectorKind kind = m_ConnectorValue->getKind();
		...
		if (kind == uml::ConnectorKind::ASSEMBLY)
		{
			value->setLiteral(UML::UMLPackage::eInstance()->get_UML_ConnectorKind_assembly());
		}
		if (kind == uml::ConnectorKind::DELEGATION)
		{
			value->setLiteral(UML::UMLPackage::eInstance()->get_UML_ConnectorKind_delegation());
		}
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Connector_redefinedConnector())
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Connector_type())
	{
		...
		value->setLocus(this->getLocus());
		value->setAssociationValue(m_ConnectorValue->getType());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_owner())
	{
		...
		value->setThisElementObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setElementValue(m_ConnectorValue->getOwner().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Feature_isStatic())
	{
		...
		value->setValue(m_ConnectorValue->getIsStatic());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_clientDependency())
	{
		std::shared_ptr<Bag<uml::Dependency>> clientDependencyList = m_ConnectorValue->getClientDependency();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		value->setValue(m_ConnectorValue->getName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		value->setLocus(this->getLocus());
		value->setStringExpressionValue(m_ConnectorValue->getNameExpression());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace())
	{
		...
		value->setLocus(this->getLocus());
		value->setNamespaceValue(m_ConnectorValue->getNamespace().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::StringValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createStringValue();
		value->setValue(m_ConnectorValue->getQualifiedName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		uml::VisibilityKind visibility = m_ConnectorValue->getVisibility();
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::EnumerationValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createEnumerationValue();
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_ConnectorValue->getIsLeaf());
		values->add(value);
	}
...
std::shared_ptr<fUML::Semantics::SimpleClassifiers::FeatureValue> ConnectorObject::retrieveFeatureValue(std::shared_ptr<uml::StructuralFeature> feature)
{
...
void ConnectorObject::setFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	if (feature->getMetaElementID() != uml::UmlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::UmlPackage::PORT_CLASS && feature->getMetaElementID() != uml::UmlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Connector_contract())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ConnectorValue->getContract()->push_back(value->getBehaviorValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Connector_end())
	{
		...
		while (iter != end)
		{
			std::shared_ptr<fUML::Semantics::Values::Value> inputValue = *iter;
			std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = std::dynamic_pointer_cast<PSCS::Semantics::StructuredClassifiers::CS_Reference>(inputValue);
			std::shared_ptr<UML::ConnectorEndObject> value = std::dynamic_pointer_cast<UML::ConnectorEndObject>(reference->getReferent());
			if (value != nullptr)
			{
				m_ConnectorValue->getEnd()->push_back(value->getConnectorEndValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Connector_redefinedConnector())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ConnectorValue->getRedefinedConnector()->push_back(value->getConnectorValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Connector_type())
	{
		...
		if (value != nullptr)
		{
			m_ConnectorValue->setType(value->getAssociationValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ConnectorValue->getOwnedComment()->push_back(value->getCommentValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Feature_isStatic())
	{
		...
		{
			m_ConnectorValue->setIsStatic(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		if (valueObject != nullptr)
		{
			m_ConnectorValue->setName(valueObject->getValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		if (value != nullptr)
		{
			m_ConnectorValue->setNameExpression(value->getStringExpressionValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		...
		{
			m_ConnectorValue->setVisibility(uml::VisibilityKind::PUBLIC);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_private())
		{
			m_ConnectorValue->setVisibility(uml::VisibilityKind::PRIVATE);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_protected())
		{
			m_ConnectorValue->setVisibility(uml::VisibilityKind::PROTECTED);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_package())
		{
			m_ConnectorValue->setVisibility(uml::VisibilityKind::PACKAGE);
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_isLeaf())
	{
		...
		if (valueObject != nullptr)
		{
			m_ConnectorValue->setIsLeaf(valueObject->isValue());
		}
		
	}
}

void ConnectorObject::assignFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	this->setFeatureValue(feature, values, position);
}

std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> ConnectorObject::retrieveFeatureValues()
{
	...
	for(unsigned int i = 0; i < allAttributesSize; i++)
	{
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_Connector_contract() && m_ConnectorValue->getContract() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Connector_end() && m_ConnectorValue->getEnd() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Connector_redefinedConnector() && m_ConnectorValue->getRedefinedConnector() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Connector_type() && m_ConnectorValue->getType() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment() && m_ConnectorValue->getOwnedComment() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedElement() && m_ConnectorValue->getOwnedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_owner() && m_ConnectorValue->getOwner().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Feature_featuringClassifier() && m_ConnectorValue->getFeaturingClassifier() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_clientDependency() && m_ConnectorValue->getClientDependency() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression() && m_ConnectorValue->getNameExpression() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace() && m_ConnectorValue->getNamespace().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_redefinedElement() && m_ConnectorValue->getRedefinedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_redefinitionContext() && m_ConnectorValue->getRedefinitionContext() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
	}
