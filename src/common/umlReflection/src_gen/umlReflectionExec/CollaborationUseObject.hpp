...
#ifndef UML_COLLABORATIONUSE_EXECUTION_HPP
#define UML_COLLABORATIONUSE_EXECUTION_HPP
...
namespace UML 
{
	class CollaborationUseObject : virtual public UML::NamedElementObject
	{
		public:
		    //constructors
		    CollaborationUseObject(CollaborationUseObject &obj);
		    CollaborationUseObject(std::shared_ptr<uml::CollaborationUse>);
		 	CollaborationUseObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::CollaborationUse> getCollaborationUseValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setCollaborationUseValue(std::shared_ptr<uml::CollaborationUse>);
			virtual void setThisCollaborationUseObjectPtr(std::weak_ptr<CollaborationUseObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::CollaborationUse> m_CollaborationUseValue = nullptr;
	};
}
#endif /* end of include guard: UML_COLLABORATIONUSE_OBJECT_HPP */
