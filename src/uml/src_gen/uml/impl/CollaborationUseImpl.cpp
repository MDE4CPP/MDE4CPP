...
CollaborationUseImpl::CollaborationUseImpl(const CollaborationUseImpl & obj): NamedElementImpl(obj), CollaborationUse(obj)
{
	...
	for(auto _roleBinding : *obj.getRoleBinding()) 
	{
