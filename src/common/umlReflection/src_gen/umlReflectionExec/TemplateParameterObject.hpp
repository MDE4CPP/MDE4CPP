...
#ifndef UML_TEMPLATEPARAMETER_EXECUTION_HPP
#define UML_TEMPLATEPARAMETER_EXECUTION_HPP
...
namespace UML 
{
	class TemplateParameterObject : virtual public UML::ElementObject
	{
		public:
		    //constructors
		    TemplateParameterObject(TemplateParameterObject &obj);
		    TemplateParameterObject(std::shared_ptr<uml::TemplateParameter>);
		 	TemplateParameterObject();
		    //destructor
		    virtual ~TemplateParameterObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			TemplateParameterObject& operator=(TemplateParameterObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::TemplateParameter> getTemplateParameterValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setTemplateParameterValue(std::shared_ptr<uml::TemplateParameter>);
			virtual void setThisTemplateParameterObjectPtr(std::weak_ptr<TemplateParameterObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::TemplateParameter> m_TemplateParameterValue = nullptr;
	};
}
#endif /* end of include guard: UML_TEMPLATEPARAMETER_OBJECT_HPP */
