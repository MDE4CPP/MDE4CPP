...
void ExpansionRegionActivationImpl::doOutput()
{
	...
	if (!isSuspended())
	{
		...
		for (unsigned int i=0; i<activationGroupsSize; i++)
		{
			...
			const std::shared_ptr<Bag<fUML::Semantics::Activities::ExpansionNodeActivation>>& groupOutputs = activationGroup->getGroupOutputs();
...
void ExpansionRegionActivationImpl::doStructuredActivity()
{
	...
	while (k < n)
	{
		...
		const std::shared_ptr<Bag<fUML::Semantics::Activities::ExpansionNodeActivation>>& groupInputsList = activationGroup->getGroupInputs();
		const std::shared_ptr<Bag<fUML::Semantics::Activities::ExpansionNodeActivation>>& groupOutputsList = activationGroup->getGroupOutputs();
...
std::shared_ptr<fUML::Semantics::Activities::ExpansionNodeActivation> ExpansionRegionActivationImpl::getExpansionNodeActivation(const std::shared_ptr<uml::ExpansionNode>& node)
{
	//ADD_COUNT(__PRETTY_FUNCTION__)
	//generated from body annotation
...
void ExpansionRegionActivationImpl::resume(const std::shared_ptr<fUML::Semantics::Activities::ExpansionActivationGroup>& activationGroup)
{
	//ADD_COUNT(__PRETTY_FUNCTION__)
	//generated from body annotation
	std::shared_ptr<uml::ExpansionRegion> region = std::dynamic_pointer_cast<uml::ExpansionRegion>(m_node);
...
void ExpansionRegionActivationImpl::runGroup(const std::shared_ptr<fUML::Semantics::Activities::ExpansionActivationGroup>& activationGroup)
{
	//ADD_COUNT(__PRETTY_FUNCTION__)
	//generated from body annotation
	if (isRunning())
...
std::shared_ptr<Bag<fUML::Semantics::Activities::Token>> ExpansionRegionActivationImpl::takeOfferedTokens()
{
	...
	while (inputElementIter != inputElementEnd)
	{
		...
		std::shared_ptr<TokenSet> tokenSet = fUML::Semantics::Activities::ActivitiesFactory::eInstance()->createTokenSet();
		int j = 0;
		const std::shared_ptr<Bag<Token>>& tokenSetTokens = tokenSet->getTokens();
		while (j < n)
		{
...
void ExpansionRegionActivationImpl::terminateGroup(const std::shared_ptr<fUML::Semantics::Activities::ExpansionActivationGroup>& activationGroup)
{
	//ADD_COUNT(__PRETTY_FUNCTION__)
	//generated from body annotation
...
const std::shared_ptr<Bag<fUML::Semantics::Activities::ExpansionActivationGroup>>& ExpansionRegionActivationImpl::getActivationGroups() const
{
...
bool ExpansionRegionActivationImpl::eSet(int featureID, const Any& newValue)
{
	switch(featureID)
	{
		case fUML::Semantics::Activities::ActivitiesPackage::EXPANSIONREGIONACTIVATION_ATTRIBUTE_ACTIVATIONGROUPS:
...
// EOperation Invoke
//*********************************
Any ExpansionRegionActivationImpl::eInvoke(int operationID, const std::shared_ptr<std::list<Any>>& arguments)
{
	Any result;
