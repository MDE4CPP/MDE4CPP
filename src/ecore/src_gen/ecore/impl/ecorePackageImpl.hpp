...
namespace ecore
{
	class ECORE_API ecorePackageImpl : public EPackageImpl ,virtual public ecorePackage
	{
		...
		public:
			...
			virtual const std::shared_ptr<ecore::EOperation>& getEObject_Operation_eInvoke_EOperation_EEList() const ;
			...
			virtual const std::shared_ptr<ecore::EReference>& getEObjectAny_Attribute_any() const ;
			...
			virtual const std::shared_ptr<ecore::EAttribute>& getEOperation_Attribute_operationID() const ;
			...
			virtual const std::shared_ptr<ecore::EAttribute>& getEStructuralFeature_Attribute_featureID() const ;
