...
namespace uml
{
	class UmlPackageImpl : public ecore::EPackageImpl ,virtual public UmlPackage
	{
		...
		private:
			std::shared_ptr<ecore::EClass> m_abstraction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_acceptCallAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_acceptEventAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_action_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_actionExecutionSpecification_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_actionInputPin_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_activity_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_activityContent_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_activityEdge_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_activityFinalNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_activityGroup_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_activityNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_activityParameterNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_activityPartition_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_actor_Class = nullptr;
			...
			std::shared_ptr<ecore::EClass> m_behavior_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_behaviorExecutionSpecification_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_behavioralFeature_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_behavioredClassifier_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_broadcastSignalAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_callAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_callBehaviorAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_callEvent_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_callOperationAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_centralBufferNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_changeEvent_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_class_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_classifier_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_classifierTemplateParameter_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_clause_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_clearAssociationAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_clearStructuralFeatureAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_clearVariableAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_collaboration_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_collaborationUse_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_combinedFragment_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_comment_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_communicationPath_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_component_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_componentRealization_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_conditionalNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_connectableElement_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_connectableElementTemplateParameter_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_connectionPointReference_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_connector_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_connectorEnd_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_considerIgnoreFragment_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_constraint_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_continuation_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_controlFlow_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_controlNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_createLinkAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_createLinkObjectAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_createObjectAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_dataStoreNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_dataType_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_decisionNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_dependency_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_deployedArtifact_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_deployment_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_deploymentSpecification_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_deploymentTarget_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_destroyLinkAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_destroyObjectAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_destructionOccurrenceSpecification_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_device_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_directedRelationship_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_duration_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_durationConstraint_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_durationInterval_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_durationObservation_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_element_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_elementImport_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_encapsulatedClassifier_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_enumeration_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_enumerationLiteral_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_event_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_exceptionHandler_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_executableNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_executionEnvironment_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_executionOccurrenceSpecification_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_executionSpecification_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_expansionNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_expansionRegion_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_expression_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_extend_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_extension_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_extensionEnd_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_extensionPoint_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_factory_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_feature_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_finalNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_finalState_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_flowFinalNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_forkNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_functionBehavior_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_gate_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_generalOrdering_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_generalization_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_generalizationSet_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_image_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_include_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_informationFlow_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_informationItem_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_initialNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_inputPin_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_instanceSpecification_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_instanceValue_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_interaction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_interactionConstraint_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_interactionFragment_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_interactionOperand_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_interactionUse_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_interface_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_interfaceRealization_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_interruptibleActivityRegion_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_interval_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_intervalConstraint_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_invocationAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_joinNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_lifeline_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_linkAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_linkEndCreationData_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_linkEndData_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_linkEndDestructionData_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_literalBoolean_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_literalInteger_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_literalNull_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_literalReal_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_literalSpecification_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_literalString_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_literalUnlimitedNatural_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_loopNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_manifestation_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_mergeNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_message_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_messageEnd_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_messageEvent_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_messageOccurrenceSpecification_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_model_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_multiplicityElement_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_namedElement_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_namespace_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_node_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_object_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_objectFlow_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_objectNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_observation_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_occurrenceSpecification_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_opaqueAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_opaqueBehavior_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_opaqueExpression_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_operation_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_operationTemplateParameter_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_outputPin_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_package_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_packageImport_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_packageMerge_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_packageableElement_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_parameter_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_parameterSet_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_parameterableElement_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_partDecomposition_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_pin_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_port_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_primitiveType_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_profile_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_profileApplication_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_property_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_protocolConformance_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_protocolStateMachine_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_protocolTransition_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_pseudostate_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_qualifierValue_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_raiseExceptionAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_readExtentAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_readIsClassifiedObjectAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_readLinkAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_readLinkObjectEndAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_readLinkObjectEndQualifierAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_readSelfAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_readStructuralFeatureAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_readVariableAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_realization_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_reception_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_reclassifyObjectAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_redefinableElement_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_redefinableTemplateSignature_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_reduceAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_region_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_relationship_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_removeStructuralFeatureValueAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_removeVariableValueAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_replyAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_sendObjectAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_sendSignalAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_sequenceNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_signal_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_signalEvent_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_slot_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_startClassifierBehaviorAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_startObjectBehaviorAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_state_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_stateInvariant_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_stateMachine_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_stereotype_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_stringExpression_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_structuralFeature_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_structuralFeatureAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_structuredActivityNode_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_structuredClassifier_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_substitution_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_templateBinding_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_templateParameter_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_templateParameterSubstitution_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_templateSignature_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_templateableElement_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_testIdentityAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_timeConstraint_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_timeEvent_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_timeExpression_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_timeInterval_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_timeObservation_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_transition_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_trigger_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_type_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_typedElement_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_unmarshallAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_usage_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_useCase_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_valuePin_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_valueSpecification_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_valueSpecificationAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_variable_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_variableAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_vertex_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_writeLinkAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_writeStructuralFeatureAction_Class = nullptr;
			std::shared_ptr<ecore::EClass> m_writeVariableAction_Class = nullptr;
			
			std::shared_ptr<ecore::EEnum> m_aggregationKind_Class = nullptr;
			std::shared_ptr<ecore::EEnum> m_callConcurrencyKind_Class = nullptr;
			std::shared_ptr<ecore::EEnum> m_connectorKind_Class = nullptr;
			std::shared_ptr<ecore::EEnum> m_expansionKind_Class = nullptr;
			std::shared_ptr<ecore::EEnum> m_interactionOperatorKind_Class = nullptr;
			std::shared_ptr<ecore::EEnum> m_messageKind_Class = nullptr;
			std::shared_ptr<ecore::EEnum> m_messageSort_Class = nullptr;
			std::shared_ptr<ecore::EEnum> m_objectNodeOrderingKind_Class = nullptr;
			std::shared_ptr<ecore::EEnum> m_parameterDirectionKind_Class = nullptr;
			std::shared_ptr<ecore::EEnum> m_parameterEffectKind_Class = nullptr;
			std::shared_ptr<ecore::EEnum> m_pseudostateKind_Class = nullptr;
			std::shared_ptr<ecore::EEnum> m_transitionKind_Class = nullptr;
			std::shared_ptr<ecore::EEnum> m_visibilityKind_Class = nullptr;
			
			std::shared_ptr<ecore::EAttribute> m_package_Attribute_uRI = nullptr;
			std::shared_ptr<ecore::EAttribute> m_property_Attribute_aggregation = nullptr;
			std::shared_ptr<ecore::EAttribute> m_elementImport_Attribute_alias = nullptr;
			std::shared_ptr<ecore::EAttribute> m_classifierTemplateParameter_Attribute_allowSubstitutable = nullptr;
			std::shared_ptr<ecore::EAttribute> m_comment_Attribute_body = nullptr;
			std::shared_ptr<ecore::EAttribute> m_opaqueExpression_Attribute_body = nullptr;
			std::shared_ptr<ecore::EAttribute> m_opaqueAction_Attribute_body = nullptr;
			std::shared_ptr<ecore::EAttribute> m_opaqueBehavior_Attribute_body = nullptr;
			std::shared_ptr<ecore::EAttribute> m_behavioralFeature_Attribute_concurrency = nullptr;
			std::shared_ptr<ecore::EAttribute> m_image_Attribute_content = nullptr;
			std::shared_ptr<ecore::EAttribute> m_property_Attribute_default = nullptr;
			std::shared_ptr<ecore::EAttribute> m_parameter_Attribute_default = nullptr;
			std::shared_ptr<ecore::EAttribute> m_deploymentSpecification_Attribute_deploymentLocation = nullptr;
			std::shared_ptr<ecore::EAttribute> m_parameter_Attribute_direction = nullptr;
			std::shared_ptr<ecore::EAttribute> m_parameter_Attribute_effect = nullptr;
			std::shared_ptr<ecore::EAttribute> m_deploymentSpecification_Attribute_executionLocation = nullptr;
			std::shared_ptr<ecore::EAttribute> m_artifact_Attribute_fileName = nullptr;
			std::shared_ptr<ecore::EAttribute> m_durationConstraint_Attribute_firstEvent = nullptr;
			std::shared_ptr<ecore::EAttribute> m_durationObservation_Attribute_firstEvent = nullptr;
			std::shared_ptr<ecore::EAttribute> m_timeConstraint_Attribute_firstEvent = nullptr;
			std::shared_ptr<ecore::EAttribute> m_timeObservation_Attribute_firstEvent = nullptr;
			std::shared_ptr<ecore::EAttribute> m_image_Attribute_format = nullptr;
			std::shared_ptr<ecore::EAttribute> m_combinedFragment_Attribute_interactionOperator = nullptr;
			std::shared_ptr<ecore::EAttribute> m_classifier_Attribute_isAbstract = nullptr;
			std::shared_ptr<ecore::EAttribute> m_behavioralFeature_Attribute_isAbstract = nullptr;
			std::shared_ptr<ecore::EAttribute> m_class_Attribute_isActive = nullptr;
			std::shared_ptr<ecore::EAttribute> m_conditionalNode_Attribute_isAssured = nullptr;
			std::shared_ptr<ecore::EAttribute> m_port_Attribute_isBehavior = nullptr;
			std::shared_ptr<ecore::EAttribute> m_joinNode_Attribute_isCombineDuplicate = nullptr;
			std::shared_ptr<ecore::EAttribute> m_property_Attribute_isComposite = nullptr;
			std::shared_ptr<ecore::EAttribute> m_state_Attribute_isComposite = nullptr;
			std::shared_ptr<ecore::EAttribute> m_port_Attribute_isConjugated = nullptr;
			std::shared_ptr<ecore::EAttribute> m_pin_Attribute_isControl = nullptr;
			std::shared_ptr<ecore::EAttribute> m_objectNode_Attribute_isControlType = nullptr;
			std::shared_ptr<ecore::EAttribute> m_generalizationSet_Attribute_isCovering = nullptr;
			std::shared_ptr<ecore::EAttribute> m_association_Attribute_isDerived = nullptr;
			std::shared_ptr<ecore::EAttribute> m_property_Attribute_isDerived = nullptr;
			std::shared_ptr<ecore::EAttribute> m_property_Attribute_isDerivedUnion = nullptr;
			std::shared_ptr<ecore::EAttribute> m_linkEndDestructionData_Attribute_isDestroyDuplicates = nullptr;
			std::shared_ptr<ecore::EAttribute> m_destroyObjectAction_Attribute_isDestroyLinks = nullptr;
			std::shared_ptr<ecore::EAttribute> m_destroyObjectAction_Attribute_isDestroyOwnedObjects = nullptr;
			std::shared_ptr<ecore::EAttribute> m_conditionalNode_Attribute_isDeterminate = nullptr;
			std::shared_ptr<ecore::EAttribute> m_activityPartition_Attribute_isDimension = nullptr;
			std::shared_ptr<ecore::EAttribute> m_readIsClassifiedObjectAction_Attribute_isDirect = nullptr;
			std::shared_ptr<ecore::EAttribute> m_generalizationSet_Attribute_isDisjoint = nullptr;
			std::shared_ptr<ecore::EAttribute> m_parameter_Attribute_isException = nullptr;
			std::shared_ptr<ecore::EAttribute> m_activityPartition_Attribute_isExternal = nullptr;
			std::shared_ptr<ecore::EAttribute> m_classifier_Attribute_isFinalSpecialization = nullptr;
			std::shared_ptr<ecore::EAttribute> m_property_Attribute_isID = nullptr;
			std::shared_ptr<ecore::EAttribute> m_component_Attribute_isIndirectlyInstantiated = nullptr;
			std::shared_ptr<ecore::EAttribute> m_redefinableElement_Attribute_isLeaf = nullptr;
			std::shared_ptr<ecore::EAttribute> m_action_Attribute_isLocallyReentrant = nullptr;
			std::shared_ptr<ecore::EAttribute> m_objectFlow_Attribute_isMulticast = nullptr;
			std::shared_ptr<ecore::EAttribute> m_objectFlow_Attribute_isMultireceive = nullptr;
			std::shared_ptr<ecore::EAttribute> m_multiplicityElement_Attribute_isOrdered = nullptr;
			std::shared_ptr<ecore::EAttribute> m_operation_Attribute_isOrdered = nullptr;
			std::shared_ptr<ecore::EAttribute> m_reduceAction_Attribute_isOrdered = nullptr;
			std::shared_ptr<ecore::EAttribute> m_state_Attribute_isOrthogonal = nullptr;
			std::shared_ptr<ecore::EAttribute> m_operation_Attribute_isQuery = nullptr;
			std::shared_ptr<ecore::EAttribute> m_activity_Attribute_isReadOnly = nullptr;
			std::shared_ptr<ecore::EAttribute> m_structuralFeature_Attribute_isReadOnly = nullptr;
			std::shared_ptr<ecore::EAttribute> m_behavior_Attribute_isReentrant = nullptr;
			std::shared_ptr<ecore::EAttribute> m_timeEvent_Attribute_isRelative = nullptr;
			std::shared_ptr<ecore::EAttribute> m_removeStructuralFeatureValueAction_Attribute_isRemoveDuplicates = nullptr;
			std::shared_ptr<ecore::EAttribute> m_removeVariableValueAction_Attribute_isRemoveDuplicates = nullptr;
			std::shared_ptr<ecore::EAttribute> m_addStructuralFeatureValueAction_Attribute_isReplaceAll = nullptr;
			std::shared_ptr<ecore::EAttribute> m_addVariableValueAction_Attribute_isReplaceAll = nullptr;
			std::shared_ptr<ecore::EAttribute> m_linkEndCreationData_Attribute_isReplaceAll = nullptr;
			std::shared_ptr<ecore::EAttribute> m_reclassifyObjectAction_Attribute_isReplaceAll = nullptr;
			std::shared_ptr<ecore::EAttribute> m_extension_Attribute_isRequired = nullptr;
			std::shared_ptr<ecore::EAttribute> m_port_Attribute_isService = nullptr;
			std::shared_ptr<ecore::EAttribute> m_state_Attribute_isSimple = nullptr;
			std::shared_ptr<ecore::EAttribute> m_activity_Attribute_isSingleExecution = nullptr;
			std::shared_ptr<ecore::EAttribute> m_feature_Attribute_isStatic = nullptr;
			std::shared_ptr<ecore::EAttribute> m_parameter_Attribute_isStream = nullptr;
			std::shared_ptr<ecore::EAttribute> m_profileApplication_Attribute_isStrict = nullptr;
			std::shared_ptr<ecore::EAttribute> m_state_Attribute_isSubmachineState = nullptr;
			std::shared_ptr<ecore::EAttribute> m_generalization_Attribute_isSubstitutable = nullptr;
			std::shared_ptr<ecore::EAttribute> m_callAction_Attribute_isSynchronous = nullptr;
			std::shared_ptr<ecore::EAttribute> m_loopNode_Attribute_isTestedFirst = nullptr;
			std::shared_ptr<ecore::EAttribute> m_multiplicityElement_Attribute_isUnique = nullptr;
			std::shared_ptr<ecore::EAttribute> m_operation_Attribute_isUnique = nullptr;
			std::shared_ptr<ecore::EAttribute> m_acceptEventAction_Attribute_isUnmarshall = nullptr;
			std::shared_ptr<ecore::EAttribute> m_pseudostate_Attribute_kind = nullptr;
			std::shared_ptr<ecore::EAttribute> m_transition_Attribute_kind = nullptr;
			std::shared_ptr<ecore::EAttribute> m_connector_Attribute_kind = nullptr;
			std::shared_ptr<ecore::EAttribute> m_opaqueExpression_Attribute_language = nullptr;
			std::shared_ptr<ecore::EAttribute> m_opaqueAction_Attribute_language = nullptr;
			std::shared_ptr<ecore::EAttribute> m_opaqueBehavior_Attribute_language = nullptr;
			std::shared_ptr<ecore::EAttribute> m_image_Attribute_location = nullptr;
			std::shared_ptr<ecore::EAttribute> m_multiplicityElement_Attribute_lower = nullptr;
			std::shared_ptr<ecore::EAttribute> m_operation_Attribute_lower = nullptr;
			std::shared_ptr<ecore::EAttribute> m_message_Attribute_messageKind = nullptr;
			std::shared_ptr<ecore::EAttribute> m_message_Attribute_messageSort = nullptr;
			...
			std::shared_ptr<ecore::EAttribute> m_expression_Attribute_symbol = nullptr;
			std::shared_ptr<ecore::EAttribute> m_multiplicityElement_Attribute_upper = nullptr;
			std::shared_ptr<ecore::EAttribute> m_operation_Attribute_upper = nullptr;
			std::shared_ptr<ecore::EAttribute> m_literalBoolean_Attribute_value = nullptr;
			std::shared_ptr<ecore::EAttribute> m_literalInteger_Attribute_value = nullptr;
			std::shared_ptr<ecore::EAttribute> m_literalReal_Attribute_value = nullptr;
			std::shared_ptr<ecore::EAttribute> m_literalString_Attribute_value = nullptr;
			std::shared_ptr<ecore::EAttribute> m_literalUnlimitedNatural_Attribute_value = nullptr;
			std::shared_ptr<ecore::EAttribute> m_model_Attribute_viewpoint = nullptr;
			std::shared_ptr<ecore::EAttribute> m_namedElement_Attribute_visibility = nullptr;
			std::shared_ptr<ecore::EAttribute> m_elementImport_Attribute_visibility = nullptr;
			std::shared_ptr<ecore::EAttribute> m_packageImport_Attribute_visibility = nullptr;
			
			std::shared_ptr<ecore::EReference> m_componentRealization_Attribute_abstraction = nullptr;
			std::shared_ptr<ecore::EReference> m_inputPin_Attribute_action = nullptr;
			std::shared_ptr<ecore::EReference> m_outputPin_Attribute_action = nullptr;
			std::shared_ptr<ecore::EReference> m_interaction_Attribute_action = nullptr;
			std::shared_ptr<ecore::EReference> m_actionExecutionSpecification_Attribute_action = nullptr;
			std::shared_ptr<ecore::EReference> m_activityEdge_Attribute_activity = nullptr;
			std::shared_ptr<ecore::EReference> m_activityNode_Attribute_activity = nullptr;
			...
			std::shared_ptr<ecore::EReference> m_profileApplication_Attribute_appliedProfile = nullptr;
			std::shared_ptr<ecore::EReference> m_profileApplication_Attribute_applyingPackage = nullptr;
			std::shared_ptr<ecore::EReference> m_invocationAction_Attribute_argument = nullptr;
			std::shared_ptr<ecore::EReference> m_message_Attribute_argument = nullptr;
			std::shared_ptr<ecore::EReference> m_interactionUse_Attribute_argument = nullptr;
			std::shared_ptr<ecore::EReference> m_property_Attribute_association = nullptr;
			std::shared_ptr<ecore::EReference> m_clearAssociationAction_Attribute_association = nullptr;
			std::shared_ptr<ecore::EReference> m_property_Attribute_associationEnd = nullptr;
			std::shared_ptr<ecore::EReference> m_classifier_Attribute_attribute = nullptr;
			std::shared_ptr<ecore::EReference> m_generalOrdering_Attribute_before = nullptr;
			std::shared_ptr<ecore::EReference> m_opaqueExpression_Attribute_behavior = nullptr;
			std::shared_ptr<ecore::EReference> m_parameter_Attribute_behavior = nullptr;
			std::shared_ptr<ecore::EReference> m_callBehaviorAction_Attribute_behavior = nullptr;
			std::shared_ptr<ecore::EReference> m_behaviorExecutionSpecification_Attribute_behavior = nullptr;
			std::shared_ptr<ecore::EReference> m_behavior_Attribute_behavioredClassifier = nullptr;
			std::shared_ptr<ecore::EReference> m_clause_Attribute_body = nullptr;
			std::shared_ptr<ecore::EReference> m_operation_Attribute_bodyCondition = nullptr;
			std::shared_ptr<ecore::EReference> m_clause_Attribute_bodyOutput = nullptr;
			std::shared_ptr<ecore::EReference> m_loopNode_Attribute_bodyOutput = nullptr;
			std::shared_ptr<ecore::EReference> m_loopNode_Attribute_bodyPart = nullptr;
			std::shared_ptr<ecore::EReference> m_templateBinding_Attribute_boundElement = nullptr;
			std::shared_ptr<ecore::EReference> m_outputPin_Attribute_callAction = nullptr;
			std::shared_ptr<ecore::EReference> m_inputPin_Attribute_callOperationAction = nullptr;
			std::shared_ptr<ecore::EReference> m_combinedFragment_Attribute_cfragmentGate = nullptr;
			std::shared_ptr<ecore::EReference> m_changeEvent_Attribute_changeExpression = nullptr;
			std::shared_ptr<ecore::EReference> m_property_Attribute_class = nullptr;
			std::shared_ptr<ecore::EReference> m_operation_Attribute_class = nullptr;
			std::shared_ptr<ecore::EReference> m_instanceSpecification_Attribute_classifier = nullptr;
			std::shared_ptr<ecore::EReference> m_redefinableTemplateSignature_Attribute_classifier = nullptr;
			std::shared_ptr<ecore::EReference> m_createObjectAction_Attribute_classifier = nullptr;
			std::shared_ptr<ecore::EReference> m_readExtentAction_Attribute_classifier = nullptr;
			...
			std::shared_ptr<ecore::EReference> m_classifier_Attribute_collaborationUse = nullptr;
			std::shared_ptr<ecore::EReference> m_reduceAction_Attribute_collection = nullptr;
			std::shared_ptr<ecore::EReference> m_parameterSet_Attribute_condition = nullptr;
			std::shared_ptr<ecore::EReference> m_extend_Attribute_condition = nullptr;
			std::shared_ptr<ecore::EReference> m_deployment_Attribute_configuration = nullptr;
			std::shared_ptr<ecore::EReference> m_protocolStateMachine_Attribute_conformance = nullptr;
			std::shared_ptr<ecore::EReference> m_state_Attribute_connection = nullptr;
			std::shared_ptr<ecore::EReference> m_stateMachine_Attribute_connectionPoint = nullptr;
			std::shared_ptr<ecore::EReference> m_state_Attribute_connectionPoint = nullptr;
			std::shared_ptr<ecore::EReference> m_message_Attribute_connector = nullptr;
			std::shared_ptr<ecore::EReference> m_constraint_Attribute_constrainedElement = nullptr;
			std::shared_ptr<ecore::EReference> m_classifierTemplateParameter_Attribute_constrainingClassifier = nullptr;
			std::shared_ptr<ecore::EReference> m_activityGroup_Attribute_containedEdge = nullptr;
			std::shared_ptr<ecore::EReference> m_activityGroup_Attribute_containedNode = nullptr;
			std::shared_ptr<ecore::EReference> m_vertex_Attribute_container = nullptr;
			std::shared_ptr<ecore::EReference> m_transition_Attribute_container = nullptr;
			std::shared_ptr<ecore::EReference> m_behavior_Attribute_context = nullptr;
			std::shared_ptr<ecore::EReference> m_constraint_Attribute_context = nullptr;
			std::shared_ptr<ecore::EReference> m_action_Attribute_context = nullptr;
			std::shared_ptr<ecore::EReference> m_connector_Attribute_contract = nullptr;
			std::shared_ptr<ecore::EReference> m_substitution_Attribute_contract = nullptr;
			std::shared_ptr<ecore::EReference> m_interfaceRealization_Attribute_contract = nullptr;
			...
			std::shared_ptr<ecore::EReference> m_loopNode_Attribute_decider = nullptr;
			std::shared_ptr<ecore::EReference> m_decisionNode_Attribute_decisionInput = nullptr;
			std::shared_ptr<ecore::EReference> m_decisionNode_Attribute_decisionInputFlow = nullptr;
			std::shared_ptr<ecore::EReference> m_lifeline_Attribute_decomposedAs = nullptr;
			std::shared_ptr<ecore::EReference> m_templateParameter_Attribute_default = nullptr;
			std::shared_ptr<ecore::EReference> m_property_Attribute_defaultValue = nullptr;
			std::shared_ptr<ecore::EReference> m_parameter_Attribute_defaultValue = nullptr;
			std::shared_ptr<ecore::EReference> m_state_Attribute_deferrableTrigger = nullptr;
			std::shared_ptr<ecore::EReference> m_connectorEnd_Attribute_definingEnd = nullptr;
			std::shared_ptr<ecore::EReference> m_slot_Attribute_definingFeature = nullptr;
			std::shared_ptr<ecore::EReference> m_deployment_Attribute_deployedArtifact = nullptr;
			std::shared_ptr<ecore::EReference> m_deploymentTarget_Attribute_deployedElement = nullptr;
			...
			std::shared_ptr<ecore::EReference> m_structuredActivityNode_Attribute_edge = nullptr;
			std::shared_ptr<ecore::EReference> m_transition_Attribute_effect = nullptr;
			std::shared_ptr<ecore::EReference> m_namespace_Attribute_elementImport = nullptr;
			std::shared_ptr<ecore::EReference> m_interactionFragment_Attribute_enclosingInteraction = nullptr;
			std::shared_ptr<ecore::EReference> m_interactionFragment_Attribute_enclosingOperand = nullptr;
			std::shared_ptr<ecore::EReference> m_connectableElement_Attribute_end = nullptr;
			std::shared_ptr<ecore::EReference> m_connector_Attribute_end = nullptr;
			std::shared_ptr<ecore::EReference> m_linkEndData_Attribute_end = nullptr;
			std::shared_ptr<ecore::EReference> m_readLinkObjectEndAction_Attribute_end = nullptr;
			std::shared_ptr<ecore::EReference> m_linkAction_Attribute_endData = nullptr;
			std::shared_ptr<ecore::EReference> m_association_Attribute_endType = nullptr;
			std::shared_ptr<ecore::EReference> m_state_Attribute_entry = nullptr;
			std::shared_ptr<ecore::EReference> m_connectionPointReference_Attribute_entry = nullptr;
			std::shared_ptr<ecore::EReference> m_enumerationLiteral_Attribute_enumeration = nullptr;
			std::shared_ptr<ecore::EReference> m_trigger_Attribute_event = nullptr;
			std::shared_ptr<ecore::EReference> m_durationObservation_Attribute_event = nullptr;
			std::shared_ptr<ecore::EReference> m_timeObservation_Attribute_event = nullptr;
			std::shared_ptr<ecore::EReference> m_raiseExceptionAction_Attribute_exception = nullptr;
			std::shared_ptr<ecore::EReference> m_exceptionHandler_Attribute_exceptionInput = nullptr;
			std::shared_ptr<ecore::EReference> m_exceptionHandler_Attribute_exceptionType = nullptr;
			std::shared_ptr<ecore::EReference> m_sequenceNode_Attribute_executableNode = nullptr;
			std::shared_ptr<ecore::EReference> m_executionOccurrenceSpecification_Attribute_execution = nullptr;
			std::shared_ptr<ecore::EReference> m_state_Attribute_exit = nullptr;
			std::shared_ptr<ecore::EReference> m_connectionPointReference_Attribute_exit = nullptr;
			std::shared_ptr<ecore::EReference> m_timeExpression_Attribute_expr = nullptr;
			std::shared_ptr<ecore::EReference> m_duration_Attribute_expr = nullptr;
			std::shared_ptr<ecore::EReference> m_useCase_Attribute_extend = nullptr;
			std::shared_ptr<ecore::EReference> m_extend_Attribute_extendedCase = nullptr;
			std::shared_ptr<ecore::EReference> m_region_Attribute_extendedRegion = nullptr;
			std::shared_ptr<ecore::EReference> m_redefinableTemplateSignature_Attribute_extendedSignature = nullptr;
			std::shared_ptr<ecore::EReference> m_stateMachine_Attribute_extendedStateMachine = nullptr;
			std::shared_ptr<ecore::EReference> m_class_Attribute_extension = nullptr;
			std::shared_ptr<ecore::EReference> m_extend_Attribute_extension = nullptr;
			std::shared_ptr<ecore::EReference> m_extend_Attribute_extensionLocation = nullptr;
			std::shared_ptr<ecore::EReference> m_useCase_Attribute_extensionPoint = nullptr;
			std::shared_ptr<ecore::EReference> m_classifier_Attribute_feature = nullptr;
			std::shared_ptr<ecore::EReference> m_feature_Attribute_featuringClassifier = nullptr;
			std::shared_ptr<ecore::EReference> m_executionSpecification_Attribute_finish = nullptr;
			std::shared_ptr<ecore::EReference> m_testIdentityAction_Attribute_first = nullptr;
			std::shared_ptr<ecore::EReference> m_templateParameterSubstitution_Attribute_formal = nullptr;
			std::shared_ptr<ecore::EReference> m_interaction_Attribute_formalGate = nullptr;
			std::shared_ptr<ecore::EReference> m_interaction_Attribute_fragment = nullptr;
			std::shared_ptr<ecore::EReference> m_interactionOperand_Attribute_fragment = nullptr;
			std::shared_ptr<ecore::EReference> m_actionInputPin_Attribute_fromAction = nullptr;
			std::shared_ptr<ecore::EReference> m_classifier_Attribute_general = nullptr;
			std::shared_ptr<ecore::EReference> m_generalization_Attribute_general = nullptr;
			std::shared_ptr<ecore::EReference> m_protocolConformance_Attribute_generalMachine = nullptr;
			std::shared_ptr<ecore::EReference> m_interactionFragment_Attribute_generalOrdering = nullptr;
			std::shared_ptr<ecore::EReference> m_classifier_Attribute_generalization = nullptr;
			std::shared_ptr<ecore::EReference> m_generalizationSet_Attribute_generalization = nullptr;
			std::shared_ptr<ecore::EReference> m_generalization_Attribute_generalizationSet = nullptr;
			std::shared_ptr<ecore::EReference> m_activity_Attribute_group = nullptr;
			std::shared_ptr<ecore::EReference> m_transition_Attribute_guard = nullptr;
			std::shared_ptr<ecore::EReference> m_activityEdge_Attribute_guard = nullptr;
			std::shared_ptr<ecore::EReference> m_interactionOperand_Attribute_guard = nullptr;
			std::shared_ptr<ecore::EReference> m_executableNode_Attribute_handler = nullptr;
			std::shared_ptr<ecore::EReference> m_exceptionHandler_Attribute_handlerBody = nullptr;
			std::shared_ptr<ecore::EReference> m_stereotype_Attribute_icon = nullptr;
			std::shared_ptr<ecore::EReference> m_interfaceRealization_Attribute_implementingClassifier = nullptr;
			std::shared_ptr<ecore::EReference> m_elementImport_Attribute_importedElement = nullptr;
			std::shared_ptr<ecore::EReference> m_namespace_Attribute_importedMember = nullptr;
			std::shared_ptr<ecore::EReference> m_packageImport_Attribute_importedPackage = nullptr;
			std::shared_ptr<ecore::EReference> m_elementImport_Attribute_importingNamespace = nullptr;
			std::shared_ptr<ecore::EReference> m_packageImport_Attribute_importingNamespace = nullptr;
			std::shared_ptr<ecore::EReference> m_activityGroup_Attribute_inActivity = nullptr;
			std::shared_ptr<ecore::EReference> m_activityEdge_Attribute_inGroup = nullptr;
			std::shared_ptr<ecore::EReference> m_activityNode_Attribute_inGroup = nullptr;
			std::shared_ptr<ecore::EReference> m_activityNode_Attribute_inInterruptibleRegion = nullptr;
			std::shared_ptr<ecore::EReference> m_activityEdge_Attribute_inPartition = nullptr;
			std::shared_ptr<ecore::EReference> m_activityNode_Attribute_inPartition = nullptr;
			std::shared_ptr<ecore::EReference> m_objectNode_Attribute_inState = nullptr;
			std::shared_ptr<ecore::EReference> m_activityEdge_Attribute_inStructuredNode = nullptr;
			std::shared_ptr<ecore::EReference> m_activityNode_Attribute_inStructuredNode = nullptr;
			std::shared_ptr<ecore::EReference> m_useCase_Attribute_include = nullptr;
			std::shared_ptr<ecore::EReference> m_include_Attribute_includingCase = nullptr;
			std::shared_ptr<ecore::EReference> m_vertex_Attribute_incoming = nullptr;
			std::shared_ptr<ecore::EReference> m_activityNode_Attribute_incoming = nullptr;
			std::shared_ptr<ecore::EReference> m_informationFlow_Attribute_informationSource = nullptr;
			std::shared_ptr<ecore::EReference> m_informationFlow_Attribute_informationTarget = nullptr;
			std::shared_ptr<ecore::EReference> m_classifier_Attribute_inheritedMember = nullptr;
			std::shared_ptr<ecore::EReference> m_redefinableTemplateSignature_Attribute_inheritedParameter = nullptr;
			std::shared_ptr<ecore::EReference> m_action_Attribute_input = nullptr;
			std::shared_ptr<ecore::EReference> m_expansionRegion_Attribute_inputElement = nullptr;
			std::shared_ptr<ecore::EReference> m_linkAction_Attribute_inputValue = nullptr;
			std::shared_ptr<ecore::EReference> m_opaqueAction_Attribute_inputValue = nullptr;
			std::shared_ptr<ecore::EReference> m_addStructuralFeatureValueAction_Attribute_insertAt = nullptr;
			std::shared_ptr<ecore::EReference> m_addVariableValueAction_Attribute_insertAt = nullptr;
			std::shared_ptr<ecore::EReference> m_linkEndCreationData_Attribute_insertAt = nullptr;
			std::shared_ptr<ecore::EReference> m_instanceValue_Attribute_instance = nullptr;
			std::shared_ptr<ecore::EReference> m_message_Attribute_interaction = nullptr;
			std::shared_ptr<ecore::EReference> m_lifeline_Attribute_interaction = nullptr;
			std::shared_ptr<ecore::EReference> m_property_Attribute_interface = nullptr;
			std::shared_ptr<ecore::EReference> m_operation_Attribute_interface = nullptr;
			std::shared_ptr<ecore::EReference> m_behavioredClassifier_Attribute_interfaceRealization = nullptr;
			std::shared_ptr<ecore::EReference> m_interruptibleActivityRegion_Attribute_interruptingEdge = nullptr;
			std::shared_ptr<ecore::EReference> m_activityEdge_Attribute_interrupts = nullptr;
			std::shared_ptr<ecore::EReference> m_stateInvariant_Attribute_invariant = nullptr;
			std::shared_ptr<ecore::EReference> m_inputPin_Attribute_invocationAction = nullptr;
			std::shared_ptr<ecore::EReference> m_joinNode_Attribute_joinSpec = nullptr;
			std::shared_ptr<ecore::EReference> m_interaction_Attribute_lifeline = nullptr;
			std::shared_ptr<ecore::EReference> m_action_Attribute_localPostcondition = nullptr;
			std::shared_ptr<ecore::EReference> m_action_Attribute_localPrecondition = nullptr;
			std::shared_ptr<ecore::EReference> m_deployment_Attribute_location = nullptr;
			std::shared_ptr<ecore::EReference> m_loopNode_Attribute_loopVariable = nullptr;
			std::shared_ptr<ecore::EReference> m_loopNode_Attribute_loopVariableInput = nullptr;
			std::shared_ptr<ecore::EReference> m_multiplicityElement_Attribute_lowerValue = nullptr;
			std::shared_ptr<ecore::EReference> m_artifact_Attribute_manifestation = nullptr;
			std::shared_ptr<ecore::EReference> m_abstraction_Attribute_mapping = nullptr;
			std::shared_ptr<ecore::EReference> m_interval_Attribute_max = nullptr;
			std::shared_ptr<ecore::EReference> m_interactionConstraint_Attribute_maxint = nullptr;
			std::shared_ptr<ecore::EReference> m_namespace_Attribute_member = nullptr;
			std::shared_ptr<ecore::EReference> m_association_Attribute_memberEnd = nullptr;
			std::shared_ptr<ecore::EReference> m_packageMerge_Attribute_mergedPackage = nullptr;
			std::shared_ptr<ecore::EReference> m_interaction_Attribute_message = nullptr;
			std::shared_ptr<ecore::EReference> m_messageEnd_Attribute_message = nullptr;
			std::shared_ptr<ecore::EReference> m_considerIgnoreFragment_Attribute_message = nullptr;
			std::shared_ptr<ecore::EReference> m_extension_Attribute_metaclass = nullptr;
			std::shared_ptr<ecore::EReference> m_profile_Attribute_metaclassReference = nullptr;
			std::shared_ptr<ecore::EReference> m_profile_Attribute_metamodelReference = nullptr;
			std::shared_ptr<ecore::EReference> m_behavioralFeature_Attribute_method = nullptr;
			std::shared_ptr<ecore::EReference> m_interval_Attribute_min = nullptr;
			std::shared_ptr<ecore::EReference> m_interactionConstraint_Attribute_minint = nullptr;
			std::shared_ptr<ecore::EReference> m_namedElement_Attribute_nameExpression = nullptr;
			std::shared_ptr<ecore::EReference> m_namedElement_Attribute_namespace = nullptr;
			std::shared_ptr<ecore::EReference> m_association_Attribute_navigableOwnedEnd = nullptr;
			std::shared_ptr<ecore::EReference> m_artifact_Attribute_nestedArtifact = nullptr;
			std::shared_ptr<ecore::EReference> m_class_Attribute_nestedClassifier = nullptr;
			std::shared_ptr<ecore::EReference> m_interface_Attribute_nestedClassifier = nullptr;
			std::shared_ptr<ecore::EReference> m_node_Attribute_nestedNode = nullptr;
			std::shared_ptr<ecore::EReference> m_package_Attribute_nestedPackage = nullptr;
			std::shared_ptr<ecore::EReference> m_package_Attribute_nestingPackage = nullptr;
			std::shared_ptr<ecore::EReference> m_reclassifyObjectAction_Attribute_newClassifier = nullptr;
			std::shared_ptr<ecore::EReference> m_activity_Attribute_node = nullptr;
			std::shared_ptr<ecore::EReference> m_activityPartition_Attribute_node = nullptr;
			std::shared_ptr<ecore::EReference> m_interruptibleActivityRegion_Attribute_node = nullptr;
			std::shared_ptr<ecore::EReference> m_structuredActivityNode_Attribute_node = nullptr;
			std::shared_ptr<ecore::EReference> m_structuralFeatureAction_Attribute_object = nullptr;
			std::shared_ptr<ecore::EReference> m_clearAssociationAction_Attribute_object = nullptr;
			std::shared_ptr<ecore::EReference> m_readIsClassifiedObjectAction_Attribute_object = nullptr;
			std::shared_ptr<ecore::EReference> m_readLinkObjectEndAction_Attribute_object = nullptr;
			std::shared_ptr<ecore::EReference> m_readLinkObjectEndQualifierAction_Attribute_object = nullptr;
			std::shared_ptr<ecore::EReference> m_reclassifyObjectAction_Attribute_object = nullptr;
			std::shared_ptr<ecore::EReference> m_startClassifierBehaviorAction_Attribute_object = nullptr;
			std::shared_ptr<ecore::EReference> m_startObjectBehaviorAction_Attribute_object = nullptr;
			std::shared_ptr<ecore::EReference> m_unmarshallAction_Attribute_object = nullptr;
			std::shared_ptr<ecore::EReference> m_timeExpression_Attribute_observation = nullptr;
			std::shared_ptr<ecore::EReference> m_duration_Attribute_observation = nullptr;
			std::shared_ptr<ecore::EReference> m_reclassifyObjectAction_Attribute_oldClassifier = nullptr;
			std::shared_ptr<ecore::EReference> m_invocationAction_Attribute_onPort = nullptr;
			std::shared_ptr<ecore::EReference> m_expression_Attribute_operand = nullptr;
			std::shared_ptr<ecore::EReference> m_combinedFragment_Attribute_operand = nullptr;
			std::shared_ptr<ecore::EReference> m_parameter_Attribute_operation = nullptr;
			std::shared_ptr<ecore::EReference> m_callOperationAction_Attribute_operation = nullptr;
			std::shared_ptr<ecore::EReference> m_callEvent_Attribute_operation = nullptr;
			std::shared_ptr<ecore::EReference> m_property_Attribute_opposite = nullptr;
			std::shared_ptr<ecore::EReference> m_vertex_Attribute_outgoing = nullptr;
			std::shared_ptr<ecore::EReference> m_activityNode_Attribute_outgoing = nullptr;
			std::shared_ptr<ecore::EReference> m_action_Attribute_output = nullptr;
			std::shared_ptr<ecore::EReference> m_expansionRegion_Attribute_outputElement = nullptr;
			std::shared_ptr<ecore::EReference> m_opaqueAction_Attribute_outputValue = nullptr;
			std::shared_ptr<ecore::EReference> m_templateParameterSubstitution_Attribute_ownedActual = nullptr;
			std::shared_ptr<ecore::EReference> m_artifact_Attribute_ownedAttribute = nullptr;
			std::shared_ptr<ecore::EReference> m_dataType_Attribute_ownedAttribute = nullptr;
			std::shared_ptr<ecore::EReference> m_interface_Attribute_ownedAttribute = nullptr;
			std::shared_ptr<ecore::EReference> m_signal_Attribute_ownedAttribute = nullptr;
			std::shared_ptr<ecore::EReference> m_structuredClassifier_Attribute_ownedAttribute = nullptr;
			std::shared_ptr<ecore::EReference> m_behavioredClassifier_Attribute_ownedBehavior = nullptr;
			std::shared_ptr<ecore::EReference> m_element_Attribute_ownedComment = nullptr;
			std::shared_ptr<ecore::EReference> m_structuredClassifier_Attribute_ownedConnector = nullptr;
			std::shared_ptr<ecore::EReference> m_templateParameter_Attribute_ownedDefault = nullptr;
			std::shared_ptr<ecore::EReference> m_element_Attribute_ownedElement = nullptr;
			std::shared_ptr<ecore::EReference> m_association_Attribute_ownedEnd = nullptr;
			std::shared_ptr<ecore::EReference> m_activity_Attribute_ownedGroup = nullptr;
			std::shared_ptr<ecore::EReference> m_enumeration_Attribute_ownedLiteral = nullptr;
			std::shared_ptr<ecore::EReference> m_namespace_Attribute_ownedMember = nullptr;
			std::shared_ptr<ecore::EReference> m_activity_Attribute_ownedNode = nullptr;
			std::shared_ptr<ecore::EReference> m_class_Attribute_ownedOperation = nullptr;
			std::shared_ptr<ecore::EReference> m_artifact_Attribute_ownedOperation = nullptr;
			std::shared_ptr<ecore::EReference> m_dataType_Attribute_ownedOperation = nullptr;
			std::shared_ptr<ecore::EReference> m_interface_Attribute_ownedOperation = nullptr;
			std::shared_ptr<ecore::EReference> m_behavior_Attribute_ownedParameter = nullptr;
			std::shared_ptr<ecore::EReference> m_templateSignature_Attribute_ownedParameter = nullptr;
			std::shared_ptr<ecore::EReference> m_behavioralFeature_Attribute_ownedParameter = nullptr;
			std::shared_ptr<ecore::EReference> m_behavior_Attribute_ownedParameterSet = nullptr;
			std::shared_ptr<ecore::EReference> m_behavioralFeature_Attribute_ownedParameterSet = nullptr;
			std::shared_ptr<ecore::EReference> m_templateParameter_Attribute_ownedParameteredElement = nullptr;
			std::shared_ptr<ecore::EReference> m_encapsulatedClassifier_Attribute_ownedPort = nullptr;
			std::shared_ptr<ecore::EReference> m_class_Attribute_ownedReception = nullptr;
			std::shared_ptr<ecore::EReference> m_interface_Attribute_ownedReception = nullptr;
			std::shared_ptr<ecore::EReference> m_namespace_Attribute_ownedRule = nullptr;
			std::shared_ptr<ecore::EReference> m_package_Attribute_ownedStereotype = nullptr;
			std::shared_ptr<ecore::EReference> m_templateableElement_Attribute_ownedTemplateSignature = nullptr;
			std::shared_ptr<ecore::EReference> m_package_Attribute_ownedType = nullptr;
			std::shared_ptr<ecore::EReference> m_classifier_Attribute_ownedUseCase = nullptr;
			std::shared_ptr<ecore::EReference> m_element_Attribute_owner = nullptr;
			std::shared_ptr<ecore::EReference> m_property_Attribute_owningAssociation = nullptr;
			std::shared_ptr<ecore::EReference> m_stringExpression_Attribute_owningExpression = nullptr;
			std::shared_ptr<ecore::EReference> m_slot_Attribute_owningInstance = nullptr;
			std::shared_ptr<ecore::EReference> m_packageableElement_Attribute_owningPackage = nullptr;
			std::shared_ptr<ecore::EReference> m_valueSpecification_Attribute_owningSlot = nullptr;
			std::shared_ptr<ecore::EReference> m_parameterableElement_Attribute_owningTemplateParameter = nullptr;
			std::shared_ptr<ecore::EReference> m_type_Attribute_package = nullptr;
			std::shared_ptr<ecore::EReference> m_namespace_Attribute_packageImport = nullptr;
			std::shared_ptr<ecore::EReference> m_package_Attribute_packageMerge = nullptr;
			std::shared_ptr<ecore::EReference> m_package_Attribute_packagedElement = nullptr;
			std::shared_ptr<ecore::EReference> m_component_Attribute_packagedElement = nullptr;
			std::shared_ptr<ecore::EReference> m_templateSignature_Attribute_parameter = nullptr;
			std::shared_ptr<ecore::EReference> m_parameterSet_Attribute_parameter = nullptr;
			std::shared_ptr<ecore::EReference> m_activityParameterNode_Attribute_parameter = nullptr;
			std::shared_ptr<ecore::EReference> m_parameter_Attribute_parameterSet = nullptr;
			std::shared_ptr<ecore::EReference> m_templateBinding_Attribute_parameterSubstitution = nullptr;
			std::shared_ptr<ecore::EReference> m_templateParameter_Attribute_parameteredElement = nullptr;
			std::shared_ptr<ecore::EReference> m_structuredClassifier_Attribute_part = nullptr;
			std::shared_ptr<ecore::EReference> m_connectorEnd_Attribute_partWithPort = nullptr;
			std::shared_ptr<ecore::EReference> m_activity_Attribute_partition = nullptr;
			std::shared_ptr<ecore::EReference> m_trigger_Attribute_port = nullptr;
			std::shared_ptr<ecore::EReference> m_protocolTransition_Attribute_postCondition = nullptr;
			std::shared_ptr<ecore::EReference> m_behavior_Attribute_postcondition = nullptr;
			std::shared_ptr<ecore::EReference> m_operation_Attribute_postcondition = nullptr;
			std::shared_ptr<ecore::EReference> m_generalizationSet_Attribute_powertype = nullptr;
			std::shared_ptr<ecore::EReference> m_classifier_Attribute_powertypeExtent = nullptr;
			std::shared_ptr<ecore::EReference> m_protocolTransition_Attribute_preCondition = nullptr;
			std::shared_ptr<ecore::EReference> m_behavior_Attribute_precondition = nullptr;
			std::shared_ptr<ecore::EReference> m_operation_Attribute_precondition = nullptr;
			std::shared_ptr<ecore::EReference> m_clause_Attribute_predecessorClause = nullptr;
			std::shared_ptr<ecore::EReference> m_stereotype_Attribute_profile = nullptr;
			std::shared_ptr<ecore::EReference> m_package_Attribute_profileApplication = nullptr;
			std::shared_ptr<ecore::EReference> m_exceptionHandler_Attribute_protectedNode = nullptr;
			std::shared_ptr<ecore::EReference> m_interface_Attribute_protocol = nullptr;
			std::shared_ptr<ecore::EReference> m_port_Attribute_protocol = nullptr;
			std::shared_ptr<ecore::EReference> m_port_Attribute_provided = nullptr;
			std::shared_ptr<ecore::EReference> m_component_Attribute_provided = nullptr;
			std::shared_ptr<ecore::EReference> m_property_Attribute_qualifier = nullptr;
			std::shared_ptr<ecore::EReference> m_linkEndData_Attribute_qualifier = nullptr;
			...
			std::shared_ptr<ecore::EReference> m_componentRealization_Attribute_realizingClassifier = nullptr;
			std::shared_ptr<ecore::EReference> m_informationFlow_Attribute_realizingConnector = nullptr;
			std::shared_ptr<ecore::EReference> m_informationFlow_Attribute_realizingMessage = nullptr;
			std::shared_ptr<ecore::EReference> m_message_Attribute_receiveEvent = nullptr;
			std::shared_ptr<ecore::EReference> m_packageMerge_Attribute_receivingPackage = nullptr;
			std::shared_ptr<ecore::EReference> m_behavior_Attribute_redefinedBehavior = nullptr;
			std::shared_ptr<ecore::EReference> m_classifier_Attribute_redefinedClassifier = nullptr;
			std::shared_ptr<ecore::EReference> m_connector_Attribute_redefinedConnector = nullptr;
			std::shared_ptr<ecore::EReference> m_activityEdge_Attribute_redefinedEdge = nullptr;
			std::shared_ptr<ecore::EReference> m_redefinableElement_Attribute_redefinedElement = nullptr;
			std::shared_ptr<ecore::EReference> m_interface_Attribute_redefinedInterface = nullptr;
			std::shared_ptr<ecore::EReference> m_activityNode_Attribute_redefinedNode = nullptr;
			std::shared_ptr<ecore::EReference> m_operation_Attribute_redefinedOperation = nullptr;
			std::shared_ptr<ecore::EReference> m_port_Attribute_redefinedPort = nullptr;
			std::shared_ptr<ecore::EReference> m_property_Attribute_redefinedProperty = nullptr;
			std::shared_ptr<ecore::EReference> m_state_Attribute_redefinedState = nullptr;
			std::shared_ptr<ecore::EReference> m_transition_Attribute_redefinedTransition = nullptr;
			std::shared_ptr<ecore::EReference> m_redefinableElement_Attribute_redefinitionContext = nullptr;
			std::shared_ptr<ecore::EReference> m_reduceAction_Attribute_reducer = nullptr;
			std::shared_ptr<ecore::EReference> m_protocolTransition_Attribute_referred = nullptr;
			std::shared_ptr<ecore::EReference> m_interactionUse_Attribute_refersTo = nullptr;
			std::shared_ptr<ecore::EReference> m_stateMachine_Attribute_region = nullptr;
			std::shared_ptr<ecore::EReference> m_state_Attribute_region = nullptr;
			std::shared_ptr<ecore::EReference> m_expansionNode_Attribute_regionAsInput = nullptr;
			std::shared_ptr<ecore::EReference> m_expansionNode_Attribute_regionAsOutput = nullptr;
			std::shared_ptr<ecore::EReference> m_relationship_Attribute_relatedElement = nullptr;
			std::shared_ptr<ecore::EReference> m_removeStructuralFeatureValueAction_Attribute_removeAt = nullptr;
			std::shared_ptr<ecore::EReference> m_removeVariableValueAction_Attribute_removeAt = nullptr;
			std::shared_ptr<ecore::EReference> m_replyAction_Attribute_replyToCall = nullptr;
			std::shared_ptr<ecore::EReference> m_replyAction_Attribute_replyValue = nullptr;
			std::shared_ptr<ecore::EReference> m_classifier_Attribute_representation = nullptr;
			std::shared_ptr<ecore::EReference> m_informationItem_Attribute_represented = nullptr;
			std::shared_ptr<ecore::EReference> m_activityPartition_Attribute_represents = nullptr;
			std::shared_ptr<ecore::EReference> m_lifeline_Attribute_represents = nullptr;
			std::shared_ptr<ecore::EReference> m_sendObjectAction_Attribute_request = nullptr;
			std::shared_ptr<ecore::EReference> m_port_Attribute_required = nullptr;
			std::shared_ptr<ecore::EReference> m_component_Attribute_required = nullptr;
			std::shared_ptr<ecore::EReference> m_opaqueExpression_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_valueSpecificationAction_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_writeStructuralFeatureAction_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_acceptEventAction_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_callAction_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_clearStructuralFeatureAction_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_conditionalNode_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_createLinkObjectAction_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_createObjectAction_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_loopNode_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_readExtentAction_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_readIsClassifiedObjectAction_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_readLinkAction_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_readLinkObjectEndAction_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_readLinkObjectEndQualifierAction_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_readSelfAction_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_readStructuralFeatureAction_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_readVariableAction_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_reduceAction_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_testIdentityAction_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_unmarshallAction_Attribute_result = nullptr;
			std::shared_ptr<ecore::EReference> m_acceptCallAction_Attribute_returnInformation = nullptr;
			std::shared_ptr<ecore::EReference> m_replyAction_Attribute_returnInformation = nullptr;
			std::shared_ptr<ecore::EReference> m_interactionUse_Attribute_returnValue = nullptr;
			std::shared_ptr<ecore::EReference> m_interactionUse_Attribute_returnValueRecipient = nullptr;
			std::shared_ptr<ecore::EReference> m_connectorEnd_Attribute_role = nullptr;
			std::shared_ptr<ecore::EReference> m_structuredClassifier_Attribute_role = nullptr;
			std::shared_ptr<ecore::EReference> m_collaborationUse_Attribute_roleBinding = nullptr;
			std::shared_ptr<ecore::EReference> m_variable_Attribute_scope = nullptr;
			std::shared_ptr<ecore::EReference> m_testIdentityAction_Attribute_second = nullptr;
			std::shared_ptr<ecore::EReference> m_objectNode_Attribute_selection = nullptr;
			std::shared_ptr<ecore::EReference> m_objectFlow_Attribute_selection = nullptr;
			std::shared_ptr<ecore::EReference> m_lifeline_Attribute_selector = nullptr;
			std::shared_ptr<ecore::EReference> m_message_Attribute_sendEvent = nullptr;
			std::shared_ptr<ecore::EReference> m_loopNode_Attribute_setupPart = nullptr;
			std::shared_ptr<ecore::EReference> m_reception_Attribute_signal = nullptr;
			std::shared_ptr<ecore::EReference> m_broadcastSignalAction_Attribute_signal = nullptr;
			std::shared_ptr<ecore::EReference> m_sendSignalAction_Attribute_signal = nullptr;
			std::shared_ptr<ecore::EReference> m_signalEvent_Attribute_signal = nullptr;
			std::shared_ptr<ecore::EReference> m_templateParameter_Attribute_signature = nullptr;
			std::shared_ptr<ecore::EReference> m_templateBinding_Attribute_signature = nullptr;
			std::shared_ptr<ecore::EReference> m_message_Attribute_signature = nullptr;
			std::shared_ptr<ecore::EReference> m_instanceSpecification_Attribute_slot = nullptr;
			std::shared_ptr<ecore::EReference> m_directedRelationship_Attribute_source = nullptr;
			std::shared_ptr<ecore::EReference> m_transition_Attribute_source = nullptr;
			std::shared_ptr<ecore::EReference> m_activityEdge_Attribute_source = nullptr;
			std::shared_ptr<ecore::EReference> m_generalization_Attribute_specific = nullptr;
			std::shared_ptr<ecore::EReference> m_protocolConformance_Attribute_specificMachine = nullptr;
			std::shared_ptr<ecore::EReference> m_behavior_Attribute_specification = nullptr;
			std::shared_ptr<ecore::EReference> m_constraint_Attribute_specification = nullptr;
			std::shared_ptr<ecore::EReference> m_instanceSpecification_Attribute_specification = nullptr;
			std::shared_ptr<ecore::EReference> m_executionSpecification_Attribute_start = nullptr;
			std::shared_ptr<ecore::EReference> m_pseudostate_Attribute_state = nullptr;
			std::shared_ptr<ecore::EReference> m_region_Attribute_state = nullptr;
			std::shared_ptr<ecore::EReference> m_connectionPointReference_Attribute_state = nullptr;
			std::shared_ptr<ecore::EReference> m_state_Attribute_stateInvariant = nullptr;
			std::shared_ptr<ecore::EReference> m_pseudostate_Attribute_stateMachine = nullptr;
			std::shared_ptr<ecore::EReference> m_region_Attribute_stateMachine = nullptr;
			std::shared_ptr<ecore::EReference> m_structuralFeatureAction_Attribute_structuralFeature = nullptr;
			std::shared_ptr<ecore::EReference> m_inputPin_Attribute_structuralFeatureAction = nullptr;
			std::shared_ptr<ecore::EReference> m_activity_Attribute_structuredNode = nullptr;
			std::shared_ptr<ecore::EReference> m_structuredActivityNode_Attribute_structuredNodeInput = nullptr;
			std::shared_ptr<ecore::EReference> m_structuredActivityNode_Attribute_structuredNodeOutput = nullptr;
			std::shared_ptr<ecore::EReference> m_stringExpression_Attribute_subExpression = nullptr;
			std::shared_ptr<ecore::EReference> m_activityGroup_Attribute_subgroup = nullptr;
			std::shared_ptr<ecore::EReference> m_useCase_Attribute_subject = nullptr;
			std::shared_ptr<ecore::EReference> m_state_Attribute_submachine = nullptr;
			std::shared_ptr<ecore::EReference> m_stateMachine_Attribute_submachineState = nullptr;
			std::shared_ptr<ecore::EReference> m_activityPartition_Attribute_subpartition = nullptr;
			std::shared_ptr<ecore::EReference> m_property_Attribute_subsettedProperty = nullptr;
			std::shared_ptr<ecore::EReference> m_substitution_Attribute_substitutingClassifier = nullptr;
			std::shared_ptr<ecore::EReference> m_classifier_Attribute_substitution = nullptr;
			std::shared_ptr<ecore::EReference> m_region_Attribute_subvertex = nullptr;
			std::shared_ptr<ecore::EReference> m_clause_Attribute_successorClause = nullptr;
			std::shared_ptr<ecore::EReference> m_class_Attribute_superClass = nullptr;
			std::shared_ptr<ecore::EReference> m_activityGroup_Attribute_superGroup = nullptr;
			std::shared_ptr<ecore::EReference> m_activityPartition_Attribute_superPartition = nullptr;
			std::shared_ptr<ecore::EReference> m_dependency_Attribute_supplier = nullptr;
			std::shared_ptr<ecore::EReference> m_directedRelationship_Attribute_target = nullptr;
			std::shared_ptr<ecore::EReference> m_transition_Attribute_target = nullptr;
			std::shared_ptr<ecore::EReference> m_activityEdge_Attribute_target = nullptr;
			std::shared_ptr<ecore::EReference> m_callOperationAction_Attribute_target = nullptr;
			std::shared_ptr<ecore::EReference> m_destroyObjectAction_Attribute_target = nullptr;
			std::shared_ptr<ecore::EReference> m_sendObjectAction_Attribute_target = nullptr;
			std::shared_ptr<ecore::EReference> m_sendSignalAction_Attribute_target = nullptr;
			std::shared_ptr<ecore::EReference> m_templateSignature_Attribute_template = nullptr;
			std::shared_ptr<ecore::EReference> m_templateableElement_Attribute_templateBinding = nullptr;
			std::shared_ptr<ecore::EReference> m_templateParameterSubstitution_Attribute_templateBinding = nullptr;
			std::shared_ptr<ecore::EReference> m_parameterableElement_Attribute_templateParameter = nullptr;
			std::shared_ptr<ecore::EReference> m_clause_Attribute_test = nullptr;
			std::shared_ptr<ecore::EReference> m_loopNode_Attribute_test = nullptr;
			std::shared_ptr<ecore::EReference> m_occurrenceSpecification_Attribute_toAfter = nullptr;
			std::shared_ptr<ecore::EReference> m_occurrenceSpecification_Attribute_toBefore = nullptr;
			std::shared_ptr<ecore::EReference> m_objectFlow_Attribute_transformation = nullptr;
			std::shared_ptr<ecore::EReference> m_region_Attribute_transition = nullptr;
			std::shared_ptr<ecore::EReference> m_transition_Attribute_trigger = nullptr;
			std::shared_ptr<ecore::EReference> m_acceptEventAction_Attribute_trigger = nullptr;
			std::shared_ptr<ecore::EReference> m_typedElement_Attribute_type = nullptr;
			std::shared_ptr<ecore::EReference> m_operation_Attribute_type = nullptr;
			std::shared_ptr<ecore::EReference> m_collaborationUse_Attribute_type = nullptr;
			std::shared_ptr<ecore::EReference> m_connector_Attribute_type = nullptr;
			std::shared_ptr<ecore::EReference> m_unmarshallAction_Attribute_unmarshallType = nullptr;
			std::shared_ptr<ecore::EReference> m_objectNode_Attribute_upperBound = nullptr;
			std::shared_ptr<ecore::EReference> m_multiplicityElement_Attribute_upperValue = nullptr;
			std::shared_ptr<ecore::EReference> m_classifier_Attribute_useCase = nullptr;
			std::shared_ptr<ecore::EReference> m_extensionPoint_Attribute_useCase = nullptr;
			std::shared_ptr<ecore::EReference> m_manifestation_Attribute_utilizedElement = nullptr;
			std::shared_ptr<ecore::EReference> m_slot_Attribute_value = nullptr;
			std::shared_ptr<ecore::EReference> m_valueSpecificationAction_Attribute_value = nullptr;
			std::shared_ptr<ecore::EReference> m_linkEndData_Attribute_value = nullptr;
			std::shared_ptr<ecore::EReference> m_qualifierValue_Attribute_value = nullptr;
			...
			std::shared_ptr<ecore::EOperation> m_behavioralFeature_Operation_abstract_no_method_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_actionExecutionSpecification_Operation_action_referenced_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_gate_Operation_actual_gate_distinguishable_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_gate_Operation_actual_gate_matched_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifierTemplateParameter_Operation_actual_is_classifier_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_addKeyword_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_extensionEnd_Operation_aggregation_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_action_Operation_allActions = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_allApplicableStereotypes = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_allAttributes = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_allFeatures = nullptr;
			std::shared_ptr<ecore::EOperation> m_useCase_Operation_allIncludedUseCases = nullptr;
			std::shared_ptr<ecore::EOperation> m_namedElement_Operation_allNamespaces = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_allOwnedElements = nullptr;
			std::shared_ptr<ecore::EOperation> m_action_Operation_allOwnedNodes = nullptr;
			std::shared_ptr<ecore::EOperation> m_namedElement_Operation_allOwningPackages = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_allParents = nullptr;
			std::shared_ptr<ecore::EOperation> m_linkEndData_Operation_allPins = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_allRealizedInterfaces = nullptr;
			std::shared_ptr<ecore::EOperation> m_structuredClassifier_Operation_allRoles = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_allSlottableFeatures = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_allUsedInterfaces = nullptr;
			std::shared_ptr<ecore::EOperation> m_interactionUse_Operation_all_lifelines_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_writeLinkAction_Operation_allow_access_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_stateMachine_Operation_ancestor_Vertex_Vertex = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_applyProfile_Profile = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_applyStereotype_Stereotype = nullptr;
			std::shared_ptr<ecore::EOperation> m_callAction_Operation_argument_pins_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_message_Operation_arguments_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_interactionUse_Operation_arguments_are_constants_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_interactionUse_Operation_arguments_correspond_to_parameters_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_protocolTransition_Operation_associated_actions_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_linkAction_Operation_association = nullptr;
			std::shared_ptr<ecore::EOperation> m_stereotype_Operation_associationEndOwnership_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_createLinkObjectAction_Operation_association_class_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_association_Operation_association_ends_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_createLinkAction_Operation_association_not_abstract_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkObjectEndAction_Operation_association_of_association_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkObjectEndQualifierAction_Operation_association_of_association_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_actor_Operation_associations_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_partDecomposition_Operation_assume_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_operation_Operation_at_most_one_return_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_stereotype_Operation_base_property_multiplicity_multiple_extension_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_stereotype_Operation_base_property_multiplicity_single_extension_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_stereotype_Operation_base_property_upper_bound_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_port_Operation_basicProvided = nullptr;
			std::shared_ptr<ecore::EOperation> m_port_Operation_basicRequired = nullptr;
			std::shared_ptr<ecore::EOperation> m_startObjectBehaviorAction_Operation_behavior = nullptr;
			std::shared_ptr<ecore::EOperation> m_behavior_Operation_behavioredClassifier_Element = nullptr;
			std::shared_ptr<ecore::EOperation> m_region_Operation_belongsToPSM = nullptr;
			std::shared_ptr<ecore::EOperation> m_protocolTransition_Operation_belongs_to_psm_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_stereotype_Operation_binaryAssociationsOnly_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_association_Operation_binary_associations_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_useCase_Operation_binary_associations_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_binding_to_attribute_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_clause_Operation_body_output_pins_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_loopNode_Operation_body_output_pins_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_valueSpecification_Operation_booleanValue = nullptr;
			std::shared_ptr<ecore::EOperation> m_readIsClassifiedObjectAction_Operation_boolean_result_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_constraint_Operation_boolean_value_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_combinedFragment_Operation_break__EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_associationClass_Operation_cannot_be_defined_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_message_Operation_cannot_cross_boundaries_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_namespace_Operation_cannot_import_ownedMembers_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_namespace_Operation_cannot_import_self_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_useCase_Operation_cannot_include_self_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_finalState_Operation_cannot_reference_submachine_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_pseudostate_Operation_choice_vertex_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_behavioredClassifier_Operation_class_behavior_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_stateMachine_Operation_classifier_context_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_createObjectAction_Operation_classifier_not_abstract_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_reclassifyObjectAction_Operation_classifier_not_abstract_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_createObjectAction_Operation_classifier_not_association_class_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_conditionalNode_Operation_clause_no_predecessor_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_collaborationUse_Operation_client_elements_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_partDecomposition_Operation_commutativity_of_decomposition_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_multiplicityElement_Operation_compatibleWith_MultiplicityElement = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkAction_Operation_compatible_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readVariableAction_Operation_compatible_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_valueSpecificationAction_Operation_compatible_type_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_valuePin_Operation_compatible_type_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_objectFlow_Operation_compatible_types_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_state_Operation_composite_states_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_acceptEventAction_Operation_conforming_type_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_type_Operation_conformsTo_Type = nullptr;
			std::shared_ptr<ecore::EOperation> m_stateMachine_Operation_connection_points_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_parameter_Operation_connector_end_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_collaborationUse_Operation_connectors_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_combinedFragment_Operation_consider_and_ignore_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_considerIgnoreFragment_Operation_consider_or_ignore_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifierTemplateParameter_Operation_constraining_classifiers_constrain_args_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifierTemplateParameter_Operation_constraining_classifiers_constrain_parametered_element_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readSelfAction_Operation_contained_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_container = nullptr;
			std::shared_ptr<ecore::EOperation> m_activityContent_Operation_containingActivity = nullptr;
			std::shared_ptr<ecore::EOperation> m_action_Operation_containingBehavior = nullptr;
			std::shared_ptr<ecore::EOperation> m_stereotype_Operation_containingProfile = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_containingProfile = nullptr;
			std::shared_ptr<ecore::EOperation> m_vertex_Operation_containingStateMachine = nullptr;
			std::shared_ptr<ecore::EOperation> m_region_Operation_containingStateMachine = nullptr;
			std::shared_ptr<ecore::EOperation> m_transition_Operation_containingStateMachine = nullptr;
			std::shared_ptr<ecore::EOperation> m_stateMachine_Operation_context_classifier_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_initialNode_Operation_control_edges_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_pin_Operation_control_pins_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_informationFlow_Operation_convey_classifiers_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_profile_Operation_create_Classifier = nullptr;
			std::shared_ptr<ecore::EOperation> m_factory_Operation_create_Class = nullptr;
			std::shared_ptr<ecore::EOperation> m_type_Operation_createAssociation_Boolean_UnlimitedNatural = nullptr;
			std::shared_ptr<ecore::EOperation> m_node_Operation_createCommunicationPath_Boolean_UnlimitedNatural = nullptr;
			std::shared_ptr<ecore::EOperation> m_namedElement_Operation_createDependency_NamedElement = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_createEAnnotation_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_namespace_Operation_createElementImport_PackageableElement_VisibilityKind = nullptr;
			std::shared_ptr<ecore::EOperation> m_stereotype_Operation_createExtension_Class_Boolean = nullptr;
			std::shared_ptr<ecore::EOperation> m_stereotype_Operation_createIcon_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_stereotype_Operation_createIcon_String_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_artifact_Operation_createOwnedAttribute_String_UnlimitedNatural = nullptr;
			std::shared_ptr<ecore::EOperation> m_dataType_Operation_createOwnedAttribute_String_UnlimitedNatural = nullptr;
			std::shared_ptr<ecore::EOperation> m_interface_Operation_createOwnedAttribute_String_UnlimitedNatural = nullptr;
			std::shared_ptr<ecore::EOperation> m_signal_Operation_createOwnedAttribute_String_UnlimitedNatural = nullptr;
			std::shared_ptr<ecore::EOperation> m_structuredClassifier_Operation_createOwnedAttribute_String_UnlimitedNatural = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_createOwnedClass_String_Boolean = nullptr;
			std::shared_ptr<ecore::EOperation> m_component_Operation_createOwnedClass_String_Boolean = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_createOwnedEnumeration_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_component_Operation_createOwnedEnumeration_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_createOwnedInterface_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_component_Operation_createOwnedInterface_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_class_Operation_createOwnedOperation_String_Type = nullptr;
			std::shared_ptr<ecore::EOperation> m_artifact_Operation_createOwnedOperation_String_Type = nullptr;
			std::shared_ptr<ecore::EOperation> m_dataType_Operation_createOwnedOperation_String_Type = nullptr;
			std::shared_ptr<ecore::EOperation> m_interface_Operation_createOwnedOperation_String_Type = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_createOwnedPrimitiveType_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_component_Operation_createOwnedPrimitiveType_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_createOwnedStereotype_String_Boolean = nullptr;
			std::shared_ptr<ecore::EOperation> m_namespace_Operation_createPackageImport_Package_VisibilityKind = nullptr;
			std::shared_ptr<ecore::EOperation> m_behavioralFeature_Operation_createReturnResult_String_Type = nullptr;
			std::shared_ptr<ecore::EOperation> m_namedElement_Operation_createUsage_NamedElement = nullptr;
			std::shared_ptr<ecore::EOperation> m_clause_Operation_decider_output_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_decisionNode_Operation_decision_input_flow_incoming_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_region_Operation_deep_history_vertex_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_protocolStateMachine_Operation_deep_or_shallow_history_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_port_Operation_default_value_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_profile_Operation_define = nullptr;
			std::shared_ptr<ecore::EOperation> m_profile_Operation_define_EMap_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_instanceSpecification_Operation_defining_feature_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_deploymentSpecification_Operation_deployed_elements_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_instanceSpecification_Operation_deployment_artifact_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_deployment_target_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_deploymentSpecification_Operation_deployment_target_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_instanceSpecification_Operation_deployment_target_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_derived_union_is_derived_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_derived_union_is_read_only_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_state_Operation_destinations_or_sources_of_transitions_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_destroy = nullptr;
			std::shared_ptr<ecore::EOperation> m_linkEndDestructionData_Operation_destroyAt_pin_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_activityPartition_Operation_dimension_not_contained_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_directlyRealizedInterfaces = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_directlyUsedInterfaces = nullptr;
			std::shared_ptr<ecore::EOperation> m_associationClass_Operation_disjoint_attributes_ends_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_interactionConstraint_Operation_dynamic_variables_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_exceptionHandler_Operation_edge_source_target_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_structuredActivityNode_Operation_edges_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_decisionNode_Operation_edges_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_forkNode_Operation_edges_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_mergeNode_Operation_edges_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_elements_public_or_private_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_port_Operation_encapsulated_owner_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_messageEnd_Operation_enclosingFragment = nullptr;
			std::shared_ptr<ecore::EOperation> m_linkEndData_Operation_end_object_input_pin_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_association_Operation_ends_must_be_typed_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkObjectEndAction_Operation_ends_of_association_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkObjectEndQualifierAction_Operation_ends_of_association_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_protocolStateMachine_Operation_entry_exit_do_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_state_Operation_entry_or_exit_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_connectionPointReference_Operation_entry_pseudostates_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_replyAction_Operation_event_on_reply_to_call_trigger_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_collaborationUse_Operation_every_role_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_exceptionHandler_Operation_exception_input_type_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_namespace_Operation_excludeCollisions_PackageableElement = nullptr;
			std::shared_ptr<ecore::EOperation> m_conditionalNode_Operation_executable_nodes_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_loopNode_Operation_executable_nodes_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_connectionPointReference_Operation_exit_pseudostates_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_extend_Operation_extension_points_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_behavior_Operation_feature_of_context_classifier_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_durationConstraint_Operation_first_event_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_durationObservation_Operation_first_event_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_continuation_Operation_first_or_last_interaction_fragment_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_transition_Operation_fork_segment_guards_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_transition_Operation_fork_segment_state_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_pseudostate_Operation_fork_vertex_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_gate_Operation_formal_gate_distinguishable_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_interactionUse_Operation_gates_match_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_generalizationSet_Operation_generalization_same_classifier_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_stereotype_Operation_generalize_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_object_Operation_get_Property = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_getAllAppliedProfiles = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_getAllAttributes = nullptr;
			std::shared_ptr<ecore::EOperation> m_stereotype_Operation_getAllExtendedMetaclasses = nullptr;
			std::shared_ptr<ecore::EOperation> m_behavioredClassifier_Operation_getAllImplementedInterfaces = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_getAllOperations = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_getAllProfileApplications = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_getAllUsedInterfaces = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getApplicableStereotype_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getApplicableStereotypes = nullptr;
			std::shared_ptr<ecore::EOperation> m_profileApplication_Operation_getAppliedDefinition = nullptr;
			std::shared_ptr<ecore::EOperation> m_profileApplication_Operation_getAppliedDefinition_NamedElement = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_getAppliedProfile_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_getAppliedProfile_String_Boolean = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_getAppliedProfiles = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getAppliedStereotype_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getAppliedStereotypes = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getAppliedSubstereotype_Stereotype_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getAppliedSubstereotypes_Stereotype = nullptr;
			std::shared_ptr<ecore::EOperation> m_type_Operation_getAssociations = nullptr;
			std::shared_ptr<ecore::EOperation> m_enumerationLiteral_Operation_getClassifier = nullptr;
			std::shared_ptr<ecore::EOperation> m_enumerationLiteral_Operation_getClassifiers = nullptr;
			std::shared_ptr<ecore::EOperation> m_namedElement_Operation_getClientDependencies = nullptr;
			std::shared_ptr<ecore::EOperation> m_node_Operation_getCommunicationPaths = nullptr;
			std::shared_ptr<ecore::EOperation> m_behavior_Operation_getContext = nullptr;
			std::shared_ptr<ecore::EOperation> m_action_Operation_getContext = nullptr;
			std::shared_ptr<ecore::EOperation> m_occurrenceSpecification_Operation_getCovered = nullptr;
			std::shared_ptr<ecore::EOperation> m_connectorEnd_Operation_getDefiningEnd = nullptr;
			std::shared_ptr<ecore::EOperation> m_stereotype_Operation_getDefinition = nullptr;
			std::shared_ptr<ecore::EOperation> m_profile_Operation_getDefinition = nullptr;
			std::shared_ptr<ecore::EOperation> m_profile_Operation_getDefinition_NamedElement = nullptr;
			std::shared_ptr<ecore::EOperation> m_deploymentTarget_Operation_getDeployedElements = nullptr;
			std::shared_ptr<ecore::EOperation> m_association_Operation_getEndTypes = nullptr;
			std::shared_ptr<ecore::EOperation> m_connectableElement_Operation_getEnds = nullptr;
			std::shared_ptr<ecore::EOperation> m_stereotype_Operation_getExtendedMetaclasses = nullptr;
			std::shared_ptr<ecore::EOperation> m_class_Operation_getExtensions = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_getGenerals = nullptr;
			std::shared_ptr<ecore::EOperation> m_behavioredClassifier_Operation_getImplementedInterfaces = nullptr;
			std::shared_ptr<ecore::EOperation> m_namespace_Operation_getImportedElements = nullptr;
			std::shared_ptr<ecore::EOperation> m_namespace_Operation_getImportedMembers = nullptr;
			std::shared_ptr<ecore::EOperation> m_namespace_Operation_getImportedPackages = nullptr;
			std::shared_ptr<ecore::EOperation> m_vertex_Operation_getIncomings = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_getInheritedMembers = nullptr;
			std::shared_ptr<ecore::EOperation> m_redefinableTemplateSignature_Operation_getInheritedParameters = nullptr;
			std::shared_ptr<ecore::EOperation> m_stereotype_Operation_getKeyword = nullptr;
			std::shared_ptr<ecore::EOperation> m_stereotype_Operation_getKeyword_Boolean = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getKeywords = nullptr;
			std::shared_ptr<ecore::EOperation> m_connector_Operation_getKind = nullptr;
			std::shared_ptr<ecore::EOperation> m_namedElement_Operation_getLabel = nullptr;
			std::shared_ptr<ecore::EOperation> m_namedElement_Operation_getLabel_Boolean = nullptr;
			std::shared_ptr<ecore::EOperation> m_operation_Operation_getLower = nullptr;
			std::shared_ptr<ecore::EOperation> m_message_Operation_getMessageKind = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getMetaClass = nullptr;
			std::shared_ptr<ecore::EOperation> m_extension_Operation_getMetaclass = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getModel = nullptr;
			std::shared_ptr<ecore::EOperation> m_elementImport_Operation_getName = nullptr;
			std::shared_ptr<ecore::EOperation> m_gate_Operation_getName = nullptr;
			std::shared_ptr<ecore::EOperation> m_namespace_Operation_getNamesOfMember_NamedElement = nullptr;
			std::shared_ptr<ecore::EOperation> m_namedElement_Operation_getNamespace = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getNearestPackage = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_getNestedPackages = nullptr;
			std::shared_ptr<ecore::EOperation> m_gate_Operation_getOperand = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_getOperation_String_Type = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_getOperation_String_Boolean = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_getOperations = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_getOpposite = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_getOtherEnd = nullptr;
			std::shared_ptr<ecore::EOperation> m_vertex_Operation_getOutgoings = nullptr;
			std::shared_ptr<ecore::EOperation> m_profile_Operation_getOwnedExtensions_Boolean = nullptr;
			std::shared_ptr<ecore::EOperation> m_namespace_Operation_getOwnedMembers = nullptr;
			std::shared_ptr<ecore::EOperation> m_encapsulatedClassifier_Operation_getOwnedPorts = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_getOwnedStereotypes = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_getOwnedTypes = nullptr;
			std::shared_ptr<ecore::EOperation> m_structuredClassifier_Operation_getParts = nullptr;
			std::shared_ptr<ecore::EOperation> m_stereotype_Operation_getProfile = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_getProfileApplication_Profile = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_getProfileApplication_Profile_Boolean = nullptr;
			std::shared_ptr<ecore::EOperation> m_port_Operation_getProvideds = nullptr;
			std::shared_ptr<ecore::EOperation> m_component_Operation_getProvideds = nullptr;
			std::shared_ptr<ecore::EOperation> m_namedElement_Operation_getQualifiedName = nullptr;
			std::shared_ptr<ecore::EOperation> m_profile_Operation_getReferencedMetaclasses = nullptr;
			std::shared_ptr<ecore::EOperation> m_profile_Operation_getReferencedMetamodels = nullptr;
			std::shared_ptr<ecore::EOperation> m_protocolTransition_Operation_getReferreds = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getRelationships = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getRelationships_EClass = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getRequiredStereotype_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getRequiredStereotypes = nullptr;
			std::shared_ptr<ecore::EOperation> m_port_Operation_getRequireds = nullptr;
			std::shared_ptr<ecore::EOperation> m_component_Operation_getRequireds = nullptr;
			std::shared_ptr<ecore::EOperation> m_opaqueExpression_Operation_getResult = nullptr;
			std::shared_ptr<ecore::EOperation> m_operation_Operation_getReturnResult = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getSourceDirectedRelationships = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getSourceDirectedRelationships_EClass = nullptr;
			std::shared_ptr<ecore::EOperation> m_extension_Operation_getStereotype = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getStereotypeApplication_Stereotype = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getStereotypeApplications = nullptr;
			std::shared_ptr<ecore::EOperation> m_extension_Operation_getStereotypeEnd = nullptr;
			std::shared_ptr<ecore::EOperation> m_class_Operation_getSuperClasses = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getTargetDirectedRelationships = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getTargetDirectedRelationships_EClass = nullptr;
			std::shared_ptr<ecore::EOperation> m_operation_Operation_getType = nullptr;
			std::shared_ptr<ecore::EOperation> m_operation_Operation_getUpper = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_getUsedInterfaces = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_getValue_Stereotype_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_continuation_Operation_global_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_interactionConstraint_Operation_global_data_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_interactionOperand_Operation_guard_contain_references_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_interactionOperand_Operation_guard_directly_prior_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_exceptionHandler_Operation_handler_body_edges_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_exceptionHandler_Operation_handler_body_owner_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_functionBehavior_Operation_hasAllDataTypeAttributes_DataType = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_hasKeyword_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_hasValue_Stereotype_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_hasVisibilityOf_NamedElement = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifierTemplateParameter_Operation_has_constraining_classifier_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_informationItem_Operation_has_no_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_namedElement_Operation_has_no_qualified_name_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_timeConstraint_Operation_has_one_constrainedElement_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_durationConstraint_Operation_has_one_or_two_constrainedElements_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_has_owner_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_activityParameterNode_Operation_has_parameters_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_namedElement_Operation_has_qualified_name_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_pseudostate_Operation_history_vertices_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_enumeration_Operation_immutable_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_namespace_Operation_importMembers_PackageableElement = nullptr;
			std::shared_ptr<ecore::EOperation> m_elementImport_Operation_imported_element_is_public_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_parameter_Operation_in_and_out_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_multiplicityElement_Operation_includesMultiplicity_MultiplicityElement = nullptr;
			std::shared_ptr<ecore::EOperation> m_decisionNode_Operation_incoming_control_one_input_parameter_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_outputPin_Operation_incoming_edges_structured_only_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_joinNode_Operation_incoming_object_flow_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_decisionNode_Operation_incoming_object_one_input_parameter_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_decisionNode_Operation_incoming_outgoing_edges_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_inherit_NamedElement = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_inheritableMembers_Classifier = nullptr;
			std::shared_ptr<ecore::EOperation> m_transition_Operation_initial_transition_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_pseudostate_Operation_initial_vertex_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_region_Operation_initial_vertex_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_parameterSet_Operation_input_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_behavior_Operation_inputParameters = nullptr;
			std::shared_ptr<ecore::EOperation> m_behavioralFeature_Operation_inputParameters = nullptr;
			std::shared_ptr<ecore::EOperation> m_callAction_Operation_inputParameters = nullptr;
			std::shared_ptr<ecore::EOperation> m_objectFlow_Operation_input_and_output_parameter_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_loopNode_Operation_input_edges_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_objectNode_Operation_input_output_parameter_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_actionInputPin_Operation_input_pin_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_reclassifyObjectAction_Operation_input_pin_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_structuredActivityNode_Operation_input_pin_edges_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_reduceAction_Operation_input_type_is_collection_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_addStructuralFeatureValueAction_Operation_insertAt_pin_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_addVariableValueAction_Operation_insertAt_pin_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_linkEndCreationData_Operation_insertAt_pin_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_gate_Operation_inside_cf_gate_distinguishable_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_gate_Operation_inside_cf_matched_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_valueSpecification_Operation_integerValue = nullptr;
			...
			std::shared_ptr<ecore::EOperation> m_gate_Operation_isActual = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_isAttribute = nullptr;
			std::shared_ptr<ecore::EOperation> m_association_Operation_isBinary = nullptr;
			std::shared_ptr<ecore::EOperation> m_parameterableElement_Operation_isCompatibleWith_ParameterableElement = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_isComposite = nullptr;
			std::shared_ptr<ecore::EOperation> m_state_Operation_isComposite = nullptr;
			std::shared_ptr<ecore::EOperation> m_valueSpecification_Operation_isComputable = nullptr;
			std::shared_ptr<ecore::EOperation> m_redefinableElement_Operation_isConsistentWith_RedefinableElement = nullptr;
			std::shared_ptr<ecore::EOperation> m_vertex_Operation_isContainedInRegion_Region = nullptr;
			std::shared_ptr<ecore::EOperation> m_vertex_Operation_isContainedInState_State = nullptr;
			std::shared_ptr<ecore::EOperation> m_profile_Operation_isDefined = nullptr;
			std::shared_ptr<ecore::EOperation> m_namedElement_Operation_isDistinguishableFrom_NamedElement_Namespace = nullptr;
			std::shared_ptr<ecore::EOperation> m_gate_Operation_isFormal = nullptr;
			std::shared_ptr<ecore::EOperation> m_gate_Operation_isInsideCF = nullptr;
			std::shared_ptr<ecore::EOperation> m_opaqueExpression_Operation_isIntegral = nullptr;
			std::shared_ptr<ecore::EOperation> m_class_Operation_isMetaclass = nullptr;
			std::shared_ptr<ecore::EOperation> m_model_Operation_isMetamodel = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_isModelLibrary = nullptr;
			std::shared_ptr<ecore::EOperation> m_multiplicityElement_Operation_isMultivalued = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_isNavigable = nullptr;
			std::shared_ptr<ecore::EOperation> m_opaqueExpression_Operation_isNonNegative = nullptr;
			std::shared_ptr<ecore::EOperation> m_valueSpecification_Operation_isNull = nullptr;
			std::shared_ptr<ecore::EOperation> m_operation_Operation_isOrdered = nullptr;
			std::shared_ptr<ecore::EOperation> m_state_Operation_isOrthogonal = nullptr;
			std::shared_ptr<ecore::EOperation> m_gate_Operation_isOutsideCF = nullptr;
			std::shared_ptr<ecore::EOperation> m_opaqueExpression_Operation_isPositive = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_isProfileApplied_Profile = nullptr;
			std::shared_ptr<ecore::EOperation> m_messageEnd_Operation_isReceive = nullptr;
			std::shared_ptr<ecore::EOperation> m_redefinableElement_Operation_isRedefinitionContextValid_RedefinableElement = nullptr;
			std::shared_ptr<ecore::EOperation> m_extension_Operation_isRequired = nullptr;
			std::shared_ptr<ecore::EOperation> m_messageEnd_Operation_isSend = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_isSetDefault = nullptr;
			std::shared_ptr<ecore::EOperation> m_parameter_Operation_isSetDefault = nullptr;
			std::shared_ptr<ecore::EOperation> m_state_Operation_isSimple = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_isStereotypeApplicable_Stereotype = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_isStereotypeApplied_Stereotype = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_isStereotypeRequired_Stereotype = nullptr;
			std::shared_ptr<ecore::EOperation> m_state_Operation_isSubmachineState = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_isSubstitutableFor_Classifier = nullptr;
			std::shared_ptr<ecore::EOperation> m_templateableElement_Operation_isTemplate = nullptr;
			std::shared_ptr<ecore::EOperation> m_parameterableElement_Operation_isTemplateParameter = nullptr;
			std::shared_ptr<ecore::EOperation> m_operation_Operation_isUnique = nullptr;
			std::shared_ptr<ecore::EOperation> m_extension_Operation_is_binary_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_objectFlow_Operation_is_multicast_or_is_multireceive_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_transition_Operation_join_segment_guards_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_transition_Operation_join_segment_state_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_pseudostate_Operation_join_vertex_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_pseudostate_Operation_junction_vertex_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_opaqueExpression_Operation_language_body_size_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_opaqueAction_Operation_language_body_size_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_loopNode_Operation_loop_variable_outgoing_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_multiplicityElement_Operation_lowerBound = nullptr;
			std::shared_ptr<ecore::EOperation> m_multiplicityElement_Operation_lower_ge_0_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_multiplicityElement_Operation_lower_is_integer_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_makesVisible_NamedElement = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_maps_to_generalization_set_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_generalizationSet_Operation_maps_to_generalization_set_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_operationTemplateParameter_Operation_match_default_signature_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_gate_Operation_matches_Gate = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifierTemplateParameter_Operation_matching_abstract_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_loopNode_Operation_matching_loop_variables_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_conditionalNode_Operation_matching_output_pins_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_loopNode_Operation_matching_output_pins_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_loopNode_Operation_matching_result_pins_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_activity_Operation_maximum_one_parameter_node_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_activity_Operation_maximum_two_parameter_nodes_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_interactionConstraint_Operation_maxint_greater_equal_minint_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_interactionConstraint_Operation_maxint_positive_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_maySpecializeType_Classifier = nullptr;
			std::shared_ptr<ecore::EOperation> m_namespace_Operation_membersAreDistinguishable = nullptr;
			std::shared_ptr<ecore::EOperation> m_namespace_Operation_members_distinguishable_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_extension_Operation_metaclassEnd = nullptr;
			std::shared_ptr<ecore::EOperation> m_profile_Operation_metaclass_reference_not_specialized_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_stateMachine_Operation_method_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_interactionConstraint_Operation_minint_maxint_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_interactionConstraint_Operation_minint_non_negative_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_behavior_Operation_most_one_behavior_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_connectorEnd_Operation_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_extensionEnd_Operation_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_valueSpecificationAction_Operation_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_linkEndData_Operation_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_structuralFeatureAction_Operation_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_writeVariableAction_Operation_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_clearAssociationAction_Operation_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_createLinkObjectAction_Operation_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_createObjectAction_Operation_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_destroyObjectAction_Operation_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readSelfAction_Operation_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_reclassifyObjectAction_Operation_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_startClassifierBehaviorAction_Operation_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_testIdentityAction_Operation_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_multiplicity_of_composite_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readIsClassifiedObjectAction_Operation_multiplicity_of_input_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkObjectEndAction_Operation_multiplicity_of_object_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkObjectEndQualifierAction_Operation_multiplicity_of_object_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_startObjectBehaviorAction_Operation_multiplicity_of_object_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_unmarshallAction_Operation_multiplicity_of_object_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readIsClassifiedObjectAction_Operation_multiplicity_of_output_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_qualifierValue_Operation_multiplicity_of_qualifier_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkObjectEndQualifierAction_Operation_multiplicity_of_qualifier_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_writeStructuralFeatureAction_Operation_multiplicity_of_result_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_clearStructuralFeatureAction_Operation_multiplicity_of_result_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readExtentAction_Operation_multiplicity_of_result_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkObjectEndAction_Operation_multiplicity_of_result_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkObjectEndQualifierAction_Operation_multiplicity_of_result_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_writeStructuralFeatureAction_Operation_multiplicity_of_value_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_mustBeOwned = nullptr;
			std::shared_ptr<ecore::EOperation> m_templateParameter_Operation_must_be_compatible_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_templateParameterSubstitution_Operation_must_be_compatible_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_informationFlow_Operation_must_conform_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_useCase_Operation_must_have_name_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_extensionPoint_Operation_must_have_name_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_actor_Operation_must_have_name_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_stereotype_Operation_name_not_clash_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_packageableElement_Operation_namespace_needs_visibility_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkAction_Operation_navigable_open_end_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_useCase_Operation_no_association_to_use_case_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_actionInputPin_Operation_no_control_or_object_flow_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_no_cycles_in_generalization_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_activityParameterNode_Operation_no_edges_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_finalState_Operation_no_entry_behavior_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_objectFlow_Operation_no_executable_nodes_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_finalState_Operation_no_exit_behavior_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_timeExpression_Operation_no_expr_requires_observation_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_duration_Operation_no_expr_requires_observation_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_valuePin_Operation_no_incoming_edges_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_activityParameterNode_Operation_no_incoming_edges_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_initialNode_Operation_no_incoming_edges_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_acceptEventAction_Operation_no_input_pins_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_conditionalNode_Operation_no_input_pins_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_component_Operation_no_nested_classifiers_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_destructionOccurrenceSpecification_Operation_no_occurrence_specifications_below_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_broadcastSignalAction_Operation_no_onport_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_callBehaviorAction_Operation_no_onport_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_startObjectBehaviorAction_Operation_no_onport_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_finalNode_Operation_no_outgoing_edges_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_activityParameterNode_Operation_no_outgoing_edges_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_finalState_Operation_no_outgoing_transitions_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_acceptEventAction_Operation_no_output_pins_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_component_Operation_no_packaged_elements_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_finalState_Operation_no_regions_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_constraint_Operation_no_side_effects_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_finalState_Operation_no_state_behavior_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_destroyObjectAction_Operation_no_type_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readIsClassifiedObjectAction_Operation_no_type_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_testIdentityAction_Operation_no_type_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_activityGroup_Operation_nodes_and_edges_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_non_final_parents_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_redefinableElement_Operation_non_leaf_redefinition_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_extension_Operation_non_owned_end_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_constraint_Operation_not_apply_to_self_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_activityGroup_Operation_not_contained_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_interaction_Operation_not_contained_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_parameter_Operation_not_exception_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_informationItem_Operation_not_instantiable_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_not_own_self_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_linkAction_Operation_not_static_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_structuralFeatureAction_Operation_not_static_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readSelfAction_Operation_not_static_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_pin_Operation_not_unique_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_broadcastSignalAction_Operation_number_of_arguments_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_unmarshallAction_Operation_number_of_result_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_sendSignalAction_Operation_number_order_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_parameter_Operation_object_effect_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_objectNode_Operation_object_flow_edges_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_controlFlow_Operation_object_nodes_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_structuralFeatureAction_Operation_object_type_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_unmarshallAction_Operation_object_type_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_message_Operation_occurrence_specifications_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_conditionalNode_Operation_one_clause_with_executable_node_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_structuralFeatureAction_Operation_one_featuring_classifier_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_forkNode_Operation_one_incoming_edge_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_exceptionHandler_Operation_one_input_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkAction_Operation_one_open_end_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_joinNode_Operation_one_outgoing_edge_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_mergeNode_Operation_one_outgoing_edge_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_functionBehavior_Operation_one_output_parameter_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_acceptEventAction_Operation_one_output_pin_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_actionInputPin_Operation_one_output_pin_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_templateBinding_Operation_one_parameter_substitution_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_opaqueExpression_Operation_one_return_result_parameter_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_operation_Operation_only_body_for_query_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_opaqueExpression_Operation_only_return_result_parameters_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkAction_Operation_openEnd = nullptr;
			std::shared_ptr<ecore::EOperation> m_stringExpression_Operation_operands_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_messageEnd_Operation_oppositeEnd = nullptr;
			std::shared_ptr<ecore::EOperation> m_combinedFragment_Operation_opt_loop_break_neg_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_inputPin_Operation_outgoing_edges_structured_only_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_pseudostate_Operation_outgoing_from_initial_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_transition_Operation_outgoing_pseudostates_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_behavior_Operation_outputParameters = nullptr;
			std::shared_ptr<ecore::EOperation> m_behavioralFeature_Operation_outputParameters = nullptr;
			std::shared_ptr<ecore::EOperation> m_callAction_Operation_outputParameters = nullptr;
			std::shared_ptr<ecore::EOperation> m_structuredActivityNode_Operation_output_pin_edges_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_exceptionHandler_Operation_output_pins_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_reduceAction_Operation_output_types_are_compatible_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_gate_Operation_outside_cf_gate_distinguishable_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_gate_Operation_outside_cf_matched_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_templateSignature_Operation_own_elements_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_region_Operation_owned_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_templateBinding_Operation_parameter_substitution_formal_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_templateableElement_Operation_parameterableElements = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifierTemplateParameter_Operation_parametered_element_no_features_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_decisionNode_Operation_parameters_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_behavior_Operation_parameters_match_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_parents = nullptr;
			std::shared_ptr<ecore::EOperation> m_connectorEnd_Operation_part_with_port_empty_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_partDecomposition_Operation_parts_of_internal_structures_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_class_Operation_passive_class_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_replyAction_Operation_pins_match_parameter_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_port_Operation_port_aggregation_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkObjectEndAction_Operation_property_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_linkEndData_Operation_property_is_association_end_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_protocolStateMachine_Operation_protocol_transitions_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_packageImport_Operation_public_or_private_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_qualified_is_association_end_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_qualifierValue_Operation_qualifier_attribute_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkObjectEndQualifierAction_Operation_qualifier_attribute_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_linkEndData_Operation_qualifiers_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_valueSpecification_Operation_realValue = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_redefined_property_inherited_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_redefinableTemplateSignature_Operation_redefines_parents_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_region_Operation_redefinitionContext = nullptr;
			std::shared_ptr<ecore::EOperation> m_state_Operation_redefinitionContext = nullptr;
			std::shared_ptr<ecore::EOperation> m_transition_Operation_redefinitionContext = nullptr;
			std::shared_ptr<ecore::EOperation> m_redefinableElement_Operation_redefinition_consistent_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_redefinableElement_Operation_redefinition_context_valid_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_reduceAction_Operation_reducer_inputs_output_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_parameter_Operation_reentrant_behaviors_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_profile_Operation_references_same_metamodel_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_protocolTransition_Operation_refers_to_operation_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_expansionNode_Operation_region_as_input_or_output_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_removeStructuralFeatureValueAction_Operation_removeAt_and_value_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_removeVariableValueAction_Operation_removeAt_and_value_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_removeKeyword_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_activityPartition_Operation_represents_classifier_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_activityPartition_Operation_represents_property_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_activityPartition_Operation_represents_property_and_is_contained_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_addStructuralFeatureValueAction_Operation_required_value_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_addVariableValueAction_Operation_required_value_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_testIdentityAction_Operation_result_is_boolean_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_conditionalNode_Operation_result_no_incoming_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_loopNode_Operation_result_no_incoming_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_acceptCallAction_Operation_result_pins_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_callAction_Operation_result_pins_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_operation_Operation_returnResult = nullptr;
			std::shared_ptr<ecore::EOperation> m_interactionUse_Operation_returnValueRecipient_coverage_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_interactionUse_Operation_returnValue_type_recipient_correspondence_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_connectorEnd_Operation_role_and_part_with_port_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_connector_Operation_roles_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_linkAction_Operation_same_association_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_lifeline_Operation_same_classifier_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_executionSpecification_Operation_same_lifeline_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_continuation_Operation_same_name_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_reception_Operation_same_name_as_signal_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_parameterSet_Operation_same_parameterized_entity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_linkAction_Operation_same_pins_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_reception_Operation_same_structure_as_signal_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_linkEndData_Operation_same_type_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_clearAssociationAction_Operation_same_type_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_createObjectAction_Operation_same_type_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkObjectEndQualifierAction_Operation_same_type_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_activityParameterNode_Operation_same_type_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_objectFlow_Operation_same_upper_bounds_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_variableAction_Operation_scope_of_variable_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_objectNode_Operation_selection_behavior_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_objectFlow_Operation_selection_behavior_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_lifeline_Operation_selector_int_or_string_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_lifeline_Operation_selector_specified_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_connectorEnd_Operation_self_part_with_port_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_message_Operation_sending_receiving_message_event_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_namedElement_Operation_separator = nullptr;
			std::shared_ptr<ecore::EOperation> m_object_Operation_set_Property_EJavaObject = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_setBooleanDefaultValue_Boolean = nullptr;
			std::shared_ptr<ecore::EOperation> m_parameter_Operation_setBooleanDefaultValue_Boolean = nullptr;
			std::shared_ptr<ecore::EOperation> m_occurrenceSpecification_Operation_setCovered_Lifeline = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_setIntegerDefaultValue_Integer = nullptr;
			std::shared_ptr<ecore::EOperation> m_parameter_Operation_setIntegerDefaultValue_Integer = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_setIsNavigable_Boolean = nullptr;
			std::shared_ptr<ecore::EOperation> m_operation_Operation_setIsOrdered_Boolean = nullptr;
			std::shared_ptr<ecore::EOperation> m_operation_Operation_setIsUnique_Boolean = nullptr;
			std::shared_ptr<ecore::EOperation> m_operation_Operation_setLower_Integer = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_setNullDefaultValue = nullptr;
			std::shared_ptr<ecore::EOperation> m_parameter_Operation_setNullDefaultValue = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_setRealDefaultValue_Real = nullptr;
			std::shared_ptr<ecore::EOperation> m_parameter_Operation_setRealDefaultValue_Real = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_setStringDefaultValue_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_parameter_Operation_setStringDefaultValue_String = nullptr;
			std::shared_ptr<ecore::EOperation> m_operation_Operation_setType_Type = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_setUnlimitedNaturalDefaultValue_UnlimitedNatural = nullptr;
			std::shared_ptr<ecore::EOperation> m_parameter_Operation_setUnlimitedNaturalDefaultValue_UnlimitedNatural = nullptr;
			std::shared_ptr<ecore::EOperation> m_operation_Operation_setUpper_UnlimitedNatural = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_setValue_Stereotype_EJavaObject = nullptr;
			std::shared_ptr<ecore::EOperation> m_loopNode_Operation_setup_test_and_body_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_region_Operation_shallow_history_vertex_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_message_Operation_signature_is_operation_reply_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_message_Operation_signature_is_operation_request_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_message_Operation_signature_is_signal_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_message_Operation_signature_refer_to_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_structuredActivityNode_Operation_sourceNodes = nullptr;
			std::shared_ptr<ecore::EOperation> m_activityEdge_Operation_source_and_target_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_informationItem_Operation_sources_and_targets_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_informationFlow_Operation_sources_and_targets_kind_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_classifier_Operation_specialize_type_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_association_Operation_specialized_end_number_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_association_Operation_specialized_end_types_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_transition_Operation_state_is_external_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_transition_Operation_state_is_internal_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_transition_Operation_state_is_local_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_parameter_Operation_stream_and_exception_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_valueSpecification_Operation_stringValue = nullptr;
			std::shared_ptr<ecore::EOperation> m_instanceSpecification_Operation_structural_feature_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_unmarshallAction_Operation_structural_feature_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_stringExpression_Operation_subexpressions_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_state_Operation_submachine_or_regions_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_state_Operation_submachine_states_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_subsetted_property_names_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_subsettingContext = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_subsetting_context_conforms_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_subsetting_rules_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_callAction_Operation_synchronous_call_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_objectFlow_Operation_target_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_structuredActivityNode_Operation_targetNodes = nullptr;
			std::shared_ptr<ecore::EOperation> m_clause_Operation_test_and_body_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_objectFlow_Operation_transformation_behavior_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_pseudostate_Operation_transitions_incoming_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_pseudostate_Operation_transitions_outgoing_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_acceptCallAction_Operation_trigger_call_event_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_trigger_Operation_trigger_with_ports_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_decisionNode_Operation_two_input_parameters_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_parameterSet_Operation_two_parameter_sets_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readSelfAction_Operation_type_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_considerIgnoreFragment_Operation_type_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkAction_Operation_type_and_ordering_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readStructuralFeatureAction_Operation_type_and_ordering_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readVariableAction_Operation_type_and_ordering_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_startClassifierBehaviorAction_Operation_type_has_classifier_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readExtentAction_Operation_type_is_classifier_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkObjectEndAction_Operation_type_of_object_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkObjectEndQualifierAction_Operation_type_of_object_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_startObjectBehaviorAction_Operation_type_of_object_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_type_of_opposite_end_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_qualifierValue_Operation_type_of_qualifier_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_writeStructuralFeatureAction_Operation_type_of_result_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_clearStructuralFeatureAction_Operation_type_of_result_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_createLinkObjectAction_Operation_type_of_result_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkObjectEndAction_Operation_type_of_result_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_writeStructuralFeatureAction_Operation_type_of_value_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_unmarshallAction_Operation_type_ordering_and_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_broadcastSignalAction_Operation_type_ordering_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_sendSignalAction_Operation_type_ordering_multiplicity_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_callOperationAction_Operation_type_target_pin_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_sendObjectAction_Operation_type_target_pin_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_sendSignalAction_Operation_type_target_pin_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_connector_Operation_types_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_functionBehavior_Operation_types_of_parameters_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_unapplyProfile_Profile = nullptr;
			std::shared_ptr<ecore::EOperation> m_element_Operation_unapplyStereotype_Stereotype = nullptr;
			std::shared_ptr<ecore::EOperation> m_templateSignature_Operation_unique_parameters_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_valueSpecification_Operation_unlimitedValue = nullptr;
			std::shared_ptr<ecore::EOperation> m_acceptCallAction_Operation_unmarshall_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_acceptEventAction_Operation_unmarshall_signal_events_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_object_Operation_unset_Property = nullptr;
			std::shared_ptr<ecore::EOperation> m_property_Operation_unsetDefault = nullptr;
			std::shared_ptr<ecore::EOperation> m_parameter_Operation_unsetDefault = nullptr;
			std::shared_ptr<ecore::EOperation> m_multiplicityElement_Operation_upperBound = nullptr;
			std::shared_ptr<ecore::EOperation> m_multiplicityElement_Operation_upper_ge_lower_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_multiplicityElement_Operation_upper_is_unlimitedNatural_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_opaqueExpression_Operation_value = nullptr;
			std::shared_ptr<ecore::EOperation> m_multiplicityElement_Operation_value_specification_constant_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_multiplicityElement_Operation_value_specification_no_side_effects_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_writeVariableAction_Operation_value_type_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_interface_Operation_visibility_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_structuralFeatureAction_Operation_visibility_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_readLinkAction_Operation_visibility_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_namedElement_Operation_visibility_needs_ownership_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_elementImport_Operation_visibility_public_or_private_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_package_Operation_visibleMembers = nullptr;
			std::shared_ptr<ecore::EOperation> m_timeEvent_Operation_when_non_negative_EDiagnosticChain_EMap = nullptr;
			std::shared_ptr<ecore::EOperation> m_decisionNode_Operation_zero_input_parameters_EDiagnosticChain_EMap = nullptr;
