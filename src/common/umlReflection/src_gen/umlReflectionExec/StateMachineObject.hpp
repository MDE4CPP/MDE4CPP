...
#ifndef UML_STATEMACHINE_EXECUTION_HPP
#define UML_STATEMACHINE_EXECUTION_HPP
...
namespace UML 
{
	class StateMachineObject : virtual public UML::BehaviorObject
	{
		public:
		    //constructors
		    StateMachineObject(StateMachineObject &obj);
		    StateMachineObject(std::shared_ptr<uml::StateMachine>);
		 	StateMachineObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::StateMachine> getStateMachineValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setStateMachineValue(std::shared_ptr<uml::StateMachine>);
			virtual void setThisStateMachineObjectPtr(std::weak_ptr<StateMachineObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::StateMachine> m_StateMachineValue = nullptr;
	};
}
#endif /* end of include guard: UML_STATEMACHINE_OBJECT_HPP */
