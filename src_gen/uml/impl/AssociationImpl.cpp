...
AssociationImpl::AssociationImpl()
{
	...
	//*********************************
		/*Subset*/
		m_endType.reset(new Subset<uml::Type, uml::Element >(m_relatedElement));//(m_relatedElement));
	
	
		/*SubsetUnion*/
		m_memberEnd.reset(new SubsetUnion<uml::Property, uml::NamedElement >(m_member));// member));
	
	
		/*Subset*/
		m_navigableOwnedEnd.reset(new Subset<uml::Property, uml::Property /*Subset does not reference a union*/ >(m_ownedEnd));//(m_ownedEnd));
	
	
		/*SubsetUnion*/
		m_ownedEnd.reset(new SubsetUnion<uml::Property, uml::Property /*Subset does not reference a union*/
		,uml::Feature
		,uml::NamedElement >(m_memberEnd,m_feature,m_ownedMember));// memberEnd));
