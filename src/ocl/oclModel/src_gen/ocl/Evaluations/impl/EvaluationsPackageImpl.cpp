...
const std::shared_ptr<ecore::EReference>& ocl::Evaluations::EvaluationsPackageImpl::getAssociationClassCallExpEval_Attribute_referredAssociationClass() const
{
...
const std::shared_ptr<ecore::EReference>& ocl::Evaluations::EvaluationsPackageImpl::getAssociationEndCallExpEval_Attribute_referredAssociationEnd() const
{
...
const std::shared_ptr<ecore::EReference>& ocl::Evaluations::EvaluationsPackageImpl::getAttributeCallExpEval_Attribute_referredAttribute() const
{
...
const std::shared_ptr<ecore::EOperation>& ocl::Evaluations::EvaluationsPackageImpl::getEvalEnvironment_Operation_find_String() const
{
...
const std::shared_ptr<ecore::EReference>& ocl::Evaluations::EvaluationsPackageImpl::getLetExpEval_Attribute_variable() const
{
...
const std::shared_ptr<ecore::EReference>& ocl::Evaluations::EvaluationsPackageImpl::getLoopExpEval_Attribute_iterators() const
{
...
const std::shared_ptr<ecore::EReference>& ocl::Evaluations::EvaluationsPackageImpl::getNavigationCallExpEval_Attribute_navigationSource() const
{
...
const std::shared_ptr<ecore::EReference>& ocl::Evaluations::EvaluationsPackageImpl::getOperationCallExpEval_Attribute_referredOperation() const
{
...
const std::shared_ptr<ecore::EReference>& ocl::Evaluations::EvaluationsPackageImpl::getVariableDeclEval_Attribute_name() const
{
...
const std::shared_ptr<ecore::EReference>& ocl::Evaluations::EvaluationsPackageImpl::getVariableExpEval_Attribute_referredVariable() const
{
