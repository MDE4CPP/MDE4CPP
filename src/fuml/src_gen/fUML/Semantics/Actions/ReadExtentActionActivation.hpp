...
namespace fUML::Semantics::Actions 
{
	...
	class FUML_API ReadExtentActionActivation : virtual public ActionActivation
	{
		public:
		...
		public:
			...
			//*********************************
			virtual const std::shared_ptr<uml::ReadExtentAction>& getReadExtentAction() const = 0;
		...
		protected:
			...
			// Reference Members
			//*********************************
			std::shared_ptr<uml::ReadExtentAction> m_readExtentAction;
	};
}
