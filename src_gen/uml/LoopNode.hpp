...
namespace uml 
{
	...
	class LoopNode:virtual public StructuredActivityNode	{
		...
		public:
			...
			virtual bool
			 result_no_incoming(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			
			/*!
			 The loopVariableInputs must not have outgoing edges.
			loopVariableInput.outgoing->isEmpty() */ 
			virtual bool
			 input_edges(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 executable_nodes(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 setup_test_and_body(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 matching_output_pins(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 matching_loop_variables(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 matching_result_pins(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 loop_variable_outgoing(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			<p>From package UML::Actions.</p> */
			virtual 		std::shared_ptr<Subset<uml::OutputPin, uml::Element > >
			 getLoopVariable() const = 0;
