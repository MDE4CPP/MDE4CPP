...
void ActionsPackageImpl::createActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_actionActivation_Operation_getMatchingLinks_Association_StructuralFeature_FUML_Object = factory->createEOperation_as_eOperations_in_EClass(m_actionActivation_Class, ACTIONACTIVATION_OPERATION_GETMATCHINGLINKS_ASSOCIATION_STRUCTURALFEATURE_FUML_OBJECT);
	m_actionActivation_Operation_getMatchingLinksForEndValue_Association_StructuralFeature_FUML_Object_FUML_Object = factory->createEOperation_as_eOperations_in_EClass(m_actionActivation_Class, ACTIONACTIVATION_OPERATION_GETMATCHINGLINKSFORENDVALUE_ASSOCIATION_STRUCTURALFEATURE_FUML_OBJECT_FUML_OBJECT);
...
void ActionsPackageImpl::createDestroyObjectActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_destroyObjectActionActivation_Operation_destroyObject_EJavaObject_EBoolean_EBoolean = factory->createEOperation_as_eOperations_in_EClass(m_destroyObjectActionActivation_Class, DESTROYOBJECTACTIONACTIVATION_OPERATION_DESTROYOBJECT_EJAVAOBJECT_EBOOLEAN_EBOOLEAN);
...
void ActionsPackageImpl::createWriteStructuralFeatureActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_writeStructuralFeatureActionActivation_Operation_position_EJavaObject_EJavaObject_EInt = factory->createEOperation_as_eOperations_in_EClass(m_writeStructuralFeatureActionActivation_Class, WRITESTRUCTURALFEATUREACTIONACTIVATION_OPERATION_POSITION_EJAVAOBJECT_EJAVAOBJECT_EINT);
