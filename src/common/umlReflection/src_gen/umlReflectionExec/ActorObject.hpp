...
#ifndef UML_ACTOR_EXECUTION_HPP
#define UML_ACTOR_EXECUTION_HPP
...
namespace UML 
{
	class ActorObject : virtual public UML::BehavioredClassifierObject
	{
		public:
		    //constructors
		    ActorObject(ActorObject &obj);
		    ActorObject(std::shared_ptr<uml::Actor>);
		 	ActorObject();
		    //destructor
		    virtual ~ActorObject();
			...
			virtual std::shared_ptr<uml::Actor> getActorValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setActorValue(std::shared_ptr<uml::Actor>);
			virtual void setThisActorObjectPtr(std::weak_ptr<ActorObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Actor> m_ActorValue = nullptr;
	};
}
#endif /* end of include guard: UML_ACTOR_OBJECT_HPP */
