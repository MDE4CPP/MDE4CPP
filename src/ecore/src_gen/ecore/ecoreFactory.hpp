...
namespace ecore 
{
	class ECORE_API ecoreFactory : virtual public EFactory 
	{
		...
		protected:
			...
			virtual std::shared_ptr<EAnnotation> createEAnnotation_as_eContentUnion_in_EObject(std::weak_ptr<ecore::EObject> par_EObject, const int metaElementID = ecorePackage::EANNOTATION_CLASS) const = 0;
			...
			virtual std::shared_ptr<EAttribute> createEAttribute_as_eContentUnion_in_EObject(std::weak_ptr<ecore::EObject> par_EObject, const int metaElementID = ecorePackage::EATTRIBUTE_CLASS) const = 0;
			...
			virtual std::shared_ptr<EClass> createEClass_as_eContentUnion_in_EObject(std::weak_ptr<ecore::EObject> par_EObject, const int metaElementID = ecorePackage::ECLASS_CLASS) const = 0;
			...
			virtual std::shared_ptr<EDataType> createEDataType_as_eContentUnion_in_EObject(std::weak_ptr<ecore::EObject> par_EObject, const int metaElementID = ecorePackage::EDATATYPE_CLASS) const = 0;
			...
			virtual std::shared_ptr<EEnum> createEEnum_as_eContentUnion_in_EObject(std::weak_ptr<ecore::EObject> par_EObject, const int metaElementID = ecorePackage::EENUM_CLASS) const = 0;
			...
			virtual std::shared_ptr<EEnumLiteral> createEEnumLiteral_as_eContentUnion_in_EObject(std::weak_ptr<ecore::EObject> par_EObject, const int metaElementID = ecorePackage::EENUMLITERAL_CLASS) const = 0;
			...
			virtual std::shared_ptr<EFactory> createEFactory_as_eContentUnion_in_EObject(std::weak_ptr<ecore::EObject> par_EObject, const int metaElementID = ecorePackage::EFACTORY_CLASS) const = 0;
			...
			virtual std::shared_ptr<EObjectAny> createEObjectAny(const int metaElementID = ecorePackage::EOBJECTANY_CLASS) const = 0;
			//Add as contained object
			virtual std::shared_ptr<EObjectAny> createEObjectAny_as_contents_in_EAnnotation(std::shared_ptr<EAnnotation> par_EAnnotation, const int metaElementID = ecorePackage::EOBJECTANY_CLASS) const = 0;
			virtual std::shared_ptr<EObjectAny> createEObjectAny_as_eContentUnion_in_EObject(std::weak_ptr<ecore::EObject> par_EObject, const int metaElementID = ecorePackage::EOBJECTANY_CLASS) const = 0;
			...
			virtual std::shared_ptr<EOperation> createEOperation_as_eContentUnion_in_EObject(std::weak_ptr<ecore::EObject> par_EObject, const int metaElementID = ecorePackage::EOPERATION_CLASS) const = 0;
			...
			virtual std::shared_ptr<EPackage> createEPackage_as_eContentUnion_in_EObject(std::weak_ptr<ecore::EObject> par_EObject, const int metaElementID = ecorePackage::EPACKAGE_CLASS) const = 0;
			...
			virtual std::shared_ptr<EParameter> createEParameter_as_eContentUnion_in_EObject(std::weak_ptr<ecore::EObject> par_EObject, const int metaElementID = ecorePackage::EPARAMETER_CLASS) const = 0;
			...
			virtual std::shared_ptr<EReference> createEReference_as_eContentUnion_in_EObject(std::weak_ptr<ecore::EObject> par_EObject, const int metaElementID = ecorePackage::EREFERENCE_CLASS) const = 0;
			...
			virtual std::shared_ptr<ETypeParameter> createETypeParameter_as_eContentUnion_in_EObject(std::weak_ptr<ecore::EObject> par_EObject, const int metaElementID = ecorePackage::ETYPEPARAMETER_CLASS) const = 0;
