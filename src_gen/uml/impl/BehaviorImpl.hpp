...
namespace uml 
{
	class BehaviorImpl :virtual public ClassImpl, virtual public Behavior 
	{
		...
		public:
			...
			virtual bool
			 most_one_behavior(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
			...
			virtual bool
			 parameters_match(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
			...
			virtual bool
			 feature_of_context_classifier(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
			...
			virtual std::shared_ptr<uml::BehavioredClassifier> 
			 behavioredClassifier(std::shared_ptr<uml::Element>  from)  ;
