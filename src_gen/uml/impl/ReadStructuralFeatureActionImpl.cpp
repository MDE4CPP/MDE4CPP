...
void ReadStructuralFeatureActionImpl::eSet(int featureID, boost::any newValue)
{
	switch(featureID)
	{
		case UmlPackage::ACTIVITYNODE_EREFERENCE_ACTIVITY:
		...
		case UmlPackage::ACTIVITYNODE_EREFERENCE_INSTRUCTUREDNODE:
		{
			...
			setInStructuredNode(_inStructuredNode); //16516
			break;
		}
		case UmlPackage::REDEFINABLEELEMENT_EATTRIBUTE_ISLEAF:
		{
		...
		case UmlPackage::ACTION_EATTRIBUTE_ISLOCALLYREENTRANT:
		{
			...
			setIsLocallyReentrant(_isLocallyReentrant); //16524
			break;
		}
		case UmlPackage::NAMEDELEMENT_EATTRIBUTE_NAME:
		{
		...
		case UmlPackage::NAMEDELEMENT_EREFERENCE_NAMEEXPRESSION:
		{
			...
			setNameExpression(_nameExpression); //1656
			break;
		}
		case UmlPackage::STRUCTURALFEATUREACTION_EREFERENCE_OBJECT:
		{
		...
		case UmlPackage::STRUCTURALFEATUREACTION_EREFERENCE_STRUCTURALFEATURE:
		{
			...
			setStructuralFeature(_structuralFeature); //16529
			break;
		}
		case UmlPackage::NAMEDELEMENT_EATTRIBUTE_VISIBILITY:
		{
			...
			setVisibility(_visibility); //1659
			break;
		}
	}
}
