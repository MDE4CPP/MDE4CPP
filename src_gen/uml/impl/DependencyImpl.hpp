...
namespace uml 
{
	class DependencyImpl :virtual public DirectedRelationshipImpl, virtual public PackageableElementImpl, virtual public Dependency 
	{
		...
		public:
			...
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> getClient() const ;
			...
			<p>From package UML::CommonStructure.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> getSupplier() const ;
