...
#ifndef UML_OPAQUEACTION_EXECUTION_HPP
#define UML_OPAQUEACTION_EXECUTION_HPP
...
namespace UML 
{
	class OpaqueActionObject : virtual public UML::ActionObject
	{
		public:
		    //constructors
		    OpaqueActionObject(OpaqueActionObject &obj);
		    OpaqueActionObject(std::shared_ptr<uml::OpaqueAction>);
		 	OpaqueActionObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::OpaqueAction> getOpaqueActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setOpaqueActionValue(std::shared_ptr<uml::OpaqueAction>);
			virtual void setThisOpaqueActionObjectPtr(std::weak_ptr<OpaqueActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::OpaqueAction> m_OpaqueActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_OPAQUEACTION_OBJECT_HPP */
