...
#ifndef UML_FINALSTATE_EXECUTION_HPP
#define UML_FINALSTATE_EXECUTION_HPP
...
namespace UML 
{
	class FinalStateObject : virtual public UML::StateObject
	{
		public:
		    //constructors
		    FinalStateObject(FinalStateObject &obj);
		    FinalStateObject(std::shared_ptr<uml::FinalState>);
		 	FinalStateObject();
		    //destructor
		    virtual ~FinalStateObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			FinalStateObject& operator=(FinalStateObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::FinalState> getFinalStateValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setFinalStateValue(std::shared_ptr<uml::FinalState>);
			virtual void setThisFinalStateObjectPtr(std::weak_ptr<FinalStateObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::FinalState> m_FinalStateValue = nullptr;
	};
}
#endif /* end of include guard: UML_FINALSTATE_OBJECT_HPP */
