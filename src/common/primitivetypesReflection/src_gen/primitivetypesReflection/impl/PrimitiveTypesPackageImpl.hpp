...
namespace PrimitiveTypes
{
	class PrimitiveTypesPackageImpl : virtual public uml::ModelImpl, virtual public PrimitiveTypesPackage
	{
		...
		private:
			...
			void createPackageDataTypes(std::shared_ptr<uml::Package> primitiveTypes, std::shared_ptr<uml::umlFactory> factory);
			...
			void createPackageEvents(std::shared_ptr<uml::Package> primitiveTypes, std::shared_ptr<uml::umlFactory> factory);
