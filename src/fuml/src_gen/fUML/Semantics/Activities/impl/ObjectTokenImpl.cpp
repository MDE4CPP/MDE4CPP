...
void ObjectTokenImpl::loadAttributes(std::shared_ptr<persistence::interfaces::XLoadHandler> loadHandler, std::map<std::string, std::string> attr_list)
{
	try
	{
		...
		if ( iter != attr_list.end() )
		{
			...
			std::cout << "| ERROR    | " << __PRETTY_FUNCTION__ << " handle type of 'value'" << " org.eclipse.emf.ecore.impl.EDataTypeImpl@84487f4 (name: EJavaObject) (instanceClassName: java.lang.Object) (serializable: true)" << std::endl; 
