...
namespace uml 
{
	...
	class RedefinableTemplateSignature:virtual public RedefinableElement,virtual public TemplateSignature	{
		...
		public:
			...
			virtual bool
			 redefines_parents(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
