...
ecore::EClass* OpaqueBehaviorImpl::eStaticClass() const
{
...
std::vector<std::string> *  OpaqueBehaviorImpl::getBody() const 
{
	return m_body;
}
...
std::vector<std::string> *  OpaqueBehaviorImpl::getLanguage() const 
{
	return m_language;
}
...
// Union Getter
//*********************************
std::vector<uml::NamedElement * > *  OpaqueBehaviorImpl::getOwnedMember() const
{
...
std::vector<uml::ConnectableElement * > *  OpaqueBehaviorImpl::getRole() const
{
...
std::vector<uml::NamedElement * > *  OpaqueBehaviorImpl::getMember() const
{
...
std::vector<uml::Property * > *  OpaqueBehaviorImpl::getAttribute() const
{
...
std::vector<uml::Classifier * > *  OpaqueBehaviorImpl::getRedefinitionContext() const
{
...
std::vector<uml::RedefinableElement * > *  OpaqueBehaviorImpl::getRedefinedElement() const
{
...
std::vector<uml::Feature * > *  OpaqueBehaviorImpl::getFeature() const
{
...
uml::Element *  OpaqueBehaviorImpl::getOwner() const
{
...
uml::Namespace *  OpaqueBehaviorImpl::getNamespace() const
{
...
std::vector<uml::Element * > *  OpaqueBehaviorImpl::getOwnedElement() const
{
