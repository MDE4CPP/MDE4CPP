...
void FoundationalModelLibraryExecutionFactoryImpl::createFoundationalModelLibrary_BasicInputOutput_ReadLineExecutionPrototype()
{
	...
	std::shared_ptr<PSCS::Semantics::Actions::CS_CreateObjectActionActivation> foundationalModelLibrary_BasicInputOutput_ReadLine_CreateObjectAction_Create_StandardInputChannel_CreateObjectActionActivation = PSCS::Semantics::Actions::ActionsFactory::eInstance()->createCS_CreateObjectActionActivation();
	...
	std::shared_ptr<PSCS::Semantics::Actions::CS_CallOperationActionActivation> foundationalModelLibrary_BasicInputOutput_ReadLine_CallOperationAction_Call_readLine_CallOperationActionActivation = PSCS::Semantics::Actions::ActionsFactory::eInstance()->createCS_CallOperationActionActivation();
...
void FoundationalModelLibraryExecutionFactoryImpl::createFoundationalModelLibrary_BasicInputOutput_WriteLineExecutionPrototype()
{
	...
	std::shared_ptr<PSCS::Semantics::Actions::CS_CallOperationActionActivation> foundationalModelLibrary_BasicInputOutput_WriteLine_CallOperationAction_Call_writeLine_CallOperationActionActivation = PSCS::Semantics::Actions::ActionsFactory::eInstance()->createCS_CallOperationActionActivation();
	...
	std::shared_ptr<PSCS::Semantics::Actions::CS_CreateObjectActionActivation> foundationalModelLibrary_BasicInputOutput_WriteLine_CreateObjectAction_Create_StandardOutputChannel_CreateObjectActionActivation = PSCS::Semantics::Actions::ActionsFactory::eInstance()->createCS_CreateObjectActionActivation();
