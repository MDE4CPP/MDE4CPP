...
#ifndef UML_MESSAGEOCCURRENCESPECIFICATION_EXECUTION_HPP
#define UML_MESSAGEOCCURRENCESPECIFICATION_EXECUTION_HPP
...
namespace UML 
{
	class MessageOccurrenceSpecificationObject : virtual public UML::MessageEndObject , virtual public UML::OccurrenceSpecificationObject
	{
		public:
		    //constructors
		    MessageOccurrenceSpecificationObject(MessageOccurrenceSpecificationObject &obj);
		    MessageOccurrenceSpecificationObject(std::shared_ptr<uml::MessageOccurrenceSpecification>);
		 	MessageOccurrenceSpecificationObject();
		    //destructor
		    virtual ~MessageOccurrenceSpecificationObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			MessageOccurrenceSpecificationObject& operator=(MessageOccurrenceSpecificationObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::MessageOccurrenceSpecification> getMessageOccurrenceSpecificationValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setMessageOccurrenceSpecificationValue(std::shared_ptr<uml::MessageOccurrenceSpecification>);
			virtual void setThisMessageOccurrenceSpecificationObjectPtr(std::weak_ptr<MessageOccurrenceSpecificationObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::MessageOccurrenceSpecification> m_MessageOccurrenceSpecificationValue = nullptr;
	};
}
#endif /* end of include guard: UML_MESSAGEOCCURRENCESPECIFICATION_OBJECT_HPP */
