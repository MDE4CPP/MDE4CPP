...
// Union Getter
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> ReadSelfActionImpl::getOwnedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::ActivityGroup>>> ReadSelfActionImpl::getInGroup() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::OutputPin>>> ReadSelfActionImpl::getOutput() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> ReadSelfActionImpl::getRedefinedElement() const
{
