...
// Operations
//*********************************
bool CreateLinkActionImpl::association_not_abstract(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < std::shared_ptr<Any>, std::shared_ptr<Any>>> context)
{
...
std::shared_ptr<Any> CreateLinkActionImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
	std::shared_ptr<Any> result;
  	...
  	switch(operationID)
	{
		// uml::CreateLinkAction::association_not_abstract(std::shared_ptr<Any>, std::map) : bool: 3891195927
