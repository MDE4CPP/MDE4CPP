...
void ExpressionsPackageImpl::createAssociationClassCallExpContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_associationClassCallExp_Attribute_referredAssociationClass = factory->createEReference_in_EContainingClass(m_associationClassCallExp_Class, ASSOCIATIONCLASSCALLEXP_ATTRIBUTE_REFERREDASSOCIATIONCLASS);
...
void ExpressionsPackageImpl::createCallExpContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_callExp_Attribute_source = factory->createEReference_in_EContainingClass(m_callExp_Class, CALLEXP_ATTRIBUTE_SOURCE);
...
void ExpressionsPackageImpl::createCollectionItemContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_collectionItem_Attribute_item = factory->createEReference_in_EContainingClass(m_collectionItem_Class, COLLECTIONITEM_ATTRIBUTE_ITEM);
...
void ExpressionsPackageImpl::createCollectionLiteralExpContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_collectionLiteralExp_Attribute_part = factory->createEReference_in_EContainingClass(m_collectionLiteralExp_Class, COLLECTIONLITERALEXP_ATTRIBUTE_PART);
...
void ExpressionsPackageImpl::createCollectionRangeContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_collectionRange_Attribute_first = factory->createEReference_in_EContainingClass(m_collectionRange_Class, COLLECTIONRANGE_ATTRIBUTE_FIRST);
	m_collectionRange_Attribute_last = factory->createEReference_in_EContainingClass(m_collectionRange_Class, COLLECTIONRANGE_ATTRIBUTE_LAST);
...
void ExpressionsPackageImpl::createEnumLiteralExpContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_enumLiteralExp_Attribute_referredEnumLiteral = factory->createEReference_in_EContainingClass(m_enumLiteralExp_Class, ENUMLITERALEXP_ATTRIBUTE_REFERREDENUMLITERAL);
...
void ExpressionsPackageImpl::createExpressionInOclContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_expressionInOcl_Attribute_bodyExpression = factory->createEReference_in_EContainingClass(m_expressionInOcl_Class, EXPRESSIONINOCL_ATTRIBUTE_BODYEXPRESSION);
	m_expressionInOcl_Attribute_contextVariable = factory->createEReference_in_EContainingClass(m_expressionInOcl_Class, EXPRESSIONINOCL_ATTRIBUTE_CONTEXTVARIABLE);
	m_expressionInOcl_Attribute_parameterVariable = factory->createEReference_in_EContainingClass(m_expressionInOcl_Class, EXPRESSIONINOCL_ATTRIBUTE_PARAMETERVARIABLE);
	m_expressionInOcl_Attribute_resultVariable = factory->createEReference_in_EContainingClass(m_expressionInOcl_Class, EXPRESSIONINOCL_ATTRIBUTE_RESULTVARIABLE);
...
void ExpressionsPackageImpl::createIfExpContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_ifExp_Attribute_condition = factory->createEReference_in_EContainingClass(m_ifExp_Class, IFEXP_ATTRIBUTE_CONDITION);
	m_ifExp_Attribute_elseExpression = factory->createEReference_in_EContainingClass(m_ifExp_Class, IFEXP_ATTRIBUTE_ELSEEXPRESSION);
	m_ifExp_Attribute_thenExpression = factory->createEReference_in_EContainingClass(m_ifExp_Class, IFEXP_ATTRIBUTE_THENEXPRESSION);
...
void ExpressionsPackageImpl::createInfixedExpContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_infixedExp_Attribute_source = factory->createEReference_in_EContainingClass(m_infixedExp_Class, INFIXEDEXP_ATTRIBUTE_SOURCE);
...
void ExpressionsPackageImpl::createIterateExpContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_iterateExp_Attribute_result = factory->createEReference_in_EContainingClass(m_iterateExp_Class, ITERATEEXP_ATTRIBUTE_RESULT);
...
void ExpressionsPackageImpl::createLetExpContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_letExp_Attribute_in = factory->createEReference_in_EContainingClass(m_letExp_Class, LETEXP_ATTRIBUTE_IN);
	m_letExp_Attribute_variable = factory->createEReference_in_EContainingClass(m_letExp_Class, LETEXP_ATTRIBUTE_VARIABLE);
...
void ExpressionsPackageImpl::createLoopExpContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_loopExp_Attribute_body = factory->createEReference_in_EContainingClass(m_loopExp_Class, LOOPEXP_ATTRIBUTE_BODY);
	m_loopExp_Attribute_iterator = factory->createEReference_in_EContainingClass(m_loopExp_Class, LOOPEXP_ATTRIBUTE_ITERATOR);
...
void ExpressionsPackageImpl::createMessageExpContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_messageExp_Attribute_argument = factory->createEReference_in_EContainingClass(m_messageExp_Class, MESSAGEEXP_ATTRIBUTE_ARGUMENT);
	m_messageExp_Attribute_calledOperation = factory->createEReference_in_EContainingClass(m_messageExp_Class, MESSAGEEXP_ATTRIBUTE_CALLEDOPERATION);
	m_messageExp_Attribute_sentSignal = factory->createEReference_in_EContainingClass(m_messageExp_Class, MESSAGEEXP_ATTRIBUTE_SENTSIGNAL);
	m_messageExp_Attribute_target = factory->createEReference_in_EContainingClass(m_messageExp_Class, MESSAGEEXP_ATTRIBUTE_TARGET);
...
void ExpressionsPackageImpl::createNavigationCallExpContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_navigationCallExp_Attribute_navigationSource = factory->createEReference_in_EContainingClass(m_navigationCallExp_Class, NAVIGATIONCALLEXP_ATTRIBUTE_NAVIGATIONSOURCE);
	m_navigationCallExp_Attribute_qualifier = factory->createEReference_in_EContainingClass(m_navigationCallExp_Class, NAVIGATIONCALLEXP_ATTRIBUTE_QUALIFIER);
...
void ExpressionsPackageImpl::createOclExpressionContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_oclExpression_Attribute_appliedElement = factory->createEReference_in_EContainingClass(m_oclExpression_Class, OCLEXPRESSION_ATTRIBUTE_APPLIEDELEMENT);
	m_oclExpression_Attribute_elseOwner = factory->createEReference_in_EContainingClass(m_oclExpression_Class, OCLEXPRESSION_ATTRIBUTE_ELSEOWNER);
	m_oclExpression_Attribute_firstOwner = factory->createEReference_in_EContainingClass(m_oclExpression_Class, OCLEXPRESSION_ATTRIBUTE_FIRSTOWNER);
	m_oclExpression_Attribute_ifOwner = factory->createEReference_in_EContainingClass(m_oclExpression_Class, OCLEXPRESSION_ATTRIBUTE_IFOWNER);
	m_oclExpression_Attribute_initializedElement = factory->createEReference_in_EContainingClass(m_oclExpression_Class, OCLEXPRESSION_ATTRIBUTE_INITIALIZEDELEMENT);
	m_oclExpression_Attribute_instance = factory->createEReference_in_EContainingClass(m_oclExpression_Class, OCLEXPRESSION_ATTRIBUTE_INSTANCE);
	m_oclExpression_Attribute_lastOwner = factory->createEReference_in_EContainingClass(m_oclExpression_Class, OCLEXPRESSION_ATTRIBUTE_LASTOWNER);
	m_oclExpression_Attribute_loopBodyOwner = factory->createEReference_in_EContainingClass(m_oclExpression_Class, OCLEXPRESSION_ATTRIBUTE_LOOPBODYOWNER);
	m_oclExpression_Attribute_parentCall = factory->createEReference_in_EContainingClass(m_oclExpression_Class, OCLEXPRESSION_ATTRIBUTE_PARENTCALL);
	m_oclExpression_Attribute_parentNav = factory->createEReference_in_EContainingClass(m_oclExpression_Class, OCLEXPRESSION_ATTRIBUTE_PARENTNAV);
	m_oclExpression_Attribute_thenOwner = factory->createEReference_in_EContainingClass(m_oclExpression_Class, OCLEXPRESSION_ATTRIBUTE_THENOWNER);
	m_oclExpression_Attribute_topExpression = factory->createEReference_in_EContainingClass(m_oclExpression_Class, OCLEXPRESSION_ATTRIBUTE_TOPEXPRESSION);
...
void ExpressionsPackageImpl::createOperationCallExpContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_operationCallExp_Attribute_argument = factory->createEReference_in_EContainingClass(m_operationCallExp_Class, OPERATIONCALLEXP_ATTRIBUTE_ARGUMENT);
	m_operationCallExp_Attribute_referredOperation = factory->createEReference_in_EContainingClass(m_operationCallExp_Class, OPERATIONCALLEXP_ATTRIBUTE_REFERREDOPERATION);
...
void ExpressionsPackageImpl::createPropertyCallExpContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_propertyCallExp_Attribute_referredProperty = factory->createEReference_in_EContainingClass(m_propertyCallExp_Class, PROPERTYCALLEXP_ATTRIBUTE_REFERREDPROPERTY);
...
void ExpressionsPackageImpl::createStateExpContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_stateExp_Attribute_referredState = factory->createEReference_in_EContainingClass(m_stateExp_Class, STATEEXP_ATTRIBUTE_REFERREDSTATE);
...
void ExpressionsPackageImpl::createTupleLiteralExpContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_tupleLiteralExp_Attribute_part = factory->createEReference_in_EContainingClass(m_tupleLiteralExp_Class, TUPLELITERALEXP_ATTRIBUTE_PART);
...
void ExpressionsPackageImpl::createTupleLiteralPartContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_tupleLiteralPart_Attribute_attribute = factory->createEReference_in_EContainingClass(m_tupleLiteralPart_Class, TUPLELITERALPART_ATTRIBUTE_ATTRIBUTE);
...
void ExpressionsPackageImpl::createTypeExpContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_typeExp_Attribute_referredType = factory->createEReference_in_EContainingClass(m_typeExp_Class, TYPEEXP_ATTRIBUTE_REFERREDTYPE);
...
void ExpressionsPackageImpl::createVariableContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_variable_Attribute_baseExp = factory->createEReference_in_EContainingClass(m_variable_Class, VARIABLE_ATTRIBUTE_BASEEXP);
	m_variable_Attribute_initExpression = factory->createEReference_in_EContainingClass(m_variable_Class, VARIABLE_ATTRIBUTE_INITEXPRESSION);
	m_variable_Attribute_loopExp = factory->createEReference_in_EContainingClass(m_variable_Class, VARIABLE_ATTRIBUTE_LOOPEXP);
	m_variable_Attribute_referringExp = factory->createEReference_in_EContainingClass(m_variable_Class, VARIABLE_ATTRIBUTE_REFERRINGEXP);
	m_variable_Attribute_representedParameter = factory->createEReference_in_EContainingClass(m_variable_Class, VARIABLE_ATTRIBUTE_REPRESENTEDPARAMETER);
	m_variable_Attribute_resultOwner = factory->createEReference_in_EContainingClass(m_variable_Class, VARIABLE_ATTRIBUTE_RESULTOWNER);
	m_variable_Attribute_selfOwner = factory->createEReference_in_EContainingClass(m_variable_Class, VARIABLE_ATTRIBUTE_SELFOWNER);
	m_variable_Attribute_value = factory->createEReference_in_EContainingClass(m_variable_Class, VARIABLE_ATTRIBUTE_VALUE);
	m_variable_Attribute_varOwner = factory->createEReference_in_EContainingClass(m_variable_Class, VARIABLE_ATTRIBUTE_VAROWNER);
...
void ExpressionsPackageImpl::createVariableExpContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_variableExp_Attribute_referredVariable = factory->createEReference_in_EContainingClass(m_variableExp_Class, VARIABLEEXP_ATTRIBUTE_REFERREDVARIABLE);
