...
namespace uml 
{
	...
	class InstanceSpecification:virtual public DeployedArtifact,virtual public DeploymentTarget,virtual public PackageableElement	{
		...
		public:
			...
			virtual bool
			 deployment_artifact(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 defining_feature(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
