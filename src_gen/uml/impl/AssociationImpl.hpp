...
namespace uml 
{
	class AssociationImpl :virtual public ClassifierImpl, virtual public RelationshipImpl, virtual public Association 
	{
		...
		public:
			...
			virtual bool
			 specialized_end_number(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
			...
			virtual bool
			 specialized_end_types(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
			...
			virtual bool
			 binary_associations(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
			
			/*!
			 Ends of Associations with more than two ends must be owned by the Association itself.
			memberEnd->size() > 2 implies ownedEnd->includesAll(memberEnd) */ 
			virtual bool
			 association_ends(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
			
			/*!
			 memberEnd->forAll(type->notEmpty()) */ 
			virtual bool
			 ends_must_be_typed(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
