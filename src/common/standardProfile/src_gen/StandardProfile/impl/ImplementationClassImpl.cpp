...
ImplementationClassImpl::ImplementationClassImpl()
{
	...
	*/
	...
	//getter init
		//Property base_Class
		m_getterMap.insert(std::pair<long long,std::function<Any()>>(1590218076,[this](){ return eAny(this->getBase_Class(), uml::umlPackage::CLASS_CLASS, false);}));
	
	
	//setter init
	//Property base_Class
		m_setterMap.insert(std::pair<long long,std::function<void(Any)>>(1590218076,[this](Any object){this->setBase_Class(object->get<std::shared_ptr<uml::Class>>());}));
	
	
	//unsetter init
		//Property base_Class
		m_unsetterMap.insert(std::pair<long long,std::function<void()>>(1590218076,[this](){m_base_Class = std::shared_ptr<uml::Class>(nullptr);}));
...
Any ImplementationClassImpl::get(long long _uID) const
{
...
void ImplementationClassImpl::set(long long _uID, Any value)
{
...
void ImplementationClassImpl::unset(long long _uID)
{
...
Any ImplementationClassImpl::invoke(long long _uID, std::shared_ptr<Bag<Any>> _arguments)
{
