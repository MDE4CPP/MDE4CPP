...
DurationIntervalImpl::DurationIntervalImpl(const DurationIntervalImpl & obj)
{
...
ecore::EClass* DurationIntervalImpl::eStaticClass() const
{
...
// Union Getter
//*********************************
uml::Element *  DurationIntervalImpl::getOwner() const
{
...
std::vector<uml::Element * > *  DurationIntervalImpl::getOwnedElement() const
{
