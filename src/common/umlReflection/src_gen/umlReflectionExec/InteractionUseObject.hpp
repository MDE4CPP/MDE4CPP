...
#ifndef UML_INTERACTIONUSE_EXECUTION_HPP
#define UML_INTERACTIONUSE_EXECUTION_HPP
...
namespace UML 
{
	class InteractionUseObject : virtual public UML::InteractionFragmentObject
	{
		public:
		    //constructors
		    InteractionUseObject(InteractionUseObject &obj);
		    InteractionUseObject(std::shared_ptr<uml::InteractionUse>);
		 	InteractionUseObject();
		    //destructor
		    virtual ~InteractionUseObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			InteractionUseObject& operator=(InteractionUseObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::InteractionUse> getInteractionUseValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setInteractionUseValue(std::shared_ptr<uml::InteractionUse>);
			virtual void setThisInteractionUseObjectPtr(std::weak_ptr<InteractionUseObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::InteractionUse> m_InteractionUseValue = nullptr;
	};
}
#endif /* end of include guard: UML_INTERACTIONUSE_OBJECT_HPP */
