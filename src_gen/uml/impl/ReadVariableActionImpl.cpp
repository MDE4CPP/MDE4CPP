...
// Union Getter
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::ActivityGroup>>> ReadVariableActionImpl::getInGroup() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> ReadVariableActionImpl::getRedefinedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> ReadVariableActionImpl::getOwnedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::OutputPin>>> ReadVariableActionImpl::getOutput() const
{
