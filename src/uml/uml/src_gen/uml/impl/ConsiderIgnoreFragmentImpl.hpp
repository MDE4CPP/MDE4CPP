	...
	class UML_API ConsiderIgnoreFragmentImpl : virtual public CombinedFragmentImpl, virtual public ConsiderIgnoreFragment 
	{
		...
		public:
			...
			*/
			...
			virtual bool consider_or_ignore(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			/*!
			...
			*/
			...
			virtual bool type(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			...
			*/
			...
			virtual const std::shared_ptr<Bag<uml::NamedElement>>& getMessage() const ;
