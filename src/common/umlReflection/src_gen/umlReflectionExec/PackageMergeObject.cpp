...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> PackageMergeObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	...
	{
		std::shared_ptr<Bag<uml::Element>> sourceList = m_PackageMergeValue->getSource();
	...
	{
		std::shared_ptr<Bag<uml::Element>> targetList = m_PackageMergeValue->getTarget();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Bag<uml::Comment>> ownedCommentList = m_PackageMergeValue->getOwnedComment();
	...
	{
		std::shared_ptr<Bag<uml::Element>> ownedElementList = m_PackageMergeValue->getOwnedElement();
	...
	{
		std::shared_ptr<Bag<uml::Element>> relatedElementList = m_PackageMergeValue->getRelatedElement();
