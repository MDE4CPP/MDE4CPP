...
namespace uml 
{
	...
	class Stereotype:virtual public Class	{
		...
		public:
			...
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Class>>> getAllExtendedMetaclasses()  = 0;
			...
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Class>>> getExtendedMetaclasses()  = 0;
			...
			<p>From package UML::Packages.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Image>>> getIcon() const = 0;
		...
		protected:
			...
			/*!
			 Stereotype can change the graphical appearance of the extended model element by using attached icons. When this association is not null, it references the location of the icon content to be displayed within diagrams presenting the extended model elements.
			<p>From package UML::Packages.</p> */
			std::shared_ptr<std::vector<std::shared_ptr<uml::Image>>> m_icon;
			/*!
			 The profile that directly or indirectly contains this stereotype.
			<p>From package UML::Packages.</p> */
