...
bool EvalEnvironmentImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case ocl::Evaluations::EvaluationsPackage::EVALENVIRONMENT_ATTRIBUTE_BINDINGS:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> EvalEnvironmentImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
