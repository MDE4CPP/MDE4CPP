...
#ifndef STANDARDPROFILE_METACLASSMETACLASSIMPL_HPP
#define STANDARDPROFILE_METACLASSMETACLASSIMPL_HPP
...
{
	class MetaclassImpl :virtual public ecore::EObjectImpl,
virtual public Metaclass 
	{
		...
		protected:
			...
			MetaclassImpl();
			virtual std::shared_ptr<Metaclass> getThisMetaclassPtr() const;
...
#endif /* end of include guard: STANDARDPROFILE_METACLASSMETACLASSIMPL_HPP */
