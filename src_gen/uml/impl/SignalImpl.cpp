...
ecore::EClass* SignalImpl::eStaticClass() const
{
...
// Operations
//*********************************
uml::Property *  SignalImpl::createOwnedAttribute(std::string name,uml::Type *  type,int lower,int upper) 
{
...
// References
//*********************************
std::vector<uml::Property * > *  SignalImpl::getOwnedAttribute() const
{
...
// Union Getter
//*********************************
std::vector<uml::Element * > *  SignalImpl::getOwnedElement() const
{
...
uml::Namespace *  SignalImpl::getNamespace() const
{
...
std::vector<uml::Feature * > *  SignalImpl::getFeature() const
{
...
uml::Element *  SignalImpl::getOwner() const
{
...
std::vector<uml::NamedElement * > *  SignalImpl::getMember() const
{
...
std::vector<uml::RedefinableElement * > *  SignalImpl::getRedefinedElement() const
{
...
std::vector<uml::Property * > *  SignalImpl::getAttribute() const
{
...
std::vector<uml::NamedElement * > *  SignalImpl::getOwnedMember() const
{
