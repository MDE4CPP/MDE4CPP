...
namespace uml 
{
	class InformationItemImpl :virtual public ClassifierImpl, virtual public InformationItem 
	{
		...
		public:
			...
			virtual bool
			 sources_and_targets(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
			
			/*!
			 An informationItem has no feature, no generalization, and no associations.
			self.generalization->isEmpty() and self.feature->isEmpty() */ 
			virtual bool
			 has_no(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
			
			/*!
			 It is not instantiable.
			isAbstract */ 
			virtual bool
			 not_instantiable(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
