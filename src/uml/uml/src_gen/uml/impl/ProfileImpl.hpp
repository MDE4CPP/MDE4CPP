	...
	class UML_API ProfileImpl : virtual public PackageImpl, virtual public Profile 
	{
		...
		public:
			...
			*/
			...
			virtual const std::shared_ptr<Subset<uml::ElementImport, uml::ElementImport>>& getMetaclassReference() const ;
			/*!
			References a package containing (directly or indirectly) metaclasses that may be extended.
			<p>From package UML::Packages.</p>
			*/
			
			virtual const std::shared_ptr<Subset<uml::PackageImport, uml::PackageImport>>& getMetamodelReference() const ;
