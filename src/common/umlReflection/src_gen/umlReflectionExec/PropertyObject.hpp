...
#ifndef UML_PROPERTY_EXECUTION_HPP
#define UML_PROPERTY_EXECUTION_HPP
...
namespace UML 
{
	class PropertyObject : virtual public UML::ConnectableElementObject , virtual public UML::DeploymentTargetObject , virtual public UML::StructuralFeatureObject
	{
		public:
		    //constructors
		    PropertyObject(PropertyObject &obj);
		    PropertyObject(std::shared_ptr<uml::Property>);
		 	PropertyObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::Property> getPropertyValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setPropertyValue(std::shared_ptr<uml::Property>);
			virtual void setThisPropertyObjectPtr(std::weak_ptr<PropertyObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Property> m_PropertyValue = nullptr;
	};
}
#endif /* end of include guard: UML_PROPERTY_OBJECT_HPP */
