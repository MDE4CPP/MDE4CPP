...
{	
	if(m_ConnectionPointReferenceValue)
	{

	}

	m_ConnectionPointReferenceValue.reset();

	fUML::Semantics::StructuredClassifiers::ObjectImpl::destroy();
}

std::shared_ptr<uml::Element> ConnectionPointReferenceObject::getUmlValue() const
{
	return getConnectionPointReferenceValue();
}

std::shared_ptr<uml::ConnectionPointReference> ConnectionPointReferenceObject::getConnectionPointReferenceValue() const
{
	return m_ConnectionPointReferenceValue;
}

void ConnectionPointReferenceObject::setUmlValue(std::shared_ptr<uml::Element> _element)
{
	setConnectionPointReferenceValue(std::dynamic_pointer_cast<uml::ConnectionPointReference>(_element));
}

void ConnectionPointReferenceObject::setConnectionPointReferenceValue(std::shared_ptr<uml::ConnectionPointReference> _ConnectionPointReferenceElement)
{
	m_ConnectionPointReferenceValue = _ConnectionPointReferenceElement;
	//set super type values
	UML::VertexObject::setVertexValue(_ConnectionPointReferenceElement);
}

void ConnectionPointReferenceObject::setThisConnectionPointReferenceObjectPtr(std::weak_ptr<ConnectionPointReferenceObject> thisObjectPtr)
{
	setThisCS_ObjectPtr(thisObjectPtr);
}

bool ConnectionPointReferenceObject::equals(std::shared_ptr<fUML::Semantics::Values::Value> otherValue)
{
	bool isEqual = false;
	
	std::shared_ptr<ConnectionPointReferenceObject> otherConnectionPointReferenceObject = std::dynamic_pointer_cast<ConnectionPointReferenceObject>(otherValue);

	if(otherConnectionPointReferenceObject != nullptr)
	{
		if(this->getConnectionPointReferenceValue() == otherConnectionPointReferenceObject->getConnectionPointReferenceValue())
		{
			isEqual = true;
		}
	}
...
std::string ConnectionPointReferenceObject::toString()
{
	std::string buffer = "Instance of 'ConnectionPointReferenceObject', " + std::to_string(getTypes()->size()) + " types (";
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Object>> ConnectionPointReferenceObject::getDirectContainers()
{   
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Link>> ConnectionPointReferenceObject::getLinks(std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_InteractionPoint> interactionPoint)
{
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> ConnectionPointReferenceObject::retrieveEndValueAsInteractionPoint(std::shared_ptr<fUML::Semantics::Values::Value> endValue, std::shared_ptr<uml::ConnectorEnd> end)
{
	return nullptr;
}

void ConnectionPointReferenceObject::removeValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<fUML::Semantics::Values::Value> value)
{
	...
	if (m_ConnectionPointReferenceValue == nullptr)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": no value stored inside ConnectionPointReferenceObject (property: " << feature->getName() << ")" << std::endl;
		throw "NullPointerException";	
	}

	if (feature == UML::UMLPackage::eInstance()->get_UML_ConnectionPointReference_entry())
	{
		if (value == nullptr) // clear mode
		{
			m_ConnectionPointReferenceValue->getEntry()->clear();
		}
		else
		{
			...
			{
				m_ConnectionPointReferenceValue->getEntry()->erase(inputValue->getPseudostateValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ConnectionPointReference_exit())
	{
		if (value == nullptr) // clear mode
		{
			m_ConnectionPointReferenceValue->getExit()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ConnectionPointReferenceValue->getExit()->erase(inputValue->getPseudostateValue());
			}
		}
	}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		if (value == nullptr) // clear mode
		{
			m_ConnectionPointReferenceValue->getOwnedComment()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ConnectionPointReferenceValue->getOwnedComment()->erase(inputValue->getCommentValue());
			}
		}
	}
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> ConnectionPointReferenceObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	if (feature->getMetaElementID() != uml::UmlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::UmlPackage::PORT_CLASS && feature->getMetaElementID() != uml::UmlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ConnectionPointReference_entry())
	{
		std::shared_ptr<Bag<uml::Pseudostate>> entryList = m_ConnectionPointReferenceValue->getEntry();
		Bag<uml::Pseudostate>::iterator iter = entryList->begin();
		Bag<uml::Pseudostate>::iterator end = entryList->end();
		while (iter != end)
		{
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ConnectionPointReference_exit())
	{
		std::shared_ptr<Bag<uml::Pseudostate>> exitList = m_ConnectionPointReferenceValue->getExit();
		Bag<uml::Pseudostate>::iterator iter = exitList->begin();
		Bag<uml::Pseudostate>::iterator end = exitList->end();
		while (iter != end)
		{
			std::shared_ptr<UML::PseudostateObject> value(new UML::PseudostateObject());
			value->setThisPseudostateObjectPtr(value);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ConnectionPointReference_state())
	{
		...
		value->setLocus(this->getLocus());
		value->setStateValue(m_ConnectionPointReferenceValue->getState().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Bag<uml::Comment>> ownedCommentList = m_ConnectionPointReferenceValue->getOwnedComment();
	...
	{
		std::shared_ptr<Bag<uml::Element>> ownedElementList = m_ConnectionPointReferenceValue->getOwnedElement();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_owner())
	{
		...
		value->setThisElementObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setElementValue(m_ConnectionPointReferenceValue->getOwner().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<Bag<uml::Dependency>> clientDependencyList = m_ConnectionPointReferenceValue->getClientDependency();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		value->setValue(m_ConnectionPointReferenceValue->getName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		value->setLocus(this->getLocus());
		value->setStringExpressionValue(m_ConnectionPointReferenceValue->getNameExpression());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace())
	{
		...
		value->setLocus(this->getLocus());
		value->setNamespaceValue(m_ConnectionPointReferenceValue->getNamespace().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::StringValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createStringValue();
		value->setValue(m_ConnectionPointReferenceValue->getQualifiedName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		uml::VisibilityKind visibility = m_ConnectionPointReferenceValue->getVisibility();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Vertex_container())
	{
		...
		value->setLocus(this->getLocus());
		value->setRegionValue(m_ConnectionPointReferenceValue->getContainer().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<Bag<uml::Transition>> incomingList = m_ConnectionPointReferenceValue->getIncoming();
	...
	{
		std::shared_ptr<Bag<uml::Transition>> outgoingList = m_ConnectionPointReferenceValue->getOutgoing();
...
std::shared_ptr<fUML::Semantics::SimpleClassifiers::FeatureValue> ConnectionPointReferenceObject::retrieveFeatureValue(std::shared_ptr<uml::StructuralFeature> feature)
{
...
void ConnectionPointReferenceObject::setFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	if (feature->getMetaElementID() != uml::UmlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::UmlPackage::PORT_CLASS && feature->getMetaElementID() != uml::UmlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ConnectionPointReference_entry())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ConnectionPointReferenceValue->getEntry()->push_back(value->getPseudostateValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ConnectionPointReference_exit())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ConnectionPointReferenceValue->getExit()->push_back(value->getPseudostateValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ConnectionPointReferenceValue->getOwnedComment()->push_back(value->getCommentValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		{
			m_ConnectionPointReferenceValue->setName(valueObject->getValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		if (value != nullptr)
		{
			m_ConnectionPointReferenceValue->setNameExpression(value->getStringExpressionValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		...
		{
			m_ConnectionPointReferenceValue->setVisibility(uml::VisibilityKind::PUBLIC);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_private())
		{
			m_ConnectionPointReferenceValue->setVisibility(uml::VisibilityKind::PRIVATE);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_protected())
		{
			m_ConnectionPointReferenceValue->setVisibility(uml::VisibilityKind::PROTECTED);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_package())
		{
			m_ConnectionPointReferenceValue->setVisibility(uml::VisibilityKind::PACKAGE);
		}
		
	}
}

void ConnectionPointReferenceObject::assignFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	this->setFeatureValue(feature, values, position);
}

std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> ConnectionPointReferenceObject::retrieveFeatureValues()
{
	...
	for(unsigned int i = 0; i < allAttributesSize; i++)
	{
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_ConnectionPointReference_entry() && m_ConnectionPointReferenceValue->getEntry() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ConnectionPointReference_exit() && m_ConnectionPointReferenceValue->getExit() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ConnectionPointReference_state() && m_ConnectionPointReferenceValue->getState().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment() && m_ConnectionPointReferenceValue->getOwnedComment() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedElement() && m_ConnectionPointReferenceValue->getOwnedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_owner() && m_ConnectionPointReferenceValue->getOwner().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_clientDependency() && m_ConnectionPointReferenceValue->getClientDependency() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression() && m_ConnectionPointReferenceValue->getNameExpression() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace() && m_ConnectionPointReferenceValue->getNamespace().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Vertex_container() && m_ConnectionPointReferenceValue->getContainer().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Vertex_incoming() && m_ConnectionPointReferenceValue->getIncoming() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Vertex_outgoing() && m_ConnectionPointReferenceValue->getOutgoing() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
	}
