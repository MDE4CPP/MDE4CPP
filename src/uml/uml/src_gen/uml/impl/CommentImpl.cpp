...
bool CommentImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::COMMENT_ATTRIBUTE_ANNOTATEDELEMENT:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> CommentImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
