...
bool VarDeclarationExpImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::VARDECLARATIONEXP_ATTRIBUTE_ASSIGNEDOCLEXP:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> VarDeclarationExpImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
