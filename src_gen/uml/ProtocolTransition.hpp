...
namespace uml 
{
	...
	class ProtocolTransition:virtual public Transition	{
		...
		public:
			...
			<p>From package UML::StateMachines.</p> */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Operation>>> getReferreds()  = 0;
			...
			<p>From package UML::StateMachines.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Operation>>> getReferred() const = 0;
		...
		protected:
			...
			/*!
			 This association refers to the associated Operation. It is derived from the Operation of the CallEvent Trigger when applicable.
			<p>From package UML::StateMachines.</p> */
			std::shared_ptr<std::vector<std::shared_ptr<uml::Operation>>> m_referred;
