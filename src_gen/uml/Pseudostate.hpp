...
namespace uml 
{
	...
	class Pseudostate:virtual public Vertex	{
		...
		public:
			...
			virtual bool
			 transitions_outgoing(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 choice_vertex(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 outgoing_from_initial(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 join_vertex(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 junction_vertex(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			
			/*!
			 History Vertices can have at most one outgoing Transition.
			((kind = PseudostateKind::deepHistory) or (kind = PseudostateKind::shallowHistory)) implies (outgoing->size() <= 1) */ 
			virtual bool
			 history_vertices(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 fork_vertex(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 transitions_incoming(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
