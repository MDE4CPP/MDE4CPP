...
#ifndef UML_COMPONENTREALIZATION_EXECUTION_HPP
#define UML_COMPONENTREALIZATION_EXECUTION_HPP
...
namespace UML 
{
	class ComponentRealizationObject : virtual public UML::RealizationObject
	{
		public:
		    //constructors
		    ComponentRealizationObject(ComponentRealizationObject &obj);
		    ComponentRealizationObject(std::shared_ptr<uml::ComponentRealization>);
		 	ComponentRealizationObject();
		    //destructor
		    virtual ~ComponentRealizationObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			ComponentRealizationObject& operator=(ComponentRealizationObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::ComponentRealization> getComponentRealizationValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setComponentRealizationValue(std::shared_ptr<uml::ComponentRealization>);
			virtual void setThisComponentRealizationObjectPtr(std::weak_ptr<ComponentRealizationObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ComponentRealization> m_ComponentRealizationValue = nullptr;
	};
}
#endif /* end of include guard: UML_COMPONENTREALIZATION_OBJECT_HPP */
