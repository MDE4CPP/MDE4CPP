...
void oclparserParserInitialize() {
  ...
  auto staticData = std::make_unique<OclParserStaticData>(
    ...
    std::vector<std::string>{
      ...
      "STAR", "PLUS_ASSIGN", "PLUS", "KEYOR", "KEYAND", "IMPLIES", "RANGE", 
      "DOT", "AT", "SLASH", "UNDERSCORE", "DHAT", "HAT", "MINUS", "NOT", 
      "PIPE", "ID", "WS", "ERRCHAR"
    }
  );
  static const int32_t serializedATNSegment[] = {
  	4,1,80,759,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,
  	...
  	62,71,71,2,0,64,64,75,75,1,0,24,28,2,0,40,40,62,62,1,0,29,33,1,0,35,38,
  	1,0,75,76,2,0,55,60,65,67,1,0,22,23,2,0,7,7,20,21,821,0,118,1,0,0,0,2,
  	...
  	166,3,8,4,0,165,163,1,0,0,0,165,164,1,0,0,0,166,7,1,0,0,0,167,168,5,78,
  	...
  	221,1,0,0,0,224,225,3,2,1,0,225,226,5,68,0,0,226,227,3,2,1,0,227,231,
  	...
  	277,278,1,0,0,0,278,279,5,77,0,0,279,281,1,0,0,0,280,273,1,0,0,0,280,
  	281,1,0,0,0,281,282,1,0,0,0,282,283,3,2,1,0,283,284,5,49,0,0,284,318,
  	1,0,0,0,285,286,5,69,0,0,286,287,3,8,4,0,287,296,5,48,0,0,288,293,3,2,
  	...
  	0,0,300,301,5,69,0,0,301,318,3,8,4,0,302,303,5,69,0,0,303,315,3,8,4,0,
  	...
  	328,329,5,77,0,0,329,330,3,2,1,0,330,331,5,49,0,0,331,49,1,0,0,0,332,
  	...
  	5,69,0,0,387,388,3,8,4,0,388,397,5,48,0,0,389,394,3,2,1,0,390,391,5,46,
  	...
  	0,0,0,398,399,1,0,0,0,399,400,5,49,0,0,400,453,1,0,0,0,401,402,5,69,0,
  	...
  	0,417,418,5,69,0,0,418,419,3,14,7,0,419,420,5,45,0,0,420,421,3,8,4,0,
  	...
  	432,433,5,49,0,0,433,453,1,0,0,0,434,435,5,69,0,0,435,436,3,14,7,0,436,
  	...
  	0,497,468,1,0,0,0,497,483,1,0,0,0,498,65,1,0,0,0,499,500,5,69,0,0,500,
  	502,3,8,4,0,501,503,3,74,37,0,502,501,1,0,0,0,502,503,1,0,0,0,503,512,
  	1,0,0,0,504,505,5,69,0,0,505,506,3,14,7,0,506,507,5,45,0,0,507,509,3,
  	...
  	5,69,0,0,518,530,3,8,4,0,519,520,5,50,0,0,520,525,3,2,1,0,521,522,5,46,
  	...
  	1,0,0,0,551,73,1,0,0,0,552,553,5,70,0,0,553,554,5,7,0,0,554,75,1,0,0,
  	...
  	0,0,0,567,568,5,73,0,0,568,569,3,8,4,0,569,571,5,48,0,0,570,572,3,80,
  	40,0,571,570,1,0,0,0,571,572,1,0,0,0,572,573,1,0,0,0,573,574,5,49,0,0,
  	574,584,1,0,0,0,575,576,5,74,0,0,576,577,3,8,4,0,577,579,5,48,0,0,578,
...
OclParser::CollectionLiteralExpCSContext* OclParser::collectionLiteralExpCS() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if ((((_la & ~ 0x3fULL) == 0) &&
      ((1ULL << _la) & 4611984535817567492) != 0) || ((((_la - 75) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 75)) & 11) != 0)) {
      setState(203);
...
OclParser::IteratorExpCSContext* OclParser::iteratorExpCS() {
  ...
  try {
    ...
    case 2: {
      ...
      _la = _input->LA(1);
      if ((((_la & ~ 0x3fULL) == 0) &&
        ((1ULL << _la) & 4611984518637698308) != 0) || ((((_la - 75) & ~ 0x3fULL) == 0) &&
        ((1ULL << (_la - 75)) & 11) != 0)) {
        setState(288);
        oclExpressionCS(0);
        setState(293);
  ...
  try {
    ...
    switch (_input->LA(1)) {
      case OclParser::DHAT: {
        ...
        _la = _input->LA(1);
        if ((((_la & ~ 0x3fULL) == 0) &&
          ((1ULL << _la) & 6917827527851392260) != 0) || ((((_la - 75) & ~ 0x3fULL) == 0) &&
          ((1ULL << (_la - 75)) & 11) != 0)) {
          setState(570);
