...
namespace uml 
{
	...
	class ReadIsClassifiedObjectAction:virtual public Action	{
		...
		public:
			...
			result.is(1,1) */ 
			virtual bool
			 multiplicity_of_output(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			
			/*!
			 The type of the result OutputPin is Boolean.
			result.type = Boolean */ 
			virtual bool
			 boolean_result(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			
			/*!
			 The multiplicity of the object InputPin is 1..1.
			object.is(1,1) */ 
			virtual bool
			 multiplicity_of_input(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
