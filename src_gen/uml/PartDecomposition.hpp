...
namespace uml 
{
	...
	class PartDecomposition:virtual public InteractionUse	{
		...
		public:
			...
			virtual bool
			 commutativity_of_decomposition(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 assume(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			
			/*!
			 PartDecompositions apply only to Parts that are Parts of Internal Structures not to Parts of Collaborations. */ 
			virtual bool
			 parts_of_internal_structures(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
