...
#ifndef UML_EXCEPTIONHANDLER_EXECUTION_HPP
#define UML_EXCEPTIONHANDLER_EXECUTION_HPP
...
namespace UML 
{
	class ExceptionHandlerObject : virtual public UML::ElementObject
	{
		public:
		    //constructors
		    ExceptionHandlerObject(ExceptionHandlerObject &obj);
		    ExceptionHandlerObject(std::shared_ptr<uml::ExceptionHandler>);
			...
			virtual std::shared_ptr<uml::ExceptionHandler> getExceptionHandlerValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setExceptionHandlerValue(std::shared_ptr<uml::ExceptionHandler>);
			virtual void setThisExceptionHandlerObjectPtr(std::weak_ptr<ExceptionHandlerObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ExceptionHandler> m_ExceptionHandlerValue = nullptr;
	};
}
#endif /* end of include guard: UML_EXCEPTIONHANDLER_OBJECT_HPP */
