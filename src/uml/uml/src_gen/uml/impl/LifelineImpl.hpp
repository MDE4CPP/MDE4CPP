	...
	class UML_API LifelineImpl : virtual public NamedElementImpl, virtual public Lifeline 
	{
		...
		public:
			...
			*/
			...
			virtual bool interaction_uses_share_lifeline(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			/*!
			...
			*/
			...
			virtual bool same_classifier(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			/*!
			...
			*/
			...
			virtual bool selector_int_or_string(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			/*!
			...
			*/
			...
			virtual bool selector_specified(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
