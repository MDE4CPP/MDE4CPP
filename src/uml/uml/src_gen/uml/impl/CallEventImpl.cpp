...
void CallEventImpl::saveContent(std::shared_ptr<persistence::interfaces::XSaveHandler> saveHandler) const
{
	...
	// Add references
	if ( this->eIsSet(package->getCallEvent_Attribute_operation()) )
	{
...
bool CallEventImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::CALLEVENT_ATTRIBUTE_OPERATION:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> CallEventImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
