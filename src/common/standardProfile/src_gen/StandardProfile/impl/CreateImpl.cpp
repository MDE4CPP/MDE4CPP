...
//*********************************
//Get
Any CreateImpl::get(const std::shared_ptr<uml::Property>& _property) const
{
...
//Set
void CreateImpl::set(const std::shared_ptr<uml::Property>& _property, const Any& value)
{
	std::string qualifiedName = _property->getQualifiedName();
    this->set(qualifiedName, value);
}

void CreateImpl::set(std::string _qualifiedName, const Any& value)
{
	unsigned long uID = util::Util::polynomialRollingHash(_qualifiedName);
    this->set(uID, value);
}

void CreateImpl::set(unsigned long _uID, const Any& value)
{
...
//Unset
void CreateImpl::unset(const std::shared_ptr<uml::Property>& _property)
{
	std::string qualifiedName = _property->getQualifiedName();
...
//*********************************
//Invoke
Any CreateImpl::invoke(const std::shared_ptr<uml::Operation>& _operation, const std::shared_ptr<Bag<Any>>& _arguments)
{
...
Any CreateImpl::invoke(std::string _qualifiedName, const std::shared_ptr<Bag<Any>>& _arguments)
{
	unsigned long uID = util::Util::polynomialRollingHash(_qualifiedName);
    return this->invoke(uID, _arguments);
}

Any CreateImpl::invoke(unsigned long _uID, const std::shared_ptr<Bag<Any>>& _arguments)
{
