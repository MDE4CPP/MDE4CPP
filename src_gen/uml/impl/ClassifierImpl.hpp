...
namespace uml 
{
	class ClassifierImpl :virtual public NamespaceImpl, virtual public RedefinableElementImpl, virtual public TemplateableElementImpl, virtual public TypeImpl, virtual public Classifier 
	{
		...
		public:
			...
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Property>>> getAllAttributes()  ;
			
			/*!
			 Retrieves all the operations of this classifier, including those inherited from its parents. */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Operation>>> getAllOperations()  ;
			
			/*!
			 Retrieves all the interfaces on which this classifier or any of its parents has a usage dependency. */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Interface>>> getAllUsedInterfaces()  ;
			
			/*!
			 Retrieves the first operation with the specified name, parameter names, and parameter types from this classifier. */ 
			virtual std::shared_ptr<uml::Operation>  getOperation(std::string name,std::shared_ptr<std::vector<std::shared_ptr<std::string>>>  parameterNames,std::shared_ptr<std::vector<std::shared_ptr<uml::Type>>>  parameterTypes)  ;
			...
			virtual std::shared_ptr<uml::Operation>  getOperation(std::string name,std::shared_ptr<std::vector<std::shared_ptr<std::string>>>  parameterNames,std::shared_ptr<std::vector<std::shared_ptr<uml::Type>>>  parameterTypes,bool ignoreCase)  ;
			
			/*!
			 Retrieves the operations of this classifier. */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Operation>>> getOperations()  ;
			
			/*!
			 Retrieves the interfaces on which this classifier has a usage dependency. */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Interface>>> getUsedInterfaces()  ;
			
			/*!
			 The query allFeatures() gives all of the Features in the namespace of the Classifier. In general, through mechanisms such as inheritance, this will be a larger set than feature.
			result = (member->select(oclIsKindOf(Feature))->collect(oclAsType(Feature))->asSet())
			<p>From package UML::Classification.</p> */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Feature>>> allFeatures()  ;
			
			/*!
			 The query allParents() gives all of the direct and indirect ancestors of a generalized Classifier.
			result = (parents()->union(parents()->collect(allParents())->asSet()))
			<p>From package UML::Classification.</p> */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Classifier>>> allParents()  ;
			
			/*!
			 The general Classifiers are the ones referenced by the Generalization relationships.
			result = (parents())
			<p>From package UML::Classification.</p> */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Classifier>>> getGenerals()  ;
			...
			result = (inhs->reject(inh |
			  ...
			  ownedMember->select(oclIsKindOf(RedefinableElement))->
			    select(redefinedElement->includes(inh.oclAsType(RedefinableElement)))
			       ->notEmpty()))
			<p>From package UML::Classification.</p> */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> inherit(std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>>  inhs)  ;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> inheritableMembers(std::shared_ptr<uml::Classifier>  c)  ;
			
			/*!
			 The inheritedMember association is derived by inheriting the inheritable members of the parents.
			result = (inherit(parents()->collect(inheritableMembers(self))->asSet()))
			<p>From package UML::Classification.</p> */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> getInheritedMembers()  ;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Classifier>>> parents()  ;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Interface>>> directlyRealizedInterfaces()  ;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Interface>>> directlyUsedInterfaces()  ;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Interface>>> allRealizedInterfaces()  ;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Interface>>> allUsedInterfaces()  ;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Property>>> allAttributes()  ;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::StructuralFeature>>> allSlottableFeatures()  ;
			...
			<p>From package UML::Classification.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::CollaborationUse>>> getCollaborationUse() const ;
			
			/*!
			 The generalizing Classifiers for this Classifier.
			<p>From package UML::Classification.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Classifier>>> getGeneral() const ;
			...
			<p>From package UML::Classification.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::GeneralizationSet>>> getPowertypeExtent() const ;
			
			/*!
			 All elements inherited by this Classifier from its general Classifiers.
			<p>From package UML::Classification.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> getInheritedMember() const ;
			
			/*!
			 The UseCases owned by this classifier.
			<p>From package UML::Classification.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::UseCase>>> getOwnedUseCase() const ;
			
			/*!
			 The set of UseCases for which this Classifier is the subject.
			<p>From package UML::Classification.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::UseCase>>> getUseCase() const ;
			
			/*!
			 The Classifiers redefined by this Classifier.
			<p>From package UML::Classification.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Classifier>>> getRedefinedClassifier() const ;
			...
			<p>From package UML::Classification.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Substitution>>> getSubstitution() const ;
