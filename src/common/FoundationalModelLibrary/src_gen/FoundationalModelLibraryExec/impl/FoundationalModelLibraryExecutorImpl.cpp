...
std::shared_ptr<Any> FoundationalModelLibraryExecutorImpl::evaluate(std::shared_ptr<uml::ValueSpecification> specification)
{
...
std::shared_ptr<Bag<fUML::Semantics::CommonBehavior::ParameterValue>> FoundationalModelLibraryExecutorImpl::execute(std::shared_ptr<uml::Behavior> behavior, std::shared_ptr<uml::Element> context, std::shared_ptr<Bag<fUML::Semantics::CommonBehavior::ParameterValue>> inputs)
{
...
std::shared_ptr<Bag<fUML::Semantics::CommonBehavior::ParameterValue>> FoundationalModelLibraryExecutorImpl::invokeOpaqueBehavior(std::shared_ptr<uml::OpaqueBehavior> opaqueBehavior, std::shared_ptr<uml::Element> context, std::shared_ptr<Bag<fUML::Semantics::CommonBehavior::ParameterValue>> inputs)
{
