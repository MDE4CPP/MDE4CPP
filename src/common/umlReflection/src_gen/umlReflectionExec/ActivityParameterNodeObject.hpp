...
#ifndef UML_ACTIVITYPARAMETERNODE_EXECUTION_HPP
#define UML_ACTIVITYPARAMETERNODE_EXECUTION_HPP
...
namespace UML 
{
	class ActivityParameterNodeObject : virtual public UML::ObjectNodeObject
	{
		public:
		    //constructors
		    ActivityParameterNodeObject(ActivityParameterNodeObject &obj);
		    ActivityParameterNodeObject(std::shared_ptr<uml::ActivityParameterNode>);
		 	ActivityParameterNodeObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::ActivityParameterNode> getActivityParameterNodeValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setActivityParameterNodeValue(std::shared_ptr<uml::ActivityParameterNode>);
			virtual void setThisActivityParameterNodeObjectPtr(std::weak_ptr<ActivityParameterNodeObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ActivityParameterNode> m_ActivityParameterNodeValue = nullptr;
	};
}
#endif /* end of include guard: UML_ACTIVITYPARAMETERNODE_OBJECT_HPP */
