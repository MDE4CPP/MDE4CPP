...
namespace fUML::Semantics::Actions 
{
	class CreateObjectActionActivationImpl : virtual public ActionActivationImpl, virtual public CreateObjectActionActivation 
	{
		...
		public:
			...
			virtual std::shared_ptr<org.eclipse.uml2.uml.CreateObjectAction > getCreateObjectAction() const ;
			
			
			virtual void setCreateObjectAction(std::shared_ptr<org.eclipse.uml2.uml.CreateObjectAction> _createObjectAction) ;
