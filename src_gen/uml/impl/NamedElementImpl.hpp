...
namespace uml 
{
	class NamedElementImpl :virtual public ElementImpl, virtual public NamedElement
	{
		...
		public:
			...
			virtual uml::Dependency *  createDependency(uml::NamedElement *  supplier)  ;
			
			/*!
			 Creates a usage between this named element and the specified supplier, owned by this named element's nearest package. */ 
			virtual uml::Usage *  createUsage(uml::NamedElement *  supplier)  ;
			...
			virtual std::vector<uml::Namespace * > *  allNamespaces()  ;
			...
			<p>From package UML::CommonStructure.</p> */ 
			virtual std::vector<uml::Package * > *  allOwningPackages()  ;
			...
			<p>From package UML::CommonStructure.</p> */ 
			virtual bool isDistinguishableFrom(uml::NamedElement *  n,uml::Namespace *  ns)  ;
			...
			result = ('::')
			<p>From package UML::CommonStructure.</p> */ 
			virtual std::string separator()  ;
			
			/*!
			 result = (Dependency.allInstances()->select(d | d.client->includes(self)))
			<p>From package UML::CommonStructure.</p> */ 
			virtual std::vector<uml::Dependency * > *  getClientDependencies()  ;
			...
			<p>From package UML::CommonStructure.</p> */
			virtual std::vector<uml::Dependency * > *  getClientDependency() const ;
			
			/*!
			 The StringExpression used to define the name of this NamedElement.
			<p>From package UML::CommonStructure.</p> */
			virtual uml::StringExpression *  getNameExpression() const ;
			
			/*!
			 The StringExpression used to define the name of this NamedElement.
			<p>From package UML::CommonStructure.</p> */
			virtual void setNameExpression(uml::StringExpression *  _nameExpression) ;
