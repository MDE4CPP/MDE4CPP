...
namespace uml 
{
	class CallActionImpl :virtual public InvocationActionImpl, virtual public CallAction 
	{
		...
		public:
			...
			virtual bool
			 argument_pins(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
			...
			virtual bool
			 result_pins(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
			
			/*!
			 Only synchronous CallActions can have result OutputPins.
			result->notEmpty() implies isSynchronous */ 
			virtual bool
			 synchronous_call(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
