...
namespace ocl::Expressions 
{
	class LiteralExpImpl : virtual public OclExpressionImpl, virtual public LiteralExp 
	{
		...
		protected:
			...
			LiteralExpImpl();
			virtual std::shared_ptr<LiteralExp> getThisLiteralExpPtr() const;
			virtual void setThisLiteralExpPtr(std::weak_ptr<LiteralExp> thisLiteralExpPtr);

			//Additional constructors for the containments back reference
			LiteralExpImpl(std::weak_ptr<ocl::Expressions::CallExp> par_appliedElement);
			//Additional constructors for the containments back reference
			...
			//Additional constructors for the containments back reference
			//Additional constructors for the containments back reference
			LiteralExpImpl(std::weak_ptr<ocl::Expressions::Variable> par_initializedElement);
			//Additional constructors for the containments back reference
			//Additional constructors for the containments back reference
			LiteralExpImpl(std::weak_ptr<ocl::Expressions::LoopExp> par_loopBodyOwner);
			//Additional constructors for the containments back reference
