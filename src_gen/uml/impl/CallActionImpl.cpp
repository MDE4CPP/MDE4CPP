...
ecore::EClass* CallActionImpl::eStaticClass() const
{
...
std::vector<uml::Parameter * > *  CallActionImpl::inputParameters() 
{
	std::cout << __PRETTY_FUNCTION__  << std::endl;
	throw "UnsupportedOperationException";
}

std::vector<uml::Parameter * > *  CallActionImpl::outputParameters() 
{
	std::cout << __PRETTY_FUNCTION__  << std::endl;
	throw "UnsupportedOperationException";
}
...
// References
//*********************************
std::vector<uml::OutputPin * > *  CallActionImpl::getResult() const
{
...
// Union Getter
//*********************************
std::vector<uml::ActivityGroup * > *  CallActionImpl::getInGroup() const
{
...
std::vector<uml::OutputPin * > *  CallActionImpl::getOutput() const
{
...
std::vector<uml::Element * > *  CallActionImpl::getOwnedElement() const
{
...
std::vector<uml::InputPin * > *  CallActionImpl::getInput() const
{
...
uml::Element *  CallActionImpl::getOwner() const
{
...
std::vector<uml::RedefinableElement * > *  CallActionImpl::getRedefinedElement() const
{
