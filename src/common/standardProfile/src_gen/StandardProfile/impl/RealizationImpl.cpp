...
RealizationImpl::RealizationImpl()
{
	...
	*/
	...
	//getter init
		...
		m_getterMap.insert(std::pair<unsigned long,std::function<Any()>>(2125524565,[this](){ return eAny(this->getBase_Classifier(), uml::umlPackage::CLASSIFIER_CLASS, false);}));
	
	
	//setter init
	//Property base_Classifier
		m_setterMap.insert(std::pair<unsigned long,std::function<void(Any)>>(2125524565,[this](Any object){this->setBase_Classifier(object->get<std::shared_ptr<uml::Classifier>>());}));
	
	
	//unsetter init
		//Property base_Classifier
		m_unsetterMap.insert(std::pair<unsigned long,std::function<void()>>(2125524565,[this](){m_base_Classifier = std::shared_ptr<uml::Classifier>(nullptr);}));
...
//*********************************
//Get
Any RealizationImpl::get(const std::shared_ptr<uml::Property>& _property) const
{
...
Any RealizationImpl::get(unsigned long _uID) const
{
...
//Set
void RealizationImpl::set(const std::shared_ptr<uml::Property>& _property, const Any& value)
{
	std::string qualifiedName = _property->getQualifiedName();
    this->set(qualifiedName, value);
}

void RealizationImpl::set(std::string _qualifiedName, const Any& value)
{
	unsigned long uID = util::Util::polynomialRollingHash(_qualifiedName);
    this->set(uID, value);
}

void RealizationImpl::set(unsigned long _uID, const Any& value)
{
...
//*********************************
//Invoke
Any RealizationImpl::invoke(const std::shared_ptr<uml::Operation>& _operation, const std::shared_ptr<Bag<Any>>& _arguments)
{
...
Any RealizationImpl::invoke(std::string _qualifiedName, const std::shared_ptr<Bag<Any>>& _arguments)
{
	unsigned long uID = util::Util::polynomialRollingHash(_qualifiedName);
    return this->invoke(uID, _arguments);
}

Any RealizationImpl::invoke(unsigned long _uID, const std::shared_ptr<Bag<Any>>& _arguments)
{
