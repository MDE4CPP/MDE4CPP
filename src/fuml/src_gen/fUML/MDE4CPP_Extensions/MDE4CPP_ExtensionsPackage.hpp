	...
	*/
	...
	class FUML_API MDE4CPP_ExtensionsPackage : virtual public ecore::EPackage 
	{
		...
		public:
			...
			static const unsigned long FUML_LINK_OPERATION_RETRIEVEOTHERLINKENDVALUE_PROPERTY = 2415853951;
			...
			virtual const std::shared_ptr<ecore::EOperation>& getFUML_Link_Operation_retrieveOtherLinkEndValue_Property() const = 0;
