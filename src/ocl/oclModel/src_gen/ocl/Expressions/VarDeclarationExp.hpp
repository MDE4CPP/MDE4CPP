...
namespace ocl::Expressions 
{
	...
	class OCL_API VarDeclarationExp : virtual public OclExpression
	{
		...
		public:
			...
			//*********************************
			virtual const std::shared_ptr<ocl::Expressions::OclExpression>& getAssignedOclExp() const = 0;
			...
			virtual const std::shared_ptr<ocl::Expressions::TypeExp>& getVarType() const = 0;
