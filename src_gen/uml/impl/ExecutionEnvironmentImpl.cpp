...
ecore::EClass* ExecutionEnvironmentImpl::eStaticClass() const
{
...
// Union Getter
//*********************************
std::vector<uml::ConnectableElement * > *  ExecutionEnvironmentImpl::getRole() const
{
...
std::vector<uml::NamedElement * > *  ExecutionEnvironmentImpl::getMember() const
{
...
std::vector<uml::Feature * > *  ExecutionEnvironmentImpl::getFeature() const
{
...
std::vector<uml::RedefinableElement * > *  ExecutionEnvironmentImpl::getRedefinedElement() const
{
...
std::vector<uml::Element * > *  ExecutionEnvironmentImpl::getOwnedElement() const
{
...
uml::Element *  ExecutionEnvironmentImpl::getOwner() const
{
...
std::vector<uml::Property * > *  ExecutionEnvironmentImpl::getAttribute() const
{
...
uml::Namespace *  ExecutionEnvironmentImpl::getNamespace() const
{
...
std::vector<uml::NamedElement * > *  ExecutionEnvironmentImpl::getOwnedMember() const
{
