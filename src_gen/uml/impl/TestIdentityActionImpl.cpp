...
TestIdentityActionImpl::TestIdentityActionImpl(const TestIdentityActionImpl & obj)
{
	...
	{
		m_first = dynamic_cast<uml::InputPin * >(obj.getFirst()->copy());
	}
	...
	{
		m_second = dynamic_cast<uml::InputPin * >(obj.getSecond()->copy());
	}
}
...
ecore::EClass* TestIdentityActionImpl::eStaticClass() const
{
...
// References
//*********************************
uml::InputPin *  TestIdentityActionImpl::getFirst() const
{
	//assert(m_first);
	return m_first;
}
void TestIdentityActionImpl::setFirst(uml::InputPin *  _first)
{
	m_first = _first;
}

uml::OutputPin *  TestIdentityActionImpl::getResult() const
{
	//assert(m_result);
	return m_result;
}
void TestIdentityActionImpl::setResult(uml::OutputPin *  _result)
{
	m_result = _result;
}

uml::InputPin *  TestIdentityActionImpl::getSecond() const
{
	//assert(m_second);
	return m_second;
}
void TestIdentityActionImpl::setSecond(uml::InputPin *  _second)
{
	m_second = _second;
}
...
// Union Getter
//*********************************
std::vector<uml::InputPin * > *  TestIdentityActionImpl::getInput() const
{
...
std::vector<uml::RedefinableElement * > *  TestIdentityActionImpl::getRedefinedElement() const
{
...
std::vector<uml::OutputPin * > *  TestIdentityActionImpl::getOutput() const
{
...
std::vector<uml::Element * > *  TestIdentityActionImpl::getOwnedElement() const
{
...
std::vector<uml::ActivityGroup * > *  TestIdentityActionImpl::getInGroup() const
{
...
uml::Element *  TestIdentityActionImpl::getOwner() const
{
