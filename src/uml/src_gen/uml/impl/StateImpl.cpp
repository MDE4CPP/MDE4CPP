...
StateImpl::StateImpl(const StateImpl & obj): NamespaceImpl(obj), RedefinableElementImpl(obj), VertexImpl(obj), State(obj)
{
	...
	for(auto _connection : *obj.getConnection()) 
	{
	...
	for(auto _connectionPoint : *obj.getConnectionPoint()) 
	{
	...
	for(auto _deferrableTrigger : *obj.getDeferrableTrigger()) 
	{
	...
	for(auto _region : *obj.getRegion()) 
	{
