...
{
	std::shared_ptr<InteractionFragmentObject> element(new InteractionFragmentObject(*this));
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> InteractionFragmentObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Bag<uml::Comment>> ownedCommentList = m_InteractionFragmentValue->getOwnedComment();
	...
	{
		std::shared_ptr<Bag<uml::Element>> ownedElementList = m_InteractionFragmentValue->getOwnedElement();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_InteractionFragment_generalOrdering())
	{
		std::shared_ptr<Bag<uml::GeneralOrdering>> generalOrderingList = m_InteractionFragmentValue->getGeneralOrdering();
