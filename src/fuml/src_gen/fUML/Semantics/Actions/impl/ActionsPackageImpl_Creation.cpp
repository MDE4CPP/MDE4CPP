...
void ActionsPackageImpl::createActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_actionActivation_Attribute_action = factory->createEReference_as_eStructuralFeatures_in_EClass(m_actionActivation_Class, ACTIONACTIVATION_ATTRIBUTE_ACTION);m_actionActivation_Attribute_inputPinActivation = factory->createEReference_as_eStructuralFeatures_in_EClass(m_actionActivation_Class, ACTIONACTIVATION_ATTRIBUTE_INPUTPINACTIVATION);m_actionActivation_Attribute_outputPinActivation = factory->createEReference_as_eStructuralFeatures_in_EClass(m_actionActivation_Class, ACTIONACTIVATION_ATTRIBUTE_OUTPUTPINACTIVATION);m_actionActivation_Attribute_pinActivation = factory->createEReference_as_eStructuralFeatures_in_EClass(m_actionActivation_Class, ACTIONACTIVATION_ATTRIBUTE_PINACTIVATION);
...
void ActionsPackageImpl::createCallActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_callActionActivation_Attribute_callAction = factory->createEReference_as_eStructuralFeatures_in_EClass(m_callActionActivation_Class, CALLACTIONACTIVATION_ATTRIBUTE_CALLACTION);m_callActionActivation_Attribute_callExecutions = factory->createEReference_as_eStructuralFeatures_in_EClass(m_callActionActivation_Class, CALLACTIONACTIVATION_ATTRIBUTE_CALLEXECUTIONS);
...
void ActionsPackageImpl::createClauseActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_clauseActivation_Attribute_clause = factory->createEReference_as_eStructuralFeatures_in_EClass(m_clauseActivation_Class, CLAUSEACTIVATION_ATTRIBUTE_CLAUSE);m_clauseActivation_Attribute_conditionalNodeActivation = factory->createEReference_as_eStructuralFeatures_in_EClass(m_clauseActivation_Class, CLAUSEACTIVATION_ATTRIBUTE_CONDITIONALNODEACTIVATION);
...
void ActionsPackageImpl::createConditionalNodeActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_conditionalNodeActivation_Attribute_clauseActivations = factory->createEReference_as_eStructuralFeatures_in_EClass(m_conditionalNodeActivation_Class, CONDITIONALNODEACTIVATION_ATTRIBUTE_CLAUSEACTIVATIONS);m_conditionalNodeActivation_Attribute_selectedClauses = factory->createEReference_as_eStructuralFeatures_in_EClass(m_conditionalNodeActivation_Class, CONDITIONALNODEACTIVATION_ATTRIBUTE_SELECTEDCLAUSES);
...
void ActionsPackageImpl::createPinActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_pinActivation_Attribute_actionActivation = factory->createEReference_as_eStructuralFeatures_in_EClass(m_pinActivation_Class, PINACTIVATION_ATTRIBUTE_ACTIONACTIVATION);m_pinActivation_Attribute_pin = factory->createEReference_as_eStructuralFeatures_in_EClass(m_pinActivation_Class, PINACTIVATION_ATTRIBUTE_PIN);
