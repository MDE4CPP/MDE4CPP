...
LibraryImpl::LibraryImpl()
{
	...
	*/
	...
	//getter init
		...
		m_getterMap.insert(std::pair<long long,std::function<Any()>>(1798649185,[this](){ return eAny(this->getBase_Artifact(), uml::umlPackage::ARTIFACT_CLASS, false);}));
	
	
	//setter init
	//Property base_Artifact
		m_setterMap.insert(std::pair<long long,std::function<void(Any)>>(1798649185,[this](Any object){this->setBase_Artifact(object->get<std::shared_ptr<uml::Artifact>>());}));
	
	
	//unsetter init
		//Property base_Artifact
		m_unsetterMap.insert(std::pair<long long,std::function<void()>>(1798649185,[this](){m_base_Artifact = std::shared_ptr<uml::Artifact>(nullptr);}));
...
Any LibraryImpl::get(long long _uID) const
{
...
void LibraryImpl::set(std::string _qualifiedName, Any value)
{
	long long uID = util::Util::polynomialRollingHash(_qualifiedName);
    this->set(uID, value);
}

void LibraryImpl::set(long long _uID, Any value)
{
...
void LibraryImpl::unset(long long _uID)
{
...
//*********************************
//Invoke
Any LibraryImpl::invoke(std::shared_ptr<uml::Operation> _operation, std::shared_ptr<Bag<Any>> _arguments)
{
...
Any LibraryImpl::invoke(std::string _qualifiedName, std::shared_ptr<Bag<Any>> _arguments)
{
	long long uID = util::Util::polynomialRollingHash(_qualifiedName);
    return this->invoke(uID, _arguments);
}

Any LibraryImpl::invoke(long long _uID, std::shared_ptr<Bag<Any>> _arguments)
{
