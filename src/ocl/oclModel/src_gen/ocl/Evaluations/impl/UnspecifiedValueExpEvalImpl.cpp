...
UnspecifiedValueExpEvalImpl& UnspecifiedValueExpEvalImpl::operator=(const UnspecifiedValueExpEvalImpl & obj)
{
	 ...
	 * Currently, this causes an error because it calls an implicit assignment operator of UnspecifiedValueExpEval 
	 * which is generated by the compiler (as UnspecifiedValueExpEval is an abstract class and does not have a user-defined assignment operator).
...
//*********************************
std::shared_ptr<Any> UnspecifiedValueExpEvalImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
	}
...
void UnspecifiedValueExpEvalImpl::setThisUnspecifiedValueExpEvalPtr(std::weak_ptr<ocl::Evaluations::UnspecifiedValueExpEval> thisUnspecifiedValueExpEvalPtr)
{
	...
	setThisOclExpEvalPtr(thisUnspecifiedValueExpEvalPtr);
}
