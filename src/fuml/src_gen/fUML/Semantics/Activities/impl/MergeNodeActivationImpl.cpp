...
bool MergeNodeActivationImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
	}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> MergeNodeActivationImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
