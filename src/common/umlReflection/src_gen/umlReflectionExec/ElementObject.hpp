...
#ifndef UML_ELEMENT_EXECUTION_HPP
#define UML_ELEMENT_EXECUTION_HPP
...
namespace UML 
{
	class ElementObject : virtual public PSCS::Semantics::StructuredClassifiers::CS_ObjectImpl
	{
		public:
		    //constructors
		    ElementObject(ElementObject &obj);
		    ElementObject(std::shared_ptr<uml::Element>);
		 	ElementObject();
		    //destructor
		    virtual ~ElementObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			ElementObject& operator=(ElementObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::Element> getElementValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setElementValue(std::shared_ptr<uml::Element>);
			virtual void setThisElementObjectPtr(std::weak_ptr<ElementObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Element> m_ElementValue = nullptr;
	};
}
#endif /* end of include guard: UML_ELEMENT_OBJECT_HPP */
