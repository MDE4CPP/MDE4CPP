...
CS_ReadExtentActionActivationImpl& CS_ReadExtentActionActivationImpl::operator=(const CS_ReadExtentActionActivationImpl & obj)
{
	 ...
	 * Currently, this causes an error because it calls an implicit assignment operator of CS_ReadExtentActionActivation 
	 * which is generated by the compiler (as CS_ReadExtentActionActivation is an abstract class and does not have a user-defined assignment operator).
...
const std::shared_ptr<ecore::EClass>& CS_ReadExtentActionActivationImpl::eStaticClass() const
{
...
//*********************************
std::shared_ptr<Any> CS_ReadExtentActionActivationImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
	}
...
bool CS_ReadExtentActionActivationImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
	}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> CS_ReadExtentActionActivationImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
...
std::shared_ptr<PSCS::Semantics::Actions::CS_ReadExtentActionActivation> CS_ReadExtentActionActivationImpl::getThisCS_ReadExtentActionActivationPtr() const
{
	return m_thisCS_ReadExtentActionActivationPtr.lock();
}
void CS_ReadExtentActionActivationImpl::setThisCS_ReadExtentActionActivationPtr(std::weak_ptr<PSCS::Semantics::Actions::CS_ReadExtentActionActivation> thisCS_ReadExtentActionActivationPtr)
{
