...
#ifndef UML_INTERVALCONSTRAINT_EXECUTION_HPP
#define UML_INTERVALCONSTRAINT_EXECUTION_HPP
...
namespace UML 
{
	class IntervalConstraintObject : virtual public UML::ConstraintObject
	{
		public:
		    //constructors
		    IntervalConstraintObject(IntervalConstraintObject &obj);
		    IntervalConstraintObject(std::shared_ptr<uml::IntervalConstraint>);
		 	IntervalConstraintObject();
		    //destructor
		    virtual ~IntervalConstraintObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			IntervalConstraintObject& operator=(IntervalConstraintObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::IntervalConstraint> getIntervalConstraintValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setIntervalConstraintValue(std::shared_ptr<uml::IntervalConstraint>);
			virtual void setThisIntervalConstraintObjectPtr(std::weak_ptr<IntervalConstraintObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::IntervalConstraint> m_IntervalConstraintValue = nullptr;
	};
}
#endif /* end of include guard: UML_INTERVALCONSTRAINT_OBJECT_HPP */
