...
namespace uml 
{
	...
	class WriteStructuralFeatureAction:virtual public StructuralFeatureAction	{
		...
		public:
			...
			virtual bool
			 type_of_value(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			
			/*!
			 The multiplicity of the value InputPin is 1..1.
			value<>null implies value.is(1,1) */ 
			virtual bool
			 multiplicity_of_value(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
