...
#ifndef UML_EXTENSIONPOINT_EXECUTION_HPP
#define UML_EXTENSIONPOINT_EXECUTION_HPP
...
namespace UML 
{
	class ExtensionPointObject : virtual public UML::RedefinableElementObject
	{
		public:
		    //constructors
		    ExtensionPointObject(ExtensionPointObject &obj);
		    ExtensionPointObject(std::shared_ptr<uml::ExtensionPoint>);
		 	ExtensionPointObject();
		    //destructor
		    virtual ~ExtensionPointObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			ExtensionPointObject& operator=(ExtensionPointObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::ExtensionPoint> getExtensionPointValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setExtensionPointValue(std::shared_ptr<uml::ExtensionPoint>);
			virtual void setThisExtensionPointObjectPtr(std::weak_ptr<ExtensionPointObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ExtensionPoint> m_ExtensionPointValue = nullptr;
	};
}
#endif /* end of include guard: UML_EXTENSIONPOINT_OBJECT_HPP */
