...
namespace uml 
{
	...
	class ParameterSet:virtual public NamedElement	{
		...
		public:
			...
			virtual bool
			 same_parameterized_entity(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 input(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 two_parameter_sets(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
