...
namespace uml 
{
	...
	class EncapsulatedClassifier:virtual public StructuredClassifier	{
		...
		public:
			...
			<p>From package UML::StructuredClassifiers.</p> */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Port>>> getOwnedPorts()  = 0;
			...
			<p>From package UML::StructuredClassifiers.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Port>>> getOwnedPort() const = 0;
		...
		protected:
			...
			/*!
			 The Ports owned by the EncapsulatedClassifier.
			<p>From package UML::StructuredClassifiers.</p> */
			std::shared_ptr<std::vector<std::shared_ptr<uml::Port>>> m_ownedPort;
