package UML4CPP_test.generator.compiler;
...
public class CompileAcceleoGenerator 
{
	...
	public static void main(final String[] args) {
        try 
        {
            if (args.length != 3) 
            {
                System.out.println("Arguments not valid : {source folder, target folder, UML4CPP folder}.");
            } 
            else 
            {
            	...
            	String dependency = args[2];
            	file = new File(targetFolder);
            	if (file.isFile())
            	{
            		System.err.println("UML4CPP path is a file!");
            		return;
            	}
            	...
            	// generate emtl file of UML4CPP_test
