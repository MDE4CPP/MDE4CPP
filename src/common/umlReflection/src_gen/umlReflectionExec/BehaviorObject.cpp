...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> BehaviorObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Behavior_ownedParameter())
	{
		std::shared_ptr<Bag<uml::Parameter>> ownedParameterList = m_BehaviorValue->getOwnedParameter();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Behavior_ownedParameterSet())
	{
		std::shared_ptr<Bag<uml::ParameterSet>> ownedParameterSetList = m_BehaviorValue->getOwnedParameterSet();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Behavior_postcondition())
	{
		std::shared_ptr<Bag<uml::Constraint>> postconditionList = m_BehaviorValue->getPostcondition();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Behavior_precondition())
	{
		std::shared_ptr<Bag<uml::Constraint>> preconditionList = m_BehaviorValue->getPrecondition();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Behavior_redefinedBehavior())
	{
		std::shared_ptr<Bag<uml::Behavior>> redefinedBehaviorList = m_BehaviorValue->getRedefinedBehavior();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioredClassifier_interfaceRealization())
	{
		std::shared_ptr<Bag<uml::InterfaceRealization>> interfaceRealizationList = m_BehaviorValue->getInterfaceRealization();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioredClassifier_ownedBehavior())
	{
		std::shared_ptr<Bag<uml::Behavior>> ownedBehaviorList = m_BehaviorValue->getOwnedBehavior();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_nestedClassifier())
	{
		std::shared_ptr<Bag<uml::Classifier>> nestedClassifierList = m_BehaviorValue->getNestedClassifier();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_ownedAttribute())
	{
		std::shared_ptr<Bag<uml::Property>> ownedAttributeList = m_BehaviorValue->getOwnedAttribute();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_ownedOperation())
	{
		std::shared_ptr<Bag<uml::Operation>> ownedOperationList = m_BehaviorValue->getOwnedOperation();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_ownedReception())
	{
		std::shared_ptr<Bag<uml::Reception>> ownedReceptionList = m_BehaviorValue->getOwnedReception();
	...
	{
		std::shared_ptr<Bag<uml::Property>> attributeList = m_BehaviorValue->getAttribute();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_collaborationUse())
	{
		std::shared_ptr<Bag<uml::CollaborationUse>> collaborationUseList = m_BehaviorValue->getCollaborationUse();
	...
	{
		std::shared_ptr<Bag<uml::Feature>> featureList = m_BehaviorValue->getFeature();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_generalization())
	{
		std::shared_ptr<Bag<uml::Generalization>> generalizationList = m_BehaviorValue->getGeneralization();
	...
	{
		std::shared_ptr<Bag<uml::NamedElement>> inheritedMemberList = m_BehaviorValue->getInheritedMember();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_ownedUseCase())
	{
		std::shared_ptr<Bag<uml::UseCase>> ownedUseCaseList = m_BehaviorValue->getOwnedUseCase();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_redefinedClassifier())
	{
		std::shared_ptr<Bag<uml::Classifier>> redefinedClassifierList = m_BehaviorValue->getRedefinedClassifier();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_substitution())
	{
		std::shared_ptr<Bag<uml::Substitution>> substitutionList = m_BehaviorValue->getSubstitution();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Bag<uml::Comment>> ownedCommentList = m_BehaviorValue->getOwnedComment();
	...
	{
		std::shared_ptr<Bag<uml::Element>> ownedElementList = m_BehaviorValue->getOwnedElement();
	...
	{
		std::shared_ptr<Bag<uml::Port>> ownedPortList = m_BehaviorValue->getOwnedPort();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_elementImport())
	{
		std::shared_ptr<Bag<uml::ElementImport>> elementImportList = m_BehaviorValue->getElementImport();
	...
	{
		std::shared_ptr<Bag<uml::PackageableElement>> importedMemberList = m_BehaviorValue->getImportedMember();
	...
	{
		std::shared_ptr<Bag<uml::NamedElement>> memberList = m_BehaviorValue->getMember();
	...
	{
		std::shared_ptr<Bag<uml::NamedElement>> ownedMemberList = m_BehaviorValue->getOwnedMember();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_ownedRule())
	{
		std::shared_ptr<Bag<uml::Constraint>> ownedRuleList = m_BehaviorValue->getOwnedRule();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_packageImport())
	{
		std::shared_ptr<Bag<uml::PackageImport>> packageImportList = m_BehaviorValue->getPackageImport();
	...
	{
		std::shared_ptr<Bag<uml::RedefinableElement>> redefinedElementList = m_BehaviorValue->getRedefinedElement();
	...
	{
		std::shared_ptr<Bag<uml::Classifier>> redefinitionContextList = m_BehaviorValue->getRedefinitionContext();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_StructuredClassifier_ownedConnector())
	{
		std::shared_ptr<Bag<uml::Connector>> ownedConnectorList = m_BehaviorValue->getOwnedConnector();
	...
	{
		std::shared_ptr<Bag<uml::ConnectableElement>> roleList = m_BehaviorValue->getRole();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateableElement_templateBinding())
	{
		std::shared_ptr<Bag<uml::TemplateBinding>> templateBindingList = m_BehaviorValue->getTemplateBinding();
...
std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> BehaviorObject::retrieveFeatureValues()
{
	...
	for(unsigned int i = 0; i < allAttributesSize; i++)
	{
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_Class_ownedAttribute() && m_BehaviorValue->getOwnedAttribute() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
