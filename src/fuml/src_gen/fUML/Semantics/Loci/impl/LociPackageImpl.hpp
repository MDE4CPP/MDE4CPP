...
namespace fUML::Semantics::Loci
{
	class FUML_API LociPackageImpl : public ecore::EPackageImpl ,virtual public LociPackage
	{
		...
		public:
			...
			virtual const std::shared_ptr<ecore::EOperation>& getExecutor_Operation_execute_Behavior_FUML_Object_ParameterValue() const ;
