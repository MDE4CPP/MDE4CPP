...
namespace uml 
{
	...
	class AssociationClass:virtual public Association,virtual public Class	{
		...
		public:
			...
			virtual bool
			 cannot_be_defined(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			
			/*!
			 The owned attributes and owned ends of an AssociationClass are disjoint.
			ownedAttribute->intersection(ownedEnd)->isEmpty() */ 
			virtual bool
			 disjoint_attributes_ends(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
