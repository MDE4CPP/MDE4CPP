...
void umlPackageImpl::createObjectContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_object_Operation_remove_Property_EJavaObject = factory->createEOperation_as_eOperations_in_EClass(m_object_Class, OBJECT_OPERATION_REMOVE_PROPERTY_EJAVAOBJECT);
