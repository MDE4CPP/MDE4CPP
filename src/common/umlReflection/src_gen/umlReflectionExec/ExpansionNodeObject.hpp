...
#ifndef UML_EXPANSIONNODE_EXECUTION_HPP
#define UML_EXPANSIONNODE_EXECUTION_HPP
...
namespace UML 
{
	class ExpansionNodeObject : virtual public UML::ObjectNodeObject
	{
		public:
		    //constructors
		    ExpansionNodeObject(ExpansionNodeObject &obj);
		    ExpansionNodeObject(std::shared_ptr<uml::ExpansionNode>);
		 	ExpansionNodeObject();
		    //destructor
		    virtual ~ExpansionNodeObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			ExpansionNodeObject& operator=(ExpansionNodeObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::ExpansionNode> getExpansionNodeValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setExpansionNodeValue(std::shared_ptr<uml::ExpansionNode>);
			virtual void setThisExpansionNodeObjectPtr(std::weak_ptr<ExpansionNodeObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ExpansionNode> m_ExpansionNodeValue = nullptr;
	};
}
#endif /* end of include guard: UML_EXPANSIONNODE_OBJECT_HPP */
