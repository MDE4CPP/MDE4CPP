...
namespace uml 
{
	class StructuredActivityNodeImpl :virtual public ActionImpl, virtual public ActivityGroupImpl, virtual public NamespaceImpl, virtual public StructuredActivityNode
	{
		...
		public:
			...
			virtual std::vector<uml::ActivityNode * > *  sourceNodes()  ;
			...
			<p>From package UML::Actions.</p> */ 
			virtual std::vector<uml::ActivityNode * > *  targetNodes()  ;
			...
			<p>From package UML::Actions.</p> */
			virtual std::vector<uml::InputPin * > *  getStructuredNodeInput() const ;
			
			/*!
			 The OutputPins owned by the StructuredActivityNode.
			<p>From package UML::Actions.</p> */
			virtual std::vector<uml::OutputPin * > *  getStructuredNodeOutput() const ;
