...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/ecore4CPP/generator/main/generate";
    ...
    public List<String> getProperties() {
    	...
    	addToPropertiesFile(modelPropertyPath); // add model file properties 
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        resourceSet.getPackageRegistry().put("platform:/plugin/org.eclipse.emf.ecore/model/Ecore.ecore", org.eclipse.emf.ecore.EcorePackage.eINSTANCE);
        resourceSet.getPackageRegistry().put("platform:/plugin/org.eclipse.uml2.uml/model/UML.ecore", UMLPackage.eINSTANCE);
        resourceSet.getPackageRegistry().put("platform:/plugin/org.eclipse.uml2.types/model/Types.ecore", org.eclipse.uml2.types.TypesPackage.eINSTANCE);
