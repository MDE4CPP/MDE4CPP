...
bool IntegerLiteralExpImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::INTEGERLITERALEXP_ATTRIBUTE_INTEGERSYMBOL:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> IntegerLiteralExpImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
