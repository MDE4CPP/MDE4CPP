...
void TimeObservationImpl::saveContent(std::shared_ptr<persistence::interfaces::XSaveHandler> saveHandler) const
{
	...
	// Add references
	if ( this->eIsSet(package->getTimeObservation_Attribute_event()) )
	{
...
bool TimeObservationImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::TIMEOBSERVATION_ATTRIBUTE_EVENT:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> TimeObservationImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
