...
#ifndef STANDARDPROFILE_TRACE_HPP
#define STANDARDPROFILE_TRACE_HPP
...
namespace StandardProfile 
{
	/*!
	 */
	class Trace : virtual public ecore::EObject 
...
#endif /* end of include guard: STANDARDPROFILE_TRACE_HPP */
