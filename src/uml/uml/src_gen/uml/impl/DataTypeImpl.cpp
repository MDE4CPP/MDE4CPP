...
bool DataTypeImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::DATATYPE_ATTRIBUTE_OWNEDATTRIBUTE:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> DataTypeImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
