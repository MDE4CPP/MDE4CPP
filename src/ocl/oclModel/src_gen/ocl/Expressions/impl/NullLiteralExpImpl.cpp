...
//Additional constructor for the containments back reference
NullLiteralExpImpl::NullLiteralExpImpl(std::weak_ptr<ocl::Expressions::LoopExp> par_LoopExp, const int reference_id)
:NullLiteralExpImpl()
{
	switch(reference_id)
	{	
...
NullLiteralExpImpl& NullLiteralExpImpl::operator=(const NullLiteralExpImpl & obj)
{
	 ...
	 * Currently, this causes an error because it calls an implicit assignment operator of NullLiteralExp 
	 * which is generated by the compiler (as NullLiteralExp is an abstract class and does not have a user-defined assignment operator).
...
//*********************************
std::shared_ptr<Any> NullLiteralExpImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
	}
...
bool NullLiteralExpImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
	}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> NullLiteralExpImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
...
std::shared_ptr<ocl::Expressions::NullLiteralExp> NullLiteralExpImpl::getThisNullLiteralExpPtr() const
{
	return m_thisNullLiteralExpPtr.lock();
}
void NullLiteralExpImpl::setThisNullLiteralExpPtr(std::weak_ptr<ocl::Expressions::NullLiteralExp> thisNullLiteralExpPtr)
{
	m_thisNullLiteralExpPtr = thisNullLiteralExpPtr;
	setThisLiteralExpPtr(thisNullLiteralExpPtr);
}
