...
InteractionFragmentImpl::InteractionFragmentImpl()
{
	...
	//*********************************
		...
		/*Subset*/
		m_generalOrdering.reset(new Subset<uml::GeneralOrdering, uml::Element >(m_ownedElement));//(m_ownedElement));
...
//*********************************
	std::shared_ptr< Bag<uml::Lifeline> >
 InteractionFragmentImpl::getCovered() const
{
...
void InteractionFragmentImpl::setEnclosingOperand(std::shared_ptr<uml::InteractionOperand> _enclosingOperand)
{
 ...
 InteractionFragmentImpl::getGeneralOrdering() const
{
