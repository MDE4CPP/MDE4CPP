...
void ActionsPackageImpl::createAcceptEventActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_acceptEventActionActivation_Attribute_waiting = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_acceptEventActionActivation_Class, ACCEPTEVENTACTIONACTIVATION_ATTRIBUTE_WAITING);
	
	m_acceptEventActionActivation_Attribute_eventAccepter = factory->createEReference_as_eStructuralFeatures_in_EClass(m_acceptEventActionActivation_Class, ACCEPTEVENTACTIONACTIVATION_ATTRIBUTE_EVENTACCEPTER);
...
void ActionsPackageImpl::createAcceptEventActionEventAccepterContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_acceptEventActionEventAccepter_Attribute_actionActivation = factory->createEReference_as_eStructuralFeatures_in_EClass(m_acceptEventActionEventAccepter_Class, ACCEPTEVENTACTIONEVENTACCEPTER_ATTRIBUTE_ACTIONACTIVATION);
...
void ActionsPackageImpl::createActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_actionActivation_Attribute_firing = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_actionActivation_Class, ACTIONACTIVATION_ATTRIBUTE_FIRING);
	
	m_actionActivation_Attribute_action = factory->createEReference_as_eStructuralFeatures_in_EClass(m_actionActivation_Class, ACTIONACTIVATION_ATTRIBUTE_ACTION);
	m_actionActivation_Attribute_inputPinActivation = factory->createEReference_as_eStructuralFeatures_in_EClass(m_actionActivation_Class, ACTIONACTIVATION_ATTRIBUTE_INPUTPINACTIVATION);
	m_actionActivation_Attribute_outputPinActivation = factory->createEReference_as_eStructuralFeatures_in_EClass(m_actionActivation_Class, ACTIONACTIVATION_ATTRIBUTE_OUTPUTPINACTIVATION);
	m_actionActivation_Attribute_pinActivation = factory->createEReference_as_eStructuralFeatures_in_EClass(m_actionActivation_Class, ACTIONACTIVATION_ATTRIBUTE_PINACTIVATION);
	...
	m_actionActivation_Operation_makeBooleanValue_EBoolean = factory->createEOperation_as_eOperations_in_EClass(m_actionActivation_Class, ACTIONACTIVATION_OPERATION_MAKEBOOLEANVALUE_EBOOLEAN);
	m_actionActivation_Operation_putToken_OutputPin_Value = factory->createEOperation_as_eOperations_in_EClass(m_actionActivation_Class, ACTIONACTIVATION_OPERATION_PUTTOKEN_OUTPUTPIN_VALUE);
	m_actionActivation_Operation_putTokens_OutputPin_Value = factory->createEOperation_as_eOperations_in_EClass(m_actionActivation_Class, ACTIONACTIVATION_OPERATION_PUTTOKENS_OUTPUTPIN_VALUE);
	...
	m_actionActivation_Operation_valueParticipatesInLink_Value_Link = factory->createEOperation_as_eOperations_in_EClass(m_actionActivation_Class, ACTIONACTIVATION_OPERATION_VALUEPARTICIPATESINLINK_VALUE_LINK);
...
void ActionsPackageImpl::createAddStructuralFeatureValueActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_addStructuralFeatureValueActionActivation_Attribute_addStructuralFeatureValueAction = factory->createEReference_as_eStructuralFeatures_in_EClass(m_addStructuralFeatureValueActionActivation_Class, ADDSTRUCTURALFEATUREVALUEACTIONACTIVATION_ATTRIBUTE_ADDSTRUCTURALFEATUREVALUEACTION);
...
void ActionsPackageImpl::createCallActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_callActionActivation_Attribute_callAction = factory->createEReference_as_eStructuralFeatures_in_EClass(m_callActionActivation_Class, CALLACTIONACTIVATION_ATTRIBUTE_CALLACTION);
	m_callActionActivation_Attribute_callExecutions = factory->createEReference_as_eStructuralFeatures_in_EClass(m_callActionActivation_Class, CALLACTIONACTIVATION_ATTRIBUTE_CALLEXECUTIONS);
...
void ActionsPackageImpl::createCallBehaviorActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_callBehaviorActionActivation_Attribute_callBehaviorAction = factory->createEReference_as_eStructuralFeatures_in_EClass(m_callBehaviorActionActivation_Class, CALLBEHAVIORACTIONACTIVATION_ATTRIBUTE_CALLBEHAVIORACTION);
...
void ActionsPackageImpl::createCallOperationActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_callOperationActionActivation_Attribute_callOperationAction = factory->createEReference_as_eStructuralFeatures_in_EClass(m_callOperationActionActivation_Class, CALLOPERATIONACTIONACTIVATION_ATTRIBUTE_CALLOPERATIONACTION);
...
void ActionsPackageImpl::createClauseActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_clauseActivation_Attribute_clause = factory->createEReference_as_eStructuralFeatures_in_EClass(m_clauseActivation_Class, CLAUSEACTIVATION_ATTRIBUTE_CLAUSE);
	m_clauseActivation_Attribute_conditionalNodeActivation = factory->createEReference_as_eStructuralFeatures_in_EClass(m_clauseActivation_Class, CLAUSEACTIVATION_ATTRIBUTE_CONDITIONALNODEACTIVATION);
...
void ActionsPackageImpl::createConditionalNodeActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_conditionalNodeActivation_Attribute_clauseActivations = factory->createEReference_as_eStructuralFeatures_in_EClass(m_conditionalNodeActivation_Class, CONDITIONALNODEACTIVATION_ATTRIBUTE_CLAUSEACTIVATIONS);
	m_conditionalNodeActivation_Attribute_selectedClauses = factory->createEReference_as_eStructuralFeatures_in_EClass(m_conditionalNodeActivation_Class, CONDITIONALNODEACTIVATION_ATTRIBUTE_SELECTEDCLAUSES);
...
void ActionsPackageImpl::createCreateObjectActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_createObjectActionActivation_Attribute_createObjectAction = factory->createEReference_as_eStructuralFeatures_in_EClass(m_createObjectActionActivation_Class, CREATEOBJECTACTIONACTIVATION_ATTRIBUTE_CREATEOBJECTACTION);
...
void ActionsPackageImpl::createDestroyObjectActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_destroyObjectActionActivation_Attribute_destroyObjectAction = factory->createEReference_as_eStructuralFeatures_in_EClass(m_destroyObjectActionActivation_Class, DESTROYOBJECTACTIONACTIVATION_ATTRIBUTE_DESTROYOBJECTACTION);
	
	m_destroyObjectActionActivation_Operation_destroyObject_Value_EBoolean = factory->createEOperation_as_eOperations_in_EClass(m_destroyObjectActionActivation_Class, DESTROYOBJECTACTIONACTIVATION_OPERATION_DESTROYOBJECT_VALUE_EBOOLEAN);
	...
	m_destroyObjectActionActivation_Operation_objectIsComposite_Reference_Link = factory->createEOperation_as_eOperations_in_EClass(m_destroyObjectActionActivation_Class, DESTROYOBJECTACTIONACTIVATION_OPERATION_OBJECTISCOMPOSITE_REFERENCE_LINK);
...
void ActionsPackageImpl::createLinkActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_linkActionActivation_Operation_endMatchesEndData_Link_LinkEndData = factory->createEOperation_as_eOperations_in_EClass(m_linkActionActivation_Class, LINKACTIONACTIVATION_OPERATION_ENDMATCHESENDDATA_LINK_LINKENDDATA);
	...
	m_linkActionActivation_Operation_linkMatchesEndData_Link_LinkEndData = factory->createEOperation_as_eOperations_in_EClass(m_linkActionActivation_Class, LINKACTIONACTIVATION_OPERATION_LINKMATCHESENDDATA_LINK_LINKENDDATA);
...
void ActionsPackageImpl::createLoopNodeActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_loopNodeActivation_Attribute_bodyOutputLists = factory->createEReference_as_eStructuralFeatures_in_EClass(m_loopNodeActivation_Class, LOOPNODEACTIVATION_ATTRIBUTE_BODYOUTPUTLISTS);
...
void ActionsPackageImpl::createPinActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_pinActivation_Attribute_actionActivation = factory->createEReference_as_eStructuralFeatures_in_EClass(m_pinActivation_Class, PINACTIVATION_ATTRIBUTE_ACTIONACTIVATION);
	m_pinActivation_Attribute_pin = factory->createEReference_as_eStructuralFeatures_in_EClass(m_pinActivation_Class, PINACTIVATION_ATTRIBUTE_PIN);
...
void ActionsPackageImpl::createReadSelfActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_readSelfActionActivation_Attribute_readSelfAction = factory->createEReference_as_eStructuralFeatures_in_EClass(m_readSelfActionActivation_Class, READSELFACTIONACTIVATION_ATTRIBUTE_READSELFACTION);
...
void ActionsPackageImpl::createReadStructuralFeatureActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_readStructuralFeatureActionActivation_Attribute_readStructuralFeatureAction = factory->createEReference_as_eStructuralFeatures_in_EClass(m_readStructuralFeatureActionActivation_Class, READSTRUCTURALFEATUREACTIONACTIVATION_ATTRIBUTE_READSTRUCTURALFEATUREACTION);
...
void ActionsPackageImpl::createReduceActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_reduceActionActivation_Attribute_currentExecution = factory->createEReference_as_eStructuralFeatures_in_EClass(m_reduceActionActivation_Class, REDUCEACTIONACTIVATION_ATTRIBUTE_CURRENTEXECUTION);
...
void ActionsPackageImpl::createRemoveStructuralFeatureValueActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_removeStructuralFeatureValueActivation_Attribute_removeStructuralFeatureValueAction = factory->createEReference_as_eStructuralFeatures_in_EClass(m_removeStructuralFeatureValueActivation_Class, REMOVESTRUCTURALFEATUREVALUEACTIVATION_ATTRIBUTE_REMOVESTRUCTURALFEATUREVALUEACTION);
...
void ActionsPackageImpl::createReturnInformationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_returnInformation_Attribute_callEventOccurrence = factory->createEReference_as_eStructuralFeatures_in_EClass(m_returnInformation_Class, RETURNINFORMATION_ATTRIBUTE_CALLEVENTOCCURRENCE);
	...
	m_returnInformation_Operation_equals_Value = factory->createEOperation_as_eOperations_in_EClass(m_returnInformation_Class, RETURNINFORMATION_OPERATION_EQUALS_VALUE);
...
void ActionsPackageImpl::createStructuralFeatureActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_structuralFeatureActionActivation_Operation_getMatchingLinks_Association_Value = factory->createEOperation_as_eOperations_in_EClass(m_structuralFeatureActionActivation_Class, STRUCTURALFEATUREACTIONACTIVATION_OPERATION_GETMATCHINGLINKS_ASSOCIATION_VALUE);
	m_structuralFeatureActionActivation_Operation_getMatchingLinksForEndValue_Association_Value = factory->createEOperation_as_eOperations_in_EClass(m_structuralFeatureActionActivation_Class, STRUCTURALFEATUREACTIONACTIVATION_OPERATION_GETMATCHINGLINKSFORENDVALUE_ASSOCIATION_VALUE);
...
void ActionsPackageImpl::createStructuredActivityNodeActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_structuredActivityNodeActivation_Attribute_activationGroup = factory->createEReference_as_eStructuralFeatures_in_EClass(m_structuredActivityNodeActivation_Class, STRUCTUREDACTIVITYNODEACTIVATION_ATTRIBUTE_ACTIVATIONGROUP);
	...
	m_structuredActivityNodeActivation_Operation_putPinValues_OutputPin_Value = factory->createEOperation_as_eOperations_in_EClass(m_structuredActivityNodeActivation_Class, STRUCTUREDACTIVITYNODEACTIVATION_OPERATION_PUTPINVALUES_OUTPUTPIN_VALUE);
...
void ActionsPackageImpl::createValuesContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_values_Attribute_values = factory->createEReference_as_eStructuralFeatures_in_EClass(m_values_Class, VALUES_ATTRIBUTE_VALUES);
...
void ActionsPackageImpl::createWriteStructuralFeatureActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_writeStructuralFeatureActionActivation_Operation_position_Value_EInt = factory->createEOperation_as_eOperations_in_EClass(m_writeStructuralFeatureActionActivation_Class, WRITESTRUCTURALFEATUREACTIONACTIVATION_OPERATION_POSITION_VALUE_EINT);
