...
bool ArgumentImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::ARGUMENT_ATTRIBUTE_NAME:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ArgumentImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
