...
// Union Getter
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::Feature>>> ActorImpl::getFeature() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> ActorImpl::getOwnedMember() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> ActorImpl::getRedefinedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> ActorImpl::getMember() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> ActorImpl::getOwnedElement() const
{
