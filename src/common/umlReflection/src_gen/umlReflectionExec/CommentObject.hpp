...
#ifndef UML_COMMENT_EXECUTION_HPP
#define UML_COMMENT_EXECUTION_HPP
...
namespace UML 
{
	class CommentObject : virtual public UML::ElementObject
	{
		public:
		    //constructors
		    CommentObject(CommentObject &obj);
		    CommentObject(std::shared_ptr<uml::Comment>);
		 	CommentObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::Comment> getCommentValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setCommentValue(std::shared_ptr<uml::Comment>);
			virtual void setThisCommentObjectPtr(std::weak_ptr<CommentObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Comment> m_CommentValue = nullptr;
	};
}
#endif /* end of include guard: UML_COMMENT_OBJECT_HPP */
