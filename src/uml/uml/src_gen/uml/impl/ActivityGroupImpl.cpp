...
bool ActivityGroupImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::ACTIVITYGROUP_ATTRIBUTE_INACTIVITY:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ActivityGroupImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
