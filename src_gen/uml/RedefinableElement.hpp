...
namespace uml 
{
	...
	class RedefinableElement:virtual public NamedElement	{
		...
		protected:
			...
			<p>From package UML::Classification.</p> */
			std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> m_redefinedElement;
			/*!
			 The contexts that this element may be redefined from.
			<p>From package UML::Classification.</p> */
			std::shared_ptr<std::vector<std::shared_ptr<uml::Classifier>>> m_redefinitionContext;
