...
bool TestIdentityActionImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::TESTIDENTITYACTION_ATTRIBUTE_FIRST:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> TestIdentityActionImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
  	...
  	switch(operationID)
	{
		...
		case umlPackage::TESTIDENTITYACTION_OPERATION_RESULT_IS_BOOLEAN_EDIAGNOSTICCHAIN_EMAP:
		{
			...
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for parameter 'diagnostics'. Failed to invoke operation 'result_is_boolean'!")
				return nullptr;
			}
			...
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for parameter 'context'. Failed to invoke operation 'result_is_boolean'!")
				return nullptr;
			}
