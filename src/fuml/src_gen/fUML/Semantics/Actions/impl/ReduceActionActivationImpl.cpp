...
ReduceActionActivationImpl& ReduceActionActivationImpl::operator=(const ReduceActionActivationImpl & obj)
{
	 ...
	 * Currently, this causes an error because it calls an implicit assignment operator of ReduceActionActivation 
	 * which is generated by the compiler (as ReduceActionActivation is an abstract class and does not have a user-defined assignment operator).
...
Any ReduceActionActivationImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	...
	{
		case fUML::Semantics::Actions::ActionsPackage::REDUCEACTIONACTIVATION_ATTRIBUTE_CURRENTEXECUTION:
			return eAny(getCurrentExecution(),fUML::Semantics::CommonBehavior::CommonBehaviorPackage::EXECUTION_CLASS,false); //9811
	}
