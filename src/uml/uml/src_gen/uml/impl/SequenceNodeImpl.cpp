...
bool SequenceNodeImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::SEQUENCENODE_ATTRIBUTE_EXECUTABLENODE:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> SequenceNodeImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
