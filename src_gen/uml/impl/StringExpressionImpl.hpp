...
namespace uml 
{
	class StringExpressionImpl :virtual public ExpressionImpl, virtual public TemplateableElementImpl, virtual public StringExpression
	{
		...
		public:
			...
			virtual uml::StringExpression *  getOwningExpression() const ;
			
			/*!
			 The StringExpression of which this StringExpression is a subExpression.
			<p>From package UML::Values.</p> */
			virtual void setOwningExpression(uml::StringExpression *  _owningExpression) ;
			
			/*!
			 The StringExpressions that constitute this StringExpression.
			<p>From package UML::Values.</p> */
			virtual std::vector<uml::StringExpression * > *  getSubExpression() const ;
