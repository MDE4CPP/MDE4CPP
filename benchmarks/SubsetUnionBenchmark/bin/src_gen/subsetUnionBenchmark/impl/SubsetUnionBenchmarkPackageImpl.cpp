...
// Begin Class ExampleModel
std::shared_ptr<ecore::EClass> SubsetUnionBenchmarkPackageImpl::getExampleModel() const
{
	return exampleModelEClass;
}

std::shared_ptr<ecore::EReference> SubsetUnionBenchmarkPackageImpl::getExampleModel_Container() const
{
