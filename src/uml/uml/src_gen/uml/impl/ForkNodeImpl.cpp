...
ForkNodeImpl& ForkNodeImpl::operator=(const ForkNodeImpl & obj)
{
	 ...
	 * Currently, this causes an error because it calls an implicit assignment operator of ForkNode 
	 * which is generated by the compiler (as ForkNode is an abstract class and does not have a user-defined assignment operator).
...
// Operations
//*********************************
bool ForkNodeImpl::edges(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < Any, Any>> context)
{
	throw std::runtime_error("UnsupportedOperationException: " + std::string(__PRETTY_FUNCTION__));
}

bool ForkNodeImpl::one_incoming_edge(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < Any, Any>> context)
{
	throw std::runtime_error("UnsupportedOperationException: " + std::string(__PRETTY_FUNCTION__));
}
...
//*********************************
std::shared_ptr<Any> ForkNodeImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
	}
...
bool ForkNodeImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
	}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ForkNodeImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
	std::shared_ptr<Any> result;
 
  	switch(operationID)
	{
		// uml::ForkNode::edges(Any, std::map) : bool: 3696331862
		...
		// uml::ForkNode::one_incoming_edge(Any, std::map) : bool: 1554773991
		case umlPackage::FORKNODE_OPERATION_ONE_INCOMING_EDGE_EDIAGNOSTICCHAIN_EMAP:
		{
			...
			{
				DEBUG_MESSAGE(std::cout << __PRETTY_FUNCTION__ << " : Invalid type stored in 'Any' for parameter 'diagnostics'. Failed to invoke operation 'one_incoming_edge'!"<< std::endl;)
				return nullptr;
			}
			...
			{
				DEBUG_MESSAGE(std::cout << __PRETTY_FUNCTION__ << " : Invalid type stored in 'Any' for parameter 'context'. Failed to invoke operation 'one_incoming_edge'!"<< std::endl;)
				return nullptr;
			}
			
		
			result = eAny(this->one_incoming_edge(incoming_param_diagnostics,incoming_param_context),0,false);
			break;
		}
