...
namespace uml 
{
	...
	class Collaboration:virtual public BehavioredClassifier,virtual public StructuredClassifier	{
		...
		public:
			...
			<p>From package UML::StructuredClassifiers.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::ConnectableElement>>> getCollaborationRole() const = 0;
		...
		protected:
			...
			/*!
			 Represents the participants in the Collaboration.
			<p>From package UML::StructuredClassifiers.</p> */
			std::shared_ptr<std::vector<std::shared_ptr<uml::ConnectableElement>>> m_collaborationRole;
