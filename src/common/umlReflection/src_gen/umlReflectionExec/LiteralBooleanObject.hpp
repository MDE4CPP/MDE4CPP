...
#ifndef UML_LITERALBOOLEAN_EXECUTION_HPP
#define UML_LITERALBOOLEAN_EXECUTION_HPP
...
namespace UML 
{
	class LiteralBooleanObject : virtual public UML::LiteralSpecificationObject
	{
		public:
		    //constructors
		    LiteralBooleanObject(LiteralBooleanObject &obj);
		    LiteralBooleanObject(std::shared_ptr<uml::LiteralBoolean>);
		 	LiteralBooleanObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::LiteralBoolean> getLiteralBooleanValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setLiteralBooleanValue(std::shared_ptr<uml::LiteralBoolean>);
			virtual void setThisLiteralBooleanObjectPtr(std::weak_ptr<LiteralBooleanObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::LiteralBoolean> m_LiteralBooleanValue = nullptr;
	};
}
#endif /* end of include guard: UML_LITERALBOOLEAN_OBJECT_HPP */
