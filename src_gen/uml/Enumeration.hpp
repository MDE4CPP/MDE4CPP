...
namespace uml 
{
	...
	class Enumeration:virtual public DataType	{
		...
		public:
			...
			<p>From package UML::SimpleClassifiers.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::EnumerationLiteral>>> getOwnedLiteral() const = 0;
		...
		protected:
			...
			/*!
			 The ordered set of literals owned by this Enumeration.
			<p>From package UML::SimpleClassifiers.</p> */
			std::shared_ptr<std::vector<std::shared_ptr<uml::EnumerationLiteral>>> m_ownedLiteral;
