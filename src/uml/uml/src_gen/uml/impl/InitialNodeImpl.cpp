...
InitialNodeImpl& InitialNodeImpl::operator=(const InitialNodeImpl & obj)
{
	 ...
	 * Currently, this causes an error because it calls an implicit assignment operator of InitialNode 
	 * which is generated by the compiler (as InitialNode is an abstract class and does not have a user-defined assignment operator).
...
//*********************************
std::shared_ptr<Any> InitialNodeImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
	}
...
bool InitialNodeImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
	}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> InitialNodeImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
  	...
  	switch(operationID)
	{
		...
		case umlPackage::INITIALNODE_OPERATION_CONTROL_EDGES_EDIAGNOSTICCHAIN_EMAP:
		{
			...
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for parameter 'diagnostics'. Failed to invoke operation 'control_edges'!")
				return nullptr;
			}
			...
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for parameter 'context'. Failed to invoke operation 'control_edges'!")
				return nullptr;
			}
