...
ecore::EClass* FlowFinalNodeImpl::eStaticClass() const
{
...
// Union Getter
//*********************************
std::vector<uml::ActivityGroup * > *  FlowFinalNodeImpl::getInGroup() const
{
...
uml::Element *  FlowFinalNodeImpl::getOwner() const
{
...
std::vector<uml::Element * > *  FlowFinalNodeImpl::getOwnedElement() const
{
...
std::vector<uml::RedefinableElement * > *  FlowFinalNodeImpl::getRedefinedElement() const
{
