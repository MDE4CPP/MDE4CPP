...
// Operations
//*********************************
bool ReadStructuralFeatureActionImpl::type_and_ordering(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < std::shared_ptr<Any>, std::shared_ptr<Any>>> context)
{
...
bool ReadStructuralFeatureActionImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::READSTRUCTURALFEATUREACTION_ATTRIBUTE_RESULT:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ReadStructuralFeatureActionImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
	std::shared_ptr<Any> result;
 
  	switch(operationID)
	{
		// uml::ReadStructuralFeatureAction::type_and_ordering(std::shared_ptr<Any>, std::map) : bool: 3161604835
