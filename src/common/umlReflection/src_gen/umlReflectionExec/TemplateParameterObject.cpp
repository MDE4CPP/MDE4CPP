...
{	
	if(m_TemplateParameterValue)
	{

	}

	m_TemplateParameterValue.reset();

	fUML::Semantics::StructuredClassifiers::ObjectImpl::destroy();
}

std::shared_ptr<uml::Element> TemplateParameterObject::getUmlValue() const
{
	return getTemplateParameterValue();
}

std::shared_ptr<uml::TemplateParameter> TemplateParameterObject::getTemplateParameterValue() const
{
	return m_TemplateParameterValue;
}

void TemplateParameterObject::setUmlValue(std::shared_ptr<uml::Element> _element)
{
	setTemplateParameterValue(std::dynamic_pointer_cast<uml::TemplateParameter>(_element));
}

void TemplateParameterObject::setTemplateParameterValue(std::shared_ptr<uml::TemplateParameter> _TemplateParameterElement)
{
	m_TemplateParameterValue = _TemplateParameterElement;
	//set super type values
	UML::ElementObject::setElementValue(_TemplateParameterElement);
}

void TemplateParameterObject::setThisTemplateParameterObjectPtr(std::weak_ptr<TemplateParameterObject> thisObjectPtr)
{
	setThisCS_ObjectPtr(thisObjectPtr);
}

bool TemplateParameterObject::equals(std::shared_ptr<fUML::Semantics::Values::Value> otherValue)
{
	bool isEqual = false;
	
	std::shared_ptr<TemplateParameterObject> otherTemplateParameterObject = std::dynamic_pointer_cast<TemplateParameterObject>(otherValue);

	if(otherTemplateParameterObject != nullptr)
	{
		if(this->getTemplateParameterValue() == otherTemplateParameterObject->getTemplateParameterValue())
		{
			isEqual = true;
		}
	}
...
std::string TemplateParameterObject::toString()
{
	std::string buffer = "Instance of 'TemplateParameterObject', " + std::to_string(getTypes()->size()) + " types (";
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Object>> TemplateParameterObject::getDirectContainers()
{   
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Link>> TemplateParameterObject::getLinks(std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_InteractionPoint> interactionPoint)
{
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> TemplateParameterObject::retrieveEndValueAsInteractionPoint(std::shared_ptr<fUML::Semantics::Values::Value> endValue, std::shared_ptr<uml::ConnectorEnd> end)
{
	return nullptr;
}

void TemplateParameterObject::removeValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<fUML::Semantics::Values::Value> value)
{
	...
	if (m_TemplateParameterValue == nullptr)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": no value stored inside TemplateParameterObject (property: " << feature->getName() << ")" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		...
		{
			m_TemplateParameterValue->getOwnedComment()->clear();
		}
		else
		{
			...
			{
				m_TemplateParameterValue->getOwnedComment()->erase(inputValue->getCommentValue());
			}
		}
	}
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> TemplateParameterObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	if (feature->getMetaElementID() != uml::UmlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::UmlPackage::PORT_CLASS && feature->getMetaElementID() != uml::UmlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Bag<uml::Comment>> ownedCommentList = m_TemplateParameterValue->getOwnedComment();
	...
	{
		std::shared_ptr<Bag<uml::Element>> ownedElementList = m_TemplateParameterValue->getOwnedElement();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_owner())
	{
		...
		value->setThisElementObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setElementValue(m_TemplateParameterValue->getOwner().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateParameter_default())
	{
		...
		value->setLocus(this->getLocus());
		value->setParameterableElementValue(m_TemplateParameterValue->getDefault());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateParameter_ownedDefault())
	{
		...
		value->setThisParameterableElementObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setParameterableElementValue(m_TemplateParameterValue->getOwnedDefault());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateParameter_ownedParameteredElement())
	{
		...
		value->setThisParameterableElementObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setParameterableElementValue(m_TemplateParameterValue->getOwnedParameteredElement());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateParameter_parameteredElement())
	{
		...
		value->setThisParameterableElementObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setParameterableElementValue(m_TemplateParameterValue->getParameteredElement());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateParameter_signature())
	{
		...
		value->setLocus(this->getLocus());
		value->setTemplateSignatureValue(m_TemplateParameterValue->getSignature().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
...
std::shared_ptr<fUML::Semantics::SimpleClassifiers::FeatureValue> TemplateParameterObject::retrieveFeatureValue(std::shared_ptr<uml::StructuralFeature> feature)
{
...
void TemplateParameterObject::setFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	if (feature->getMetaElementID() != uml::UmlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::UmlPackage::PORT_CLASS && feature->getMetaElementID() != uml::UmlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_TemplateParameterValue->getOwnedComment()->push_back(value->getCommentValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateParameter_default())
	{
		...
		if (value != nullptr)
		{
			m_TemplateParameterValue->setDefault(value->getParameterableElementValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateParameter_ownedDefault())
	{
		...
		if (value != nullptr)
		{
			m_TemplateParameterValue->setOwnedDefault(value->getParameterableElementValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateParameter_ownedParameteredElement())
	{
		...
		if (value != nullptr)
		{
			m_TemplateParameterValue->setOwnedParameteredElement(value->getParameterableElementValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateParameter_parameteredElement())
	{
		...
		if (value != nullptr)
		{
			m_TemplateParameterValue->setParameteredElement(value->getParameterableElementValue());
		}
		
	}
}

void TemplateParameterObject::assignFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	this->setFeatureValue(feature, values, position);
}

std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> TemplateParameterObject::retrieveFeatureValues()
{
	...
	for(unsigned int i = 0; i < allAttributesSize; i++)
	{
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment() && m_TemplateParameterValue->getOwnedComment() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedElement() && m_TemplateParameterValue->getOwnedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_owner() && m_TemplateParameterValue->getOwner().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_TemplateParameter_default() && m_TemplateParameterValue->getDefault() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_TemplateParameter_ownedDefault() && m_TemplateParameterValue->getOwnedDefault() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_TemplateParameter_ownedParameteredElement() && m_TemplateParameterValue->getOwnedParameteredElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_TemplateParameter_parameteredElement() && m_TemplateParameterValue->getParameteredElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_TemplateParameter_signature() && m_TemplateParameterValue->getSignature().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
	}
