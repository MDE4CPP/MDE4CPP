...
#ifndef UML_FLOWFINALNODE_EXECUTION_HPP
#define UML_FLOWFINALNODE_EXECUTION_HPP
...
namespace UML 
{
	class FlowFinalNodeObject : virtual public UML::FinalNodeObject
	{
		public:
		    //constructors
		    FlowFinalNodeObject(FlowFinalNodeObject &obj);
		    FlowFinalNodeObject(std::shared_ptr<uml::FlowFinalNode>);
		 	FlowFinalNodeObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::FlowFinalNode> getFlowFinalNodeValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setFlowFinalNodeValue(std::shared_ptr<uml::FlowFinalNode>);
			virtual void setThisFlowFinalNodeObjectPtr(std::weak_ptr<FlowFinalNodeObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::FlowFinalNode> m_FlowFinalNodeValue = nullptr;
	};
}
#endif /* end of include guard: UML_FLOWFINALNODE_OBJECT_HPP */
