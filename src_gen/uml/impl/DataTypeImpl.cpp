...
std::shared_ptr<uml::Operation>  DataTypeImpl::createOwnedOperation(std::string name,std::shared_ptr<std::vector<std::shared_ptr<std::string>>>  parameterNames,std::shared_ptr<std::vector<std::shared_ptr<uml::Type>>>  parameterTypes,std::shared_ptr<uml::Type>  returnType) 
{
	std::cout << __PRETTY_FUNCTION__  << std::endl;
	throw "UnsupportedOperationException";
}
...
// References
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::Property>>> DataTypeImpl::getOwnedAttribute() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Operation>>> DataTypeImpl::getOwnedOperation() const
{
...
// Union Getter
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> DataTypeImpl::getOwnedMember() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Feature>>> DataTypeImpl::getFeature() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> DataTypeImpl::getMember() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> DataTypeImpl::getRedefinedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> DataTypeImpl::getOwnedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Property>>> DataTypeImpl::getAttribute() const
{
