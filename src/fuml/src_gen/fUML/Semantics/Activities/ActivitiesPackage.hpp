	...
	*/
	...
	class FUML_API ActivitiesPackage : virtual public ecore::EPackage 
	{
		...
		public:
			...
			virtual const std::shared_ptr<ecore::EOperation>& getActivityNodeActivation_Operation_initialize_ActivityNode_ActivityNodeActivationGroup() const = 0;
			...
			//Class and Feature Getter
			virtual const std::shared_ptr<ecore::EClass>& getClassifierBehaviorExecutionActivity_Class() const = 0;
			...
			//Class and Feature Getter
			virtual const std::shared_ptr<ecore::EClass>& getClassifierBehaviorExecutionActivity_OwnedBehaviorActivity1_Class() const = 0;
			...
			virtual const std::shared_ptr<ecore::EReference>& getDecisionNodeActivation_Attribute_decisionInputExecution() const = 0;
			virtual const std::shared_ptr<ecore::EReference>& getDecisionNodeActivation_Attribute_decisionNode() const = 0;
			
			virtual const std::shared_ptr<ecore::EOperation>& getDecisionNodeActivation_Operation_executeDecisionInputBehavior_Value_Value() const = 0;
			...
			virtual const std::shared_ptr<ecore::EOperation>& getDecisionNodeActivation_Operation_terminate() const = 0;
			virtual const std::shared_ptr<ecore::EOperation>& getDecisionNodeActivation_Operation_test_ValueSpecification_Value() const = 0;
			...
			virtual const std::shared_ptr<ecore::EReference>& getObjectToken_Attribute_value() const = 0;
			...
			virtual const std::shared_ptr<ecore::EOperation>& getOffer_Operation_countOfferedVales() const = 0;
