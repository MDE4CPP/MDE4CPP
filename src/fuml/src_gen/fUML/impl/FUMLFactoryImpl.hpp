...
namespace fUML 
{
	class FUMLFactoryImpl : virtual public ecore::EFactoryImpl , virtual public FUMLFactory 
	{
		...
		public:
			...
			virtual std::shared_ptr<ExecutionFactory> createExecutionFactory(const int metaElementID=-1) const ;
			//Add containing object
			virtual std::shared_ptr<ExecutionFactory> createExecutionFactory_in_Locus(std::weak_ptr<fUML::Locus > par_locus, const int metaElementID=-1) const ;
