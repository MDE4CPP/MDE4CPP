...
bool InvOrDefExpImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::INVORDEFEXP_ATTRIBUTE_KIND:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> InvOrDefExpImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
