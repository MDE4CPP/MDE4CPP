...
bool OperationContextDeclExpImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::OPERATIONCONTEXTDECLEXP_ATTRIBUTE_OPERATIONCONTEXT:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> OperationContextDeclExpImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
