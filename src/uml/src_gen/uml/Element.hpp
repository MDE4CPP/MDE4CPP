	...
	class Element: virtual public Object
	{
		...
		public:
			...
			*/
			...
			virtual bool has_owner(Any diagnostics,std::shared_ptr<std::map < Any, Any>> context) = 0;/*!
			...
			*/
			...
			virtual bool not_own_self(Any diagnostics,std::shared_ptr<std::map < Any, Any>> context) = 0;/*!
