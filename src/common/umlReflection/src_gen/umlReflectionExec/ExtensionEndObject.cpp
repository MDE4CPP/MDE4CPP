...
ExtensionEndObject::ExtensionEndObject(std::shared_ptr<uml::ExtensionEnd> _element):

	m_ExtensionEndValue(_element)
{		
	this->getTypes()->insert(this->getTypes()->begin(), UML::UMLPackage::eInstance()->get_UML_ExtensionEnd());
}

ExtensionEndObject::ExtensionEndObject(ExtensionEndObject &obj):
	CS_ObjectImpl(obj)
{
	*this = obj;
}

ExtensionEndObject::ExtensionEndObject()
{	
	this->getTypes()->insert(this->getTypes()->begin(), UML::UMLPackage::eInstance()->get_UML_ExtensionEnd());
}
...
std::shared_ptr<ecore::EObject> ExtensionEndObject::copy()
{
	std::shared_ptr<ExtensionEndObject> element(new ExtensionEndObject(*this));
	element->setThisExtensionEndObjectPtr(element);
	return element;
}

ExtensionEndObject& ExtensionEndObject::operator=(const ExtensionEndObject & obj)
{
	return *this;
}


void ExtensionEndObject::destroy()
{	
	m_ExtensionEndValue.reset();

	fUML::Semantics::StructuredClassifiers::ObjectImpl::destroy();
}

std::shared_ptr<uml::Element> ExtensionEndObject::getUmlValue() const
{
	return getExtensionEndValue();
}

std::shared_ptr<uml::ExtensionEnd> ExtensionEndObject::getExtensionEndValue() const
{
	return m_ExtensionEndValue;
}

void ExtensionEndObject::setUmlValue(std::shared_ptr<uml::Element> _element)
{
	setExtensionEndValue(std::dynamic_pointer_cast<uml::ExtensionEnd>(_element));
}

void ExtensionEndObject::setExtensionEndValue(std::shared_ptr<uml::ExtensionEnd> _ExtensionEndElement)
{
	m_ExtensionEndValue = _ExtensionEndElement;
	//set super type values
	UML::PropertyObject::setPropertyValue(_ExtensionEndElement);
}

void ExtensionEndObject::setThisExtensionEndObjectPtr(std::weak_ptr<ExtensionEndObject> thisObjectPtr)
{
	setThisCS_ObjectPtr(thisObjectPtr);
}

bool ExtensionEndObject::equals(std::shared_ptr<fUML::Semantics::Values::Value> otherValue)
{
	bool isEqual = false;
	
	std::shared_ptr<ExtensionEndObject> otherExtensionEndObject = std::dynamic_pointer_cast<ExtensionEndObject>(otherValue);

	if(otherExtensionEndObject != nullptr)
	{
		if(this->getExtensionEndValue() == otherExtensionEndObject->getExtensionEndValue())
		{
			isEqual = true;
		}
	}
...
std::string ExtensionEndObject::toString()
{
	std::string buffer = "Instance of 'ExtensionEndObject', " + std::to_string(getTypes()->size()) + " types (";
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Object>> ExtensionEndObject::getDirectContainers()
{   
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Link>> ExtensionEndObject::getLinks(std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_InteractionPoint> interactionPoint)
{
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> ExtensionEndObject::retrieveEndValueAsInteractionPoint(std::shared_ptr<fUML::Semantics::Values::Value> endValue, std::shared_ptr<uml::ConnectorEnd> end)
{
	/*Not done for metamodel object classes*/
...
void ExtensionEndObject::removeValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<fUML::Semantics::Values::Value> value)
{
	...
	if (m_ExtensionEndValue == nullptr)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": no value stored inside ExtensionEndObject (property: " << feature->getName() << ")" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_DeploymentTarget_deployment())
	{
		...
		{
			m_ExtensionEndValue->getDeployment()->clear();
		}
		else
		{
			...
			{
				m_ExtensionEndValue->getDeployment()->erase(inputValue->getDeploymentValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		if (value == nullptr) // clear mode
		{
			m_ExtensionEndValue->getOwnedComment()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExtensionEndValue->getOwnedComment()->erase(inputValue->getCommentValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ExtensionEnd_lower())
	{
	...
	{
				m_ExtensionEndValue->setIsStatic(false /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_isOrdered())
	{
				m_ExtensionEndValue->setIsOrdered(false /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_isUnique())
	{
				m_ExtensionEndValue->setIsUnique(true /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_lower())
	{
				m_ExtensionEndValue->setLower(1 /*defined default value*/);
	...
	{
				m_ExtensionEndValue->setUpper(1 /*defined default value*/);
	...
	{
				m_ExtensionEndValue->setIsComposite(false /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isDerived())
	{
				m_ExtensionEndValue->setIsDerived(false /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isDerivedUnion())
	{
				m_ExtensionEndValue->setIsDerivedUnion(false /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isID())
	{
				m_ExtensionEndValue->setIsID(false /*defined default value*/);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_qualifier())
	{
		if (value == nullptr) // clear mode
		{
			m_ExtensionEndValue->getQualifier()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExtensionEndValue->getQualifier()->erase(inputValue->getPropertyValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_redefinedProperty())
	{
		if (value == nullptr) // clear mode
		{
			m_ExtensionEndValue->getRedefinedProperty()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExtensionEndValue->getRedefinedProperty()->erase(inputValue->getPropertyValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_subsettedProperty())
	{
		if (value == nullptr) // clear mode
		{
			m_ExtensionEndValue->getSubsettedProperty()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExtensionEndValue->getSubsettedProperty()->erase(inputValue->getPropertyValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_isLeaf())
	{
				m_ExtensionEndValue->setIsLeaf(false /*defined default value*/);
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> ExtensionEndObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	if (feature->getMetaElementID() != uml::umlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::umlPackage::PORT_CLASS && feature->getMetaElementID() != uml::umlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	{
		std::shared_ptr<Bag<uml::ConnectorEnd>> endList = m_ExtensionEndValue->getEnd();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ConnectableElement_templateParameter())
	{
		...
		value->setLocus(this->getLocus());
		value->setConnectableElementTemplateParameterValue(std::dynamic_pointer_cast<uml::ConnectableElementTemplateParameter>(m_ExtensionEndValue->getTemplateParameter()));
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<Bag<uml::PackageableElement>> deployedElementList = m_ExtensionEndValue->getDeployedElement();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_owner())
	{
		...
		value->setThisElementObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setElementValue(m_ExtensionEndValue->getOwner().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ExtensionEnd_lower())
	{
		...
		value->setValue(m_ExtensionEndValue->getLower());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ExtensionEnd_type())
	{
		...
		value->setLocus(this->getLocus());
		value->setStereotypeValue(std::dynamic_pointer_cast<uml::Stereotype>(m_ExtensionEndValue->getType()));
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Feature_isStatic())
	{
		...
		value->setValue(m_ExtensionEndValue->getIsStatic());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_isOrdered())
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_ExtensionEndValue->getIsOrdered());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_isUnique())
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_ExtensionEndValue->getIsUnique());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_lower())
	{
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_lowerValue())
	{
		...
		value->setLocus(this->getLocus());
		value->setValueSpecificationValue(m_ExtensionEndValue->getLowerValue());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_upper())
	{
		...
		value->setValue(m_ExtensionEndValue->getUpper());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_upperValue())
	{
		...
		value->setThisValueSpecificationObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setValueSpecificationValue(m_ExtensionEndValue->getUpperValue());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	{
		std::shared_ptr<Bag<uml::Dependency>> clientDependencyList = m_ExtensionEndValue->getClientDependency();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		value->setValue(m_ExtensionEndValue->getName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		value->setLocus(this->getLocus());
		value->setStringExpressionValue(m_ExtensionEndValue->getNameExpression());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace())
	{
		...
		value->setLocus(this->getLocus());
		value->setNamespaceValue(m_ExtensionEndValue->getNamespace().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::StringValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createStringValue();
		value->setValue(m_ExtensionEndValue->getQualifiedName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		uml::VisibilityKind visibility = m_ExtensionEndValue->getVisibility();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_owningTemplateParameter())
	{
		...
		value->setLocus(this->getLocus());
		value->setTemplateParameterValue(m_ExtensionEndValue->getOwningTemplateParameter().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_association())
	{
		...
		value->setLocus(this->getLocus());
		value->setAssociationValue(m_ExtensionEndValue->getAssociation());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_associationEnd())
	{
		...
		value->setLocus(this->getLocus());
		value->setPropertyValue(m_ExtensionEndValue->getAssociationEnd().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_class())
	{
		...
		value->setLocus(this->getLocus());
		value->setClassValue(m_ExtensionEndValue->getClass().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_datatype())
	{
		...
		value->setLocus(this->getLocus());
		value->setDataTypeValue(m_ExtensionEndValue->getDatatype().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::StringValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createStringValue();
		value->setValue(m_ExtensionEndValue->getDefault());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_defaultValue())
	{
		...
		value->setThisValueSpecificationObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setValueSpecificationValue(m_ExtensionEndValue->getDefaultValue());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_interface())
	{
		...
		value->setLocus(this->getLocus());
		value->setInterfaceValue(m_ExtensionEndValue->getInterface().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_ExtensionEndValue->getIsComposite());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isDerived())
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_ExtensionEndValue->getIsDerived());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isDerivedUnion())
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_ExtensionEndValue->getIsDerivedUnion());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isID())
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_ExtensionEndValue->getIsID());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_opposite())
	{
		...
		value->setThisPropertyObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setPropertyValue(m_ExtensionEndValue->getOpposite());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_owningAssociation())
	{
		...
		value->setThisAssociationObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setAssociationValue(m_ExtensionEndValue->getOwningAssociation().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_subsettedProperty())
	{
		std::shared_ptr<Bag<uml::Property>> subsettedPropertyList = m_ExtensionEndValue->getSubsettedProperty();
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_ExtensionEndValue->getIsLeaf());
		values->add(value);
	}
...
std::shared_ptr<fUML::Semantics::SimpleClassifiers::FeatureValue> ExtensionEndObject::retrieveFeatureValue(std::shared_ptr<uml::StructuralFeature> feature)
{
...
void ExtensionEndObject::setFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	if (feature->getMetaElementID() != uml::umlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::umlPackage::PORT_CLASS && feature->getMetaElementID() != uml::umlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ConnectableElement_templateParameter())
	{
		...
		if (value != nullptr)
		{
			m_ExtensionEndValue->setTemplateParameter(value->getConnectableElementTemplateParameterValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_DeploymentTarget_deployment())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExtensionEndValue->getDeployment()->push_back(value->getDeploymentValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExtensionEndValue->getOwnedComment()->push_back(value->getCommentValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ExtensionEnd_lower())
	{
		...
		{
			m_ExtensionEndValue->setLower(valueObject->getValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ExtensionEnd_type())
	{
		std::shared_ptr<fUML::Semantics::Values::Value> inputValue = values->at(0);
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = std::dynamic_pointer_cast<PSCS::Semantics::StructuredClassifiers::CS_Reference>(inputValue);
		std::shared_ptr<UML::StereotypeObject> value = std::dynamic_pointer_cast<UML::StereotypeObject>(reference->getReferent());
		if (value != nullptr)
		{
			m_ExtensionEndValue->setType(value->getStereotypeValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Feature_isStatic())
	{
		...
		if (valueObject != nullptr)
		{
			m_ExtensionEndValue->setIsStatic(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_isOrdered())
	{
		...
		if (valueObject != nullptr)
		{
			m_ExtensionEndValue->setIsOrdered(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_isUnique())
	{
		...
		if (valueObject != nullptr)
		{
			m_ExtensionEndValue->setIsUnique(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_lowerValue())
	{
		...
		if (value != nullptr)
		{
			m_ExtensionEndValue->setLowerValue(value->getValueSpecificationValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_upper())
	{
		...
		if (valueObject != nullptr)
		{
			m_ExtensionEndValue->setUpper(valueObject->getValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_upperValue())
	{
		...
		if (value != nullptr)
		{
			m_ExtensionEndValue->setUpperValue(value->getValueSpecificationValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		if (valueObject != nullptr)
		{
			m_ExtensionEndValue->setName(valueObject->getValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		if (value != nullptr)
		{
			m_ExtensionEndValue->setNameExpression(value->getStringExpressionValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		...
		{
			m_ExtensionEndValue->setVisibility(uml::VisibilityKind::PUBLIC);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_private())
		{
			m_ExtensionEndValue->setVisibility(uml::VisibilityKind::PRIVATE);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_protected())
		{
			m_ExtensionEndValue->setVisibility(uml::VisibilityKind::PROTECTED);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_package())
		{
			m_ExtensionEndValue->setVisibility(uml::VisibilityKind::PACKAGE);
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_aggregation())
	{
		...
		{
			m_ExtensionEndValue->setAggregation(uml::AggregationKind::NONE);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_AggregationKind_shared())
		{
			m_ExtensionEndValue->setAggregation(uml::AggregationKind::SHARED);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_AggregationKind_composite())
		{
			m_ExtensionEndValue->setAggregation(uml::AggregationKind::COMPOSITE);
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_association())
	{
		...
		if (value != nullptr)
		{
			m_ExtensionEndValue->setAssociation(value->getAssociationValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_default())
	{
		...
		if (valueObject != nullptr)
		{
			m_ExtensionEndValue->setDefault(valueObject->getValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_defaultValue())
	{
		...
		if (value != nullptr)
		{
			m_ExtensionEndValue->setDefaultValue(value->getValueSpecificationValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isComposite())
	{
		...
		if (valueObject != nullptr)
		{
			m_ExtensionEndValue->setIsComposite(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isDerived())
	{
		...
		if (valueObject != nullptr)
		{
			m_ExtensionEndValue->setIsDerived(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isDerivedUnion())
	{
		...
		if (valueObject != nullptr)
		{
			m_ExtensionEndValue->setIsDerivedUnion(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isID())
	{
		...
		if (valueObject != nullptr)
		{
			m_ExtensionEndValue->setIsID(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_opposite())
	{
		...
		if (value != nullptr)
		{
			m_ExtensionEndValue->setOpposite(value->getPropertyValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_qualifier())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExtensionEndValue->getQualifier()->push_back(value->getPropertyValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_redefinedProperty())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExtensionEndValue->getRedefinedProperty()->push_back(value->getPropertyValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_subsettedProperty())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExtensionEndValue->getSubsettedProperty()->push_back(value->getPropertyValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_isLeaf())
	{
		...
		if (valueObject != nullptr)
		{
			m_ExtensionEndValue->setIsLeaf(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_StructuralFeature_isReadOnly())
	{
		...
		if (valueObject != nullptr)
		{
			m_ExtensionEndValue->setIsReadOnly(valueObject->isValue());
		}
...
std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> ExtensionEndObject::retrieveFeatureValues()
{
	...
	for(unsigned int i = 0; i < allAttributesSize; i++)
	{
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_ConnectableElement_end() && m_ExtensionEndValue->getEnd() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ConnectableElement_templateParameter() && m_ExtensionEndValue->getTemplateParameter() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_DeploymentTarget_deployedElement() && m_ExtensionEndValue->getDeployedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_DeploymentTarget_deployment() && m_ExtensionEndValue->getDeployment() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment() && m_ExtensionEndValue->getOwnedComment() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedElement() && m_ExtensionEndValue->getOwnedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_owner() && m_ExtensionEndValue->getOwner().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ExtensionEnd_type() && m_ExtensionEndValue->getType() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Feature_featuringClassifier() && m_ExtensionEndValue->getFeaturingClassifier() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_lowerValue() && m_ExtensionEndValue->getLowerValue() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_upperValue() && m_ExtensionEndValue->getUpperValue() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_clientDependency() && m_ExtensionEndValue->getClientDependency() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression() && m_ExtensionEndValue->getNameExpression() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace() && m_ExtensionEndValue->getNamespace().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_owningTemplateParameter() && m_ExtensionEndValue->getOwningTemplateParameter().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_associationEnd() && m_ExtensionEndValue->getAssociationEnd().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_class() && m_ExtensionEndValue->getClass().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_datatype() && m_ExtensionEndValue->getDatatype().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_defaultValue() && m_ExtensionEndValue->getDefaultValue() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_interface() && m_ExtensionEndValue->getInterface().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_opposite() && m_ExtensionEndValue->getOpposite() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_owningAssociation() && m_ExtensionEndValue->getOwningAssociation().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_qualifier() && m_ExtensionEndValue->getQualifier() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_redefinedProperty() && m_ExtensionEndValue->getRedefinedProperty() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_subsettedProperty() && m_ExtensionEndValue->getSubsettedProperty() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_redefinedElement() && m_ExtensionEndValue->getRedefinedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
