...
bool CallExpImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::CALLEXP_ATTRIBUTE_SOURCE:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> CallExpImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
