...
namespace fUML::Semantics::Actions 
{
	class FUML_API ClearStructuralFeatureActionActivationImpl : virtual public StructuralFeatureActionActivationImpl, virtual public ClearStructuralFeatureActionActivation 
	{
		...
		public:
			...
			//*********************************
			virtual const std::shared_ptr<uml::ClearStructuralFeatureAction>& getClearStructuralFeatureAction() const ;
			virtual void setClearStructuralFeatureAction(const std::shared_ptr<uml::ClearStructuralFeatureAction>&) ;
