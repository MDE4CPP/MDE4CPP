...
StartClassifierBehaviorActionImpl& StartClassifierBehaviorActionImpl::operator=(const StartClassifierBehaviorActionImpl & obj)
{
	 ...
	 * Currently, this causes an error because it calls an implicit assignment operator of StartClassifierBehaviorAction 
	 * which is generated by the compiler (as StartClassifierBehaviorAction is an abstract class and does not have a user-defined assignment operator).
...
// Operations
//*********************************
bool StartClassifierBehaviorActionImpl::multiplicity(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < Any, Any>> context)
{
	throw std::runtime_error("UnsupportedOperationException: " + std::string(__PRETTY_FUNCTION__));
}

bool StartClassifierBehaviorActionImpl::type_has_classifier(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < Any, Any>> context)
{
	throw std::runtime_error("UnsupportedOperationException: " + std::string(__PRETTY_FUNCTION__));
}
...
//*********************************
std::shared_ptr<Any> StartClassifierBehaviorActionImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
		case uml::umlPackage::STARTCLASSIFIERBEHAVIORACTION_ATTRIBUTE_OBJECT:
			return eAny(getObject(),uml::umlPackage::INPUTPIN_CLASS,false); //21827
	}
...
std::shared_ptr<Any> StartClassifierBehaviorActionImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
	std::shared_ptr<Any> result;
  	...
  	switch(operationID)
	{
		// uml::StartClassifierBehaviorAction::multiplicity(Any, std::map) : bool: 1330965660
