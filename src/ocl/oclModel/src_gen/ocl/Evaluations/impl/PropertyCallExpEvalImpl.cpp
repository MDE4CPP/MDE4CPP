...
bool PropertyCallExpEvalImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case ocl::Evaluations::EvaluationsPackage::PROPERTYCALLEXPEVAL_ATTRIBUTE_SOURCE:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> PropertyCallExpEvalImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
