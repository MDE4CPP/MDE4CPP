...
namespace ocl::Expressions 
{
	class OCL_API MessageExpImpl : virtual public OclExpressionImpl, virtual public MessageExp 
	{
		...
		public:
			...
			virtual const std::shared_ptr<uml::CallOperationAction>& getCalledOperation() const ;
			virtual void setCalledOperation(const std::shared_ptr<uml::CallOperationAction>&) ;
			virtual const std::shared_ptr<uml::SendSignalAction>& getSentSignal() const ;
			virtual void setSentSignal(const std::shared_ptr<uml::SendSignalAction>&) ;
