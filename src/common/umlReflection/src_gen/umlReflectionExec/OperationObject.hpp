...
#ifndef UML_OPERATION_EXECUTION_HPP
#define UML_OPERATION_EXECUTION_HPP
...
namespace UML 
{
	class OperationObject : virtual public UML::BehavioralFeatureObject , virtual public UML::ParameterableElementObject , virtual public UML::TemplateableElementObject
	{
		public:
		    //constructors
		    OperationObject(OperationObject &obj);
		    OperationObject(std::shared_ptr<uml::Operation>);
		 	OperationObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::Operation> getOperationValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setOperationValue(std::shared_ptr<uml::Operation>);
			virtual void setThisOperationObjectPtr(std::weak_ptr<OperationObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Operation> m_OperationValue = nullptr;
	};
}
#endif /* end of include guard: UML_OPERATION_OBJECT_HPP */
