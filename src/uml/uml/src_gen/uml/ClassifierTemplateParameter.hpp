	...
	class UML_API ClassifierTemplateParameter: virtual public TemplateParameter
	{
		...
		public:
			...
			*/
			...
			virtual bool actual_is_classifier(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool constraining_classifiers_constrain_args(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool constraining_classifiers_constrain_parametered_element(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			If allowSubstitutable is true, then there must be a constrainingClassifier.
			allowSubstitutable implies constrainingClassifier->notEmpty()
			*/
			 
			virtual bool has_constraining_classifier(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool matching_abstract(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool parametered_element_no_features(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
