...
namespace uml 
{
	class ClauseImpl :virtual public ElementImpl, virtual public Clause 
	{
		...
		public:
			...
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::ExecutableNode>>> getBody() const ;
			...
			<p>From package UML::Actions.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Clause>>> getPredecessorClause() const ;
			
			/*!
			 A set of Clauses that may not evaluate their tests unless the test for this Clause evaluates to false.
			<p>From package UML::Actions.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Clause>>> getSuccessorClause() const ;
