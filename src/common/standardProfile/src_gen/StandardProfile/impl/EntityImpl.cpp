...
EntityImpl::EntityImpl()
{
	...
	*/
	...
	//getter init
		...
		m_getterMap.insert(std::pair<long long,std::function<Any()>>(1668028860,[this](){ return eAny(this->getBase_Component(), uml::umlPackage::COMPONENT_CLASS, false);}));
	
	
	//setter init
	//Property base_Component
		m_setterMap.insert(std::pair<long long,std::function<void(Any)>>(1668028860,[this](Any object){this->setBase_Component(object->get<std::shared_ptr<uml::Component>>());}));
	
	
	//unsetter init
		//Property base_Component
		m_unsetterMap.insert(std::pair<long long,std::function<void()>>(1668028860,[this](){m_base_Component = std::shared_ptr<uml::Component>(nullptr);}));
...
Any EntityImpl::get(long long _uID) const
{
...
void EntityImpl::set(std::string _qualifiedName, Any value)
{
	long long uID = util::Util::polynomialRollingHash(_qualifiedName);
    this->set(uID, value);
}

void EntityImpl::set(long long _uID, Any value)
{
...
void EntityImpl::unset(long long _uID)
{
...
//*********************************
//Invoke
Any EntityImpl::invoke(std::shared_ptr<uml::Operation> _operation, std::shared_ptr<Bag<Any>> _arguments)
{
...
Any EntityImpl::invoke(std::string _qualifiedName, std::shared_ptr<Bag<Any>> _arguments)
{
	long long uID = util::Util::polynomialRollingHash(_qualifiedName);
    return this->invoke(uID, _arguments);
}

Any EntityImpl::invoke(long long _uID, std::shared_ptr<Bag<Any>> _arguments)
{
