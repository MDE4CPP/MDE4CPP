	...
	class PSCS_API ActionsFactoryImpl : virtual public ecore::EFactoryImpl , virtual public ActionsFactory 
	{
		...
		public:
			...
			//Creator functions
			 ...
			 virtual std::shared_ptr<PSCS::Semantics::Actions::CS_AcceptCallActionActivation> createCS_AcceptCallActionActivation_as_nodeActivations_in_ActivityNodeActivationGroup(std::weak_ptr<fUML::Semantics::Activities::ActivityNodeActivationGroup> par_ActivityNodeActivationGroup, const int metaElementID = ActionsPackage::CS_ACCEPTCALLACTIONACTIVATION_CLASS) const ;
			 ...
			 //Add as contained object
			 virtual std::shared_ptr<PSCS::Semantics::Actions::CS_CallOperationActionActivation> createCS_CallOperationActionActivation_as_nodeActivations_in_ActivityNodeActivationGroup(std::weak_ptr<fUML::Semantics::Activities::ActivityNodeActivationGroup> par_ActivityNodeActivationGroup, const int metaElementID = ActionsPackage::CS_CALLOPERATIONACTIONACTIVATION_CLASS) const ;
			 ...
			 //Add as contained object
			 virtual std::shared_ptr<PSCS::Semantics::Actions::CS_ClearStructuralFeatureActionActivation> createCS_ClearStructuralFeatureActionActivation_as_nodeActivations_in_ActivityNodeActivationGroup(std::weak_ptr<fUML::Semantics::Activities::ActivityNodeActivationGroup> par_ActivityNodeActivationGroup, const int metaElementID = ActionsPackage::CS_CLEARSTRUCTURALFEATUREACTIONACTIVATION_CLASS) const ;
			 ...
			 //Add as contained object
			 virtual std::shared_ptr<PSCS::Semantics::Actions::CS_CreateLinkActionActivation> createCS_CreateLinkActionActivation_as_nodeActivations_in_ActivityNodeActivationGroup(std::weak_ptr<fUML::Semantics::Activities::ActivityNodeActivationGroup> par_ActivityNodeActivationGroup, const int metaElementID = ActionsPackage::CS_CREATELINKACTIONACTIVATION_CLASS) const ;
			 ...
			 //Add as contained object
			 virtual std::shared_ptr<PSCS::Semantics::Actions::CS_SendSignalActionActivation> createCS_SendSignalActionActivation_as_nodeActivations_in_ActivityNodeActivationGroup(std::weak_ptr<fUML::Semantics::Activities::ActivityNodeActivationGroup> par_ActivityNodeActivationGroup, const int metaElementID = ActionsPackage::CS_SENDSIGNALACTIONACTIVATION_CLASS) const ;
