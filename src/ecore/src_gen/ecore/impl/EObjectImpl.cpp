...
void EObjectImpl::saveContent(std::shared_ptr<persistence::interfaces::XSaveHandler> saveHandler) const
{
	try
	{
		...
		// Add attributes
		// TODO 'org.eclipse.emf.ecore.impl.EDataTypeImpl@4e4c3a38 (name: EInt) (instanceClassName: int) (serializable: true)' Attribute's eType is a EJavaClass or its eClass is not typeof EDataType
		//
