...
namespace uml 
{
	...
	class Interaction:virtual public Behavior,virtual public InteractionFragment	{
		...
		public:
			...
			<p>From package UML::Interactions.</p> */
			virtual std::vector<uml::Lifeline * > *  getLifeline() const = 0;
			...
			<p>From package UML::Interactions.</p> */
			virtual std::vector<uml::Action * > *  getAction() const = 0;
			
			/*!
			 Specifies the gates that form the message interface between this Interaction and any InteractionUses which reference it.
			<p>From package UML::Interactions.</p> */
			virtual std::vector<uml::Gate * > *  getFormalGate() const = 0;
			
			/*!
			 The Messages contained in this Interaction.
			<p>From package UML::Interactions.</p> */
			virtual std::vector<uml::Message * > *  getMessage() const = 0;
		...
		protected:
			...
			/*!
			 Specifies the participants in this Interaction.
			<p>From package UML::Interactions.</p> */
			std::vector<uml::Lifeline * > *  m_lifeline =  nullptr ;
			/*!
			 The ordered set of fragments in the Interaction.
			<p>From package UML::Interactions.</p> */
			...
			/*!
			 Actions owned by the Interaction.
			<p>From package UML::Interactions.</p> */
			std::vector<uml::Action * > *  m_action =  nullptr ;
			/*!
			 Specifies the gates that form the message interface between this Interaction and any InteractionUses which reference it.
			<p>From package UML::Interactions.</p> */
			std::vector<uml::Gate * > *  m_formalGate =  nullptr ;
			/*!
			 The Messages contained in this Interaction.
			<p>From package UML::Interactions.</p> */
			std::vector<uml::Message * > *  m_message =  nullptr ;
