...
bool VariableDeclEvalImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case ocl::Evaluations::EvaluationsPackage::VARIABLEDECLEVAL_ATTRIBUTE_INITEXP:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> VariableDeclEvalImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
