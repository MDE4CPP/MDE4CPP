...
bool OpaqueBehaviorImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::OPAQUEBEHAVIOR_ATTRIBUTE_BODY:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> OpaqueBehaviorImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
