...
//*********************************
bool
 AddVariableValueActionImpl::insertAt_pin(boost::any diagnostics,std::map <   boost::any, boost::any >  context) 
{
...
bool
 AddVariableValueActionImpl::required_value(boost::any diagnostics,std::map <   boost::any, boost::any >  context) 
{
	std::cout << __PRETTY_FUNCTION__  << std::endl;
	throw "UnsupportedOperationException";
}
		...
		std::shared_ptr<Union<uml::Element> > AddVariableValueActionImpl::getOwnedElement() const
{
 ...
 AddVariableValueActionImpl::getInput() const
{
	return m_input;
}
