...
namespace uml 
{
	...
	class InteractionOperand:virtual public InteractionFragment,virtual public Namespace	{
		...
		public:
			...
			virtual bool
			 guard_contain_references(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 guard_directly_prior(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
