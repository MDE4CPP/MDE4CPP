...
void DataTypeImpl::loadNode(std::string nodeName, std::shared_ptr<persistence::interfaces::XLoadHandler> loadHandler)
{
	...
	try
	{
		if ( nodeName.compare("ownedAttribute") == 0 )
		{
			...
			std::shared_ptr<uml::Property> new_ownedAttribute = std::dynamic_pointer_cast<uml::Property>(modelFactory->create(typeName, loadHandler->getCurrentObject(), uml::umlPackage::DATATYPE_ATTRIBUTE_OWNEDATTRIBUTE));
		...
		if ( nodeName.compare("ownedOperation") == 0 )
		{
			...
			std::shared_ptr<ecore::ecoreFactory> modelFactory = ecore::ecoreFactory::eInstance();		
			std::shared_ptr<uml::Operation> new_ownedOperation = std::dynamic_pointer_cast<uml::Operation>(modelFactory->create(typeName, loadHandler->getCurrentObject(), uml::umlPackage::DATATYPE_ATTRIBUTE_OWNEDOPERATION));
...
std::shared_ptr<Any> DataTypeImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
  	...
  	switch(operationID)
	{
		...
		case umlPackage::DATATYPE_OPERATION_CREATEOWNEDATTRIBUTE_STRING_TYPE_INTEGER_UNLIMITEDNATURAL:
		{
		...
		case umlPackage::DATATYPE_OPERATION_CREATEOWNEDOPERATION_STRING_STRING_TYPE_TYPE:
		{
			//Retrieve input parameter 'name'
			//parameter 0
			std::string incoming_param_name;
