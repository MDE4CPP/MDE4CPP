...
#ifndef UML_TEMPLATEPARAMETERSUBSTITUTION_EXECUTION_HPP
#define UML_TEMPLATEPARAMETERSUBSTITUTION_EXECUTION_HPP
...
namespace UML 
{
	class TemplateParameterSubstitutionObject : virtual public UML::ElementObject
	{
		public:
		    //constructors
		    TemplateParameterSubstitutionObject(TemplateParameterSubstitutionObject &obj);
		    TemplateParameterSubstitutionObject(std::shared_ptr<uml::TemplateParameterSubstitution>);
		 	TemplateParameterSubstitutionObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::TemplateParameterSubstitution> getTemplateParameterSubstitutionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setTemplateParameterSubstitutionValue(std::shared_ptr<uml::TemplateParameterSubstitution>);
			virtual void setThisTemplateParameterSubstitutionObjectPtr(std::weak_ptr<TemplateParameterSubstitutionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::TemplateParameterSubstitution> m_TemplateParameterSubstitutionValue = nullptr;
	};
}
#endif /* end of include guard: UML_TEMPLATEPARAMETERSUBSTITUTION_OBJECT_HPP */
