...
#ifndef UML_TESTIDENTITYACTION_EXECUTION_HPP
#define UML_TESTIDENTITYACTION_EXECUTION_HPP
...
namespace UML 
{
	class TestIdentityActionObject : virtual public UML::ActionObject
	{
		public:
		    //constructors
		    TestIdentityActionObject(TestIdentityActionObject &obj);
		    TestIdentityActionObject(std::shared_ptr<uml::TestIdentityAction>);
		 	TestIdentityActionObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::TestIdentityAction> getTestIdentityActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setTestIdentityActionValue(std::shared_ptr<uml::TestIdentityAction>);
			virtual void setThisTestIdentityActionObjectPtr(std::weak_ptr<TestIdentityActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::TestIdentityAction> m_TestIdentityActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_TESTIDENTITYACTION_OBJECT_HPP */
