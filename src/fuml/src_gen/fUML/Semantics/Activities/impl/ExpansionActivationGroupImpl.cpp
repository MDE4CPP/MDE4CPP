...
ExpansionActivationGroupImpl::ExpansionActivationGroupImpl(const ExpansionActivationGroupImpl & obj): ActivityNodeActivationGroupImpl(obj), ExpansionActivationGroup(obj)
{
