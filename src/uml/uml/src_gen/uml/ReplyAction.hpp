	...
	class UML_API ReplyAction: virtual public Action
	{
		...
		public:
			...
			*/
			...
			virtual bool event_on_reply_to_call_trigger(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool pins_match_parameter(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			...
			*/
			...
			virtual void setReplyToCall(const std::shared_ptr<uml::Trigger>&) = 0;
			/*!
			...
			*/
			...
			virtual void setReturnInformation(const std::shared_ptr<uml::InputPin>&) = 0;
