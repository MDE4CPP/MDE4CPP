...
namespace ocl::Values 
{
	class OCL_API OclMessageValueImpl : virtual public fUML::Semantics::Values::ValueImpl, virtual public OclMessageValue 
	{
		...
		public:
			...
			//*********************************
			virtual const std::shared_ptr<Bag<ocl::Values::NameValueBinding>>& getArguments() const ;
			virtual const std::shared_ptr<ocl::Values::OclMessageValue>& getReturnMessage() const ;
			virtual void setReturnMessage(const std::shared_ptr<ocl::Values::OclMessageValue>&) ;
			virtual const std::shared_ptr<ocl::Values::ObjectValue>& getSource() const ;
			virtual void setSource(const std::shared_ptr<ocl::Values::ObjectValue>&) ;
			virtual const std::shared_ptr<ocl::Values::ObjectValue>& getTarget() const ;
			virtual void setTarget(const std::shared_ptr<ocl::Values::ObjectValue>&) ;
