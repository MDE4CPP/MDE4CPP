...
void CommonBehaviorPackageImpl::createCallEventBehaviorContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_callEventBehavior_Attribute_operation = factory->createEReference_as_eReferences_in_EClass(m_callEventBehavior_Class, CALLEVENTBEHAVIOR_ATTRIBUTE_OPERATION);
...
void CommonBehaviorPackageImpl::createClassifierBehaviorInvocationEventAccepterContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_classifierBehaviorInvocationEventAccepter_Attribute_classifier = factory->createEReference_as_eReferences_in_EClass(m_classifierBehaviorInvocationEventAccepter_Class, CLASSIFIERBEHAVIORINVOCATIONEVENTACCEPTER_ATTRIBUTE_CLASSIFIER);
	m_classifierBehaviorInvocationEventAccepter_Attribute_execution = factory->createEReference_as_eReferences_in_EClass(m_classifierBehaviorInvocationEventAccepter_Class, CLASSIFIERBEHAVIORINVOCATIONEVENTACCEPTER_ATTRIBUTE_EXECUTION);
	m_classifierBehaviorInvocationEventAccepter_Attribute_objectActivation = factory->createEReference_as_eReferences_in_EClass(m_classifierBehaviorInvocationEventAccepter_Class, CLASSIFIERBEHAVIORINVOCATIONEVENTACCEPTER_ATTRIBUTE_OBJECTACTIVATION);
...
void CommonBehaviorPackageImpl::createInvocationEventOccurrenceContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_invocationEventOccurrence_Attribute_execution = factory->createEReference_as_eReferences_in_EClass(m_invocationEventOccurrence_Class, INVOCATIONEVENTOCCURRENCE_ATTRIBUTE_EXECUTION);
...
void CommonBehaviorPackageImpl::createObjectActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_objectActivation_Operation__send_EventOccurrence = factory->createEOperation_as_eOperations_in_EClass(m_objectActivation_Class, OBJECTACTIVATION_OPERATION__SEND_EVENTOCCURRENCE);
