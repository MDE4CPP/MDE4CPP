...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> StateObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Bag<uml::Comment>> ownedCommentList = m_StateValue->getOwnedComment();
	...
	{
		std::shared_ptr<Bag<uml::Element>> ownedElementList = m_StateValue->getOwnedElement();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_elementImport())
	{
		std::shared_ptr<Bag<uml::ElementImport>> elementImportList = m_StateValue->getElementImport();
	...
	{
		std::shared_ptr<Bag<uml::PackageableElement>> importedMemberList = m_StateValue->getImportedMember();
	...
	{
		std::shared_ptr<Bag<uml::NamedElement>> memberList = m_StateValue->getMember();
	...
	{
		std::shared_ptr<Bag<uml::NamedElement>> ownedMemberList = m_StateValue->getOwnedMember();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_ownedRule())
	{
		std::shared_ptr<Bag<uml::Constraint>> ownedRuleList = m_StateValue->getOwnedRule();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_packageImport())
	{
		std::shared_ptr<Bag<uml::PackageImport>> packageImportList = m_StateValue->getPackageImport();
	...
	{
		std::shared_ptr<Bag<uml::RedefinableElement>> redefinedElementList = m_StateValue->getRedefinedElement();
	...
	{
		std::shared_ptr<Bag<uml::Classifier>> redefinitionContextList = m_StateValue->getRedefinitionContext();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_State_connection())
	{
		std::shared_ptr<Bag<uml::ConnectionPointReference>> connectionList = m_StateValue->getConnection();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_State_connectionPoint())
	{
		std::shared_ptr<Bag<uml::Pseudostate>> connectionPointList = m_StateValue->getConnectionPoint();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_State_deferrableTrigger())
	{
		std::shared_ptr<Bag<uml::Trigger>> deferrableTriggerList = m_StateValue->getDeferrableTrigger();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_State_region())
	{
		std::shared_ptr<Bag<uml::Region>> regionList = m_StateValue->getRegion();
