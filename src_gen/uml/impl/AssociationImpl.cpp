...
AssociationImpl::AssociationImpl()
{
	...
	{
		m_endType = new std::vector<uml::Type * >();
	}
	if( m_memberEnd == nullptr)
	{
		m_memberEnd = new std::vector<uml::Property * >();
	}
	if( m_navigableOwnedEnd == nullptr)
	{
		m_navigableOwnedEnd = new std::vector<uml::Property * >();
	}
	if( m_ownedEnd == nullptr)
	{
		m_ownedEnd = new std::vector<uml::Property * >();
	}
}
...
AssociationImpl::~AssociationImpl()
{
	...
	if(m_navigableOwnedEnd!=nullptr)
	{
		delete(m_navigableOwnedEnd);
	 	m_navigableOwnedEnd = nullptr;
	}
...
ecore::EClass* AssociationImpl::eStaticClass() const
{
...
std::vector<uml::Type * > *  AssociationImpl::getEndTypes() 
{
	std::cout << __PRETTY_FUNCTION__  << std::endl;
	throw "UnsupportedOperationException";
}
...
// References
//*********************************
std::vector<uml::Type * > *  AssociationImpl::getEndType() const
{
	//assert(m_endType);
	return m_endType;
}
...
std::vector<uml::Property * > *  AssociationImpl::getMemberEnd() const
{
	//assert(m_memberEnd);
	return m_memberEnd;
}
...
std::vector<uml::Property * > *  AssociationImpl::getNavigableOwnedEnd() const
{
...
std::vector<uml::Property * > *  AssociationImpl::getOwnedEnd() const
{
...
// Union Getter
//*********************************
std::vector<uml::Element * > *  AssociationImpl::getOwnedElement() const
{
...
std::vector<uml::NamedElement * > *  AssociationImpl::getMember() const
{
...
uml::Element *  AssociationImpl::getOwner() const
{
...
std::vector<uml::RedefinableElement * > *  AssociationImpl::getRedefinedElement() const
{
...
std::vector<uml::NamedElement * > *  AssociationImpl::getOwnedMember() const
{
...
std::vector<uml::Element * > *  AssociationImpl::getRelatedElement() const
{
...
uml::Namespace *  AssociationImpl::getNamespace() const
{
...
std::vector<uml::Feature * > *  AssociationImpl::getFeature() const
{
