...
namespace uml 
{
	...
	class ElementImport:virtual public DirectedRelationship	{
		...
		public:
			...
			<p>From package UML::CommonStructure.</p> */
			virtual uml::PackageableElement *  getImportedElement() const = 0;
			
			/*!
			 Specifies the PackageableElement whose name is to be added to a Namespace.
			<p>From package UML::CommonStructure.</p> */
			virtual void setImportedElement(uml::PackageableElement *  _importedElement) = 0;
		...
		protected:
			...
			/*!
			 Specifies the PackageableElement whose name is to be added to a Namespace.
			<p>From package UML::CommonStructure.</p> */
			uml::PackageableElement *  m_importedElement =  nullptr ;
			/*!
			 Specifies the Namespace that imports a PackageableElement from another Namespace.
			<p>From package UML::CommonStructure.</p> */
