	...
	class UML_API ObjectNode: virtual public ActivityNode, virtual public TypedElement
	{
		...
		public:
			...
			*/
			...
			virtual bool input_output_parameter(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < std::shared_ptr<Any>, std::shared_ptr<Any>>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool object_flow_edges(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < std::shared_ptr<Any>, std::shared_ptr<Any>>> context) = 0;
			/*!
