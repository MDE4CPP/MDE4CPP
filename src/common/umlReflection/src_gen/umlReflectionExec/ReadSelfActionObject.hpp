...
#ifndef UML_READSELFACTION_EXECUTION_HPP
#define UML_READSELFACTION_EXECUTION_HPP
...
namespace UML 
{
	class ReadSelfActionObject : virtual public UML::ActionObject
	{
		public:
		    //constructors
		    ReadSelfActionObject(ReadSelfActionObject &obj);
		    ReadSelfActionObject(std::shared_ptr<uml::ReadSelfAction>);
		 	ReadSelfActionObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::ReadSelfAction> getReadSelfActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setReadSelfActionValue(std::shared_ptr<uml::ReadSelfAction>);
			virtual void setThisReadSelfActionObjectPtr(std::weak_ptr<ReadSelfActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ReadSelfAction> m_ReadSelfActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_READSELFACTION_OBJECT_HPP */
