...
#ifndef STANDARDPROFILE_CALL_HPP
#define STANDARDPROFILE_CALL_HPP
...
namespace StandardProfile 
{
	/*!
	 */
	class Call : virtual public ecore::EObject 
...
#endif /* end of include guard: STANDARDPROFILE_CALL_HPP */
