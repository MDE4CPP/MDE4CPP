...
#ifndef UML_ASSOCIATION_EXECUTION_HPP
#define UML_ASSOCIATION_EXECUTION_HPP
...
namespace UML 
{
	class AssociationObject : virtual public UML::ClassifierObject , virtual public UML::RelationshipObject
	{
		public:
		    //constructors
		    AssociationObject(AssociationObject &obj);
		    AssociationObject(std::shared_ptr<uml::Association>);
		 	AssociationObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::Association> getAssociationValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setAssociationValue(std::shared_ptr<uml::Association>);
			virtual void setThisAssociationObjectPtr(std::weak_ptr<AssociationObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Association> m_AssociationValue = nullptr;
	};
}
#endif /* end of include guard: UML_ASSOCIATION_OBJECT_HPP */
