...
#ifndef UML_RAISEEXCEPTIONACTION_EXECUTION_HPP
#define UML_RAISEEXCEPTIONACTION_EXECUTION_HPP
...
namespace UML 
{
	class RaiseExceptionActionObject : virtual public UML::ActionObject
	{
		public:
		    //constructors
		    RaiseExceptionActionObject(RaiseExceptionActionObject &obj);
		    RaiseExceptionActionObject(std::shared_ptr<uml::RaiseExceptionAction>);
		 	RaiseExceptionActionObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::RaiseExceptionAction> getRaiseExceptionActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setRaiseExceptionActionValue(std::shared_ptr<uml::RaiseExceptionAction>);
			virtual void setThisRaiseExceptionActionObjectPtr(std::weak_ptr<RaiseExceptionActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::RaiseExceptionAction> m_RaiseExceptionActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_RAISEEXCEPTIONACTION_OBJECT_HPP */
