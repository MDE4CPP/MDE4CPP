...
EntityImpl::EntityImpl()
{
	...
	*/
	...
	//getter init
		...
		m_getterMap.insert(std::pair<unsigned long,std::function<Any()>>(1668028860,[this](){ return eAny(this->getBase_Component(), uml::umlPackage::COMPONENT_CLASS, false);}));
	
	
	//setter init
	//Property base_Component
		m_setterMap.insert(std::pair<unsigned long,std::function<void(Any)>>(1668028860,[this](Any object){this->setBase_Component(object->get<std::shared_ptr<uml::Component>>());}));
	
	
	//unsetter init
		//Property base_Component
		m_unsetterMap.insert(std::pair<unsigned long,std::function<void()>>(1668028860,[this](){m_base_Component = std::shared_ptr<uml::Component>(nullptr);}));
...
//*********************************
//Get
Any EntityImpl::get(const std::shared_ptr<uml::Property>& _property) const
{
	std::string qualifiedName = _property->getQualifiedName();
    return this->get(qualifiedName);
}

Any EntityImpl::get(std::string _qualifiedName) const
{
	unsigned long uID = util::Util::polynomialRollingHash(_qualifiedName);
    return this->get(uID);
}

Any EntityImpl::get(unsigned long _uID) const
{
...
//Set
void EntityImpl::set(const std::shared_ptr<uml::Property>& _property, const Any& value)
{
	std::string qualifiedName = _property->getQualifiedName();
    this->set(qualifiedName, value);
}

void EntityImpl::set(std::string _qualifiedName, const Any& value)
{
	unsigned long uID = util::Util::polynomialRollingHash(_qualifiedName);
    this->set(uID, value);
}

void EntityImpl::set(unsigned long _uID, const Any& value)
{
...
//*********************************
//Invoke
Any EntityImpl::invoke(const std::shared_ptr<uml::Operation>& _operation, const std::shared_ptr<Bag<Any>>& _arguments)
{
...
Any EntityImpl::invoke(std::string _qualifiedName, const std::shared_ptr<Bag<Any>>& _arguments)
{
	unsigned long uID = util::Util::polynomialRollingHash(_qualifiedName);
    return this->invoke(uID, _arguments);
}

Any EntityImpl::invoke(unsigned long _uID, const std::shared_ptr<Bag<Any>>& _arguments)
{
