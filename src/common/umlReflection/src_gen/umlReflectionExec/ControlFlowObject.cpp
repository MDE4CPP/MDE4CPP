...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> ControlFlowObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	...
	{
		std::shared_ptr<Union<uml::ActivityGroup>> inGroupList = m_ControlFlowValue->getInGroup();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityEdge_inPartition())
	{
		std::shared_ptr<Subset<uml::ActivityPartition, uml::ActivityGroup>> inPartitionList = m_ControlFlowValue->getInPartition();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityEdge_redefinedEdge())
	{
		std::shared_ptr<Subset<uml::ActivityEdge, uml::RedefinableElement>> redefinedEdgeList = m_ControlFlowValue->getRedefinedEdge();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Subset<uml::Comment, uml::Element>> ownedCommentList = m_ControlFlowValue->getOwnedComment();
	...
	{
		std::shared_ptr<Union<uml::Element>> ownedElementList = m_ControlFlowValue->getOwnedElement();
	...
	{
		std::shared_ptr<Union<uml::RedefinableElement>> redefinedElementList = m_ControlFlowValue->getRedefinedElement();
	...
	{
		std::shared_ptr<Union<uml::Classifier>> redefinitionContextList = m_ControlFlowValue->getRedefinitionContext();
