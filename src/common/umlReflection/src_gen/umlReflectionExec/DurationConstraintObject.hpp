...
#ifndef UML_DURATIONCONSTRAINT_EXECUTION_HPP
#define UML_DURATIONCONSTRAINT_EXECUTION_HPP
...
namespace UML 
{
	class DurationConstraintObject : virtual public UML::IntervalConstraintObject
	{
		public:
		    //constructors
		    DurationConstraintObject(DurationConstraintObject &obj);
		    DurationConstraintObject(std::shared_ptr<uml::DurationConstraint>);
		 	DurationConstraintObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::DurationConstraint> getDurationConstraintValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setDurationConstraintValue(std::shared_ptr<uml::DurationConstraint>);
			virtual void setThisDurationConstraintObjectPtr(std::weak_ptr<DurationConstraintObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::DurationConstraint> m_DurationConstraintValue = nullptr;
	};
}
#endif /* end of include guard: UML_DURATIONCONSTRAINT_OBJECT_HPP */
