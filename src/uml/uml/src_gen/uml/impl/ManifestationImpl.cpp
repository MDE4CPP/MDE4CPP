...
bool ManifestationImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::MANIFESTATION_ATTRIBUTE_UTILIZEDELEMENT:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ManifestationImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
