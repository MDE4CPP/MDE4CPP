...
{	
	if(m_ReadStructuralFeatureActionValue)
	{
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> ReadStructuralFeatureActionObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	...
	{
		std::shared_ptr<Bag<uml::InputPin>> inputList = m_ReadStructuralFeatureActionValue->getInput();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Action_localPostcondition())
	{
		std::shared_ptr<Bag<uml::Constraint>> localPostconditionList = m_ReadStructuralFeatureActionValue->getLocalPostcondition();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Action_localPrecondition())
	{
		std::shared_ptr<Bag<uml::Constraint>> localPreconditionList = m_ReadStructuralFeatureActionValue->getLocalPrecondition();
	...
	{
		std::shared_ptr<Bag<uml::OutputPin>> outputList = m_ReadStructuralFeatureActionValue->getOutput();
	...
	{
		std::shared_ptr<Bag<uml::ActivityGroup>> inGroupList = m_ReadStructuralFeatureActionValue->getInGroup();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inInterruptibleRegion())
	{
		std::shared_ptr<Bag<uml::InterruptibleActivityRegion>> inInterruptibleRegionList = m_ReadStructuralFeatureActionValue->getInInterruptibleRegion();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inPartition())
	{
		std::shared_ptr<Bag<uml::ActivityPartition>> inPartitionList = m_ReadStructuralFeatureActionValue->getInPartition();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_redefinedNode())
	{
		std::shared_ptr<Bag<uml::ActivityNode>> redefinedNodeList = m_ReadStructuralFeatureActionValue->getRedefinedNode();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Bag<uml::Comment>> ownedCommentList = m_ReadStructuralFeatureActionValue->getOwnedComment();
	...
	{
		std::shared_ptr<Bag<uml::Element>> ownedElementList = m_ReadStructuralFeatureActionValue->getOwnedElement();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ExecutableNode_handler())
	{
		std::shared_ptr<Bag<uml::ExceptionHandler>> handlerList = m_ReadStructuralFeatureActionValue->getHandler();
	...
	{
		std::shared_ptr<Bag<uml::RedefinableElement>> redefinedElementList = m_ReadStructuralFeatureActionValue->getRedefinedElement();
	...
	{
		std::shared_ptr<Bag<uml::Classifier>> redefinitionContextList = m_ReadStructuralFeatureActionValue->getRedefinitionContext();
