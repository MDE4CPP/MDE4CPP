...
#ifndef UML_ADDSTRUCTURALFEATUREVALUEACTION_EXECUTION_HPP
#define UML_ADDSTRUCTURALFEATUREVALUEACTION_EXECUTION_HPP
...
namespace UML 
{
	class AddStructuralFeatureValueActionObject : virtual public UML::WriteStructuralFeatureActionObject
	{
		public:
		    //constructors
		    AddStructuralFeatureValueActionObject(AddStructuralFeatureValueActionObject &obj);
		    AddStructuralFeatureValueActionObject(std::shared_ptr<uml::AddStructuralFeatureValueAction>);
		 	AddStructuralFeatureValueActionObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::AddStructuralFeatureValueAction> getAddStructuralFeatureValueActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setAddStructuralFeatureValueActionValue(std::shared_ptr<uml::AddStructuralFeatureValueAction>);
			virtual void setThisAddStructuralFeatureValueActionObjectPtr(std::weak_ptr<AddStructuralFeatureValueActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::AddStructuralFeatureValueAction> m_AddStructuralFeatureValueActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_ADDSTRUCTURALFEATUREVALUEACTION_OBJECT_HPP */
