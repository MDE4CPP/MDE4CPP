...
#ifndef UML_TEMPLATEBINDING_EXECUTION_HPP
#define UML_TEMPLATEBINDING_EXECUTION_HPP
...
namespace UML 
{
	class TemplateBindingObject : virtual public UML::DirectedRelationshipObject
	{
		public:
		    //constructors
		    TemplateBindingObject(TemplateBindingObject &obj);
		    TemplateBindingObject(std::shared_ptr<uml::TemplateBinding>);
		 	TemplateBindingObject();
		    //destructor
		    virtual ~TemplateBindingObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			TemplateBindingObject& operator=(TemplateBindingObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::TemplateBinding> getTemplateBindingValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setTemplateBindingValue(std::shared_ptr<uml::TemplateBinding>);
			virtual void setThisTemplateBindingObjectPtr(std::weak_ptr<TemplateBindingObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::TemplateBinding> m_TemplateBindingValue = nullptr;
	};
}
#endif /* end of include guard: UML_TEMPLATEBINDING_OBJECT_HPP */
