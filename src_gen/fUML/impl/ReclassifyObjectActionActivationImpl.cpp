...
std::shared_ptr<ReclassifyObjectActionActivation> ReclassifyObjectActionActivationImpl::getThisReclassifyObjectActionActivationPtr()
{
	...
	{
		std::shared_ptr<Bag<fUML::ActivityNodeActivation>> ownersReclassifyObjectActionActivationList = wp->getNodeActivations();
		for (std::shared_ptr<fUML::ActivityNodeActivation> anReclassifyObjectActionActivation : *ownersReclassifyObjectActionActivationList)
		{
			if (anReclassifyObjectActionActivation.get() == this)
			{
				return std::dynamic_pointer_cast<ReclassifyObjectActionActivation>(anReclassifyObjectActionActivation );
			}
		}
	}
	struct null_deleter{void operator()(void const *) const {}};
	return std::shared_ptr<ReclassifyObjectActionActivation>(this, null_deleter());
}
