...
void MDE4CPP_ExtensionsPackageImpl::createFUML_LinkContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_fUML_Link_Operation_add_FUML_Object_Property_EInt = factory->createEOperation_as_eOperations_in_EClass(m_fUML_Link_Class, FUML_LINK_OPERATION_ADD_FUML_OBJECT_PROPERTY_EINT);
	...
	m_fUML_Link_Operation_retrieveOtherLinkEndValue_Property = factory->createEOperation_as_eOperations_in_EClass(m_fUML_Link_Class, FUML_LINK_OPERATION_RETRIEVEOTHERLINKENDVALUE_PROPERTY);
...
void MDE4CPP_ExtensionsPackageImpl::createFUML_ObjectContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_fUML_Object_Operation_invokeOperation_EString_EJavaObject_EJavaObject = factory->createEOperation_as_eOperations_in_EClass(m_fUML_Object_Class, FUML_OBJECT_OPERATION_INVOKEOPERATION_ESTRING_EJAVAOBJECT_EJAVAOBJECT);
	m_fUML_Object_Operation_invokeOperation_EInt_EJavaObject_EJavaObject = factory->createEOperation_as_eOperations_in_EClass(m_fUML_Object_Class, FUML_OBJECT_OPERATION_INVOKEOPERATION_EINT_EJAVAOBJECT_EJAVAOBJECT);
