	...
	class BehaviorImpl : virtual public ClassImpl, virtual public Behavior 
	{
		...
		public:
			...
			*/
			...
			virtual void setBehavioredClassifier(std::shared_ptr<uml::BehavioredClassifier> _behavioredClassifier) ;
			...
			*/
			...
			virtual void setContext(std::shared_ptr<uml::BehavioredClassifier> _context) ;
