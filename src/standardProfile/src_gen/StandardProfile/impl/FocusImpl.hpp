...
#ifndef STANDARDPROFILE_FOCUSFOCUSIMPL_HPP
#define STANDARDPROFILE_FOCUSFOCUSIMPL_HPP
...
{
	class FocusImpl :virtual public ecore::EObjectImpl,
virtual public Focus 
	{
		public: 
		...
		protected:
			...
			FocusImpl();
			virtual std::shared_ptr<Focus> getThisFocusPtr() const;
...
#endif /* end of include guard: STANDARDPROFILE_FOCUSFOCUSIMPL_HPP */
