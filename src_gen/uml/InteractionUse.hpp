...
namespace uml 
{
	...
	class InteractionUse:virtual public InteractionFragment	{
		...
		public:
			...
			<p>From package UML::Interactions.</p> */
			virtual std::vector<uml::Gate * > *  getActualGate() const = 0;
			...
			<p>From package UML::Interactions.</p> */
			virtual uml::Interaction *  getRefersTo() const = 0;
			
			/*!
			 Refers to the Interaction that defines its meaning.
			<p>From package UML::Interactions.</p> */
			virtual void setRefersTo(uml::Interaction *  _refersTo) = 0;
			
			/*!
			 The value of the executed Interaction.
			<p>From package UML::Interactions.</p> */
			virtual uml::ValueSpecification *  getReturnValue() const = 0;
			
			/*!
			 The value of the executed Interaction.
			<p>From package UML::Interactions.</p> */
			virtual void setReturnValue(uml::ValueSpecification *  _returnValue) = 0;
			
			/*!
			 The recipient of the return value.
			<p>From package UML::Interactions.</p> */
			virtual uml::Property *  getReturnValueRecipient() const = 0;
			
			/*!
			 The recipient of the return value.
			<p>From package UML::Interactions.</p> */
			virtual void setReturnValueRecipient(uml::Property *  _returnValueRecipient) = 0;
		...
		protected:
			...
			/*!
			 The actual gates of the InteractionUse.
			<p>From package UML::Interactions.</p> */
			std::vector<uml::Gate * > *  m_actualGate =  nullptr ;
			/*!
			 The actual arguments of the Interaction.
			<p>From package UML::Interactions.</p> */
			...
			/*!
			 Refers to the Interaction that defines its meaning.
			<p>From package UML::Interactions.</p> */
			uml::Interaction *  m_refersTo =  nullptr ;
			/*!
			 The value of the executed Interaction.
			<p>From package UML::Interactions.</p> */
			uml::ValueSpecification *  m_returnValue =  nullptr ;
			/*!
			 The recipient of the return value.
			<p>From package UML::Interactions.</p> */
			uml::Property *  m_returnValueRecipient =  nullptr ;
