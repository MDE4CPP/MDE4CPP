...
namespace uml 
{
	...
	class Classifier:virtual public Namespace,virtual public RedefinableElement,virtual public TemplateableElement,virtual public Type	{
		...
		public:
			...
			virtual bool
			 specialize_type(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 non_final_parents(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			
			/*!
			 Generalization hierarchies must be directed and acyclical. A Classifier can not be both a transitively general and transitively specific Classifier of the same Classifier.
			not allParents()->includes(self) */ 
			virtual bool
			 no_cycles_in_generalization(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual std::shared_ptr<uml::Operation> 
			 getOperation(std::string name,std::shared_ptr<Bag<std::string> >  parameterNames,std::shared_ptr<Bag<uml::Type> >  parameterTypes)  = 0;
			...
			virtual std::shared_ptr<uml::Operation> 
			 getOperation(std::string name,std::shared_ptr<Bag<std::string> >  parameterNames,std::shared_ptr<Bag<uml::Type> >  parameterTypes,bool ignoreCase)  = 0;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::shared_ptr<Bag<uml::Feature> >
			 allFeatures()  = 0;
			...
			<p>From package UML::Classification.</p> */ 
			virtual bool
			 hasVisibilityOf(std::shared_ptr<uml::NamedElement>  n)  = 0;
			...
			virtual std::shared_ptr<Bag<uml::NamedElement> >
			 inherit(std::shared_ptr<Bag<uml::NamedElement> >  inhs)  = 0;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::shared_ptr<Bag<uml::NamedElement> >
			 inheritableMembers(std::shared_ptr<uml::Classifier>  c)  = 0;
			...
			<p>From package UML::Classification.</p> */ 
			virtual bool
			 maySpecializeType(std::shared_ptr<uml::Classifier>  c)  = 0;
			...
			<p>From package UML::Classification.</p> */ 
			virtual bool
			 isSubstitutableFor(std::shared_ptr<uml::Classifier>  contract)  = 0;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::shared_ptr<Bag<uml::StructuralFeature> >
			 allSlottableFeatures()  = 0;
			...
			<p>From package UML::Classification.</p> */
			virtual 		std::shared_ptr<SubsetUnion<uml::CollaborationUse, uml::Element > >
			 getCollaborationUse() const = 0;
			...
			<p>From package UML::Classification.</p> */
			virtual 		std::shared_ptr<Subset<uml::Generalization, uml::Element > >
			...
			virtual 	std::shared_ptr< Bag<uml::GeneralizationSet> >
			 getPowertypeExtent() const = 0;
			
			/*!
			 All elements inherited by this Classifier from its general Classifiers.
			<p>From package UML::Classification.</p> */
			virtual 		std::shared_ptr<Subset<uml::NamedElement, uml::NamedElement > >
			 getInheritedMember() const = 0;
			
			/*!
			 The UseCases owned by this classifier.
			<p>From package UML::Classification.</p> */
			virtual 		std::shared_ptr<Subset<uml::UseCase, uml::NamedElement > >
			 getOwnedUseCase() const = 0;
			
			/*!
			 The set of UseCases for which this Classifier is the subject.
			<p>From package UML::Classification.</p> */
			virtual 	std::shared_ptr< Bag<uml::UseCase> >
			 getUseCase() const = 0;
			
			/*!
			 The Classifiers redefined by this Classifier.
			<p>From package UML::Classification.</p> */
			virtual 		std::shared_ptr<SubsetUnion<uml::Classifier, uml::RedefinableElement > >
			 getRedefinedClassifier() const = 0;
			...
			<p>From package UML::Classification.</p> */
			virtual 		std::shared_ptr<Subset<uml::Substitution, uml::Element > >
			 getSubstitution() const = 0;
