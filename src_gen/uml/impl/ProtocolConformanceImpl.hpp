...
namespace uml 
{
	class ProtocolConformanceImpl :virtual public DirectedRelationshipImpl, virtual public ProtocolConformance
	{
		...
		public:
			...
			virtual uml::ProtocolStateMachine *  getGeneralMachine() const ;
			
			/*!
			 Specifies the ProtocolStateMachine to which the specific ProtocolStateMachine conforms.
			<p>From package UML::StateMachines.</p> */
			virtual void setGeneralMachine(uml::ProtocolStateMachine *  _generalMachine) ;
			
			/*!
			 Specifies the ProtocolStateMachine which conforms to the general ProtocolStateMachine.
			<p>From package UML::StateMachines.</p> */
			virtual uml::ProtocolStateMachine *  getSpecificMachine() const ;
			
			/*!
			 Specifies the ProtocolStateMachine which conforms to the general ProtocolStateMachine.
			<p>From package UML::StateMachines.</p> */
			virtual void setSpecificMachine(uml::ProtocolStateMachine *  _specificMachine) ;
