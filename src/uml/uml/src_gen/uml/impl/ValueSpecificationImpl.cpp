...
bool ValueSpecificationImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::VALUESPECIFICATION_ATTRIBUTE_OWNINGSLOT:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ValueSpecificationImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
	std::shared_ptr<Any> result;
