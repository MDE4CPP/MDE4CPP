...
void ecorePackageImpl::createEObjectContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_eObject_Operation_eInvoke_EOperation_EJavaObject = factory->createEOperation_as_eOperations_in_EClass(m_eObject_Class, EOBJECT_OPERATION_EINVOKE_EOPERATION_EJAVAOBJECT);
...
void ecorePackageImpl::createEObjectAnyContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_eObjectAny_Attribute_any = factory->createEAttribute_as_eAttributes_in_EClass(m_eObjectAny_Class, EOBJECTANY_ATTRIBUTE_ANY);
...
void ecorePackageImpl::createEObjectContainerContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_eObjectContainer_Operation_setContainer_EObject = factory->createEOperation_as_eOperations_in_EClass(m_eObjectContainer_Class, EOBJECTCONTAINER_OPERATION_SETCONTAINER_EOBJECT);
