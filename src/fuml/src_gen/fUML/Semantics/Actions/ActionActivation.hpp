...
namespace fUML::Semantics::Actions 
{
	...
	class ActionActivation:virtual public fUML::Semantics::Activities::ActivityNodeActivation
	{
		...
		protected:
			...
			/*!
			 */
			std::shared_ptr<Subset<fUML::Semantics::Actions::InputPinActivation, fUML::Semantics::Actions::PinActivation>> m_inputPinActivation;
			/*!
			 */
			std::shared_ptr<Subset<fUML::Semantics::Actions::OutputPinActivation, fUML::Semantics::Actions::PinActivation>> m_outputPinActivation;
			/*!
			 */
			std::shared_ptr<Union<fUML::Semantics::Actions::PinActivation>> m_pinActivation;
