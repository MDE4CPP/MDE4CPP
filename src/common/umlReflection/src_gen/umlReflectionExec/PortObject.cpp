...
std::shared_ptr<uml::Element> PortObject::getUmlValue() const
{
	return getPortValue();
}

std::shared_ptr<uml::Port> PortObject::getPortValue() const
{
	return m_PortValue;
}

void PortObject::setUmlValue(std::shared_ptr<uml::Element> _element)
{
	setPortValue(std::dynamic_pointer_cast<uml::Port>(_element));
}

void PortObject::setPortValue(std::shared_ptr<uml::Port> _PortElement)
{
	m_PortValue = _PortElement;
	//set super type values
	UML::PropertyObject::setPropertyValue(_PortElement);
}

void PortObject::setThisPortObjectPtr(std::weak_ptr<PortObject> thisObjectPtr)
{
	setThisCS_ObjectPtr(thisObjectPtr);
}

bool PortObject::equals(std::shared_ptr<fUML::Semantics::Values::Value> otherValue)
{
	bool isEqual = false;
	
	std::shared_ptr<PortObject> otherPortObject = std::dynamic_pointer_cast<PortObject>(otherValue);

	if(otherPortObject != nullptr)
	{
		if(this->getPortValue() == otherPortObject->getPortValue())
		{
			isEqual = true;
		}
	}
...
std::string PortObject::toString()
{
	std::string buffer = "Instance of 'PortObject', " + std::to_string(getTypes()->size()) + " types (";
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Object>> PortObject::getDirectContainers()
{   
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Link>> PortObject::getLinks(std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_InteractionPoint> interactionPoint)
{
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> PortObject::retrieveEndValueAsInteractionPoint(std::shared_ptr<fUML::Semantics::Values::Value> endValue, std::shared_ptr<uml::ConnectorEnd> end)
{
	/*Not done for metamodel object classes*/
...
void PortObject::removeValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<fUML::Semantics::Values::Value> value)
{
	...
	if (m_PortValue == nullptr)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": no value stored inside PortObject (property: " << feature->getName() << ")" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_DeploymentTarget_deployment())
	{
		...
		{
			m_PortValue->getDeployment()->clear();
		}
		else
		{
			...
			{
				m_PortValue->getDeployment()->erase(inputValue->getDeploymentValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		if (value == nullptr) // clear mode
		{
			m_PortValue->getOwnedComment()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
	...
	{
				m_PortValue->setUpper(1 /*defined default value*/);
	...
	{
				m_PortValue->setIsBehavior(false /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Port_isConjugated())
	{
				m_PortValue->setIsConjugated(false /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Port_isService())
	{
				m_PortValue->setIsService(true /*defined default value*/);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Port_redefinedPort())
	{
		if (value == nullptr) // clear mode
		{
			m_PortValue->getRedefinedPort()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = std::dynamic_pointer_cast<PSCS::Semantics::StructuredClassifiers::CS_Reference>(value); */
			std::shared_ptr<fUML::Semantics::StructuredClassifiers::Reference> reference = std::dynamic_pointer_cast<fUML::Semantics::StructuredClassifiers::Reference>(value);
			std::shared_ptr<UML::PortObject> inputValue = std::dynamic_pointer_cast<UML::PortObject>(reference->getReferent());
			if (inputValue != nullptr)
			{
				m_PortValue->getRedefinedPort()->erase(inputValue->getPortValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_aggregation())
	{
				m_PortValue->setAggregation(uml::AggregationKind::NONE /*defined default value*/);
	...
	{
				m_PortValue->setIsComposite(false /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isDerived())
	{
				m_PortValue->setIsDerived(false /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isDerivedUnion())
	{
				m_PortValue->setIsDerivedUnion(false /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isID())
	{
				m_PortValue->setIsID(false /*defined default value*/);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_qualifier())
	{
		if (value == nullptr) // clear mode
		{
			m_PortValue->getQualifier()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_PortValue->getQualifier()->erase(inputValue->getPropertyValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_redefinedProperty())
	{
		if (value == nullptr) // clear mode
		{
			m_PortValue->getRedefinedProperty()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_PortValue->getRedefinedProperty()->erase(inputValue->getPropertyValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_subsettedProperty())
	{
		if (value == nullptr) // clear mode
		{
			m_PortValue->getSubsettedProperty()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_PortValue->getSubsettedProperty()->erase(inputValue->getPropertyValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_isLeaf())
	{
				m_PortValue->setIsLeaf(false /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_StructuralFeature_isReadOnly())
	{
				m_PortValue->setIsReadOnly(false /*defined default value*/);
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> PortObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	if (feature->getMetaElementID() != uml::umlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::umlPackage::PORT_CLASS && feature->getMetaElementID() != uml::umlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	{
		std::shared_ptr<Bag<uml::ConnectorEnd>> endList = m_PortValue->getEnd();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ConnectableElement_templateParameter())
	{
		...
		value->setLocus(this->getLocus());
		value->setConnectableElementTemplateParameterValue(std::dynamic_pointer_cast<uml::ConnectableElementTemplateParameter>(m_PortValue->getTemplateParameter()));
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<Bag<uml::PackageableElement>> deployedElementList = m_PortValue->getDeployedElement();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_owner())
	{
		...
		value->setThisElementObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setElementValue(m_PortValue->getOwner().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Feature_isStatic())
	{
		...
		value->setValue(m_PortValue->getIsStatic());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_isOrdered())
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_PortValue->getIsOrdered());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_isUnique())
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_PortValue->getIsUnique());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_lower())
	{
		...
		value->setValue(m_PortValue->getLower());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_lowerValue())
	{
		...
		value->setLocus(this->getLocus());
		value->setValueSpecificationValue(m_PortValue->getLowerValue());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_upper())
	{
		...
		value->setValue(m_PortValue->getUpper());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_upperValue())
	{
		...
		value->setThisValueSpecificationObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setValueSpecificationValue(m_PortValue->getUpperValue());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	{
		std::shared_ptr<Bag<uml::Dependency>> clientDependencyList = m_PortValue->getClientDependency();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		value->setValue(m_PortValue->getName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		value->setLocus(this->getLocus());
		value->setStringExpressionValue(m_PortValue->getNameExpression());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace())
	{
		...
		value->setLocus(this->getLocus());
		value->setNamespaceValue(m_PortValue->getNamespace().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::StringValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createStringValue();
		value->setValue(m_PortValue->getQualifiedName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		uml::VisibilityKind visibility = m_PortValue->getVisibility();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_owningTemplateParameter())
	{
		...
		value->setLocus(this->getLocus());
		value->setTemplateParameterValue(m_PortValue->getOwningTemplateParameter().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_templateParameter())
	{
		...
		value->setThisTemplateParameterObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setTemplateParameterValue(m_PortValue->getTemplateParameter());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_PortValue->getIsBehavior());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Port_isConjugated())
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_PortValue->getIsConjugated());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Port_isService())
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_PortValue->getIsService());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Port_protocol())
	{
		...
		value->setLocus(this->getLocus());
		value->setProtocolStateMachineValue(m_PortValue->getProtocol());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Port_provided())
	{
		std::shared_ptr<Bag<uml::Interface>> providedList = m_PortValue->getProvided();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Port_required())
	{
		std::shared_ptr<Bag<uml::Interface>> requiredList = m_PortValue->getRequired();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_aggregation())
	{
		uml::AggregationKind aggregation = m_PortValue->getAggregation();
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::EnumerationValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createEnumerationValue();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_association())
	{
		...
		value->setLocus(this->getLocus());
		value->setAssociationValue(m_PortValue->getAssociation());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_associationEnd())
	{
		...
		value->setLocus(this->getLocus());
		value->setPropertyValue(m_PortValue->getAssociationEnd().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_class())
	{
		...
		value->setLocus(this->getLocus());
		value->setClassValue(m_PortValue->getClass().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_datatype())
	{
		...
		value->setLocus(this->getLocus());
		value->setDataTypeValue(m_PortValue->getDatatype().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::StringValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createStringValue();
		value->setValue(m_PortValue->getDefault());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_defaultValue())
	{
		...
		value->setThisValueSpecificationObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setValueSpecificationValue(m_PortValue->getDefaultValue());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_interface())
	{
		...
		value->setThisInterfaceObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setInterfaceValue(m_PortValue->getInterface().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_PortValue->getIsComposite());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isDerived())
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_PortValue->getIsDerived());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isDerivedUnion())
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_PortValue->getIsDerivedUnion());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isID())
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_PortValue->getIsID());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_opposite())
	{
		...
		value->setThisPropertyObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setPropertyValue(m_PortValue->getOpposite());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_owningAssociation())
	{
		...
		value->setThisAssociationObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setAssociationValue(m_PortValue->getOwningAssociation().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_subsettedProperty())
	{
		std::shared_ptr<Bag<uml::Property>> subsettedPropertyList = m_PortValue->getSubsettedProperty();
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_PortValue->getIsLeaf());
		values->add(value);
	}
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_PortValue->getIsReadOnly());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_TypedElement_type())
	{
		...
		value->setLocus(this->getLocus());
		value->setTypeValue(m_PortValue->getType());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
...
std::shared_ptr<fUML::Semantics::SimpleClassifiers::FeatureValue> PortObject::retrieveFeatureValue(std::shared_ptr<uml::StructuralFeature> feature)
{
...
void PortObject::setFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	if (feature->getMetaElementID() != uml::umlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::umlPackage::PORT_CLASS && feature->getMetaElementID() != uml::umlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ConnectableElement_templateParameter())
	{
		...
		if (value != nullptr)
		{
			m_PortValue->setTemplateParameter(value->getConnectableElementTemplateParameterValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_DeploymentTarget_deployment())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_PortValue->getDeployment()->push_back(value->getDeploymentValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_PortValue->getOwnedComment()->push_back(value->getCommentValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Feature_isStatic())
	{
		...
		{
			m_PortValue->setIsStatic(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_isOrdered())
	{
		...
		if (valueObject != nullptr)
		{
			m_PortValue->setIsOrdered(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_isUnique())
	{
		...
		if (valueObject != nullptr)
		{
			m_PortValue->setIsUnique(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_lower())
	{
		...
		if (valueObject != nullptr)
		{
			m_PortValue->setLower(valueObject->getValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_lowerValue())
	{
		...
		if (value != nullptr)
		{
			m_PortValue->setLowerValue(value->getValueSpecificationValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_upper())
	{
		...
		if (valueObject != nullptr)
		{
			m_PortValue->setUpper(valueObject->getValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_upperValue())
	{
		...
		if (value != nullptr)
		{
			m_PortValue->setUpperValue(value->getValueSpecificationValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		if (valueObject != nullptr)
		{
			m_PortValue->setName(valueObject->getValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		if (value != nullptr)
		{
			m_PortValue->setNameExpression(value->getStringExpressionValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		...
		{
			m_PortValue->setVisibility(uml::VisibilityKind::PUBLIC);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_private())
		{
			m_PortValue->setVisibility(uml::VisibilityKind::PRIVATE);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_protected())
		{
			m_PortValue->setVisibility(uml::VisibilityKind::PROTECTED);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_package())
		{
			m_PortValue->setVisibility(uml::VisibilityKind::PACKAGE);
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_templateParameter())
	{
		...
		if (value != nullptr)
		{
			m_PortValue->setTemplateParameter(value->getTemplateParameterValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Port_isBehavior())
	{
		...
		if (valueObject != nullptr)
		{
			m_PortValue->setIsBehavior(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Port_isConjugated())
	{
		...
		if (valueObject != nullptr)
		{
			m_PortValue->setIsConjugated(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Port_isService())
	{
		...
		if (valueObject != nullptr)
		{
			m_PortValue->setIsService(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Port_protocol())
	{
		...
		if (value != nullptr)
		{
			m_PortValue->setProtocol(value->getProtocolStateMachineValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Port_redefinedPort())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_PortValue->getRedefinedPort()->push_back(value->getPortValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_aggregation())
	{
		...
		{
			m_PortValue->setAggregation(uml::AggregationKind::NONE);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_AggregationKind_shared())
		{
			m_PortValue->setAggregation(uml::AggregationKind::SHARED);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_AggregationKind_composite())
		{
			m_PortValue->setAggregation(uml::AggregationKind::COMPOSITE);
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_association())
	{
		...
		if (value != nullptr)
		{
			m_PortValue->setAssociation(value->getAssociationValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_default())
	{
		...
		if (valueObject != nullptr)
		{
			m_PortValue->setDefault(valueObject->getValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_defaultValue())
	{
		...
		if (value != nullptr)
		{
			m_PortValue->setDefaultValue(value->getValueSpecificationValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isComposite())
	{
		...
		if (valueObject != nullptr)
		{
			m_PortValue->setIsComposite(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isDerived())
	{
		...
		if (valueObject != nullptr)
		{
			m_PortValue->setIsDerived(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isDerivedUnion())
	{
		...
		if (valueObject != nullptr)
		{
			m_PortValue->setIsDerivedUnion(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_isID())
	{
		...
		if (valueObject != nullptr)
		{
			m_PortValue->setIsID(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_opposite())
	{
		...
		if (value != nullptr)
		{
			m_PortValue->setOpposite(value->getPropertyValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_qualifier())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_PortValue->getQualifier()->push_back(value->getPropertyValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_redefinedProperty())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_PortValue->getRedefinedProperty()->push_back(value->getPropertyValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Property_subsettedProperty())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_PortValue->getSubsettedProperty()->push_back(value->getPropertyValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_isLeaf())
	{
		...
		if (valueObject != nullptr)
		{
			m_PortValue->setIsLeaf(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_StructuralFeature_isReadOnly())
	{
		...
		if (valueObject != nullptr)
		{
			m_PortValue->setIsReadOnly(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TypedElement_type())
	{
		...
		if (value != nullptr)
		{
			m_PortValue->setType(value->getTypeValue());
		}
		
	}
}

void PortObject::assignFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	this->setFeatureValue(feature, values, position);
}

std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> PortObject::retrieveFeatureValues()
{
	...
	for(unsigned int i = 0; i < allAttributesSize; i++)
	{
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_ConnectableElement_end() && m_PortValue->getEnd() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ConnectableElement_templateParameter() && m_PortValue->getTemplateParameter() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_DeploymentTarget_deployedElement() && m_PortValue->getDeployedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_DeploymentTarget_deployment() && m_PortValue->getDeployment() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment() && m_PortValue->getOwnedComment() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedElement() && m_PortValue->getOwnedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_owner() && m_PortValue->getOwner().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Feature_featuringClassifier() && m_PortValue->getFeaturingClassifier() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_lowerValue() && m_PortValue->getLowerValue() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_MultiplicityElement_upperValue() && m_PortValue->getUpperValue() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_clientDependency() && m_PortValue->getClientDependency() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression() && m_PortValue->getNameExpression() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace() && m_PortValue->getNamespace().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_owningTemplateParameter() && m_PortValue->getOwningTemplateParameter().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_templateParameter() && m_PortValue->getTemplateParameter() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Port_protocol() && m_PortValue->getProtocol() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Port_provided() && m_PortValue->getProvided() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Port_redefinedPort() && m_PortValue->getRedefinedPort() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Port_required() && m_PortValue->getRequired() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_association() && m_PortValue->getAssociation() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_associationEnd() && m_PortValue->getAssociationEnd().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_class() && m_PortValue->getClass().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_datatype() && m_PortValue->getDatatype().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_defaultValue() && m_PortValue->getDefaultValue() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_interface() && m_PortValue->getInterface().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_opposite() && m_PortValue->getOpposite() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_owningAssociation() && m_PortValue->getOwningAssociation().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_qualifier() && m_PortValue->getQualifier() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_redefinedProperty() && m_PortValue->getRedefinedProperty() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Property_subsettedProperty() && m_PortValue->getSubsettedProperty() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_redefinedElement() && m_PortValue->getRedefinedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_redefinitionContext() && m_PortValue->getRedefinitionContext() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_TypedElement_type() && m_PortValue->getType() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
	}
