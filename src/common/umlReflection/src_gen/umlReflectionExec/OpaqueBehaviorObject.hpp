...
#ifndef UML_OPAQUEBEHAVIOR_EXECUTION_HPP
#define UML_OPAQUEBEHAVIOR_EXECUTION_HPP
...
namespace UML 
{
	class OpaqueBehaviorObject : virtual public UML::BehaviorObject
	{
		public:
		    //constructors
		    OpaqueBehaviorObject(OpaqueBehaviorObject &obj);
		    OpaqueBehaviorObject(std::shared_ptr<uml::OpaqueBehavior>);
		 	OpaqueBehaviorObject();
		    //destructor
		    virtual ~OpaqueBehaviorObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			OpaqueBehaviorObject& operator=(OpaqueBehaviorObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::OpaqueBehavior> getOpaqueBehaviorValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setOpaqueBehaviorValue(std::shared_ptr<uml::OpaqueBehavior>);
			virtual void setThisOpaqueBehaviorObjectPtr(std::weak_ptr<OpaqueBehaviorObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::OpaqueBehavior> m_OpaqueBehaviorValue = nullptr;
	};
}
#endif /* end of include guard: UML_OPAQUEBEHAVIOR_OBJECT_HPP */
