...
namespace uml 
{
	...
	class ReadLinkObjectEndAction:virtual public Action	{
		...
		public:
			...
			virtual bool
			 property(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 ends_of_association(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 type_of_object(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			
			/*!
			 The association of the end must be an AssociationClass.
			end.association.oclIsKindOf(AssociationClass) */ 
			virtual bool
			 association_of_association(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
