...
#ifndef UML_TIMECONSTRAINT_EXECUTION_HPP
#define UML_TIMECONSTRAINT_EXECUTION_HPP
...
namespace UML 
{
	class TimeConstraintObject : virtual public UML::IntervalConstraintObject
	{
		public:
		    //constructors
		    TimeConstraintObject(TimeConstraintObject &obj);
		    TimeConstraintObject(std::shared_ptr<uml::TimeConstraint>);
			...
			virtual std::shared_ptr<uml::TimeConstraint> getTimeConstraintValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setTimeConstraintValue(std::shared_ptr<uml::TimeConstraint>);
			virtual void setThisTimeConstraintObjectPtr(std::weak_ptr<TimeConstraintObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::TimeConstraint> m_TimeConstraintValue = nullptr;
	};
}
#endif /* end of include guard: UML_TIMECONSTRAINT_OBJECT_HPP */
