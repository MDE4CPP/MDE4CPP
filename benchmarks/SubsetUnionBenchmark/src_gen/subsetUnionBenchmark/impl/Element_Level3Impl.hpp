...
namespace subsetUnionBenchmark 
{
	class Element_Level3Impl :virtual public ElementImpl, virtual public Element_Level3 
	{
		...
		protected:
			...
			Element_Level3Impl();
			virtual std::shared_ptr<Element_Level3> getThisElement_Level3Ptr() const;
			virtual void setThisElement_Level3Ptr(std::weak_ptr<Element_Level3> thisElement_Level3Ptr);
		...
		private:
			std::weak_ptr<Element_Level3> m_thisElement_Level3Ptr;
	};
}
