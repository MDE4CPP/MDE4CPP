...
namespace uml 
{
	...
	class Namespace:virtual public NamedElement	{
		...
		public:
			...
			virtual uml::ElementImport *  createElementImport(uml::PackageableElement *  element,VisibilityKind visibility)  = 0;
			
			/*!
			 Creates an import of the specified package into this namespace with the specified visibility. */ 
			virtual uml::PackageImport *  createPackageImport(uml::Package *  package_,VisibilityKind visibility)  = 0;
			
			/*!
			 Retrieves the elements imported by this namespace. */ 
			virtual std::vector<uml::PackageableElement * > *  getImportedElements()  = 0;
			
			/*!
			 Retrieves the packages imported by this namespace. */ 
			virtual std::vector<uml::Package * > *  getImportedPackages()  = 0;
			
			/*!
			 */ 
			virtual std::vector<uml::NamedElement * > *  getOwnedMembers()  = 0;
			
			/*!
			 The query excludeCollisions() excludes from a set of PackageableElements any that would not be distinguishable from each other in this Namespace.
			result = (imps->reject(imp1  | imps->exists(imp2 | not imp1.isDistinguishableFrom(imp2, self))))
			<p>From package UML::CommonStructure.</p> */ 
			virtual std::vector<uml::PackageableElement * > *  excludeCollisions(std::vector<uml::PackageableElement * > *  imps)  = 0;
			...
			<p>From package UML::CommonStructure.</p> */ 
			virtual std::vector<std::string> *  getNamesOfMember(uml::NamedElement *  element)  = 0;
			...
			<p>From package UML::CommonStructure.</p> */ 
			virtual std::vector<uml::PackageableElement * > *  importMembers(std::vector<uml::PackageableElement * > *  imps)  = 0;
			...
			<p>From package UML::CommonStructure.</p> */ 
			virtual std::vector<uml::PackageableElement * > *  getImportedMembers()  = 0;
			...
			<p>From package UML::CommonStructure.</p> */
			virtual std::vector<uml::Constraint * > *  getOwnedRule() const = 0;
			
			/*!
			 References the ElementImports owned by the Namespace.
			<p>From package UML::CommonStructure.</p> */
			virtual std::vector<uml::ElementImport * > *  getElementImport() const = 0;
			
			/*!
			 References the PackageImports owned by the Namespace.
			<p>From package UML::CommonStructure.</p> */
			virtual std::vector<uml::PackageImport * > *  getPackageImport() const = 0;
			
			
			/*!
			 References the PackageableElements that are members of this Namespace as a result of either PackageImports or ElementImports.
			<p>From package UML::CommonStructure.</p> */
			virtual std::vector<uml::PackageableElement * > *  getImportedMember() const = 0;
		...
		protected:
			...
			/*!
			 Specifies a set of Constraints owned by this Namespace.
			<p>From package UML::CommonStructure.</p> */
			std::vector<uml::Constraint * > *  m_ownedRule =  nullptr ;
			/*!
			 References the ElementImports owned by the Namespace.
			<p>From package UML::CommonStructure.</p> */
			std::vector<uml::ElementImport * > *  m_elementImport =  nullptr ;
			/*!
			 References the PackageImports owned by the Namespace.
			<p>From package UML::CommonStructure.</p> */
			std::vector<uml::PackageImport * > *  m_packageImport =  nullptr ;
			/*!
			 A collection of NamedElements owned by the Namespace.
			<p>From package UML::CommonStructure.</p> */
			std::vector<uml::NamedElement * > *  m_ownedMember =  nullptr ;
			/*!
			 References the PackageableElements that are members of this Namespace as a result of either PackageImports or ElementImports.
			<p>From package UML::CommonStructure.</p> */
			std::vector<uml::PackageableElement * > *  m_importedMember =  nullptr ;
			/*!
			 A collection of NamedElements identifiable within the Namespace, either by being owned or by being introduced by importing or inheritance.
			<p>From package UML::CommonStructure.</p> */
			std::vector<uml::NamedElement * > *  m_member =  nullptr ;
