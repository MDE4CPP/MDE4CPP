...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> AbstractionObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Dependency_client())
	{
		std::shared_ptr<Bag<uml::NamedElement>> clientList = m_AbstractionValue->getClient();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Dependency_supplier())
	{
		std::shared_ptr<Bag<uml::NamedElement>> supplierList = m_AbstractionValue->getSupplier();
	...
	{
		std::shared_ptr<Bag<uml::Element>> sourceList = m_AbstractionValue->getSource();
	...
	{
		std::shared_ptr<Bag<uml::Element>> targetList = m_AbstractionValue->getTarget();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Bag<uml::Comment>> ownedCommentList = m_AbstractionValue->getOwnedComment();
	...
	{
		std::shared_ptr<Bag<uml::Element>> ownedElementList = m_AbstractionValue->getOwnedElement();
	...
	{
		std::shared_ptr<Bag<uml::Element>> relatedElementList = m_AbstractionValue->getRelatedElement();
