...
WriteLinkActionActivationImpl& WriteLinkActionActivationImpl::operator=(const WriteLinkActionActivationImpl & obj)
{
	 ...
	 * Currently, this causes an error because it calls an implicit assignment operator of WriteLinkActionActivation 
	 * which is generated by the compiler (as WriteLinkActionActivation is an abstract class and does not have a user-defined assignment operator).
...
const std::shared_ptr<ecore::EClass>& WriteLinkActionActivationImpl::eStaticClass() const
{
...
//*********************************
std::shared_ptr<Any> WriteLinkActionActivationImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
	}
...
bool WriteLinkActionActivationImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
	}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> WriteLinkActionActivationImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
