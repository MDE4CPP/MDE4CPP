...
#ifndef UML_EVENT_EXECUTION_HPP
#define UML_EVENT_EXECUTION_HPP
...
namespace UML 
{
	class EventObject : virtual public UML::PackageableElementObject
	{
		public:
		    //constructors
		    EventObject(EventObject &obj);
		    EventObject(std::shared_ptr<uml::Event>);
		 	EventObject();
		    //destructor
		    virtual ~EventObject();
			...
			virtual std::shared_ptr<uml::Event> getEventValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setEventValue(std::shared_ptr<uml::Event>);
			virtual void setThisEventObjectPtr(std::weak_ptr<EventObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Event> m_EventValue = nullptr;
	};
}
#endif /* end of include guard: UML_EVENT_OBJECT_HPP */
