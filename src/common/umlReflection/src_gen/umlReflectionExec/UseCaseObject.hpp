...
#ifndef UML_USECASE_EXECUTION_HPP
#define UML_USECASE_EXECUTION_HPP
...
namespace UML 
{
	class UseCaseObject : virtual public UML::BehavioredClassifierObject
	{
		public:
		    //constructors
		    UseCaseObject(UseCaseObject &obj);
		    UseCaseObject(std::shared_ptr<uml::UseCase>);
		 	UseCaseObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::UseCase> getUseCaseValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setUseCaseValue(std::shared_ptr<uml::UseCase>);
			virtual void setThisUseCaseObjectPtr(std::weak_ptr<UseCaseObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::UseCase> m_UseCaseValue = nullptr;
	};
}
#endif /* end of include guard: UML_USECASE_OBJECT_HPP */
