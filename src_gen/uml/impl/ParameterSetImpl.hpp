...
namespace uml 
{
	class ParameterSetImpl :virtual public NamedElementImpl, virtual public ParameterSet 
	{
		...
		public:
			...
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Constraint>>> getCondition() const ;
			
			/*!
			 Parameters in the ParameterSet.
			<p>From package UML::Classification.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Parameter>>> getParameter() const ;
