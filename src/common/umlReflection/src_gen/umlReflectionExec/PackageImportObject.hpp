...
#ifndef UML_PACKAGEIMPORT_EXECUTION_HPP
#define UML_PACKAGEIMPORT_EXECUTION_HPP
...
namespace UML 
{
	class PackageImportObject : virtual public UML::DirectedRelationshipObject
	{
		public:
		    //constructors
		    PackageImportObject(PackageImportObject &obj);
		    PackageImportObject(std::shared_ptr<uml::PackageImport>);
		 	PackageImportObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::PackageImport> getPackageImportValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setPackageImportValue(std::shared_ptr<uml::PackageImport>);
			virtual void setThisPackageImportObjectPtr(std::weak_ptr<PackageImportObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::PackageImport> m_PackageImportValue = nullptr;
	};
}
#endif /* end of include guard: UML_PACKAGEIMPORT_OBJECT_HPP */
