...
ecore::EClass* RemoveStructuralFeatureValueActionImpl::eStaticClass() const
{
...
// References
//*********************************
uml::InputPin *  RemoveStructuralFeatureValueActionImpl::getRemoveAt() const
{
	
	return m_removeAt;
}
void RemoveStructuralFeatureValueActionImpl::setRemoveAt(uml::InputPin *  _removeAt)
{
...
// Union Getter
//*********************************
std::vector<uml::RedefinableElement * > *  RemoveStructuralFeatureValueActionImpl::getRedefinedElement() const
{
...
std::vector<uml::Element * > *  RemoveStructuralFeatureValueActionImpl::getOwnedElement() const
{
...
uml::Element *  RemoveStructuralFeatureValueActionImpl::getOwner() const
{
...
std::vector<uml::InputPin * > *  RemoveStructuralFeatureValueActionImpl::getInput() const
{
...
std::vector<uml::OutputPin * > *  RemoveStructuralFeatureValueActionImpl::getOutput() const
{
...
std::vector<uml::ActivityGroup * > *  RemoveStructuralFeatureValueActionImpl::getInGroup() const
{
