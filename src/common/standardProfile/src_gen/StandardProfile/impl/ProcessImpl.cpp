...
ProcessImpl::ProcessImpl()
{
	...
	*/
	...
	//getter init
		...
		m_getterMap.insert(std::pair<unsigned long,std::function<Any()>>(1144790346,[this](){ return eAny(this->getBase_Component(), uml::umlPackage::COMPONENT_CLASS, false);}));
	
	
	//setter init
	//Property base_Component
		m_setterMap.insert(std::pair<unsigned long,std::function<void(Any)>>(1144790346,[this](Any object){this->setBase_Component(object->get<std::shared_ptr<uml::Component>>());}));
	
	
	//unsetter init
		//Property base_Component
		m_unsetterMap.insert(std::pair<unsigned long,std::function<void()>>(1144790346,[this](){m_base_Component = std::shared_ptr<uml::Component>(nullptr);}));
...
//*********************************
//Get
Any ProcessImpl::get(const std::shared_ptr<uml::Property>& _property) const
{
...
Any ProcessImpl::get(unsigned long _uID) const
{
...
//Set
void ProcessImpl::set(const std::shared_ptr<uml::Property>& _property, const Any& value)
{
	std::string qualifiedName = _property->getQualifiedName();
    this->set(qualifiedName, value);
}

void ProcessImpl::set(std::string _qualifiedName, const Any& value)
{
	unsigned long uID = util::Util::polynomialRollingHash(_qualifiedName);
    this->set(uID, value);
}

void ProcessImpl::set(unsigned long _uID, const Any& value)
{
...
//Unset
void ProcessImpl::unset(const std::shared_ptr<uml::Property>& _property)
{
	std::string qualifiedName = _property->getQualifiedName();
...
//*********************************
//Invoke
Any ProcessImpl::invoke(const std::shared_ptr<uml::Operation>& _operation, const std::shared_ptr<Bag<Any>>& _arguments)
{
...
Any ProcessImpl::invoke(std::string _qualifiedName, const std::shared_ptr<Bag<Any>>& _arguments)
{
	unsigned long uID = util::Util::polynomialRollingHash(_qualifiedName);
    return this->invoke(uID, _arguments);
}

Any ProcessImpl::invoke(unsigned long _uID, const std::shared_ptr<Bag<Any>>& _arguments)
{
