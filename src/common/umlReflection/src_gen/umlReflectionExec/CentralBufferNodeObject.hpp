...
#ifndef UML_CENTRALBUFFERNODE_EXECUTION_HPP
#define UML_CENTRALBUFFERNODE_EXECUTION_HPP
...
namespace UML 
{
	class CentralBufferNodeObject : virtual public UML::ObjectNodeObject
	{
		public:
		    //constructors
		    CentralBufferNodeObject(CentralBufferNodeObject &obj);
		    CentralBufferNodeObject(std::shared_ptr<uml::CentralBufferNode>);
		 	CentralBufferNodeObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::CentralBufferNode> getCentralBufferNodeValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setCentralBufferNodeValue(std::shared_ptr<uml::CentralBufferNode>);
			virtual void setThisCentralBufferNodeObjectPtr(std::weak_ptr<CentralBufferNodeObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::CentralBufferNode> m_CentralBufferNodeValue = nullptr;
	};
}
#endif /* end of include guard: UML_CENTRALBUFFERNODE_OBJECT_HPP */
