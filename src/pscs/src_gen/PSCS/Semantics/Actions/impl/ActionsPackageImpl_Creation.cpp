...
void ActionsPackageImpl::createCS_DefaultConstructStrategyContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_cS_DefaultConstructStrategy_Operation_addStructuralFeatureValue_PSCS_Object_EJavaObject = factory->createEOperation_as_eOperations_in_EClass(m_cS_DefaultConstructStrategy_Class, CS_DEFAULTCONSTRUCTSTRATEGY_OPERATION_ADDSTRUCTURALFEATUREVALUE_PSCS_OBJECT_EJAVAOBJECT);
	...
	m_cS_DefaultConstructStrategy_Operation_construct_Operation_PSCS_Object = factory->createEOperation_as_eOperations_in_EClass(m_cS_DefaultConstructStrategy_Class, CS_DEFAULTCONSTRUCTSTRATEGY_OPERATION_CONSTRUCT_OPERATION_PSCS_OBJECT);
	m_cS_DefaultConstructStrategy_Operation_constructObject_PSCS_Object_Class = factory->createEOperation_as_eOperations_in_EClass(m_cS_DefaultConstructStrategy_Class, CS_DEFAULTCONSTRUCTSTRATEGY_OPERATION_CONSTRUCTOBJECT_PSCS_OBJECT_CLASS);
	m_cS_DefaultConstructStrategy_Operation_generateArrayPattern_PSCS_Object_Connector = factory->createEOperation_as_eOperations_in_EClass(m_cS_DefaultConstructStrategy_Class, CS_DEFAULTCONSTRUCTSTRATEGY_OPERATION_GENERATEARRAYPATTERN_PSCS_OBJECT_CONNECTOR);
	...
	m_cS_DefaultConstructStrategy_Operation_generateStarPattern_PSCS_Object_Connector = factory->createEOperation_as_eOperations_in_EClass(m_cS_DefaultConstructStrategy_Class, CS_DEFAULTCONSTRUCTSTRATEGY_OPERATION_GENERATESTARPATTERN_PSCS_OBJECT_CONNECTOR);
	...
	m_cS_DefaultConstructStrategy_Operation_getValuesFromConnectorEnd_PSCS_Object_ConnectorEnd = factory->createEOperation_as_eOperations_in_EClass(m_cS_DefaultConstructStrategy_Class, CS_DEFAULTCONSTRUCTSTRATEGY_OPERATION_GETVALUESFROMCONNECTOREND_PSCS_OBJECT_CONNECTOREND);
