...
#ifndef UML_OBJECTFLOW_EXECUTION_HPP
#define UML_OBJECTFLOW_EXECUTION_HPP
...
namespace UML 
{
	class ObjectFlowObject : virtual public UML::ActivityEdgeObject
	{
		public:
		    //constructors
		    ObjectFlowObject(ObjectFlowObject &obj);
		    ObjectFlowObject(std::shared_ptr<uml::ObjectFlow>);
		 	ObjectFlowObject();
		    //destructor
		    virtual ~ObjectFlowObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			ObjectFlowObject& operator=(ObjectFlowObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::ObjectFlow> getObjectFlowValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setObjectFlowValue(std::shared_ptr<uml::ObjectFlow>);
			virtual void setThisObjectFlowObjectPtr(std::weak_ptr<ObjectFlowObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ObjectFlow> m_ObjectFlowValue = nullptr;
	};
}
#endif /* end of include guard: UML_OBJECTFLOW_OBJECT_HPP */
