...
void SimpleClassifiersPackageImpl::createEnumerationValueContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_enumerationValue_Attribute_literal = factory->createEReference_as_eStructuralFeatures_in_EClass(m_enumerationValue_Class, ENUMERATIONVALUE_ATTRIBUTE_LITERAL);m_enumerationValue_Attribute_type = factory->createEReference_as_eStructuralFeatures_in_EClass(m_enumerationValue_Class, ENUMERATIONVALUE_ATTRIBUTE_TYPE);
...
void SimpleClassifiersPackageImpl::createFeatureValueContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_featureValue_Attribute_feature = factory->createEReference_as_eStructuralFeatures_in_EClass(m_featureValue_Class, FEATUREVALUE_ATTRIBUTE_FEATURE);m_featureValue_Attribute_values = factory->createEReference_as_eStructuralFeatures_in_EClass(m_featureValue_Class, FEATUREVALUE_ATTRIBUTE_VALUES);
