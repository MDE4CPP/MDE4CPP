...
namespace uml 
{
	...
	class FunctionBehavior:virtual public OpaqueBehavior	{
		...
		public:
			...
			virtual bool
			 one_output_parameter(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 types_of_parameters(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			<p>From package UML::CommonBehavior.</p> */ 
			virtual bool
			 hasAllDataTypeAttributes(std::shared_ptr<uml::DataType>  d)  = 0;
