...
void FUMLPackageImpl::createDestroyObjectActionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::EcoreFactory> factory)
{
	...
	m_destroyObjectActionActivation_EOperation_doAction = factory->createEOperation_in_EContainingClass(m_destroyObjectActionActivation_EClass, DESTROYOBJECTACTIONACTIVATION_EOPERATION_DOACTION);
