	...
	class UML_API ElementImpl : virtual public ObjectImpl, virtual public Element 
	{
		...
		public:
			...
			*/
			...
			virtual std::shared_ptr<Any> getValue(std::shared_ptr<uml::Stereotype> stereotype, std::string propertyName) ;
			/*!
			...
			*/
			...
			virtual bool has_owner(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < std::shared_ptr<Any>, std::shared_ptr<Any>>> context) ;
			/*!
			...
			*/
			...
			virtual bool not_own_self(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < std::shared_ptr<Any>, std::shared_ptr<Any>>> context) ;
			/*!
			...
			*/
			...
			virtual void setValue(std::shared_ptr<uml::Stereotype> stereotype, std::string propertyName, std::shared_ptr<Any> newValue) ;
			/*!
