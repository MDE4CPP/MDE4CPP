...
#ifndef FOUNDATIONALMODELLIBRARY_BASICINPUTOUTPUT_STANDARDOUTPUTCHANNEL_STANDARDOUTPUTCHANNELIMPL_HPP
#define FOUNDATIONALMODELLIBRARY_BASICINPUTOUTPUT_STANDARDOUTPUTCHANNEL_STANDARDOUTPUTCHANNELIMPL_HPP

//Model includes
#include "../StandardOutputChannel.hpp"
...
{
	class StandardOutputChannelImpl:virtual public TextOutputChannelImpl, virtual public StandardOutputChannel
	{
		public: 
			StandardOutputChannelImpl(const StandardOutputChannelImpl & obj);
			virtual std::shared_ptr<ecore::EObject> copy() const;  
			StandardOutputChannelImpl& operator=(StandardOutputChannelImpl const&);

		protected:
			friend class BasicInputOutputFactoryImpl;
			//constructor
			StandardOutputChannelImpl();
			virtual std::shared_ptr<StandardOutputChannel> getThisStandardOutputChannelPtr();
			virtual void setThisStandardOutputChannelPtr(std::weak_ptr<StandardOutputChannel> thisStandardOutputChannelPtr);


		public:

			//destructor
			virtual ~StandardOutputChannelImpl();
		...
		private:
			std::weak_ptr<StandardOutputChannel> m_thisStandardOutputChannelPtr;
	};
}
#endif /* end of include guard: FOUNDATIONALMODELLIBRARY_BASICINPUTOUTPUT_STANDARDOUTPUTCHANNEL_STANDARDOUTPUTCHANNELIMPL_HPP */
