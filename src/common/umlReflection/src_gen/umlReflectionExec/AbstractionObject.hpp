...
#ifndef UML_ABSTRACTION_EXECUTION_HPP
#define UML_ABSTRACTION_EXECUTION_HPP
...
namespace UML 
{
	class AbstractionObject : virtual public UML::DependencyObject
	{
		public:
		    //constructors
		    AbstractionObject(AbstractionObject &obj);
		    AbstractionObject(std::shared_ptr<uml::Abstraction>);
		 	AbstractionObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::Abstraction> getAbstractionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setAbstractionValue(std::shared_ptr<uml::Abstraction>);
			virtual void setThisAbstractionObjectPtr(std::weak_ptr<AbstractionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Abstraction> m_AbstractionValue = nullptr;
	};
}
#endif /* end of include guard: UML_ABSTRACTION_OBJECT_HPP */
