...
#ifndef UML_CONNECTABLEELEMENT_EXECUTION_HPP
#define UML_CONNECTABLEELEMENT_EXECUTION_HPP
...
namespace UML 
{
	class ConnectableElementObject : virtual public UML::ParameterableElementObject , virtual public UML::TypedElementObject
	{
		public:
		    //constructors
		    ConnectableElementObject(ConnectableElementObject &obj);
		    ConnectableElementObject(std::shared_ptr<uml::ConnectableElement>);
		 	ConnectableElementObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::ConnectableElement> getConnectableElementValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setConnectableElementValue(std::shared_ptr<uml::ConnectableElement>);
			virtual void setThisConnectableElementObjectPtr(std::weak_ptr<ConnectableElementObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ConnectableElement> m_ConnectableElementValue = nullptr;
	};
}
#endif /* end of include guard: UML_CONNECTABLEELEMENT_OBJECT_HPP */
