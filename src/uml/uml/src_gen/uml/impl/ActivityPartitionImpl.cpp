...
// Operations
//*********************************
bool ActivityPartitionImpl::dimension_not_contained(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < std::shared_ptr<Any>, std::shared_ptr<Any>>> context)
{
	throw std::runtime_error("UnsupportedOperationException: " + std::string(__PRETTY_FUNCTION__));
}

bool ActivityPartitionImpl::represents_classifier(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < std::shared_ptr<Any>, std::shared_ptr<Any>>> context)
{
	throw std::runtime_error("UnsupportedOperationException: " + std::string(__PRETTY_FUNCTION__));
}

bool ActivityPartitionImpl::represents_property(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < std::shared_ptr<Any>, std::shared_ptr<Any>>> context)
{
	throw std::runtime_error("UnsupportedOperationException: " + std::string(__PRETTY_FUNCTION__));
}

bool ActivityPartitionImpl::represents_property_and_is_contained(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < std::shared_ptr<Any>, std::shared_ptr<Any>>> context)
{
	throw std::runtime_error("UnsupportedOperationException: " + std::string(__PRETTY_FUNCTION__));
}
...
std::shared_ptr<Any> ActivityPartitionImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
	std::shared_ptr<Any> result;
  	...
  	switch(operationID)
	{
		// uml::ActivityPartition::dimension_not_contained(std::shared_ptr<Any>, std::map) : bool: 3774023604
		...
		// uml::ActivityPartition::represents_classifier(std::shared_ptr<Any>, std::map) : bool: 3047870621
		...
		// uml::ActivityPartition::represents_property(std::shared_ptr<Any>, std::map) : bool: 163368661
		...
		// uml::ActivityPartition::represents_property_and_is_contained(std::shared_ptr<Any>, std::map) : bool: 897444454
