...
void CreateObjectActionImpl::saveContent(std::shared_ptr<persistence::interfaces::XSaveHandler> saveHandler) const
{
	...
	// Add references
	if ( this->eIsSet(package->getCreateObjectAction_Attribute_classifier()) )
	{
...
bool CreateObjectActionImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::CREATEOBJECTACTION_ATTRIBUTE_CLASSIFIER:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> CreateObjectActionImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
