...
// Union Getter
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> ClearStructuralFeatureActionImpl::getOwnedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::OutputPin>>> ClearStructuralFeatureActionImpl::getOutput() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> ClearStructuralFeatureActionImpl::getRedefinedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::InputPin>>> ClearStructuralFeatureActionImpl::getInput() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::ActivityGroup>>> ClearStructuralFeatureActionImpl::getInGroup() const
{
