...
OpaqueBehaviorImpl::OpaqueBehaviorImpl(const OpaqueBehaviorImpl & obj)
{
...
ecore::EObject *  OpaqueBehaviorImpl::copy() const
{
	return new OpaqueBehaviorImpl(*this);
}
...
std::shared_ptr<std::vector<std::string>> OpaqueBehaviorImpl::getBody() const 
{
	return m_body;
}
...
std::shared_ptr<std::vector<std::string>> OpaqueBehaviorImpl::getLanguage() const 
{
	return m_language;
}
...
// Union Getter
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::Feature>>> OpaqueBehaviorImpl::getFeature() const
{
...
std::shared_ptr<uml::Element> OpaqueBehaviorImpl::getOwner() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Classifier>>> OpaqueBehaviorImpl::getRedefinitionContext() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> OpaqueBehaviorImpl::getRedefinedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> OpaqueBehaviorImpl::getMember() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> OpaqueBehaviorImpl::getOwnedMember() const
{
...
std::shared_ptr<uml::Namespace> OpaqueBehaviorImpl::getNamespace() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Property>>> OpaqueBehaviorImpl::getAttribute() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> OpaqueBehaviorImpl::getOwnedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::ConnectableElement>>> OpaqueBehaviorImpl::getRole() const
{
