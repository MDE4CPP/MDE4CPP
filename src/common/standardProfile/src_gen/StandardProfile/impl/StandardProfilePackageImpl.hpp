...
namespace StandardProfile
{
	class StandardProfilePackageImpl : virtual public uml::ProfileImpl, virtual public StandardProfilePackage
	{
		...
		public:
			...
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Auxiliary_StandardProfile_Auxiliary();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_BehavioralFeature_Create_StandardProfile_Create();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_BuildComponent_StandardProfile_BuildComponent();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Call_StandardProfile_Call();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Derive_StandardProfile_Derive();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Destroy_StandardProfile_Destroy();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Document_StandardProfile_Document();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Entity_StandardProfile_Entity();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Executable_StandardProfile_Executable();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_File_StandardProfile_File();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Focus_StandardProfile_Focus();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Framework_StandardProfile_Framework();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Implement_StandardProfile_Implement();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_ImplementationClass_StandardProfile_ImplementationClass();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Instantiate_StandardProfile_Instantiate();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Library_StandardProfile_Library();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Metaclass_StandardProfile_Metaclass();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Metamodel_StandardProfile_Metamodel();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_ModelLibrary_StandardProfile_ModelLibrary();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Process_StandardProfile_Process();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Realization_StandardProfile_Realization();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Refine_StandardProfile_Refine();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Responsibility_StandardProfile_Responsibility();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Script_StandardProfile_Script();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Send_StandardProfile_Send();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Service_StandardProfile_Service();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Source_StandardProfile_Source();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Specification_StandardProfile_Specification();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Subsystem_StandardProfile_Subsystem();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_SystemModel_StandardProfile_SystemModel();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Trace_StandardProfile_Trace();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Type_StandardProfile_Type();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Usage_Create_StandardProfile_Create();  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Utility_StandardProfile_Utility();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Abstraction_Derive();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Abstraction_Refine();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Abstraction_Trace();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Artifact_Document();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Artifact_Executable();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Artifact_File();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Artifact_Library();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Artifact_Script();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Artifact_Source();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Auxiliary();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Auxiliary_base_Class();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_BehavioralFeature_Create();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_BehavioralFeature_Destroy();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_BuildComponent();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_BuildComponent_base_Component();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Call();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Call_base_Usage();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Class_Auxiliary();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Class_Focus();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Class_ImplementationClass();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Class_Metaclass();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Class_Type();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Class_Utility();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Classifier_Realization();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Classifier_Specification();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Component_BuildComponent();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Component_Entity();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Component_Implement();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Component_Process();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Component_Service();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Component_Subsystem();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Create();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Create_base_BehavioralFeature();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Create_base_Usage();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Derive();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Derive_base_Abstraction();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Destroy();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Destroy_base_BehavioralFeature();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Document();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Document_base_Artifact();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Entity();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Entity_base_Component();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Executable();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Executable_base_Artifact();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_File();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_File_base_Artifact();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Focus();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Focus_base_Class();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Framework();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Framework_base_Package();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Implement();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Implement_base_Component();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_ImplementationClass();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_ImplementationClass_base_Class();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Instantiate();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Instantiate_base_Usage();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Library();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Library_base_Artifact();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Metaclass();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Metaclass_base_Class();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Metamodel();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Metamodel_base_Model();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_ModelLibrary();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_ModelLibrary_base_Package();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Model_Metamodel();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Model_SystemModel();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Package_Framework();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Package_ModelLibrary();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Process();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Process_base_Component();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Realization();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Realization_base_Classifier();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Refine();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Refine_base_Abstraction();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Responsibility();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Responsibility_base_Usage();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Script();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Script_base_Artifact();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Send();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Send_base_Usage();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Service();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Service_base_Component();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Source();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Source_base_Artifact();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Specification();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Specification_base_Classifier();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Subsystem();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Subsystem_base_Component();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_SystemModel();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_SystemModel_base_Model();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Trace();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Trace_base_Abstraction();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Type();  
			virtual const std::shared_ptr<uml::Property>& get_StandardProfile_Type_base_Class();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Usage_Call();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Usage_Create();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Usage_Instantiate();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Usage_Responsibility();  
			virtual const std::shared_ptr<uml::Extension>& get_StandardProfile_Usage_Send();  
			virtual const std::shared_ptr<uml::Stereotype>& get_StandardProfile_Utility();  
		...
		private:
			...
			void createPackageEvents(std::shared_ptr<uml::Package> standardProfile, std::shared_ptr<uml::umlFactory> factory);
