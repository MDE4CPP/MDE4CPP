...
void SignalEventImpl::saveContent(std::shared_ptr<persistence::interfaces::XSaveHandler> saveHandler) const
{
	...
	// Add references
	if ( this->eIsSet(package->getSignalEvent_Attribute_signal()) )
	{
...
bool SignalEventImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::SIGNALEVENT_ATTRIBUTE_SIGNAL:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> SignalEventImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
