...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> ActionInputPinObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	...
	{
		std::shared_ptr<Bag<uml::ActivityGroup>> inGroupList = m_ActionInputPinValue->getInGroup();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inInterruptibleRegion())
	{
		std::shared_ptr<Bag<uml::InterruptibleActivityRegion>> inInterruptibleRegionList = m_ActionInputPinValue->getInInterruptibleRegion();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inPartition())
	{
		std::shared_ptr<Bag<uml::ActivityPartition>> inPartitionList = m_ActionInputPinValue->getInPartition();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_redefinedNode())
	{
		std::shared_ptr<Bag<uml::ActivityNode>> redefinedNodeList = m_ActionInputPinValue->getRedefinedNode();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Bag<uml::Comment>> ownedCommentList = m_ActionInputPinValue->getOwnedComment();
	...
	{
		std::shared_ptr<Bag<uml::Element>> ownedElementList = m_ActionInputPinValue->getOwnedElement();
	...
	{
		std::shared_ptr<Bag<uml::RedefinableElement>> redefinedElementList = m_ActionInputPinValue->getRedefinedElement();
	...
	{
		std::shared_ptr<Bag<uml::Classifier>> redefinitionContextList = m_ActionInputPinValue->getRedefinitionContext();
