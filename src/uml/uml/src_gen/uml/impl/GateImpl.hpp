	...
	class UML_API GateImpl : virtual public MessageEndImpl, virtual public Gate 
	{
		...
		public:
			...
			*/
			...
			virtual bool actual_gate_distinguishable(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			/*!
			...
			*/
			...
			virtual bool actual_gate_matched(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			/*!
			...
			*/
			...
			virtual bool formal_gate_distinguishable(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			/*!
			...
			*/
			...
			virtual bool inside_cf_gate_distinguishable(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			/*!
			...
			*/
			...
			virtual bool inside_cf_matched(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			/*!
			...
			*/
			...
			virtual bool outside_cf_gate_distinguishable(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			/*!
			...
			*/
			...
			virtual bool outside_cf_matched(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
