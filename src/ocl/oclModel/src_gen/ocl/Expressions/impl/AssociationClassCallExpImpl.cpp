...
bool AssociationClassCallExpImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::ASSOCIATIONCLASSCALLEXP_ATTRIBUTE_REFERREDASSOCIATIONCLASS:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> AssociationClassCallExpImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
