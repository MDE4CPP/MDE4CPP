...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> WriteLinkActionObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	...
	{
		std::shared_ptr<Bag<uml::InputPin>> inputList = m_WriteLinkActionValue->getInput();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Action_localPostcondition())
	{
		std::shared_ptr<Bag<uml::Constraint>> localPostconditionList = m_WriteLinkActionValue->getLocalPostcondition();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Action_localPrecondition())
	{
		std::shared_ptr<Bag<uml::Constraint>> localPreconditionList = m_WriteLinkActionValue->getLocalPrecondition();
	...
	{
		std::shared_ptr<Bag<uml::OutputPin>> outputList = m_WriteLinkActionValue->getOutput();
	...
	{
		std::shared_ptr<Bag<uml::ActivityGroup>> inGroupList = m_WriteLinkActionValue->getInGroup();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inInterruptibleRegion())
	{
		std::shared_ptr<Bag<uml::InterruptibleActivityRegion>> inInterruptibleRegionList = m_WriteLinkActionValue->getInInterruptibleRegion();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inPartition())
	{
		std::shared_ptr<Bag<uml::ActivityPartition>> inPartitionList = m_WriteLinkActionValue->getInPartition();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_redefinedNode())
	{
		std::shared_ptr<Bag<uml::ActivityNode>> redefinedNodeList = m_WriteLinkActionValue->getRedefinedNode();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Bag<uml::Comment>> ownedCommentList = m_WriteLinkActionValue->getOwnedComment();
	...
	{
		std::shared_ptr<Bag<uml::Element>> ownedElementList = m_WriteLinkActionValue->getOwnedElement();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ExecutableNode_handler())
	{
		std::shared_ptr<Bag<uml::ExceptionHandler>> handlerList = m_WriteLinkActionValue->getHandler();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_LinkAction_endData())
	{
		std::shared_ptr<Bag<uml::LinkEndData>> endDataList = m_WriteLinkActionValue->getEndData();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_LinkAction_inputValue())
	{
		std::shared_ptr<Bag<uml::InputPin>> inputValueList = m_WriteLinkActionValue->getInputValue();
	...
	{
		std::shared_ptr<Bag<uml::RedefinableElement>> redefinedElementList = m_WriteLinkActionValue->getRedefinedElement();
	...
	{
		std::shared_ptr<Bag<uml::Classifier>> redefinitionContextList = m_WriteLinkActionValue->getRedefinitionContext();
