...
namespace uml 
{
	...
	class ConditionalNode:virtual public StructuredActivityNode	{
		...
		public:
			...
			input->isEmpty() */ 
			virtual bool
			 no_input_pins(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 one_clause_with_executable_node(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 clause_no_predecessor(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
