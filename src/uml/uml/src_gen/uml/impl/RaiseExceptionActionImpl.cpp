...
bool RaiseExceptionActionImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::RAISEEXCEPTIONACTION_ATTRIBUTE_EXCEPTION:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> RaiseExceptionActionImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
