...
namespace fUML::Semantics::Values 
{
	...
	class FUML_API LiteralUnlimitedNaturalEvaluation: virtual public LiteralEvaluation
	{
		public:
...
#endif /* end of include guard: FUML_SEMANTICS_VALUES_LITERALUNLIMITEDNATURALEVALUATION_HPP */
