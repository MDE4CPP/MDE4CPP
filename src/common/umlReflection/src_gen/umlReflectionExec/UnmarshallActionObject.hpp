...
#ifndef UML_UNMARSHALLACTION_EXECUTION_HPP
#define UML_UNMARSHALLACTION_EXECUTION_HPP
...
namespace UML 
{
	class UnmarshallActionObject : virtual public UML::ActionObject
	{
		public:
		    //constructors
		    UnmarshallActionObject(UnmarshallActionObject &obj);
		    UnmarshallActionObject(std::shared_ptr<uml::UnmarshallAction>);
		 	UnmarshallActionObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::UnmarshallAction> getUnmarshallActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setUnmarshallActionValue(std::shared_ptr<uml::UnmarshallAction>);
			virtual void setThisUnmarshallActionObjectPtr(std::weak_ptr<UnmarshallActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::UnmarshallAction> m_UnmarshallActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_UNMARSHALLACTION_OBJECT_HPP */
