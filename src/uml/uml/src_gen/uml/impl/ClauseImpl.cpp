...
bool ClauseImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::CLAUSE_ATTRIBUTE_BODY:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ClauseImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
