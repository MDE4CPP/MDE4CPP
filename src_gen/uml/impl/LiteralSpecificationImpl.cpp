...
ecore::EClass* LiteralSpecificationImpl::eStaticClass() const
{
...
// Union Getter
//*********************************
std::vector<uml::Element * > *  LiteralSpecificationImpl::getOwnedElement() const
{
...
uml::Element *  LiteralSpecificationImpl::getOwner() const
{
