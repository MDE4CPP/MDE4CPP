...
BuildComponentImpl::BuildComponentImpl()
{
	...
	*/
	...
	//getter init
		...
		m_getterMap.insert(std::pair<long long,std::function<Any()>>(1091275515,[this](){ return eAny(this->getBase_Component(), uml::umlPackage::COMPONENT_CLASS, false);}));
	
	
	//setter init
	//Property base_Component
		m_setterMap.insert(std::pair<long long,std::function<void(Any)>>(1091275515,[this](Any object){this->setBase_Component(object->get<std::shared_ptr<uml::Component>>());}));
	
	
	//unsetter init
		//Property base_Component
		m_unsetterMap.insert(std::pair<long long,std::function<void()>>(1091275515,[this](){m_base_Component = std::shared_ptr<uml::Component>(nullptr);}));
...
Any BuildComponentImpl::get(long long _uID) const
{
...
void BuildComponentImpl::set(std::string _qualifiedName, Any value)
{
	long long uID = util::Util::polynomialRollingHash(_qualifiedName);
    this->set(uID, value);
}

void BuildComponentImpl::set(long long _uID, Any value)
{
...
void BuildComponentImpl::unset(long long _uID)
{
...
//*********************************
//Invoke
Any BuildComponentImpl::invoke(std::shared_ptr<uml::Operation> _operation, std::shared_ptr<Bag<Any>> _arguments)
{
...
Any BuildComponentImpl::invoke(std::string _qualifiedName, std::shared_ptr<Bag<Any>> _arguments)
{
	long long uID = util::Util::polynomialRollingHash(_qualifiedName);
    return this->invoke(uID, _arguments);
}

Any BuildComponentImpl::invoke(long long _uID, std::shared_ptr<Bag<Any>> _arguments)
{
