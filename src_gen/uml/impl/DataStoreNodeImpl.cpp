...
//Additional constructor for the containments back reference
			DataStoreNodeImpl::DataStoreNodeImpl(std::shared_ptr<uml::Activity > par_activity)
			:DataStoreNodeImpl()
			{
...
//Additional constructor for the containments back reference
			DataStoreNodeImpl::DataStoreNodeImpl(std::shared_ptr<uml::Namespace > par_namespace)
			:DataStoreNodeImpl()
			{
