...
#ifndef UML_BEHAVIOREXECUTIONSPECIFICATION_EXECUTION_HPP
#define UML_BEHAVIOREXECUTIONSPECIFICATION_EXECUTION_HPP
...
namespace UML 
{
	class BehaviorExecutionSpecificationObject : virtual public UML::ExecutionSpecificationObject
	{
		public:
		    //constructors
		    BehaviorExecutionSpecificationObject(BehaviorExecutionSpecificationObject &obj);
		    BehaviorExecutionSpecificationObject(std::shared_ptr<uml::BehaviorExecutionSpecification>);
		 	BehaviorExecutionSpecificationObject();
		    //destructor
		    virtual ~BehaviorExecutionSpecificationObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			BehaviorExecutionSpecificationObject& operator=(BehaviorExecutionSpecificationObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::BehaviorExecutionSpecification> getBehaviorExecutionSpecificationValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setBehaviorExecutionSpecificationValue(std::shared_ptr<uml::BehaviorExecutionSpecification>);
			virtual void setThisBehaviorExecutionSpecificationObjectPtr(std::weak_ptr<BehaviorExecutionSpecificationObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::BehaviorExecutionSpecification> m_BehaviorExecutionSpecificationValue = nullptr;
	};
}
#endif /* end of include guard: UML_BEHAVIOREXECUTIONSPECIFICATION_OBJECT_HPP */
