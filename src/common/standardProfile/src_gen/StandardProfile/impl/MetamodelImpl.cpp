...
MetamodelImpl::MetamodelImpl()
{
	...
	*/
	...
	//getter init
		//Property base_Model
		m_getterMap.insert(std::pair<long long,std::function<Any()>>(377161386,[this](){ return eAny(this->getBase_Model(), uml::umlPackage::MODEL_CLASS, false);}));
	
	
	//setter init
	//Property base_Model
		m_setterMap.insert(std::pair<long long,std::function<void(Any)>>(377161386,[this](Any object){this->setBase_Model(object->get<std::shared_ptr<uml::Model>>());}));
	
	
	//unsetter init
		//Property base_Model
		m_unsetterMap.insert(std::pair<long long,std::function<void()>>(377161386,[this](){m_base_Model = std::shared_ptr<uml::Model>(nullptr);}));
...
Any MetamodelImpl::get(long long _uID) const
{
...
void MetamodelImpl::set(long long _uID, Any value)
{
...
void MetamodelImpl::unset(long long _uID)
{
...
Any MetamodelImpl::invoke(long long _uID, std::shared_ptr<Bag<Any>> _arguments)
{
