...
void ActivitiesPackageImpl::createActivityEdgeInstanceContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_activityEdgeInstance_Attribute_edge = factory->createEReference_as_eStructuralFeatures_in_EClass(m_activityEdgeInstance_Class, ACTIVITYEDGEINSTANCE_ATTRIBUTE_EDGE);
	m_activityEdgeInstance_Attribute_group = factory->createEReference_as_eStructuralFeatures_in_EClass(m_activityEdgeInstance_Class, ACTIVITYEDGEINSTANCE_ATTRIBUTE_GROUP);
	m_activityEdgeInstance_Attribute_offers = factory->createEReference_as_eStructuralFeatures_in_EClass(m_activityEdgeInstance_Class, ACTIVITYEDGEINSTANCE_ATTRIBUTE_OFFERS);
	m_activityEdgeInstance_Attribute_source = factory->createEReference_as_eStructuralFeatures_in_EClass(m_activityEdgeInstance_Class, ACTIVITYEDGEINSTANCE_ATTRIBUTE_SOURCE);
	m_activityEdgeInstance_Attribute_target = factory->createEReference_as_eStructuralFeatures_in_EClass(m_activityEdgeInstance_Class, ACTIVITYEDGEINSTANCE_ATTRIBUTE_TARGET);
...
void ActivitiesPackageImpl::createActivityExecutionContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_activityExecution_Attribute_activationGroup = factory->createEReference_as_eStructuralFeatures_in_EClass(m_activityExecution_Class, ACTIVITYEXECUTION_ATTRIBUTE_ACTIVATIONGROUP);
	m_activityExecution_Attribute_activity = factory->createEReference_as_eStructuralFeatures_in_EClass(m_activityExecution_Class, ACTIVITYEXECUTION_ATTRIBUTE_ACTIVITY);
...
void ActivitiesPackageImpl::createActivityNodeActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_activityNodeActivation_Attribute_running = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_activityNodeActivation_Class, ACTIVITYNODEACTIVATION_ATTRIBUTE_RUNNING);
	
	m_activityNodeActivation_Attribute_group = factory->createEReference_as_eStructuralFeatures_in_EClass(m_activityNodeActivation_Class, ACTIVITYNODEACTIVATION_ATTRIBUTE_GROUP);
	m_activityNodeActivation_Attribute_heldTokens = factory->createEReference_as_eStructuralFeatures_in_EClass(m_activityNodeActivation_Class, ACTIVITYNODEACTIVATION_ATTRIBUTE_HELDTOKENS);
	m_activityNodeActivation_Attribute_incomingEdges = factory->createEReference_as_eStructuralFeatures_in_EClass(m_activityNodeActivation_Class, ACTIVITYNODEACTIVATION_ATTRIBUTE_INCOMINGEDGES);
	m_activityNodeActivation_Attribute_node = factory->createEReference_as_eStructuralFeatures_in_EClass(m_activityNodeActivation_Class, ACTIVITYNODEACTIVATION_ATTRIBUTE_NODE);
	m_activityNodeActivation_Attribute_outgoingEdges = factory->createEReference_as_eStructuralFeatures_in_EClass(m_activityNodeActivation_Class, ACTIVITYNODEACTIVATION_ATTRIBUTE_OUTGOINGEDGES);
...
void ActivitiesPackageImpl::createActivityNodeActivationGroupContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_activityNodeActivationGroup_Attribute_activityExecution = factory->createEReference_as_eStructuralFeatures_in_EClass(m_activityNodeActivationGroup_Class, ACTIVITYNODEACTIVATIONGROUP_ATTRIBUTE_ACTIVITYEXECUTION);
	m_activityNodeActivationGroup_Attribute_containingNodeActivation = factory->createEReference_as_eStructuralFeatures_in_EClass(m_activityNodeActivationGroup_Class, ACTIVITYNODEACTIVATIONGROUP_ATTRIBUTE_CONTAININGNODEACTIVATION);
	m_activityNodeActivationGroup_Attribute_edgeInstances = factory->createEReference_as_eStructuralFeatures_in_EClass(m_activityNodeActivationGroup_Class, ACTIVITYNODEACTIVATIONGROUP_ATTRIBUTE_EDGEINSTANCES);
	m_activityNodeActivationGroup_Attribute_nodeActivations = factory->createEReference_as_eStructuralFeatures_in_EClass(m_activityNodeActivationGroup_Class, ACTIVITYNODEACTIVATIONGROUP_ATTRIBUTE_NODEACTIVATIONS);
	m_activityNodeActivationGroup_Attribute_suspendedActivations = factory->createEReference_as_eStructuralFeatures_in_EClass(m_activityNodeActivationGroup_Class, ACTIVITYNODEACTIVATIONGROUP_ATTRIBUTE_SUSPENDEDACTIVATIONS);
...
void ActivitiesPackageImpl::createDecisionNodeActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_decisionNodeActivation_Attribute_decisionInputExecution = factory->createEReference_as_eStructuralFeatures_in_EClass(m_decisionNodeActivation_Class, DECISIONNODEACTIVATION_ATTRIBUTE_DECISIONINPUTEXECUTION);
	m_decisionNodeActivation_Attribute_decisionNode = factory->createEReference_as_eStructuralFeatures_in_EClass(m_decisionNodeActivation_Class, DECISIONNODEACTIVATION_ATTRIBUTE_DECISIONNODE);
...
void ActivitiesPackageImpl::createExpansionActivationGroupContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_expansionActivationGroup_Attribute_index = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_expansionActivationGroup_Class, EXPANSIONACTIVATIONGROUP_ATTRIBUTE_INDEX);
	
	m_expansionActivationGroup_Attribute_groupInputs = factory->createEReference_as_eStructuralFeatures_in_EClass(m_expansionActivationGroup_Class, EXPANSIONACTIVATIONGROUP_ATTRIBUTE_GROUPINPUTS);
	m_expansionActivationGroup_Attribute_groupOutputs = factory->createEReference_as_eStructuralFeatures_in_EClass(m_expansionActivationGroup_Class, EXPANSIONACTIVATIONGROUP_ATTRIBUTE_GROUPOUTPUTS);
	m_expansionActivationGroup_Attribute_regionActivation = factory->createEReference_as_eStructuralFeatures_in_EClass(m_expansionActivationGroup_Class, EXPANSIONACTIVATIONGROUP_ATTRIBUTE_REGIONACTIVATION);
	m_expansionActivationGroup_Attribute_regionInputs = factory->createEReference_as_eStructuralFeatures_in_EClass(m_expansionActivationGroup_Class, EXPANSIONACTIVATIONGROUP_ATTRIBUTE_REGIONINPUTS);
...
void ActivitiesPackageImpl::createExpansionRegionActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_expansionRegionActivation_Attribute_next = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_expansionRegionActivation_Class, EXPANSIONREGIONACTIVATION_ATTRIBUTE_NEXT);
	
	m_expansionRegionActivation_Attribute_activationGroups = factory->createEReference_as_eStructuralFeatures_in_EClass(m_expansionRegionActivation_Class, EXPANSIONREGIONACTIVATION_ATTRIBUTE_ACTIVATIONGROUPS);
	m_expansionRegionActivation_Attribute_inputExpansionTokens = factory->createEReference_as_eStructuralFeatures_in_EClass(m_expansionRegionActivation_Class, EXPANSIONREGIONACTIVATION_ATTRIBUTE_INPUTEXPANSIONTOKENS);
	m_expansionRegionActivation_Attribute_inputTokens = factory->createEReference_as_eStructuralFeatures_in_EClass(m_expansionRegionActivation_Class, EXPANSIONREGIONACTIVATION_ATTRIBUTE_INPUTTOKENS);
...
void ActivitiesPackageImpl::createForkedTokenContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_forkedToken_Attribute_baseTokenIsWithdrawn = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_forkedToken_Class, FORKEDTOKEN_ATTRIBUTE_BASETOKENISWITHDRAWN);
	m_forkedToken_Attribute_remainingOffersCount = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_forkedToken_Class, FORKEDTOKEN_ATTRIBUTE_REMAININGOFFERSCOUNT);
	
	m_forkedToken_Attribute_baseToken = factory->createEReference_as_eStructuralFeatures_in_EClass(m_forkedToken_Class, FORKEDTOKEN_ATTRIBUTE_BASETOKEN);
...
void ActivitiesPackageImpl::createObjectNodeActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_objectNodeActivation_Attribute_offeredTokenCount = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_objectNodeActivation_Class, OBJECTNODEACTIVATION_ATTRIBUTE_OFFEREDTOKENCOUNT);
...
void ActivitiesPackageImpl::createObjectTokenContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_objectToken_Attribute_value = factory->createEReference_as_eStructuralFeatures_in_EClass(m_objectToken_Class, OBJECTTOKEN_ATTRIBUTE_VALUE);
...
void ActivitiesPackageImpl::createOfferContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_offer_Attribute_offeredTokens = factory->createEReference_as_eStructuralFeatures_in_EClass(m_offer_Class, OFFER_ATTRIBUTE_OFFEREDTOKENS);
...
void ActivitiesPackageImpl::createTokenContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_token_Attribute_withdrawn = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_token_Class, TOKEN_ATTRIBUTE_WITHDRAWN);
	
	m_token_Attribute_holder = factory->createEReference_as_eStructuralFeatures_in_EClass(m_token_Class, TOKEN_ATTRIBUTE_HOLDER);
...
void ActivitiesPackageImpl::createTokenSetContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_tokenSet_Attribute_tokens = factory->createEReference_as_eStructuralFeatures_in_EClass(m_tokenSet_Class, TOKENSET_ATTRIBUTE_TOKENS);
