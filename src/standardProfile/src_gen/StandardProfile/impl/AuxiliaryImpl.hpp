...
#ifndef STANDARDPROFILE_AUXILIARYAUXILIARYIMPL_HPP
#define STANDARDPROFILE_AUXILIARYAUXILIARYIMPL_HPP
...
{
	class AuxiliaryImpl :virtual public ecore::EObjectImpl,
virtual public Auxiliary 
	{
		public: 
		...
		protected:
			...
			AuxiliaryImpl();
			virtual std::shared_ptr<Auxiliary> getThisAuxiliaryPtr() const;
...
#endif /* end of include guard: STANDARDPROFILE_AUXILIARYAUXILIARYIMPL_HPP */
