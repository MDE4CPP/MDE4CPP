...
#ifndef UML_MODEL_EXECUTION_HPP
#define UML_MODEL_EXECUTION_HPP
...
namespace UML 
{
	class ModelObject : virtual public UML::PackageObject
	{
		public:
		    //constructors
		    ModelObject(ModelObject &obj);
		    ModelObject(std::shared_ptr<uml::Model>);
		 	ModelObject();
		    //destructor
		    virtual ~ModelObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			ModelObject& operator=(ModelObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::Model> getModelValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setModelValue(std::shared_ptr<uml::Model>);
			virtual void setThisModelObjectPtr(std::weak_ptr<ModelObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Model> m_ModelValue = nullptr;
	};
}
#endif /* end of include guard: UML_MODEL_OBJECT_HPP */
