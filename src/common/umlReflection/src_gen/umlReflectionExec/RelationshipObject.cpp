...
{	
	if(m_RelationshipValue)
	{

	}

	m_RelationshipValue.reset();

	fUML::Semantics::StructuredClassifiers::ObjectImpl::destroy();
}

std::shared_ptr<uml::Element> RelationshipObject::getUmlValue() const
{
	return getRelationshipValue();
}

std::shared_ptr<uml::Relationship> RelationshipObject::getRelationshipValue() const
{
	return m_RelationshipValue;
}

void RelationshipObject::setUmlValue(std::shared_ptr<uml::Element> _element)
{
	setRelationshipValue(std::dynamic_pointer_cast<uml::Relationship>(_element));
}

void RelationshipObject::setRelationshipValue(std::shared_ptr<uml::Relationship> _RelationshipElement)
{
	m_RelationshipValue = _RelationshipElement;
	//set super type values
	UML::ElementObject::setElementValue(_RelationshipElement);
}

void RelationshipObject::setThisRelationshipObjectPtr(std::weak_ptr<RelationshipObject> thisObjectPtr)
{
	setThisCS_ObjectPtr(thisObjectPtr);
}

bool RelationshipObject::equals(std::shared_ptr<fUML::Semantics::Values::Value> otherValue)
{
	bool isEqual = false;
	
	std::shared_ptr<RelationshipObject> otherRelationshipObject = std::dynamic_pointer_cast<RelationshipObject>(otherValue);

	if(otherRelationshipObject != nullptr)
	{
		if(this->getRelationshipValue() == otherRelationshipObject->getRelationshipValue())
		{
			isEqual = true;
		}
	}
...
std::string RelationshipObject::toString()
{
	std::string buffer = "Instance of 'RelationshipObject', " + std::to_string(getTypes()->size()) + " types (";
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Object>> RelationshipObject::getDirectContainers()
{   
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Link>> RelationshipObject::getLinks(std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_InteractionPoint> interactionPoint)
{
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> RelationshipObject::retrieveEndValueAsInteractionPoint(std::shared_ptr<fUML::Semantics::Values::Value> endValue, std::shared_ptr<uml::ConnectorEnd> end)
{
	return nullptr;
}

void RelationshipObject::removeValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<fUML::Semantics::Values::Value> value)
{
	...
	if (m_RelationshipValue == nullptr)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": no value stored inside RelationshipObject (property: " << feature->getName() << ")" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		...
		{
			m_RelationshipValue->getOwnedComment()->clear();
		}
		else
		{
			...
			{
				m_RelationshipValue->getOwnedComment()->erase(inputValue->getCommentValue());
			}
		}
	}
}
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> RelationshipObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	if (feature->getMetaElementID() != uml::UmlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::UmlPackage::PORT_CLASS && feature->getMetaElementID() != uml::UmlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_owner())
	{
		...
		value->setThisElementObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setElementValue(m_RelationshipValue->getOwner().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
...
std::shared_ptr<fUML::Semantics::SimpleClassifiers::FeatureValue> RelationshipObject::retrieveFeatureValue(std::shared_ptr<uml::StructuralFeature> feature)
{
...
void RelationshipObject::setFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	if (feature->getMetaElementID() != uml::UmlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::UmlPackage::PORT_CLASS && feature->getMetaElementID() != uml::UmlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_RelationshipValue->getOwnedComment()->push_back(value->getCommentValue());
			}
...
void RelationshipObject::assignFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	this->setFeatureValue(feature, values, position);
}

std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> RelationshipObject::retrieveFeatureValues()
{
	...
	for(unsigned int i = 0; i < allAttributesSize; i++)
	{
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment() && m_RelationshipValue->getOwnedComment() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedElement() && m_RelationshipValue->getOwnedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_owner() && m_RelationshipValue->getOwner().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Relationship_relatedElement() && m_RelationshipValue->getRelatedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
	}
