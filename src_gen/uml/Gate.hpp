...
namespace uml 
{
	...
	class Gate:virtual public MessageEnd	{
		...
		public:
			...
			virtual bool
			 actual_gate_matched(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 inside_cf_matched(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 outside_cf_matched(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 formal_gate_distinguishable(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 actual_gate_distinguishable(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 outside_cf_gate_distinguishable(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 inside_cf_gate_distinguishable(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			<p>From package UML::Interactions.</p> */ 
			virtual bool
			 matches(std::shared_ptr<uml::Gate>  gateToMatch)  = 0;
