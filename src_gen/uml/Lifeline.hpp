...
namespace uml 
{
	...
	class Lifeline:virtual public NamedElement	{
		...
		public:
			...
			<p>From package UML::Interactions.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::InteractionFragment>>> getCoveredBy() const = 0;
		...
		protected:
			...
			/*!
			 References the InteractionFragments in which this Lifeline takes part.
			<p>From package UML::Interactions.</p> */
			std::shared_ptr<std::vector<std::shared_ptr<uml::InteractionFragment>>> m_coveredBy;
