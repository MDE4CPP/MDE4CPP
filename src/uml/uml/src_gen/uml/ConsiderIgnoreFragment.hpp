	...
	class UML_API ConsiderIgnoreFragment : virtual public CombinedFragment
	{
		...
		public:
			...
			*/
			...
			virtual bool consider_or_ignore(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool type(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
