...
ecore::EClass* ClearAssociationActionImpl::eStaticClass() const
{
...
// References
//*********************************
uml::Association *  ClearAssociationActionImpl::getAssociation() const
{
	//assert(m_association);
	return m_association;
}
void ClearAssociationActionImpl::setAssociation(uml::Association *  _association)
{
	m_association = _association;
}

uml::InputPin *  ClearAssociationActionImpl::getObject() const
{
	//assert(m_object);
	return m_object;
}
void ClearAssociationActionImpl::setObject(uml::InputPin *  _object)
{
	m_object = _object;
}
...
// Union Getter
//*********************************
std::vector<uml::ActivityGroup * > *  ClearAssociationActionImpl::getInGroup() const
{
...
std::vector<uml::InputPin * > *  ClearAssociationActionImpl::getInput() const
{
...
std::vector<uml::Element * > *  ClearAssociationActionImpl::getOwnedElement() const
{
...
uml::Element *  ClearAssociationActionImpl::getOwner() const
{
...
std::vector<uml::RedefinableElement * > *  ClearAssociationActionImpl::getRedefinedElement() const
{
