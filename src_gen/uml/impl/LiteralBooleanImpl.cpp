...
ecore::EClass* LiteralBooleanImpl::eStaticClass() const
{
...
// Union Getter
//*********************************
std::vector<uml::Element * > *  LiteralBooleanImpl::getOwnedElement() const
{
...
uml::Element *  LiteralBooleanImpl::getOwner() const
{
