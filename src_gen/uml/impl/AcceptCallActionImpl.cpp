...
//*********************************
bool
 AcceptCallActionImpl::result_pins(boost::any diagnostics,std::map <   boost::any, boost::any >  context) 
{
...
bool
 AcceptCallActionImpl::trigger_call_event(boost::any diagnostics,std::map <   boost::any, boost::any >  context) 
{
	std::cout << __PRETTY_FUNCTION__  << std::endl;
	throw "UnsupportedOperationException";
}
...
bool
 AcceptCallActionImpl::unmarshall(boost::any diagnostics,std::map <   boost::any, boost::any >  context) 
{
	std::cout << __PRETTY_FUNCTION__  << std::endl;
	throw "UnsupportedOperationException";
}
		...
		std::shared_ptr<Union<uml::ActivityGroup> > AcceptCallActionImpl::getInGroup() const
{
 ...
 AcceptCallActionImpl::getOutput() const
{
	return m_output;
}
