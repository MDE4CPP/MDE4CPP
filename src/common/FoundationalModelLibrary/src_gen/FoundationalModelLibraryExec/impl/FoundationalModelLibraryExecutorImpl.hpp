...
namespace FoundationalModelLibrary 
{
	class FoundationalModelLibraryExecutorImpl :virtual public /*PSCS::Semantics::Loci::CS_ExecutorImpl*/ fUML::Semantics::Loci::ExecutorImpl, virtual public FoundationalModelLibraryExecutor
	{
		private:    
			...
			std::shared_ptr<Bag<fUML::Semantics::CommonBehavior::ParameterValue>> invokeOpaqueBehavior(std::shared_ptr<uml::OpaqueBehavior>, std::shared_ptr<uml::Element>, std::shared_ptr<Bag<fUML::Semantics::CommonBehavior::ParameterValue>>);
		...
		public:
			...
			/*!
			 */ 
			virtual std::shared_ptr<Any> evaluate(std::shared_ptr<uml::ValueSpecification>);
			virtual std::shared_ptr<Bag<fUML::Semantics::CommonBehavior::ParameterValue>> execute(std::shared_ptr<uml::Behavior>, std::shared_ptr<uml::Element>, std::shared_ptr<Bag<fUML::Semantics::CommonBehavior::ParameterValue>>);
