...
#ifndef UML_SENDSIGNALACTION_EXECUTION_HPP
#define UML_SENDSIGNALACTION_EXECUTION_HPP
...
namespace UML 
{
	class SendSignalActionObject : virtual public UML::InvocationActionObject
	{
		public:
		    //constructors
		    SendSignalActionObject(SendSignalActionObject &obj);
		    SendSignalActionObject(std::shared_ptr<uml::SendSignalAction>);
		 	SendSignalActionObject();
		    //destructor
		    virtual ~SendSignalActionObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			SendSignalActionObject& operator=(SendSignalActionObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::SendSignalAction> getSendSignalActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setSendSignalActionValue(std::shared_ptr<uml::SendSignalAction>);
			virtual void setThisSendSignalActionObjectPtr(std::weak_ptr<SendSignalActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::SendSignalAction> m_SendSignalActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_SENDSIGNALACTION_OBJECT_HPP */
