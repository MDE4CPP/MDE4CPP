...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> ManifestationObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Dependency_client())
	{
		std::shared_ptr<Bag<uml::NamedElement>> clientList = m_ManifestationValue->getClient();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Dependency_supplier())
	{
		std::shared_ptr<Bag<uml::NamedElement>> supplierList = m_ManifestationValue->getSupplier();
	...
	{
		std::shared_ptr<Bag<uml::Element>> sourceList = m_ManifestationValue->getSource();
	...
	{
		std::shared_ptr<Bag<uml::Element>> targetList = m_ManifestationValue->getTarget();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Bag<uml::Comment>> ownedCommentList = m_ManifestationValue->getOwnedComment();
	...
	{
		std::shared_ptr<Bag<uml::Element>> ownedElementList = m_ManifestationValue->getOwnedElement();
	...
	{
		std::shared_ptr<Bag<uml::Element>> relatedElementList = m_ManifestationValue->getRelatedElement();
