...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> VariableActionObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	...
	{
		std::shared_ptr<Bag<uml::InputPin>> inputList = m_VariableActionValue->getInput();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Action_localPostcondition())
	{
		std::shared_ptr<Bag<uml::Constraint>> localPostconditionList = m_VariableActionValue->getLocalPostcondition();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Action_localPrecondition())
	{
		std::shared_ptr<Bag<uml::Constraint>> localPreconditionList = m_VariableActionValue->getLocalPrecondition();
	...
	{
		std::shared_ptr<Bag<uml::OutputPin>> outputList = m_VariableActionValue->getOutput();
	...
	{
		std::shared_ptr<Bag<uml::ActivityGroup>> inGroupList = m_VariableActionValue->getInGroup();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inInterruptibleRegion())
	{
		std::shared_ptr<Bag<uml::InterruptibleActivityRegion>> inInterruptibleRegionList = m_VariableActionValue->getInInterruptibleRegion();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inPartition())
	{
		std::shared_ptr<Bag<uml::ActivityPartition>> inPartitionList = m_VariableActionValue->getInPartition();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_redefinedNode())
	{
		std::shared_ptr<Bag<uml::ActivityNode>> redefinedNodeList = m_VariableActionValue->getRedefinedNode();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Bag<uml::Comment>> ownedCommentList = m_VariableActionValue->getOwnedComment();
	...
	{
		std::shared_ptr<Bag<uml::Element>> ownedElementList = m_VariableActionValue->getOwnedElement();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ExecutableNode_handler())
	{
		std::shared_ptr<Bag<uml::ExceptionHandler>> handlerList = m_VariableActionValue->getHandler();
	...
	{
		std::shared_ptr<Bag<uml::RedefinableElement>> redefinedElementList = m_VariableActionValue->getRedefinedElement();
	...
	{
		std::shared_ptr<Bag<uml::Classifier>> redefinitionContextList = m_VariableActionValue->getRedefinitionContext();
