...
ecore::EClass* ControlNodeImpl::eStaticClass() const
{
...
// Union Getter
//*********************************
std::vector<uml::ActivityGroup * > *  ControlNodeImpl::getInGroup() const
{
...
std::vector<uml::RedefinableElement * > *  ControlNodeImpl::getRedefinedElement() const
{
...
uml::Element *  ControlNodeImpl::getOwner() const
{
...
std::vector<uml::Element * > *  ControlNodeImpl::getOwnedElement() const
{
