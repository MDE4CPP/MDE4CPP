...
bool TupleLiteralExpEvalImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case ocl::Evaluations::EvaluationsPackage::TUPLELITERALEXPEVAL_ATTRIBUTE_TUPLEPART:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> TupleLiteralExpEvalImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
