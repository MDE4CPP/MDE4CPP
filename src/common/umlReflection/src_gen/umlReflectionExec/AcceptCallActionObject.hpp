...
#ifndef UML_ACCEPTCALLACTION_EXECUTION_HPP
#define UML_ACCEPTCALLACTION_EXECUTION_HPP
...
namespace UML 
{
	class AcceptCallActionObject : virtual public UML::AcceptEventActionObject
	{
		public:
		    //constructors
		    AcceptCallActionObject(AcceptCallActionObject &obj);
		    AcceptCallActionObject(std::shared_ptr<uml::AcceptCallAction>);
		 	AcceptCallActionObject();
		    //destructor
		    virtual ~AcceptCallActionObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			AcceptCallActionObject& operator=(AcceptCallActionObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::AcceptCallAction> getAcceptCallActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setAcceptCallActionValue(std::shared_ptr<uml::AcceptCallAction>);
			virtual void setThisAcceptCallActionObjectPtr(std::weak_ptr<AcceptCallActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::AcceptCallAction> m_AcceptCallActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_ACCEPTCALLACTION_OBJECT_HPP */
