...
namespace FoundationalModelLibrary 
{
	class FoundationalModelLibraryExecPluginImpl : virtual public FoundationalModelLibraryExecPlugin 
	{
		public:
			...
			virtual std::shared_ptr<Any> executeActivity(std::shared_ptr<uml::Activity>, std::shared_ptr<Bag<Any>>, std::shared_ptr<fUML::MDE4CPP_Extensions::FUML_Object>);
			virtual std::shared_ptr<Any> executeStateMachine(std::shared_ptr<uml::StateMachine>, std::shared_ptr<Bag<Any>>, std::shared_ptr<fUML::MDE4CPP_Extensions::FUML_Object>);
			virtual std::shared_ptr<Bag<fUML::Semantics::CommonBehavior::ParameterValue>> executeBehavior(std::shared_ptr<uml::Behavior>, std::shared_ptr<fUML::MDE4CPP_Extensions::FUML_Object>, std::shared_ptr<Bag<fUML::Semantics::CommonBehavior::ParameterValue>>);
			virtual std::shared_ptr<fUML::MDE4CPP_Extensions::FUML_Object> instantiateClass(std::shared_ptr<uml::Class>);
			virtual std::shared_ptr<fUML::MDE4CPP_Extensions::FUML_SignalInstance> instantiateSignal(std::shared_ptr<uml::Signal>);
