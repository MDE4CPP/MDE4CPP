...
Any IntegerLiteralExpImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::INTEGERLITERALEXP_ATTRIBUTE_INTEGERSYMBOL:
			return eAny(getIntegerSymbol(),ecore::ecorePackage::EINT_CLASS,false); //3423
	}
...
bool IntegerLiteralExpImpl::eSet(int featureID, const Any& newValue)
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::INTEGERLITERALEXP_ATTRIBUTE_INTEGERSYMBOL:
...
// EOperation Invoke
//*********************************
Any IntegerLiteralExpImpl::eInvoke(int operationID, const std::shared_ptr<std::list<Any>>& arguments)
{
	Any result;
