...
namespace uml 
{
	...
	class StateMachine:virtual public Behavior	{
		...
		public:
			...
			virtual bool
			 connection_points(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 classifier_context(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 method(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 context_classifier(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual std::shared_ptr<uml::Region> 
			 LCA(std::shared_ptr<uml::Vertex>  s1,std::shared_ptr<uml::Vertex>  s2)  = 0;
			...
			<p>From package UML::StateMachines.</p> */ 
			virtual bool
			 ancestor(std::shared_ptr<uml::Vertex>  s1,std::shared_ptr<uml::Vertex>  s2)  = 0;
			...
			virtual std::shared_ptr<uml::State> 
			 LCAState(std::shared_ptr<uml::Vertex>  v1,std::shared_ptr<uml::Vertex>  v2)  = 0;
			...
			virtual 	std::shared_ptr< Bag<uml::StateMachine> >
			 getExtendedStateMachine() const = 0;
