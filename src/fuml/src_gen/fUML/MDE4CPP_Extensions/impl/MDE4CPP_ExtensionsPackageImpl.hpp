...
namespace fUML::MDE4CPP_Extensions
{
	class FUML_API MDE4CPP_ExtensionsPackageImpl : public ecore::EPackageImpl ,virtual public MDE4CPP_ExtensionsPackage
	{
		...
		public:
			...
			virtual const std::shared_ptr<ecore::EOperation>& getFUML_Object_Operation_dispatchCall_Operation_EJavaObject() const ;
