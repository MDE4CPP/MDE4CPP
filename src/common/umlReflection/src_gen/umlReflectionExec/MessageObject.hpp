...
#ifndef UML_MESSAGE_EXECUTION_HPP
#define UML_MESSAGE_EXECUTION_HPP
...
namespace UML 
{
	class MessageObject : virtual public UML::NamedElementObject
	{
		public:
		    //constructors
		    MessageObject(MessageObject &obj);
		    MessageObject(std::shared_ptr<uml::Message>);
		 	MessageObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::Message> getMessageValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setMessageValue(std::shared_ptr<uml::Message>);
			virtual void setThisMessageObjectPtr(std::weak_ptr<MessageObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Message> m_MessageValue = nullptr;
	};
}
#endif /* end of include guard: UML_MESSAGE_OBJECT_HPP */
