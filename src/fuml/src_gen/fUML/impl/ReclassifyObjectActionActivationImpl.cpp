...
//Additional constructor for the containments back reference
			ReclassifyObjectActionActivationImpl::ReclassifyObjectActionActivationImpl(std::weak_ptr<fUML::ActivityNodeActivationGroup > par_group)
...
// Union Getter
//*********************************
std::shared_ptr<Union<fUML::PinActivation>> ReclassifyObjectActionActivationImpl::getPinActivation() const
{
