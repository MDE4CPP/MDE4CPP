...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> ModelObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Bag<uml::Comment>> ownedCommentList = m_ModelValue->getOwnedComment();
	...
	{
		std::shared_ptr<Bag<uml::Element>> ownedElementList = m_ModelValue->getOwnedElement();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_elementImport())
	{
		std::shared_ptr<Bag<uml::ElementImport>> elementImportList = m_ModelValue->getElementImport();
	...
	{
		std::shared_ptr<Bag<uml::PackageableElement>> importedMemberList = m_ModelValue->getImportedMember();
	...
	{
		std::shared_ptr<Bag<uml::NamedElement>> memberList = m_ModelValue->getMember();
	...
	{
		std::shared_ptr<Bag<uml::NamedElement>> ownedMemberList = m_ModelValue->getOwnedMember();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_ownedRule())
	{
		std::shared_ptr<Bag<uml::Constraint>> ownedRuleList = m_ModelValue->getOwnedRule();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_packageImport())
	{
		std::shared_ptr<Bag<uml::PackageImport>> packageImportList = m_ModelValue->getPackageImport();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Package_nestedPackage())
	{
		std::shared_ptr<Bag<uml::Package>> nestedPackageList = m_ModelValue->getNestedPackage();
	...
	{
		std::shared_ptr<Bag<uml::Stereotype>> ownedStereotypeList = m_ModelValue->getOwnedStereotype();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Package_ownedType())
	{
		std::shared_ptr<Bag<uml::Type>> ownedTypeList = m_ModelValue->getOwnedType();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Package_packageMerge())
	{
		std::shared_ptr<Bag<uml::PackageMerge>> packageMergeList = m_ModelValue->getPackageMerge();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Package_packagedElement())
	{
		std::shared_ptr<Bag<uml::PackageableElement>> packagedElementList = m_ModelValue->getPackagedElement();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Package_profileApplication())
	{
		std::shared_ptr<Bag<uml::ProfileApplication>> profileApplicationList = m_ModelValue->getProfileApplication();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateableElement_templateBinding())
	{
		std::shared_ptr<Bag<uml::TemplateBinding>> templateBindingList = m_ModelValue->getTemplateBinding();
