...
namespace uml 
{
	class CombinedFragmentImpl :virtual public InteractionFragmentImpl, virtual public CombinedFragment 
	{
		...
		public:
			...
			<p>From package UML::Interactions.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Gate>>> getCfragmentGate() const ;
			
			/*!
			 The set of operands of the combined fragment.
			<p>From package UML::Interactions.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::InteractionOperand>>> getOperand() const ;
