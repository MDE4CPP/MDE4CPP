...
void ParameterValueImpl::saveContent(std::shared_ptr<persistence::interfaces::XSaveHandler> saveHandler) const
{
	...
	// Add references
	if ( this->eIsSet(package->getParameterValue_Attribute_parameter()) )
	{
...
std::shared_ptr<Any> ParameterValueImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	...
	{
		case fUML::Semantics::CommonBehavior::CommonBehaviorPackage::PARAMETERVALUE_ATTRIBUTE_PARAMETER:
			return eAny(getParameter(),uml::umlPackage::PARAMETER_CLASS,false); //900
		case fUML::Semantics::CommonBehavior::CommonBehaviorPackage::PARAMETERVALUE_ATTRIBUTE_VALUES:
			return eAny(getValues(),ecore::ecorePackage::EJAVAOBJECT_CLASS,true); //901
	}
...
bool ParameterValueImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case fUML::Semantics::CommonBehavior::CommonBehaviorPackage::PARAMETERVALUE_ATTRIBUTE_PARAMETER:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ParameterValueImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
