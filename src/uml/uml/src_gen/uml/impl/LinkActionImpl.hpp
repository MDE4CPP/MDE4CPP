	...
	class UML_API LinkActionImpl : virtual public ActionImpl, virtual public LinkAction 
	{
		...
		public:
			...
			*/
			...
			virtual bool same_association(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			/*!
			...
			*/
			...
			virtual bool same_pins(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
