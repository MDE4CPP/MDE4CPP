...
#ifndef UML_TYPE_EXECUTION_HPP
#define UML_TYPE_EXECUTION_HPP
...
namespace UML 
{
	class TypeObject : virtual public UML::PackageableElementObject
	{
		public:
		    //constructors
		    TypeObject(TypeObject &obj);
		    TypeObject(std::shared_ptr<uml::Type>);
		 	TypeObject();
		    //destructor
		    virtual ~TypeObject();
			...
			virtual std::shared_ptr<uml::Type> getTypeValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setTypeValue(std::shared_ptr<uml::Type>);
			virtual void setThisTypeObjectPtr(std::weak_ptr<TypeObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Type> m_TypeValue = nullptr;
	};
}
#endif /* end of include guard: UML_TYPE_OBJECT_HPP */
