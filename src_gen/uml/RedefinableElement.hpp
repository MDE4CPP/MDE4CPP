...
namespace uml 
{
	...
	class RedefinableElement:virtual public NamedElement	{
		...
		public:
			...
			<p>From package UML::Classification.</p> */ 
			virtual bool isConsistentWith(uml::RedefinableElement *  redefiningElement)  = 0;
			...
			<p>From package UML::Classification.</p> */ 
			virtual bool isRedefinitionContextValid(uml::RedefinableElement *  redefinedElement)  = 0;
		...
		protected:
			...
			<p>From package UML::Classification.</p> */
			std::vector<uml::RedefinableElement * > *  m_redefinedElement =  nullptr ;
			/*!
			 The contexts that this element may be redefined from.
			<p>From package UML::Classification.</p> */
			std::vector<uml::Classifier * > *  m_redefinitionContext =  nullptr ;
