...
FlowFinalNodeActivationImpl::FlowFinalNodeActivationImpl(const FlowFinalNodeActivationImpl & obj): ControlNodeActivationImpl(obj), FlowFinalNodeActivation(obj)
{
