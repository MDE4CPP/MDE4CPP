...
void TokenSetImpl::saveContent(std::shared_ptr<persistence::interfaces::XSaveHandler> saveHandler) const
{
	...
	// Add references
	if ( this->eIsSet(package->getTokenSet_Attribute_tokens()) )
	{
...
std::shared_ptr<Any> TokenSetImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	...
	{
		case fUML::Semantics::Activities::ActivitiesPackage::TOKENSET_ATTRIBUTE_TOKENS:
			return eEcoreContainerAny(getTokens(),fUML::Semantics::Activities::ActivitiesPackage::TOKEN_CLASS); //1190
	}
...
bool TokenSetImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case fUML::Semantics::Activities::ActivitiesPackage::TOKENSET_ATTRIBUTE_TOKENS:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> TokenSetImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
