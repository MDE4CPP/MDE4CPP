...
#ifndef UML_PARAMETER_EXECUTION_HPP
#define UML_PARAMETER_EXECUTION_HPP
...
namespace UML 
{
	class ParameterObject : virtual public UML::ConnectableElementObject , virtual public UML::MultiplicityElementObject
	{
		public:
		    //constructors
		    ParameterObject(ParameterObject &obj);
		    ParameterObject(std::shared_ptr<uml::Parameter>);
		 	ParameterObject();
		    //destructor
		    virtual ~ParameterObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			ParameterObject& operator=(ParameterObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::Parameter> getParameterValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setParameterValue(std::shared_ptr<uml::Parameter>);
			virtual void setThisParameterObjectPtr(std::weak_ptr<ParameterObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Parameter> m_ParameterValue = nullptr;
	};
}
#endif /* end of include guard: UML_PARAMETER_OBJECT_HPP */
