...
bool DeploymentTargetImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::DEPLOYMENTTARGET_ATTRIBUTE_DEPLOYMENT:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> DeploymentTargetImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
