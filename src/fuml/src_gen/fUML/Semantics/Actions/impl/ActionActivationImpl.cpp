...
void ActionActivationImpl::createNodeActivations()
{
	...
	const std::shared_ptr<Bag<uml::OutputPin>>& outputPins = action->getOutput();
...
std::shared_ptr<uml::Association> ActionActivationImpl::getAssociation(const std::shared_ptr<uml::StructuralFeature>& feature)
{
	//ADD_COUNT(__PRETTY_FUNCTION__)
	//generated from body annotation
...
std::shared_ptr<Bag<fUML::MDE4CPP_Extensions::FUML_Link>> ActionActivationImpl::getMatchingLinks(const std::shared_ptr<uml::Association>& association, const std::shared_ptr<uml::StructuralFeature>& end, const std::shared_ptr<fUML::MDE4CPP_Extensions::FUML_Object>& oppositeValue)
{
	//ADD_COUNT(__PRETTY_FUNCTION__)
	//generated from body annotation
...
std::shared_ptr<Bag<fUML::MDE4CPP_Extensions::FUML_Link>> ActionActivationImpl::getMatchingLinksForEndValue(const std::shared_ptr<uml::Association>& association, const std::shared_ptr<uml::StructuralFeature>& end, const std::shared_ptr<fUML::MDE4CPP_Extensions::FUML_Object>& oppositeValue, const std::shared_ptr<fUML::MDE4CPP_Extensions::FUML_Object>& endValue)
{
	//ADD_COUNT(__PRETTY_FUNCTION__)
	//generated from body annotation
		// Get the links of the given binary association whose end opposite
...
std::shared_ptr<uml::Property> ActionActivationImpl::getOppositeEnd(const std::shared_ptr<uml::Association>& association, const std::shared_ptr<uml::StructuralFeature>& end)
{
	//ADD_COUNT(__PRETTY_FUNCTION__)
	//generated from body annotation
   	...
   	for(const std::shared_ptr<fUML::Semantics::Activities::Token>& token : *tokenList)
    	{
    		std::shared_ptr<fUML::Semantics::Activities::ObjectToken> objToken = std::dynamic_pointer_cast<fUML::Semantics::Activities::ObjectToken>(token);
        		if(objToken!=nullptr)
        		{
            		const std::shared_ptr<Any>& value = objToken->getValue();
            		if(value != nullptr)
            		{
...
bool ActionActivationImpl::isReady()
{
	//ADD_COUNT(__PRETTY_FUNCTION__)
	//generated from body annotation
	const std::shared_ptr<uml::Action>& actionNode = this->getAction();
    bool ready = false;
...
void ActionActivationImpl::sendOffers()
{
	...
	const std::shared_ptr<Subset<fUML::Semantics::Actions::OutputPinActivation, fUML::Semantics::Actions::PinActivation>>& outputPins=this->getOutputPinActivation();
...
bool ActionActivationImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case fUML::Semantics::Actions::ActionsPackage::ACTIONACTIVATION_ATTRIBUTE_ACTION:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ActionActivationImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
  	...
  	switch(operationID)
	{
		...
		// fUML::Semantics::Actions::ActionActivation::getAssociation(uml::StructuralFeature) : uml::Association: 2442191042
		case ActionsPackage::ACTIONACTIVATION_OPERATION_GETASSOCIATION_STRUCTURALFEATURE:
		{
		...
		// fUML::Semantics::Actions::ActionActivation::getOppositeEnd(uml::Association, uml::StructuralFeature) : uml::Property: 2375095834
		case ActionsPackage::ACTIONACTIVATION_OPERATION_GETOPPOSITEEND_ASSOCIATION_STRUCTURALFEATURE:
		{
			//Retrieve input parameter 'association'
			//parameter 0
			std::shared_ptr<uml::Association> incoming_param_association;
