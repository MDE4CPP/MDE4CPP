#include "umlReflectionExec/ActionExecutionSpecificationObject.hpp"

//General Includes
#include "abstractDataTypes/SubsetUnion.hpp"
#include "uml/ActionExecutionSpecification.hpp"
...
{	
	if(m_ActionExecutionSpecificationValue)
	{

	}

	m_ActionExecutionSpecificationValue.reset();

	fUML::Semantics::StructuredClassifiers::ObjectImpl::destroy();
}

std::shared_ptr<uml::Element> ActionExecutionSpecificationObject::getUmlValue() const
{
	return getActionExecutionSpecificationValue();
}

std::shared_ptr<uml::ActionExecutionSpecification> ActionExecutionSpecificationObject::getActionExecutionSpecificationValue() const
{
	return m_ActionExecutionSpecificationValue;
}

void ActionExecutionSpecificationObject::setUmlValue(std::shared_ptr<uml::Element> _element)
{
	setActionExecutionSpecificationValue(std::dynamic_pointer_cast<uml::ActionExecutionSpecification>(_element));
}

void ActionExecutionSpecificationObject::setActionExecutionSpecificationValue(std::shared_ptr<uml::ActionExecutionSpecification> _ActionExecutionSpecificationElement)
{
	m_ActionExecutionSpecificationValue = _ActionExecutionSpecificationElement;
	//set super type values
	UML::ExecutionSpecificationObject::setExecutionSpecificationValue(_ActionExecutionSpecificationElement);
}

void ActionExecutionSpecificationObject::setThisActionExecutionSpecificationObjectPtr(std::weak_ptr<ActionExecutionSpecificationObject> thisObjectPtr)
{
	setThisCS_ObjectPtr(thisObjectPtr);
}

bool ActionExecutionSpecificationObject::equals(std::shared_ptr<fUML::Semantics::Values::Value> otherValue)
{
	bool isEqual = false;
	
	std::shared_ptr<ActionExecutionSpecificationObject> otherActionExecutionSpecificationObject = std::dynamic_pointer_cast<ActionExecutionSpecificationObject>(otherValue);

	if(otherActionExecutionSpecificationObject != nullptr)
	{
		if(this->getActionExecutionSpecificationValue() == otherActionExecutionSpecificationObject->getActionExecutionSpecificationValue())
		{
			isEqual = true;
		}
	}
...
std::string ActionExecutionSpecificationObject::toString()
{
	std::string buffer = "Instance of 'ActionExecutionSpecificationObject', " + std::to_string(getTypes()->size()) + " types (";
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Object>> ActionExecutionSpecificationObject::getDirectContainers()
{   
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Link>> ActionExecutionSpecificationObject::getLinks(std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_InteractionPoint> interactionPoint)
{
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> ActionExecutionSpecificationObject::retrieveEndValueAsInteractionPoint(std::shared_ptr<fUML::Semantics::Values::Value> endValue, std::shared_ptr<uml::ConnectorEnd> end)
{
	return nullptr;
}

void ActionExecutionSpecificationObject::removeValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<fUML::Semantics::Values::Value> value)
{
	...
	if (m_ActionExecutionSpecificationValue == nullptr)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": no value stored inside ActionExecutionSpecificationObject (property: " << feature->getName() << ")" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		...
		{
			m_ActionExecutionSpecificationValue->getOwnedComment()->clear();
		}
		else
		{
			...
			{
				m_ActionExecutionSpecificationValue->getOwnedComment()->erase(inputValue->getCommentValue());
			}
		}
	}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_InteractionFragment_covered())
	{
		if (value == nullptr) // clear mode
		{
			m_ActionExecutionSpecificationValue->getCovered()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ActionExecutionSpecificationValue->getCovered()->erase(inputValue->getLifelineValue());
			}
		}
	}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_InteractionFragment_generalOrdering())
	{
		if (value == nullptr) // clear mode
		{
			m_ActionExecutionSpecificationValue->getGeneralOrdering()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ActionExecutionSpecificationValue->getGeneralOrdering()->erase(inputValue->getGeneralOrderingValue());
			}
		}
	}
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> ActionExecutionSpecificationObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	if (feature->getMetaElementID() != uml::UmlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::UmlPackage::PORT_CLASS && feature->getMetaElementID() != uml::UmlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActionExecutionSpecification_action())
	{
		...
		value->setActionValue(m_ActionExecutionSpecificationValue->getAction());
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Bag<uml::Comment>> ownedCommentList = m_ActionExecutionSpecificationValue->getOwnedComment();
	...
	{
		std::shared_ptr<Bag<uml::Element>> ownedElementList = m_ActionExecutionSpecificationValue->getOwnedElement();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_owner())
	{
		...
		value->setThisElementObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setElementValue(m_ActionExecutionSpecificationValue->getOwner().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ExecutionSpecification_finish())
	{
		...
		value->setLocus(this->getLocus());
		value->setOccurrenceSpecificationValue(m_ActionExecutionSpecificationValue->getFinish());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ExecutionSpecification_start())
	{
		...
		value->setThisOccurrenceSpecificationObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setOccurrenceSpecificationValue(m_ActionExecutionSpecificationValue->getStart());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_InteractionFragment_covered())
	{
		std::shared_ptr<Bag<uml::Lifeline>> coveredList = m_ActionExecutionSpecificationValue->getCovered();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_InteractionFragment_enclosingInteraction())
	{
		...
		value->setLocus(this->getLocus());
		value->setInteractionValue(m_ActionExecutionSpecificationValue->getEnclosingInteraction().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_InteractionFragment_enclosingOperand())
	{
		...
		value->setLocus(this->getLocus());
		value->setInteractionOperandValue(m_ActionExecutionSpecificationValue->getEnclosingOperand().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_InteractionFragment_generalOrdering())
	{
		std::shared_ptr<Bag<uml::GeneralOrdering>> generalOrderingList = m_ActionExecutionSpecificationValue->getGeneralOrdering();
	...
	{
		std::shared_ptr<Bag<uml::Dependency>> clientDependencyList = m_ActionExecutionSpecificationValue->getClientDependency();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		value->setValue(m_ActionExecutionSpecificationValue->getName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		value->setLocus(this->getLocus());
		value->setStringExpressionValue(m_ActionExecutionSpecificationValue->getNameExpression());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace())
	{
		...
		value->setLocus(this->getLocus());
		value->setNamespaceValue(m_ActionExecutionSpecificationValue->getNamespace().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::StringValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createStringValue();
		value->setValue(m_ActionExecutionSpecificationValue->getQualifiedName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		uml::VisibilityKind visibility = m_ActionExecutionSpecificationValue->getVisibility();
...
std::shared_ptr<fUML::Semantics::SimpleClassifiers::FeatureValue> ActionExecutionSpecificationObject::retrieveFeatureValue(std::shared_ptr<uml::StructuralFeature> feature)
{
...
void ActionExecutionSpecificationObject::setFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	if (feature->getMetaElementID() != uml::UmlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::UmlPackage::PORT_CLASS && feature->getMetaElementID() != uml::UmlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActionExecutionSpecification_action())
	{
		...
		if (value != nullptr)
		{
			m_ActionExecutionSpecificationValue->setAction(value->getActionValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ActionExecutionSpecificationValue->getOwnedComment()->push_back(value->getCommentValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ExecutionSpecification_finish())
	{
		...
		if (value != nullptr)
		{
			m_ActionExecutionSpecificationValue->setFinish(value->getOccurrenceSpecificationValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ExecutionSpecification_start())
	{
		...
		if (value != nullptr)
		{
			m_ActionExecutionSpecificationValue->setStart(value->getOccurrenceSpecificationValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_InteractionFragment_covered())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ActionExecutionSpecificationValue->getCovered()->push_back(value->getLifelineValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_InteractionFragment_generalOrdering())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ActionExecutionSpecificationValue->getGeneralOrdering()->push_back(value->getGeneralOrderingValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		{
			m_ActionExecutionSpecificationValue->setName(valueObject->getValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		if (value != nullptr)
		{
			m_ActionExecutionSpecificationValue->setNameExpression(value->getStringExpressionValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		...
		{
			m_ActionExecutionSpecificationValue->setVisibility(uml::VisibilityKind::PUBLIC);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_private())
		{
			m_ActionExecutionSpecificationValue->setVisibility(uml::VisibilityKind::PRIVATE);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_protected())
		{
			m_ActionExecutionSpecificationValue->setVisibility(uml::VisibilityKind::PROTECTED);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_package())
		{
			m_ActionExecutionSpecificationValue->setVisibility(uml::VisibilityKind::PACKAGE);
		}
		
	}
}

void ActionExecutionSpecificationObject::assignFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	this->setFeatureValue(feature, values, position);
}

std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> ActionExecutionSpecificationObject::retrieveFeatureValues()
{
	...
	for(unsigned int i = 0; i < allAttributesSize; i++)
	{
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_ActionExecutionSpecification_action() && m_ActionExecutionSpecificationValue->getAction() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment() && m_ActionExecutionSpecificationValue->getOwnedComment() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedElement() && m_ActionExecutionSpecificationValue->getOwnedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_owner() && m_ActionExecutionSpecificationValue->getOwner().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ExecutionSpecification_finish() && m_ActionExecutionSpecificationValue->getFinish() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ExecutionSpecification_start() && m_ActionExecutionSpecificationValue->getStart() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_InteractionFragment_covered() && m_ActionExecutionSpecificationValue->getCovered() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_InteractionFragment_enclosingInteraction() && m_ActionExecutionSpecificationValue->getEnclosingInteraction().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_InteractionFragment_enclosingOperand() && m_ActionExecutionSpecificationValue->getEnclosingOperand().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_InteractionFragment_generalOrdering() && m_ActionExecutionSpecificationValue->getGeneralOrdering() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_clientDependency() && m_ActionExecutionSpecificationValue->getClientDependency() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression() && m_ActionExecutionSpecificationValue->getNameExpression() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace() && m_ActionExecutionSpecificationValue->getNamespace().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
	}
