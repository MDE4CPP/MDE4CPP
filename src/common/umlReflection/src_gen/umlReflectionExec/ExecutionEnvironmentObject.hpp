...
#ifndef UML_EXECUTIONENVIRONMENT_EXECUTION_HPP
#define UML_EXECUTIONENVIRONMENT_EXECUTION_HPP
...
namespace UML 
{
	class ExecutionEnvironmentObject : virtual public UML::NodeObject
	{
		public:
		    //constructors
		    ExecutionEnvironmentObject(ExecutionEnvironmentObject &obj);
		    ExecutionEnvironmentObject(std::shared_ptr<uml::ExecutionEnvironment>);
		 	ExecutionEnvironmentObject();
		    //destructor
		    virtual ~ExecutionEnvironmentObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			ExecutionEnvironmentObject& operator=(ExecutionEnvironmentObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::ExecutionEnvironment> getExecutionEnvironmentValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setExecutionEnvironmentValue(std::shared_ptr<uml::ExecutionEnvironment>);
			virtual void setThisExecutionEnvironmentObjectPtr(std::weak_ptr<ExecutionEnvironmentObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ExecutionEnvironment> m_ExecutionEnvironmentValue = nullptr;
	};
}
#endif /* end of include guard: UML_EXECUTIONENVIRONMENT_OBJECT_HPP */
