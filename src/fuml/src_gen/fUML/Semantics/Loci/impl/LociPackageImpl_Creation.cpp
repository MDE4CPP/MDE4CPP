...
void LociPackageImpl::createExecutionFactoryContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_executionFactory_Operation_instantiateOpaqueBehaviorExecution_Behavior = factory->createEOperation_in_EContainingClass(m_executionFactory_Class, EXECUTIONFACTORY_OPERATION_INSTANTIATEOPAQUEBEHAVIOREXECUTION_BEHAVIOR);
