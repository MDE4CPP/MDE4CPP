...
bool ExpansionNodeImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::EXPANSIONNODE_ATTRIBUTE_REGIONASINPUT:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ExpansionNodeImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
