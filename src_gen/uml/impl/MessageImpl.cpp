...
// References
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::ValueSpecification>>> MessageImpl::getArgument() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> MessageImpl::getOwnedElement() const
{
