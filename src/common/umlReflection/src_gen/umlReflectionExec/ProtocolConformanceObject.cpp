...
{	
	if(m_ProtocolConformanceValue)
	{

	}

	m_ProtocolConformanceValue.reset();

	fUML::Semantics::StructuredClassifiers::ObjectImpl::destroy();
}

std::shared_ptr<uml::Element> ProtocolConformanceObject::getUmlValue() const
{
	return getProtocolConformanceValue();
}

std::shared_ptr<uml::ProtocolConformance> ProtocolConformanceObject::getProtocolConformanceValue() const
{
	return m_ProtocolConformanceValue;
}

void ProtocolConformanceObject::setUmlValue(std::shared_ptr<uml::Element> _element)
{
	setProtocolConformanceValue(std::dynamic_pointer_cast<uml::ProtocolConformance>(_element));
}

void ProtocolConformanceObject::setProtocolConformanceValue(std::shared_ptr<uml::ProtocolConformance> _ProtocolConformanceElement)
{
	m_ProtocolConformanceValue = _ProtocolConformanceElement;
	//set super type values
	UML::DirectedRelationshipObject::setDirectedRelationshipValue(_ProtocolConformanceElement);
}

void ProtocolConformanceObject::setThisProtocolConformanceObjectPtr(std::weak_ptr<ProtocolConformanceObject> thisObjectPtr)
{
	setThisCS_ObjectPtr(thisObjectPtr);
}

bool ProtocolConformanceObject::equals(std::shared_ptr<fUML::Semantics::Values::Value> otherValue)
{
	bool isEqual = false;
	
	std::shared_ptr<ProtocolConformanceObject> otherProtocolConformanceObject = std::dynamic_pointer_cast<ProtocolConformanceObject>(otherValue);

	if(otherProtocolConformanceObject != nullptr)
	{
		if(this->getProtocolConformanceValue() == otherProtocolConformanceObject->getProtocolConformanceValue())
		{
			isEqual = true;
		}
	}
...
std::string ProtocolConformanceObject::toString()
{
	std::string buffer = "Instance of 'ProtocolConformanceObject', " + std::to_string(getTypes()->size()) + " types (";
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Object>> ProtocolConformanceObject::getDirectContainers()
{   
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Link>> ProtocolConformanceObject::getLinks(std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_InteractionPoint> interactionPoint)
{
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> ProtocolConformanceObject::retrieveEndValueAsInteractionPoint(std::shared_ptr<fUML::Semantics::Values::Value> endValue, std::shared_ptr<uml::ConnectorEnd> end)
{
	return nullptr;
}

void ProtocolConformanceObject::removeValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<fUML::Semantics::Values::Value> value)
{
	...
	if (m_ProtocolConformanceValue == nullptr)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": no value stored inside ProtocolConformanceObject (property: " << feature->getName() << ")" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		...
		{
			m_ProtocolConformanceValue->getOwnedComment()->clear();
		}
		else
		{
			...
			{
				m_ProtocolConformanceValue->getOwnedComment()->erase(inputValue->getCommentValue());
			}
		}
	}
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> ProtocolConformanceObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	if (feature->getMetaElementID() != uml::UmlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::UmlPackage::PORT_CLASS && feature->getMetaElementID() != uml::UmlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_owner())
	{
		...
		value->setThisElementObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setElementValue(m_ProtocolConformanceValue->getOwner().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ProtocolConformance_generalMachine())
	{
		...
		value->setLocus(this->getLocus());
		value->setProtocolStateMachineValue(m_ProtocolConformanceValue->getGeneralMachine());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ProtocolConformance_specificMachine())
	{
		...
		value->setThisProtocolStateMachineObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setProtocolStateMachineValue(m_ProtocolConformanceValue->getSpecificMachine().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
...
std::shared_ptr<fUML::Semantics::SimpleClassifiers::FeatureValue> ProtocolConformanceObject::retrieveFeatureValue(std::shared_ptr<uml::StructuralFeature> feature)
{
...
void ProtocolConformanceObject::setFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	if (feature->getMetaElementID() != uml::UmlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::UmlPackage::PORT_CLASS && feature->getMetaElementID() != uml::UmlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ProtocolConformanceValue->getOwnedComment()->push_back(value->getCommentValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ProtocolConformance_generalMachine())
	{
		...
		if (value != nullptr)
		{
			m_ProtocolConformanceValue->setGeneralMachine(value->getProtocolStateMachineValue());
		}
		
	}
}

void ProtocolConformanceObject::assignFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	this->setFeatureValue(feature, values, position);
}

std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> ProtocolConformanceObject::retrieveFeatureValues()
{
	...
	for(unsigned int i = 0; i < allAttributesSize; i++)
	{
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_DirectedRelationship_source() && m_ProtocolConformanceValue->getSource() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_DirectedRelationship_target() && m_ProtocolConformanceValue->getTarget() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment() && m_ProtocolConformanceValue->getOwnedComment() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedElement() && m_ProtocolConformanceValue->getOwnedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_owner() && m_ProtocolConformanceValue->getOwner().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ProtocolConformance_generalMachine() && m_ProtocolConformanceValue->getGeneralMachine() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ProtocolConformance_specificMachine() && m_ProtocolConformanceValue->getSpecificMachine().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Relationship_relatedElement() && m_ProtocolConformanceValue->getRelatedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
	}
