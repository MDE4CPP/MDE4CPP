...
namespace ocl::Expressions 
{
	...
	class OCL_API CollectionRange : virtual public CollectionLiteralPart
	{
		...
		public:
			...
			//*********************************
			virtual const std::shared_ptr<ocl::Expressions::OclExpression>& getFirst() const = 0;
			virtual void setFirst(const std::shared_ptr<ocl::Expressions::OclExpression>&) = 0;
			virtual const std::shared_ptr<ocl::Expressions::OclExpression>& getLast() const = 0;
			virtual void setLast(const std::shared_ptr<ocl::Expressions::OclExpression>&) = 0;
