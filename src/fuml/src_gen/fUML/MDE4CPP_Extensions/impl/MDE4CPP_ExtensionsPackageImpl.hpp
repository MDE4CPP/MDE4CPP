...
namespace fUML::MDE4CPP_Extensions
{
	class FUML_API MDE4CPP_ExtensionsPackageImpl : public ecore::EPackageImpl ,virtual public MDE4CPP_ExtensionsPackage
	{
		...
		public:
			...
			virtual const std::shared_ptr<ecore::EOperation>& getFUML_Link_Operation_add_FUML_Object_Property_EInt() const ;
			virtual const std::shared_ptr<ecore::EOperation>& getFUML_Link_Operation_contains_FUML_Object() const ;
			...
			virtual const std::shared_ptr<ecore::EOperation>& getFUML_Link_Operation_retrieveOtherLinkEnd_Property() const ;
			virtual const std::shared_ptr<ecore::EOperation>& getFUML_Link_Operation_retrieveOtherLinkEndValue_Property() const ;
			...
			virtual const std::shared_ptr<ecore::EOperation>& getFUML_Object_Operation_dispatchCall_Operation_EJavaObject_EJavaObject() const ;
			virtual const std::shared_ptr<ecore::EOperation>& getFUML_Object_Operation_equals_FUML_Object() const ;
			virtual const std::shared_ptr<ecore::EOperation>& getFUML_Object_Operation_getTypes() const ;
			virtual const std::shared_ptr<ecore::EOperation>& getFUML_Object_Operation_invokeOpaqueBehavior_EString_EJavaObject_EJavaObject() const ;
			virtual const std::shared_ptr<ecore::EOperation>& getFUML_Object_Operation_invokeOpaqueBehavior_EInt_EJavaObject_EJavaObject() const ;
			virtual const std::shared_ptr<ecore::EOperation>& getFUML_Object_Operation_invokeOperation_EString_EJavaObject_EJavaObject() const ;
			virtual const std::shared_ptr<ecore::EOperation>& getFUML_Object_Operation_invokeOperation_EInt_EJavaObject_EJavaObject() const ;
			...
			virtual const std::shared_ptr<ecore::EOperation>& getFUML_SignalInstance_Operation_equals_FUML_SignalInstance() const ;
