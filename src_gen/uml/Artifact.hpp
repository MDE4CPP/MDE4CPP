...
namespace uml 
{
	...
	class Artifact:virtual public Classifier,virtual public DeployedArtifact	{
		...
		public:
			...
			<p>From package UML::Deployments.</p> */
			virtual std::vector<uml::Manifestation * > *  getManifestation() const = 0;
			
			/*!
			 The Artifacts that are defined (nested) within the Artifact. The association is a specialization of the ownedMember association from Namespace to NamedElement.
			<p>From package UML::Deployments.</p> */
			virtual std::vector<uml::Artifact * > *  getNestedArtifact() const = 0;
		...
		protected:
			...
			/*!
			 The set of model elements that are manifested in the Artifact. That is, these model elements are utilized in the construction (or generation) of the artifact.
			<p>From package UML::Deployments.</p> */
			std::vector<uml::Manifestation * > *  m_manifestation =  nullptr ;
			/*!
			 The Artifacts that are defined (nested) within the Artifact. The association is a specialization of the ownedMember association from Namespace to NamedElement.
			<p>From package UML::Deployments.</p> */
			std::vector<uml::Artifact * > *  m_nestedArtifact =  nullptr ;
			/*!
			 The attributes or association ends defined for the Artifact. The association is a specialization of the ownedMember association.
			<p>From package UML::Deployments.</p> */
