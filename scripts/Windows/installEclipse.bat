...
if "%MDE4CPP_ECLIPSE_VERSION%"=="" (
    echo [installEclipse] ERROR: MDE4CPP_ECLIPSE_VERSION is not set. See MDE$CPP/build.gradle file.
    exit /b 1
)
if "%MDE4CPP_ECLIPSE_MILESTONE%"=="" (
    echo [installEclipse] ERROR: MDE4CPP_ECLIPSE_MILESTONE is not set. See MDE$CPP/build.gradle file.
    exit /b 1
)
if "%MDE4CPP_ECLIPSE_ACCELEO_VERSION%"=="" (
    echo [installEclipse] ERROR: MDE4CPP_ECLIPSE_ACCELEO_VERSION is not set. See MDE$CPP/build.gradle file.
    exit /b 1
)
if "%MDE4CPP_ECLIPSE_SIRIUS_VERSION%"=="" (
    echo [installEclipse] ERROR: MDE4CPP_ECLIPSE_SIRIUS_VERSION is not set. See MDE$CPP/build.gradle file.
    exit /b 1
)
if "%MDE4CPP_ECLIPSE_SIRIUS_ECLIPSE_VERSION%"=="" (
    echo [installEclipse] ERROR: MDE4CPP_ECLIPSE_SIRIUS_ECLIPSE_VERSION is not set. See MDE$CPP/build.gradle file.
    exit /b 1
)
