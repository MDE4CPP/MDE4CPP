...
//*********************************
//Get
Any ModelLibraryImpl::get(const std::shared_ptr<uml::Property>& _property) const
{
...
//Set
void ModelLibraryImpl::set(const std::shared_ptr<uml::Property>& _property, const Any& value)
{
	std::string qualifiedName = _property->getQualifiedName();
    this->set(qualifiedName, value);
}

void ModelLibraryImpl::set(std::string _qualifiedName, const Any& value)
{
	unsigned long uID = util::Util::polynomialRollingHash(_qualifiedName);
    this->set(uID, value);
}

void ModelLibraryImpl::set(unsigned long _uID, const Any& value)
{
...
//*********************************
//Invoke
Any ModelLibraryImpl::invoke(const std::shared_ptr<uml::Operation>& _operation, const std::shared_ptr<Bag<Any>>& _arguments)
{
...
Any ModelLibraryImpl::invoke(std::string _qualifiedName, const std::shared_ptr<Bag<Any>>& _arguments)
{
	unsigned long uID = util::Util::polynomialRollingHash(_qualifiedName);
    return this->invoke(uID, _arguments);
}

Any ModelLibraryImpl::invoke(unsigned long _uID, const std::shared_ptr<Bag<Any>>& _arguments)
{
