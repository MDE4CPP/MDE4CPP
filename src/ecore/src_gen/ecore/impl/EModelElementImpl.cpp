...
EModelElementImpl& EModelElementImpl::operator=(const EModelElementImpl & obj)
{
	...
	{
		DEBUG_WARNING("container is nullptr for eAnnotations.")
	}
	/*Subset*/
	getEAnnotations()->initSubset(getEContentUnion());
	#ifdef SHOW_SUBSET_UNION
...
bool EModelElementImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case ecore::ecorePackage::EMODELELEMENT_ATTRIBUTE_EANNOTATIONS:
		{
			...
			if(ecoreContainerAny)
			{
				...
				{
					DEBUG_ERROR("Invalid type stored in 'ecore::ecoreContainerAny' for feature 'eAnnotations'. Failed to set feature!")
					return false;
				}
			}
			else
			{
				DEBUG_ERROR("Invalid instance of 'ecore::ecoreContainerAny' for feature 'eAnnotations'. Failed to set feature!")
				return false;
			}
		return true;
		}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> EModelElementImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
	std::shared_ptr<Any> result;
 
  	switch(operationID)
	{
		// ecore::EModelElement::getEAnnotation(std::string) : ecore::EAnnotation: 3174938665
		case ecorePackage::EMODELELEMENT_OPERATION_GETEANNOTATION_ESTRING:
		{
			...
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for parameter 'source'. Failed to invoke operation 'getEAnnotation'!")
				return nullptr;
			}
