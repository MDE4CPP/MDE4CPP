...
{
	std::shared_ptr<AddVariableValueActionObject> element(new AddVariableValueActionObject(*this));
...
{	
	if(m_AddVariableValueActionValue)
	{
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> AddVariableValueActionObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	...
	{
		std::shared_ptr<Bag<uml::InputPin>> inputList = m_AddVariableValueActionValue->getInput();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Action_localPostcondition())
	{
		std::shared_ptr<Bag<uml::Constraint>> localPostconditionList = m_AddVariableValueActionValue->getLocalPostcondition();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Action_localPrecondition())
	{
		std::shared_ptr<Bag<uml::Constraint>> localPreconditionList = m_AddVariableValueActionValue->getLocalPrecondition();
	...
	{
		std::shared_ptr<Bag<uml::OutputPin>> outputList = m_AddVariableValueActionValue->getOutput();
	...
	{
		std::shared_ptr<Bag<uml::ActivityGroup>> inGroupList = m_AddVariableValueActionValue->getInGroup();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inInterruptibleRegion())
	{
		std::shared_ptr<Bag<uml::InterruptibleActivityRegion>> inInterruptibleRegionList = m_AddVariableValueActionValue->getInInterruptibleRegion();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_inPartition())
	{
		std::shared_ptr<Bag<uml::ActivityPartition>> inPartitionList = m_AddVariableValueActionValue->getInPartition();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityNode_redefinedNode())
	{
		std::shared_ptr<Bag<uml::ActivityNode>> redefinedNodeList = m_AddVariableValueActionValue->getRedefinedNode();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Bag<uml::Comment>> ownedCommentList = m_AddVariableValueActionValue->getOwnedComment();
	...
	{
		std::shared_ptr<Bag<uml::Element>> ownedElementList = m_AddVariableValueActionValue->getOwnedElement();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ExecutableNode_handler())
	{
		std::shared_ptr<Bag<uml::ExceptionHandler>> handlerList = m_AddVariableValueActionValue->getHandler();
	...
	{
		std::shared_ptr<Bag<uml::RedefinableElement>> redefinedElementList = m_AddVariableValueActionValue->getRedefinedElement();
	...
	{
		std::shared_ptr<Bag<uml::Classifier>> redefinitionContextList = m_AddVariableValueActionValue->getRedefinitionContext();
