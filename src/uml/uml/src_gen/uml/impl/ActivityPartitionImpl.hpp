	...
	class UML_API ActivityPartitionImpl : virtual public ActivityGroupImpl, virtual public ActivityPartition 
	{
		...
		public:
			...
			*/
			...
			virtual bool dimension_not_contained(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			/*!
			...
			*/
			...
			virtual bool represents_classifier(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			/*!
			...
			*/
			...
			virtual bool represents_property(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			/*!
			...
			*/
			...
			virtual bool represents_property_and_is_contained(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			...
			*/
			...
			virtual void setRepresents(const std::shared_ptr<uml::Element>&) ;
			/*!
