...
#ifndef UML_BEHAVIOR_EXECUTION_HPP
#define UML_BEHAVIOR_EXECUTION_HPP
...
namespace UML 
{
	class BehaviorObject : virtual public UML::ClassObject
	{
		public:
		    //constructors
		    BehaviorObject(BehaviorObject &obj);
		    BehaviorObject(std::shared_ptr<uml::Behavior>);
		 	BehaviorObject();
		    //destructor
		    virtual ~BehaviorObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			BehaviorObject& operator=(BehaviorObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::Behavior> getBehaviorValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setBehaviorValue(std::shared_ptr<uml::Behavior>);
			virtual void setThisBehaviorObjectPtr(std::weak_ptr<BehaviorObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Behavior> m_BehaviorValue = nullptr;
	};
}
#endif /* end of include guard: UML_BEHAVIOR_OBJECT_HPP */
