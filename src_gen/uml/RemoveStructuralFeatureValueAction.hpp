...
namespace uml 
{
	...
	class RemoveStructuralFeatureValueAction:virtual public WriteStructuralFeatureAction	{
		public:
 			RemoveStructuralFeatureValueAction(const RemoveStructuralFeatureValueAction &) {}
			RemoveStructuralFeatureValueAction& operator=(RemoveStructuralFeatureValueAction const&) = delete;
		...
		public:
			...
			virtual bool
			 removeAt_and_value(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
