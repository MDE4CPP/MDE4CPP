	...
	class UML_API Element: virtual public Object
	{
		...
		public:
			...
			*/
			...
			virtual std::shared_ptr<ecore::EObject> applyStereotype(const std::shared_ptr<uml::Stereotype>& stereotype) = 0;
			/*!
			...
			*/
			...
			virtual std::shared_ptr<uml::Stereotype> getAppliedSubstereotype(const std::shared_ptr<uml::Stereotype>& stereotype, std::string qualifiedName) = 0;
			/*!
			...
			*/
			...
			virtual std::shared_ptr<ecore::EObject> getStereotypeApplication(const std::shared_ptr<uml::Stereotype>& stereotype) = 0;
			/*!
			...
			*/
			...
			virtual Any getValue(const std::shared_ptr<uml::Stereotype>& stereotype, std::string propertyName) = 0;
			/*!
			...
			*/
			...
			virtual bool hasValue(const std::shared_ptr<uml::Stereotype>& stereotype, std::string propertyName) = 0;
			/*!
			Elements that must be owned must have an owner.
			mustBeOwned() implies owner->notEmpty()
			*/
			 
			virtual bool has_owner(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			Determines whether the specified stereotype is applicable to this element.
			*/
			 
			virtual bool isStereotypeApplicable(const std::shared_ptr<uml::Stereotype>& stereotype) = 0;
			/*!
			Determines whether the specified stereotype is applied to this element.
			*/
			 
			virtual bool isStereotypeApplied(const std::shared_ptr<uml::Stereotype>& stereotype) = 0;
			/*!
			Determines whether the specified stereotype is required for this element.
			*/
			 
			virtual bool isStereotypeRequired(const std::shared_ptr<uml::Stereotype>& stereotype) = 0;
			/*!
			...
			*/
			...
			virtual bool not_own_self(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual void setValue(const std::shared_ptr<uml::Stereotype>& stereotype, std::string propertyName, const Any& newValue) = 0;
			/*!
			Unapplies the specified stereotype from this element.
			*/
			 
			virtual std::shared_ptr<ecore::EObject> unapplyStereotype(const std::shared_ptr<uml::Stereotype>& stereotype) = 0;
