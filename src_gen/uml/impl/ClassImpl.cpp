...
ClassImpl::ClassImpl()
{
	...
	{
		m_extension = new std::vector<uml::Extension * >();
	}
	...
	{
		m_superClass = new std::vector<uml::Class * >();
	}
}
...
ecore::EClass* ClassImpl::eStaticClass() const
{
...
// Operations
//*********************************
uml::Operation *  ClassImpl::createOwnedOperation(std::string name,std::vector<std::string> *  parameterNames,std::vector<uml::Type * > *  parameterTypes,uml::Type *  returnType) 
{
	std::cout << __PRETTY_FUNCTION__  << std::endl;
	throw "UnsupportedOperationException";
}

std::vector<uml::Extension * > *  ClassImpl::getExtensions() 
{
	std::cout << __PRETTY_FUNCTION__  << std::endl;
	throw "UnsupportedOperationException";
}

std::vector<uml::Class * > *  ClassImpl::getSuperClasses() 
{
	//generated from body annotation
	 auto superClass = new std::vector<Class *>();

    for(Classifier * c : * getGenerals())
    {
        Class * cl = dynamic_cast<Class *>(c);
        if(cl)
        {
...
// References
//*********************************
std::vector<uml::Extension * > *  ClassImpl::getExtension() const
{
...
std::vector<uml::Classifier * > *  ClassImpl::getNestedClassifier() const
{
...
std::vector<uml::Operation * > *  ClassImpl::getOwnedOperation() const
{
...
std::vector<uml::Reception * > *  ClassImpl::getOwnedReception() const
{
...
std::vector<uml::Class * > *  ClassImpl::getSuperClass() const
{
...
// Union Getter
//*********************************
std::vector<uml::NamedElement * > *  ClassImpl::getOwnedMember() const
{
...
std::vector<uml::Feature * > *  ClassImpl::getFeature() const
{
...
uml::Namespace *  ClassImpl::getNamespace() const
{
...
std::vector<uml::Element * > *  ClassImpl::getOwnedElement() const
{
...
std::vector<uml::NamedElement * > *  ClassImpl::getMember() const
{
...
std::vector<uml::RedefinableElement * > *  ClassImpl::getRedefinedElement() const
{
...
std::vector<uml::ConnectableElement * > *  ClassImpl::getRole() const
{
...
uml::Element *  ClassImpl::getOwner() const
{
...
std::vector<uml::Property * > *  ClassImpl::getAttribute() const
{
