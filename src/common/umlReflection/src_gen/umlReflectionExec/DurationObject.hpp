...
#ifndef UML_DURATION_EXECUTION_HPP
#define UML_DURATION_EXECUTION_HPP
...
namespace UML 
{
	class DurationObject : virtual public UML::ValueSpecificationObject
	{
		public:
		    //constructors
		    DurationObject(DurationObject &obj);
		    DurationObject(std::shared_ptr<uml::Duration>);
		 	DurationObject();
		    //destructor
		    virtual ~DurationObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			DurationObject& operator=(DurationObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::Duration> getDurationValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setDurationValue(std::shared_ptr<uml::Duration>);
			virtual void setThisDurationObjectPtr(std::weak_ptr<DurationObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Duration> m_DurationValue = nullptr;
	};
}
#endif /* end of include guard: UML_DURATION_OBJECT_HPP */
