...
void ecorePackageImpl::createEAnnotationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_eAnnotation_Attribute_details = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eAnnotation_Class, EANNOTATION_ATTRIBUTE_DETAILS);m_eAnnotation_Attribute_source = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eAnnotation_Class, EANNOTATION_ATTRIBUTE_SOURCE);
	m_eAnnotation_Attribute_contents = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eAnnotation_Class, EANNOTATION_ATTRIBUTE_CONTENTS);m_eAnnotation_Attribute_eModelElement = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eAnnotation_Class, EANNOTATION_ATTRIBUTE_EMODELELEMENT);m_eAnnotation_Attribute_references = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eAnnotation_Class, EANNOTATION_ATTRIBUTE_REFERENCES);
...
void ecorePackageImpl::createEClassContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_eClass_Attribute_abstract = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eClass_Class, ECLASS_ATTRIBUTE_ABSTRACT);m_eClass_Attribute_interface = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eClass_Class, ECLASS_ATTRIBUTE_INTERFACE);
	m_eClass_Attribute_eAllAttributes = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eClass_Class, ECLASS_ATTRIBUTE_EALLATTRIBUTES);m_eClass_Attribute_eAllContainments = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eClass_Class, ECLASS_ATTRIBUTE_EALLCONTAINMENTS);m_eClass_Attribute_eAllGenericSuperTypes = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eClass_Class, ECLASS_ATTRIBUTE_EALLGENERICSUPERTYPES);m_eClass_Attribute_eAllOperations = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eClass_Class, ECLASS_ATTRIBUTE_EALLOPERATIONS);m_eClass_Attribute_eAllReferences = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eClass_Class, ECLASS_ATTRIBUTE_EALLREFERENCES);m_eClass_Attribute_eAllStructuralFeatures = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eClass_Class, ECLASS_ATTRIBUTE_EALLSTRUCTURALFEATURES);m_eClass_Attribute_eAllSuperTypes = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eClass_Class, ECLASS_ATTRIBUTE_EALLSUPERTYPES);m_eClass_Attribute_eAttributes = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eClass_Class, ECLASS_ATTRIBUTE_EATTRIBUTES);m_eClass_Attribute_eGenericSuperTypes = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eClass_Class, ECLASS_ATTRIBUTE_EGENERICSUPERTYPES);m_eClass_Attribute_eIDAttribute = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eClass_Class, ECLASS_ATTRIBUTE_EIDATTRIBUTE);m_eClass_Attribute_eOperations = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eClass_Class, ECLASS_ATTRIBUTE_EOPERATIONS);m_eClass_Attribute_eReferences = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eClass_Class, ECLASS_ATTRIBUTE_EREFERENCES);m_eClass_Attribute_eStructuralFeatures = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eClass_Class, ECLASS_ATTRIBUTE_ESTRUCTURALFEATURES);m_eClass_Attribute_eSuperTypes = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eClass_Class, ECLASS_ATTRIBUTE_ESUPERTYPES);
...
void ecorePackageImpl::createEClassifierContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_eClassifier_Attribute_defaultValue = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eClassifier_Class, ECLASSIFIER_ATTRIBUTE_DEFAULTVALUE);m_eClassifier_Attribute_instanceClass = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eClassifier_Class, ECLASSIFIER_ATTRIBUTE_INSTANCECLASS);m_eClassifier_Attribute_instanceClassName = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eClassifier_Class, ECLASSIFIER_ATTRIBUTE_INSTANCECLASSNAME);m_eClassifier_Attribute_instanceTypeName = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eClassifier_Class, ECLASSIFIER_ATTRIBUTE_INSTANCETYPENAME);
	m_eClassifier_Attribute_ePackage = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eClassifier_Class, ECLASSIFIER_ATTRIBUTE_EPACKAGE);m_eClassifier_Attribute_eTypeParameters = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eClassifier_Class, ECLASSIFIER_ATTRIBUTE_ETYPEPARAMETERS);
...
void ecorePackageImpl::createEEnumLiteralContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_eEnumLiteral_Attribute_instance = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eEnumLiteral_Class, EENUMLITERAL_ATTRIBUTE_INSTANCE);m_eEnumLiteral_Attribute_literal = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eEnumLiteral_Class, EENUMLITERAL_ATTRIBUTE_LITERAL);m_eEnumLiteral_Attribute_value = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eEnumLiteral_Class, EENUMLITERAL_ATTRIBUTE_VALUE);
...
void ecorePackageImpl::createEGenericTypeContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_eGenericType_Attribute_eClassifier = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eGenericType_Class, EGENERICTYPE_ATTRIBUTE_ECLASSIFIER);m_eGenericType_Attribute_eLowerBound = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eGenericType_Class, EGENERICTYPE_ATTRIBUTE_ELOWERBOUND);m_eGenericType_Attribute_eRawType = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eGenericType_Class, EGENERICTYPE_ATTRIBUTE_ERAWTYPE);m_eGenericType_Attribute_eTypeArguments = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eGenericType_Class, EGENERICTYPE_ATTRIBUTE_ETYPEARGUMENTS);m_eGenericType_Attribute_eTypeParameter = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eGenericType_Class, EGENERICTYPE_ATTRIBUTE_ETYPEPARAMETER);m_eGenericType_Attribute_eUpperBound = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eGenericType_Class, EGENERICTYPE_ATTRIBUTE_EUPPERBOUND);
...
void ecorePackageImpl::createEPackageContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_ePackage_Attribute_nsPrefix = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_ePackage_Class, EPACKAGE_ATTRIBUTE_NSPREFIX);m_ePackage_Attribute_nsURI = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_ePackage_Class, EPACKAGE_ATTRIBUTE_NSURI);
	m_ePackage_Attribute_eClassifiers = factory->createEReference_as_eStructuralFeatures_in_EClass(m_ePackage_Class, EPACKAGE_ATTRIBUTE_ECLASSIFIERS);m_ePackage_Attribute_eFactoryInstance = factory->createEReference_as_eStructuralFeatures_in_EClass(m_ePackage_Class, EPACKAGE_ATTRIBUTE_EFACTORYINSTANCE);m_ePackage_Attribute_eSubpackages = factory->createEReference_as_eStructuralFeatures_in_EClass(m_ePackage_Class, EPACKAGE_ATTRIBUTE_ESUBPACKAGES);m_ePackage_Attribute_eSuperPackage = factory->createEReference_as_eStructuralFeatures_in_EClass(m_ePackage_Class, EPACKAGE_ATTRIBUTE_ESUPERPACKAGE);
...
void ecorePackageImpl::createEReferenceContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_eReference_Attribute_container = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eReference_Class, EREFERENCE_ATTRIBUTE_CONTAINER);m_eReference_Attribute_containment = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eReference_Class, EREFERENCE_ATTRIBUTE_CONTAINMENT);m_eReference_Attribute_resolveProxies = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eReference_Class, EREFERENCE_ATTRIBUTE_RESOLVEPROXIES);
	m_eReference_Attribute_eKeys = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eReference_Class, EREFERENCE_ATTRIBUTE_EKEYS);m_eReference_Attribute_eOpposite = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eReference_Class, EREFERENCE_ATTRIBUTE_EOPPOSITE);m_eReference_Attribute_eReferenceType = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eReference_Class, EREFERENCE_ATTRIBUTE_EREFERENCETYPE);
...
void ecorePackageImpl::createEStringToStringMapEntryContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_eStringToStringMapEntry_Attribute_key = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eStringToStringMapEntry_Class, ESTRINGTOSTRINGMAPENTRY_ATTRIBUTE_KEY);m_eStringToStringMapEntry_Attribute_value = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eStringToStringMapEntry_Class, ESTRINGTOSTRINGMAPENTRY_ATTRIBUTE_VALUE);
...
void ecorePackageImpl::createETypedElementContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_eTypedElement_Attribute_lowerBound = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eTypedElement_Class, ETYPEDELEMENT_ATTRIBUTE_LOWERBOUND);m_eTypedElement_Attribute_many = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eTypedElement_Class, ETYPEDELEMENT_ATTRIBUTE_MANY);m_eTypedElement_Attribute_ordered = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eTypedElement_Class, ETYPEDELEMENT_ATTRIBUTE_ORDERED);m_eTypedElement_Attribute_required = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eTypedElement_Class, ETYPEDELEMENT_ATTRIBUTE_REQUIRED);m_eTypedElement_Attribute_unique = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eTypedElement_Class, ETYPEDELEMENT_ATTRIBUTE_UNIQUE);m_eTypedElement_Attribute_upperBound = factory->createEAttribute_as_eStructuralFeatures_in_EClass(m_eTypedElement_Class, ETYPEDELEMENT_ATTRIBUTE_UPPERBOUND);
	m_eTypedElement_Attribute_eGenericType = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eTypedElement_Class, ETYPEDELEMENT_ATTRIBUTE_EGENERICTYPE);m_eTypedElement_Attribute_eType = factory->createEReference_as_eStructuralFeatures_in_EClass(m_eTypedElement_Class, ETYPEDELEMENT_ATTRIBUTE_ETYPE);
