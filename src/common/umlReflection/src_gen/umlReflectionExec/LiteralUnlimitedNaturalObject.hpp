...
#ifndef UML_LITERALUNLIMITEDNATURAL_EXECUTION_HPP
#define UML_LITERALUNLIMITEDNATURAL_EXECUTION_HPP
...
namespace UML 
{
	class LiteralUnlimitedNaturalObject : virtual public UML::LiteralSpecificationObject
	{
		public:
		    //constructors
		    LiteralUnlimitedNaturalObject(LiteralUnlimitedNaturalObject &obj);
		    LiteralUnlimitedNaturalObject(std::shared_ptr<uml::LiteralUnlimitedNatural>);
		 	LiteralUnlimitedNaturalObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::LiteralUnlimitedNatural> getLiteralUnlimitedNaturalValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setLiteralUnlimitedNaturalValue(std::shared_ptr<uml::LiteralUnlimitedNatural>);
			virtual void setThisLiteralUnlimitedNaturalObjectPtr(std::weak_ptr<LiteralUnlimitedNaturalObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::LiteralUnlimitedNatural> m_LiteralUnlimitedNaturalValue = nullptr;
	};
}
#endif /* end of include guard: UML_LITERALUNLIMITEDNATURAL_OBJECT_HPP */
