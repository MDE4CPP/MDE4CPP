...
#ifndef FUML_CLEARASSOCIATIONACTIONACTIVATION_HPP
#define FUML_CLEARASSOCIATIONACTIONACTIVATION_HPP
...
#endif /* end of include guard: FUML_CLEARASSOCIATIONACTIONACTIVATION_HPP */
