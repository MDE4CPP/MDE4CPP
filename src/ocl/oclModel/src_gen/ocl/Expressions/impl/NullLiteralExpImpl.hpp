...
{
	class OCL_API NullLiteralExpImpl : virtual public LiteralExpImpl, virtual public NullLiteralExp 
	{
		public: 
		...
		protected:
			...
			//Additional constructors for the containments back reference
			//Additional constructors for the containments back reference
			NullLiteralExpImpl(std::weak_ptr<ocl::Expressions::LoopExp> par_LoopExp, const int reference_id);
			//Additional constructors for the containments back reference
			//Additional constructors for the containments back reference
