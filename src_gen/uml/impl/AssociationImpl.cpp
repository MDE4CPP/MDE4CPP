...
AssociationImpl::AssociationImpl()
{
	...
	// Reference Members
	//*********************************
	m_endType.reset(new std::vector<std::shared_ptr<uml::Type>>());
	m_memberEnd.reset(new std::vector<std::shared_ptr<uml::Property>>());
	m_navigableOwnedEnd.reset(new std::vector<std::shared_ptr<uml::Property>>());
	m_ownedEnd.reset(new std::vector<std::shared_ptr<uml::Property>>());
}
...
AssociationImpl::AssociationImpl(const AssociationImpl & obj)
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Type>>> AssociationImpl::getEndTypes() 
{
	std::cout << __PRETTY_FUNCTION__  << std::endl;
	throw "UnsupportedOperationException";
}
...
// References
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::Type>>> AssociationImpl::getEndType() const
{
//assert(m_endType);
    return m_endType;
}
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Property>>> AssociationImpl::getMemberEnd() const
{
//assert(m_memberEnd);
    return m_memberEnd;
}
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Property>>> AssociationImpl::getNavigableOwnedEnd() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Property>>> AssociationImpl::getOwnedEnd() const
{
...
// Union Getter
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> AssociationImpl::getOwnedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> AssociationImpl::getRedefinedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Feature>>> AssociationImpl::getFeature() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> AssociationImpl::getOwnedMember() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> AssociationImpl::getMember() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> AssociationImpl::getRelatedElement() const
{
