#include "umlReflectionExec/ExecutionEnvironmentObject.hpp"

//General Includes
#include "abstractDataTypes/SubsetUnion.hpp"
#include "uml/ExecutionEnvironment.hpp"
...
{	
	m_ExecutionEnvironmentValue.reset();

	fUML::Semantics::StructuredClassifiers::ObjectImpl::destroy();
}

std::shared_ptr<uml::Element> ExecutionEnvironmentObject::getUmlValue() const
{
	return getExecutionEnvironmentValue();
}

std::shared_ptr<uml::ExecutionEnvironment> ExecutionEnvironmentObject::getExecutionEnvironmentValue() const
{
	return m_ExecutionEnvironmentValue;
}

void ExecutionEnvironmentObject::setUmlValue(std::shared_ptr<uml::Element> _element)
{
	setExecutionEnvironmentValue(std::dynamic_pointer_cast<uml::ExecutionEnvironment>(_element));
}

void ExecutionEnvironmentObject::setExecutionEnvironmentValue(std::shared_ptr<uml::ExecutionEnvironment> _ExecutionEnvironmentElement)
{
	m_ExecutionEnvironmentValue = _ExecutionEnvironmentElement;
	//set super type values
	UML::NodeObject::setNodeValue(_ExecutionEnvironmentElement);
}

void ExecutionEnvironmentObject::setThisExecutionEnvironmentObjectPtr(std::weak_ptr<ExecutionEnvironmentObject> thisObjectPtr)
{
	setThisCS_ObjectPtr(thisObjectPtr);
}

bool ExecutionEnvironmentObject::equals(std::shared_ptr<fUML::Semantics::Values::Value> otherValue)
{
	bool isEqual = false;
	
	std::shared_ptr<ExecutionEnvironmentObject> otherExecutionEnvironmentObject = std::dynamic_pointer_cast<ExecutionEnvironmentObject>(otherValue);

	if(otherExecutionEnvironmentObject != nullptr)
	{
		if(this->getExecutionEnvironmentValue() == otherExecutionEnvironmentObject->getExecutionEnvironmentValue())
		{
			isEqual = true;
		}
	}
...
std::string ExecutionEnvironmentObject::toString()
{
	std::string buffer = "Instance of 'ExecutionEnvironmentObject', " + std::to_string(getTypes()->size()) + " types (";
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Object>> ExecutionEnvironmentObject::getDirectContainers()
{   
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Link>> ExecutionEnvironmentObject::getLinks(std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_InteractionPoint> interactionPoint)
{
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> ExecutionEnvironmentObject::retrieveEndValueAsInteractionPoint(std::shared_ptr<fUML::Semantics::Values::Value> endValue, std::shared_ptr<uml::ConnectorEnd> end)
{
	/*Not done for metamodel object classes*/
...
void ExecutionEnvironmentObject::removeValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<fUML::Semantics::Values::Value> value)
{
	...
	if (m_ExecutionEnvironmentValue == nullptr)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": no value stored inside ExecutionEnvironmentObject (property: " << feature->getName() << ")" << std::endl;
		throw "NullPointerException";	
	}

	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioredClassifier_classifierBehavior())
	{
				//m_ExecutionEnvironmentValue->getClassifierBehavior().reset();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioredClassifier_interfaceRealization())
	{
		...
		{
			m_ExecutionEnvironmentValue->getInterfaceRealization()->clear();
		}
		else
		{
			...
			{
				m_ExecutionEnvironmentValue->getInterfaceRealization()->erase(inputValue->getInterfaceRealizationValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioredClassifier_ownedBehavior())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getOwnedBehavior()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getOwnedBehavior()->erase(inputValue->getBehaviorValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_isAbstract())
	{
				m_ExecutionEnvironmentValue->setIsAbstract(false /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_isActive())
	{
				m_ExecutionEnvironmentValue->setIsActive(false /*defined default value*/);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_nestedClassifier())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getNestedClassifier()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getNestedClassifier()->erase(inputValue->getClassifierValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_ownedAttribute())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getClass_OwnedAttribute()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getClass_OwnedAttribute()->erase(inputValue->getPropertyValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_ownedOperation())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getOwnedOperation()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getOwnedOperation()->erase(inputValue->getOperationValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_ownedReception())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getOwnedReception()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getOwnedReception()->erase(inputValue->getReceptionValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_superClass())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getSuperClass()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getSuperClass()->erase(inputValue->getClassValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_collaborationUse())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getCollaborationUse()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getCollaborationUse()->erase(inputValue->getCollaborationUseValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_general())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getGeneral()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getGeneral()->erase(inputValue->getClassifierValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_generalization())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getGeneralization()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getGeneralization()->erase(inputValue->getGeneralizationValue());
			}
		}
	}
	...
	{
				m_ExecutionEnvironmentValue->setIsFinalSpecialization(false /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_ownedTemplateSignature())
	{
				//m_ExecutionEnvironmentValue->getOwnedTemplateSignature().reset();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_ownedUseCase())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getOwnedUseCase()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getOwnedUseCase()->erase(inputValue->getUseCaseValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_powertypeExtent())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getPowertypeExtent()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getPowertypeExtent()->erase(inputValue->getGeneralizationSetValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_redefinedClassifier())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getRedefinedClassifier()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getRedefinedClassifier()->erase(inputValue->getClassifierValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_representation())
	{
				//m_ExecutionEnvironmentValue->getRepresentation().reset();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_substitution())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getSubstitution()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getSubstitution()->erase(inputValue->getSubstitutionValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_templateParameter())
	{
				//m_ExecutionEnvironmentValue->getTemplateParameter().reset();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_useCase())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getUseCase()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getUseCase()->erase(inputValue->getUseCaseValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_DeploymentTarget_deployment())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getDeployment()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getDeployment()->erase(inputValue->getDeploymentValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getOwnedComment()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getOwnedComment()->erase(inputValue->getCommentValue());
			}
		}
	}
	...
	{
				//m_ExecutionEnvironmentValue->getNameExpression().reset();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_elementImport())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getElementImport()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getElementImport()->erase(inputValue->getElementImportValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_ownedRule())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getOwnedRule()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getOwnedRule()->erase(inputValue->getConstraintValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_packageImport())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getPackageImport()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getPackageImport()->erase(inputValue->getPackageImportValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Node_nestedNode())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getNestedNode()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getNestedNode()->erase(inputValue->getNodeValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_PackageableElement_visibility())
	{
				m_ExecutionEnvironmentValue->setVisibility(uml::VisibilityKind::PUBLIC /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_owningTemplateParameter())
	{
				//m_ExecutionEnvironmentValue->getOwningTemplateParameter().reset();
	...
	{
				m_ExecutionEnvironmentValue->setIsLeaf(false /*defined default value*/);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_StructuredClassifier_ownedAttribute())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getOwnedAttribute()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getOwnedAttribute()->erase(inputValue->getPropertyValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_StructuredClassifier_ownedConnector())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getOwnedConnector()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getOwnedConnector()->erase(inputValue->getConnectorValue());
			}
		}
	}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateableElement_templateBinding())
	{
		if (value == nullptr) // clear mode
		{
			m_ExecutionEnvironmentValue->getTemplateBinding()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_ExecutionEnvironmentValue->getTemplateBinding()->erase(inputValue->getTemplateBindingValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Type_package())
	{
				//m_ExecutionEnvironmentValue->getPackage().reset();

	}
}


std::shared_ptr<Bag<fUML::Semantics::Values::Value>> ExecutionEnvironmentObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	if (feature->getMetaElementID() != uml::umlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::umlPackage::PORT_CLASS && feature->getMetaElementID() != uml::umlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioredClassifier_classifierBehavior())
	{
		...
		value->setBehaviorValue(m_ExecutionEnvironmentValue->getClassifierBehavior());
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioredClassifier_interfaceRealization())
	{
		std::shared_ptr<Subset<uml::InterfaceRealization, uml::Element>> interfaceRealizationList = m_ExecutionEnvironmentValue->getInterfaceRealization();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioredClassifier_ownedBehavior())
	{
		std::shared_ptr<SubsetUnion<uml::Behavior, uml::NamedElement>> ownedBehaviorList = m_ExecutionEnvironmentValue->getOwnedBehavior();
	...
	{
		std::shared_ptr<Bag<uml::Extension>> extensionList = m_ExecutionEnvironmentValue->getExtension();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_isAbstract())
	{
		...
		value->setValue(m_ExecutionEnvironmentValue->getIsAbstract());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_isActive())
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_ExecutionEnvironmentValue->getIsActive());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_nestedClassifier())
	{
		std::shared_ptr<Subset<uml::Classifier, uml::NamedElement>> nestedClassifierList = m_ExecutionEnvironmentValue->getNestedClassifier();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_ownedAttribute())
	{
		std::shared_ptr<Subset<uml::Property, uml::ConnectableElement, uml::NamedElement, uml::Property>> ownedAttributeList = m_ExecutionEnvironmentValue->getClass_OwnedAttribute();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_ownedOperation())
	{
		std::shared_ptr<Subset<uml::Operation, uml::Feature, uml::NamedElement>> ownedOperationList = m_ExecutionEnvironmentValue->getOwnedOperation();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_ownedReception())
	{
		std::shared_ptr<Subset<uml::Reception, uml::Feature, uml::NamedElement>> ownedReceptionList = m_ExecutionEnvironmentValue->getOwnedReception();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_superClass())
	{
		std::shared_ptr<Bag<uml::Class>> superClassList = m_ExecutionEnvironmentValue->getSuperClass();
	...
	{
		std::shared_ptr<SubsetUnion<uml::Property, uml::Feature>> attributeList = m_ExecutionEnvironmentValue->getAttribute();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_collaborationUse())
	{
		std::shared_ptr<SubsetUnion<uml::CollaborationUse, uml::Element>> collaborationUseList = m_ExecutionEnvironmentValue->getCollaborationUse();
	...
	{
		std::shared_ptr<SubsetUnion<uml::Feature, uml::NamedElement>> featureList = m_ExecutionEnvironmentValue->getFeature();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_general())
	{
		std::shared_ptr<Bag<uml::Classifier>> generalList = m_ExecutionEnvironmentValue->getGeneral();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_generalization())
	{
		std::shared_ptr<Subset<uml::Generalization, uml::Element>> generalizationList = m_ExecutionEnvironmentValue->getGeneralization();
	...
	{
		std::shared_ptr<Subset<uml::NamedElement, uml::NamedElement>> inheritedMemberList = m_ExecutionEnvironmentValue->getInheritedMember();
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_ExecutionEnvironmentValue->getIsFinalSpecialization());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_ownedTemplateSignature())
	{
		...
		value->setLocus(this->getLocus());
		value->setRedefinableTemplateSignatureValue(std::dynamic_pointer_cast<uml::RedefinableTemplateSignature>(m_ExecutionEnvironmentValue->getOwnedTemplateSignature()));
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_ownedUseCase())
	{
		std::shared_ptr<Subset<uml::UseCase, uml::NamedElement>> ownedUseCaseList = m_ExecutionEnvironmentValue->getOwnedUseCase();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_powertypeExtent())
	{
		std::shared_ptr<Bag<uml::GeneralizationSet>> powertypeExtentList = m_ExecutionEnvironmentValue->getPowertypeExtent();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_redefinedClassifier())
	{
		std::shared_ptr<SubsetUnion<uml::Classifier, uml::RedefinableElement>> redefinedClassifierList = m_ExecutionEnvironmentValue->getRedefinedClassifier();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_representation())
	{
		...
		value->setThisCollaborationUseObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setCollaborationUseValue(m_ExecutionEnvironmentValue->getRepresentation());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_substitution())
	{
		std::shared_ptr<Subset<uml::Substitution, uml::Element>> substitutionList = m_ExecutionEnvironmentValue->getSubstitution();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_templateParameter())
	{
		...
		value->setLocus(this->getLocus());
		value->setClassifierTemplateParameterValue(std::dynamic_pointer_cast<uml::ClassifierTemplateParameter>(m_ExecutionEnvironmentValue->getTemplateParameter()));
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_useCase())
	{
		std::shared_ptr<Bag<uml::UseCase>> useCaseList = m_ExecutionEnvironmentValue->getUseCase();
	...
	{
		std::shared_ptr<Bag<uml::PackageableElement>> deployedElementList = m_ExecutionEnvironmentValue->getDeployedElement();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_DeploymentTarget_deployment())
	{
		std::shared_ptr<Subset<uml::Deployment, uml::Element>> deploymentList = m_ExecutionEnvironmentValue->getDeployment();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Subset<uml::Comment, uml::Element>> ownedCommentList = m_ExecutionEnvironmentValue->getOwnedComment();
	...
	{
		std::shared_ptr<Union<uml::Element>> ownedElementList = m_ExecutionEnvironmentValue->getOwnedElement();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_owner())
	{
		...
		value->setThisElementObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setElementValue(m_ExecutionEnvironmentValue->getOwner().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<Subset<uml::Port, uml::Property /*Subset does not reference a union*/>> ownedPortList = m_ExecutionEnvironmentValue->getOwnedPort();
	...
	{
		std::shared_ptr<Bag<uml::Dependency>> clientDependencyList = m_ExecutionEnvironmentValue->getClientDependency();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		value->setValue(m_ExecutionEnvironmentValue->getName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		value->setLocus(this->getLocus());
		value->setStringExpressionValue(m_ExecutionEnvironmentValue->getNameExpression());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace())
	{
		...
		value->setLocus(this->getLocus());
		value->setNamespaceValue(m_ExecutionEnvironmentValue->getNamespace().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::StringValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createStringValue();
		value->setValue(m_ExecutionEnvironmentValue->getQualifiedName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		uml::VisibilityKind visibility = m_ExecutionEnvironmentValue->getVisibility();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_elementImport())
	{
		std::shared_ptr<SubsetUnion<uml::ElementImport, uml::Element>> elementImportList = m_ExecutionEnvironmentValue->getElementImport();
	...
	{
		std::shared_ptr<Subset<uml::PackageableElement, uml::NamedElement>> importedMemberList = m_ExecutionEnvironmentValue->getImportedMember();
	...
	{
		std::shared_ptr<Union<uml::NamedElement>> memberList = m_ExecutionEnvironmentValue->getMember();
	...
	{
		std::shared_ptr<SubsetUnion<uml::NamedElement, uml::Element, uml::NamedElement>> ownedMemberList = m_ExecutionEnvironmentValue->getOwnedMember();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_ownedRule())
	{
		std::shared_ptr<SubsetUnion<uml::Constraint, uml::NamedElement>> ownedRuleList = m_ExecutionEnvironmentValue->getOwnedRule();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_packageImport())
	{
		std::shared_ptr<SubsetUnion<uml::PackageImport, uml::Element>> packageImportList = m_ExecutionEnvironmentValue->getPackageImport();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Node_nestedNode())
	{
		std::shared_ptr<Subset<uml::Node, uml::NamedElement>> nestedNodeList = m_ExecutionEnvironmentValue->getNestedNode();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_owningTemplateParameter())
	{
		...
		value->setLocus(this->getLocus());
		value->setTemplateParameterValue(m_ExecutionEnvironmentValue->getOwningTemplateParameter().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_templateParameter())
	{
		...
		value->setThisTemplateParameterObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setTemplateParameterValue(m_ExecutionEnvironmentValue->getTemplateParameter());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_ExecutionEnvironmentValue->getIsLeaf());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_redefinedElement())
	{
		std::shared_ptr<Union<uml::RedefinableElement>> redefinedElementList = m_ExecutionEnvironmentValue->getRedefinedElement();
	...
	{
		std::shared_ptr<Union<uml::Classifier>> redefinitionContextList = m_ExecutionEnvironmentValue->getRedefinitionContext();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_StructuredClassifier_ownedAttribute())
	{
		std::shared_ptr<SubsetUnion<uml::Property, uml::ConnectableElement, uml::NamedElement, uml::Property>> ownedAttributeList = m_ExecutionEnvironmentValue->getOwnedAttribute();
		Bag<uml::Property>::iterator iter = ownedAttributeList->begin();
		Bag<uml::Property>::iterator end = ownedAttributeList->end();
		while (iter != end)
		{
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_StructuredClassifier_ownedConnector())
	{
		std::shared_ptr<Subset<uml::Connector, uml::Feature, uml::NamedElement>> ownedConnectorList = m_ExecutionEnvironmentValue->getOwnedConnector();
	...
	{
		std::shared_ptr<Bag<uml::Property>> partList = m_ExecutionEnvironmentValue->getPart();
	...
	{
		std::shared_ptr<SubsetUnion<uml::ConnectableElement, uml::NamedElement>> roleList = m_ExecutionEnvironmentValue->getRole();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateableElement_ownedTemplateSignature())
	{
		...
		value->setLocus(this->getLocus());
		value->setTemplateSignatureValue(m_ExecutionEnvironmentValue->getOwnedTemplateSignature());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateableElement_templateBinding())
	{
		std::shared_ptr<Subset<uml::TemplateBinding, uml::Element>> templateBindingList = m_ExecutionEnvironmentValue->getTemplateBinding();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Type_package())
	{
		...
		value->setLocus(this->getLocus());
		value->setPackageValue(m_ExecutionEnvironmentValue->getPackage().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
...
std::shared_ptr<fUML::Semantics::SimpleClassifiers::FeatureValue> ExecutionEnvironmentObject::retrieveFeatureValue(std::shared_ptr<uml::StructuralFeature> feature)
{
...
void ExecutionEnvironmentObject::setFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	if (feature->getMetaElementID() != uml::umlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::umlPackage::PORT_CLASS && feature->getMetaElementID() != uml::umlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioredClassifier_classifierBehavior())
	{
		...
		if (value != nullptr)
		{
			m_ExecutionEnvironmentValue->setClassifierBehavior(value->getBehaviorValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioredClassifier_interfaceRealization())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getInterfaceRealization()->push_back(value->getInterfaceRealizationValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioredClassifier_ownedBehavior())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getOwnedBehavior()->push_back(value->getBehaviorValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_isAbstract())
	{
		...
		{
			m_ExecutionEnvironmentValue->setIsAbstract(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_isActive())
	{
		...
		if (valueObject != nullptr)
		{
			m_ExecutionEnvironmentValue->setIsActive(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_nestedClassifier())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getNestedClassifier()->push_back(value->getClassifierValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_ownedAttribute())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getClass_OwnedAttribute()->push_back(value->getPropertyValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_ownedOperation())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getOwnedOperation()->push_back(value->getOperationValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_ownedReception())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getOwnedReception()->push_back(value->getReceptionValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_superClass())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getSuperClass()->push_back(value->getClassValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_collaborationUse())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getCollaborationUse()->push_back(value->getCollaborationUseValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_general())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getGeneral()->push_back(value->getClassifierValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_generalization())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getGeneralization()->push_back(value->getGeneralizationValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_isFinalSpecialization())
	{
		...
		if (valueObject != nullptr)
		{
			m_ExecutionEnvironmentValue->setIsFinalSpecialization(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_ownedTemplateSignature())
	{
		...
		if (value != nullptr)
		{
			m_ExecutionEnvironmentValue->setOwnedTemplateSignature(value->getRedefinableTemplateSignatureValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_ownedUseCase())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getOwnedUseCase()->push_back(value->getUseCaseValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_powertypeExtent())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getPowertypeExtent()->push_back(value->getGeneralizationSetValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_redefinedClassifier())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getRedefinedClassifier()->push_back(value->getClassifierValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_representation())
	{
		...
		if (value != nullptr)
		{
			m_ExecutionEnvironmentValue->setRepresentation(value->getCollaborationUseValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_substitution())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getSubstitution()->push_back(value->getSubstitutionValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_templateParameter())
	{
		...
		if (value != nullptr)
		{
			m_ExecutionEnvironmentValue->setTemplateParameter(value->getClassifierTemplateParameterValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_useCase())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getUseCase()->push_back(value->getUseCaseValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_DeploymentTarget_deployment())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getDeployment()->push_back(value->getDeploymentValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getOwnedComment()->push_back(value->getCommentValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		if (valueObject != nullptr)
		{
			m_ExecutionEnvironmentValue->setName(valueObject->getValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		if (value != nullptr)
		{
			m_ExecutionEnvironmentValue->setNameExpression(value->getStringExpressionValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		...
		{
			m_ExecutionEnvironmentValue->setVisibility(uml::VisibilityKind::PUBLIC);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_private())
		{
			m_ExecutionEnvironmentValue->setVisibility(uml::VisibilityKind::PRIVATE);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_protected())
		{
			m_ExecutionEnvironmentValue->setVisibility(uml::VisibilityKind::PROTECTED);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_package())
		{
			m_ExecutionEnvironmentValue->setVisibility(uml::VisibilityKind::PACKAGE);
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_elementImport())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getElementImport()->push_back(value->getElementImportValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_ownedRule())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getOwnedRule()->push_back(value->getConstraintValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_packageImport())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getPackageImport()->push_back(value->getPackageImportValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Node_nestedNode())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getNestedNode()->push_back(value->getNodeValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_templateParameter())
	{
		...
		if (value != nullptr)
		{
			m_ExecutionEnvironmentValue->setTemplateParameter(value->getTemplateParameterValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_isLeaf())
	{
		...
		if (valueObject != nullptr)
		{
			m_ExecutionEnvironmentValue->setIsLeaf(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_StructuredClassifier_ownedAttribute())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getOwnedAttribute()->push_back(value->getPropertyValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_StructuredClassifier_ownedConnector())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getOwnedConnector()->push_back(value->getConnectorValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateableElement_ownedTemplateSignature())
	{
		...
		if (value != nullptr)
		{
			m_ExecutionEnvironmentValue->setOwnedTemplateSignature(value->getTemplateSignatureValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateableElement_templateBinding())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_ExecutionEnvironmentValue->getTemplateBinding()->push_back(value->getTemplateBindingValue());
			}
...
void ExecutionEnvironmentObject::assignFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	this->setFeatureValue(feature, values, position);
}

std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> ExecutionEnvironmentObject::retrieveFeatureValues()
{
	...
	for(unsigned int i = 0; i < allAttributesSize; i++)
	{
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_BehavioredClassifier_classifierBehavior() && m_ExecutionEnvironmentValue->getClassifierBehavior() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_BehavioredClassifier_interfaceRealization() && m_ExecutionEnvironmentValue->getInterfaceRealization() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_BehavioredClassifier_ownedBehavior() && m_ExecutionEnvironmentValue->getOwnedBehavior() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Class_extension() && m_ExecutionEnvironmentValue->getExtension() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Class_nestedClassifier() && m_ExecutionEnvironmentValue->getNestedClassifier() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Class_ownedAttribute() && m_ExecutionEnvironmentValue->getClass_OwnedAttribute() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Class_ownedOperation() && m_ExecutionEnvironmentValue->getOwnedOperation() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Class_ownedReception() && m_ExecutionEnvironmentValue->getOwnedReception() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Class_superClass() && m_ExecutionEnvironmentValue->getSuperClass() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Classifier_attribute() && m_ExecutionEnvironmentValue->getAttribute() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Classifier_collaborationUse() && m_ExecutionEnvironmentValue->getCollaborationUse() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Classifier_feature() && m_ExecutionEnvironmentValue->getFeature() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Classifier_general() && m_ExecutionEnvironmentValue->getGeneral() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Classifier_generalization() && m_ExecutionEnvironmentValue->getGeneralization() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Classifier_inheritedMember() && m_ExecutionEnvironmentValue->getInheritedMember() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Classifier_ownedTemplateSignature() && m_ExecutionEnvironmentValue->getOwnedTemplateSignature() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Classifier_ownedUseCase() && m_ExecutionEnvironmentValue->getOwnedUseCase() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Classifier_powertypeExtent() && m_ExecutionEnvironmentValue->getPowertypeExtent() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Classifier_redefinedClassifier() && m_ExecutionEnvironmentValue->getRedefinedClassifier() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Classifier_representation() && m_ExecutionEnvironmentValue->getRepresentation() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Classifier_substitution() && m_ExecutionEnvironmentValue->getSubstitution() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Classifier_templateParameter() && m_ExecutionEnvironmentValue->getTemplateParameter() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Classifier_useCase() && m_ExecutionEnvironmentValue->getUseCase() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_DeploymentTarget_deployedElement() && m_ExecutionEnvironmentValue->getDeployedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_DeploymentTarget_deployment() && m_ExecutionEnvironmentValue->getDeployment() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment() && m_ExecutionEnvironmentValue->getOwnedComment() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedElement() && m_ExecutionEnvironmentValue->getOwnedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_owner() && m_ExecutionEnvironmentValue->getOwner().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_EncapsulatedClassifier_ownedPort() && m_ExecutionEnvironmentValue->getOwnedPort() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_clientDependency() && m_ExecutionEnvironmentValue->getClientDependency() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression() && m_ExecutionEnvironmentValue->getNameExpression() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace() && m_ExecutionEnvironmentValue->getNamespace().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Namespace_elementImport() && m_ExecutionEnvironmentValue->getElementImport() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Namespace_importedMember() && m_ExecutionEnvironmentValue->getImportedMember() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Namespace_member() && m_ExecutionEnvironmentValue->getMember() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Namespace_ownedMember() && m_ExecutionEnvironmentValue->getOwnedMember() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Namespace_ownedRule() && m_ExecutionEnvironmentValue->getOwnedRule() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Namespace_packageImport() && m_ExecutionEnvironmentValue->getPackageImport() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Node_nestedNode() && m_ExecutionEnvironmentValue->getNestedNode() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_owningTemplateParameter() && m_ExecutionEnvironmentValue->getOwningTemplateParameter().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_templateParameter() && m_ExecutionEnvironmentValue->getTemplateParameter() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_redefinedElement() && m_ExecutionEnvironmentValue->getRedefinedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_redefinitionContext() && m_ExecutionEnvironmentValue->getRedefinitionContext() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_StructuredClassifier_ownedAttribute() && m_ExecutionEnvironmentValue->getOwnedAttribute() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_StructuredClassifier_ownedConnector() && m_ExecutionEnvironmentValue->getOwnedConnector() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_StructuredClassifier_part() && m_ExecutionEnvironmentValue->getPart() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_StructuredClassifier_role() && m_ExecutionEnvironmentValue->getRole() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_TemplateableElement_ownedTemplateSignature() && m_ExecutionEnvironmentValue->getOwnedTemplateSignature() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_TemplateableElement_templateBinding() && m_ExecutionEnvironmentValue->getTemplateBinding() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Type_package() && m_ExecutionEnvironmentValue->getPackage().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
	}
