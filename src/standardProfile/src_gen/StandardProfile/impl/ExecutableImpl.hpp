...
#ifndef STANDARDPROFILE_EXECUTABLEEXECUTABLEIMPL_HPP
#define STANDARDPROFILE_EXECUTABLEEXECUTABLEIMPL_HPP
...
namespace StandardProfile 
{
	class ExecutableImpl :virtual public FileImpl, virtual public Executable 
	{
		...
		protected:
			...
			ExecutableImpl();
			virtual std::shared_ptr<Executable> getThisExecutablePtr() const;
...
#endif /* end of include guard: STANDARDPROFILE_EXECUTABLEEXECUTABLEIMPL_HPP */
