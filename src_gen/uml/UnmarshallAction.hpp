...
namespace uml 
{
	...
	class UnmarshallAction:virtual public Action	{
		...
		public:
			...
			<p>From package UML::Actions.</p> */
			virtual uml::Classifier *  getUnmarshallType() const = 0;
			
			/*!
			 The type of the object to be unmarshalled.
			<p>From package UML::Actions.</p> */
			virtual void setUnmarshallType(uml::Classifier *  _unmarshallType) = 0;
		...
		protected:
			...
			/*!
			 The type of the object to be unmarshalled.
			<p>From package UML::Actions.</p> */
			uml::Classifier *  m_unmarshallType =  nullptr ;
