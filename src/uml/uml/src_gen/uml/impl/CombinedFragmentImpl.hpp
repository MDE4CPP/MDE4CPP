	...
	class UML_API CombinedFragmentImpl : virtual public InteractionFragmentImpl, virtual public CombinedFragment 
	{
		...
		public:
			...
			*/
			...
			virtual bool break_(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			/*!
			...
			*/
			...
			virtual bool consider_and_ignore(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
			/*!
			...
			*/
			...
			virtual bool opt_loop_break_neg(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) ;
