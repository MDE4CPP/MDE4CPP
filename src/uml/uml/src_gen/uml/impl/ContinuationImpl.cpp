...
bool ContinuationImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::CONTINUATION_ATTRIBUTE_SETTING:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ContinuationImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
