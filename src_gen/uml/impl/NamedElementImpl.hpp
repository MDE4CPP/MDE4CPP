...
namespace uml 
{
	class NamedElementImpl :virtual public ElementImpl, virtual public NamedElement 
	{
		...
		public:
			...
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Namespace>>> allNamespaces()  ;
			...
			<p>From package UML::CommonStructure.</p> */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Package>>> allOwningPackages()  ;
			...
			<p>From package UML::CommonStructure.</p> */ 
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Dependency>>> getClientDependencies()  ;
			...
			<p>From package UML::CommonStructure.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Dependency>>> getClientDependency() const ;
			...
			/*!
			 The StringExpression used to define the name of this NamedElement.
			<p>From package UML::CommonStructure.</p> */
			virtual void setNameExpression(std::shared_ptr<uml::StringExpression> _nameExpression) ;
