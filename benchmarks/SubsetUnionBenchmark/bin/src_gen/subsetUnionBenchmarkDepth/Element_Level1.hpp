...
#ifndef SUBSETUNIONBENCHMARKDEPTH_ELEMENT_LEVEL1_HPP
#define SUBSETUNIONBENCHMARKDEPTH_ELEMENT_LEVEL1_HPP
...
#endif /* end of include guard: SUBSETUNIONBENCHMARKDEPTH_ELEMENT_LEVEL1_HPP */
