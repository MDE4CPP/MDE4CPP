...
// Union Getter
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::OutputPin>>> WriteStructuralFeatureActionImpl::getOutput() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::InputPin>>> WriteStructuralFeatureActionImpl::getInput() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> WriteStructuralFeatureActionImpl::getRedefinedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> WriteStructuralFeatureActionImpl::getOwnedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::ActivityGroup>>> WriteStructuralFeatureActionImpl::getInGroup() const
{
