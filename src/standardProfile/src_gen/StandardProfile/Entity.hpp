...
#ifndef STANDARDPROFILE_ENTITY_HPP
#define STANDARDPROFILE_ENTITY_HPP
...
namespace StandardProfile 
{
	/*!
	 */
	class Entity : virtual public ecore::EObject 
...
#endif /* end of include guard: STANDARDPROFILE_ENTITY_HPP */
