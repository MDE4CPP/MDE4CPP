...
#ifndef UML_WRITEVARIABLEACTION_EXECUTION_HPP
#define UML_WRITEVARIABLEACTION_EXECUTION_HPP
...
namespace UML 
{
	class WriteVariableActionObject : virtual public UML::VariableActionObject
	{
		public:
		    //constructors
		    WriteVariableActionObject(WriteVariableActionObject &obj);
		    WriteVariableActionObject(std::shared_ptr<uml::WriteVariableAction>);
		 	WriteVariableActionObject();
		    //destructor
		    virtual ~WriteVariableActionObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			WriteVariableActionObject& operator=(WriteVariableActionObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::WriteVariableAction> getWriteVariableActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setWriteVariableActionValue(std::shared_ptr<uml::WriteVariableAction>);
			virtual void setThisWriteVariableActionObjectPtr(std::weak_ptr<WriteVariableActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::WriteVariableAction> m_WriteVariableActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_WRITEVARIABLEACTION_OBJECT_HPP */
