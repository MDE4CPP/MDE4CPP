...
#ifndef FUML_CALLEVENTEXECUTIONCALLEVENTEXECUTIONIMPL_HPP
#define FUML_CALLEVENTEXECUTIONCALLEVENTEXECUTIONIMPL_HPP
...
namespace fUML 
{
	class CallEventExecutionImpl :virtual public ExecutionImpl, virtual public CallEventExecution 
	{
		...
		public:
			...
			/*!
			 */ 
			virtual std::shared_ptr<fUML::EventOccurrence> createEventOccurrence() ;
...
#endif /* end of include guard: FUML_CALLEVENTEXECUTIONCALLEVENTEXECUTIONIMPL_HPP */
