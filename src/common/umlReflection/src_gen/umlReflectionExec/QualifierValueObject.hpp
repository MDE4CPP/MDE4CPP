...
#ifndef UML_QUALIFIERVALUE_EXECUTION_HPP
#define UML_QUALIFIERVALUE_EXECUTION_HPP
...
namespace UML 
{
	class QualifierValueObject : virtual public UML::ElementObject
	{
		public:
		    //constructors
		    QualifierValueObject(QualifierValueObject &obj);
		    QualifierValueObject(std::shared_ptr<uml::QualifierValue>);
		 	QualifierValueObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::QualifierValue> getQualifierValueValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setQualifierValueValue(std::shared_ptr<uml::QualifierValue>);
			virtual void setThisQualifierValueObjectPtr(std::weak_ptr<QualifierValueObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::QualifierValue> m_QualifierValueValue = nullptr;
	};
}
#endif /* end of include guard: UML_QUALIFIERVALUE_OBJECT_HPP */
