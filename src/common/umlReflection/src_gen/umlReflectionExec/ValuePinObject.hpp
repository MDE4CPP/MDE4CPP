...
#ifndef UML_VALUEPIN_EXECUTION_HPP
#define UML_VALUEPIN_EXECUTION_HPP
...
namespace UML 
{
	class ValuePinObject : virtual public UML::InputPinObject
	{
		public:
		    //constructors
		    ValuePinObject(ValuePinObject &obj);
		    ValuePinObject(std::shared_ptr<uml::ValuePin>);
		 	ValuePinObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::ValuePin> getValuePinValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setValuePinValue(std::shared_ptr<uml::ValuePin>);
			virtual void setThisValuePinObjectPtr(std::weak_ptr<ValuePinObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ValuePin> m_ValuePinValue = nullptr;
	};
}
#endif /* end of include guard: UML_VALUEPIN_OBJECT_HPP */
