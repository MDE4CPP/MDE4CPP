...
void CommonBehaviorPackageImpl::createCallEventBehaviorContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_callEventBehavior_Operation_assignOperation_Operation = factory->createEOperation_as_eOperations_in_EClass(m_callEventBehavior_Class, CALLEVENTBEHAVIOR_OPERATION_ASSIGNOPERATION_OPERATION);
...
void CommonBehaviorPackageImpl::createClassifierBehaviorExecutionContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_classifierBehaviorExecution_Attribute_classifier = factory->createEReference_as_eStructuralFeatures_in_EClass(m_classifierBehaviorExecution_Class, CLASSIFIERBEHAVIOREXECUTION_ATTRIBUTE_CLASSIFIER);m_classifierBehaviorExecution_Attribute_execution = factory->createEReference_as_eStructuralFeatures_in_EClass(m_classifierBehaviorExecution_Class, CLASSIFIERBEHAVIOREXECUTION_ATTRIBUTE_EXECUTION);m_classifierBehaviorExecution_Attribute_objectActivation = factory->createEReference_as_eStructuralFeatures_in_EClass(m_classifierBehaviorExecution_Class, CLASSIFIERBEHAVIOREXECUTION_ATTRIBUTE_OBJECTACTIVATION);
...
void CommonBehaviorPackageImpl::createClassifierBehaviorInvocationEventAccepterContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_classifierBehaviorInvocationEventAccepter_Attribute_classifier = factory->createEReference_as_eStructuralFeatures_in_EClass(m_classifierBehaviorInvocationEventAccepter_Class, CLASSIFIERBEHAVIORINVOCATIONEVENTACCEPTER_ATTRIBUTE_CLASSIFIER);m_classifierBehaviorInvocationEventAccepter_Attribute_execution = factory->createEReference_as_eStructuralFeatures_in_EClass(m_classifierBehaviorInvocationEventAccepter_Class, CLASSIFIERBEHAVIORINVOCATIONEVENTACCEPTER_ATTRIBUTE_EXECUTION);m_classifierBehaviorInvocationEventAccepter_Attribute_objectActivation = factory->createEReference_as_eStructuralFeatures_in_EClass(m_classifierBehaviorInvocationEventAccepter_Class, CLASSIFIERBEHAVIORINVOCATIONEVENTACCEPTER_ATTRIBUTE_OBJECTACTIVATION);
	...
	m_classifierBehaviorInvocationEventAccepter_Operation_invokeBehavior_Class_ParameterValue = factory->createEOperation_as_eOperations_in_EClass(m_classifierBehaviorInvocationEventAccepter_Class, CLASSIFIERBEHAVIORINVOCATIONEVENTACCEPTER_OPERATION_INVOKEBEHAVIOR_CLASS_PARAMETERVALUE);
...
void CommonBehaviorPackageImpl::createExecutionContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_execution_Attribute_behavior = factory->createEReference_as_eStructuralFeatures_in_EClass(m_execution_Class, EXECUTION_ATTRIBUTE_BEHAVIOR);m_execution_Attribute_context = factory->createEReference_as_eStructuralFeatures_in_EClass(m_execution_Class, EXECUTION_ATTRIBUTE_CONTEXT);m_execution_Attribute_parameterValues = factory->createEReference_as_eStructuralFeatures_in_EClass(m_execution_Class, EXECUTION_ATTRIBUTE_PARAMETERVALUES);
	...
	m_execution_Operation_getBehavior = factory->createEOperation_as_eOperations_in_EClass(m_execution_Class, EXECUTION_OPERATION_GETBEHAVIOR);
...
void CommonBehaviorPackageImpl::createObjectActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_objectActivation_Attribute_classifierBehaviorExecutions = factory->createEReference_as_eStructuralFeatures_in_EClass(m_objectActivation_Class, OBJECTACTIVATION_ATTRIBUTE_CLASSIFIERBEHAVIOREXECUTIONS);m_objectActivation_Attribute_eventPool = factory->createEReference_as_eStructuralFeatures_in_EClass(m_objectActivation_Class, OBJECTACTIVATION_ATTRIBUTE_EVENTPOOL);m_objectActivation_Attribute_object = factory->createEReference_as_eStructuralFeatures_in_EClass(m_objectActivation_Class, OBJECTACTIVATION_ATTRIBUTE_OBJECT);m_objectActivation_Attribute_waitingEventAccepters = factory->createEReference_as_eStructuralFeatures_in_EClass(m_objectActivation_Class, OBJECTACTIVATION_ATTRIBUTE_WAITINGEVENTACCEPTERS);
...
void CommonBehaviorPackageImpl::createParameterValueContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_parameterValue_Attribute_parameter = factory->createEReference_as_eStructuralFeatures_in_EClass(m_parameterValue_Class, PARAMETERVALUE_ATTRIBUTE_PARAMETER);m_parameterValue_Attribute_values = factory->createEReference_as_eStructuralFeatures_in_EClass(m_parameterValue_Class, PARAMETERVALUE_ATTRIBUTE_VALUES);
