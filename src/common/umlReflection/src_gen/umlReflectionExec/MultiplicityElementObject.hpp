...
#ifndef UML_MULTIPLICITYELEMENT_EXECUTION_HPP
#define UML_MULTIPLICITYELEMENT_EXECUTION_HPP
...
namespace UML 
{
	class MultiplicityElementObject : virtual public UML::ElementObject
	{
		public:
		    //constructors
		    MultiplicityElementObject(MultiplicityElementObject &obj);
		    MultiplicityElementObject(std::shared_ptr<uml::MultiplicityElement>);
		 	MultiplicityElementObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::MultiplicityElement> getMultiplicityElementValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setMultiplicityElementValue(std::shared_ptr<uml::MultiplicityElement>);
			virtual void setThisMultiplicityElementObjectPtr(std::weak_ptr<MultiplicityElementObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::MultiplicityElement> m_MultiplicityElementValue = nullptr;
	};
}
#endif /* end of include guard: UML_MULTIPLICITYELEMENT_OBJECT_HPP */
