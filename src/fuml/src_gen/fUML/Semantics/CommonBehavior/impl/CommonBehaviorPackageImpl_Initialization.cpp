...
void CommonBehaviorPackageImpl::initializeCallEventExecutionContent()
{
	...
	m_callEventExecution_Operation__copy->setEType(ecore::ecorePackage::eInstance()->getEJavaObject_Class());
	...
	{ 	std::shared_ptr<ecore::ecoreFactory> factory = ecore::ecoreFactory::eInstance();
		...
		unknownClass->setAbstract(true);
		unknownClass->setInterface(true);
		m_callEventExecution_Operation_makeCall->setEType(unknownClass);
	}
	...
	{ 	std::shared_ptr<ecore::ecoreFactory> factory = ecore::ecoreFactory::eInstance();
		...
		unknownClass->setAbstract(true);
		unknownClass->setInterface(true);
		m_callEventExecution_Operation_setOutputParameterValues_ParameterValue->setEType(unknownClass);
	}
	...
	{
		std::shared_ptr<ecore::EParameter> parameter = ecore::ecoreFactory::eInstance()->createEParameter_as_eParameters_in_EOperation(m_callEventExecution_Operation_setOutputParameterValues_ParameterValue);
	...
	{ 	std::shared_ptr<ecore::ecoreFactory> factory = ecore::ecoreFactory::eInstance();
		...
		unknownClass->setAbstract(true);
		unknownClass->setInterface(true);
		m_callEventExecution_Operation_suspendCaller->setEType(unknownClass);
	}
	...
	{ 	std::shared_ptr<ecore::ecoreFactory> factory = ecore::ecoreFactory::eInstance();
		...
		unknownClass->setAbstract(true);
		unknownClass->setInterface(true);
		m_callEventExecution_Operation_wait_->setEType(unknownClass);
	}
...
void CommonBehaviorPackageImpl::initializeCallEventOccurrenceContent()
{
	...
	{
		std::shared_ptr<ecore::EParameter> parameter = ecore::ecoreFactory::eInstance()->createEParameter_as_eParameters_in_EOperation(m_callEventOccurrence_Operation_match_Trigger);
	...
	{ 	std::shared_ptr<ecore::ecoreFactory> factory = ecore::ecoreFactory::eInstance();
		...
		unknownClass->setAbstract(true);
		unknownClass->setInterface(true);
		m_callEventOccurrence_Operation_releaseCaller->setEType(unknownClass);
	}
	...
	{ 	std::shared_ptr<ecore::ecoreFactory> factory = ecore::ecoreFactory::eInstance();
		...
		unknownClass->setAbstract(true);
		unknownClass->setInterface(true);
		m_callEventOccurrence_Operation_setOutputParameterValues_ParameterValue->setEType(unknownClass);
	}
	...
	{
		std::shared_ptr<ecore::EParameter> parameter = ecore::ecoreFactory::eInstance()->createEParameter_as_eParameters_in_EOperation(m_callEventOccurrence_Operation_setOutputParameterValues_ParameterValue);
		parameter->setName("parameterValues");
		parameter->setEType(nullptr);
		parameter->setLowerBound(0);
		parameter->setUpperBound(1);
...
void CommonBehaviorPackageImpl::initializeClassifierBehaviorInvocationEventAccepterContent()
{
	...
	{ 	std::shared_ptr<ecore::ecoreFactory> factory = ecore::ecoreFactory::eInstance();
		...
		unknownClass->setAbstract(true);
		unknownClass->setInterface(true);
		m_classifierBehaviorInvocationEventAccepter_Operation_accept_EventOccurrence->setEType(unknownClass);
	}
	...
	{
		std::shared_ptr<ecore::EParameter> parameter = ecore::ecoreFactory::eInstance()->createEParameter_as_eParameters_in_EOperation(m_classifierBehaviorInvocationEventAccepter_Operation_accept_EventOccurrence);
	...
	{
		std::shared_ptr<ecore::EParameter> parameter = ecore::ecoreFactory::eInstance()->createEParameter_as_eParameters_in_EOperation(m_classifierBehaviorInvocationEventAccepter_Operation_match_EventOccurrence);
		parameter->setName("eventOccurrence");
	...
	{ 	std::shared_ptr<ecore::ecoreFactory> factory = ecore::ecoreFactory::eInstance();
		...
		unknownClass->setAbstract(true);
		unknownClass->setInterface(true);
		m_classifierBehaviorInvocationEventAccepter_Operation_terminate->setEType(unknownClass);
	}
...
void CommonBehaviorPackageImpl::initializeEventAccepterContent()
{
	...
	m_eventAccepter_Operation_accept_Element->setName("accept");
	{ 	std::shared_ptr<ecore::ecoreFactory> factory = ecore::ecoreFactory::eInstance();
		std::shared_ptr<ecore::EClass> unknownClass = factory ->createEClass(-1);
	   	unknownClass->setName("invalid");
		unknownClass->setAbstract(true);
		unknownClass->setInterface(true);
		m_eventAccepter_Operation_accept_Element->setEType(unknownClass);
	}
	m_eventAccepter_Operation_accept_Element->setLowerBound(1);
	m_eventAccepter_Operation_accept_Element->setUpperBound(1);
	m_eventAccepter_Operation_accept_Element->setUnique(true);
	m_eventAccepter_Operation_accept_Element->setOrdered(false);
	{
		std::shared_ptr<ecore::EParameter> parameter = ecore::ecoreFactory::eInstance()->createEParameter_as_eParameters_in_EOperation(m_eventAccepter_Operation_accept_Element);
	...
	m_eventAccepter_Operation_match_Element->setName("match");
	m_eventAccepter_Operation_match_Element->setEType(ecore::ecorePackage::eInstance()->getEBoolean_Class());
	m_eventAccepter_Operation_match_Element->setLowerBound(1);
	m_eventAccepter_Operation_match_Element->setUpperBound(1);
	m_eventAccepter_Operation_match_Element->setUnique(true);
	m_eventAccepter_Operation_match_Element->setOrdered(false);
	{
		std::shared_ptr<ecore::EParameter> parameter = ecore::ecoreFactory::eInstance()->createEParameter_as_eParameters_in_EOperation(m_eventAccepter_Operation_match_Element);
		parameter->setName("signalInstance");
...
void CommonBehaviorPackageImpl::initializeGetNextEventStrategyContent()
{
	...
	m_getNextEventStrategy_Operation_retrieveNextEvent_ObjectActivation->setEType(uml::umlPackage::eInstance()->getElement_Class());
...
void CommonBehaviorPackageImpl::initializeInvocationEventOccurrenceContent()
{
	...
	{
		std::shared_ptr<ecore::EParameter> parameter = ecore::ecoreFactory::eInstance()->createEParameter_as_eParameters_in_EOperation(m_invocationEventOccurrence_Operation_match_Trigger);
		parameter->setName("trigger");
		parameter->setEType(uml::umlPackage::eInstance()->getTrigger_Class());
		parameter->setLowerBound(0);
		parameter->setUpperBound(1);
...
void CommonBehaviorPackageImpl::initializeObjectActivationContent()
{
	...
	m_objectActivation_Attribute_eventPool->setEType(uml::umlPackage::eInstance()->getElement_Class());
	...
	m_objectActivation_Attribute_object->setEType(uml::umlPackage::eInstance()->getElement_Class());
	...
	m_objectActivation_Operation_retrieveNextEvent->setEType(uml::umlPackage::eInstance()->getElement_Class());
	...
	m_objectActivation_Operation_send_Element->setName("send");
	{ 	std::shared_ptr<ecore::ecoreFactory> factory = ecore::ecoreFactory::eInstance();
		std::shared_ptr<ecore::EClass> unknownClass = factory ->createEClass(-1);
	   	unknownClass->setName("invalid");
		unknownClass->setAbstract(true);
		unknownClass->setInterface(true);
		m_objectActivation_Operation_send_Element->setEType(unknownClass);
	}
	m_objectActivation_Operation_send_Element->setLowerBound(1);
	m_objectActivation_Operation_send_Element->setUpperBound(1);
	m_objectActivation_Operation_send_Element->setUnique(true);
	m_objectActivation_Operation_send_Element->setOrdered(true);
	{
		std::shared_ptr<ecore::EParameter> parameter = ecore::ecoreFactory::eInstance()->createEParameter_as_eParameters_in_EOperation(m_objectActivation_Operation_send_Element);
		parameter->setName("signalInstance");
		parameter->setEType(nullptr);
		parameter->setLowerBound(0);
		parameter->setUpperBound(1);
...
void CommonBehaviorPackageImpl::initializeOpaqueBehaviorExecutionContent()
{
	...
	{ 	std::shared_ptr<ecore::ecoreFactory> factory = ecore::ecoreFactory::eInstance();
		...
		unknownClass->setAbstract(true);
		unknownClass->setInterface(true);
		m_opaqueBehaviorExecution_Operation_doBody_ParameterValue_ParameterValue->setEType(unknownClass);
	}
	...
	{
		std::shared_ptr<ecore::EParameter> parameter = ecore::ecoreFactory::eInstance()->createEParameter_as_eParameters_in_EOperation(m_opaqueBehaviorExecution_Operation_doBody_ParameterValue_ParameterValue);
	...
	{ 	std::shared_ptr<ecore::ecoreFactory> factory = ecore::ecoreFactory::eInstance();
		...
		unknownClass->setAbstract(true);
		unknownClass->setInterface(true);
		m_opaqueBehaviorExecution_Operation_execute->setEType(unknownClass);
	}
