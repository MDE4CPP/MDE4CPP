...
void CallActionActivationImpl::doAction()
{
	...
	const std::shared_ptr<Bag<fUML::Semantics::Actions::InputPinActivation>>& inputActivationList = this->getInputPinActivation();
...
std::shared_ptr<Bag<fUML::Semantics::CommonBehavior::ParameterValue>> CallActionActivationImpl::doCall(const std::shared_ptr<Bag<fUML::Semantics::CommonBehavior::ParameterValue>>& inputParameterValues)
{
...
void CallActionActivationImpl::saveContent(std::shared_ptr<persistence::interfaces::XSaveHandler> saveHandler) const
{
	...
	// Add references
	if ( this->eIsSet(package->getCallActionActivation_Attribute_callAction()) )
	{
...
bool CallActionActivationImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case fUML::Semantics::Actions::ActionsPackage::CALLACTIONACTIVATION_ATTRIBUTE_CALLACTION:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> CallActionActivationImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
