...
//*********************************
std::shared_ptr<Any> LiteralRealImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
		case uml::umlPackage::LITERALREAL_ATTRIBUTE_VALUE:
			return eAny(getValue(),0,false); //14015
	}
...
bool LiteralRealImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::LITERALREAL_ATTRIBUTE_VALUE:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> LiteralRealImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
