...
bool NullLiteralExpImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
	}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> NullLiteralExpImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
