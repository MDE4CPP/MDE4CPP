...
std::shared_ptr<ClearAssociationActionActivation> ClearAssociationActionActivationImpl::getThisClearAssociationActionActivationPtr()
{
	...
	{
		std::shared_ptr<Bag<fUML::ActivityNodeActivation>> ownersClearAssociationActionActivationList = wp->getNodeActivations();
		for (std::shared_ptr<fUML::ActivityNodeActivation> anClearAssociationActionActivation : *ownersClearAssociationActionActivationList)
		{
			if (anClearAssociationActionActivation.get() == this)
			{
				return std::dynamic_pointer_cast<ClearAssociationActionActivation>(anClearAssociationActionActivation );
			}
		}
	}
	struct null_deleter{void operator()(void const *) const {}};
	return std::shared_ptr<ClearAssociationActionActivation>(this, null_deleter());
}
