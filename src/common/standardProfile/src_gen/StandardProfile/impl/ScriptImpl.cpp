...
ScriptImpl::ScriptImpl()
{
	...
	*/
	...
	//getter init
		...
		m_getterMap.insert(std::pair<long long,std::function<Any()>>(1334320141,[this](){ return eAny(this->getBase_Artifact(), uml::umlPackage::ARTIFACT_CLASS, false);}));
	
	
	//setter init
	//Property base_Artifact
		m_setterMap.insert(std::pair<long long,std::function<void(Any)>>(1334320141,[this](Any object){this->setBase_Artifact(object->get<std::shared_ptr<uml::Artifact>>());}));
	
	
	//unsetter init
		//Property base_Artifact
		m_unsetterMap.insert(std::pair<long long,std::function<void()>>(1334320141,[this](){m_base_Artifact = std::shared_ptr<uml::Artifact>(nullptr);}));
...
Any ScriptImpl::get(long long _uID) const
{
...
void ScriptImpl::set(long long _uID, Any value)
{
...
void ScriptImpl::unset(long long _uID)
{
...
Any ScriptImpl::invoke(long long _uID, std::shared_ptr<Bag<Any>> _arguments)
{
