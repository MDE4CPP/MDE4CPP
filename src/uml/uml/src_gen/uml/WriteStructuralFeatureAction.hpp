	...
	class UML_API WriteStructuralFeatureAction: virtual public StructuralFeatureAction
	{
		...
		public:
			...
			*/
			...
			virtual bool multiplicity_of_value(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < std::shared_ptr<Any>, std::shared_ptr<Any>>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool type_of_value(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < std::shared_ptr<Any>, std::shared_ptr<Any>>> context) = 0;
