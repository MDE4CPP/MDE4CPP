...
ecore::EClass* ClearVariableActionImpl::eStaticClass() const
{
...
// Union Getter
//*********************************
std::vector<uml::RedefinableElement * > *  ClearVariableActionImpl::getRedefinedElement() const
{
...
std::vector<uml::ActivityGroup * > *  ClearVariableActionImpl::getInGroup() const
{
...
std::vector<uml::Element * > *  ClearVariableActionImpl::getOwnedElement() const
{
...
uml::Element *  ClearVariableActionImpl::getOwner() const
{
