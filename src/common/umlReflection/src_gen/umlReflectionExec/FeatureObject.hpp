...
#ifndef UML_FEATURE_EXECUTION_HPP
#define UML_FEATURE_EXECUTION_HPP
...
namespace UML 
{
	class FeatureObject : virtual public UML::RedefinableElementObject
	{
		public:
		    //constructors
		    FeatureObject(FeatureObject &obj);
		    FeatureObject(std::shared_ptr<uml::Feature>);
		 	FeatureObject();
		    //destructor
		    virtual ~FeatureObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			FeatureObject& operator=(FeatureObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::Feature> getFeatureValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setFeatureValue(std::shared_ptr<uml::Feature>);
			virtual void setThisFeatureObjectPtr(std::weak_ptr<FeatureObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Feature> m_FeatureValue = nullptr;
	};
}
#endif /* end of include guard: UML_FEATURE_OBJECT_HPP */
