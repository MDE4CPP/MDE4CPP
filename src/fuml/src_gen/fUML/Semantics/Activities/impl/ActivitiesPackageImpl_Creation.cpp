...
void ActivitiesPackageImpl::createActivityParameterNodeActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_activityParameterNodeActivation_Attribute_activityParameterNode = factory->createEReference_as_eReferences_in_EClass(m_activityParameterNodeActivation_Class, ACTIVITYPARAMETERNODEACTIVATION_ATTRIBUTE_ACTIVITYPARAMETERNODE);
