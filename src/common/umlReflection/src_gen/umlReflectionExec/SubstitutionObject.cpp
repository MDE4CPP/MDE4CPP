...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> SubstitutionObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Dependency_client())
	{
		std::shared_ptr<Bag<uml::NamedElement>> clientList = m_SubstitutionValue->getClient();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Dependency_supplier())
	{
		std::shared_ptr<Bag<uml::NamedElement>> supplierList = m_SubstitutionValue->getSupplier();
	...
	{
		std::shared_ptr<Bag<uml::Element>> sourceList = m_SubstitutionValue->getSource();
	...
	{
		std::shared_ptr<Bag<uml::Element>> targetList = m_SubstitutionValue->getTarget();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Bag<uml::Comment>> ownedCommentList = m_SubstitutionValue->getOwnedComment();
	...
	{
		std::shared_ptr<Bag<uml::Element>> ownedElementList = m_SubstitutionValue->getOwnedElement();
	...
	{
		std::shared_ptr<Bag<uml::Element>> relatedElementList = m_SubstitutionValue->getRelatedElement();
