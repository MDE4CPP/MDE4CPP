...
#ifndef UML_LITERALNULL_EXECUTION_HPP
#define UML_LITERALNULL_EXECUTION_HPP
...
namespace UML 
{
	class LiteralNullObject : virtual public UML::LiteralSpecificationObject
	{
		public:
		    //constructors
		    LiteralNullObject(LiteralNullObject &obj);
		    LiteralNullObject(std::shared_ptr<uml::LiteralNull>);
		 	LiteralNullObject();
		    //destructor
		    virtual ~LiteralNullObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			LiteralNullObject& operator=(LiteralNullObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::LiteralNull> getLiteralNullValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setLiteralNullValue(std::shared_ptr<uml::LiteralNull>);
			virtual void setThisLiteralNullObjectPtr(std::weak_ptr<LiteralNullObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::LiteralNull> m_LiteralNullValue = nullptr;
	};
}
#endif /* end of include guard: UML_LITERALNULL_OBJECT_HPP */
