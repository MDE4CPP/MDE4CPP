...
void CommonBehaviorPackageImpl::createCS_CallEventExecutionContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::EcoreFactory> factory)
{
	...
	m_cS_CallEventExecution_Operation__copy = factory->createEOperation_in_EContainingClass(m_cS_CallEventExecution_Class, CS_CALLEVENTEXECUTION_OPERATION__COPY);
