...
void ActivityNodeActivationGroupImpl::createEdgeInstance(const std::shared_ptr<Bag<uml::ActivityEdge>>& edges)
{
	//ADD_COUNT(__PRETTY_FUNCTION__)
	//generated from body annotation
	for (const std::shared_ptr<uml::ActivityEdge>& edge : *edges) 
	{
...
const std::shared_ptr<Bag<fUML::Semantics::Activities::ActivityEdgeInstance>>& edgeInstances = this->getEdgeInstances();
