...
namespace uml 
{
	class ClassifierTemplateParameterImpl :virtual public TemplateParameterImpl, virtual public ClassifierTemplateParameter 
	{
		...
		public:
			...
			virtual bool actual_is_classifier(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
			...
			virtual bool constraining_classifiers_constrain_args(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
			...
			<p>From package UML::Classification.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Classifier>>> getConstrainingClassifier() const ;
