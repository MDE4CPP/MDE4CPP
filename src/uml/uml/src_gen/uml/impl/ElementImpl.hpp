	...
	class UML_API ElementImpl : virtual public ObjectImpl, virtual public Element 
	{
		...
		public:
			...
			*/
			...
			virtual std::shared_ptr<Any> getValue(const std::shared_ptr<uml::Stereotype>& stereotype, std::string propertyName) ;
			/*!
			...
			*/
			...
			virtual void setValue(const std::shared_ptr<uml::Stereotype>& stereotype, std::string propertyName, const std::shared_ptr<Any>& newValue) ;
			/*!
