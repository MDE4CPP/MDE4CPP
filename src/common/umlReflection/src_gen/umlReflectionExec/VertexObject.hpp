...
#ifndef UML_VERTEX_EXECUTION_HPP
#define UML_VERTEX_EXECUTION_HPP
...
namespace UML 
{
	class VertexObject : virtual public UML::NamedElementObject
	{
		public:
		    //constructors
		    VertexObject(VertexObject &obj);
		    VertexObject(std::shared_ptr<uml::Vertex>);
		 	VertexObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::Vertex> getVertexValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setVertexValue(std::shared_ptr<uml::Vertex>);
			virtual void setThisVertexObjectPtr(std::weak_ptr<VertexObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Vertex> m_VertexValue = nullptr;
	};
}
#endif /* end of include guard: UML_VERTEX_OBJECT_HPP */
