...
void StateMachinesPackageImpl::createEntryPointPseudostateActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_entryPointPseudostateActivation_Operation__enter_TransitionActivation_RegionActivation = factory->createEOperation_as_eOperations_in_EClass(m_entryPointPseudostateActivation_Class, ENTRYPOINTPSEUDOSTATEACTIVATION_OPERATION__ENTER_TRANSITIONACTIVATION_REGIONACTIVATION);
...
void StateMachinesPackageImpl::createForkPseudostateActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_forkPseudostateActivation_Operation_canPropagateExecution_TransitionActivation_RegionActivation = factory->createEOperation_as_eOperations_in_EClass(m_forkPseudostateActivation_Class, FORKPSEUDOSTATEACTIVATION_OPERATION_CANPROPAGATEEXECUTION_TRANSITIONACTIVATION_REGIONACTIVATION);
...
void StateMachinesPackageImpl::createJoinPseudostateActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_joinPseudostateActivation_Operation_canPropagateExecution_TransitionActivation_RegionActivation = factory->createEOperation_as_eOperations_in_EClass(m_joinPseudostateActivation_Class, JOINPSEUDOSTATEACTIVATION_OPERATION_CANPROPAGATEEXECUTION_TRANSITIONACTIVATION_REGIONACTIVATION);
...
void StateMachinesPackageImpl::createStateMachineSemanticVisitorContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_stateMachineSemanticVisitor_Operation_getExecutionFor_Behavior_FUML_Object = factory->createEOperation_as_eOperations_in_EClass(m_stateMachineSemanticVisitor_Class, STATEMACHINESEMANTICVISITOR_OPERATION_GETEXECUTIONFOR_BEHAVIOR_FUML_OBJECT);
...
void StateMachinesPackageImpl::createTerminatePseudostateActivationContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory)
{
	...
	m_terminatePseudostateActivation_Operation_enter_TransitionActivation_RegionActivation = factory->createEOperation_as_eOperations_in_EClass(m_terminatePseudostateActivation_Class, TERMINATEPSEUDOSTATEACTIVATION_OPERATION_ENTER_TRANSITIONACTIVATION_REGIONACTIVATION);
