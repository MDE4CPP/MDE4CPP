...
namespace ecore
{
	class ECORE_API ecorePackageImpl : public EPackageImpl ,virtual public ecorePackage
	{
		...
		private:
			...
			void createEObjectAnyContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory);
			void createEObjectContainerContent(std::shared_ptr<ecore::EPackage> package, std::shared_ptr<ecore::ecoreFactory> factory);
			...
			void initializeEObjectAnyContent();
			void initializeEObjectContainerContent();
