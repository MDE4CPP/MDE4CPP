...
// Union Getter
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::ActivityGroup>>> ClearVariableActionImpl::getInGroup() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> ClearVariableActionImpl::getOwnedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> ClearVariableActionImpl::getRedefinedElement() const
{
