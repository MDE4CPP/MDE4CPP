...
#ifndef UML_ENCAPSULATEDCLASSIFIER_EXECUTION_HPP
#define UML_ENCAPSULATEDCLASSIFIER_EXECUTION_HPP
...
namespace UML 
{
	class EncapsulatedClassifierObject : virtual public UML::StructuredClassifierObject
	{
		public:
		    //constructors
		    EncapsulatedClassifierObject(EncapsulatedClassifierObject &obj);
		    EncapsulatedClassifierObject(std::shared_ptr<uml::EncapsulatedClassifier>);
		 	EncapsulatedClassifierObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::EncapsulatedClassifier> getEncapsulatedClassifierValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setEncapsulatedClassifierValue(std::shared_ptr<uml::EncapsulatedClassifier>);
			virtual void setThisEncapsulatedClassifierObjectPtr(std::weak_ptr<EncapsulatedClassifierObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::EncapsulatedClassifier> m_EncapsulatedClassifierValue = nullptr;
	};
}
#endif /* end of include guard: UML_ENCAPSULATEDCLASSIFIER_OBJECT_HPP */
