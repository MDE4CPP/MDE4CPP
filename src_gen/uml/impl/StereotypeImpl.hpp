...
namespace uml 
{
	class StereotypeImpl :virtual public ClassImpl, virtual public Stereotype 
	{
		...
		public:
			...
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Class>>> getAllExtendedMetaclasses()  ;
			...
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Class>>> getExtendedMetaclasses()  ;
			...
			<p>From package UML::Packages.</p> */
			virtual std::shared_ptr<std::vector<std::shared_ptr<uml::Image>>> getIcon() const ;
