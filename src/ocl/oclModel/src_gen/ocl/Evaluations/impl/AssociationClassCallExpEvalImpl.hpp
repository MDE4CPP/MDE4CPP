...
namespace ocl::Evaluations 
{
	class OCL_API AssociationClassCallExpEvalImpl : virtual public NavigationCallExpEvalImpl, virtual public AssociationClassCallExpEval 
	{
		...
		public:
			...
			//*********************************
			virtual const std::shared_ptr<fUML::Semantics::SimpleClassifiers::StringValue>& getReferredAssociationClass() const ;
			virtual void setReferredAssociationClass(const std::shared_ptr<fUML::Semantics::SimpleClassifiers::StringValue>&) ;
