...
#ifndef UML_CONNECTOR_EXECUTION_HPP
#define UML_CONNECTOR_EXECUTION_HPP
...
namespace UML 
{
	class ConnectorObject : virtual public UML::FeatureObject
	{
		public:
		    //constructors
		    ConnectorObject(ConnectorObject &obj);
		    ConnectorObject(std::shared_ptr<uml::Connector>);
		 	ConnectorObject();
		    //destructor
		    virtual ~ConnectorObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			ConnectorObject& operator=(ConnectorObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::Connector> getConnectorValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setConnectorValue(std::shared_ptr<uml::Connector>);
			virtual void setThisConnectorObjectPtr(std::weak_ptr<ConnectorObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Connector> m_ConnectorValue = nullptr;
	};
}
#endif /* end of include guard: UML_CONNECTOR_OBJECT_HPP */
