...
namespace ocl::Expressions 
{
	class OCL_API IfExpImpl : virtual public OclExpressionImpl, virtual public IfExp 
	{
		...
		public:
			...
			virtual void setCondition(std::shared_ptr<ocl::Expressions::OclExpression>) ;
			virtual std::shared_ptr<ocl::Expressions::OclExpression> getElseExpression() const ;
			virtual void setElseExpression(std::shared_ptr<ocl::Expressions::OclExpression>) ;
			virtual std::shared_ptr<ocl::Expressions::OclExpression> getThenExpression() const ;
			virtual void setThenExpression(std::shared_ptr<ocl::Expressions::OclExpression>) ;
