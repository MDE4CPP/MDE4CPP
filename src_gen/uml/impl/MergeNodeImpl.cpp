...
MergeNodeImpl::MergeNodeImpl(const MergeNodeImpl & obj)
{
...
ecore::EClass* MergeNodeImpl::eStaticClass() const
{
...
// Union Getter
//*********************************
std::vector<uml::ActivityGroup * > *  MergeNodeImpl::getInGroup() const
{
...
std::vector<uml::Element * > *  MergeNodeImpl::getOwnedElement() const
{
...
uml::Element *  MergeNodeImpl::getOwner() const
{
...
std::vector<uml::RedefinableElement * > *  MergeNodeImpl::getRedefinedElement() const
{
