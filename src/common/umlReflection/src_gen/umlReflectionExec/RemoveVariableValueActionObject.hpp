...
#ifndef UML_REMOVEVARIABLEVALUEACTION_EXECUTION_HPP
#define UML_REMOVEVARIABLEVALUEACTION_EXECUTION_HPP
...
namespace UML 
{
	class RemoveVariableValueActionObject : virtual public UML::WriteVariableActionObject
	{
		public:
		    //constructors
		    RemoveVariableValueActionObject(RemoveVariableValueActionObject &obj);
		    RemoveVariableValueActionObject(std::shared_ptr<uml::RemoveVariableValueAction>);
		 	RemoveVariableValueActionObject();
		    //destructor
		    virtual ~RemoveVariableValueActionObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			RemoveVariableValueActionObject& operator=(RemoveVariableValueActionObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::RemoveVariableValueAction> getRemoveVariableValueActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setRemoveVariableValueActionValue(std::shared_ptr<uml::RemoveVariableValueAction>);
			virtual void setThisRemoveVariableValueActionObjectPtr(std::weak_ptr<RemoveVariableValueActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::RemoveVariableValueAction> m_RemoveVariableValueActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_REMOVEVARIABLEVALUEACTION_OBJECT_HPP */
