...
ActivityImpl& ActivityImpl::operator=(const ActivityImpl & obj)
{
	...
	for(auto _ownedGroup : *obj.getOwnedGroup()) 
	{
	...
	for(auto _ownedNode : *obj.getOwnedNode()) 
	{
	...
	for(auto _partition : *obj.getPartition()) 
	{
	...
	for(auto _structuredNode : *obj.getStructuredNode()) 
	{
	...
	for(auto _variable : *obj.getVariable()) 
	{
