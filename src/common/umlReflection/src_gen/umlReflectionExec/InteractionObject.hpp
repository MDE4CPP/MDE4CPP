...
#ifndef UML_INTERACTION_EXECUTION_HPP
#define UML_INTERACTION_EXECUTION_HPP
...
namespace UML 
{
	class InteractionObject : virtual public UML::BehaviorObject , virtual public UML::InteractionFragmentObject
	{
		public:
		    //constructors
		    InteractionObject(InteractionObject &obj);
		    InteractionObject(std::shared_ptr<uml::Interaction>);
		 	InteractionObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::Interaction> getInteractionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setInteractionValue(std::shared_ptr<uml::Interaction>);
			virtual void setThisInteractionObjectPtr(std::weak_ptr<InteractionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Interaction> m_InteractionValue = nullptr;
	};
}
#endif /* end of include guard: UML_INTERACTION_OBJECT_HPP */
