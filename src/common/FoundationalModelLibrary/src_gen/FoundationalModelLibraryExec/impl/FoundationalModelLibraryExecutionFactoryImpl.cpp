...
std::shared_ptr<fUML::Semantics::CommonBehavior::Execution> FoundationalModelLibraryExecutionFactoryImpl::createExecution(std::shared_ptr<uml::Behavior> behavior, std::shared_ptr<uml::Element> context)
{
	...
	return fUML::Semantics::Loci::ExecutionFactoryImpl::createExecution(behavior, context);
}
