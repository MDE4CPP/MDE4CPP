...
// Union Getter
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::OutputPin>>> CallBehaviorActionImpl::getOutput() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> CallBehaviorActionImpl::getRedefinedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::ActivityGroup>>> CallBehaviorActionImpl::getInGroup() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::InputPin>>> CallBehaviorActionImpl::getInput() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> CallBehaviorActionImpl::getOwnedElement() const
{
