...
void UsageImpl::eSet(int featureID, boost::any newValue)
{
	switch(featureID)
	{
		case UmlPackage::NAMEDELEMENT_NAME:
		...
		case UmlPackage::NAMEDELEMENT_NAMEEXPRESSION:
		{
			...
			setNameExpression(_nameExpression); //896
			break;
		}
		case UmlPackage::PACKAGEABLEELEMENT_OWNINGPACKAGE:
		{
			...
			setOwningPackage(_owningPackage); //8912
			break;
		}
		case UmlPackage::PARAMETERABLEELEMENT_OWNINGTEMPLATEPARAMETER:
		{
			...
			setOwningTemplateParameter(_owningTemplateParameter); //894
			break;
		}
		case UmlPackage::PARAMETERABLEELEMENT_TEMPLATEPARAMETER:
		{
			...
			setTemplateParameter(_templateParameter); //895
			break;
		}
		case UmlPackage::NAMEDELEMENT_VISIBILITY:
		{
