...
namespace uml 
{
	class OccurrenceSpecificationImpl :virtual public InteractionFragmentImpl, virtual public OccurrenceSpecification
	{
		...
		public:
			...
			virtual void setCovered(uml::Lifeline *  value)  ;
			...
			virtual std::vector<uml::GeneralOrdering * > *  getToAfter() const ;
			
			/*!
			 References the GeneralOrderings that specify EventOcurrences that must occur before this OccurrenceSpecification.
			<p>From package UML::Interactions.</p> */
			virtual std::vector<uml::GeneralOrdering * > *  getToBefore() const ;
