...
namespace ocl::Evaluations
{
	class OCL_API EvaluationsPackageImpl : public ecore::EPackageImpl ,virtual public EvaluationsPackage
	{
		...
		public:
			...
			virtual const std::shared_ptr<ecore::EAttribute>& getAssociationClassCallExpEval_Attribute_referredAssociationClass() const ;
			...
			virtual const std::shared_ptr<ecore::EAttribute>& getAssociationEndCallExpEval_Attribute_referredAssociationEnd() const ;
			...
			virtual const std::shared_ptr<ecore::EAttribute>& getAttributeCallExpEval_Attribute_referredAttribute() const ;
			...
			virtual const std::shared_ptr<ecore::EOperation>& getEvalEnvironment_Operation_find_EString() const ;
			...
			virtual const std::shared_ptr<ecore::EAttribute>& getLetExpEval_Attribute_variable() const ;
			...
			virtual const std::shared_ptr<ecore::EAttribute>& getLoopExpEval_Attribute_iterators() const ;
			...
			virtual const std::shared_ptr<ecore::EAttribute>& getNavigationCallExpEval_Attribute_navigationSource() const ;
			...
			virtual const std::shared_ptr<ecore::EAttribute>& getOperationCallExpEval_Attribute_referredOperation() const ;
			...
			virtual const std::shared_ptr<ecore::EAttribute>& getVariableDeclEval_Attribute_name() const ;
			...
			virtual const std::shared_ptr<ecore::EAttribute>& getVariableExpEval_Attribute_referredVariable() const ;
