...
//*********************************
std::shared_ptr<Any> ClassifierBehaviorExecutionActivityImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
	}
...
bool ClassifierBehaviorExecutionActivityImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
	}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ClassifierBehaviorExecutionActivityImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
