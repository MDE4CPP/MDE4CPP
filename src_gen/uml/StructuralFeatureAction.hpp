...
namespace uml 
{
	...
	class StructuralFeatureAction:virtual public Action	{
		...
		public:
			...
			<p>From package UML::Actions.</p> */
			virtual uml::StructuralFeature *  getStructuralFeature() const = 0;
			
			/*!
			 The StructuralFeature to be read or written.
			<p>From package UML::Actions.</p> */
			virtual void setStructuralFeature(uml::StructuralFeature *  _structuralFeature) = 0;
		...
		protected:
			...
			/*!
			 The StructuralFeature to be read or written.
			<p>From package UML::Actions.</p> */
			uml::StructuralFeature *  m_structuralFeature =  nullptr ;
