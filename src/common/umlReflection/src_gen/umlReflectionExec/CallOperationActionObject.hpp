...
#ifndef UML_CALLOPERATIONACTION_EXECUTION_HPP
#define UML_CALLOPERATIONACTION_EXECUTION_HPP
...
namespace UML 
{
	class CallOperationActionObject : virtual public UML::CallActionObject
	{
		public:
		    //constructors
		    CallOperationActionObject(CallOperationActionObject &obj);
		    CallOperationActionObject(std::shared_ptr<uml::CallOperationAction>);
		 	CallOperationActionObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::CallOperationAction> getCallOperationActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setCallOperationActionValue(std::shared_ptr<uml::CallOperationAction>);
			virtual void setThisCallOperationActionObjectPtr(std::weak_ptr<CallOperationActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::CallOperationAction> m_CallOperationActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_CALLOPERATIONACTION_OBJECT_HPP */
