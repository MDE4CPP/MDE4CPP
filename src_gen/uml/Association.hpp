...
namespace uml 
{
	...
	class Association:virtual public Classifier,virtual public Relationship	{
		...
		public:
			...
			virtual bool
			 specialized_end_number(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 specialized_end_types(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 binary_associations(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			
			/*!
			 Ends of Associations with more than two ends must be owned by the Association itself.
			memberEnd->size() > 2 implies ownedEnd->includesAll(memberEnd) */ 
			virtual bool
			 association_ends(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			
			/*!
			 memberEnd->forAll(type->notEmpty()) */ 
			virtual bool
			 ends_must_be_typed(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			<p>From package UML::StructuredClassifiers.</p> */
			virtual 		std::shared_ptr<Subset<uml::Type, uml::Element > >
			 getEndType() const = 0;
			
			/*!
			 Each end represents participation of instances of the Classifier connected to the end in links of the Association.
			<p>From package UML::StructuredClassifiers.</p> */
			virtual 		std::shared_ptr<SubsetUnion<uml::Property, uml::NamedElement > >
			 getMemberEnd() const = 0;
			...
			<p>From package UML::StructuredClassifiers.</p> */
			virtual 		std::shared_ptr<Subset<uml::Property, uml::Property /*Subset does not reference a union*/ > >
			 getNavigableOwnedEnd() const = 0;
