...
#ifndef UML_INSTANCESPECIFICATION_EXECUTION_HPP
#define UML_INSTANCESPECIFICATION_EXECUTION_HPP
...
namespace UML 
{
	class InstanceSpecificationObject : virtual public UML::DeployedArtifactObject , virtual public UML::DeploymentTargetObject , virtual public UML::PackageableElementObject
	{
		public:
		    //constructors
		    InstanceSpecificationObject(InstanceSpecificationObject &obj);
		    InstanceSpecificationObject(std::shared_ptr<uml::InstanceSpecification>);
			...
			virtual std::shared_ptr<uml::InstanceSpecification> getInstanceSpecificationValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setInstanceSpecificationValue(std::shared_ptr<uml::InstanceSpecification>);
			virtual void setThisInstanceSpecificationObjectPtr(std::weak_ptr<InstanceSpecificationObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::InstanceSpecification> m_InstanceSpecificationValue = nullptr;
	};
}
#endif /* end of include guard: UML_INSTANCESPECIFICATION_OBJECT_HPP */
