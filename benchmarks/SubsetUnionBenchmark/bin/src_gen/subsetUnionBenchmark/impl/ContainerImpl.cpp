...
ContainerImpl::ContainerImpl()
{
	...
	//References
		...
		m_subset10.reset(new Bag<subsetUnionBenchmark::Element_Level10>());
		...
		m_subset7.reset(new Bag<subsetUnionBenchmark::Element_Level7>());
	
	

		m_subset8.reset(new Bag<subsetUnionBenchmark::Element_Level8>());
	
	

		m_subset9.reset(new Bag<subsetUnionBenchmark::Element_Level9>());
...
std::shared_ptr< Bag<subsetUnionBenchmark::Element_Level10> > ContainerImpl::getSubset10() const
{
...
std::shared_ptr< Bag<subsetUnionBenchmark::Element_Level7> > ContainerImpl::getSubset7() const
{
...
std::shared_ptr< Bag<subsetUnionBenchmark::Element_Level8> > ContainerImpl::getSubset8() const
{
...
std::shared_ptr< Bag<subsetUnionBenchmark::Element_Level9> > ContainerImpl::getSubset9() const
{
