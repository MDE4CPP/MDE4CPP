...
#ifndef UML_PARAMETERABLEELEMENT_EXECUTION_HPP
#define UML_PARAMETERABLEELEMENT_EXECUTION_HPP
...
namespace UML 
{
	class ParameterableElementObject : virtual public UML::ElementObject
	{
		public:
		    //constructors
		    ParameterableElementObject(ParameterableElementObject &obj);
		    ParameterableElementObject(std::shared_ptr<uml::ParameterableElement>);
		 	ParameterableElementObject();
		    //destructor
		    virtual ~ParameterableElementObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			ParameterableElementObject& operator=(ParameterableElementObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::ParameterableElement> getParameterableElementValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setParameterableElementValue(std::shared_ptr<uml::ParameterableElement>);
			virtual void setThisParameterableElementObjectPtr(std::weak_ptr<ParameterableElementObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ParameterableElement> m_ParameterableElementValue = nullptr;
	};
}
#endif /* end of include guard: UML_PARAMETERABLEELEMENT_OBJECT_HPP */
