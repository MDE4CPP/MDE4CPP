...
namespace UML 
{
	class InteractionConstraintObject : virtual public UML::ConstraintObject
	{
		public:
		    //constructors
		    InteractionConstraintObject(InteractionConstraintObject &obj);
		    InteractionConstraintObject(std::shared_ptr<uml::InteractionConstraint>);
		 	InteractionConstraintObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::InteractionConstraint> getInteractionConstraintValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setInteractionConstraintValue(std::shared_ptr<uml::InteractionConstraint>);
			virtual void setThisInteractionConstraintObjectPtr(std::weak_ptr<InteractionConstraintObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::InteractionConstraint> m_InteractionConstraintValue = nullptr;
	};
}
#endif /* end of include guard: UML_INTERACTIONCONSTRAINT_OBJECT_HPP */
