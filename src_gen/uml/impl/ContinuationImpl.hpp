...
namespace uml 
{
	class ContinuationImpl :virtual public InteractionFragmentImpl, virtual public Continuation 
	{
		...
		public:
			...
			virtual bool
			 first_or_last_interaction_fragment(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
			...
			virtual bool
			 same_name(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
			...
			virtual bool
			 global(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
