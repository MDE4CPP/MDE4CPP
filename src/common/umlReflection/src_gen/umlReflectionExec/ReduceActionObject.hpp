...
#ifndef UML_REDUCEACTION_EXECUTION_HPP
#define UML_REDUCEACTION_EXECUTION_HPP
...
namespace UML 
{
	class ReduceActionObject : virtual public UML::ActionObject
	{
		public:
		    //constructors
		    ReduceActionObject(ReduceActionObject &obj);
		    ReduceActionObject(std::shared_ptr<uml::ReduceAction>);
		 	ReduceActionObject();
		    //destructor
		    virtual ~ReduceActionObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			ReduceActionObject& operator=(ReduceActionObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::ReduceAction> getReduceActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setReduceActionValue(std::shared_ptr<uml::ReduceAction>);
			virtual void setThisReduceActionObjectPtr(std::weak_ptr<ReduceActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ReduceAction> m_ReduceActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_REDUCEACTION_OBJECT_HPP */
