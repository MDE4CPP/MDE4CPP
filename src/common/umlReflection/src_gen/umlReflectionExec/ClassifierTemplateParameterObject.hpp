...
#ifndef UML_CLASSIFIERTEMPLATEPARAMETER_EXECUTION_HPP
#define UML_CLASSIFIERTEMPLATEPARAMETER_EXECUTION_HPP
...
namespace UML 
{
	class ClassifierTemplateParameterObject : virtual public UML::TemplateParameterObject
	{
		public:
		    //constructors
		    ClassifierTemplateParameterObject(ClassifierTemplateParameterObject &obj);
		    ClassifierTemplateParameterObject(std::shared_ptr<uml::ClassifierTemplateParameter>);
		 	ClassifierTemplateParameterObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::ClassifierTemplateParameter> getClassifierTemplateParameterValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setClassifierTemplateParameterValue(std::shared_ptr<uml::ClassifierTemplateParameter>);
			virtual void setThisClassifierTemplateParameterObjectPtr(std::weak_ptr<ClassifierTemplateParameterObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ClassifierTemplateParameter> m_ClassifierTemplateParameterValue = nullptr;
	};
}
#endif /* end of include guard: UML_CLASSIFIERTEMPLATEPARAMETER_OBJECT_HPP */
