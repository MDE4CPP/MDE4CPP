...
// Union Getter
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> ExecutionEnvironmentImpl::getMember() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> ExecutionEnvironmentImpl::getOwnedMember() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> ExecutionEnvironmentImpl::getRedefinedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Property>>> ExecutionEnvironmentImpl::getAttribute() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::ConnectableElement>>> ExecutionEnvironmentImpl::getRole() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Feature>>> ExecutionEnvironmentImpl::getFeature() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> ExecutionEnvironmentImpl::getOwnedElement() const
{
