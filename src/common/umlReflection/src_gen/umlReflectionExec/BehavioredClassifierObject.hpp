...
#ifndef UML_BEHAVIOREDCLASSIFIER_EXECUTION_HPP
#define UML_BEHAVIOREDCLASSIFIER_EXECUTION_HPP
...
namespace UML 
{
	class BehavioredClassifierObject : virtual public UML::ClassifierObject
	{
		public:
		    //constructors
		    BehavioredClassifierObject(BehavioredClassifierObject &obj);
		    BehavioredClassifierObject(std::shared_ptr<uml::BehavioredClassifier>);
		 	BehavioredClassifierObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::BehavioredClassifier> getBehavioredClassifierValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setBehavioredClassifierValue(std::shared_ptr<uml::BehavioredClassifier>);
			virtual void setThisBehavioredClassifierObjectPtr(std::weak_ptr<BehavioredClassifierObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::BehavioredClassifier> m_BehavioredClassifierValue = nullptr;
	};
}
#endif /* end of include guard: UML_BEHAVIOREDCLASSIFIER_OBJECT_HPP */
