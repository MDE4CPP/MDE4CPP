...
#ifndef UML_REDEFINABLETEMPLATESIGNATURE_EXECUTION_HPP
#define UML_REDEFINABLETEMPLATESIGNATURE_EXECUTION_HPP
...
namespace UML 
{
	class RedefinableTemplateSignatureObject : virtual public UML::RedefinableElementObject , virtual public UML::TemplateSignatureObject
	{
		public:
		    //constructors
		    RedefinableTemplateSignatureObject(RedefinableTemplateSignatureObject &obj);
		    RedefinableTemplateSignatureObject(std::shared_ptr<uml::RedefinableTemplateSignature>);
		 	RedefinableTemplateSignatureObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::RedefinableTemplateSignature> getRedefinableTemplateSignatureValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setRedefinableTemplateSignatureValue(std::shared_ptr<uml::RedefinableTemplateSignature>);
			virtual void setThisRedefinableTemplateSignatureObjectPtr(std::weak_ptr<RedefinableTemplateSignatureObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::RedefinableTemplateSignature> m_RedefinableTemplateSignatureValue = nullptr;
	};
}
#endif /* end of include guard: UML_REDEFINABLETEMPLATESIGNATURE_OBJECT_HPP */
