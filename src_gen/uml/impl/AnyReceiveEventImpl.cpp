...
ecore::EClass* AnyReceiveEventImpl::eStaticClass() const
{
...
// Union Getter
//*********************************
uml::Element *  AnyReceiveEventImpl::getOwner() const
{
...
std::vector<uml::Element * > *  AnyReceiveEventImpl::getOwnedElement() const
{
