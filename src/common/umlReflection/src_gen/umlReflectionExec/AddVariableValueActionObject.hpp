...
#ifndef UML_ADDVARIABLEVALUEACTION_EXECUTION_HPP
#define UML_ADDVARIABLEVALUEACTION_EXECUTION_HPP
...
namespace UML 
{
	class AddVariableValueActionObject : virtual public UML::WriteVariableActionObject
	{
		public:
		    //constructors
		    AddVariableValueActionObject(AddVariableValueActionObject &obj);
		    AddVariableValueActionObject(std::shared_ptr<uml::AddVariableValueAction>);
		 	AddVariableValueActionObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::AddVariableValueAction> getAddVariableValueActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setAddVariableValueActionValue(std::shared_ptr<uml::AddVariableValueAction>);
			virtual void setThisAddVariableValueActionObjectPtr(std::weak_ptr<AddVariableValueActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::AddVariableValueAction> m_AddVariableValueActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_ADDVARIABLEVALUEACTION_OBJECT_HPP */
