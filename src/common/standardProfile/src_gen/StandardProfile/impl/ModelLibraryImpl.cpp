...
ModelLibraryImpl::ModelLibraryImpl()
{
	...
	*/
	...
	//getter init
		...
		m_getterMap.insert(std::pair<long long,std::function<Any()>>(908252098,[this](){ return eAny(this->getBase_Package(), uml::umlPackage::PACKAGE_CLASS, false);}));
	
	
	//setter init
	//Property base_Package
		m_setterMap.insert(std::pair<long long,std::function<void(Any)>>(908252098,[this](Any object){this->setBase_Package(object->get<std::shared_ptr<uml::Package>>());}));
	
	
	//unsetter init
		//Property base_Package
		m_unsetterMap.insert(std::pair<long long,std::function<void()>>(908252098,[this](){m_base_Package = std::shared_ptr<uml::Package>(nullptr);}));
...
Any ModelLibraryImpl::get(long long _uID) const
{
...
void ModelLibraryImpl::set(long long _uID, Any value)
{
...
void ModelLibraryImpl::unset(long long _uID)
{
...
Any ModelLibraryImpl::invoke(long long _uID, std::shared_ptr<Bag<Any>> _arguments)
{
