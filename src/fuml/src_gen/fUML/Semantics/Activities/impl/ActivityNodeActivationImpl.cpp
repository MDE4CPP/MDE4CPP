...
void ActivityNodeActivationImpl::initialize(const std::shared_ptr<uml::ActivityNode>& node, const std::shared_ptr<fUML::Semantics::Activities::ActivityNodeActivationGroup>& group)
{
	//ADD_COUNT(__PRETTY_FUNCTION__)
	//generated from body annotation
...
bool ActivityNodeActivationImpl::eSet(int featureID, const Any& newValue)
{
	switch(featureID)
	{
		case fUML::Semantics::Activities::ActivitiesPackage::ACTIVITYNODEACTIVATION_ATTRIBUTE_GROUP:
...
// EOperation Invoke
//*********************************
Any ActivityNodeActivationImpl::eInvoke(int operationID, const std::shared_ptr<std::list<Any>>& arguments)
{
	Any result;
  	...
  	switch(operationID)
	{
		...
		{
			const std::shared_ptr<Bag<fUML::Semantics::Activities::Token>>& resultList = this->getTokens();
		...
		{
			const std::shared_ptr<Bag<fUML::Semantics::Activities::Token>>& resultList = this->takeTokens();
			return eAnyBag(resultList,fUML::Semantics::Activities::ActivitiesPackage::TOKEN_CLASS);
			break;
		}
