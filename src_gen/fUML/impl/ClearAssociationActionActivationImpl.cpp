...
//Additional constructor for the containments back reference
			ClearAssociationActionActivationImpl::ClearAssociationActionActivationImpl(std::weak_ptr<fUML::ActivityNodeActivationGroup > par_group)
...
// Union Getter
//*********************************
std::shared_ptr<Union<fUML::PinActivation>> ClearAssociationActionActivationImpl::getPinActivation() const
{
