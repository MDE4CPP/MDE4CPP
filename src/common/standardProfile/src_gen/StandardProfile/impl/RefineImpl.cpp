...
RefineImpl::RefineImpl()
{
	...
	*/
	...
	//getter init
		...
		m_getterMap.insert(std::pair<long long,std::function<Any()>>(1915089674,[this](){ return eAny(this->getBase_Abstraction(), uml::umlPackage::ABSTRACTION_CLASS, false);}));
	
	
	//setter init
	//Property base_Abstraction
		m_setterMap.insert(std::pair<long long,std::function<void(Any)>>(1915089674,[this](Any object){this->setBase_Abstraction(object->get<std::shared_ptr<uml::Abstraction>>());}));
	
	
	//unsetter init
		//Property base_Abstraction
		m_unsetterMap.insert(std::pair<long long,std::function<void()>>(1915089674,[this](){m_base_Abstraction = std::shared_ptr<uml::Abstraction>(nullptr);}));
...
Any RefineImpl::get(long long _uID) const
{
...
void RefineImpl::set(std::string _qualifiedName, Any value)
{
	long long uID = util::Util::polynomialRollingHash(_qualifiedName);
    this->set(uID, value);
}

void RefineImpl::set(long long _uID, Any value)
{
...
void RefineImpl::unset(long long _uID)
{
...
//*********************************
//Invoke
Any RefineImpl::invoke(std::shared_ptr<uml::Operation> _operation, std::shared_ptr<Bag<Any>> _arguments)
{
...
Any RefineImpl::invoke(std::string _qualifiedName, std::shared_ptr<Bag<Any>> _arguments)
{
	long long uID = util::Util::polynomialRollingHash(_qualifiedName);
    return this->invoke(uID, _arguments);
}

Any RefineImpl::invoke(long long _uID, std::shared_ptr<Bag<Any>> _arguments)
{
