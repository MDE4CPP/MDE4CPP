	...
	class UML_API DecisionNode: virtual public ControlNode
	{
		...
		public:
			...
			*/
			...
			virtual bool decision_input_flow_incoming(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool incoming_control_one_input_parameter(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool incoming_object_one_input_parameter(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool incoming_outgoing_edges(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool parameters(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool two_input_parameters(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool zero_input_parameters(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
