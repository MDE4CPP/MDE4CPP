...
namespace uml 
{
	class ConnectorEndImpl :virtual public MultiplicityElementImpl, virtual public ConnectorEnd 
	{
		...
		public:
			...
			virtual bool
			 role_and_part_with_port(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
			...
			virtual bool
			 part_with_port_empty(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
			...
			virtual bool
			 self_part_with_port(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
