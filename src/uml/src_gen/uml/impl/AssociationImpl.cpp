...
AssociationImpl::AssociationImpl(const AssociationImpl & obj): ClassifierImpl(obj), RelationshipImpl(obj), Association(obj)
{
	...
	for(auto _endType : *obj.getEndType()) 
	{
	...
	for(auto _memberEnd : *obj.getMemberEnd()) 
	{
	...
	for(auto _navigableOwnedEnd : *obj.getNavigableOwnedEnd()) 
	{
	...
	for(auto _ownedEnd : *obj.getOwnedEnd()) 
	{
