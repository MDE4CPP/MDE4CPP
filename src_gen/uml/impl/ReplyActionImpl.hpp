...
namespace uml 
{
	class ReplyActionImpl :virtual public ActionImpl, virtual public ReplyAction
	{
		...
		public:
			...
			virtual uml::Trigger *  getReplyToCall() const ;
			
			/*!
			 The Trigger specifying the Operation whose call is being replied to.
			<p>From package UML::Actions.</p> */
			virtual void setReplyToCall(uml::Trigger *  _replyToCall) ;
			...
			<p>From package UML::Actions.</p> */
			virtual std::vector<uml::InputPin * > *  getReplyValue() const ;
			
			/*!
			 An InputPin that holds the return information value produced by an earlier AcceptCallAction.
			<p>From package UML::Actions.</p> */
			virtual uml::InputPin *  getReturnInformation() const ;
			
			/*!
			 An InputPin that holds the return information value produced by an earlier AcceptCallAction.
			<p>From package UML::Actions.</p> */
			virtual void setReturnInformation(uml::InputPin *  _returnInformation) ;
