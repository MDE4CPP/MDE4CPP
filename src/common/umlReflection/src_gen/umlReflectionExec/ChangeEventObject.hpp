...
#ifndef UML_CHANGEEVENT_EXECUTION_HPP
#define UML_CHANGEEVENT_EXECUTION_HPP
...
namespace UML 
{
	class ChangeEventObject : virtual public UML::EventObject
	{
		public:
		    //constructors
		    ChangeEventObject(ChangeEventObject &obj);
		    ChangeEventObject(std::shared_ptr<uml::ChangeEvent>);
		 	ChangeEventObject();
		    //destructor
		    virtual ~ChangeEventObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			ChangeEventObject& operator=(ChangeEventObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::ChangeEvent> getChangeEventValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setChangeEventValue(std::shared_ptr<uml::ChangeEvent>);
			virtual void setThisChangeEventObjectPtr(std::weak_ptr<ChangeEventObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ChangeEvent> m_ChangeEventValue = nullptr;
	};
}
#endif /* end of include guard: UML_CHANGEEVENT_OBJECT_HPP */
