...
bool InstanceValueImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::INSTANCEVALUE_ATTRIBUTE_INSTANCE:
		{
			...
			if(ecoreAny)
			{
				...
				{
					DEBUG_MESSAGE(std::cout << __PRETTY_FUNCTION__ << " : Invalid type stored in 'ecore::ecoreAny' for feature 'instance'. Failed to set feature!"<< std::endl;)
					return false;
				}
			}
			else
			{
				DEBUG_MESSAGE(std::cout << __PRETTY_FUNCTION__ << " : Invalid instance of 'ecore::ecoreAny' for feature 'instance'. Failed to set feature!"<< std::endl;)
				return false;
			}
		return true;
		}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> InstanceValueImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
