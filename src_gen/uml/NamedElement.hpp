...
namespace uml 
{
	...
	class NamedElement:virtual public Element	{
		...
		public:
			...
			virtual bool
			 visibility_needs_ownership(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 has_qualified_name(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual bool
			 has_no_qualified_name(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  = 0;
			...
			virtual std::shared_ptr<uml::Dependency> 
			 createDependency(std::shared_ptr<uml::NamedElement>  supplier)  = 0;
			...
			virtual std::shared_ptr<uml::Usage> 
			 createUsage(std::shared_ptr<uml::NamedElement>  supplier)  = 0;
			...
			<p>From package UML::CommonStructure.</p> */ 
			virtual bool
			 isDistinguishableFrom(std::shared_ptr<uml::NamedElement>  n,std::shared_ptr<uml::Namespace>  ns)  = 0;
		...
		protected:
			...
			<p>From package UML::CommonStructure.</p> */
			std::shared_ptr<uml::Namespace > m_namespace;
