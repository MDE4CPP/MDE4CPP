...
std::shared_ptr<LiteralReal> LiteralRealImpl::getThisLiteralRealPtr()
{
...
bool LiteralRealImpl::internalEIsSet(int featureID) const
{
	...
	{
		case UmlPackage::LITERALREAL_EATTRIBUTE_VALUE:
			return getValue() != 0; //25215
	}
	return LiteralSpecificationImpl::internalEIsSet(featureID);
}
bool LiteralRealImpl::eSet(int featureID, boost::any newValue)
{
	switch(featureID)
	{
		case UmlPackage::LITERALREAL_EATTRIBUTE_VALUE:
...
//*********************************
void LiteralRealImpl::load(std::shared_ptr<persistence::interface::XLoadHandler> loadHandler)
{
...
void LiteralRealImpl::loadAttributes(std::shared_ptr<persistence::interface::XLoadHandler> loadHandler, std::map<std::string, std::string> attr_list)
{
	try
	{
...
void LiteralRealImpl::loadNode(std::string nodeName, std::shared_ptr<persistence::interface::XLoadHandler> loadHandler, std::shared_ptr<uml::UmlFactory> modelFactory)
{
...
void LiteralRealImpl::save(std::shared_ptr<persistence::interface::XSaveHandler> saveHandler) const
{
...
void LiteralRealImpl::saveContent(std::shared_ptr<persistence::interface::XSaveHandler> saveHandler) const
{
	try
	{
