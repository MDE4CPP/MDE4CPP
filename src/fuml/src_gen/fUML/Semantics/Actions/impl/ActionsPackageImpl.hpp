...
namespace fUML::Semantics::Actions
{
	class FUML_API ActionsPackageImpl : public ecore::EPackageImpl ,virtual public ActionsPackage
	{
		...
		public:
			...
			virtual std::shared_ptr<ecore::EOperation> getLinkActionActivation_Operation_endMatchesEndData_Element_LinkEndData() const ;
			virtual std::shared_ptr<ecore::EOperation> getLinkActionActivation_Operation_getAssociation() const ;
			virtual std::shared_ptr<ecore::EOperation> getLinkActionActivation_Operation_linkMatchesEndData_Element_LinkEndData() const ;
			...
			virtual std::shared_ptr<ecore::EOperation> getReturnInformation_Operation_equals_EJavaObject() const ;
		...
		private:
			...
			std::shared_ptr<ecore::EAttribute> m_actionActivation_Attribute_firing = nullptr;std::shared_ptr<ecore::EAttribute> m_values_Attribute_values = nullptr;std::shared_ptr<ecore::EAttribute> m_acceptEventActionActivation_Attribute_waiting = nullptr;
