...
#ifndef STANDARDPROFILE_SUBSYSTEM_HPP
#define STANDARDPROFILE_SUBSYSTEM_HPP
...
namespace StandardProfile 
{
	/*!
	 */
	class Subsystem : virtual public ecore::EObject 
...
#endif /* end of include guard: STANDARDPROFILE_SUBSYSTEM_HPP */
