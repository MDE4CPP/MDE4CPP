...
std::shared_ptr<Any> FoundationalModelLibrary::PrimitiveBehaviors::UnlimitedNaturalFunctions::invoke(std::shared_ptr<uml::OpaqueBehavior> _opaqueBehavior, std::shared_ptr<Bag<Any>> inputArguments, std::shared_ptr<Bag<Any>> outputArguments)
{
