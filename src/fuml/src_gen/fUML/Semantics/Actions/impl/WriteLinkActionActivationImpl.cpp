...
bool WriteLinkActionActivationImpl::eSet(int featureID, const Any& newValue)
{
	switch(featureID)
	{
	}
...
// EOperation Invoke
//*********************************
Any WriteLinkActionActivationImpl::eInvoke(int operationID, const std::shared_ptr<std::list<Any>>& arguments)
{
	Any result;
