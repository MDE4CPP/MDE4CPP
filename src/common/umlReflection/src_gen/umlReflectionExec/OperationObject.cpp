...
{	
	m_OperationValue.reset();

	fUML::Semantics::StructuredClassifiers::ObjectImpl::destroy();
}

std::shared_ptr<uml::Element> OperationObject::getUmlValue() const
{
	return getOperationValue();
}

std::shared_ptr<uml::Operation> OperationObject::getOperationValue() const
{
	return m_OperationValue;
}

void OperationObject::setUmlValue(std::shared_ptr<uml::Element> _element)
{
	setOperationValue(std::dynamic_pointer_cast<uml::Operation>(_element));
}

void OperationObject::setOperationValue(std::shared_ptr<uml::Operation> _OperationElement)
{
	m_OperationValue = _OperationElement;
	//set super type values
	UML::BehavioralFeatureObject::setBehavioralFeatureValue(_OperationElement);
	UML::ParameterableElementObject::setParameterableElementValue(_OperationElement);
	UML::TemplateableElementObject::setTemplateableElementValue(_OperationElement);
}

void OperationObject::setThisOperationObjectPtr(std::weak_ptr<OperationObject> thisObjectPtr)
{
	setThisCS_ObjectPtr(thisObjectPtr);
}

bool OperationObject::equals(std::shared_ptr<fUML::Semantics::Values::Value> otherValue)
{
	bool isEqual = false;
	
	std::shared_ptr<OperationObject> otherOperationObject = std::dynamic_pointer_cast<OperationObject>(otherValue);

	if(otherOperationObject != nullptr)
	{
		if(this->getOperationValue() == otherOperationObject->getOperationValue())
		{
			isEqual = true;
		}
	}
...
std::string OperationObject::toString()
{
	std::string buffer = "Instance of 'OperationObject', " + std::to_string(getTypes()->size()) + " types (";
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Object>> OperationObject::getDirectContainers()
{   
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Link>> OperationObject::getLinks(std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_InteractionPoint> interactionPoint)
{
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> OperationObject::retrieveEndValueAsInteractionPoint(std::shared_ptr<fUML::Semantics::Values::Value> endValue, std::shared_ptr<uml::ConnectorEnd> end)
{
	/*Not done for metamodel object classes*/
...
void OperationObject::removeValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<fUML::Semantics::Values::Value> value)
{
	...
	if (m_OperationValue == nullptr)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": no value stored inside OperationObject (property: " << feature->getName() << ")" << std::endl;
		throw "NullPointerException";	
	}

	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioralFeature_concurrency())
	{
				m_OperationValue->setConcurrency(uml::CallConcurrencyKind::SEQUENTIAL /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioralFeature_isAbstract())
	{
				m_OperationValue->setIsAbstract(false /*defined default value*/);

	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioralFeature_method())
	{
		if (value == nullptr) // clear mode
		{
			m_OperationValue->getMethod()->clear();
		}
		else
		{
			...
			{
				m_OperationValue->getMethod()->erase(inputValue->getBehaviorValue());
			}
		}
	}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioralFeature_ownedParameterSet())
	{
		if (value == nullptr) // clear mode
		{
			m_OperationValue->getOwnedParameterSet()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		if (value == nullptr) // clear mode
		{
			m_OperationValue->getOwnedComment()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_OperationValue->getOwnedComment()->erase(inputValue->getCommentValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Feature_isStatic())
	{
				m_OperationValue->setIsStatic(false /*defined default value*/);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_elementImport())
	{
		if (value == nullptr) // clear mode
		{
			m_OperationValue->getElementImport()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_OperationValue->getElementImport()->erase(inputValue->getElementImportValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_ownedRule())
	{
		if (value == nullptr) // clear mode
		{
			m_OperationValue->getOwnedRule()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_OperationValue->getOwnedRule()->erase(inputValue->getConstraintValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_packageImport())
	{
		if (value == nullptr) // clear mode
		{
			m_OperationValue->getPackageImport()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_OperationValue->getPackageImport()->erase(inputValue->getPackageImportValue());
			}
		}
	}
	...
	{
				m_OperationValue->setIsQuery(false /*defined default value*/);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_postcondition())
	{
		if (value == nullptr) // clear mode
		{
			m_OperationValue->getPostcondition()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_OperationValue->getPostcondition()->erase(inputValue->getConstraintValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_precondition())
	{
		if (value == nullptr) // clear mode
		{
			m_OperationValue->getPrecondition()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_OperationValue->getPrecondition()->erase(inputValue->getConstraintValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_raisedException())
	{
		if (value == nullptr) // clear mode
		{
			m_OperationValue->getRaisedException()->clear();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_redefinedOperation())
	{
		if (value == nullptr) // clear mode
		{
			m_OperationValue->getRedefinedOperation()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_OperationValue->getRedefinedOperation()->erase(inputValue->getOperationValue());
			}
		}
	}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateableElement_templateBinding())
	{
		if (value == nullptr) // clear mode
		{
			m_OperationValue->getTemplateBinding()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_OperationValue->getTemplateBinding()->erase(inputValue->getTemplateBindingValue());
			}
		}
	}
}
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> OperationObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	if (feature->getMetaElementID() != uml::umlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::umlPackage::PORT_CLASS && feature->getMetaElementID() != uml::umlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioralFeature_concurrency())
	{
		uml::CallConcurrencyKind concurrency = m_OperationValue->getConcurrency();
		...
		if (concurrency == uml::CallConcurrencyKind::SEQUENTIAL)
		{
			value->setLiteral(UML::UMLPackage::eInstance()->get_UML_CallConcurrencyKind_sequential());
		}
		if (concurrency == uml::CallConcurrencyKind::GUARDED)
		{
			value->setLiteral(UML::UMLPackage::eInstance()->get_UML_CallConcurrencyKind_guarded());
		}
		if (concurrency == uml::CallConcurrencyKind::CONCURRENT)
		{
			value->setLiteral(UML::UMLPackage::eInstance()->get_UML_CallConcurrencyKind_concurrent());
		}
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioralFeature_isAbstract())
	{
		...
		value->setValue(m_OperationValue->getIsAbstract());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioralFeature_method())
	{
		std::shared_ptr<Bag<uml::Behavior>> methodList = m_OperationValue->getMethod();
		Bag<uml::Behavior>::iterator iter = methodList->begin();
		Bag<uml::Behavior>::iterator end = methodList->end();
		while (iter != end)
		{
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioralFeature_ownedParameter())
	{
		std::shared_ptr<Subset<uml::Parameter, uml::NamedElement>> ownedParameterList = m_OperationValue->getOwnedParameter();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioralFeature_ownedParameterSet())
	{
		std::shared_ptr<Subset<uml::ParameterSet, uml::NamedElement>> ownedParameterSetList = m_OperationValue->getOwnedParameterSet();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Subset<uml::Comment, uml::Element>> ownedCommentList = m_OperationValue->getOwnedComment();
	...
	{
		std::shared_ptr<Union<uml::Element>> ownedElementList = m_OperationValue->getOwnedElement();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_owner())
	{
		...
		value->setThisElementObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setElementValue(m_OperationValue->getOwner().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<Union<uml::Classifier>> featuringClassifierList = m_OperationValue->getFeaturingClassifier();
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_OperationValue->getIsStatic());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_clientDependency())
	{
		std::shared_ptr<Bag<uml::Dependency>> clientDependencyList = m_OperationValue->getClientDependency();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		value->setValue(m_OperationValue->getName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		value->setLocus(this->getLocus());
		value->setStringExpressionValue(m_OperationValue->getNameExpression());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace())
	{
		...
		value->setLocus(this->getLocus());
		value->setNamespaceValue(m_OperationValue->getNamespace().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::StringValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createStringValue();
		value->setValue(m_OperationValue->getQualifiedName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		uml::VisibilityKind visibility = m_OperationValue->getVisibility();
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::EnumerationValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createEnumerationValue();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_elementImport())
	{
		std::shared_ptr<SubsetUnion<uml::ElementImport, uml::Element>> elementImportList = m_OperationValue->getElementImport();
	...
	{
		std::shared_ptr<Subset<uml::PackageableElement, uml::NamedElement>> importedMemberList = m_OperationValue->getImportedMember();
	...
	{
		std::shared_ptr<Union<uml::NamedElement>> memberList = m_OperationValue->getMember();
	...
	{
		std::shared_ptr<SubsetUnion<uml::NamedElement, uml::Element, uml::NamedElement>> ownedMemberList = m_OperationValue->getOwnedMember();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_ownedRule())
	{
		std::shared_ptr<SubsetUnion<uml::Constraint, uml::NamedElement>> ownedRuleList = m_OperationValue->getOwnedRule();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_packageImport())
	{
		std::shared_ptr<SubsetUnion<uml::PackageImport, uml::Element>> packageImportList = m_OperationValue->getPackageImport();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_bodyCondition())
	{
		...
		value->setThisConstraintObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setConstraintValue(m_OperationValue->getBodyCondition());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_class())
	{
		...
		value->setLocus(this->getLocus());
		value->setClassValue(m_OperationValue->getClass().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_datatype())
	{
		...
		value->setLocus(this->getLocus());
		value->setDataTypeValue(m_OperationValue->getDatatype().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_interface())
	{
		...
		value->setLocus(this->getLocus());
		value->setInterfaceValue(m_OperationValue->getInterface().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_isOrdered())
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_OperationValue->getIsOrdered());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_isQuery())
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_OperationValue->getIsQuery());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_isUnique())
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_OperationValue->getIsUnique());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_lower())
	{
		...
		value->setValue(m_OperationValue->getLower());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_ownedParameter())
	{
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_postcondition())
	{
		std::shared_ptr<Subset<uml::Constraint, uml::Constraint /*Subset does not reference a union*/>> postconditionList = m_OperationValue->getPostcondition();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_precondition())
	{
		std::shared_ptr<Subset<uml::Constraint, uml::Constraint /*Subset does not reference a union*/>> preconditionList = m_OperationValue->getPrecondition();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_redefinedOperation())
	{
		std::shared_ptr<Subset<uml::Operation, uml::RedefinableElement>> redefinedOperationList = m_OperationValue->getRedefinedOperation();
		Bag<uml::Operation>::iterator iter = redefinedOperationList->begin();
		Bag<uml::Operation>::iterator end = redefinedOperationList->end();
		while (iter != end)
		{
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_templateParameter())
	{
		std::shared_ptr<UML::OperationTemplateParameterObject> value(new UML::OperationTemplateParameterObject());
		value->setThisOperationTemplateParameterObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setOperationTemplateParameterValue(std::dynamic_pointer_cast<uml::OperationTemplateParameter>(m_OperationValue->getTemplateParameter()));
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_type())
	{
		std::shared_ptr<UML::TypeObject> value(new UML::TypeObject());
		value->setThisTypeObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setTypeValue(m_OperationValue->getType());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_upper())
	{
		...
		value->setValue(m_OperationValue->getUpper());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_ParameterableElement_owningTemplateParameter())
	{
		...
		value->setLocus(this->getLocus());
		value->setTemplateParameterValue(m_OperationValue->getOwningTemplateParameter().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::BooleanValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createBooleanValue();
		value->setValue(m_OperationValue->getIsLeaf());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_redefinedElement())
	{
		std::shared_ptr<Union<uml::RedefinableElement>> redefinedElementList = m_OperationValue->getRedefinedElement();
	...
	{
		std::shared_ptr<Union<uml::Classifier>> redefinitionContextList = m_OperationValue->getRedefinitionContext();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateableElement_ownedTemplateSignature())
	{
		...
		value->setLocus(this->getLocus());
		value->setTemplateSignatureValue(m_OperationValue->getOwnedTemplateSignature());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateableElement_templateBinding())
	{
		std::shared_ptr<Subset<uml::TemplateBinding, uml::Element>> templateBindingList = m_OperationValue->getTemplateBinding();
...
std::shared_ptr<fUML::Semantics::SimpleClassifiers::FeatureValue> OperationObject::retrieveFeatureValue(std::shared_ptr<uml::StructuralFeature> feature)
{
...
void OperationObject::setFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	if (feature->getMetaElementID() != uml::umlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::umlPackage::PORT_CLASS && feature->getMetaElementID() != uml::umlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioralFeature_concurrency())
	{
		...
		if (literal == UML::UMLPackage::eInstance()->get_UML_CallConcurrencyKind_sequential())
		{
			m_OperationValue->setConcurrency(uml::CallConcurrencyKind::SEQUENTIAL);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_CallConcurrencyKind_guarded())
		{
			m_OperationValue->setConcurrency(uml::CallConcurrencyKind::GUARDED);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_CallConcurrencyKind_concurrent())
		{
			m_OperationValue->setConcurrency(uml::CallConcurrencyKind::CONCURRENT);
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioralFeature_isAbstract())
	{
		...
		{
			m_OperationValue->setIsAbstract(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioralFeature_method())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_OperationValue->getMethod()->push_back(value->getBehaviorValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_OperationValue->getOwnedComment()->push_back(value->getCommentValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Feature_isStatic())
	{
		...
		if (valueObject != nullptr)
		{
			m_OperationValue->setIsStatic(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		if (valueObject != nullptr)
		{
			m_OperationValue->setName(valueObject->getValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		if (value != nullptr)
		{
			m_OperationValue->setNameExpression(value->getStringExpressionValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		...
		{
			m_OperationValue->setVisibility(uml::VisibilityKind::PUBLIC);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_private())
		{
			m_OperationValue->setVisibility(uml::VisibilityKind::PRIVATE);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_protected())
		{
			m_OperationValue->setVisibility(uml::VisibilityKind::PROTECTED);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_package())
		{
			m_OperationValue->setVisibility(uml::VisibilityKind::PACKAGE);
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_elementImport())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_OperationValue->getElementImport()->push_back(value->getElementImportValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_ownedRule())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_OperationValue->getOwnedRule()->push_back(value->getConstraintValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_packageImport())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_OperationValue->getPackageImport()->push_back(value->getPackageImportValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_bodyCondition())
	{
		...
		if (value != nullptr)
		{
			m_OperationValue->setBodyCondition(value->getConstraintValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_isQuery())
	{
		...
		if (valueObject != nullptr)
		{
			m_OperationValue->setIsQuery(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_postcondition())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_OperationValue->getPostcondition()->push_back(value->getConstraintValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_precondition())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_OperationValue->getPrecondition()->push_back(value->getConstraintValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_redefinedOperation())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_OperationValue->getRedefinedOperation()->push_back(value->getOperationValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Operation_templateParameter())
	{
		std::shared_ptr<fUML::Semantics::Values::Value> inputValue = values->at(0);
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = std::dynamic_pointer_cast<PSCS::Semantics::StructuredClassifiers::CS_Reference>(inputValue);
		std::shared_ptr<UML::OperationTemplateParameterObject> value = std::dynamic_pointer_cast<UML::OperationTemplateParameterObject>(reference->getReferent());
		if (value != nullptr)
		{
			m_OperationValue->setTemplateParameter(value->getOperationTemplateParameterValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_isLeaf())
	{
		...
		if (valueObject != nullptr)
		{
			m_OperationValue->setIsLeaf(valueObject->isValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateableElement_ownedTemplateSignature())
	{
		...
		if (value != nullptr)
		{
			m_OperationValue->setOwnedTemplateSignature(value->getTemplateSignatureValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateableElement_templateBinding())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_OperationValue->getTemplateBinding()->push_back(value->getTemplateBindingValue());
			}
...
void OperationObject::assignFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	this->setFeatureValue(feature, values, position);
}

std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> OperationObject::retrieveFeatureValues()
{
	...
	for(unsigned int i = 0; i < allAttributesSize; i++)
	{
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_BehavioralFeature_method() && m_OperationValue->getMethod() != nullptr)
		{
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment() && m_OperationValue->getOwnedComment() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedElement() && m_OperationValue->getOwnedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_owner() && m_OperationValue->getOwner().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Feature_featuringClassifier() && m_OperationValue->getFeaturingClassifier() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_clientDependency() && m_OperationValue->getClientDependency() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression() && m_OperationValue->getNameExpression() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace() && m_OperationValue->getNamespace().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Namespace_elementImport() && m_OperationValue->getElementImport() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Namespace_importedMember() && m_OperationValue->getImportedMember() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Namespace_member() && m_OperationValue->getMember() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Namespace_ownedMember() && m_OperationValue->getOwnedMember() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Namespace_ownedRule() && m_OperationValue->getOwnedRule() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Namespace_packageImport() && m_OperationValue->getPackageImport() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Operation_bodyCondition() && m_OperationValue->getBodyCondition() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Operation_class() && m_OperationValue->getClass().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Operation_datatype() && m_OperationValue->getDatatype().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Operation_interface() && m_OperationValue->getInterface().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_Operation_postcondition() && m_OperationValue->getPostcondition() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Operation_precondition() && m_OperationValue->getPrecondition() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Operation_raisedException() && m_OperationValue->getRaisedException() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Operation_redefinedOperation() && m_OperationValue->getRedefinedOperation() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Operation_templateParameter() && m_OperationValue->getTemplateParameter() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Operation_type() && m_OperationValue->getType() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_redefinedElement() && m_OperationValue->getRedefinedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_RedefinableElement_redefinitionContext() && m_OperationValue->getRedefinitionContext() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_TemplateableElement_ownedTemplateSignature() && m_OperationValue->getOwnedTemplateSignature() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_TemplateableElement_templateBinding() && m_OperationValue->getTemplateBinding() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
	}
