...
namespace fUML::Semantics::Actions 
{
	...
	class FUML_API ReplyActionActivation: virtual public ActionActivation
	{
		public:
...
#endif /* end of include guard: FUML_SEMANTICS_ACTIONS_REPLYACTIONACTIVATION_HPP */
