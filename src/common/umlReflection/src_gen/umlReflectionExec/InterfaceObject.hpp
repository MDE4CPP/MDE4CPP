...
#ifndef UML_INTERFACE_EXECUTION_HPP
#define UML_INTERFACE_EXECUTION_HPP
...
namespace UML 
{
	class InterfaceObject : virtual public UML::ClassifierObject
	{
		public:
		    //constructors
		    InterfaceObject(InterfaceObject &obj);
		    InterfaceObject(std::shared_ptr<uml::Interface>);
		 	InterfaceObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::Interface> getInterfaceValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setInterfaceValue(std::shared_ptr<uml::Interface>);
			virtual void setThisInterfaceObjectPtr(std::weak_ptr<InterfaceObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Interface> m_InterfaceValue = nullptr;
	};
}
#endif /* end of include guard: UML_INTERFACE_OBJECT_HPP */
