...
ecore::EClass* RealizationImpl::eStaticClass() const
{
...
// Union Getter
//*********************************
std::vector<uml::Element * > *  RealizationImpl::getRelatedElement() const
{
...
std::vector<uml::Element * > *  RealizationImpl::getOwnedElement() const
{
...
uml::Element *  RealizationImpl::getOwner() const
{
...
std::vector<uml::Element * > *  RealizationImpl::getTarget() const
{
...
std::vector<uml::Element * > *  RealizationImpl::getSource() const
{
