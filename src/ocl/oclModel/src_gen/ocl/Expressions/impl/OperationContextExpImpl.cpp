...
bool OperationContextExpImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::OPERATIONCONTEXTEXP_ATTRIBUTE_INPUTPARAMETERS:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> OperationContextExpImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
