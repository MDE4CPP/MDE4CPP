...
// Union Getter
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::ActivityGroup>>> ValueSpecificationActionImpl::getInGroup() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> ValueSpecificationActionImpl::getOwnedElement() const
{
...
std::shared_ptr<uml::Element> ValueSpecificationActionImpl::getOwner() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> ValueSpecificationActionImpl::getRedefinedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::OutputPin>>> ValueSpecificationActionImpl::getOutput() const
{
