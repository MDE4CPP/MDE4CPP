...
// Union Getter
//*********************************
std::shared_ptr<Union<fUML::Semantics::Actions::PinActivation>> ClearAssociationActionActivationImpl::getPinActivation() const
{
...
//*********************************
Any ClearAssociationActionActivationImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
	}
...
bool ClearAssociationActionActivationImpl::eSet(int featureID, Any newValue)
{
	switch(featureID)
	{
	}
...
void ClearAssociationActionActivationImpl::loadNode(std::string nodeName, std::shared_ptr<persistence::interfaces::XLoadHandler> loadHandler, std::shared_ptr<fUML::FUMLFactory> modelFactory)
{
...
void ClearAssociationActionActivationImpl::resolveReferences(const int featureID, std::list<std::shared_ptr<ecore::EObject> > references)
{
