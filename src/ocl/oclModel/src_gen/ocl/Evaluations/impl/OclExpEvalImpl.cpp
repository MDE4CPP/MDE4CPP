...
bool OclExpEvalImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case ocl::Evaluations::EvaluationsPackage::OCLEXPEVAL_ATTRIBUTE_BEFOREENVIRONMENT:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> OclExpEvalImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
