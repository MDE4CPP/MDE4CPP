...
#ifndef UML_EXECUTIONSPECIFICATION_EXECUTION_HPP
#define UML_EXECUTIONSPECIFICATION_EXECUTION_HPP
...
namespace UML 
{
	class ExecutionSpecificationObject : virtual public UML::InteractionFragmentObject
	{
		public:
		    //constructors
		    ExecutionSpecificationObject(ExecutionSpecificationObject &obj);
		    ExecutionSpecificationObject(std::shared_ptr<uml::ExecutionSpecification>);
		 	ExecutionSpecificationObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::ExecutionSpecification> getExecutionSpecificationValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setExecutionSpecificationValue(std::shared_ptr<uml::ExecutionSpecification>);
			virtual void setThisExecutionSpecificationObjectPtr(std::weak_ptr<ExecutionSpecificationObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ExecutionSpecification> m_ExecutionSpecificationValue = nullptr;
	};
}
#endif /* end of include guard: UML_EXECUTIONSPECIFICATION_OBJECT_HPP */
