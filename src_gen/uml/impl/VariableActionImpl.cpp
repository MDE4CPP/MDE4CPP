...
std::shared_ptr<std::vector<std::shared_ptr<uml::ActivityGroup>>> VariableActionImpl::getInGroup() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> VariableActionImpl::getOwnedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> VariableActionImpl::getRedefinedElement() const
{
