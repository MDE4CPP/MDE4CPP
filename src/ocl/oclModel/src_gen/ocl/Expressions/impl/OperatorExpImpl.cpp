...
bool OperatorExpImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::OPERATOREXP_ATTRIBUTE_LEFTHANDOPERAND:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> OperatorExpImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
