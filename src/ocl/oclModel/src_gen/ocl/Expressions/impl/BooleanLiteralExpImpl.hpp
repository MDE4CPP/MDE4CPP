...
namespace ocl::Expressions 
{
	class OCL_API BooleanLiteralExpImpl : virtual public PrimitiveLiteralExpImpl, virtual public BooleanLiteralExp 
	{
		...
		protected:
			...
			virtual std::shared_ptr<ocl::Expressions::BooleanLiteralExp> getThisBooleanLiteralExpPtr() const;
			virtual void setThisBooleanLiteralExpPtr(std::weak_ptr<ocl::Expressions::BooleanLiteralExp> thisBooleanLiteralExpPtr);
			...
			//Additional constructors for the containments back reference
			//Additional constructors for the containments back reference
			BooleanLiteralExpImpl(std::weak_ptr<ocl::Expressions::LoopExp> par_LoopExp, const int reference_id);
			//Additional constructors for the containments back reference
			//Additional constructors for the containments back reference
		...
		public:
			...
			//*********************************
			virtual bool isBooleanSymbol() const ;
		...
		private:
			std::weak_ptr<ocl::Expressions::BooleanLiteralExp> m_thisBooleanLiteralExpPtr;
	};
}
