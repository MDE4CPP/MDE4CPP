...
const std::shared_ptr<ecore::EDataType>& types::typesPackageImpl::getAny_Class() const
{
	return m_any_Class;
}
const std::shared_ptr<ecore::EDataType>& types::typesPackageImpl::getBoolean_Class() const
{
	return m_boolean_Class;
}
const std::shared_ptr<ecore::EDataType>& types::typesPackageImpl::getInteger_Class() const
{
	return m_integer_Class;
}
const std::shared_ptr<ecore::EDataType>& types::typesPackageImpl::getReal_Class() const
{
	return m_real_Class;
}
const std::shared_ptr<ecore::EDataType>& types::typesPackageImpl::getString_Class() const
{
	return m_string_Class;
}
const std::shared_ptr<ecore::EDataType>& types::typesPackageImpl::getUnlimitedNatural_Class() const
{
