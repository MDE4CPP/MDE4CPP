...
router.get('/:pluginName/objects/tree', pluginController.getObjectTree);
router.post('/:pluginName/objects/:parentName/children/:className/:childName', pluginController.createChildObject);
router.post('/:pluginName/objects', pluginController.createObject);
router.get('/objects', pluginController.listObjects);
router.get('/objects/export', pluginController.exportObjects);
