...
ecore::EClass* CreateLinkActionImpl::eStaticClass() const
{
...
// Union Getter
//*********************************
uml::Element *  CreateLinkActionImpl::getOwner() const
{
...
std::vector<uml::Element * > *  CreateLinkActionImpl::getOwnedElement() const
{
...
std::vector<uml::InputPin * > *  CreateLinkActionImpl::getInput() const
{
...
std::vector<uml::ActivityGroup * > *  CreateLinkActionImpl::getInGroup() const
{
...
std::vector<uml::RedefinableElement * > *  CreateLinkActionImpl::getRedefinedElement() const
{
