...
namespace ocl::Expressions 
{
	class OCL_API EnumLiteralExpImpl : virtual public LiteralExpImpl, virtual public EnumLiteralExp 
	{
		...
		public:
			...
			//*********************************
			virtual const std::shared_ptr<uml::EnumerationLiteral>& getReferredEnumLiteral() const ;
			virtual void setReferredEnumLiteral(const std::shared_ptr<uml::EnumerationLiteral>&) ;
