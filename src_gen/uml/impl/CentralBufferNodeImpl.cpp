...
//Additional constructor for the containments back reference
			CentralBufferNodeImpl::CentralBufferNodeImpl(std::shared_ptr<uml::Activity > par_activity)
...
//Additional constructor for the containments back reference
			CentralBufferNodeImpl::CentralBufferNodeImpl(std::shared_ptr<uml::Namespace > par_namespace)
			:CentralBufferNodeImpl()
			{
