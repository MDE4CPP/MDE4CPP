...
namespace uml 
{
	class UML_API TypeImpl : virtual public PackageableElementImpl, virtual public Type 
	{
		...
		protected:
			...
			TypeImpl();
			virtual std::shared_ptr<uml::Type> getThisTypePtr() const;
			virtual void setThisTypePtr(std::weak_ptr<uml::Type> thisTypePtr);
		...
		public:
			...
			*/
			...
			virtual bool conformsTo(const std::shared_ptr<uml::Type>& other) ;
			/*!
		...
		private:
			std::weak_ptr<uml::Type> m_thisTypePtr;
	};
}
