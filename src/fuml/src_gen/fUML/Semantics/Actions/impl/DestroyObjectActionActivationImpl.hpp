...
namespace fUML::Semantics::Actions 
{
	class FUML_API DestroyObjectActionActivationImpl : virtual public ActionActivationImpl, virtual public DestroyObjectActionActivation 
	{
		...
		public:
			...
			// Operations
			//*********************************
			virtual void destroyObject(const std::shared_ptr<fUML::Semantics::Values::Value>& value, bool isDestroyLinks, bool isDestroyOwnedObjects) ;
			virtual void doAction() ;
			virtual bool objectIsComposite(const std::shared_ptr<fUML::Semantics::StructuredClassifiers::Reference>& reference, const std::shared_ptr<fUML::Semantics::StructuredClassifiers::Link>& link) ;
