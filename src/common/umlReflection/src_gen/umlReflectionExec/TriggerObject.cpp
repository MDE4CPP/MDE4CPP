...
{
	std::shared_ptr<TriggerObject> element(new TriggerObject(*this));
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> TriggerObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Bag<uml::Comment>> ownedCommentList = m_TriggerValue->getOwnedComment();
	...
	{
		std::shared_ptr<Bag<uml::Element>> ownedElementList = m_TriggerValue->getOwnedElement();
