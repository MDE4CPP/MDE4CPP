...
{
	class IteratorExpImpl : virtual public LoopExpImpl, virtual public IteratorExp 
	{
		public: 
		...
		protected:
			...
			IteratorExpImpl();
			virtual std::shared_ptr<IteratorExp> getThisIteratorExpPtr() const;
			virtual void setThisIteratorExpPtr(std::weak_ptr<IteratorExp> thisIteratorExpPtr);

			//Additional constructors for the containments back reference
			IteratorExpImpl(std::weak_ptr<ocl::Expressions::CallExp> par_appliedElement);
			//Additional constructors for the containments back reference
			...
			//Additional constructors for the containments back reference
			//Additional constructors for the containments back reference
			IteratorExpImpl(std::weak_ptr<ocl::Expressions::Variable> par_initializedElement);
			//Additional constructors for the containments back reference
			//Additional constructors for the containments back reference
			IteratorExpImpl(std::weak_ptr<ocl::Expressions::LoopExp> par_loopBodyOwner);
			//Additional constructors for the containments back reference
		...
		private:
			std::weak_ptr<IteratorExp> m_thisIteratorExpPtr;
	};
}
