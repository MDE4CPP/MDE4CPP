...
#ifndef UML_PRIMITIVETYPE_EXECUTION_HPP
#define UML_PRIMITIVETYPE_EXECUTION_HPP
...
namespace UML 
{
	class PrimitiveTypeObject : virtual public UML::DataTypeObject
	{
		public:
		    //constructors
		    PrimitiveTypeObject(PrimitiveTypeObject &obj);
		    PrimitiveTypeObject(std::shared_ptr<uml::PrimitiveType>);
		 	PrimitiveTypeObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::PrimitiveType> getPrimitiveTypeValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setPrimitiveTypeValue(std::shared_ptr<uml::PrimitiveType>);
			virtual void setThisPrimitiveTypeObjectPtr(std::weak_ptr<PrimitiveTypeObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::PrimitiveType> m_PrimitiveTypeValue = nullptr;
	};
}
#endif /* end of include guard: UML_PRIMITIVETYPE_OBJECT_HPP */
