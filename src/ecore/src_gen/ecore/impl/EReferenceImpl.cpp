...
//*********************************
std::shared_ptr<Any> EReferenceImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
		case ecore::ecorePackage::EREFERENCE_ATTRIBUTE_CONTAINER:
			return eAny(isContainer(),ecore::ecorePackage::EBOOLEAN_CLASS,false); //4622
		case ecore::ecorePackage::EREFERENCE_ATTRIBUTE_CONTAINMENT:
			return eAny(isContainment(),ecore::ecorePackage::EBOOLEAN_CLASS,false); //4621
		case ecore::ecorePackage::EREFERENCE_ATTRIBUTE_EKEYS:
			return eEcoreContainerAny(getEKeys(),ecore::ecorePackage::EATTRIBUTE_CLASS); //4626
		case ecore::ecorePackage::EREFERENCE_ATTRIBUTE_EOPPOSITE:
			return eAny(getEOpposite(),ecore::ecorePackage::EREFERENCE_CLASS,false); //4624
		case ecore::ecorePackage::EREFERENCE_ATTRIBUTE_EREFERENCETYPE:
			return eAny(getEReferenceType(),ecore::ecorePackage::ECLASS_CLASS,false); //4625
		case ecore::ecorePackage::EREFERENCE_ATTRIBUTE_RESOLVEPROXIES:
			return eAny(isResolveProxies(),ecore::ecorePackage::EBOOLEAN_CLASS,false); //4623
	}
...
bool EReferenceImpl::internalEIsSet(int featureID) const
{
	...
	{
		case ecore::ecorePackage::EREFERENCE_ATTRIBUTE_CONTAINER:
			return isContainer() != false; //4622
		case ecore::ecorePackage::EREFERENCE_ATTRIBUTE_CONTAINMENT:
			return isContainment() != false; //4621
		case ecore::ecorePackage::EREFERENCE_ATTRIBUTE_EKEYS:
			return getEKeys() != nullptr; //4626
		case ecore::ecorePackage::EREFERENCE_ATTRIBUTE_EOPPOSITE:
			return getEOpposite() != nullptr; //4624
		case ecore::ecorePackage::EREFERENCE_ATTRIBUTE_EREFERENCETYPE:
			return getEReferenceType() != nullptr; //4625
		case ecore::ecorePackage::EREFERENCE_ATTRIBUTE_RESOLVEPROXIES:
			return isResolveProxies() != true; //4623
	}
	return EStructuralFeatureImpl::internalEIsSet(featureID);
}

bool EReferenceImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case ecore::ecorePackage::EREFERENCE_ATTRIBUTE_CONTAINMENT:
		{
			try
			{
				...
				setContainment(_containment); //4621
			}
			catch(...)
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for feature 'containment'. Failed to set feature!")
				return false;
			}
		return true;
		}
		case ecore::ecorePackage::EREFERENCE_ATTRIBUTE_EKEYS:
		{
			...
			if(ecoreContainerAny)
			{
				...
				{
					DEBUG_ERROR("Invalid type stored in 'ecore::ecoreContainerAny' for feature 'eKeys'. Failed to set feature!")
					return false;
				}
			}
			else
			{
				DEBUG_ERROR("Invalid instance of 'ecore::ecoreContainerAny' for feature 'eKeys'. Failed to set feature!")
				return false;
			}
		return true;
		}
		case ecore::ecorePackage::EREFERENCE_ATTRIBUTE_EOPPOSITE:
		{
			...
			if(ecoreAny)
			{
				...
				{
					DEBUG_ERROR("Invalid type stored in 'ecore::ecoreAny' for feature 'eOpposite'. Failed to set feature!")
					return false;
				}
			}
			else
			{
				DEBUG_ERROR("Invalid instance of 'ecore::ecoreAny' for feature 'eOpposite'. Failed to set feature!")
				return false;
			}
		return true;
		}
		case ecore::ecorePackage::EREFERENCE_ATTRIBUTE_EREFERENCETYPE:
		{
			...
			if(ecoreAny)
			{
				try
				{
					...
					if(_eReferenceType)
					{
						setEReferenceType(_eReferenceType); //4625
					}
					else
					{
						throw "Invalid argument";
				...
				{
					DEBUG_ERROR("Invalid type stored in 'ecore::ecoreAny' for feature 'eReferenceType'. Failed to set feature!")
					return false;
				}
			}
			else
			{
				DEBUG_ERROR("Invalid instance of 'ecore::ecoreAny' for feature 'eReferenceType'. Failed to set feature!")
				return false;
			}
		return true;
		}
		case ecore::ecorePackage::EREFERENCE_ATTRIBUTE_RESOLVEPROXIES:
		{
			try
			{
				...
				setResolveProxies(_resolveProxies); //4623
			}
			catch(...)
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for feature 'resolveProxies'. Failed to set feature!")
				return false;
			}
		return true;
		}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> EReferenceImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
