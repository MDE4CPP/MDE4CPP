...
const std::shared_ptr<ecore::EReference>& fUML::Semantics::Loci::LociPackageImpl::getExecutionFactory_Attribute_primitiveBehaviorPrototypes() const
{
...
const std::shared_ptr<ecore::EOperation>& fUML::Semantics::Loci::LociPackageImpl::getExecutionFactory_Operation_addPrimitiveBehaviorPrototype_OpaqueBehaviorExecution() const
{
...
const std::shared_ptr<ecore::EOperation>& fUML::Semantics::Loci::LociPackageImpl::getExecutionFactory_Operation_createEvaluation_ValueSpecification() const
{
	return m_executionFactory_Operation_createEvaluation_ValueSpecification;
}
const std::shared_ptr<ecore::EOperation>& fUML::Semantics::Loci::LociPackageImpl::getExecutionFactory_Operation_createExecution_Behavior_Object() const
{
...
const std::shared_ptr<ecore::EOperation>& fUML::Semantics::Loci::LociPackageImpl::getExecutionFactory_Operation_instantiateOpaqueBehaviorExecution_Behavior() const
{
...
const std::shared_ptr<ecore::EOperation>& fUML::Semantics::Loci::LociPackageImpl::getLocus_Operation_add_ExtensionalValue() const
{
...
const std::shared_ptr<ecore::EOperation>& fUML::Semantics::Loci::LociPackageImpl::getLocus_Operation_remove_ExtensionalValue() const
{
