...
// Operations
//*********************************
Any LiteralRealEvaluationImpl::evaluate()
{
...
// EOperation Invoke
//*********************************
Any LiteralRealEvaluationImpl::eInvoke(int operationID, std::shared_ptr<std::list<Any>> arguments)
{
	Any result;
 
  	switch(operationID)
	{
		// fUML::Semantics::Values::LiteralRealEvaluation::evaluate() : Any: 3477098586
