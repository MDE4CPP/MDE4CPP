...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> AssociationClassImpl::getRedefinedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> AssociationClassImpl::getOwnedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> AssociationClassImpl::getRelatedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Property>>> AssociationClassImpl::getAttribute() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> AssociationClassImpl::getOwnedMember() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::ConnectableElement>>> AssociationClassImpl::getRole() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> AssociationClassImpl::getMember() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Feature>>> AssociationClassImpl::getFeature() const
{
