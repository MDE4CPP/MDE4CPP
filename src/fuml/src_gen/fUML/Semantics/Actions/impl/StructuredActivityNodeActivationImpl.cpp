...
Any StructuredActivityNodeActivationImpl::eInvoke(int operationID, const std::shared_ptr<std::list<Any>>& arguments)
{
  	...
  	switch(operationID)
	{
		...
		case ActionsPackage::STRUCTUREDACTIVITYNODEACTIVATION_OPERATION_GETPINVALUES_OUTPUTPIN:
		{
			...
			const std::shared_ptr<Bag<fUML::Semantics::Values::Value>>& resultList = this->getPinValues(incoming_param_pin);
		...
		case ActionsPackage::STRUCTUREDACTIVITYNODEACTIVATION_OPERATION_MAKEACTIVITYNODELIST_EXECUTABLENODE:
		{
			...
			const std::shared_ptr<Bag<uml::ActivityNode>>& resultList = this->makeActivityNodeList(incoming_param_nodes);
