...
std::shared_ptr<ReadLinkActionActivation> ReadLinkActionActivationImpl::getThisReadLinkActionActivationPtr()
{
	...
	{
		std::shared_ptr<Bag<fUML::ActivityNodeActivation>> ownersReadLinkActionActivationList = wp->getNodeActivations();
		for (std::shared_ptr<fUML::ActivityNodeActivation> anReadLinkActionActivation : *ownersReadLinkActionActivationList)
		{
			if (anReadLinkActionActivation.get() == this)
			{
				return std::dynamic_pointer_cast<ReadLinkActionActivation>(anReadLinkActionActivation );
			}
		}
	}
	struct null_deleter{void operator()(void const *) const {}};
	return std::shared_ptr<ReadLinkActionActivation>(this, null_deleter());
}
