...
// Union Getter
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::ActivityGroup>>> DestroyObjectActionImpl::getInGroup() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::InputPin>>> DestroyObjectActionImpl::getInput() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> DestroyObjectActionImpl::getRedefinedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> DestroyObjectActionImpl::getOwnedElement() const
{
