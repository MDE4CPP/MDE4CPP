...
#ifndef STANDARDPROFILEPLUGIN_HPP
#define STANDARDPROFILEPLUGIN_HPP

#include "pluginFramework/EcoreModelPlugin.hpp"

namespace StandardProfile
{
	class StandardProfilePlugin : virtual public EcoreModelPlugin
	{
		public:
...
#endif /* end of include guard: STANDARDPROFILEPLUGIN_HPP */
