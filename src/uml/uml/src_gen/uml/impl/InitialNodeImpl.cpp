...
bool InitialNodeImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
	}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> InitialNodeImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
