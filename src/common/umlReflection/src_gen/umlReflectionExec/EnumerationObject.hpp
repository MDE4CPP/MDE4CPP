...
#ifndef UML_ENUMERATION_EXECUTION_HPP
#define UML_ENUMERATION_EXECUTION_HPP
...
namespace UML 
{
	class EnumerationObject : virtual public UML::DataTypeObject
	{
		public:
		    //constructors
		    EnumerationObject(EnumerationObject &obj);
		    EnumerationObject(std::shared_ptr<uml::Enumeration>);
		 	EnumerationObject();
		    //destructor
		    virtual ~EnumerationObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			EnumerationObject& operator=(EnumerationObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::Enumeration> getEnumerationValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setEnumerationValue(std::shared_ptr<uml::Enumeration>);
			virtual void setThisEnumerationObjectPtr(std::weak_ptr<EnumerationObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Enumeration> m_EnumerationValue = nullptr;
	};
}
#endif /* end of include guard: UML_ENUMERATION_OBJECT_HPP */
