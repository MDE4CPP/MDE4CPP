...
namespace uml 
{
	...
	class Extension:virtual public Association	{
		...
		public:
			...
			<p>From package UML::Packages.</p> */ 
			virtual uml::Property *  metaclassEnd()  = 0;
			...
			<p>From package UML::Packages.</p> */
			virtual uml::Class *  getMetaclass() const = 0;
