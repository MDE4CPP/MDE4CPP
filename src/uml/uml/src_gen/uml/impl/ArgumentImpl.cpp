...
//*********************************
std::shared_ptr<Any> ArgumentImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
...
bool ArgumentImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::ARGUMENT_ATTRIBUTE_NAME:
		...
		case uml::umlPackage::ARGUMENT_ATTRIBUTE_VALUE:
		{
			...
			if(ecoreAny)
			{
				try
				{
					...
					std::shared_ptr<uml::Object> _value = std::dynamic_pointer_cast<uml::Object>(eObject);
					if(_value)
					{
						setValue(_value); //191
					}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ArgumentImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
