	...
	*/
	class UML4CPPProfilePackage : virtual public uml::Profile
	{
		...
		public:
			...
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_DoNotGenerate_UML4CPPProfile_DoNotGenerate() = 0;  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_ExternalLibrary_UML4CPPProfile_ExternalLibrary() = 0;  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_GetterName_UML4CPPProfile_GetterName() = 0;  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_MainBehavior_UML4CPPProfile_MainBehavior() = 0;  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_NonExecutable_UML4CPPProfile_NonExecutable() = 0;  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_SetterName_UML4CPPProfile_SetterName() = 0;  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_Singleton_UML4CPPProfile_Singleton() = 0;  
			virtual const std::shared_ptr<uml::ExtensionEnd>& get_ExtensionEnd_extension_UML4CPPPackage_UML4CPPProfile_UML4CPPPackage() = 0;  
			virtual const std::shared_ptr<uml::Extension>& get_UML4CPPProfile_Behavior_MainBehavior() = 0;  
			virtual const std::shared_ptr<uml::Extension>& get_UML4CPPProfile_Class_Singleton() = 0;  
			virtual const std::shared_ptr<uml::Stereotype>& get_UML4CPPProfile_DoNotGenerate() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_UML4CPPProfile_DoNotGenerate_base_Element() = 0;  
			virtual const std::shared_ptr<uml::Extension>& get_UML4CPPProfile_Element_DoNotGenerate() = 0;  
			virtual const std::shared_ptr<uml::Stereotype>& get_UML4CPPProfile_ExternalLibrary() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_UML4CPPProfile_ExternalLibrary_base_Package() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_UML4CPPProfile_ExternalLibrary_includePath() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_UML4CPPProfile_ExternalLibrary_libraryName() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_UML4CPPProfile_ExternalLibrary_libraryPath() = 0;  
			virtual const std::shared_ptr<uml::Stereotype>& get_UML4CPPProfile_GetterName() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_UML4CPPProfile_GetterName_base_Property() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_UML4CPPProfile_GetterName_getterName() = 0;  
			virtual const std::shared_ptr<uml::Stereotype>& get_UML4CPPProfile_MainBehavior() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_UML4CPPProfile_MainBehavior_base_Behavior() = 0;  
			virtual const std::shared_ptr<uml::Extension>& get_UML4CPPProfile_NamedElement_NonExecutable() = 0;  
			virtual const std::shared_ptr<uml::Stereotype>& get_UML4CPPProfile_NonExecutable() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_UML4CPPProfile_NonExecutable_base_NamedElement() = 0;  
			virtual const std::shared_ptr<uml::Extension>& get_UML4CPPProfile_Package_ExternalLibrary() = 0;  
			virtual const std::shared_ptr<uml::Extension>& get_UML4CPPProfile_Package_UML4CPPPackage() = 0;  
			virtual const std::shared_ptr<uml::Extension>& get_UML4CPPProfile_Property_GetterName() = 0;  
			virtual const std::shared_ptr<uml::Extension>& get_UML4CPPProfile_Property_SetterName() = 0;  
			virtual const std::shared_ptr<uml::Stereotype>& get_UML4CPPProfile_SetterName() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_UML4CPPProfile_SetterName_base_Property() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_UML4CPPProfile_SetterName_setterName() = 0;  
			virtual const std::shared_ptr<uml::Stereotype>& get_UML4CPPProfile_Singleton() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_UML4CPPProfile_Singleton_base_Class() = 0;  
			virtual const std::shared_ptr<uml::Stereotype>& get_UML4CPPProfile_UML4CPPPackage() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_UML4CPPProfile_UML4CPPPackage_base_Package() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_UML4CPPProfile_UML4CPPPackage_eclipseURI() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_UML4CPPProfile_UML4CPPPackage_ignoreNamespace() = 0;  
