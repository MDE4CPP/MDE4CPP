...
#ifndef UML_STEREOTYPE_EXECUTION_HPP
#define UML_STEREOTYPE_EXECUTION_HPP
...
namespace UML 
{
	class StereotypeObject : virtual public UML::ClassObject
	{
		public:
		    //constructors
		    StereotypeObject(StereotypeObject &obj);
		    StereotypeObject(std::shared_ptr<uml::Stereotype>);
		 	StereotypeObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::Stereotype> getStereotypeValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setStereotypeValue(std::shared_ptr<uml::Stereotype>);
			virtual void setThisStereotypeObjectPtr(std::weak_ptr<StereotypeObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Stereotype> m_StereotypeValue = nullptr;
	};
}
#endif /* end of include guard: UML_STEREOTYPE_OBJECT_HPP */
