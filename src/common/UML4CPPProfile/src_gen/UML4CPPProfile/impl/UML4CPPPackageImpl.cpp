...
//*********************************
//Get
Any UML4CPPPackageImpl::get(const std::shared_ptr<uml::Property>& _property) const
{
...
//Set
void UML4CPPPackageImpl::set(const std::shared_ptr<uml::Property>& _property, const Any& value)
{
	std::string qualifiedName = _property->getQualifiedName();
    this->set(qualifiedName, value);
}

void UML4CPPPackageImpl::set(std::string _qualifiedName, const Any& value)
{
	unsigned long uID = util::Util::polynomialRollingHash(_qualifiedName);
    this->set(uID, value);
}

void UML4CPPPackageImpl::set(unsigned long _uID, const Any& value)
{
...
//*********************************
//Invoke
Any UML4CPPPackageImpl::invoke(const std::shared_ptr<uml::Operation>& _operation, const std::shared_ptr<Bag<Any>>& _arguments)
{
...
Any UML4CPPPackageImpl::invoke(std::string _qualifiedName, const std::shared_ptr<Bag<Any>>& _arguments)
{
	unsigned long uID = util::Util::polynomialRollingHash(_qualifiedName);
    return this->invoke(uID, _arguments);
}

Any UML4CPPPackageImpl::invoke(unsigned long _uID, const std::shared_ptr<Bag<Any>>& _arguments)
{
