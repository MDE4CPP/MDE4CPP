...
bool AcceptEventActionImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::ACCEPTEVENTACTION_ATTRIBUTE_ISUNMARSHALL:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> AcceptEventActionImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
