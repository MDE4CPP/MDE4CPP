...
// Union Getter
//*********************************
std::shared_ptr<std::vector<std::shared_ptr<uml::RedefinableElement>>> PrimitiveTypeImpl::getRedefinedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Element>>> PrimitiveTypeImpl::getOwnedElement() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> PrimitiveTypeImpl::getMember() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::NamedElement>>> PrimitiveTypeImpl::getOwnedMember() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Feature>>> PrimitiveTypeImpl::getFeature() const
{
...
std::shared_ptr<std::vector<std::shared_ptr<uml::Property>>> PrimitiveTypeImpl::getAttribute() const
{
