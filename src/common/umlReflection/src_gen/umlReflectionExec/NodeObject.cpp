...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> NodeObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioredClassifier_interfaceRealization())
	{
		std::shared_ptr<Bag<uml::InterfaceRealization>> interfaceRealizationList = m_NodeValue->getInterfaceRealization();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_BehavioredClassifier_ownedBehavior())
	{
		std::shared_ptr<Bag<uml::Behavior>> ownedBehaviorList = m_NodeValue->getOwnedBehavior();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_nestedClassifier())
	{
		std::shared_ptr<Bag<uml::Classifier>> nestedClassifierList = m_NodeValue->getNestedClassifier();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_ownedAttribute())
	{
		std::shared_ptr<Bag<uml::Property>> ownedAttributeList = m_NodeValue->getOwnedAttribute();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_ownedOperation())
	{
		std::shared_ptr<Bag<uml::Operation>> ownedOperationList = m_NodeValue->getOwnedOperation();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Class_ownedReception())
	{
		std::shared_ptr<Bag<uml::Reception>> ownedReceptionList = m_NodeValue->getOwnedReception();
	...
	{
		std::shared_ptr<Bag<uml::Property>> attributeList = m_NodeValue->getAttribute();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_collaborationUse())
	{
		std::shared_ptr<Bag<uml::CollaborationUse>> collaborationUseList = m_NodeValue->getCollaborationUse();
	...
	{
		std::shared_ptr<Bag<uml::Feature>> featureList = m_NodeValue->getFeature();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_generalization())
	{
		std::shared_ptr<Bag<uml::Generalization>> generalizationList = m_NodeValue->getGeneralization();
	...
	{
		std::shared_ptr<Bag<uml::NamedElement>> inheritedMemberList = m_NodeValue->getInheritedMember();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_ownedUseCase())
	{
		std::shared_ptr<Bag<uml::UseCase>> ownedUseCaseList = m_NodeValue->getOwnedUseCase();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_redefinedClassifier())
	{
		std::shared_ptr<Bag<uml::Classifier>> redefinedClassifierList = m_NodeValue->getRedefinedClassifier();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Classifier_substitution())
	{
		std::shared_ptr<Bag<uml::Substitution>> substitutionList = m_NodeValue->getSubstitution();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_DeploymentTarget_deployment())
	{
		std::shared_ptr<Bag<uml::Deployment>> deploymentList = m_NodeValue->getDeployment();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		std::shared_ptr<Bag<uml::Comment>> ownedCommentList = m_NodeValue->getOwnedComment();
	...
	{
		std::shared_ptr<Bag<uml::Element>> ownedElementList = m_NodeValue->getOwnedElement();
	...
	{
		std::shared_ptr<Bag<uml::Port>> ownedPortList = m_NodeValue->getOwnedPort();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_elementImport())
	{
		std::shared_ptr<Bag<uml::ElementImport>> elementImportList = m_NodeValue->getElementImport();
	...
	{
		std::shared_ptr<Bag<uml::PackageableElement>> importedMemberList = m_NodeValue->getImportedMember();
	...
	{
		std::shared_ptr<Bag<uml::NamedElement>> memberList = m_NodeValue->getMember();
	...
	{
		std::shared_ptr<Bag<uml::NamedElement>> ownedMemberList = m_NodeValue->getOwnedMember();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_ownedRule())
	{
		std::shared_ptr<Bag<uml::Constraint>> ownedRuleList = m_NodeValue->getOwnedRule();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Namespace_packageImport())
	{
		std::shared_ptr<Bag<uml::PackageImport>> packageImportList = m_NodeValue->getPackageImport();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Node_nestedNode())
	{
		std::shared_ptr<Bag<uml::Node>> nestedNodeList = m_NodeValue->getNestedNode();
	...
	{
		std::shared_ptr<Bag<uml::RedefinableElement>> redefinedElementList = m_NodeValue->getRedefinedElement();
	...
	{
		std::shared_ptr<Bag<uml::Classifier>> redefinitionContextList = m_NodeValue->getRedefinitionContext();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_StructuredClassifier_ownedConnector())
	{
		std::shared_ptr<Bag<uml::Connector>> ownedConnectorList = m_NodeValue->getOwnedConnector();
	...
	{
		std::shared_ptr<Bag<uml::ConnectableElement>> roleList = m_NodeValue->getRole();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_TemplateableElement_templateBinding())
	{
		std::shared_ptr<Bag<uml::TemplateBinding>> templateBindingList = m_NodeValue->getTemplateBinding();
...
std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> NodeObject::retrieveFeatureValues()
{
	...
	for(unsigned int i = 0; i < allAttributesSize; i++)
	{
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_Class_ownedAttribute() && m_NodeValue->getOwnedAttribute() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
