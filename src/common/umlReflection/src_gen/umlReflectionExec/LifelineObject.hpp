...
#ifndef UML_LIFELINE_EXECUTION_HPP
#define UML_LIFELINE_EXECUTION_HPP
...
namespace UML 
{
	class LifelineObject : virtual public UML::NamedElementObject
	{
		public:
		    //constructors
		    LifelineObject(LifelineObject &obj);
		    LifelineObject(std::shared_ptr<uml::Lifeline>);
		 	LifelineObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::Lifeline> getLifelineValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setLifelineValue(std::shared_ptr<uml::Lifeline>);
			virtual void setThisLifelineObjectPtr(std::weak_ptr<LifelineObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Lifeline> m_LifelineValue = nullptr;
	};
}
#endif /* end of include guard: UML_LIFELINE_OBJECT_HPP */
