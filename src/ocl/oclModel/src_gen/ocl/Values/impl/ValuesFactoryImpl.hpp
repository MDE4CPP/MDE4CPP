...
namespace ocl::Values 
{
	class OCL_API ValuesFactoryImpl : virtual public ecore::EFactoryImpl , virtual public ValuesFactory 
	{
		...
		public:
			...
			//Creator functions
			 virtual std::shared_ptr<ocl::Values::AnyValue> createAnyValue(const int metaElementID = ValuesPackage::ANYVALUE_CLASS) const ;
			 //Add as contained object
			 virtual std::shared_ptr<ocl::Values::AnyValue> createAnyValue_as_value_in_ObjectToken(std::shared_ptr<fUML::Semantics::Activities::ObjectToken> par_ObjectToken, const int metaElementID = ValuesPackage::ANYVALUE_CLASS) const ;
			 virtual std::shared_ptr<ocl::Values::AnyValue> createAnyValue_as_values_in_FeatureValue(std::shared_ptr<fUML::Semantics::SimpleClassifiers::FeatureValue> par_FeatureValue, const int metaElementID = ValuesPackage::ANYVALUE_CLASS) const ;
			 virtual std::shared_ptr<ocl::Values::AnyValue> createAnyValue_as_values_in_ParameterValue(std::shared_ptr<fUML::Semantics::CommonBehavior::ParameterValue> par_ParameterValue, const int metaElementID = ValuesPackage::ANYVALUE_CLASS) const ;
