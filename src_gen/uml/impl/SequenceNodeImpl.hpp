...
namespace uml 
{
	class SequenceNodeImpl :virtual public StructuredActivityNodeImpl, virtual public SequenceNode 
	{
		...
		protected:
			...
			SequenceNodeImpl(std::shared_ptr<uml::Activity > par_Activity, const int reference_id);
			...
			//Additional constructors for the containments back reference
			SequenceNodeImpl(std::shared_ptr<uml::Namespace > par_namespace);
			...
			//Additional constructors for the containments back reference
			SequenceNodeImpl(std::shared_ptr<uml::ActivityGroup > par_superGroup);
