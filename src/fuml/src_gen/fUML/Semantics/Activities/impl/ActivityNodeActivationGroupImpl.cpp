...
// Operations
//*********************************
void ActivityNodeActivationGroupImpl::activate(std::shared_ptr<Bag<org.eclipse.uml2.uml.ActivityNode> > nodes,std::shared_ptr<Bag<org.eclipse.uml2.uml.ActivityEdge> > edges)
{
...
void ActivityNodeActivationGroupImpl::createEdgeInstance(std::shared_ptr<Bag<org.eclipse.uml2.uml.ActivityEdge> > edges)
{
	//ADD_COUNT(__PRETTY_FUNCTION__)
	//generated from body annotation
...
std::shared_ptr<fUML::Semantics::Activities::ActivityNodeActivation> ActivityNodeActivationGroupImpl::createNodeActivation(std::shared_ptr<org.eclipse.uml2.uml.ActivityNode> node)
{
	//ADD_COUNT(__PRETTY_FUNCTION__)
	//generated from body annotation
...
void ActivityNodeActivationGroupImpl::createNodeActivations(std::shared_ptr<Bag<org.eclipse.uml2.uml.ActivityNode> > nodes)
{
	//ADD_COUNT(__PRETTY_FUNCTION__)
	//generated from body annotation
...
std::shared_ptr<fUML::Semantics::Activities::ActivityNodeActivation> ActivityNodeActivationGroupImpl::getNodeActivation(std::shared_ptr<org.eclipse.uml2.uml.ActivityNode> node)
{
	//ADD_COUNT(__PRETTY_FUNCTION__)
	//generated from body annotation
...
void ActivityNodeActivationGroupImpl::runNodes(std::shared_ptr<Bag<org.eclipse.uml2.uml.ActivityNode> > nodes)
{
	//ADD_COUNT(__PRETTY_FUNCTION__)
	//generated from body annotation
...
void ActivityNodeActivationGroupImpl::loadNode(std::string nodeName, std::shared_ptr<persistence::interfaces::XLoadHandler> loadHandler)
{
	...
	try
	{
		if ( nodeName.compare("edgeInstances") == 0 )
		{
			...
			std::shared_ptr<ecore::EObject> edgeInstances = modelFactory->create(typeName, loadHandler->getCurrentObject(), fUML::Semantics::Activities::ActivitiesPackage::ACTIVITYEDGEINSTANCE_ATTRIBUTE_GROUP);
		...
		if ( nodeName.compare("nodeActivations") == 0 )
		{
			...
			std::shared_ptr<ecore::EObject> nodeActivations = modelFactory->create(typeName, loadHandler->getCurrentObject(), fUML::Semantics::Activities::ActivitiesPackage::ACTIVITYNODEACTIVATION_ATTRIBUTE_GROUP);
...
void ActivityNodeActivationGroupImpl::saveContent(std::shared_ptr<persistence::interfaces::XSaveHandler> saveHandler) const
{
	...
	// Add references
		...
		{
			saveHandler->addReference(edgeInstances, "edgeInstances", edgeInstances->eClass() !=fUML::Semantics::Activities::ActivitiesPackage::eInstance()->getActivityEdgeInstance_Class());
		}
		...
		{
			saveHandler->addReference(nodeActivations, "nodeActivations", nodeActivations->eClass() !=fUML::Semantics::Activities::ActivitiesPackage::eInstance()->getActivityNodeActivation_Class());
		}
	}
	catch (std::exception& e)
	{
