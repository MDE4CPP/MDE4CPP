...
namespace uml 
{
	class UseCaseImpl :virtual public BehavioredClassifierImpl, virtual public UseCase 
	{
		...
		public:
			...
			virtual bool
			 no_association_to_use_case(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
			
			/*!
			 A UseCase cannot include UseCases that directly or indirectly include it.
			not allIncludedUseCases()->includes(self) */ 
			virtual bool
			 cannot_include_self(boost::any diagnostics,std::map <   boost::any, boost::any >  context)  ;
