...
#ifndef UML_EXTENSION_EXECUTION_HPP
#define UML_EXTENSION_EXECUTION_HPP
...
namespace UML 
{
	class ExtensionObject : virtual public UML::AssociationObject
	{
		public:
		    //constructors
		    ExtensionObject(ExtensionObject &obj);
		    ExtensionObject(std::shared_ptr<uml::Extension>);
		 	ExtensionObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::Extension> getExtensionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setExtensionValue(std::shared_ptr<uml::Extension>);
			virtual void setThisExtensionObjectPtr(std::weak_ptr<ExtensionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::Extension> m_ExtensionValue = nullptr;
	};
}
#endif /* end of include guard: UML_EXTENSION_OBJECT_HPP */
