	...
	*/
	class EcorePackage : virtual public uml::Model
	{
		...
		public:
			...
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EAttribute_eAllAttributes_ecore_EClass() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EAttribute_eAllAttributes_ecore_EClass_eClass() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EAttribute_eAttributes_ecore_EClass() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EAttribute_eAttributes_ecore_EClass_eClass() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EAttribute_eIDAttribute_ecore_EClass() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EAttribute_eIDAttribute_ecore_EClass_eClass() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EAttribute_eKeys_ecore_EReference() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EAttribute_eKeys_ecore_EReference_eReference() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EClass_eAllSuperTypes_ecore_EClass() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EClass_eAllSuperTypes_ecore_EClass_eClass() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EClass_eReferenceType_ecore_EReference() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EClass_eReferenceType_ecore_EReference_eReference() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EClass_eSuperTypes_ecore_EClass() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EClass_eSuperTypes_ecore_EClass_eClass() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EClassifier_eClassifier_ecore_EGenericType() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EClassifier_eClassifier_ecore_EGenericType_eGenericType() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EClassifier_eClassifiers_Ecore_EPackage_ePackage() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EClassifier_eExceptions_ecore_EOperation() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EClassifier_eExceptions_ecore_EOperation_eOperation() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EClassifier_eRawType_ecore_EGenericType() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EClassifier_eRawType_ecore_EGenericType_eGenericType() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EClassifier_eType_ecore_ETypedElement() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EClassifier_eType_ecore_ETypedElement_eTypedElement() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EDataType_eAttributeType_ecore_EAttribute() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EDataType_eAttributeType_ecore_EAttribute_eAttribute() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EEnumLiteral_eLiterals_Ecore_EEnum_eEnum() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EGenericType_eAllGenericSuperTypes_ecore_EClass() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EGenericType_eAllGenericSuperTypes_ecore_EClass_eClass() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EGenericType_eBounds_ecore_ETypeParameter() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EGenericType_eBounds_ecore_ETypeParameter_eTypeParameter() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EGenericType_eGenericExceptions_ecore_EOperation() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EGenericType_eGenericExceptions_ecore_EOperation_eOperation() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EGenericType_eGenericSuperTypes_ecore_EClass() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EGenericType_eGenericSuperTypes_ecore_EClass_eClass() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EGenericType_eGenericType_ecore_ETypedElement() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EGenericType_eGenericType_ecore_ETypedElement_eTypedElement() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EGenericType_eLowerBound_ecore_EGenericType() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EGenericType_eLowerBound_ecore_EGenericType_eGenericType() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EGenericType_eTypeArguments_ecore_EGenericType() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EGenericType_eTypeArguments_ecore_EGenericType_eGenericType() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EGenericType_eUpperBound_ecore_EGenericType() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EGenericType_eUpperBound_ecore_EGenericType_eGenericType() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EObject_contents_ecore_EAnnotation() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EObject_contents_ecore_EAnnotation_eAnnotation() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EObject_references_ecore_EAnnotation() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EObject_references_ecore_EAnnotation_eAnnotation() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EOperation_eAllOperations_ecore_EClass() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EOperation_eAllOperations_ecore_EClass_eClass() = 0;  
			...
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EReference_eAllContainments_ecore_EClass() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EReference_eAllContainments_ecore_EClass_eClass() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EReference_eAllReferences_ecore_EClass() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EReference_eAllReferences_ecore_EClass_eClass() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EReference_eOpposite_ecore_EReference() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EReference_eOpposite_ecore_EReference_eReference() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EReference_eReferences_ecore_EClass() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EReference_eReferences_ecore_EClass_eClass() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EStringToStringMapEntry_details_ecore_EAnnotation() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EStringToStringMapEntry_details_ecore_EAnnotation_eAnnotation() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_EStructuralFeature_eAllStructuralFeatures_ecore_EClass() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_EStructuralFeature_eAllStructuralFeatures_ecore_EClass_eClass() = 0;  
			...
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_ETypeParameter_eTypeParameter_ecore_EGenericType() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_ETypeParameter_eTypeParameter_ecore_EGenericType_eGenericType() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_ETypeParameter_eTypeParameters_ecore_EClassifier() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_ETypeParameter_eTypeParameters_ecore_EClassifier_eClassifier() = 0;  
			virtual const std::shared_ptr<uml::Association>& get_A_Ecore_ETypeParameter_eTypeParameters_ecore_EOperation() = 0;  
			virtual const std::shared_ptr<uml::Property>& get_A_Ecore_ETypeParameter_eTypeParameters_ecore_EOperation_eOperation() = 0;  
