...
std::shared_ptr<Any> ElementImportImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
  	...
  	switch(operationID)
	{
		...
		case umlPackage::ELEMENTIMPORT_OPERATION_IMPORTED_ELEMENT_IS_PUBLIC_EDIAGNOSTICCHAIN_EMAP:
		{
			...
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for parameter 'diagnostics'. Failed to invoke operation 'imported_element_is_public'!")
				return nullptr;
			}
			...
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for parameter 'context'. Failed to invoke operation 'imported_element_is_public'!")
				return nullptr;
			}
		...
		case umlPackage::ELEMENTIMPORT_OPERATION_VISIBILITY_PUBLIC_OR_PRIVATE_EDIAGNOSTICCHAIN_EMAP:
		{
			...
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for parameter 'diagnostics'. Failed to invoke operation 'visibility_public_or_private'!")
				return nullptr;
			}
			...
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for parameter 'context'. Failed to invoke operation 'visibility_public_or_private'!")
				return nullptr;
			}
