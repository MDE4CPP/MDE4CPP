...
#ifndef UML_EXPANSIONREGION_EXECUTION_HPP
#define UML_EXPANSIONREGION_EXECUTION_HPP
...
namespace UML 
{
	class ExpansionRegionObject : virtual public UML::StructuredActivityNodeObject
	{
		public:
		    //constructors
		    ExpansionRegionObject(ExpansionRegionObject &obj);
		    ExpansionRegionObject(std::shared_ptr<uml::ExpansionRegion>);
		 	ExpansionRegionObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::ExpansionRegion> getExpansionRegionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setExpansionRegionValue(std::shared_ptr<uml::ExpansionRegion>);
			virtual void setThisExpansionRegionObjectPtr(std::weak_ptr<ExpansionRegionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ExpansionRegion> m_ExpansionRegionValue = nullptr;
	};
}
#endif /* end of include guard: UML_EXPANSIONREGION_OBJECT_HPP */
