...
#ifndef UML_READISCLASSIFIEDOBJECTACTION_EXECUTION_HPP
#define UML_READISCLASSIFIEDOBJECTACTION_EXECUTION_HPP
...
namespace UML 
{
	class ReadIsClassifiedObjectActionObject : virtual public UML::ActionObject
	{
		public:
		    //constructors
		    ReadIsClassifiedObjectActionObject(ReadIsClassifiedObjectActionObject &obj);
		    ReadIsClassifiedObjectActionObject(std::shared_ptr<uml::ReadIsClassifiedObjectAction>);
		 	ReadIsClassifiedObjectActionObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::ReadIsClassifiedObjectAction> getReadIsClassifiedObjectActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setReadIsClassifiedObjectActionValue(std::shared_ptr<uml::ReadIsClassifiedObjectAction>);
			virtual void setThisReadIsClassifiedObjectActionObjectPtr(std::weak_ptr<ReadIsClassifiedObjectActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ReadIsClassifiedObjectAction> m_ReadIsClassifiedObjectActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_READISCLASSIFIEDOBJECTACTION_OBJECT_HPP */
