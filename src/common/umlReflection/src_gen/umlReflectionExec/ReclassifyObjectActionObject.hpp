...
#ifndef UML_RECLASSIFYOBJECTACTION_EXECUTION_HPP
#define UML_RECLASSIFYOBJECTACTION_EXECUTION_HPP
...
namespace UML 
{
	class ReclassifyObjectActionObject : virtual public UML::ActionObject
	{
		public:
		    //constructors
		    ReclassifyObjectActionObject(ReclassifyObjectActionObject &obj);
		    ReclassifyObjectActionObject(std::shared_ptr<uml::ReclassifyObjectAction>);
		 	ReclassifyObjectActionObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::ReclassifyObjectAction> getReclassifyObjectActionValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setReclassifyObjectActionValue(std::shared_ptr<uml::ReclassifyObjectAction>);
			virtual void setThisReclassifyObjectActionObjectPtr(std::weak_ptr<ReclassifyObjectActionObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ReclassifyObjectAction> m_ReclassifyObjectActionValue = nullptr;
	};
}
#endif /* end of include guard: UML_RECLASSIFYOBJECTACTION_OBJECT_HPP */
