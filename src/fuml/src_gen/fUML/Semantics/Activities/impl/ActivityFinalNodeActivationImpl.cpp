...
ActivityFinalNodeActivationImpl::ActivityFinalNodeActivationImpl(const ActivityFinalNodeActivationImpl & obj): ControlNodeActivationImpl(obj), ActivityFinalNodeActivation(obj)
{
