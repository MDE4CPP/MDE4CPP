...
#ifndef UML_CONNECTABLEELEMENTTEMPLATEPARAMETER_EXECUTION_HPP
#define UML_CONNECTABLEELEMENTTEMPLATEPARAMETER_EXECUTION_HPP
...
namespace UML 
{
	class ConnectableElementTemplateParameterObject : virtual public UML::TemplateParameterObject
	{
		public:
		    //constructors
		    ConnectableElementTemplateParameterObject(ConnectableElementTemplateParameterObject &obj);
		    ConnectableElementTemplateParameterObject(std::shared_ptr<uml::ConnectableElementTemplateParameter>);
		 	ConnectableElementTemplateParameterObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::ConnectableElementTemplateParameter> getConnectableElementTemplateParameterValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setConnectableElementTemplateParameterValue(std::shared_ptr<uml::ConnectableElementTemplateParameter>);
			virtual void setThisConnectableElementTemplateParameterObjectPtr(std::weak_ptr<ConnectableElementTemplateParameterObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ConnectableElementTemplateParameter> m_ConnectableElementTemplateParameterValue = nullptr;
	};
}
#endif /* end of include guard: UML_CONNECTABLEELEMENTTEMPLATEPARAMETER_OBJECT_HPP */
