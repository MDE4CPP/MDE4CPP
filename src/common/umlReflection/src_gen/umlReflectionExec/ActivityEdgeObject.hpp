...
#ifndef UML_ACTIVITYEDGE_EXECUTION_HPP
#define UML_ACTIVITYEDGE_EXECUTION_HPP
...
namespace UML 
{
	class ActivityEdgeObject : virtual public UML::RedefinableElementObject
	{
		public:
		    //constructors
		    ActivityEdgeObject(ActivityEdgeObject &obj);
		    ActivityEdgeObject(std::shared_ptr<uml::ActivityEdge>);
		 	ActivityEdgeObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::ActivityEdge> getActivityEdgeValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setActivityEdgeValue(std::shared_ptr<uml::ActivityEdge>);
			virtual void setThisActivityEdgeObjectPtr(std::weak_ptr<ActivityEdgeObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ActivityEdge> m_ActivityEdgeValue = nullptr;
	};
}
#endif /* end of include guard: UML_ACTIVITYEDGE_OBJECT_HPP */
