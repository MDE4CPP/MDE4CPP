	...
	class UML_API ObjectFlow: virtual public ActivityEdge
	{
		...
		public:
			...
			*/
			...
			virtual bool compatible_types(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool input_and_output_parameter(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			isMulticast and isMultireceive cannot both be true.
			not (isMulticast and isMultireceive)
			*/
			 
			virtual bool is_multicast_or_is_multireceive(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool no_executable_nodes(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			ObjectNodes connected by an ObjectFlow, with optionally intervening ControlNodes, must have the same upperBounds.
			*/
			 
			virtual bool same_upper_bounds(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool target(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool transformation_behavior(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
