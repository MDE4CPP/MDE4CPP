...
namespace uml 
{
	...
	class Classifier:virtual public Namespace,virtual public RedefinableElement,virtual public TemplateableElement,virtual public Type	{
		...
		public:
			...
			virtual uml::Operation *  getOperation(std::string name,std::vector<std::string> *  parameterNames,std::vector<uml::Type * > *  parameterTypes,bool ignoreCase)  = 0;
			
			/*!
			 Retrieves the operations of this classifier. */ 
			virtual std::vector<uml::Operation * > *  getOperations()  = 0;
			
			/*!
			 Retrieves the interfaces on which this classifier has a usage dependency. */ 
			virtual std::vector<uml::Interface * > *  getUsedInterfaces()  = 0;
			
			/*!
			 The query allFeatures() gives all of the Features in the namespace of the Classifier. In general, through mechanisms such as inheritance, this will be a larger set than feature.
			result = (member->select(oclIsKindOf(Feature))->collect(oclAsType(Feature))->asSet())
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::Feature * > *  allFeatures()  = 0;
			
			/*!
			 The query allParents() gives all of the direct and indirect ancestors of a generalized Classifier.
			result = (parents()->union(parents()->collect(allParents())->asSet()))
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::Classifier * > *  allParents()  = 0;
			
			/*!
			 The general Classifiers are the ones referenced by the Generalization relationships.
			result = (parents())
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::Classifier * > *  getGenerals()  = 0;
			...
			<p>From package UML::Classification.</p> */ 
			virtual bool hasVisibilityOf(uml::NamedElement *  n)  = 0;
			...
			result = (inhs->reject(inh |
			  ...
			  ownedMember->select(oclIsKindOf(RedefinableElement))->
			    select(redefinedElement->includes(inh.oclAsType(RedefinableElement)))
			       ->notEmpty()))
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::NamedElement * > *  inherit(std::vector<uml::NamedElement * > *  inhs)  = 0;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::NamedElement * > *  inheritableMembers(uml::Classifier *  c)  = 0;
			
			/*!
			 The inheritedMember association is derived by inheriting the inheritable members of the parents.
			result = (inherit(parents()->collect(inheritableMembers(self))->asSet()))
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::NamedElement * > *  getInheritedMembers()  = 0;
			
			/*!
			 The query maySpecializeType() determines whether this classifier may have a generalization relationship to classifiers of the specified type. By default a classifier may specialize classifiers of the same or a more general type. It is intended to be redefined by classifiers that have different specialization constraints.
			result = (self.oclIsKindOf(c.oclType()))
			<p>From package UML::Classification.</p> */ 
			virtual bool maySpecializeType(uml::Classifier *  c)  = 0;
			
			/*!
			 The query parents() gives all of the immediate ancestors of a generalized Classifier.
			result = (generalization.general->asSet())
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::Classifier * > *  parents()  = 0;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::Interface * > *  directlyRealizedInterfaces()  = 0;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::Interface * > *  directlyUsedInterfaces()  = 0;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::Interface * > *  allRealizedInterfaces()  = 0;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::Interface * > *  allUsedInterfaces()  = 0;
			
			/*!
			 result = (substitution.contract->includes(contract))
			<p>From package UML::Classification.</p> */ 
			virtual bool isSubstitutableFor(uml::Classifier *  contract)  = 0;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::Property * > *  allAttributes()  = 0;
			...
			<p>From package UML::Classification.</p> */ 
			virtual std::vector<uml::StructuralFeature * > *  allSlottableFeatures()  = 0;
			...
			<p>From package UML::Classification.</p> */
			virtual std::vector<uml::CollaborationUse * > *  getCollaborationUse() const = 0;
			
			/*!
			 The generalizing Classifiers for this Classifier.
			<p>From package UML::Classification.</p> */
			virtual std::vector<uml::Classifier * > *  getGeneral() const = 0;
			...
			<p>From package UML::Classification.</p> */
			virtual std::vector<uml::Generalization * > *  getGeneralization() const = 0;
			
			/*!
			 The GeneralizationSet of which this Classifier is a power type.
			<p>From package UML::Classification.</p> */
			virtual std::vector<uml::GeneralizationSet * > *  getPowertypeExtent() const = 0;
			
			/*!
			 All elements inherited by this Classifier from its general Classifiers.
			<p>From package UML::Classification.</p> */
			virtual std::vector<uml::NamedElement * > *  getInheritedMember() const = 0;
			
			/*!
			 The UseCases owned by this classifier.
			<p>From package UML::Classification.</p> */
			virtual std::vector<uml::UseCase * > *  getOwnedUseCase() const = 0;
			
			/*!
			 The set of UseCases for which this Classifier is the subject.
			<p>From package UML::Classification.</p> */
			virtual std::vector<uml::UseCase * > *  getUseCase() const = 0;
			
			/*!
			 The Classifiers redefined by this Classifier.
			<p>From package UML::Classification.</p> */
			virtual std::vector<uml::Classifier * > *  getRedefinedClassifier() const = 0;
			
			/*!
			 A CollaborationUse which indicates the Collaboration that represents this Classifier.
			<p>From package UML::Classification.</p> */
			virtual uml::CollaborationUse *  getRepresentation() const = 0;
			
			/*!
			 A CollaborationUse which indicates the Collaboration that represents this Classifier.
			<p>From package UML::Classification.</p> */
			virtual void setRepresentation(uml::CollaborationUse *  _representation) = 0;
			
			/*!
			 The Substitutions owned by this Classifier.
			<p>From package UML::Classification.</p> */
			virtual std::vector<uml::Substitution * > *  getSubstitution() const = 0;
		...
		protected:
			...
			<p>From package UML::Classification.</p> */
			std::vector<uml::Feature * > *  m_feature =  nullptr ;
			/*!
			 All of the Properties that are direct (i.e., not inherited or imported) attributes of the Classifier.
			<p>From package UML::Classification.</p> */
			std::vector<uml::Property * > *  m_attribute =  nullptr ;
			/*!
			 The CollaborationUses owned by the Classifier.
			<p>From package UML::Classification.</p> */
			std::vector<uml::CollaborationUse * > *  m_collaborationUse =  nullptr ;
			/*!
			 The generalizing Classifiers for this Classifier.
			<p>From package UML::Classification.</p> */
			std::vector<uml::Classifier * > *  m_general =  nullptr ;
			/*!
			 The Generalization relationships for this Classifier. These Generalizations navigate to more general Classifiers in the generalization hierarchy.
			<p>From package UML::Classification.</p> */
			std::vector<uml::Generalization * > *  m_generalization =  nullptr ;
			/*!
			 The GeneralizationSet of which this Classifier is a power type.
			<p>From package UML::Classification.</p> */
			std::vector<uml::GeneralizationSet * > *  m_powertypeExtent =  nullptr ;
			/*!
			 All elements inherited by this Classifier from its general Classifiers.
			<p>From package UML::Classification.</p> */
			std::vector<uml::NamedElement * > *  m_inheritedMember =  nullptr ;
			/*!
			 The UseCases owned by this classifier.
			<p>From package UML::Classification.</p> */
			std::vector<uml::UseCase * > *  m_ownedUseCase =  nullptr ;
			/*!
			 The set of UseCases for which this Classifier is the subject.
			<p>From package UML::Classification.</p> */
			std::vector<uml::UseCase * > *  m_useCase =  nullptr ;
			/*!
			 The Classifiers redefined by this Classifier.
			<p>From package UML::Classification.</p> */
			std::vector<uml::Classifier * > *  m_redefinedClassifier =  nullptr ;
			/*!
			 A CollaborationUse which indicates the Collaboration that represents this Classifier.
			<p>From package UML::Classification.</p> */
			uml::CollaborationUse *  m_representation =  nullptr ;
			/*!
			 The Substitutions owned by this Classifier.
			<p>From package UML::Classification.</p> */
			std::vector<uml::Substitution * > *  m_substitution =  nullptr ;
