...
#ifndef UML_OCCURRENCESPECIFICATION_EXECUTION_HPP
#define UML_OCCURRENCESPECIFICATION_EXECUTION_HPP
...
namespace UML 
{
	class OccurrenceSpecificationObject : virtual public UML::InteractionFragmentObject
	{
		public:
		    //constructors
		    OccurrenceSpecificationObject(OccurrenceSpecificationObject &obj);
		    OccurrenceSpecificationObject(std::shared_ptr<uml::OccurrenceSpecification>);
		 	OccurrenceSpecificationObject();
		    //destructor
		    virtual ~OccurrenceSpecificationObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			OccurrenceSpecificationObject& operator=(OccurrenceSpecificationObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::OccurrenceSpecification> getOccurrenceSpecificationValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setOccurrenceSpecificationValue(std::shared_ptr<uml::OccurrenceSpecification>);
			virtual void setThisOccurrenceSpecificationObjectPtr(std::weak_ptr<OccurrenceSpecificationObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::OccurrenceSpecification> m_OccurrenceSpecificationValue = nullptr;
	};
}
#endif /* end of include guard: UML_OCCURRENCESPECIFICATION_OBJECT_HPP */
