	...
	class UML_API InstanceSpecification: virtual public DeployedArtifact, virtual public DeploymentTarget, virtual public PackageableElement
	{
		...
		public:
			...
			*/
			...
			virtual bool defining_feature(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
			...
			*/
			...
			virtual bool deployment_artifact(const Any& diagnostics, std::shared_ptr<std::map < Any, Any>> context) = 0;
			/*!
