...
#ifndef UML_EXTENSIONEND_EXECUTION_HPP
#define UML_EXTENSIONEND_EXECUTION_HPP
...
namespace UML 
{
	class ExtensionEndObject : virtual public UML::PropertyObject
	{
		public:
		    //constructors
		    ExtensionEndObject(ExtensionEndObject &obj);
		    ExtensionEndObject(std::shared_ptr<uml::ExtensionEnd>);
		 	ExtensionEndObject();
		    //destructor
		    virtual ~ExtensionEndObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			ExtensionEndObject& operator=(ExtensionEndObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::ExtensionEnd> getExtensionEndValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setExtensionEndValue(std::shared_ptr<uml::ExtensionEnd>);
			virtual void setThisExtensionEndObjectPtr(std::weak_ptr<ExtensionEndObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ExtensionEnd> m_ExtensionEndValue = nullptr;
	};
}
#endif /* end of include guard: UML_EXTENSIONEND_OBJECT_HPP */
