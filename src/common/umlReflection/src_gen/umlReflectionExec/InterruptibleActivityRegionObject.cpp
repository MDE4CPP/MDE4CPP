...
{	
	if(m_InterruptibleActivityRegionValue)
	{

	}

	m_InterruptibleActivityRegionValue.reset();

	fUML::Semantics::StructuredClassifiers::ObjectImpl::destroy();
}

std::shared_ptr<uml::Element> InterruptibleActivityRegionObject::getUmlValue() const
{
	return getInterruptibleActivityRegionValue();
}

std::shared_ptr<uml::InterruptibleActivityRegion> InterruptibleActivityRegionObject::getInterruptibleActivityRegionValue() const
{
	return m_InterruptibleActivityRegionValue;
}

void InterruptibleActivityRegionObject::setUmlValue(std::shared_ptr<uml::Element> _element)
{
	setInterruptibleActivityRegionValue(std::dynamic_pointer_cast<uml::InterruptibleActivityRegion>(_element));
}

void InterruptibleActivityRegionObject::setInterruptibleActivityRegionValue(std::shared_ptr<uml::InterruptibleActivityRegion> _InterruptibleActivityRegionElement)
{
	m_InterruptibleActivityRegionValue = _InterruptibleActivityRegionElement;
	//set super type values
	UML::ActivityGroupObject::setActivityGroupValue(_InterruptibleActivityRegionElement);
}

void InterruptibleActivityRegionObject::setThisInterruptibleActivityRegionObjectPtr(std::weak_ptr<InterruptibleActivityRegionObject> thisObjectPtr)
{
	setThisCS_ObjectPtr(thisObjectPtr);
}

bool InterruptibleActivityRegionObject::equals(std::shared_ptr<fUML::Semantics::Values::Value> otherValue)
{
	bool isEqual = false;
	
	std::shared_ptr<InterruptibleActivityRegionObject> otherInterruptibleActivityRegionObject = std::dynamic_pointer_cast<InterruptibleActivityRegionObject>(otherValue);

	if(otherInterruptibleActivityRegionObject != nullptr)
	{
		if(this->getInterruptibleActivityRegionValue() == otherInterruptibleActivityRegionObject->getInterruptibleActivityRegionValue())
		{
			isEqual = true;
		}
	}
...
std::string InterruptibleActivityRegionObject::toString()
{
	std::string buffer = "Instance of 'InterruptibleActivityRegionObject', " + std::to_string(getTypes()->size()) + " types (";
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Object>> InterruptibleActivityRegionObject::getDirectContainers()
{   
...
std::shared_ptr<Bag<PSCS::Semantics::StructuredClassifiers::CS_Link>> InterruptibleActivityRegionObject::getLinks(std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_InteractionPoint> interactionPoint)
{
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> InterruptibleActivityRegionObject::retrieveEndValueAsInteractionPoint(std::shared_ptr<fUML::Semantics::Values::Value> endValue, std::shared_ptr<uml::ConnectorEnd> end)
{
	return nullptr;
}

void InterruptibleActivityRegionObject::removeValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<fUML::Semantics::Values::Value> value)
{
	...
	if (m_InterruptibleActivityRegionValue == nullptr)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": no value stored inside InterruptibleActivityRegionObject (property: " << feature->getName() << ")" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		...
		{
			m_InterruptibleActivityRegionValue->getOwnedComment()->clear();
		}
		else
		{
			...
			{
				m_InterruptibleActivityRegionValue->getOwnedComment()->erase(inputValue->getCommentValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_InterruptibleActivityRegion_interruptingEdge())
	{
		if (value == nullptr) // clear mode
		{
			m_InterruptibleActivityRegionValue->getInterruptingEdge()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_InterruptibleActivityRegionValue->getInterruptingEdge()->erase(inputValue->getActivityEdgeValue());
			}
		}
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_InterruptibleActivityRegion_node())
	{
		if (value == nullptr) // clear mode
		{
			m_InterruptibleActivityRegionValue->getNode()->clear();
		}
		else
		{
			/* Should use PSCS::CS_Reference but dynamic_pointer_cast fails --> using fUML::Reference instead
			...
			if (inputValue != nullptr)
			{
				m_InterruptibleActivityRegionValue->getNode()->erase(inputValue->getActivityNodeValue());
			}
		}
	}
...
std::shared_ptr<Bag<fUML::Semantics::Values::Value>> InterruptibleActivityRegionObject::getValues(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> featureValues)
{
	if (feature->getMetaElementID() != uml::UmlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::UmlPackage::PORT_CLASS && feature->getMetaElementID() != uml::UmlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityGroup_inActivity())
	{
		...
		value->setLocus(this->getLocus());
		value->setActivityValue(m_InterruptibleActivityRegionValue->getInActivity().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_ActivityGroup_superGroup())
	{
		...
		value->setThisActivityGroupObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setActivityGroupValue(m_InterruptibleActivityRegionValue->getSuperGroup().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_owner())
	{
		...
		value->setThisElementObjectPtr(value);
		value->setLocus(this->getLocus());
		value->setElementValue(m_InterruptibleActivityRegionValue->getOwner().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_InterruptibleActivityRegion_interruptingEdge())
	{
		std::shared_ptr<Bag<uml::ActivityEdge>> interruptingEdgeList = m_InterruptibleActivityRegionValue->getInterruptingEdge();
		Bag<uml::ActivityEdge>::iterator iter = interruptingEdgeList->begin();
		Bag<uml::ActivityEdge>::iterator end = interruptingEdgeList->end();
		while (iter != end)
		{
			std::shared_ptr<UML::ActivityEdgeObject> value(new UML::ActivityEdgeObject());
			value->setThisActivityEdgeObjectPtr(value);
	...
	{
		std::shared_ptr<Bag<uml::Dependency>> clientDependencyList = m_InterruptibleActivityRegionValue->getClientDependency();
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		value->setValue(m_InterruptibleActivityRegionValue->getName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		value->setLocus(this->getLocus());
		value->setStringExpressionValue(m_InterruptibleActivityRegionValue->getNameExpression());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		reference->setCompositeReferent(value);
		values->add(reference);
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace())
	{
		...
		value->setLocus(this->getLocus());
		value->setNamespaceValue(m_InterruptibleActivityRegionValue->getNamespace().lock());
		std::shared_ptr<PSCS::Semantics::StructuredClassifiers::CS_Reference> reference = PSCS::Semantics::StructuredClassifiers::StructuredClassifiersFactory::eInstance()->createCS_Reference();
		reference->setReferent(value);
		values->add(reference);
	}
	...
	{
		std::shared_ptr<fUML::Semantics::SimpleClassifiers::StringValue> value = fUML::Semantics::SimpleClassifiers::SimpleClassifiersFactory::eInstance()->createStringValue();
		value->setValue(m_InterruptibleActivityRegionValue->getQualifiedName());
		values->add(value);
	}
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		uml::VisibilityKind visibility = m_InterruptibleActivityRegionValue->getVisibility();
...
std::shared_ptr<fUML::Semantics::SimpleClassifiers::FeatureValue> InterruptibleActivityRegionObject::retrieveFeatureValue(std::shared_ptr<uml::StructuralFeature> feature)
{
...
void InterruptibleActivityRegionObject::setFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	if (feature->getMetaElementID() != uml::UmlPackage::PROPERTY_CLASS && feature->getMetaElementID() != uml::UmlPackage::PORT_CLASS && feature->getMetaElementID() != uml::UmlPackage::EXTENSIONEND_CLASS)
	{
		std::cerr << __PRETTY_FUNCTION__ << ": feature is null or not kind of uml::Property" << std::endl;
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_InterruptibleActivityRegionValue->getOwnedComment()->push_back(value->getCommentValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_InterruptibleActivityRegion_interruptingEdge())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_InterruptibleActivityRegionValue->getInterruptingEdge()->push_back(value->getActivityEdgeValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_InterruptibleActivityRegion_node())
	{
		...
		while (iter != end)
		{
			...
			if (value != nullptr)
			{
				m_InterruptibleActivityRegionValue->getNode()->push_back(value->getActivityNodeValue());
			}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_name())
	{
		...
		{
			m_InterruptibleActivityRegionValue->setName(valueObject->getValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression())
	{
		...
		if (value != nullptr)
		{
			m_InterruptibleActivityRegionValue->setNameExpression(value->getStringExpressionValue());
		}
	...
	if (feature == UML::UMLPackage::eInstance()->get_UML_NamedElement_visibility())
	{
		...
		{
			m_InterruptibleActivityRegionValue->setVisibility(uml::VisibilityKind::PUBLIC);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_private())
		{
			m_InterruptibleActivityRegionValue->setVisibility(uml::VisibilityKind::PRIVATE);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_protected())
		{
			m_InterruptibleActivityRegionValue->setVisibility(uml::VisibilityKind::PROTECTED);
		}
		if (literal == UML::UMLPackage::eInstance()->get_UML_VisibilityKind_package())
		{
			m_InterruptibleActivityRegionValue->setVisibility(uml::VisibilityKind::PACKAGE);
		}
		
	}
}

void InterruptibleActivityRegionObject::assignFeatureValue(std::shared_ptr<uml::StructuralFeature> feature, std::shared_ptr<Bag<fUML::Semantics::Values::Value>> values, int position)
{
	this->setFeatureValue(feature, values, position);
}

std::shared_ptr<Bag<fUML::Semantics::SimpleClassifiers::FeatureValue>> InterruptibleActivityRegionObject::retrieveFeatureValues()
{
	...
	for(unsigned int i = 0; i < allAttributesSize; i++)
	{
		...
		if (property == UML::UMLPackage::eInstance()->get_UML_ActivityGroup_containedEdge() && m_InterruptibleActivityRegionValue->getContainedEdge() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ActivityGroup_containedNode() && m_InterruptibleActivityRegionValue->getContainedNode() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ActivityGroup_inActivity() && m_InterruptibleActivityRegionValue->getInActivity().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ActivityGroup_subgroup() && m_InterruptibleActivityRegionValue->getSubgroup() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_ActivityGroup_superGroup() && m_InterruptibleActivityRegionValue->getSuperGroup().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedComment() && m_InterruptibleActivityRegionValue->getOwnedComment() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_ownedElement() && m_InterruptibleActivityRegionValue->getOwnedElement() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_Element_owner() && m_InterruptibleActivityRegionValue->getOwner().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_InterruptibleActivityRegion_interruptingEdge() && m_InterruptibleActivityRegionValue->getInterruptingEdge() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_InterruptibleActivityRegion_node() && m_InterruptibleActivityRegionValue->getNode() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_clientDependency() && m_InterruptibleActivityRegionValue->getClientDependency() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_nameExpression() && m_InterruptibleActivityRegionValue->getNameExpression() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
		if (property == UML::UMLPackage::eInstance()->get_UML_NamedElement_namespace() && m_InterruptibleActivityRegionValue->getNamespace().lock() != nullptr)
		{
			featureValues->add(this->retrieveFeatureValue(property));
		}
	}
