...
ShallowHistoryPseudostateActivationImpl& ShallowHistoryPseudostateActivationImpl::operator=(const ShallowHistoryPseudostateActivationImpl & obj)
{
	//call overloaded =Operator for each base class
	HistoryPseudostateActivationImpl::operator=(obj);
	/* TODO: Find out if this call is necessary
	 * Currently, this causes an error because it calls an implicit assignment operator of ShallowHistoryPseudostateActivation 
	 * which is generated by the compiler (as ShallowHistoryPseudostateActivation is an abstract class and does not have a user-defined assignment operator).
	 ...
	 */
	//ShallowHistoryPseudostateActivation::operator=(obj);
...
{
	std::shared_ptr<ShallowHistoryPseudostateActivationImpl> element(new ShallowHistoryPseudostateActivationImpl());
	*element =(*this);
...
void ShallowHistoryPseudostateActivationImpl::loadNode(std::string nodeName, std::shared_ptr<persistence::interfaces::XLoadHandler> loadHandler)
{
...
void ShallowHistoryPseudostateActivationImpl::resolveReferences(const int featureID, std::vector<std::shared_ptr<ecore::EObject>> references)
{
...
const std::shared_ptr<ecore::EClass>& ShallowHistoryPseudostateActivationImpl::eStaticClass() const
{
	return PSSM::Semantics::StateMachines::StateMachinesPackage::eInstance()->getShallowHistoryPseudostateActivation_Class();
}

//*********************************
// EStructuralFeature Get/Set/IsSet
//*********************************
std::shared_ptr<Any> ShallowHistoryPseudostateActivationImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
	}
...
bool ShallowHistoryPseudostateActivationImpl::eSet(int featureID,  const std::shared_ptr<Any>& newValue)
{
	switch(featureID)
	{
	}
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ShallowHistoryPseudostateActivationImpl::eInvoke(int operationID, const std::shared_ptr<Bag<Any>>& arguments)
{
...
std::shared_ptr<PSSM::Semantics::StateMachines::ShallowHistoryPseudostateActivation> ShallowHistoryPseudostateActivationImpl::getThisShallowHistoryPseudostateActivationPtr() const
{
	return m_thisShallowHistoryPseudostateActivationPtr.lock();
}
void ShallowHistoryPseudostateActivationImpl::setThisShallowHistoryPseudostateActivationPtr(std::weak_ptr<PSSM::Semantics::StateMachines::ShallowHistoryPseudostateActivation> thisShallowHistoryPseudostateActivationPtr)
{
