...
namespace uml 
{
	class BehavioredClassifierImpl :virtual public ClassifierImpl, virtual public BehavioredClassifier
	{
		...
		public:
			...
			virtual std::vector<uml::Interface * > *  getAllImplementedInterfaces()  ;
			
			/*!
			 Retrieves the interfaces on which this behaviored classifier has an interface realization dependency. */ 
			virtual std::vector<uml::Interface * > *  getImplementedInterfaces()  ;
			...
			virtual uml::Behavior *  getClassifierBehavior() const ;
			
			/*!
			 A Behavior that specifies the behavior of the BehavioredClassifier itself.
			<p>From package UML::SimpleClassifiers.</p> */
			virtual void setClassifierBehavior(uml::Behavior *  _classifierBehavior) ;
			
			/*!
			 The set of InterfaceRealizations owned by the BehavioredClassifier. Interface realizations reference the Interfaces of which the BehavioredClassifier is an implementation.
			<p>From package UML::SimpleClassifiers.</p> */
			virtual std::vector<uml::InterfaceRealization * > *  getInterfaceRealization() const ;
			
			/*!
			 Behaviors owned by a BehavioredClassifier.
			<p>From package UML::SimpleClassifiers.</p> */
			virtual std::vector<uml::Behavior * > *  getOwnedBehavior() const ;
