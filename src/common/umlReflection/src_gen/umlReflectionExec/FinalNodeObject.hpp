...
#ifndef UML_FINALNODE_EXECUTION_HPP
#define UML_FINALNODE_EXECUTION_HPP
...
namespace UML 
{
	class FinalNodeObject : virtual public UML::ControlNodeObject
	{
		public:
		    //constructors
		    FinalNodeObject(FinalNodeObject &obj);
		    FinalNodeObject(std::shared_ptr<uml::FinalNode>);
		 	FinalNodeObject();
		    //destructor
		    virtual ~FinalNodeObject();
		
		    virtual std::shared_ptr<ecore::EObject> copy();
			FinalNodeObject& operator=(FinalNodeObject const&);

			virtual void destroy();
			
			virtual std::shared_ptr<uml::FinalNode> getFinalNodeValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setFinalNodeValue(std::shared_ptr<uml::FinalNode>);
			virtual void setThisFinalNodeObjectPtr(std::weak_ptr<FinalNodeObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::FinalNode> m_FinalNodeValue = nullptr;
	};
}
#endif /* end of include guard: UML_FINALNODE_OBJECT_HPP */
