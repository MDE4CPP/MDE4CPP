...
#ifndef UML_ACTIVITYGROUP_EXECUTION_HPP
#define UML_ACTIVITYGROUP_EXECUTION_HPP
...
namespace UML 
{
	class ActivityGroupObject : virtual public UML::NamedElementObject
	{
		public:
		    //constructors
		    ActivityGroupObject(ActivityGroupObject &obj);
		    ActivityGroupObject(std::shared_ptr<uml::ActivityGroup>);
		 	ActivityGroupObject();
		    //destructor
			...
			virtual std::shared_ptr<uml::ActivityGroup> getActivityGroupValue() const;
			virtual std::shared_ptr<uml::Element> getUmlValue() const;
			virtual void setUmlValue(std::shared_ptr<uml::Element>);
			virtual void setActivityGroupValue(std::shared_ptr<uml::ActivityGroup>);
			virtual void setThisActivityGroupObjectPtr(std::weak_ptr<ActivityGroupObject> thisObjectPtr);
		...
		protected:
			std::shared_ptr<uml::ActivityGroup> m_ActivityGroupValue = nullptr;
	};
}
#endif /* end of include guard: UML_ACTIVITYGROUP_OBJECT_HPP */
