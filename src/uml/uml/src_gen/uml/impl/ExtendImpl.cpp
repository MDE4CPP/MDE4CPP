...
// Operations
//*********************************
bool ExtendImpl::extension_points(std::shared_ptr<Any> diagnostics, std::shared_ptr<std::map < Any, Any>> context)
{
...
bool ExtendImpl::eSet(int featureID, std::shared_ptr<Any> newValue)
{
	switch(featureID)
	{
		case uml::umlPackage::EXTEND_ATTRIBUTE_CONDITION:
...
// EOperation Invoke
//*********************************
std::shared_ptr<Any> ExtendImpl::eInvoke(int operationID, std::shared_ptr<Bag<Any>> arguments)
{
	std::shared_ptr<Any> result;
  	...
  	switch(operationID)
	{
		...
		case umlPackage::EXTEND_OPERATION_EXTENSION_POINTS_EDIAGNOSTICCHAIN_EMAP:
		{
			...
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for parameter 'diagnostics'. Failed to invoke operation 'extension_points'!")
				return nullptr;
			}
			...
			{
				DEBUG_ERROR("Invalid type stored in 'Any' for parameter 'context'. Failed to invoke operation 'extension_points'!")
				return nullptr;
			}
